...
equation
  connect(mixAirTemSet.y, conEco.TMixSet)
    annotation(
      Line(
        points={{-59, 80}, {-20, 80}, {20, 80}, {20, 8}, {39, 8}},
        color={0, 0, 127}));
  connect(mixAirTem.y, conEco.TMix)
    annotation(
      Line(
        points={{-59, 50}, {-59, 50}, {10, 50}, {10, 5}, {39, 5}},
        color={0, 0, 127}));
  connect(retAirTem.y, conEco.TRet)
    annotation(
      Line(
        points={{-59, 20}, {-59, 20}, {0, 20}, {0, 2}, {39, 2}},
        color={0, 0, 127}));
  ...
  connect(heaConSig.y, conEco.yHea)
    annotation(
      Line(
        points={{-59,-80}, {-18,-80}, {20,-80}, {20,-8}, {39,-8}},
        color={0, 0, 127}));
  annotation(
    experiment(
      StopTime=604800,
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Air/Systems/SingleZone/VAV/BaseClasses/Validation/ControllerEconomizer.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
