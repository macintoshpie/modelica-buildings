...
model ControllerHeatingFan
  ...
  Buildings.Air.Systems.SingleZone.VAV.BaseClasses.ControllerHeatingFan conHeaFan(
    minAirFlo=0.6)
...
equation
  connect(zonHeaSet.y, conHeaFan.TSetRooHea)
    annotation(
      Line(
        points={{-39, 30}, {-20, 30}, {0, 30}, {0, 6}, {19, 6}},
        color={0, 0, 127}));
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Air/Systems/SingleZone/VAV/BaseClasses/Validation/ControllerHeatingFan.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
