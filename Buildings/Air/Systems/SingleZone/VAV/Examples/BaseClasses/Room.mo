  ...
  Fluid.Sources.MassFlowSource_WeatherData sinInf(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-40,-20}, {-20, 0}})));
  Modelica.Blocks.Sources.Constant InfiltrationRate(
    k=48*2.7*0.5/3600)
    "0.41 ACH adjusted for the altitude (0.5 at sea level)"
    annotation(
      Placement(
        transformation(
          extent={{-180,-94}, {-160,-74}})));
...
equation
  ...
  connect(sinInf.ports[1], roo.ports[2])
    annotation(
      Line(
        points={{-20,-10}, {14,-10}, {14,-15.08}, {40.5,-15.08}},
        color={0, 127, 255}));
  ...
  connect(qRadGai_flow.y, pro1.u1)
    annotation(
      Line(
        points={{-99, 130}, {-80, 130}, {-80, 136}, {-42, 136}},
        color={0, 0, 127}));
  connect(qLatGai_flow.y, pro2.u1)
    annotation(
      Line(
        points={{-99, 70}, {-70, 70}, {-70, 76}, {-42, 76}},
        color={0, 0, 127}));
  connect(qConGai_flow.y, pro3.u1)
    annotation(
      Line(
        points={{-99, 100}, {-94, 100}, {-94, 96}, {-82, 96}},
        color={0, 0, 127}));
  connect(intLoad.y[1], pro2.u2)
    annotation(
      Line(
        points={{-99, 160}, {-90, 160}, {-90, 64}, {-42, 64}},
        color={0, 0, 127}));
  connect(pro1.y, mul.u1[1])
    annotation(
      Line(
        points={{-19, 130}, {-12, 130}, {-12, 98.7}, {-2.2, 98.7}},
        color={0, 0, 127}));
  connect(pro3.y, mul.u2[1])
    annotation(
      Line(
        points={{-59, 90}, {-58, 90}, {-58, 91}, {-2.2, 91}},
        color={0, 0, 127}));
  connect(pro2.y, mul.u3[1])
    annotation(
      Line(
        points={{-19, 70}, {-12, 70}, {-12, 83.3}, {-2.2, 83.3}},
        color={0, 0, 127}));
  ...
  connect(souInf.ports[1], roo.ports[3])
    annotation(
      Line(
        points={{-20,-50}, {-6,-50}, {-6,-13}, {40.5,-13}},
        color={0, 127, 255}));
  ...
  connect(gaiInf.y, souInf.m_flow_in)
    annotation(
      Line(
        points={{-59,-90}, {-46,-90}, {-46,-42}, {-40,-42}},
        color={0, 0, 127}));
  connect(product.y, sinInf.m_flow_in)
    annotation(
      Line(
        points={{-99,-90}, {-92,-90}, {-92,-2}, {-40,-2}},
        color={0, 0, 127}));
  connect(supplyAir, roo.ports[4])
    annotation(
      Line(
        points={{-200, 20}, {-120, 20}, {-120, 48}, {0, 48}, {0,-10.92}, {40.5,-10.92}},
        color={0, 127, 255}));
  connect(returnAir, roo.ports[5])
    annotation(
      Line(
        points={{-200,-20}, {-114,-20}, {-114, 42}, {-2, 42}, {-2,-8.84}, {40.5,-8.84}},
        color={0, 127, 255}));
  connect(InfiltrationRate.y, product.u1)
    annotation(
      Line(
        points={{-159,-84}, {-122,-84}},
        color={0, 0, 127}));
  connect(intLoad.y[1], pro1.u2)
    annotation(
      Line(
        points={{-99, 160}, {-90, 160}, {-90, 124}, {-42, 124}},
        color={0, 0, 127}));
  connect(pro3.u2, intLoad.y[1])
    annotation(
      Line(
        points={{-82, 84}, {-90, 84}, {-90, 160}, {-99, 160}},
        color={0, 0, 127}));
  annotation(
    Documentation(
      info="<html>
