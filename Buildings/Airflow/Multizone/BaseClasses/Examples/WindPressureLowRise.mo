...
model WindPressureLowRise
  ...
  parameter Real G=Modelica.Math.log(0.5)
...
equation
  ...
  annotation(experiment(StartTime=-2, Tolerance=1e-6, StopTime=2), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Airflow/Multizone/BaseClasses/Examples/WindPressureLowRise.mos"
