...
partial model ZonalFlow
  "Flow across zonal boundaries of a room"
  extends Buildings.Fluid.Interfaces.PartialFourPortInterface(redeclare final package Medium1=Medium, redeclare final package Medium2=Medium, final allowFlowReversal1=false, final allowFlowReversal2=false, final m1_flow_nominal=10/3600*1.2, final m2_flow_nominal=m1_flow_nominal, final m1_flow_small=1E-4*abs(m1_flow_nominal), final m2_flow_small=1E-4*abs(m2_flow_nominal));
...
equation
  ...
  annotation(Icon(graphics={Rectangle(extent={{-100,-100}, {100, 100}}, lineColor={0, 0, 127}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Line(points={{-84, 54}, {-40, 34}, {0, 68}, {36, 42}, {72, 50}}, color={0, 0, 127}, smooth=Smooth.Bezier), Polygon(points={{7,-1}, {-9,-1}, {-7,-9}, {7,-1}}, lineColor={0, 0, 127}, fillColor={0, 0, 127}, fillPattern=FillPattern.Solid, origin={79, 55}, rotation=360), Line(points={{76,-62}, {32,-82}, {-8,-48}, {-44,-74}, {-80,-66}}, color={0, 0, 127}, smooth=Smooth.Bezier), Polygon(points={{-7,-1}, {9,-1}, {7,-9}, {-7,-1}}, lineColor={0, 0, 127}, fillColor={0, 0, 127}, fillPattern=FillPattern.Solid, origin={-79,-63}, rotation=360)}), Documentation(info="<html>
<p>
