...
model CO2TransportStep
  ...
  extends Buildings.Airflow.Multizone.Validation.ThreeRoomsContam(volWes(nPorts=5), volTop(nPorts=3), volEas(nPorts=6));
  ...
  Modelica.Blocks.Sources.Pulse pulse(amplitude=8.18E-6, width=1/24/10, period=86400, startTime=3600)
    annotation(Placement(transformation(extent={{-140,-80}, {-120,-60}})));
  Buildings.Fluid.Sources.TraceSubstancesFlowSource sou(redeclare package Medium=Medium, use_m_flow_in=true, nPorts=1)
    "CO2 source"
    annotation(Placement(transformation(extent={{-100,-80}, {-80,-60}})));
equation
  connect(sou.m_flow_in, pulse.y)
    annotation(Line(points={{-102.1,-70}, {-119,-70}}, color={0, 0, 127}));
  connect(sou.ports[1], volWes.ports[4])
    annotation(Line(points={{-80,-70}, {-74,-70}, {-74,-38}, {-80,-38}, {-80,-30}}, color={0, 127, 255}));
  connect(CO2SenWes.port, volWes.ports[5])
    annotation(Line(points={{-92, 10}, {-92, 0}, {-72, 0}, {-72,-34}, {-80,-34}, {-80,-30}}, color={0, 127, 255}));
  connect(CO2SenTop.port, volTop.ports[3])
    annotation(Line(points={{30, 120}, {30, 108}, {-10, 108}, {-10, 120}}, color={0, 127, 255}));
  connect(CO2SenEas.port, volEas.ports[6])
    annotation(Line(points={{68, 10}, {68,-30}, {90,-30}, {90,-20}}, color={0, 127, 255}));
  annotation(Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-200,-150}, {300, 250}})), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Airflow/Multizone/Examples/CO2TransportStep.mos"
    "Simulate and plot"), experiment(StopTime=86400, Tolerance=1e-6), Documentation(info="<html>
<p>
