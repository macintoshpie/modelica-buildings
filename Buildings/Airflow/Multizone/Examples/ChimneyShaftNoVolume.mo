    ...
    annotation(
      Placement(
        transformation(
          ...
          extent={{10,-10}, {-10, 10}},
          rotation=90)));
  Modelica.Blocks.Sources.CombiTimeTable mRoo_flow(
    tableOnFile=false,
    table=[
      0, 0.05;
      600, 0.05;
  ...
  Modelica.Blocks.Math.Gain gain(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-28, 20}, {-8, 40}})));
  Buildings.Airflow.Multizone.MediumColumn sha(
    redeclare package Medium=Medium,
...
equation
  ...
  connect(preHea.port, roo.heatPort)
    annotation(
      Line(
        points={{-1.22629e-15, 1.22125e-15}, {-1.22629e-15,-20}, {0,-20}, {0,-50}, {20,-50}},
        color={191, 0, 0}));
  connect(roo.heatPort, temSen.port)
    annotation(
      Line(
        points={{20,-50}, {-40,-50}, {-40,-20}, {-96,-20}, {-96, 6.10623e-16}, {-90, 6.10623e-16}},
        color={191, 0, 0}));
  ...
  annotation(
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Airflow/Multizone/Examples/ChimneyShaftNoVolume.mos"
        "Simulate and plot"),
    experiment(
      StopTime=3600,
      Tolerance=1e-06),
