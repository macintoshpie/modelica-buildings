  ...
  Buildings.Airflow.Multizone.DoorDiscretizedOperable dooAC(
    ...
    annotation(
      Placement(
        transformation(
          extent={{10,-60}, {30,-40}})));
  Modelica.Blocks.Sources.Constant yDoor(
    k=0)
...
equation
  ...
  connect(yDoor.y, dooAB.y)
    annotation(
      Line(
        points={{-39,-80}, {-34,-80}, {-34,-20}, {9,-20}},
        color={0, 0, 255}));
  connect(yDoor.y, dooAC.y)
    annotation(
      Line(
        points={{-39,-80}, {-34,-80}, {-34,-50}, {9,-50}},
        color={0, 0, 255}));
  connect(yDoor.y, dooBC.y)
    annotation(
      Line(
        points={{-39,-80}, {-16,-80}, {9,-80}},
        color={0, 0, 255}));
  ...
  annotation(
    experiment(
      ...
      StopTime=7200),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Airflow/Multizone/Examples/ClosedDoors.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
