  ...
  Modelica.Blocks.Math.Gain Gain1(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-40, 20}, {-20, 40}})));
  Buildings.Airflow.Multizone.EffectiveAirLeakageArea cra(
    redeclare package Medium=Medium,
    L=20E-4)
    annotation(
      Placement(
...
equation
  ...
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Airflow/Multizone/Examples/OneEffectiveAirLeakageArea.mos"
        "Simulate and plot"),
    experiment(
      StopTime=7200,
      Tolerance=1e-08),
