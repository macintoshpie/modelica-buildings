  ...
  Modelica.Thermal.HeatTransfer.Sources.PrescribedHeatFlow preHeaFlo
    annotation(
      Placement(
        transformation(
          extent={{14, 60}, {34, 80}})));
  Modelica.Blocks.Sources.Sine heaSou(
    freqHz=1/3600)
    annotation(
      Placement(
        transformation(
...
equation
  ...
  connect(heaSou.y, Gain1.u)
    annotation(
      Line(
        points={{-39, 70}, {-39, 70}, {-22, 70}},
        color={0, 0, 255}));
  connect(ramp.y, dooOpeClo.y)
    annotation(
      Line(
        points={{-39,-34}, {-39,-34}, {9,-34}},
        color={0, 0, 255}));
  ...
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Airflow/Multizone/Examples/OneOpenDoor.mos"
        "Simulate and plot"),
    experiment(
      StopTime=7200,
      Tolerance=1e-06),
