  ...
  Modelica.Blocks.Sources.Ramp Ramp1(
    ...
    annotation(
      Placement(
        transformation(
          extent={{0,-48}, {20,-28}})));
  Modelica.Blocks.Sources.Constant Pre(
    k=100000)
    annotation(
      Placement(
        transformation(
...
equation
  connect(Pre.y, Add1.u1)
    annotation(
      Line(
        points={{-79,-10}, {-42,-10}, {-42,-14}, {42,-14}},
        color={0, 0, 255}));
  connect(Ramp1.y, Add1.u2)
    annotation(
      Line(
        points={{21,-38}, {26,-38}, {26,-26}, {42,-26}},
        color={0, 0, 255}));
  ...
  annotation(
    experiment(
      ...
      StopTime=1),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Airflow/Multizone/Examples/Orifice.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
