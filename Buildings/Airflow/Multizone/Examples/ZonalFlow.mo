  ...
  Buildings.Fluid.MixingVolumes.MixingVolume rooB(
    ...
    annotation(
      Placement(
        transformation(
          extent={{40, 20}, {60, 40}})));
  Modelica.Blocks.Sources.Constant ACS(
    k=5/3600)
...
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=3600),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Airflow/Multizone/Examples/ZonalFlow.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
