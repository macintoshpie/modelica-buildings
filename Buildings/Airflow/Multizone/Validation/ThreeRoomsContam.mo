...
model ThreeRoomsContam
  ...
  Buildings.Fluid.MixingVolumes.MixingVolume volWes(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-90,-30}, {-70,-10}})));
  Modelica.Blocks.Sources.Constant open(
    k=1)
    annotation(
      Placement(
        transformation(
  ...
  Buildings.Fluid.MixingVolumes.MixingVolume volTop(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-20, 120}, {0, 140}})));
  Buildings.HeatTransfer.Sources.FixedTemperature TTop(
    T=293.15)
    "Fixed temperature"
    annotation(
      Placement(
  ...
  Buildings.HeatTransfer.Sources.FixedTemperature TWes(
    T=298.15)
    "Fixed temperature"
    annotation(
      Placement(
        transformation(
          extent={{-150,-30}, {-130,-10}})));
  Buildings.HeatTransfer.Sources.FixedTemperature TEas(
    T=293.15)
    "Fixed temperature"
    annotation(
      Placement(
  ...
  Modelica.Thermal.HeatTransfer.Components.ThermalConductor conTop(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-50, 120}, {-30, 140}})));
  Modelica.Thermal.HeatTransfer.Components.ThermalConductor conWes(
    G=1E9)
    "Thermal conductor"
    annotation(
      Placement(
  ...
  Modelica.Thermal.HeatTransfer.Components.ThermalConductor conEas(
    G=1E9)
    "Thermal conductor"
    annotation(
      Placement(
...
equation
  ...
  annotation(
    ...
    experiment(
      ...
      StopTime=3600),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Airflow/Multizone/Validation/ThreeRoomsContam.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
