  ...
  Buildings.Controls.Continuous.LimPID conPID(
    ...
    annotation(
      Placement(
        transformation(
          extent={{20,-50}, {40,-30}})));
  Modelica.Blocks.Math.IntegerToBoolean fmcMod(
    threshold=3)
...
equation
  connect(TCWSupSet, swi1.u1)
    annotation(
      Line(
        points={{-120, 80}, {-48, 80}, {-48, 48}, {-32, 48}},
        color={0, 0, 127}));
  connect(TCHWSupSet, swi1.u3)
    annotation(
      Line(
        points={{-120, 0}, {-48, 0}, {-48, 32}, {-32, 32}},
        color={0, 0, 127}));
  connect(swi1.y, conPID.u_s)
    annotation(
      Line(
        points={{-9, 40}, {0, 40}, {0,-40}, {18,-40}},
        color={0, 0, 127}));
  connect(fmcMod.y, swi2.u2)
    annotation(
      Line(
        points={{-59, 40}, {-54, 40}, {-54,-66}, {-42,-66}},
        color={255, 0, 255}));
  connect(TCWSup, swi2.u1)
    annotation(
      Line(
        points={{-120,-40}, {-50,-40}, {-50,-58}, {-42,-58}},
        color={0, 0, 127}));
  ...
  connect(swi2.y, conPID.u_m)
    annotation(
      Line(
        points={{-19,-66}, {30,-66}, {30,-52}},
        color={0, 0, 127}));
  connect(pmcMod.y, swi3.u2)
    annotation(
      Line(
        points={{41, 0}, {51.5, 0}, {62, 0}},
        color={255, 0, 255}));
  connect(uni.y, swi3.u1)
    annotation(
      Line(
        points={{41, 40}, {50, 40}, {50, 8}, {62, 8}},
        color={0, 0, 127}));
