...
equation
  connect(QTot.y, chiStaCon.QTot)
    annotation(
      Line(
        points={{-39, 0}, {-39, 0}, {-12, 0}},
        color={0, 0, 127}));
  connect(cooMod.y, chiStaCon.cooMod)
    annotation(
      Line(
        points={{-39, 50}, {-26, 50}, {-26, 6}, {-12, 6}},
        color={255, 127, 0}));
  ...
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Applications/DataCenters/ChillerCooled/Controls/Validation/ChillerStage.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
