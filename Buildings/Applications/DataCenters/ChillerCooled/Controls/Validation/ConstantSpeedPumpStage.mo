...
model ConstantSpeedPumpStage
  ...
  Buildings.Applications.DataCenters.ChillerCooled.Controls.ConstantSpeedPumpStage conSpePumSta(tWai=30)
...
equation
  connect(cooMod.y, conSpePumSta.cooMod)
    annotation(Line(points={{-39, 50}, {-20, 50}, {-20, 5}, {-12, 5}}, color={255, 127, 0}));
  connect(chiNumOn.y, conSpePumSta.numOnChi)
    annotation(Line(points={{-39,-30}, {-20,-30}, {-20,-5}, {-12,-5}}, color={255, 127, 0}));
  annotation(__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Applications/DataCenters/ChillerCooled/Controls/Validation/ConstantSpeedPumpStage.mos"
