...
equation
  connect(TCHWSupSet.y, cooModCon.TCHWSupSet)
    annotation(
      Line(
        points={{-39, 70}, {-20, 70}, {-20, 6}, {-12, 6}},
        color={0, 0, 127}));
  connect(TWetBub.y, cooModCon.TWetBul)
    annotation(
      Line(
        points={{-39, 30}, {-26, 30}, {-26, 2}, {-12, 2}},
        color={0, 0, 127}));
  ...
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Applications/DataCenters/ChillerCooled/Controls/Validation/CoolingModeNonIntegrated.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
