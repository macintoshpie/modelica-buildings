  ...
  Modelica.Blocks.Sources.Sine CHWST(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60,-80}, {-40,-60}})));
  Modelica.Blocks.Sources.Constant CWSTSet(
    k=273.15 + 20)
...
equation
  connect(CWSTSet.y, cooTowSpeCon.TCWSupSet)
    annotation(
      Line(
        points={{-39, 80}, {-20, 80}, {-20, 80}, {-20, 22}, {-20, 10}, {-12, 10}},
        color={0, 0, 127}));
  connect(CHWSTSet.y, cooTowSpeCon.TCHWSupSet)
    annotation(
      Line(
        points={{-39, 10}, {-32, 10}, {-32, 1.11111}, {-12, 1.11111}},
        color={0, 0, 127}));
  connect(CWST.y, cooTowSpeCon.TCWSup)
    annotation(
      Line(
        points={{-39,-30}, {-32,-30}, {-32,-3.33333}, {-12,-3.33333}},
        color={0, 0, 127}));
  connect(CHWST.y, cooTowSpeCon.TCHWSup)
    annotation(
      Line(
        points={{-39,-70}, {-32,-70}, {-24,-70}, {-24,-7.77778}, {-12,-7.77778}},
        color={0, 0, 127}));
  connect(cooMod.y, cooTowSpeCon.cooMod)
    annotation(
      Line(
        points={{-39, 50}, {-26, 50}, {-26, 5.55556}, {-12, 5.55556}},
        color={255, 127, 0}));
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Applications/DataCenters/ChillerCooled/Controls/Validation/CoolingTowerSpeed.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
