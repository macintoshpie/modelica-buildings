...
model VariableSpeedPumpStage
  ...
  Modelica.StateGraph.Transition con2(
    enableTimer=true,
    waitTime=tWai,
    condition=speSig > criPoiSpe + deaBanSpe and masFloPum > criPoiFlo + deaBanFlo)
  ...
  Modelica.StateGraph.Transition con3(
    enableTimer=true,
    waitTime=tWai,
    condition=speSig < criPoiSpe-deaBanSpe or masFloPum < criPoiFlo-deaBanFlo)
...
equation
  ...
  connect(booToInt.u, oneOn.active)
    annotation(
      Line(
        points={{18,-40}, {10,-40}, {10, 10}, {-39, 10}},
        color={255, 0, 255}));
  ...
  connect(booToInt1.y, addInt.u2)
    annotation(
      Line(
        points={{41,-70}, {48,-70}, {48,-52}, {58,-52}},
        color={255, 127, 0}));
  connect(addInt.y, intToRea.u)
    annotation(
      Line(
        points={{81,-46}, {90,-46}, {90,-20}, {30,-20}, {30, 0}, {38, 0}},
        color={255, 127, 0}));
