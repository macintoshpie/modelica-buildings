...
partial model AHUParameters
  ...
  parameter Modelica.SIunits.Time tau1=20
    "Time constant at nominal flow of medium 1"
    annotation(Dialog(group="Cooling coil", enable=not(energyDynamics == Modelica.Fluid.Types.Dynamics.SteadyState)));
  parameter Modelica.SIunits.Time tau2=1
    "Time constant at nominal flow of medium 2"
    annotation(Dialog(group="Cooling coil", enable=not(energyDynamics == Modelica.Fluid.Types.Dynamics.SteadyState)));
