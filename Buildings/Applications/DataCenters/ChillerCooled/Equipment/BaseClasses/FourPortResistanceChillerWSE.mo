...
record FourPortResistanceChillerWSE
  ...
  parameter Modelica.SIunits.PressureDifference dp1_chi_nominal(min=0, displayUnit="Pa")
    "Pressure difference on medium 1 side in the chillers"
    annotation(Dialog(group="Chiller"));
  parameter Modelica.SIunits.PressureDifference dp1_wse_nominal(min=0, displayUnit="Pa")
  ...
  parameter Modelica.SIunits.PressureDifference dp2_chi_nominal(min=0, displayUnit="Pa")
    "Pressure difference on medium 2 side in the chillers"
    annotation(Dialog(group="Chiller"));
  parameter Modelica.SIunits.PressureDifference dp2_wse_nominal(min=0, displayUnit="Pa")
