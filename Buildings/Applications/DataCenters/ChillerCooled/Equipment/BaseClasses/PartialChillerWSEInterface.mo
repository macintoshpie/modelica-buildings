...
partial model PartialChillerWSEInterface
  ...
  parameter Integer num(min=1)=2
    "Total number of chillers and waterside economizer";
  Modelica.Blocks.Interfaces.RealInput TSet(final unit="K", final quantity="ThermodynamicTemperature", displayUnit="degC")
    ...
    annotation(Placement(transformation(extent={{-140, 84}, {-100, 124}}), iconTransformation(extent={{-132, 92}, {-100, 124}})));
  Modelica.Blocks.Interfaces.BooleanInput on[num]
    "Set to true to enable equipment, or false to disable equipment"
    annotation(Placement(transformation(extent={{-140, 52}, {-100, 92}}), iconTransformation(extent={{-132, 60}, {-100, 92}})));
...
protected
  ...
  annotation(Icon(coordinateSystem(preserveAspectRatio=false), graphics={Rectangle(extent={{-100, 100}, {100,-100}}, pattern=LinePattern.None), Rectangle(extent={{-80, 80}, {80,-80}}, lineColor={255, 255, 255}, fillColor={95, 95, 95}, fillPattern=FillPattern.Solid)}), Documentation(info="<html>
<p>
