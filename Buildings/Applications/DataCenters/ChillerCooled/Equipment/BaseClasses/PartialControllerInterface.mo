...
partial model PartialControllerInterface
  ...
  parameter Modelica.SIunits.Time Ti(
    ...
    annotation(
      Dialog(
        enable=(use_controller and(controllerType == Modelica.Blocks.Types.SimpleController.PI or controllerType == Modelica.Blocks.Types.SimpleController.PID)),
        tab="Controller"));
  parameter Modelica.SIunits.Time Td(
    ...
    annotation(
      Dialog(
        enable=use_controller and(controllerType == Modelica.Blocks.Types.SimpleController.PD or controllerType == Modelica.Blocks.Types.SimpleController.PID),
        tab="Controller"));
  parameter Real yMax(
    start=1)=1
  ...
  parameter Real yCon_start=0
    ...
    annotation(
      Dialog(
        enable=(initType == Modelica.Blocks.Types.InitPID.InitialOutput and use_controller),
        group="Initialization",
        tab="Controller"));
  ...
  parameter Real y_reset=xi_start
    ...
    annotation(
      Dialog(
        enable=use_controller and reset == Buildings.Types.Reset.Parameter,
        group="Integrator reset",
        tab="Controller"));
