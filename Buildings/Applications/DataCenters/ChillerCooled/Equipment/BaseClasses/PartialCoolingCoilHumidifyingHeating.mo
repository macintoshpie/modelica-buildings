...
partial model PartialCoolingCoilHumidifyingHeating
  ...
  parameter Real kFixed(
    unit="",
    min=0)=m1_flow_nominal/sqrt(dp1_nominal)
  ...
  Buildings.Fluid.HeatExchangers.WetCoilCounterFlow cooCoi(
    ...
    annotation(
      Placement(
        transformation(
          extent={{60,-64}, {80,-44}})));
  replaceable Buildings.Fluid.Movers.BaseClasses.PartialFlowMachine fan constrainedby Buildings.Fluid.Movers.BaseClasses.PartialFlowMachine(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-50,-70}, {-70,-50}})));
  replaceable Buildings.Fluid.Actuators.BaseClasses.PartialTwoWayValveKv watVal constrainedby Buildings.Fluid.Actuators.BaseClasses.PartialTwoWayValveKv(
...
equation
  connect(port_a1, cooCoi.port_a1)
    annotation(
      Line(
        points={{-100, 60}, {50, 60}, {50,-48}, {60,-48}},
        color={0, 127, 255}));
  connect(cooCoi.port_a2, port_a2)
    annotation(
      Line(
        points={{80,-60}, {80,-60}, {84,-60}, {100,-60}},
        color={0, 127, 255}));
  connect(cooCoi.port_b1, watVal.port_a)
    annotation(
      Line(
        points={{80,-48}, {80,-48}, {80,-26}, {80,-34}, {80,-20}},
        color={0, 127, 255}));
  connect(watVal.port_b, port_b1)
    annotation(
      Line(
        points={{80, 0}, {80, 0}, {80, 60}, {100, 60}},
        color={0, 127, 255}));
  connect(fan.P, PFan)
    annotation(
      Line(
        points={{-71,-51}, {-80,-51}, {-80,-80}, {-20,-80}, {-20,-110}},
        color={0, 0, 127}));
  connect(watVal.y, uVal)
    annotation(
      Line(
        points={{68,-10}, {62,-10}, {62, 30}, {-62, 30}, {-120, 30}},
        color={0, 0, 127}));
  ...
  connect(fan.stage, stage)
    annotation(
      Line(
        points={{-60,-48}, {-60,-40}, {-90,-40}, {-90,-50}, {-120,-50}},
        color={255, 127, 0}));
  connect(yVal, watVal.y_actual)
    annotation(
      Line(
        points={{110, 40}, {92, 40}, {73, 40}, {73,-5}},
        color={0, 0, 127}));
  annotation(
    Diagram(
      coordinateSystem(
