...
equation
  connect(port_a1, hex.port_a1)
    annotation(
      Line(
        points={{-100, 60}, {-100, 60}, {-40, 60}, {-40, 6}, {-10, 6}},
        color={0, 127, 255}));
  ...
  if activate_ThrWayVal then
    connect(hex.port_b2, thrWayVal.port_1)
      annotation(
        Line(
          points={{-10,-6}, {-28,-6}, {-28,-30}, {-40,-30}},
          color={0, 127, 255}));
    connect(port_a2, thrWayVal.port_3)
      annotation(
        Line(
          points={{100,-60}, {-50,-60}, {-50,-40}},
          color={0, 127, 255}));
    connect(thrWayVal.port_2, port_b2)
      annotation(
        Line(
          points={{-60,-30}, {-60,-30}, {-80,-30}, {-80,-60}, {-100,-60}},
          color={0, 127, 255}));
  else
    connect(port_b2, hex.port_b2)
      annotation(
        Line(
          points={{-100,-60}, {-80,-60}, {-80,-6}, {-10,-6}},
          color={0, 127, 255}));
  end if;
  annotation(
    Icon(
