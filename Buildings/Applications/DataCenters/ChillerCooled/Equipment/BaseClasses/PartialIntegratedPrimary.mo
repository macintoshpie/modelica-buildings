...
equation
  connect(port_a2, val5.port_a)
    annotation(
      Line(
        points={{100,-60}, {80,-60}, {80,-20}, {60,-20}},
        color={0, 127, 255}));
  connect(port_a2, wse.port_a2)
    annotation(
      Line(
        points={{100,-60}, {88,-60}, {80,-60}, {80, 24}, {60, 24}},
        color={0, 127, 255}));
  connect(val6.port_a, chiPar.port_a2)
    annotation(
      Line(
        points={{-40,-20}, {-20,-20}, {-20, 24}, {-40, 24}},
        color={0, 127, 255}));
  ...
  connect(val6.port_b, port_b2)
    annotation(
      Line(
        points={{-60,-20}, {-80,-20}, {-80,-60}, {-100,-60}},
        color={0, 127, 255}));
  connect(val5.y, yVal5)
    annotation(
      Line(
        points={{50,-8}, {50, 0}, {50, 0}, {-94, 0}, {-94, 20}, {-120, 20}},
        color={0, 0, 127}));
  connect(yVal6, val6.y)
    annotation(
      Line(
        points={{-120,-10}, {-94,-10}, {-94, 0}, {-50, 0}, {-50,-8}},
        color={0, 0, 127}));
  connect(senTem.port_b, val5.port_b)
    annotation(
      Line(
        points={{8, 24}, {0, 24}, {0,-20}, {40,-20}},
        color={0, 127, 255}));
  annotation(
    Documentation(
      info="<html>
...
First implementation.
    ...
    Icon(
      graphics={Rectangle(
        ...
        fillPattern=FillPattern.Solid,
        origin={42,-45}), Line(
        points={{90,-60}, {78,-60}, {78,-44}, {52,-44}},
        color={0, 128, 255}), Line(
        points={{36,-44}, {12,-44}},
        color={0, 128, 255}), Line(
        points={{-18,-44}, {-36,-44}},
        color={0, 128, 255}), Line(
        points={{-94,-60}, {-78,-60}, {-78,-44}, {-52,-44}},
        color={0, 128, 255}), Line(
        points={{78,-44}, {78, 0}, {64, 0}},
        color={0, 128, 255}), Line(
        points={{24, 0}, {14, 0}, {12, 0}, {12,-44}},
        color={0, 128, 255}), Line(
        points={{12, 6}, {12, 0}},
        color={0, 128, 255}), Line(
        points={{-70, 0}},
        color={0, 0, 0}), Line(
        points={{-72, 0}, {-78, 0}, {-78,-54}},
        color={0, 128, 255}), Line(
        points={{-24, 0}, {-18, 0}, {-18,-44}},
        color={0, 128, 255})}));
