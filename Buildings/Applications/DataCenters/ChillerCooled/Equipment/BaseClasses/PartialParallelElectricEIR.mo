...
partial model PartialParallelElectricEIR
  ...
  replaceable Buildings.Fluid.Chillers.BaseClasses.PartialElectric chi[num] constrainedby Buildings.Fluid.Chillers.BaseClasses.PartialElectric(
...
equation
  ...
  connect(on, chi.on)
    annotation(
      Line(
        points={{-120, 40}, {-90, 40}, {-90, 3}, {-12, 3}},
        color={255, 0, 255}));
  connect(chi.P, P)
    annotation(
      Line(
        points={{11, 9}, {96, 9}, {96, 20}, {110, 20}},
        color={0, 0, 127}));
  annotation(
    Documentation(
      info="<html>
