...
partial model PartialPlantParallelInterface
  ...
  parameter Integer num(min=1)=2
    "Number of equipment";
  Modelica.Blocks.Math.BooleanToReal booToRea[num](each final realTrue=1, each final realFalse=0)
...
equation
  connect(on, booToRea.u)
    annotation(Line(points={{-120, 40}, {-120, 40}, {-81.2, 40}}, color={255, 0, 255}));
  annotation(Icon(coordinateSystem(preserveAspectRatio=false), graphics={Rectangle(extent={{-80, 80}, {80,-80}}, lineColor={0, 0, 255}, pattern=LinePattern.None, fillColor={95, 95, 95}, fillPattern=FillPattern.Solid)}), Documentation(revisions="<html>
<ul>
<li>
