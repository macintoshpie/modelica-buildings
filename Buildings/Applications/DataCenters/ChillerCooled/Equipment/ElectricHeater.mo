  ...
  Buildings.Fluid.HeatExchangers.Heater_T hea(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-8,-10}, {12, 10}})));
  Modelica.Blocks.Math.Gain gaiEff(
    final k=1/eta)
    "Gain for efficiency"
    annotation(
      Placement(
...
equation
  connect(port_a, hea.port_a)
    annotation(
      Line(
        points={{-100, 0}, {-54, 0}, {-8, 0}},
        color={0, 127, 255}));
  connect(hea.port_b, port_b)
    annotation(
      Line(
        points={{12, 0}, {56, 0}, {100, 0}},
        color={0, 127, 255}));
  connect(hea.Q_flow, Q_flow)
    annotation(
      Line(
        points={{13, 8}, {40, 8}, {40, 80}, {110, 80}},
        color={0, 0, 127}));
  connect(on, swi.u2)
    annotation(
      Line(
        points={{-120, 30}, {-80, 30}, {-62, 30}},
        color={255, 0, 255}));
  connect(swi.y, hea.TSet)
    annotation(
      Line(
        points={{-39, 30}, {-20, 30}, {-20, 8}, {-10, 8}},
        color={0, 0, 127}));
  connect(TSet, swi.u1)
    annotation(
      Line(
        points={{-120, 80}, {-80, 80}, {-80, 38}, {-62, 38}},
        color={0, 0, 127}));
  ...
  connect(hea.Q_flow, gaiEff.u)
    annotation(
      Line(
        points={{13, 8}, {40, 8}, {40,-60}, {56,-60}},
        color={0, 0, 127}));
  connect(gaiEff.y, P)
    annotation(
      Line(
        points={{79,-60}, {90,-60}, {90,-60}, {110,-60}},
        color={0, 0, 127}));
  annotation(
    Icon(
      coordinateSystem(
