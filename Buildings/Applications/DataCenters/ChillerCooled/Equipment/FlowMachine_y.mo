...
model FlowMachine_y
  ...
  extends Buildings.Applications.DataCenters.ChillerCooled.Equipment.BaseClasses.PartialPumpParallel(redeclare final Buildings.Fluid.Movers.SpeedControlled_y pum, rhoStd=Medium.density_pTX(101325, 273.15 + 4, Medium.X_default));
equation
  connect(u, pum.y)
