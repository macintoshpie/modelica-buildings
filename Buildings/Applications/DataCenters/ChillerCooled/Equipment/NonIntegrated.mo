...
model NonIntegrated
  ...
  extends Buildings.Applications.DataCenters.ChillerCooled.Equipment.BaseClasses.PartialChillerWSE(
    final numVal=4,
    final m_flow_nominal={m1_flow_chi_nominal, m2_flow_chi_nominal, m1_flow_wse_nominal, m2_flow_wse_nominal},
    rhoStd={Medium1.density_pTX(101325, 273.15 + 4, Medium1.X_default), Medium2.density_pTX(101325, 273.15 + 4, Medium2.X_default), Medium1.density_pTX(101325, 273.15 + 4, Medium1.X_default), Medium2.density_pTX(101325, 273.15 + 4, Medium2.X_default)});
equation
  connect(port_a2, wse.port_a2)
    annotation(
      Line(
        points={{100,-60}, {80,-60}, {80, 24}, {60, 24}},
        color={0, 127, 255}));
  connect(port_a2, chiPar.port_a2)
    annotation(
      Line(
        points={{100,-60}, {-8,-60}, {-8, 24}, {-40, 24}},
        color={0, 127, 255}));
  connect(chiPar.port_b2, port_b2)
    annotation(
      Line(
        points={{-60, 24}, {-72, 24}, {-72,-60}, {-100,-60}},
        color={0, 127, 255}));
  connect(senTem.port_b, port_b2)
    annotation(
      Line(
        points={{8, 24}, {0, 24}, {0,-40}, {-72,-40}, {-72,-60}, {-100,-60}},
        color={0, 127, 255}));
  annotation(
    Icon(
      coordinateSystem(
      ...
      graphics={Line(
        points={{64, 0}, {74, 0}, {74,-60}, {90,-60}},
        color={0, 128, 255}), Line(
        points={{-72, 0}, {-76, 0}, {-76,-60}, {-92,-60}},
        color={0, 128, 255}), Line(
        points={{90,-60}, {90,-60}, {-14,-60}, {-14, 0}, {-24, 0}},
        color={0, 128, 255}), Line(
        points={{12, 0}, {12,-40}, {12,-40}, {-76,-40}},
        color={0, 128, 255})}),
    Documentation(
      info="<html>
<p>
