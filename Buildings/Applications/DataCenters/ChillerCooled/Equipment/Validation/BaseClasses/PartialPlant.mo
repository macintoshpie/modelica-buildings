...
partial model PartialPlant
  ...
  parameter Integer numChi=1
    "Number of chillers";
  Buildings.Fluid.Sources.Boundary_pT sin1(redeclare package Medium=MediumCW)
    "Sink on medium 1 side"
    annotation(Placement(transformation(extent={{10,-10}, {-10, 10}}, origin={80,-4})));
  Buildings.Fluid.Sources.MassFlowSource_T sou1(use_T_in=true, redeclare package Medium=MediumCW, m_flow=mCW_flow_nominal, T=298.15)
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort TSup1(redeclare package Medium=MediumCHW, m_flow_nominal=mCHW_flow_nominal)
    "Temperature sensor"
...
equation
  ...
  connect(sin2.ports[1], TSup1.port_b)
    annotation(Line(points={{-70,-70}, {-68,-70}, {-68,-70}, {-64,-70}, {-64,-44}, {-60,-44}}, color={0, 127, 255}));
