...
model HeatExchanger_ResetController
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort TSen3(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-30,-166}, {-50,-146}})));
  Modelica.Blocks.Sources.Constant yRes(
    k=0)
...
equation
  connect(TSet.y, hex1.TSet)
    annotation(
      Line(
        points={{-69, 50}, {-62, 50}, {-62, 60}, {-14, 60}},
        color={0, 0, 127}));
  connect(sou1.ports[1], hex1.port_a1)
    annotation(
      Line(
        points={{-40, 78.6667}, {-20, 78.6667}, {-20, 62}, {-12, 62}},
        color={0, 127, 255}));
  connect(hex1.port_b1, sin1.ports[1])
    annotation(
      Line(
        points={{8, 62}, {18, 62}, {18, 72.6667}, {68, 72.6667}},
        color={0, 127, 255}));
  connect(TCon_in.y, sou1.T_in)
    annotation(
      Line(
        points={{-69, 80}, {-69, 80}, {-62, 80}},
        color={0, 0, 127}));
  connect(hex1.port_b2, TSen1.port_a)
    annotation(
      Line(
        points={{-12, 50}, {-30, 50}, {-30,-22}, {-40,-22}},
        color={0, 127, 255}));
  connect(TSen1.port_b, sin2.ports[1])
    annotation(
      Line(
        points={{-60,-22}, {-70,-22}, {-70,-39.3333}, {-72,-39.3333}},
        color={0, 127, 255}));
  connect(TSen2.port_b, sin2.ports[2])
    annotation(
      Line(
        points={{-60,-70}, {-68,-70}, {-68,-42}, {-72,-42}},
        color={0, 127, 255}));
  connect(hex1.port_a2, sou2_1.ports[1])
    annotation(
      Line(
        points={{8, 50}, {28, 50}, {28, 26.6667}, {40, 26.6667}},
        color={0, 127, 255}));
  ...
  connect(sou1.ports[2], hex2.port_a1)
    annotation(
      Line(
        points={{-40, 76}, {-22, 76}, {-22,-58}, {-12,-58}},
        color={0, 127, 255}));
  connect(hex2.port_b1, sin1.ports[2])
    annotation(
      Line(
        points={{8,-58}, {20,-58}, {20, 70}, {68, 70}},
        color={0, 127, 255}));
  connect(TSet.y, hex2.TSet)
    annotation(
      Line(
        points={{-69, 50}, {-62, 50}, {-62, 60}, {-20, 60}, {-20,-60}, {-14,-60}},
        color={0, 0, 127}));
  connect(tri.y, hex1.trigger)
    annotation(
      Line(
        points={{-69, 10}, {-8, 10}, {-8, 46}},
        color={255, 0, 255}));
  connect(sou2_1.ports[2], hex2.port_a2)
    annotation(
      Line(
        points={{40, 24}, {28, 24}, {28,-70}, {8,-70}},
        color={0, 127, 255}));
  connect(sin2.ports[3], TSen3.port_b)
    annotation(
      Line(
        points={{-72,-44.6667}, {-66,-44.6667}, {-66,-156}, {-50,-156}},
        color={0, 127, 255}));
  connect(TSen3.port_a, hex3.port_b2)
    annotation(
      Line(
        points={{-30,-156}, {-10,-156}},
        color={0, 127, 255}));
  connect(hex3.port_a1, sou1.ports[3])
    annotation(
      Line(
        points={{-10,-144}, {-24,-144}, {-24, 73.3333}, {-40, 73.3333}},
        color={0, 127, 255}));
  connect(hex3.port_b1, sin1.ports[3])
    annotation(
      Line(
        points={{10,-144}, {22,-144}, {22, 67.3333}, {68, 67.3333}},
        color={0, 127, 255}));
  connect(hex3.port_a2, sou2_1.ports[3])
    annotation(
      Line(
        points={{10,-156}, {30,-156}, {30, 21.3333}, {40, 21.3333}},
        color={0, 127, 255}));
  connect(TSet.y, hex3.TSet)
    annotation(
      Line(
        points={{-69, 50}, {-62, 50}, {-62, 60}, {-20, 60}, {-20,-146}, {-12,-146}},
        color={0, 0, 127}));
  connect(tri.y, hex2.trigger)
    annotation(
      Line(
        points={{-69, 10}, {-34, 10}, {-34,-86}, {-8,-86}, {-8,-74}},
        color={255, 0, 255}));
  connect(yRes.y, hex2.y_reset_in)
    annotation(
      Line(
        points={{-79,-120}, {-12,-120}, {-12,-74}},
        color={0, 0, 127}));
  annotation(
    __Dymola_Commands(
