...
model IntegratedPrimaryLoadSide
  ...
  extends Buildings.Applications.DataCenters.ChillerCooled.Equipment.Validation.BaseClasses.PartialPlant(
    ...
    sin2(
      nPorts=2));
  Buildings.Applications.DataCenters.ChillerCooled.Equipment.IntegratedPrimaryLoadSide intWSEPri1(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-10,-48}, {10,-28}})));
  Modelica.Blocks.Sources.Constant yPum(
    k=1)
...
equation
  connect(onChi.y, intWSEPri1.on[1])
    annotation(
      Line(
        points={{-79, 90}, {-26, 90}, {-26,-30.4}, {-11.6,-30.4}},
        color={255, 0, 255}));
  connect(onWSE.y, intWSEPri1.on[2])
    annotation(
      Line(
        points={{-79, 60}, {-26, 60}, {-26,-30.4}, {-11.6,-30.4}},
        color={255, 0, 255}));
  connect(TSet.y, intWSEPri1.TSet)
    annotation(
      Line(
        points={{-79, 30}, {-28, 30}, {-28,-27.2}, {-11.6,-27.2}},
        color={0, 0, 127}));
  connect(yVal5.y, intWSEPri1.yVal5)
    annotation(
      Line(
        points={{19, 80}, {-24, 80}, {-24,-35}, {-11.6,-35}},
        color={0, 0, 127}));
  connect(yVal6.y, intWSEPri1.yVal6)
    annotation(
      Line(
        points={{19, 60}, {2, 60}, {2, 50}, {-22, 50}, {-22,-38.2}, {-11.6,-38.2}},
        color={0, 0, 127}));
  connect(yPum.y, intWSEPri1.yPum[1])
    annotation(
      Line(
        points={{19, 30}, {-20, 30}, {-20,-42.4}, {-11.6,-42.4}},
        color={0, 0, 127}));
  connect(intWSEPri1.port_a1, sou1.ports[1])
    annotation(
      Line(
        points={{-10,-32}, {-32,-32}, {-32,-4}, {-40,-4}},
        color={0, 127, 255}));
  ...
  connect(TSup2.port_a, intWSEPri2.port_b2)
    annotation(
      Line(
        points={{-40,-126}, {-10,-126}},
        color={0, 127, 255}));
  connect(intWSEPri2.port_a2, sou2.ports[2])
    annotation(
      Line(
        points={{10,-126}, {26,-126}, {26,-76}, {40,-76}},
        color={0, 127, 255}));
  connect(intWSEPri2.port_b1, sin1.ports[2])
    annotation(
      Line(
        points={{10,-114}, {22,-114}, {22,-4}, {70,-4}},
        color={0, 127, 255}));
  connect(intWSEPri2.port_a1, sou1.ports[2])
    annotation(
      Line(
        points={{-10,-114}, {-32,-114}, {-32,-4}, {-40,-4}},
        color={0, 127, 255}));
  connect(TSup2.port_b, sin2.ports[2])
    annotation(
      Line(
        points={{-60,-126}, {-64,-126}, {-64,-70}, {-70,-70}},
        color={0, 127, 255}));
  connect(onChi.y, intWSEPri2.on[1])
    annotation(
      Line(
        points={{-79, 90}, {-26, 90}, {-26,-112.4}, {-11.6,-112.4}},
        color={255, 0, 255}));
  connect(onWSE.y, intWSEPri2.on[2])
    annotation(
      Line(
        points={{-79, 60}, {-26, 60}, {-26,-112.4}, {-11.6,-112.4}},
        color={255, 0, 255}));
  connect(TSet.y, intWSEPri2.TSet)
    annotation(
      Line(
        points={{-79, 30}, {-28, 30}, {-28,-109.2}, {-11.6,-109.2}},
        color={0, 0, 127}));
  connect(yVal5.y, intWSEPri2.yVal5)
    annotation(
      Line(
        points={{19, 80}, {-24, 80}, {-24,-117}, {-11.6,-117}},
        color={0, 0, 127}));
  connect(yVal6.y, intWSEPri2.yVal6)
    annotation(
      Line(
        points={{19, 60}, {2, 60}, {2, 50}, {-22, 50}, {-22,-120.2}, {-11.6,-120.2}},
        color={0, 0, 127}));
  connect(yPum.y, intWSEPri2.yPum[1])
    annotation(
      Line(
        points={{19, 30}, {-20, 30}, {-20,-124.4}, {-11.6,-124.4}},
        color={0, 0, 127}));
  connect(tri.y, intWSEPri2.trigger)
    annotation(
      Line(
        points={{-79,-150}, {-6,-150}, {-6,-130}},
        color={255, 0, 255}));
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Applications/DataCenters/ChillerCooled/Equipment/Validation/IntegratedPrimaryLoadSide.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
