...
model IntegratedPrimaryPlantSide
  ...
  extends Buildings.Applications.DataCenters.ChillerCooled.Equipment.Validation.BaseClasses.PartialPlant(
    ...
    sin2(
      nPorts=2));
  Buildings.Applications.DataCenters.ChillerCooled.Equipment.IntegratedPrimaryPlantSide intWSEPri1(
...
equation
  ...
  connect(yVal6.y, intWSEPri1.yVal6)
    annotation(
      Line(
        points={{19, 70}, {-22, 70}, {-22,-38.2}, {-11.6,-38.2}},
        color={0, 0, 127}));
  ...
  connect(sou1.ports[2], intWSEPri2.port_a1)
    annotation(
      Line(
        points={{-40,-4}, {-28,-4}, {-28,-102}, {-10,-102}},
        color={0, 127, 255}));
  connect(sou2.ports[2], intWSEPri2.port_a2)
    annotation(
      Line(
        points={{40,-76}, {26,-76}, {26,-114}, {10,-114}},
        color={0, 127, 255}));
  connect(intWSEPri2.port_b1, sin1.ports[2])
    annotation(
      Line(
        points={{10,-102}, {20,-102}, {20,-4}, {70,-4}},
        color={0, 127, 255}));
  connect(TSet.y, intWSEPri2.TSet)
    annotation(
      Line(
        points={{-79, 30}, {-16, 30}, {-16,-97.2}, {-11.6,-97.2}},
        color={0, 0, 127}));
  connect(onChi.y, intWSEPri2.on[1])
    annotation(
      Line(
        points={{-79, 90}, {-18, 90}, {-18,-100.4}, {-11.6,-100.4}},
        color={255, 0, 255}));
  connect(onWSE.y, intWSEPri2.on[2])
    annotation(
      Line(
        points={{-79, 60}, {-18, 60}, {-18,-100.4}, {-11.6,-100.4}},
        color={255, 0, 255}));
  connect(yVal5.y, intWSEPri2.yVal5)
    annotation(
      Line(
        points={{19, 90}, {-20, 90}, {-20,-105}, {-11.6,-105}},
        color={0, 0, 127}));
  connect(yVal6.y, intWSEPri2.yVal6)
    annotation(
      Line(
        points={{19, 70}, {-22, 70}, {-22,-108.2}, {-11.6,-108.2}},
        color={0, 0, 127}));
  connect(tri.y, intWSEPri2.trigger)
    annotation(
      Line(
        points={{-79,-150}, {-6,-150}, {-6,-118}},
        color={255, 0, 255}));
  connect(sin2.ports[2], TSup2.port_b)
    annotation(
      Line(
        points={{-70,-70}, {-64,-70}, {-64,-114}, {-60,-114}},
        color={0, 127, 255}));
  connect(TSup2.port_a, intWSEPri2.port_b2)
    annotation(
      Line(
        points={{-40,-114}, {-10,-114}},
        color={0, 127, 255}));
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Applications/DataCenters/ChillerCooled/Equipment/Validation/IntegratedPrimaryPlantSide.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
