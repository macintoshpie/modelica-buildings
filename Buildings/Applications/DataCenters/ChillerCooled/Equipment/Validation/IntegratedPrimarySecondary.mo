...
model IntegratedPrimarySecondary
  ...
  extends Buildings.Applications.DataCenters.ChillerCooled.Equipment.Validation.BaseClasses.PartialPlant(sou1(nPorts=2, m_flow=2*mCW_flow_nominal), sin1(nPorts=2), TSet(k=273.15 + 5.56), TEva_in(k=273.15 + 10.28), sin2(nPorts=2));
  ...
  Buildings.Fluid.Sources.MassFlowSource_T sou2(redeclare package Medium=MediumCHW, nPorts=2, use_T_in=true, m_flow=1.6*mCHW_flow_nominal)
  ...
  parameter Buildings.Fluid.Movers.Data.Generic[numChi] perPum(each pressure=Buildings.Fluid.Movers.BaseClasses.Characteristics.flowParameters(V_flow=mCHW_flow_nominal/1000*{0.2, 0.6, 1.0, 1.2}, dp=dpCHW_nominal*{1.2, 1.1, 1.0, 0.6}))
...
equation
  connect(TSet.y, intWSEPriSec1.TSet)
    annotation(Line(points={{-79, 30}, {-16, 30}, {-16,-27.2}, {-11.6,-27.2}}, color={0, 0, 127}));
  connect(yVal5.y, intWSEPriSec1.yVal5)
    annotation(Line(points={{19, 90}, {-20, 90}, {-20,-35}, {-11.6,-35}}, color={0, 0, 127}));
  connect(intWSEPriSec1.port_a1, sou1.ports[1])
    annotation(Line(points={{-10,-32}, {-22,-32}, {-28,-32}, {-28,-4}, {-40,-4}}, color={0, 127, 255}));
  ...
  connect(intWSEPriSec1.port_b1, sin1.ports[1])
    annotation(Line(points={{10,-32}, {20,-32}, {20,-4}, {70,-4}}, color={0, 127, 255}));
  ...
  connect(yPum.y, intWSEPriSec1.yPum[1])
    annotation(Line(points={{19, 70}, {-22, 70}, {-22,-42}, {-11.6,-42}}, color={0, 0, 127}));
  connect(TEva_in.y, sou2.T_in)
    annotation(Line(points={{69,-70}, {62,-70}}, color={0, 0, 127}));
  connect(onChi.y, intWSEPriSec1.on[1])
    annotation(Line(points={{-79, 90}, {-18, 90}, {-18,-30.4}, {-11.6,-30.4}}, color={255, 0, 255}));
  connect(onWSE.y, intWSEPriSec1.on[2])
    annotation(Line(points={{-79, 60}, {-18, 60}, {-18,-30.4}, {-11.6,-30.4}}, color={255, 0, 255}));
  connect(TSet.y, intWSEPriSec2.TSet)
    annotation(Line(points={{-79, 30}, {-16, 30}, {-16,-99.2}, {-11.6,-99.2}}, color={0, 0, 127}));
  connect(onChi.y, intWSEPriSec2.on[1])
    annotation(Line(points={{-79, 90}, {-18, 90}, {-18,-102.4}, {-11.6,-102.4}}, color={255, 0, 255}));
  connect(onWSE.y, intWSEPriSec2.on[2])
    annotation(Line(points={{-79, 60}, {-18, 60}, {-18,-102.4}, {-11.6,-102.4}}, color={255, 0, 255}));
  connect(yVal5.y, intWSEPriSec2.yVal5)
    annotation(Line(points={{19, 90}, {-20, 90}, {-20,-107}, {-11.6,-107}}, color={0, 0, 127}));
  connect(yPum.y, intWSEPriSec2.yPum[1])
    annotation(Line(points={{19, 70}, {-22, 70}, {-22,-114}, {-11.6,-114}}, color={0, 0, 127}));
  connect(sou1.ports[2], intWSEPriSec2.port_a1)
    annotation(Line(points={{-40,-4}, {-28,-4}, {-28,-104}, {-10,-104}}, color={0, 127, 255}));
  connect(sou2.ports[2], intWSEPriSec2.port_a2)
    annotation(Line(points={{40,-76}, {26,-76}, {26,-116}, {10,-116}}, color={0, 127, 255}));
  connect(intWSEPriSec2.port_b1, sin1.ports[2])
    annotation(Line(points={{10,-104}, {20,-104}, {20,-4}, {70,-4}}, color={0, 127, 255}));
  connect(tri.y, intWSEPriSec2.trigger)
    annotation(Line(points={{-79,-150}, {-6,-150}, {-6,-120}}, color={255, 0, 255}));
  connect(sin2.ports[2], TSup2.port_b)
    annotation(Line(points={{-70,-70}, {-64,-70}, {-64,-116}, {-60,-116}}, color={0, 127, 255}));
  connect(TSup2.port_a, intWSEPriSec2.port_b2)
    annotation(Line(points={{-40,-116}, {-10,-116}}, color={0, 127, 255}));
  annotation(__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Applications/DataCenters/ChillerCooled/Equipment/Validation/IntegratedPrimarySecondary.mos"
