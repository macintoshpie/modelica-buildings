...
model IntegratedPrimarySecondary
  ...
  extends Buildings.Applications.DataCenters.ChillerCooled.Equipment.Validation.BaseClasses.PartialPlant(
    ...
    sin2(
      nPorts=2));
  Buildings.Applications.DataCenters.ChillerCooled.Equipment.IntegratedPrimarySecondary intWSEPriSec1(
    ...
    redeclare Buildings.Fluid.Chillers.Data.ElectricEIR.ElectricEIRChiller_Trane_CVHF_2567kW_11_77COP_VSD perChi,
    k=0.4,
    Ti=80,
    numChi=numChi,
    ...
    annotation(
      Placement(
        transformation(
          extent={{10,-10}, {-10, 10}},
          origin={50,-74})));
  Buildings.Applications.DataCenters.ChillerCooled.Equipment.IntegratedPrimarySecondary intWSEPriSec2(
    m1_flow_chi_nominal=mCW_flow_nominal,
    m2_flow_chi_nominal=mCHW_flow_nominal,
    m1_flow_wse_nominal=mCW_flow_nominal,
    m2_flow_wse_nominal=mCHW_flow_nominal,
...
equation
  ...
  connect(onChi.y, intWSEPriSec1.on[1])
    annotation(
      Line(
        points={{-79, 90}, {-18, 90}, {-18,-30.4}, {-11.6,-30.4}},
        color={255, 0, 255}));
  connect(onWSE.y, intWSEPriSec1.on[2])
    annotation(
      Line(
        points={{-79, 60}, {-18, 60}, {-18,-30.4}, {-11.6,-30.4}},
        color={255, 0, 255}));
  connect(TSet.y, intWSEPriSec2.TSet)
    annotation(
      Line(
        points={{-79, 30}, {-16, 30}, {-16,-99.2}, {-11.6,-99.2}},
        color={0, 0, 127}));
  connect(onChi.y, intWSEPriSec2.on[1])
    annotation(
      Line(
        points={{-79, 90}, {-18, 90}, {-18,-102.4}, {-11.6,-102.4}},
        color={255, 0, 255}));
  connect(onWSE.y, intWSEPriSec2.on[2])
    annotation(
      Line(
        points={{-79, 60}, {-18, 60}, {-18,-102.4}, {-11.6,-102.4}},
        color={255, 0, 255}));
  connect(yVal5.y, intWSEPriSec2.yVal5)
    annotation(
      Line(
        points={{19, 90}, {-20, 90}, {-20,-107}, {-11.6,-107}},
        color={0, 0, 127}));
  connect(yPum.y, intWSEPriSec2.yPum[1])
    annotation(
      Line(
        points={{19, 70}, {-22, 70}, {-22,-114}, {-11.6,-114}},
        color={0, 0, 127}));
  connect(sou1.ports[2], intWSEPriSec2.port_a1)
    annotation(
      Line(
        points={{-40,-4}, {-28,-4}, {-28,-104}, {-10,-104}},
        color={0, 127, 255}));
  connect(sou2.ports[2], intWSEPriSec2.port_a2)
    annotation(
      Line(
        points={{40,-76}, {26,-76}, {26,-116}, {10,-116}},
        color={0, 127, 255}));
  connect(intWSEPriSec2.port_b1, sin1.ports[2])
    annotation(
      Line(
        points={{10,-104}, {20,-104}, {20,-4}, {70,-4}},
        color={0, 127, 255}));
  connect(tri.y, intWSEPriSec2.trigger)
    annotation(
      Line(
        points={{-79,-150}, {-6,-150}, {-6,-120}},
        color={255, 0, 255}));
  connect(sin2.ports[2], TSup2.port_b)
    annotation(
      Line(
        points={{-70,-70}, {-64,-70}, {-64,-116}, {-60,-116}},
        color={0, 127, 255}));
  connect(TSup2.port_a, intWSEPriSec2.port_b2)
    annotation(
      Line(
        points={{-40,-116}, {-10,-116}},
        color={0, 127, 255}));
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Applications/DataCenters/ChillerCooled/Equipment/Validation/IntegratedPrimarySecondary.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
