...
equation
  connect(TSet.y, nonIntWSE1.TSet)
    annotation(
      Line(
        points={{-79, 30}, {-79, 30}, {-20, 30}, {-20,-27.2}, {-11.6,-27.2}},
        color={0, 0, 127}));
  ...
  connect(onChi.y, nonIntWSE1.on[1])
    annotation(
      Line(
        points={{-79, 90}, {-22, 90}, {-22,-30.4}, {-11.6,-30.4}},
        color={255, 0, 255}));
  connect(onWSE.y, nonIntWSE1.on[2])
    annotation(
      Line(
        points={{-79, 60}, {-22, 60}, {-22,-30.4}, {-11.6,-30.4}},
        color={255, 0, 255}));
  connect(TSet.y, nonIntWSE2.TSet)
    annotation(
      Line(
        points={{-79, 30}, {-20, 30}, {-20,-99.2}, {-11.6,-99.2}},
        color={0, 0, 127}));
  connect(onChi.y, nonIntWSE2.on[1])
    annotation(
      Line(
        points={{-79, 90}, {-22, 90}, {-22,-102.4}, {-11.6,-102.4}},
        color={255, 0, 255}));
  connect(onWSE.y, nonIntWSE2.on[2])
    annotation(
      Line(
        points={{-79, 60}, {-22, 60}, {-22,-102.4}, {-11.6,-102.4}},
        color={255, 0, 255}));
  ...
  connect(sin1.ports[2], nonIntWSE2.port_b1)
    annotation(
      Line(
        points={{70,-4}, {20,-4}, {20,-104}, {10,-104}},
        color={0, 127, 255}));
  connect(nonIntWSE2.port_a2, sou2.ports[2])
    annotation(
      Line(
        points={{10,-116}, {26,-116}, {26,-76}, {40,-76}},
        color={0, 127, 255}));
  ...
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Applications/DataCenters/ChillerCooled/Equipment/Validation/NonIntegrated.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
