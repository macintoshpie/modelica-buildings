...
model WatersideEconomizer
  ...
  extends Buildings.Applications.DataCenters.ChillerCooled.Equipment.BaseClasses.PartialPlantParallel(final num=1, val2(each final dpFixed_nominal=0), val1(each final dpFixed_nominal=dp1_nominal), kFixed={m1_flow_nominal/sqrt(dp1_nominal), 0}, final yValve_start={yValWSE_start});
  ...
  // Heat exchanger
  parameter Modelica.SIunits.Efficiency eta(start=0.8)
  ...
  parameter Modelica.SIunits.Time tauThrWayVal=10
    ...
    annotation(Dialog(tab="Dynamics", group="Nominal condition", enable=use_controller and not energyDynamics == Modelica.Fluid.Types.Dynamics.SteadyState));
...
equation
  connect(port_a1, heaExc.port_a1)
    annotation(Line(points={{-100, 60}, {-40, 60}, {-40, 2}, {-10, 2}}, color={0, 127, 255}));
  connect(heaExc.port_a2, port_a2)
    annotation(Line(points={{10,-10}, {40,-10}, {40,-60}, {100,-60}}, color={0, 127, 255}));
  connect(TSet, heaExc.TSet)
    annotation(Line(points={{-120, 0}, {-12, 0}}, color={0, 0, 127}));
  connect(y_reset_in, heaExc.y_reset_in)
    annotation(Line(points={{-90,-100}, {-90,-100}, {-90,-80}, {-10,-80}, {-10,-14}}, color={0, 0, 127}));
  connect(trigger, heaExc.trigger)
    annotation(Line(points={{-60,-100}, {-60,-80}, {-6,-80}, {-6,-14}}, color={255, 0, 255}));
  ...
  connect(val2[1].port_a, heaExc.port_b2)
    annotation(Line(points={{-40,-22}, {-40,-22}, {-40,-10}, {-10,-10}}, color={0, 127, 255}));
...
</html>"), Icon(graphics={Rectangle(extent={{-80, 80}, {80,-80}}, lineColor={0, 128, 255}, fillPattern=FillPattern.Solid, fillColor={95, 95, 95}), Rectangle(extent={{-94,-52}, {100,-66}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Rectangle(extent={{-92, 66}, {92, 54}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Rectangle(extent={{-72, 70}, {-66, 50}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Rectangle(extent={{-66, 70}, {-60, 50}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Rectangle(extent={{-60, 80}, {-40,-80}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Rectangle(extent={{-40, 80}, {-20,-80}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Rectangle(extent={{-20, 80}, {0,-80}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Rectangle(extent={{0, 80}, {20,-80}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Rectangle(extent={{20, 80}, {40,-80}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Rectangle(extent={{40, 80}, {60,-80}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Rectangle(extent={{60, 70}, {66, 50}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Rectangle(extent={{66, 70}, {72, 50}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Rectangle(extent={{66,-50}, {72,-70}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Rectangle(extent={{60,-50}, {66,-70}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Rectangle(extent={{-66,-50}, {-60,-70}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Rectangle(extent={{-72,-50}, {-66,-70}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid)}));
