...
partial model PostProcess
  "Post-processing"
  Buildings.Utilities.Math.IntegratorWithReset FCTim
    "Free cooling time"
    annotation(Placement(transformation(extent={{240, 80}, {260, 100}})));
  Modelica.Blocks.Sources.RealExpression freCooSig
    "Free cooling signal"
  ...
  Modelica.Blocks.Sources.RealExpression PHVAC
    ...
    annotation(Placement(transformation(extent={{-10,-10}, {10, 10}}, origin={190,-50})));
  ...
  Modelica.Blocks.MathInteger.TriggeredAdd swiTim
    "Triggered addition"
...
equation
  ...
  connect(PHVAC.y, EHVAC.u)
    annotation(Line(points={{201,-50}, {238,-50}}, color={0, 0, 127}, smooth=Smooth.None));
  connect(PIT.y, EIT.u)
    annotation(Line(points={{201,-90}, {238,-90}}, color={0, 0, 127}, smooth=Smooth.None));
  connect(sigCha.y, swiTim.trigger)
    annotation(Line(points={{201, 160}, {244, 160}, {244, 184}}, color={255, 0, 255}));
  connect(conInt.y, swiTim.u)
    annotation(Line(points={{202, 196}, {236, 196}}, color={255, 127, 0}));
  annotation(Diagram(coordinateSystem(extent={{-100,-200}, {160, 220}}), graphics={Rectangle(extent={{160, 220}, {320,-200}}, fillColor={229, 229, 229}, fillPattern=FillPattern.Solid, lineColor={0, 0, 0}, pattern=LinePattern.Dot), Text(extent={{174,-164}, {282,-192}}, lineColor={0, 0, 0}, pattern=LinePattern.Dash, lineThickness=0.5, textString="Post-processing"), Text(extent={{310, 120}, {254, 108}}, lineColor={0, 0, 0}, pattern=LinePattern.Dot, fillColor={229, 229, 229}, fillPattern=FillPattern.Solid, textString="Economizing Hours"), Text(extent={{258,-6}, {318,-52}}, lineColor={0, 0, 0}, pattern=LinePattern.Dot, fillColor={229, 229, 229}, fillPattern=FillPattern.Solid, textString="Energy Consumption"), Text(extent={{262, 224}, {308, 200}}, lineColor={0, 0, 0}, pattern=LinePattern.Dot, fillColor={229, 229, 229}, fillPattern=FillPattern.Solid, textString="Switch Times")}), Documentation(info="<html>
<p>
