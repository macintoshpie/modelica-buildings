...
equation
  ...
  connect(sigCha.y, swiTim.trigger)
    annotation(
      Line(
        points={{201, 160}, {244, 160}, {244, 184}},
        color={255, 0, 255}));
  connect(conInt.y, swiTim.u)
    annotation(
      Line(
        points={{202, 196}, {236, 196}},
        color={255, 127, 0}));
  annotation(
    Diagram(
      coordinateSystem(
        extent={{-100,-200}, {160, 220}}),
      graphics={Rectangle(
        ...
        lineThickness=0.5,
        textString="Post-processing"), Text(
        extent={{310, 120}, {254, 108}},
        lineColor={0, 0, 0},
        pattern=LinePattern.Dot,
        fillColor={229, 229, 229},
        fillPattern=FillPattern.Solid,
        textString="Economizing Hours"), Text(
        extent={{258,-6}, {318,-52}},
        lineColor={0, 0, 0},
        pattern=LinePattern.Dot,
        fillColor={229, 229, 229},
        fillPattern=FillPattern.Solid,
        textString="Energy Consumption"), Text(
