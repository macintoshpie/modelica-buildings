...
model NonIntegratedPrimarySecondaryEconomizer
  ...
  extends Buildings.Applications.DataCenters.ChillerCooled.Examples.BaseClasses.PostProcess(
    ...
    PHVAC(
      y=cooTow[1].PFan + cooTow[2].PFan + pumCW[1].P + pumCW[2].P + sum(chiWSE.powChi) + sum(priPum.P) + sum(secPum.P) + ahu.PFan + ahu.PHea),
    PIT(
      y=roo.QSou.Q_flow));
...
equation
  ...
  connect(chiWSE.port_a2, priPum.port_b)
    annotation(
      Line(
        points={{20, 24}, {32, 24}, {32, 0}, {32, 0}, {32, 0}, {32, 0}, {32, 0}, {32, 0}, {32, 0}, {32, 0}, {40, 0}, {40, 0}, {40, 0}, {40, 1.33227e-15}},
        color={0, 127, 255},
        thickness=0.5));
  ...
  connect(TCHWSup.T, chiStaCon.TCHWSup)
    annotation(
      Line(
        points={{-26, 11}, {-26, 12}, {-26, 12}, {-26, 18}, {-180, 18}, {-180, 134}, {-172, 134}},
        color={0, 0, 127}));
  ...
  connect(chiNumOn.y, priPumCon.numOnChi)
    annotation(
      Line(
        points={{-236.9, 65}, {-188, 65}, {-188, 25}, {-174, 25}},
        color={255, 127, 0}));
  connect(cooModCon.y, cooTowSpeCon.cooMod)
    annotation(
      Line(
        points={{-191, 110}, {-186, 110}, {-186, 182.444}, {-172, 182.444}},
        color={255, 127, 0}));
  annotation(
    Diagram(
      coordinateSystem(
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Applications/DataCenters/ChillerCooled/Examples/NonIntegratedPrimarySecondaryEconomizer.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
