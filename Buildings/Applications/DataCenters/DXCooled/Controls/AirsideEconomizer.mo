...
equation
  ...
  connect(TMixAirMea, con.u_m)
    annotation(
      Line(
        points={{-120, 0}, {-70, 0}, {-70, 48}},
        color={0, 0, 127}));
  connect(switch1.y, y)
    annotation(
      Line(
        points={{61, 0}, {68, 0}, {110, 0}},
        color={0, 0, 127}));
  connect(ecoOff.y, switch1.u2)
    annotation(
      Line(
        points={{-19,-60}, {20,-60}, {20, 0}, {38, 0}},
        color={255, 0, 255}));
  connect(const.y, switch1.u1)
    annotation(
      Line(
        points={{21, 30}, {28, 30}, {28, 8}, {38, 8}},
        color={0, 0, 127}));
  connect(con.y, switch1.u3)
    annotation(
      Line(
        points={{-59, 60}, {-20, 60}, {-20,-8}, {38,-8}},
        color={0, 0, 127}));
  connect(ecoOff.u2, conInt.y)
    annotation(
      Line(
        points={{-42,-68}, {-50,-68}, {-50,-80}, {-59,-80}},
        color={255, 127, 0}));
