  ...
  Buildings.Applications.DataCenters.DXCooled.Controls.AirsideEconomizer con(
    ...
    annotation(
      Placement(
        transformation(
          extent={{10, 40}, {30, 60}})));
  Modelica.Blocks.Sources.Constant mixAirSetPoi(
    k=291.15)
  ...
  Buildings.Fluid.Sources.Boundary_pT roo(
    ...
    annotation(
      Placement(
        transformation(
          extent={{72,-72}, {52,-52}})));
  Modelica.Blocks.Sources.CombiTimeTable outAir(
    table=[
      0, 273.15 + 5;
      120, 273.15 + 5;
      120, 273.15 + 20;
...
equation
  ...
  connect(eco.port_Exh, OA.ports[2])
    annotation(
      Line(
        points={{-20,-44}, {-24,-44}, {-24,-36}, {-30,-36}},
        color={0, 127, 255}));
  ...
  connect(senTemMixAir.T, con.TMixAirMea)
    annotation(
      Line(
        points={{20,-21}, {20, 8}, {-12, 8}, {-12, 50}, {8, 50}},
        color={0, 0, 127}));
  connect(con.y, eco.y)
    annotation(
      Line(
        points={{31, 50}, {40, 50}, {40,-12}, {-10,-12}, {-10,-26}},
        color={0, 0, 127}));
  connect(eco.port_Ret, roo.ports[1])
    annotation(
      Line(
        points={{0,-44}, {4,-44}, {4,-62}, {52,-62}},
        color={0, 127, 255}));
  ...
  annotation(
    __Dymola_Commands(
      file="Resources/Scripts/Dymola/Applications/DataCenters/DXCooled/Controls/Validation/AirsideEconomizer.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<P>
