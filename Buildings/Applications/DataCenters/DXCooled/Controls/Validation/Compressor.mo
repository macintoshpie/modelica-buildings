...
model Compressor
  ...
  Modelica.Blocks.Sources.Sine TSupMea(amplitude=2, freqHz=1/120, offset=291.15)
...
equation
  connect(TSupSet.y, dxSpeCon.TMixAirSet)
    annotation(Line(points={{-39, 70}, {10, 70}, {10, 6}, {18, 6}}, color={0, 0, 127}));
  ...
  connect(reaToInt.y, dxSpeCon.cooMod)
    annotation(Line(points={{1,-40}, {10,-40}, {10,-7}, {18,-7}}, color={255, 127, 0}));
  annotation(__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Applications/DataCenters/DXCooled/Controls/Validation/Compressor.mos"
