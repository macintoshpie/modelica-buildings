  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus
    ...
    annotation(
      Placement(
        ...
        iconTransformation(
          extent={{0, 0}, {2, 2}})));
  Buildings.BoundaryConditions.SkyTemperature.BlackBody TBlaSkyIrr(
...
First implementation.
    ...
    experiment(
      ...
      StopTime=86400),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/BoundaryConditions/SkyTemperature/Examples/BlackBody.mos"
        "Simulate and plot"));
end BlackBody;
