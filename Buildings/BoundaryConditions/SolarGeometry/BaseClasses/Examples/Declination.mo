...
model Declination
  ...
  Modelica.Blocks.Sources.TimeTable solDecNOAA(table=[
    ...
    28857600,-0.3817216;
    28944000,-0.3843185;
    31536000,-0.4010977], y(unit="rad"))
    "Solar declination according to NOAA"
    annotation(Placement(transformation(extent={{-20,-40}, {0,-20}})));
equation
  connect(modTim.y, decAng.nDay)
...
</html>"), experiment(Tolerance=1e-6, StopTime=3.1536e+007), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/BoundaryConditions/SolarGeometry/BaseClasses/Examples/Declination.mos"
    "Simulate and plot"));
end Declination;
