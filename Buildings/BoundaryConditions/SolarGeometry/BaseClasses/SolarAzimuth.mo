...
block SolarAzimuth
  ...
  Modelica.Blocks.Interfaces.RealInput solTim(
    quantity="Time",
    unit="s")
    "Solar time"
    annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput decAng(
    quantity="Angle",
    unit="rad")
    "Declination angle"
    annotation(
...
First implementation.
    ...
    Icon(
      ...
      graphics={Bitmap(
        extent={{-90,-90}, {90, 90}},
        fileName="modelica://Buildings/Resources/Images/BoundaryConditions/SolarGeometry/BaseClasses/SolarAzimuth.png"), Text(
