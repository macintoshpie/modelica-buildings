...
equation
  connect(zen.zen, y)
    annotation(
      Line(
        points={{21, 0}, {88.25, 0}, {88.25, 0}, {95.5, 0}, {95.5, 0}, {110, 0}},
        color={0, 0, 127}));
...
First implementation.
    ...
    Icon(
      ...
      graphics={Text(
        ...
        textString="%name",
        lineColor={0, 0, 255}), Bitmap(
        extent={{-90,-90}, {90, 90}},
        fileName="modelica://Buildings/Resources/Images/BoundaryConditions/SolarGeometry/BaseClasses/ZenithAngle.png")}));
end ZenithAngle;
