...
equation
  connect(datRea.y[4], chePre.PIn)
    annotation(Line(points={{1, 10}, {10, 10}, {10, 10}, {18, 10}}, color={0, 0, 127}));
...
</html>"), experiment(Tolerance=1e-6, StartTime=0, StopTime=8640000), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/CheckPressure.mos"
    "Simulate and plot"));
end CheckPressure;
