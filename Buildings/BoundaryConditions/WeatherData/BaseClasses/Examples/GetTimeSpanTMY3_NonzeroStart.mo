...
model GetTimeSpanTMY3_NonzeroStart
  ...
  extends Buildings.BoundaryConditions.WeatherData.BaseClasses.Examples.GetTimeSpanTMY3(
    filNam=Modelica.Utilities.Files.loadResource("modelica://Buildings/Resources/Data/BoundaryConditions/WeatherData/Validation/DecemberToJanuary.mos"),
    staTim=30992400,
    endTim=31863600);
  annotation(
    Documentation(
...
First implementation.
    ...
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/GetTimeSpanTMY3_NonzeroStart.mos"
        "Simulate and plot"));
