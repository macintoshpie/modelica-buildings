...
equation
  connect(datRea.y[20], limCeiHei.u)
    annotation(Line(points={{21,-10}, {30,-10}, {30,-10}, {38,-10}}, color={0, 0, 127}));
...
</html>"), experiment(Tolerance=1e-6, StartTime=0, StopTime=8640000), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/LimitMin.mos"
    "Simulate and plot"));
end LimitMin;
