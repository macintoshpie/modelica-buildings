...
model SolarTime
  ...
  Buildings.BoundaryConditions.WeatherData.BaseClasses.LocalCivilTime locTim(timZon=-21600, lon=-1.7039261675061)
...
equation
  connect(modTim.y, locTim.cloTim)
    annotation(Line(points={{-39,-10}, {-30,-10}, {-30,-30}, {-22,-30}}, color={0, 0, 127}));
  connect(locTim.locTim, solTim.locTim)
    annotation(Line(points={{1,-30}, {8,-30}, {8,-15.4}, {18,-15.4}}, color={0, 0, 127}));
  connect(modTim.y, eqnTim.nDay)
    annotation(Line(points={{-39,-10}, {-30,-10}, {-30, 10}, {-22, 10}}, color={0, 0, 127}));
  connect(eqnTim.eqnTim, solTim.equTim)
    annotation(Line(points={{1, 10}, {8, 10}, {8,-4}, {18,-4}}, color={0, 0, 127}));
...
</html>"), experiment(Tolerance=1e-6, StopTime=864000), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/BaseClasses/Examples/SolarTime.mos"
    "Simulate and plot"));
end SolarTime;
