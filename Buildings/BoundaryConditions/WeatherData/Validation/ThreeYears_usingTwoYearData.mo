...
model ThreeYears_usingTwoYearData
  ...
  Buildings.BoundaryConditions.WeatherData.ReaderTMY3 weaDat(
    ...
    filNam=Modelica.Utilities.Files.loadResource("modelica://Buildings/Resources/Data/BoundaryConditions/WeatherData/Validation/TwoYears_DataOnceAMonth_TMY3.mos"))
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-006),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/Validation/ThreeYears_usingTwoYearData.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
