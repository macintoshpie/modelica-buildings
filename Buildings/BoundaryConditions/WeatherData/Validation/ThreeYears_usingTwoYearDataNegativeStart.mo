...
model ThreeYears_usingTwoYearDataNegativeStart
  ...
  annotation(experiment(StartTime=-47174400, StopTime=47433600, Tolerance=1e-006), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/BoundaryConditions/WeatherData/Validation/ThreeYears_usingTwoYearDataNegativeStart.mos"
