...
protected
  ...
  equation
    ...
    connect(TBou.port, theCon.port_a)
      annotation(
        Line(
          points={{-60,-40}, {-60,-40}, {-50,-40}},
          color={191, 0, 0}));
    connect(cap.port, theCon1.port_a)
      annotation(
        Line(
          points={{-28, 0}, {-28, 0}, {-10, 0}},
          color={191, 0, 0}));
    ...
    connect(cap1.port, temSen.port)
      annotation(
        Line(
          points={{30, 0}, {30, 0}, {50, 0}},
          color={191, 0, 0}));
    connect(theCon.port_b, cap.port)
      annotation(
        Line(
          points={{-30,-40}, {-30,-40}, {-20,-40}, {-20, 0}, {-28, 0}},
          color={191, 0, 0}));
...
First implementation.
    ...
    Modelica.Blocks.Math.Gain gain(
      ...
      annotation(
        Placement(
          transformation(
            extent={{30,-10}, {50, 10}})));
    Modelica.Blocks.Logical.GreaterThreshold trigger(
      threshold=303.15)
  ...
  equation
    connect(conPID.y, gain.u)
      annotation(
        Line(
          points={{11, 0}, {11, 0}, {28, 0}},
          color={0, 0, 127}));
    connect(trigger.y, conPID.trigger)
      annotation(
        Line(
          points={{-19,-30}, {-8,-30}, {-8,-12}},
          color={255, 0, 255}));
    ...
    connect(conPID.u_s, TSet)
      annotation(
        Line(
          points={{-12, 0}, {-70, 0}, {-120, 0}},
          color={0, 0, 127}));
    connect(trigger.u, TSet)
      annotation(
        Line(
          points={{-42,-30}, {-70,-30}, {-70, 0}, {-120, 0}},
          color={0, 0, 127}));
    connect(gain.y, y)
      annotation(
        Line(
          points={{51, 0}, {100, 0}, {110, 0}},
          color={0, 0, 127}));
    annotation(
      Documentation(
        info="<html>
...
equation
  connect(plaWitRes.T, conWitRes.u_m)
    annotation(
      Line(
        points={{41, 50}, {60, 50}, {60, 20}, {-30, 20}, {-30, 39}},
        color={0, 0, 127}));
  ...
  connect(plaNoRes.T, conNoRes.u_m)
    annotation(
      Line(
        points={{41,-10}, {60,-10}, {60,-40}, {-30,-40}, {-30,-21}},
        color={0, 0, 127}));
  ...
  connect(TSet.y, conWitRes.TSet)
    annotation(
      Line(
        points={{-59, 0}, {-50, 0}, {-50, 50}, {-42, 50}},
        color={0, 0, 127}));
  connect(TSet.y, conNoRes.TSet)
    annotation(
      Line(
        points={{-59, 0}, {-50, 0}, {-50,-10}, {-42,-10}},
        color={0, 0, 127}));
  annotation(
    experiment(
      Tolerance=1e-06,
      StopTime=600),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/Continuous/Examples/LimPIDWithReset.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
