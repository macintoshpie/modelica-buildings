...
equation
  connect(u_m, con.u_m)
    annotation(
      Line(
        points={{-1.11022e-15,-120}, {-1.11022e-15,-105.5}, {-6.66131e-16,-105.5}, {-6.66131e-16,-91}, {4.44089e-16,-91}, {4.44089e-16,-62}},
        color={0, 0, 127}));
  ...
  connect(and3.y, switch2.u2)
    annotation(
      Line(
        points={{81, 6.10623e-16}, {90, 6.10623e-16}, {90,-20}, {52,-20}, {52,-40}, {60,-40}},
        color={255, 0, 255}));
  ...
  connect(and3.y, onTimer.u)
    annotation(
      Line(
        points={{81, 6.10623e-16}, {90, 6.10623e-16}, {90, 60}, {-40, 60}, {-40, 80}, {-22, 80}},
        color={255, 0, 255}));
  connect(and3.y, not1.u)
    annotation(
      Line(
        points={{81, 6.10623e-16}, {90, 6.10623e-16}, {90, 60}, {-40, 60}, {-40, 40}, {-22, 40}},
        color={255, 0, 255}));
  ...
  connect(and3.y, switch1.u2)
    annotation(
      Line(
        points={{81, 6.10623e-16}, {90, 6.10623e-16}, {90,-20}, {-60,-20}, {-60,-50}, {-42,-50}},
        color={255, 0, 255}));
  ...
  connect(u_m, switch1.u3)
    annotation(
      Line(
        points={{-1.11022e-15,-120}, {-1.11022e-15,-90}, {-80,-90}, {-80,-58}, {-42,-58}},
        color={0, 0, 127}));
  ...
  connect(u_s, feeBac.u1)
    annotation(
      Line(
        points={{-120, 1.11022e-15}, {-112, 1.11022e-15}, {-112, 1.77635e-15}, {-104, 1.77635e-15}, {-104, 6.66134e-16}, {-88, 6.66134e-16}},
        color={0, 0, 127}));
  ...
  connect(feeBac.y, hys.u)
    annotation(
      Line(
        points={{-71, 6.10623e-16}, {-68.75, 6.10623e-16}, {-68.75, 1.27676e-15}, {-66.5, 1.27676e-15}, {-66.5, 6.66134e-16}, {-62, 6.66134e-16}},
        color={0, 0, 127}));
  ...
  annotation(
    Icon(
      graphics={Polygon(
        ...
        points={{-80, 84}, {-80,-84}},
        color={192, 192, 192}), Line(
        points={{-80,-76}, {-48,-76}, {-48, 30}, {2, 40}, {54,-42}, {54,-76}, {64,-76}},
        color={0, 0, 127})}),
