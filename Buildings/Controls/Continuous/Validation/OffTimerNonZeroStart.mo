...
model OffTimerNonZeroStart
  ...
  extends Buildings.Controls.Continuous.Examples.OffTimer(booleanPulse(startTime=-1));
  annotation(experiment(Tolerance=1e-6, StartTime=-1, StopTime=0), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/Continuous/Validation/OffTimerNonZeroStart.mos"
