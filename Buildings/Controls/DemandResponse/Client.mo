...
model Client
  ...
  Modelica.Blocks.Interfaces.BooleanInput isEventDay
    ...
    annotation(
      Placement(
        ...
        iconTransformation(
          extent={{-120, 50}, {-100, 30}})));
  Modelica.Blocks.Interfaces.RealInput ECon(
    unit="J")
  ...
  Modelica.Blocks.Interfaces.BooleanInput shed
    ...
    annotation(
      Placement(
        ...
        iconTransformation(
          extent={{-120,-40}, {-100,-20}})));
  Modelica.Blocks.Interfaces.RealInput yShed(
    min=-1,
    max=1,
    unit="1")
  ...
  Modelica.Blocks.Interfaces.RealInput TOut(
    unit="K",
    displayUnit="degC") if(predictionModel == Buildings.Controls.Predictors.Types.PredictionModel.WeatherRegression)
  ...
  Modelica.Blocks.Interfaces.RealInput TOutFut[nPre-1](
    each unit="K") if(predictionModel == Buildings.Controls.Predictors.Types.PredictionModel.WeatherRegression)
    ...
    annotation(
      Placement(
        ...
        iconTransformation(
          extent={{-120,-100}, {-100,-80}})));
  Modelica.Blocks.Interfaces.RealOutput PPre(
    unit="W")
    ...
    annotation(
      Placement(
        transformation(
          ...
          rotation=90,
          origin={60, 20})));
  BaseClasses.NormalOperation norOpe(
    nOut=2)
    "Normal operation"
    annotation(
      Placement(
    ...
    annotation(
      Placement(
        transformation(
          ...
          rotation=270,
          origin={-40, 10})));
  Modelica.Blocks.Sources.SampleTrigger tri(
    period=tSample)
    "Sample trigger"
    annotation(
      Placement(
