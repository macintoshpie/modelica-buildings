...
block Controller
  ...
  Buildings.Controls.OBC.CDL.Interfaces.IntegerInput uFreProSta if use_G36FrePro
    ...
    annotation(
      Placement(
        transformation(
          extent={{-200,-170}, {-160,-130}})));
  Buildings.Controls.OBC.CDL.Interfaces.IntegerInput uOpeMod
    "AHU operation mode status signal"
    annotation(
      Placement(
        transformation(
          extent={{-200,-130}, {-160,-90}})));
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZone.VAV.Economizers.Subsequences.Limits damLim(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-80, 0}, {-60, 20}})));
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZone.VAV.Economizers.Subsequences.Modulation mod(
    final uRetDamMin=uRetDamMin,
    final uMin=uHeaMax,
    final uMax=uCooMin,
...
equation
  ...
  connect(outDamMaxFre.u2, noTMix1.y)
    annotation(
      Line(
        points={{118,-46}, {102,-46}},
        color={0, 0, 127}));
  connect(mod.yRetDamPos, retDamMinFre.u2)
    annotation(
      Line(
        points={{62, 16}, {110, 16}, {110, 34}, {118, 34}},
        color={0, 0, 127}));
  ...
  connect(TMix, freProTMix.TMix)
    annotation(
      Line(
        points={{-180,-50}, {-120,-50}, {-120,-60}, {60,-60}, {60,-10}, {78,-10}},
        color={0, 0, 127}));
  connect(freProTMix.yFrePro, retDamMinFre.u1)
    annotation(
      Line(
        points={{102,-13}, {104,-13}, {104, 46}, {118, 46}},
        color={0, 0, 127}));
  connect(freProTMix.yFreProInv, outDamMaxFre.u2)
    annotation(
      Line(
        points={{102,-7}, {104,-7}, {104,-46}, {118,-46}},
        color={0, 0, 127}));
  connect(freProSta.y, damLim.uFreProSta)
    annotation(
      Line(
        points={{-118,-130}, {-90,-130}, {-90, 6}, {-82, 6}},
        color={255, 127, 0}));
  connect(freProSta.y, enaDis.uFreProSta)
    annotation(
      Line(
        points={{-118,-130}, {-60,-130}, {-60,-30}, {-2,-30}},
        color={255, 127, 0}));
  annotation(
