...
protected
  ...
  Buildings.Controls.OBC.CDL.Integers.LessEqual intLesEqu
    ...
    annotation(
      Placement(
        transformation(
          extent={{-120,-150}, {-100,-130}})));
  Buildings.Controls.OBC.CDL.Integers.Equal intEqu
    "Check if operation mode is occupied"
    annotation(
      Placement(
        transformation(
          extent={{-120,-190}, {-100,-170}})));
...
equation
  ...
  connect(retDamPosMinSwitch.y, yRetDamPosMin)
    annotation(
      Line(
        points={{62,-20}, {100,-20}, {100, 0}, {200, 0}},
        color={0, 0, 127}));
  connect(retDamPhyPosMaxSig.y, yRetDamPhyPosMax)
    annotation(
      Line(
        points={{-138,-40}, {40,-40}, {40,-90}, {200,-90}},
        color={0, 0, 127}));
  connect(uOpeMod, intEqu.u1)
    annotation(
      Line(
        points={{-200,-180}, {-122,-180}},
        color={255, 127, 0}));
  connect(conInt1.y, intEqu.u2)
    annotation(
      Line(
        points={{-138,-200}, {-130,-200}, {-130,-188}, {-122,-188}},
        color={255, 127, 0}));
  connect(conInt.y, intLesEqu.u2)
    annotation(
      Line(
        points={{-138,-160}, {-130,-160}, {-130,-148}, {-122,-148}},
        color={255, 127, 0}));
  connect(uFreProSta, intLesEqu.u1)
    annotation(
      Line(
        points={{-200,-140}, {-122,-140}},
        color={255, 127, 0}));
  connect(damLimCon.trigger, uSupFan)
    annotation(
      Line(
        points={{-138, 178}, {-138, 166}, {-100, 166}, {-100,-100}, {-200,-100}},
        color={255, 0, 255}));
  connect(uSupFan, and2.u1)
    annotation(
      Line(
        points={{-200,-100}, {-140,-100}, {-140,-100}, {-82,-100}},
        color={255, 0, 255}));
  connect(intLesEqu.y, and2.u2)
    annotation(
      Line(
        points={{-98,-140}, {-90,-140}, {-90,-108}, {-82,-108}},
        color={255, 0, 255}));
  connect(and2.y, and3.u1)
    annotation(
      Line(
        points={{-58,-100}, {-42,-100}},
        color={255, 0, 255}));
  connect(and3.y, not1.u)
    annotation(
      Line(
        points={{-18,-100}, {-10,-100}},
        color={255, 0, 255}));
  connect(intEqu.y, and3.u2)
    annotation(
      Line(
        points={{-98,-180}, {-50,-180}, {-50,-108}, {-42,-108}},
        color={255, 0, 255}));
  annotation(
