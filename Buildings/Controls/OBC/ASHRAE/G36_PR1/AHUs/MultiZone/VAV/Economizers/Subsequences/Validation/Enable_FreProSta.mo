...
model Enable_FreProSta
  ...
  Buildings.Controls.OBC.CDL.Conversions.BooleanToInteger freProSta1(integerTrue=Buildings.Controls.OBC.ASHRAE.G36_PR1.Types.FreezeProtectionStages.stage0, integerFalse=Buildings.Controls.OBC.ASHRAE.G36_PR1.Types.FreezeProtectionStages.stage1)
...
equation
  ...
  connect(hOutBelowCutoff.y, enaDis.hOut)
    annotation(Line(points={{-118, 90}, {-100, 90}, {-100, 60}, {-30, 60}, {-30,-24}, {58,-24}}, color={0, 0, 127}));
  ...
  connect(outDamPosMin.y, enaDis.uOutDamPosMin)
    annotation(Line(points={{-118,-140}, {-30,-140}, {-30,-34}, {58,-34}}, color={0, 0, 127}));
  ...
  connect(retDamPosMax.y, enaDis.uRetDamPosMax)
    annotation(Line(points={{-88,-50}, {-60,-50}, {-60,-38}, {58,-38}}, color={0, 0, 127}));
  ...
  connect(booPul1.y, freProSta1.u)
    annotation(Line(points={{2,-150}, {4,-150}, {4,-150}, {8,-150}, {8,-150}, {18,-150}}, color={255, 0, 255}));
  connect(freProSta1.y, enaDis.uFreProSta)
    annotation(Line(points={{42,-150}, {50,-150}, {50,-120}, {-20,-120}, {-20,-30}, {58,-30}}, color={255, 127, 0}));
  annotation(experiment(StopTime=1800.0, Tolerance=1e-06), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_PR1/AHUs/MultiZone/VAV/Economizers/Subsequences/Validation/Enable_FreProSta.mos"
    "Simulate and plot"), Icon(graphics={Ellipse(lineColor={75, 138, 73}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid, extent={{-100,-100}, {100, 100}}), Polygon(lineColor={0, 0, 255}, fillColor={75, 138, 73}, pattern=LinePattern.None, fillPattern=FillPattern.Solid, points={{-36, 58}, {64,-2}, {-36,-62}, {-36, 58}})}), Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-180,-180}, {180, 180}}), graphics={Text(extent={{58,-38}, {176,-64}}, lineColor={0, 0, 0}, horizontalAlignment=TextAlignment.Left, textString="Tests freeze protection disable condition")}), Documentation(info="<html>
<p>
