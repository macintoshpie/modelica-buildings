...
model Enable_TOut_hOut
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZone.VAV.Economizers.Subsequences.Enable enaDis1
    "Multi zone VAV AHU economizer enable disable sequence"
    annotation(Placement(transformation(extent={{80,-40}, {100,-20}})));
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZone.VAV.Economizers.Subsequences.Enable enaDis2(final use_enthalpy=false)
    "Multi zone VAV AHU economizer enable disable sequence"
...
protected
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant retDamPosMax(final k=0.8)
    "Maximal allowed economizer damper position"
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant retDamPhyPosMax(final k=1)
    "Maximal allowed economizer damper position"
...
equation
  ...
  connect(hOutCut.y, enaDis.hOutCut)
    annotation(Line(points={{-218, 90}, {-186, 90}, {-186, 58}, {-138, 58}, {-138,-26}, {-82,-26}}, color={0, 0, 127}));
  ...
  connect(outDamPosMin.y, enaDis.uOutDamPosMin)
    annotation(Line(points={{-218,-110}, {-210,-110}, {-210,-60}, {-140,-60}, {-140,-34}, {-82,-34}}, color={0, 0, 127}));
  ...
  connect(hOutBelowCutoff.y, enaDis.hOut)
    annotation(Line(points={{-218, 128}, {-180, 128}, {-180, 66}, {-130, 66}, {-130,-24}, {-82,-24}}, color={0, 0, 127}));
  ...
  connect(outDamPosMin.y, enaDis1.uOutDamPosMin)
    annotation(Line(points={{-218,-110}, {-190,-110}, {-190,-64}, {12,-64}, {12,-34}, {78,-34}}, color={0, 0, 127}));
  ...
  connect(TOutCut.y, enaDis2.TOutCut)
    annotation(Line(points={{-138, 90}, {-120, 90}, {-120, 120}, {188, 120}, {188,-22}, {218,-22}}, color={0, 0, 127}));
  ...
  connect(outDamPosMin.y, enaDis2.uOutDamPosMin)
    annotation(Line(points={{-218,-110}, {-180,-110}, {-180,-70}, {188,-70}, {188,-34}, {218,-34}}, color={0, 0, 127}));
  ...
  connect(supFanSta.y, enaDis.uSupFan)
    annotation(Line(points={{-178,-32}, {-160,-32}, {-160,-28}, {-80,-28}, {-80,-28}, {-82,-28}}, color={255, 0, 255}));
  connect(supFanSta.y, enaDis1.uSupFan)
    annotation(Line(points={{-178,-32}, {-160,-32}, {-160,-12}, {-20,-12}, {-20,-28}, {78,-28}}, color={255, 0, 255}));
  connect(supFanSta.y, enaDis2.uSupFan)
    annotation(Line(points={{-178,-32}, {-160,-32}, {-160,-12}, {140,-12}, {140,-28}, {218,-28}}, color={255, 0, 255}));
  annotation(experiment(StopTime=1800.0, Tolerance=1e-06), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_PR1/AHUs/MultiZone/VAV/Economizers/Subsequences/Validation/Enable_TOut_hOut.mos"
    "Simulate and plot"), Icon(graphics={Ellipse(lineColor={75, 138, 73}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid, extent={{-100,-100}, {100, 100}}), Polygon(lineColor={0, 0, 255}, fillColor={75, 138, 73}, pattern=LinePattern.None, fillPattern=FillPattern.Solid, points={{-36, 58}, {64,-2}, {-36,-62}, {-36, 58}})}), Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-260,-220}, {260, 220}}), graphics={Text(extent={{-50, 214}, {530, 162}}, lineColor={0, 0, 0}, horizontalAlignment=TextAlignment.Left, textString="Example high limit cutoff conditions:
                      ASHRAE 90.1-2013:
                      Device Type: Fixed Enthalpy + Fixed Drybulb, Fixed Drybulb
                      TOut > 75 degF [24 degC]
                      hOut > 28 Btu/lb [65.1 kJ/kg]"), Text(extent={{-82,-40}, {14,-66}}, lineColor={0, 0, 0}, horizontalAlignment=TextAlignment.Left, textString="Tests temperature hysteresis"), Text(extent={{80,-40}, {166,-66}}, lineColor={0, 0, 0}, horizontalAlignment=TextAlignment.Left, textString="Tests enthalpy hysteresis"), Text(extent={{204,-46}, {272,-68}}, lineColor={0, 0, 0}, horizontalAlignment=TextAlignment.Left, textString="No enthalpy
