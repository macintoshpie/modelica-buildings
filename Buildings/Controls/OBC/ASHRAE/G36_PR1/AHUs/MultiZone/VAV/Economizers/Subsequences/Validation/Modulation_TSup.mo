...
model Modulation_TSup
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Ramp uTSup(final duration=900, final height=2, final offset=-1)
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZone.VAV.Economizers.Subsequences.Modulation modFre
...
equation
  ...
  connect(outDamPosMax.y, mod.uOutDamPosMax)
    annotation(Line(points={{-58, 26}, {-10, 26}, {-10, 25}, {38, 25}}, color={0, 0, 127}));
  ...
  annotation(experiment(StopTime=900.0, Tolerance=1e-06), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_PR1/AHUs/MultiZone/VAV/Economizers/Subsequences/Validation/Modulation_TSup.mos"
