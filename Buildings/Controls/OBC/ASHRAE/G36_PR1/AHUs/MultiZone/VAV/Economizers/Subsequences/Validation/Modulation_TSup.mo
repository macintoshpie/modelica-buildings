  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZone.VAV.Economizers.Subsequences.Modulation modFre
    ...
    annotation(
      Placement(
        transformation(
          extent={{40,-40}, {60,-20}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant outDamPosMaxFre(
    final k=0)
    ...
    annotation(
      Placement(
        transformation(
          extent={{0,-80}, {20,-60}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant retDamPosMinFre(
    final k=1)
...
equation
  ...
  connect(outDamPosMaxFre.y, modFre.uOutDamPosMax)
    annotation(
      Line(
        points={{22,-70}, {30,-70}, {30,-35}, {38,-35}},
        color={0, 0, 127}));
  connect(retDamPosMinFre.y, modFre.uRetDamPosMin)
    annotation(
      Line(
        points={{26, 0}, {32, 0}, {32,-25}, {38,-25}},
        color={0, 0, 127}));
  annotation(
    experiment(
      StopTime=900.0,
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_PR1/AHUs/MultiZone/VAV/Economizers/Subsequences/Validation/Modulation_TSup.mos"
        "Simulate and plot"),
    Icon(
      graphics={Ellipse(
        lineColor={75, 138, 73},
