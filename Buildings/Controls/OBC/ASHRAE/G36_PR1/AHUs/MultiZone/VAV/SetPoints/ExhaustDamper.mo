...
block ExhaustDamper
  ...
  parameter Real k(
    ...
    annotation(
      Dialog(
        group="Exhaust damper P-control parameter"));
...
equation
  ...
  connect(zerDam.y, swi.u3)
    annotation(
      Line(
        points={{-38,-60}, {20,-60}, {20,-38}, {38,-38}},
        color={0, 0, 127}));
  connect(swi.y, yExhDamPos)
    annotation(
      Line(
        points={{62,-30}, {72,-30}, {72, 0}, {100, 0}},
        color={0, 0, 127}));
  ...
  connect(dpBuiSetPoi1.y, conErr.u2)
    annotation(
      Line(
        points={{-38, 20}, {-20, 20}, {-20, 48}},
        color={0, 0, 127}));
  connect(zer1.y, conP.u_m)
    annotation(
      Line(
        points={{22, 20}, {50, 20}, {50, 48}},
        color={0, 0, 127}));
  connect(conP.y, swi.u1)
    annotation(
      Line(
        points={{62, 60}, {66, 60}, {66, 0}, {20, 0}, {20,-22}, {38,-22}},
        color={0, 0, 127}));
  annotation(
    ...
    Icon(
      graphics={Rectangle(
        ...
        fillColor={192, 192, 192},
        fillPattern=FillPattern.Solid), Line(
        points={{-80,-78}, {-80,-78}, {14, 62}, {80, 62}},
        color={0, 0, 127}), Text(
