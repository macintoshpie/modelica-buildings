...
equation
  connect(peaSysPopulation.y, occDivFra.u1)
    annotation(
      Line(
        points={{-158, 220}, {-140, 220}, {-140, 196}, {-122, 196}},
        color={0, 0, 127}));
  connect(pro.y, unCorOutAirInk.u1)
    annotation(
      Line(
        points={{-38, 170}, {-20, 170}, {-20, 156}, {-2, 156}},
        color={0, 0, 127}));
  connect(aveOutAirFra.y, addPar1.u)
    annotation(
      Line(
        points={{82, 130}, {118, 130}},
        color={0, 0, 127}));
  connect(unCorOutAirInk.y, desOutAirInt.u1)
    annotation(
      Line(
        points={{22, 150}, {40, 150}, {40, 86}, {58, 86}},
        color={0, 0, 127}));
  connect(sysUncOutAir.y, effMinOutAirInt.u1)
    annotation(
      Line(
        points={{-158, 10}, {-140, 10}, {-140, 26}, {98, 26}},
        color={0, 0, 127}));
  connect(sysUncOutAir.y, outAirFra.u1)
    annotation(
      Line(
        points={{-158, 10}, {-140, 10}, {-140,-4}, {-122,-4}},
        color={0, 0, 127}));
  connect(unCorOutAirInk.y, sysUncOutAir.u1)
    annotation(
      Line(
        points={{22, 150}, {40, 150}, {40, 50}, {-200, 50}, {-200, 16}, {-182, 16}},
        color={0, 0, 127}));
  connect(desOutAirInt.y, min.u1)
    annotation(
      Line(
        points={{82, 80}, {140, 80}, {140, 36}, {178, 36}},
        color={0, 0, 127}));
  connect(unCorOutAirInk.y, VDesUncOutAir_flow)
    annotation(
      Line(
        points={{22, 150}, {40, 150}, {40, 180}, {260, 180}},
        color={0, 0, 127}));
  ...
  connect(occDivFra.y, pro.u1)
    annotation(
      Line(
        points={{-98, 190}, {-80, 190}, {-80, 176}, {-62, 176}},
        color={0, 0, 127}));
  connect(uOpeMod, intEqu1.u1)
    annotation(
      Line(
        points={{-240,-180}, {-102,-180}},
        color={255, 127, 0}));
  connect(occMod.y, intEqu1.u2)
    annotation(
      Line(
        points={{-158,-220}, {-140,-220}, {-140,-188}, {-102,-188}},
        color={255, 127, 0}));
  connect(intEqu1.y, and1.u2)
    annotation(
      Line(
        points={{-78,-180}, {20,-180}, {20,-148}, {118,-148}},
        color={255, 0, 255}));
  connect(sysVenEff.y, swi4.u1)
    annotation(
      Line(
        points={{-18,-30}, {0,-30}, {0,-52}, {58,-52}},
        color={0, 0, 127}));
  connect(swi4.y, effMinOutAirInt.u2)
    annotation(
      Line(
        points={{82,-60}, {90,-60}, {90, 14}, {98, 14}},
        color={0, 0, 127}));
  ...
  connect(addPar.y, sysVenEff.u1)
    annotation(
      Line(
        points={{-58,-10}, {-50,-10}, {-50,-24}, {-42,-24}},
        color={0, 0, 127}));
  connect(conOne.y, swi4.u3)
    annotation(
      Line(
        points={{42,-70}, {50,-70}, {50,-68}, {58,-68}},
        color={0, 0, 127}));
  connect(VEffOutAir_flow, min.y)
    annotation(
      Line(
        points={{260, 30}, {202, 30}},
        color={0, 0, 127}));
  connect(effMinOutAirInt.y, min.u2)
    annotation(
      Line(
        points={{122, 20}, {160, 20}, {160, 24}, {178, 24}},
        color={0, 0, 127}));
  connect(norVOutMin.u1, min.y)
    annotation(
      Line(
        points={{178,-44}, {160,-44}, {160,-10}, {220,-10}, {220, 30}, {202, 30}},
        color={0, 0, 127}));
  connect(desOutAirInt.y, norVOutMin.u2)
    annotation(
      Line(
        points={{82, 80}, {140, 80}, {140,-56}, {178,-56}},
        color={0, 0, 127}));
  connect(norVOutMin.y, effOutAir_normalized)
    annotation(
      Line(
        points={{202,-50}, {260,-50}},
        color={0, 0, 127}));
  connect(uSupFan, and1.u1)
    annotation(
      Line(
        points={{-240,-140}, {118,-140}},
        color={255, 0, 255}));
  ...
  annotation(
    ...
    Icon(
      ...
      graphics={Rectangle(
        ...
        extent={{-98, 38}, {-34, 26}},
        lineColor={0, 0, 0},
        textString="desSysVenEff"), Text(
        extent={{-98, 18}, {-30, 4}},
        lineColor={0, 0, 0},
        textString="VUncOutAir_flow"), Text(
        extent={{-98,-2}, {-34,-18}},
        lineColor={0, 0, 0},
        textString="VSysPriAir_flow"), Text(
        extent={{-98,-22}, {-28,-38}},
        lineColor={0, 0, 0},
        ...
        extent={{34, 30}, {98, 12}},
        lineColor={0, 0, 0},
        textString="VDesOutAir_flow"), Text(
        extent={{38,-10}, {98,-26}},
        lineColor={0, 0, 0},
