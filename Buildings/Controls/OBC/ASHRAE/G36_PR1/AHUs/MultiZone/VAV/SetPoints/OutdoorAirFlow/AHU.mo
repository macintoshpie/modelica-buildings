...
block AHU
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput sumDesZonPop(final min=0, final unit="1")
    ...
    annotation(Placement(transformation(extent={{-260, 180}, {-220, 220}}), iconTransformation(extent={{-140, 70}, {-100, 110}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealInput VSumDesPopBreZon_flow(final min=0, final unit="m3/s", final quantity="VolumeFlowRate")
    ...
    annotation(Placement(transformation(extent={{-260, 140}, {-220, 180}}), iconTransformation(extent={{-140, 50}, {-100, 90}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealInput VSumDesAreBreZon_flow(final min=0, final unit="m3/s", final quantity="VolumeFlowRate")
    ...
    annotation(Placement(transformation(extent={{-260, 100}, {-220, 140}}), iconTransformation(extent={{-140, 30}, {-100, 70}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealInput uDesSysVenEff(final min=0, final unit="1")
    ...
    annotation(Placement(transformation(extent={{-260, 60}, {-220, 100}}), iconTransformation(extent={{-140, 10}, {-100, 50}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealInput VSumUncOutAir_flow(final min=0, final unit="m3/s", final quantity="VolumeFlowRate")
    ...
    annotation(Placement(transformation(extent={{-260,-44}, {-220,-4}}), iconTransformation(extent={{-140,-10}, {-100, 30}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealInput VSumSysPriAir_flow(final unit="m3/s", final quantity="VolumeFlowRate")
    "System primary airflow rate, equals to the sum of the measured discharged flow rate of all terminal units"
    annotation(Placement(transformation(extent={{-260,-80}, {-220,-40}}), iconTransformation(extent={{-140,-30}, {-100, 10}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealInput uOutAirFra_max(final min=0, final unit="1")
    ...
    annotation(Placement(transformation(extent={{-260,-120}, {-220,-80}}), iconTransformation(extent={{-140,-50}, {-100,-10}})));
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput uSupFan
    "Supply fan status, true if on, false if off"
    annotation(Placement(transformation(extent={{-260,-160}, {-220,-120}}), iconTransformation(extent={{-140,-90}, {-100,-50}})));
  Buildings.Controls.OBC.CDL.Interfaces.IntegerInput uOpeMod
    "AHU operation mode status signal"
    annotation(Placement(transformation(extent={{-260,-200}, {-220,-160}}), iconTransformation(extent={{-140,-110}, {-100,-70}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput VDesUncOutAir_flow(final min=0, final unit="m3/s", final quantity="VolumeFlowRate")
    ...
    annotation(Placement(transformation(extent={{240, 160}, {280, 200}}), iconTransformation(extent={{100, 60}, {140, 100}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput yAveOutAirFraPlu(final min=0, final unit="1")
    ...
    annotation(Placement(transformation(extent={{240, 110}, {280, 150}}), iconTransformation(extent={{100, 30}, {140, 70}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput VDesOutAir_flow(final min=0, final unit="m3/s", final quantity="VolumeFlowRate")
    "Design minimum outdoor airflow rate"
    annotation(Placement(transformation(extent={{240, 60}, {280, 100}}), iconTransformation(extent={{100, 0}, {140, 40}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput VEffOutAir_flow(final min=0, final unit="m3/s", final quantity="VolumeFlowRate")
    ...
    annotation(Placement(transformation(extent={{240, 10}, {280, 50}}), iconTransformation(extent={{100,-40}, {140, 0}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput effOutAir_normalized(final unit="1")
    "Effective minimum outdoor airflow setpoint, normalized by VDesOutMin_flow_nominal"
    annotation(Placement(transformation(extent={{240,-70}, {280,-30}}), iconTransformation(extent={{100,-70}, {140,-30}})));
  Buildings.Controls.OBC.CDL.Interfaces.BooleanOutput yReqOutAir
    ...
    annotation(Placement(transformation(extent={{240,-160}, {280,-120}}), iconTransformation(extent={{100,-100}, {140,-60}})));
protected
  ...
  Buildings.Controls.OBC.CDL.Continuous.Gain aveOutAirFra(final k=1/VPriSysMax_flow)
  ...
  Buildings.Controls.OBC.CDL.Integers.Sources.Constant occMod(final k=Buildings.Controls.OBC.ASHRAE.G36_PR1.Types.OperationModes.occupied)
    "Occupied mode index"
    annotation(Placement(transformation(extent={{-180,-230}, {-160,-210}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant peaSysPopulation(final k=peaSysPop)
    "Peak system population"
  ...
  Buildings.Controls.OBC.CDL.Continuous.Hysteresis hys1(final uLow=1E-4, final uHigh=1E-3)
...
equation
  connect(peaSysPopulation.y, occDivFra.u1)
    annotation(Line(points={{-158, 220}, {-140, 220}, {-140, 196}, {-122, 196}}, color={0, 0, 127}));
  connect(pro.y, unCorOutAirInk.u1)
    annotation(Line(points={{-38, 170}, {-20, 170}, {-20, 156}, {-2, 156}}, color={0, 0, 127}));
  ...
  connect(sysUncOutAir.y, effMinOutAirInt.u1)
    annotation(Line(points={{-158, 10}, {-140, 10}, {-140, 26}, {98, 26}}, color={0, 0, 127}));
  connect(sysUncOutAir.y, outAirFra.u1)
    annotation(Line(points={{-158, 10}, {-140, 10}, {-140,-4}, {-122,-4}}, color={0, 0, 127}));
  connect(unCorOutAirInk.y, sysUncOutAir.u1)
    annotation(Line(points={{22, 150}, {40, 150}, {40, 50}, {-200, 50}, {-200, 16}, {-182, 16}}, color={0, 0, 127}));
  connect(desOutAirInt.y, min.u1)
    annotation(Line(points={{82, 80}, {140, 80}, {140, 36}, {178, 36}}, color={0, 0, 127}));
  connect(unCorOutAirInk.y, VDesUncOutAir_flow)
    annotation(Line(points={{22, 150}, {40, 150}, {40, 180}, {260, 180}}, color={0, 0, 127}));
  connect(desOutAirInt.y, VDesOutAir_flow)
    annotation(Line(points={{82, 80}, {260, 80}}, color={0, 0, 127}));
  connect(occDivFra.y, pro.u1)
    annotation(Line(points={{-98, 190}, {-80, 190}, {-80, 176}, {-62, 176}}, color={0, 0, 127}));
  connect(uOpeMod, intEqu1.u1)
    annotation(Line(points={{-240,-180}, {-102,-180}}, color={255, 127, 0}));
  connect(occMod.y, intEqu1.u2)
    annotation(Line(points={{-158,-220}, {-140,-220}, {-140,-188}, {-102,-188}}, color={255, 127, 0}));
  connect(intEqu1.y, and1.u2)
    annotation(Line(points={{-78,-180}, {20,-180}, {20,-148}, {118,-148}}, color={255, 0, 255}));
  connect(sysVenEff.y, swi4.u1)
    annotation(Line(points={{-18,-30}, {0,-30}, {0,-52}, {58,-52}}, color={0, 0, 127}));
  connect(swi4.y, effMinOutAirInt.u2)
    annotation(Line(points={{82,-60}, {90,-60}, {90, 14}, {98, 14}}, color={0, 0, 127}));
  connect(outAirFra.y, addPar.u)
    annotation(Line(points={{-98,-10}, {-82,-10}}, color={0, 0, 127}));
  connect(addPar.y, sysVenEff.u1)
    annotation(Line(points={{-58,-10}, {-50,-10}, {-50,-24}, {-42,-24}}, color={0, 0, 127}));
  connect(conOne.y, swi4.u3)
    annotation(Line(points={{42,-70}, {50,-70}, {50,-68}, {58,-68}}, color={0, 0, 127}));
  connect(VEffOutAir_flow, min.y)
    annotation(Line(points={{260, 30}, {202, 30}}, color={0, 0, 127}));
  connect(effMinOutAirInt.y, min.u2)
    annotation(Line(points={{122, 20}, {160, 20}, {160, 24}, {178, 24}}, color={0, 0, 127}));
  connect(norVOutMin.u1, min.y)
    annotation(Line(points={{178,-44}, {160,-44}, {160,-10}, {220,-10}, {220, 30}, {202, 30}}, color={0, 0, 127}));
  connect(desOutAirInt.y, norVOutMin.u2)
    annotation(Line(points={{82, 80}, {140, 80}, {140,-56}, {178,-56}}, color={0, 0, 127}));
  connect(norVOutMin.y, effOutAir_normalized)
    annotation(Line(points={{202,-50}, {260,-50}}, color={0, 0, 127}));
  connect(uSupFan, and1.u1)
    annotation(Line(points={{-240,-140}, {118,-140}}, color={255, 0, 255}));
  connect(sysVenEff.y, hys1.u)
    annotation(Line(points={{-18,-30}, {20,-30}}, color={0, 0, 127}));
  connect(hys1.y, swi4.u2)
    annotation(Line(points={{44,-30}, {50,-30}, {50,-60}, {58,-60}}, color={255, 0, 255}));
  connect(addPar1.y, yAveOutAirFraPlu)
    annotation(Line(points={{142, 130}, {260, 130}}, color={0, 0, 127}));
  connect(occDivFra.u2, sumDesZonPop)
    annotation(Line(points={{-122, 184}, {-200, 184}, {-200, 200}, {-240, 200}}, color={0, 0, 127}));
  connect(pro.u2, VSumDesPopBreZon_flow)
    annotation(Line(points={{-62, 164}, {-200, 164}, {-200, 160}, {-240, 160}}, color={0, 0, 127}));
  connect(unCorOutAirInk.u2, VSumDesAreBreZon_flow)
    annotation(Line(points={{-2, 144}, {-200, 144}, {-200, 120}, {-240, 120}}, color={0, 0, 127}));
  connect(desOutAirInt.u2, uDesSysVenEff)
    annotation(Line(points={{58, 74}, {-80, 74}, {-80, 80}, {-240, 80}}, color={0, 0, 127}));
  connect(sysUncOutAir.u2, VSumUncOutAir_flow)
    annotation(Line(points={{-182, 4}, {-200, 4}, {-200,-24}, {-240,-24}}, color={0, 0, 127}));
  connect(outAirFra.u2, VSumSysPriAir_flow)
    annotation(Line(points={{-122,-16}, {-140,-16}, {-140,-60}, {-240,-60}}, color={0, 0, 127}));
  connect(sysVenEff.u2, uOutAirFra_max)
    annotation(Line(points={{-42,-36}, {-60,-36}, {-60,-100}, {-240,-100}}, color={0, 0, 127}));
  connect(and1.y, yReqOutAir)
    annotation(Line(points={{142,-140}, {260,-140}}, color={255, 0, 255}));
  connect(aveOutAirFra.u, unCorOutAirInk.y)
    annotation(Line(points={{58, 130}, {40, 130}, {40, 150}, {22, 150}}, color={0, 0, 127}));
  annotation(defaultComponentName="ahuOutAirSet", Icon(coordinateSystem(extent={{-100,-100}, {100, 100}}), graphics={Rectangle(extent={{-100, 100}, {100,-100}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Text(extent={{-100, 158}, {100, 118}}, lineColor={0, 0, 255}, textString="%name"), Text(extent={{-98, 98}, {-34, 86}}, lineColor={0, 0, 0}, textString="sumDesZonPop"), Text(extent={{-96,-62}, {-52,-76}}, lineColor={255, 0, 255}, textString="uSupFan"), Text(extent={{-96,-82}, {-50,-96}}, lineColor={255, 127, 0}, textString="uOpeMod"), Text(extent={{-98, 78}, {-12, 62}}, lineColor={0, 0, 0}, textString="VDesPopBreZon_flow"), Text(extent={{-98, 58}, {-12, 42}}, lineColor={0, 0, 0}, textString="VDesAreBreZon_flow"), Text(extent={{-98, 38}, {-34, 26}}, lineColor={0, 0, 0}, textString="desSysVenEff"), Text(extent={{-98, 18}, {-30, 4}}, lineColor={0, 0, 0}, textString="VUncOutAir_flow"), Text(extent={{-98,-2}, {-34,-18}}, lineColor={0, 0, 0}, textString="VSysPriAir_flow"), Text(extent={{-98,-22}, {-28,-38}}, lineColor={0, 0, 0}, textString="uOutAirFra_max"), Text(extent={{42,-74}, {102,-86}}, lineColor={255, 0, 255}, textString="yReqOutAir"), Text(extent={{20, 88}, {96, 72}}, lineColor={0, 0, 0}, textString="VDesUncOutAir_flow"), Text(extent={{30, 60}, {98, 44}}, lineColor={0, 0, 0}, textString="yAveOutAirFraPlu"), Text(extent={{34, 30}, {98, 12}}, lineColor={0, 0, 0}, textString="VDesOutAir_flow"), Text(extent={{38,-10}, {98,-26}}, lineColor={0, 0, 0}, textString="VEffOutAir_flow"), Text(extent={{18,-40}, {98,-56}}, lineColor={0, 0, 0}, textString="effOutAir_normalized")}), Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-220,-240}, {240, 240}})), Documentation(info="<html>
<p>
