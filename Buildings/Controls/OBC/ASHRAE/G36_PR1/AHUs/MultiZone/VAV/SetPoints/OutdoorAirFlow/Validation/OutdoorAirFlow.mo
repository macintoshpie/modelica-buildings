...
model OutdoorAirFlow
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZone.VAV.SetPoints.OutdoorAirFlow.AHU ahu1(
    VPriSysMax_flow=0.6,
    peaSysPop=12)
...
protected
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Ramp numOfOcc2(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-260, 170}, {-240, 190}})));
  Buildings.Controls.OBC.CDL.Conversions.RealToInteger reaToInt1
    "Convert real to integer"
    annotation(
      Placement(
        transformation(
          extent={{-220, 170}, {-200, 190}})));
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse winSta1(
    period=3600)
    "Status of windows"
    annotation(
      Placement(
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Ramp numOfOcc4(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-260,-90}, {-240,-70}})));
  Buildings.Controls.OBC.CDL.Conversions.RealToInteger reaToInt3
    "Convert real to integer"
    annotation(
      Placement(
        transformation(
          extent={{-220,-90}, {-200,-70}})));
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Ramp TDis(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-220, 110}, {-200, 130}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant zonPriFloRat(
    k=0.1)
    "Measured primary flow rate at VAV box"
    annotation(
      Placement(
        transformation(
          extent={{-260, 80}, {-240, 100}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant zonPriFloRat1(
    k=0.12)
    "Measured primary flow rate at VAV box"
    annotation(
      Placement(
...
equation
  ...
  connect(supFan.y, ahu1.uSupFan)
    annotation(
      Line(
        points={{162,-20}, {198,-20}, {198, 43}, {218, 43}},
        color={255, 0, 255}));
  connect(opeMod.y, ahu1.uOpeMod)
    annotation(
      Line(
        points={{162,-60}, {202,-60}, {202, 41}, {218, 41}},
        color={255, 127, 0}));
  connect(ahu1.yReqOutAir, zon1.uReqOutAir)
    annotation(
      Line(
        points={{242, 42}, {260, 42}, {260, 174}, {-160, 174}, {-160, 113}, {-122, 113}},
        color={255, 0, 255}));
  connect(ahu1.yReqOutAir, zon2.uReqOutAir)
    annotation(
      Line(
        points={{242, 42}, {260, 42}, {260, 174}, {-160, 174}, {-160, 3}, {-122, 3}},
        color={255, 0, 255}));
  connect(ahu1.yReqOutAir, zon3.uReqOutAir)
    annotation(
      Line(
        points={{242, 42}, {260, 42}, {260, 174}, {-160, 174}, {-160,-107}, {-122,-107}},
        color={255, 0, 255}));
  connect(numOfOcc2.y, reaToInt1.u)
    annotation(
      Line(
        points={{-238, 180}, {-222, 180}},
        color={0, 0, 127}));
  connect(numOfOcc3.y, reaToInt2.u)
    annotation(
      Line(
        points={{-238, 40}, {-222, 40}},
        color={0, 0, 127}));
  connect(reaToInt1.y, zon1.nOcc)
    annotation(
      Line(
        points={{-198, 180}, {-166, 180}, {-166, 119}, {-122, 119}},
        color={255, 127, 0}));
  connect(reaToInt2.y, zon2.nOcc)
    annotation(
      Line(
        points={{-198, 40}, {-180, 40}, {-180, 9}, {-122, 9}},
        color={255, 127, 0}));
  connect(numOfOcc4.y, reaToInt3.u)
    annotation(
      Line(
        points={{-238,-80}, {-222,-80}},
        color={0, 0, 127}));
  connect(reaToInt3.y, zon3.nOcc)
    annotation(
      Line(
        points={{-198,-80}, {-180,-80}, {-180,-101}, {-122,-101}},
        color={255, 127, 0}));
  connect(winSta1.y, zon3.uWin)
    annotation(
      Line(
        points={{-198,-130}, {-180,-130}, {-180,-104}, {-122,-104}},
        color={255, 0, 255}));
  connect(winSta.y, zon2.uWin)
    annotation(
      Line(
        points={{-198, 0}, {-180, 0}, {-180, 6}, {-122, 6}},
        color={255, 0, 255}));
  connect(TZon.y, zon1.TZon)
    annotation(
      Line(
        points={{-238, 140}, {-174, 140}, {-174, 110}, {-122, 110}},
        color={0, 0, 127}));
  connect(TZon.y, zon2.TZon)
    annotation(
      Line(
        points={{-238, 140}, {-174, 140}, {-174, 0}, {-122, 0}},
        color={0, 0, 127}));
  ...
  connect(TDis.y, zon1.TDis)
    annotation(
      Line(
        points={{-198, 120}, {-170, 120}, {-170, 107}, {-122, 107}},
        color={0, 0, 127}));
  connect(TDis.y, zon2.TDis)
    annotation(
      Line(
        points={{-198, 120}, {-170, 120}, {-170,-3}, {-122,-3}},
        color={0, 0, 127}));
  connect(TDis.y, zon3.TDis)
    annotation(
      Line(
        points={{-198, 120}, {-170, 120}, {-170,-113}, {-122,-113}},
        color={0, 0, 127}));
  connect(zonPriFloRat2.y, zon3.VDis_flow)
    annotation(
      Line(
        points={{-238,-160}, {-166,-160}, {-166,-116}, {-122,-116}},
        color={0, 0, 127}));
  connect(zonPriFloRat1.y, zon2.VDis_flow)
    annotation(
      Line(
        points={{-238,-30}, {-166,-30}, {-166,-6}, {-122,-6}},
        color={0, 0, 127}));
  connect(zonPriFloRat.y, zon1.VDis_flow)
    annotation(
      Line(
        points={{-238, 90}, {-166, 90}, {-166, 104}, {-122, 104}},
        color={0, 0, 127}));
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_PR1/AHUs/MultiZone/VAV/SetPoints/OutdoorAirFlow/Validation/OutdoorAirFlow.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
