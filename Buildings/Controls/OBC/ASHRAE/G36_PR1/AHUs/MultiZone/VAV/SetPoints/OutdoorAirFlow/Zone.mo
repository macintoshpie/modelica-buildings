...
block Zone
  ...
  parameter Real desZonDisEff(final unit="1")=1.0
    ...
    annotation(Dialog(group="Nominal condition"));
  parameter Real desZonPop(final min=occDen*AFlo, final unit="1")
    "Design zone population during peak occupancy"
    annotation(Dialog(group="Nominal condition"));
  parameter Real uLow(final unit="K", final displayUnit="K", final quantity="ThermodynamicTemperature")=-0.5
  ...
  parameter Real uHig(final unit="K", final displayUnit="K", final quantity="ThermodynamicTemperature")=0.5
  ...
  Buildings.Controls.OBC.CDL.Interfaces.IntegerInput nOcc if have_occSen
    "Number of occupants"
    annotation(Placement(transformation(extent={{-200, 20}, {-160, 60}}), iconTransformation(extent={{-140, 70}, {-100, 110}})));
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput uWin if have_winSen
    "Window status, true if open, false if closed"
    annotation(Placement(transformation(extent={{-200,-70}, {-160,-30}}), iconTransformation(extent={{-140, 40}, {-100, 80}})));
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput uReqOutAir
    ...
    annotation(Placement(transformation(extent={{-200,-110}, {-160,-70}}), iconTransformation(extent={{-140, 10}, {-100, 50}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealInput TZon(final unit="K", final displayUnit="degC", final quantity="ThermodynamicTemperature")
    ...
    annotation(Placement(transformation(extent={{-200,-150}, {-160,-110}}), iconTransformation(extent={{-140,-20}, {-100, 20}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealInput TDis(final unit="K", final displayUnit="degC", final quantity="ThermodynamicTemperature")
    ...
    annotation(Placement(transformation(extent={{-200,-190}, {-160,-150}}), iconTransformation(extent={{-140,-50}, {-100,-10}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealInput VDis_flow(final unit="m3/s", final quantity="VolumeFlowRate")
    ...
    annotation(Placement(transformation(extent={{-200,-230}, {-160,-190}}), iconTransformation(extent={{-140,-80}, {-100,-40}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealInput VUncOut_flow_nominal(final min=0, final unit="m3/s", final quantity="VolumeFlowRate")
    "AHU level design uncorrected minimum outdoor airflow rate"
    annotation(Placement(transformation(extent={{-200,-270}, {-160,-230}}), iconTransformation(extent={{-140,-110}, {-100,-70}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput yDesZonPeaOcc(final min=0, final unit="1")
    "Design zone peak occupancy"
    annotation(Placement(transformation(extent={{180, 220}, {220, 260}}), iconTransformation(extent={{100, 70}, {140, 110}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput VDesPopBreZon_flow(final min=0, final unit="m3/s", final quantity="VolumeFlowRate")
    "Population component breathing zone design outdoor airflow"
    annotation(Placement(transformation(extent={{180, 180}, {220, 220}}), iconTransformation(extent={{100, 40}, {140, 80}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput VDesAreBreZon_flow(final min=0, final unit="m3/s", final quantity="VolumeFlowRate")
    "Area component breathing zone outdoor airflow"
    annotation(Placement(transformation(extent={{180, 120}, {220, 160}}), iconTransformation(extent={{100, 10}, {140, 50}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput yDesPriOutAirFra(final min=0, final unit="1")
    "Design zone primary outdoor air fraction"
    annotation(Placement(transformation(extent={{180, 50}, {220, 90}}), iconTransformation(extent={{100,-20}, {140, 20}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput VUncOutAir_flow(final min=0, final unit="m3/s", final quantity="VolumeFlowRate")
    "Uncorrected outdoor airflow rate"
    annotation(Placement(transformation(extent={{180,-110}, {220,-70}}), iconTransformation(extent={{100,-50}, {140,-10}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput yPriOutAirFra(final min=0, final unit="1")
    "Primary outdoor air fraction"
    annotation(Placement(transformation(extent={{180,-180}, {220,-140}}), iconTransformation(extent={{100,-80}, {140,-40}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput VPriAir_flow(final min=0, final unit="m3/s", final quantity="VolumeFlowRate")
    "Primary airflow rate"
    annotation(Placement(transformation(extent={{180,-240}, {220,-200}}), iconTransformation(extent={{100,-110}, {140,-70}})));
protected
  ...
  Buildings.Controls.OBC.CDL.Continuous.Hysteresis hys(final uLow=uLow, final uHigh=uHig, final pre_y_start=true)
    "Check if cooling or heating air distribution effectiveness should be applied, with 1 degC deadband"
    annotation(Placement(transformation(extent={{-80,-160}, {-60,-140}})));
  Buildings.Controls.OBC.CDL.Logical.Sources.Constant occSen(final k=have_occSen)
    "Boolean constant to indicate if there is occupancy sensor"
    annotation(Placement(transformation(extent={{-140,-10}, {-120, 10}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant desDisEff(final k=desZonDisEff)
    "Design zone air distribution effectiveness"
    annotation(Placement(transformation(extent={{20, 150}, {40, 170}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant minZonFlo(final k=minZonPriFlo)
    "Minimum expected zone primary flow rate"
    annotation(Placement(transformation(extent={{80, 60}, {100, 80}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant disEffHea(final k=zonDisEffHea)
    "Zone distribution effectiveness for heating"
    annotation(Placement(transformation(extent={{-80,-200}, {-60,-180}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant disEffCoo(final k=zonDisEffCoo)
    "Zone distribution effectiveness fo cooling"
    annotation(Placement(transformation(extent={{-80,-120}, {-60,-100}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant zerOutAir(final k=0)
    "Zero required outdoor airflow rate when window is open or when zone is not in occupied mode"
    annotation(Placement(transformation(extent={{-40,-80}, {-20,-60}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant zerOcc(final k=0) if not have_occSen
    "Zero occupant when there is no occupancy sensor"
    annotation(Placement(transformation(extent={{-140, 70}, {-120, 90}})));
  Buildings.Controls.OBC.CDL.Logical.Sources.Constant cloWin(final k=false) if not have_winSen
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant floPerAre(final k=VOutPerAre_flow)
    "Flow rate per unit area"
    annotation(Placement(transformation(extent={{-140, 110}, {-120, 130}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant floAre(final k=AFlo)
    "Floor area"
    annotation(Placement(transformation(extent={{-140, 150}, {-120, 170}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant floPerPer(final k=VOutPerPer_flow)
    "Flow rate per person"
    annotation(Placement(transformation(extent={{-140, 190}, {-120, 210}})));
  Buildings.Controls.OBC.CDL.Continuous.Gain breZonPop(final k=occDen)
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant desPeaOcc(final k=desZonPop)
    "Design zone population during peak occupancy"
...
equation
  connect(gai.y, swi.u1)
    annotation(Line(points={{-78, 40}, {-60, 40}, {-60, 8}, {-42, 8}}, color={0, 0, 127}));
  connect(swi.y, breZon.u2)
    annotation(Line(points={{-18, 0}, {0, 0}, {0, 44}, {18, 44}}, color={0, 0, 127}));
  connect(disEffCoo.y, swi1.u1)
    annotation(Line(points={{-58,-110}, {-40,-110}, {-40,-142}, {-22,-142}}, color={0, 0, 127}));
  connect(disEffHea.y, swi1.u3)
    annotation(Line(points={{-58,-190}, {-40,-190}, {-40,-158}, {-22,-158}}, color={0, 0, 127}));
  connect(breZon.y, zonOutAirRate.u1)
    annotation(Line(points={{42, 50}, {60, 50}, {60, 26}, {78, 26}}, color={0, 0, 127}));
  connect(swi1.y, zonOutAirRate.u2)
    annotation(Line(points={{2,-150}, {20,-150}, {20, 14}, {78, 14}}, color={0, 0, 127}));
  connect(desDisEff.y, desZonOutAirRate.u2)
    annotation(Line(points={{42, 160}, {60, 160}, {60, 174}, {78, 174}}, color={0, 0, 127}));
  connect(desBreZon.y, desZonOutAirRate.u1)
    annotation(Line(points={{42, 200}, {60, 200}, {60, 186}, {78, 186}}, color={0, 0, 127}));
  connect(desZonOutAirRate.y, desZonPriOutAirRate.u1)
    annotation(Line(points={{102, 180}, {120, 180}, {120, 76}, {138, 76}}, color={0, 0, 127}));
  connect(minZonFlo.y, desZonPriOutAirRate.u2)
    annotation(Line(points={{102, 70}, {120, 70}, {120, 64}, {138, 64}}, color={0, 0, 127}));
  connect(swi.u2, occSen.y)
    annotation(Line(points={{-42, 0}, {-118, 0}}, color={255, 0, 255}));
  connect(TDis, add2.u2)
    annotation(Line(points={{-180,-170}, {-140,-170}, {-140,-156}, {-122,-156}}, color={0, 0, 127}));
  connect(TZon, add2.u1)
    annotation(Line(points={{-180,-130}, {-140,-130}, {-140,-144}, {-122,-144}}, color={0, 0, 127}));
  ...
  connect(zerOcc.y, swi.u1)
    annotation(Line(points={{-118, 80}, {-60, 80}, {-60, 8}, {-42, 8}}, color={0, 0, 127}));
  ...
  connect(zerOutAir.y, swi4.u1)
    annotation(Line(points={{-18,-70}, {0,-70}, {0,-42}, {58,-42}}, color={0, 0, 127}));
  connect(zonOutAirRate.y, swi4.u3)
    annotation(Line(points={{102, 20}, {120, 20}, {120,-20}, {40,-20}, {40,-58}, {58,-58}}, color={0, 0, 127}));
  connect(swi5.y, VUncOutAir_flow)
    annotation(Line(points={{142,-90}, {200,-90}}, color={0, 0, 127}));
  connect(swi5.y, priOutAirFra.u1)
    annotation(Line(points={{142,-90}, {160,-90}, {160,-120}, {100,-120}, {100,-154}, {118,-154}}, color={0, 0, 127}));
  connect(uWin, swi4.u2)
    annotation(Line(points={{-180,-50}, {58,-50}}, color={255, 0, 255}));
  connect(cloWin.y, swi4.u2)
    annotation(Line(points={{-78,-70}, {-60,-70}, {-60,-50}, {58,-50}}, color={255, 0, 255}));
  connect(uReqOutAir, swi5.u2)
    annotation(Line(points={{-180,-90}, {118,-90}}, color={255, 0, 255}));
  connect(VDis_flow, max.u1)
    annotation(Line(points={{-180,-210}, {-40,-210}, {-40,-214}, {-22,-214}}, color={0, 0, 127}));
  connect(max.y, priOutAirFra.u2)
    annotation(Line(points={{2,-220}, {100,-220}, {100,-166}, {118,-166}}, color={0, 0, 127}));
  connect(max.y, VPriAir_flow)
    annotation(Line(points={{2,-220}, {200,-220}}, color={0, 0, 127}));
  connect(floAre.y, breZonAre.u1)
    annotation(Line(points={{-118, 160}, {-100, 160}, {-100, 146}, {-82, 146}}, color={0, 0, 127}));
  connect(floPerAre.y, breZonAre.u2)
    annotation(Line(points={{-118, 120}, {-100, 120}, {-100, 134}, {-82, 134}}, color={0, 0, 127}));
  connect(breZonAre.y, desBreZon.u2)
    annotation(Line(points={{-58, 140}, {0, 140}, {0, 194}, {18, 194}}, color={0, 0, 127}));
  connect(breZonAre.y, breZon.u1)
    annotation(Line(points={{-58, 140}, {0, 140}, {0, 56}, {18, 56}}, color={0, 0, 127}));
  connect(floPerPer.y, pro.u1)
    annotation(Line(points={{-118, 200}, {-100, 200}, {-100, 186}, {-82, 186}}, color={0, 0, 127}));
  connect(floAre.y, pro.u2)
    annotation(Line(points={{-118, 160}, {-100, 160}, {-100, 174}, {-82, 174}}, color={0, 0, 127}));
  connect(breZonPop.y, swi.u3)
    annotation(Line(points={{-78,-30}, {-60,-30}, {-60,-8}, {-42,-8}}, color={0, 0, 127}));
  connect(pro.y, breZonPop.u)
    annotation(Line(points={{-58, 180}, {-40, 180}, {-40, 100}, {-110, 100}, {-110,-30}, {-102,-30}}, color={0, 0, 127}));
  connect(VUncOut_flow_nominal, gaiDivZer.u)
    annotation(Line(points={{-180,-250}, {-100,-250}, {-100,-240}, {-82,-240}}, color={0, 0, 127}));
  connect(gaiDivZer.y, max.u2)
    annotation(Line(points={{-58,-240}, {-40,-240}, {-40,-226}, {-22,-226}}, color={0, 0, 127}));
  connect(floPerPer.y, desBreZonPer.u2)
    annotation(Line(points={{-118, 200}, {-100, 200}, {-100, 214}, {-82, 214}}, color={0, 0, 127}));
  connect(desPeaOcc.y, desBreZonPer.u1)
    annotation(Line(points={{-118, 240}, {-100, 240}, {-100, 226}, {-82, 226}}, color={0, 0, 127}));
  connect(desBreZonPer.y, desBreZon.u1)
    annotation(Line(points={{-58, 220}, {0, 220}, {0, 206}, {18, 206}}, color={0, 0, 127}));
  connect(desPeaOcc.y, yDesZonPeaOcc)
    annotation(Line(points={{-118, 240}, {200, 240}}, color={0, 0, 127}));
  connect(desBreZonPer.y, VDesPopBreZon_flow)
    annotation(Line(points={{-58, 220}, {120, 220}, {120, 200}, {200, 200}}, color={0, 0, 127}));
  connect(breZonAre.y, VDesAreBreZon_flow)
    annotation(Line(points={{-58, 140}, {200, 140}}, color={0, 0, 127}));
  connect(zerOutAir.y, swi5.u3)
    annotation(Line(points={{-18,-70}, {0,-70}, {0,-98}, {118,-98}}, color={0, 0, 127}));
  connect(swi4.y, swi5.u1)
    annotation(Line(points={{82,-50}, {100,-50}, {100,-82}, {118,-82}}, color={0, 0, 127}));
  annotation(defaultComponentName="zonOutAirSet", Icon(coordinateSystem(extent={{-100,-100}, {100, 100}}), graphics={Rectangle(extent={{-100, 100}, {100,-100}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Text(extent={{-98,-82}, {-14,-98}}, lineColor={0, 0, 0}, textString="VUncOut_flow_nominal"), Text(extent={{-100, 158}, {100, 118}}, lineColor={0, 0, 255}, textString="%name"), Text(extent={{-100,-54}, {-58,-64}}, lineColor={0, 0, 0}, textString="VDis_flow"), Text(extent={{-100,-24}, {-72,-36}}, lineColor={0, 0, 0}, textString="TDis"), Text(extent={{-100, 8}, {-70,-4}}, lineColor={0, 0, 0}, textString="TZon"), Text(extent={{-100, 36}, {-40, 24}}, lineColor={255, 0, 255}, textString="uReqOutAir"), Text(visible=have_winSen, extent={{-100, 68}, {-72, 56}}, lineColor={255, 0, 255}, textString="uWin"), Text(visible=have_occSen, extent={{-100, 98}, {-70, 86}}, lineColor={255, 127, 0}, textString="nOcc"), Text(extent={{28, 98}, {98, 82}}, lineColor={0, 0, 0}, textString="yDesZonPeaOcc"), Text(extent={{12, 70}, {96, 54}}, lineColor={0, 0, 0}, textString="VDesPopBreZon_flow"), Text(extent={{14, 38}, {98, 22}}, lineColor={0, 0, 0}, textString="VDesAreBreZon_flow"), Text(extent={{28, 10}, {98,-8}}, lineColor={0, 0, 0}, textString="yDesPriOutAirFra"), Text(extent={{28,-20}, {98,-36}}, lineColor={0, 0, 0}, textString="VUncOutAir_flow"), Text(extent={{40,-50}, {96,-66}}, lineColor={0, 0, 0}, textString="yPriOutAirFra"), Text(extent={{48,-82}, {98,-96}}, lineColor={0, 0, 0}, textString="VPriAir_flow")}), Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-160,-260}, {180, 260}})), Documentation(info="<html>
<p>
