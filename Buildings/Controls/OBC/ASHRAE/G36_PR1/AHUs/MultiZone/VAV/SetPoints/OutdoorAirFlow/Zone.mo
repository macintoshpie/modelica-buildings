...
equation
  connect(gai.y, swi.u1)
    annotation(
      Line(
        points={{-78, 40}, {-60, 40}, {-60, 8}, {-42, 8}},
        color={0, 0, 127}));
  connect(swi.y, breZon.u2)
    annotation(
      Line(
        points={{-18, 0}, {0, 0}, {0, 44}, {18, 44}},
        color={0, 0, 127}));
  connect(disEffCoo.y, swi1.u1)
    annotation(
      Line(
        points={{-58,-110}, {-40,-110}, {-40,-142}, {-22,-142}},
        color={0, 0, 127}));
  connect(disEffHea.y, swi1.u3)
    annotation(
      Line(
        points={{-58,-190}, {-40,-190}, {-40,-158}, {-22,-158}},
        color={0, 0, 127}));
  connect(breZon.y, zonOutAirRate.u1)
    annotation(
      Line(
        points={{42, 50}, {60, 50}, {60, 26}, {78, 26}},
        color={0, 0, 127}));
  connect(swi1.y, zonOutAirRate.u2)
    annotation(
      Line(
        points={{2,-150}, {20,-150}, {20, 14}, {78, 14}},
        color={0, 0, 127}));
  connect(desDisEff.y, desZonOutAirRate.u2)
    annotation(
      Line(
        points={{42, 160}, {60, 160}, {60, 174}, {78, 174}},
        color={0, 0, 127}));
  connect(desBreZon.y, desZonOutAirRate.u1)
    annotation(
      Line(
        points={{42, 200}, {60, 200}, {60, 186}, {78, 186}},
        color={0, 0, 127}));
  connect(desZonOutAirRate.y, desZonPriOutAirRate.u1)
    annotation(
      Line(
        points={{102, 180}, {120, 180}, {120, 76}, {138, 76}},
        color={0, 0, 127}));
  connect(minZonFlo.y, desZonPriOutAirRate.u2)
    annotation(
      Line(
        points={{102, 70}, {120, 70}, {120, 64}, {138, 64}},
        color={0, 0, 127}));
  ...
  connect(TDis, add2.u2)
    annotation(
      Line(
        points={{-180,-170}, {-140,-170}, {-140,-156}, {-122,-156}},
        color={0, 0, 127}));
  connect(TZon, add2.u1)
    annotation(
      Line(
        points={{-180,-130}, {-140,-130}, {-140,-144}, {-122,-144}},
        color={0, 0, 127}));
  connect(add2.y, hys.u)
    annotation(
      Line(
        points={{-98,-150}, {-82,-150}},
        color={0, 0, 127}));
  connect(hys.y, swi1.u2)
    annotation(
      Line(
        points={{-58,-150}, {-22,-150}},
        color={255, 0, 255}));
  connect(zerOcc.y, swi.u1)
    annotation(
      Line(
        points={{-118, 80}, {-60, 80}, {-60, 8}, {-42, 8}},
        color={0, 0, 127}));
  connect(intToRea.y, gai.u)
    annotation(
      Line(
        points={{-118, 40}, {-102, 40}},
        color={0, 0, 127}));
  ...
  connect(priOutAirFra.y, yPriOutAirFra)
    annotation(
      Line(
        points={{142,-160}, {200,-160}},
        color={0, 0, 127}));
  connect(zerOutAir.y, swi4.u1)
    annotation(
      Line(
        points={{-18,-70}, {0,-70}, {0,-42}, {58,-42}},
        color={0, 0, 127}));
  connect(zonOutAirRate.y, swi4.u3)
    annotation(
      Line(
        points={{102, 20}, {120, 20}, {120,-20}, {40,-20}, {40,-58}, {58,-58}},
        color={0, 0, 127}));
  connect(swi5.y, VUncOutAir_flow)
    annotation(
      Line(
        points={{142,-90}, {200,-90}},
        color={0, 0, 127}));
  connect(swi5.y, priOutAirFra.u1)
    annotation(
      Line(
        points={{142,-90}, {160,-90}, {160,-120}, {100,-120}, {100,-154}, {118,-154}},
        color={0, 0, 127}));
  ...
  connect(cloWin.y, swi4.u2)
    annotation(
      Line(
        points={{-78,-70}, {-60,-70}, {-60,-50}, {58,-50}},
        color={255, 0, 255}));
  connect(uReqOutAir, swi5.u2)
    annotation(
      Line(
        points={{-180,-90}, {118,-90}},
        color={255, 0, 255}));
  connect(VDis_flow, max.u1)
    annotation(
      Line(
        points={{-180,-210}, {-40,-210}, {-40,-214}, {-22,-214}},
        color={0, 0, 127}));
  connect(max.y, priOutAirFra.u2)
    annotation(
      Line(
        points={{2,-220}, {100,-220}, {100,-166}, {118,-166}},
        color={0, 0, 127}));
  connect(max.y, VPriAir_flow)
    annotation(
      Line(
        points={{2,-220}, {200,-220}},
        color={0, 0, 127}));
  connect(floAre.y, breZonAre.u1)
    annotation(
      Line(
        points={{-118, 160}, {-100, 160}, {-100, 146}, {-82, 146}},
        color={0, 0, 127}));
  connect(floPerAre.y, breZonAre.u2)
    annotation(
      Line(
        points={{-118, 120}, {-100, 120}, {-100, 134}, {-82, 134}},
        color={0, 0, 127}));
  connect(breZonAre.y, desBreZon.u2)
    annotation(
      Line(
        points={{-58, 140}, {0, 140}, {0, 194}, {18, 194}},
        color={0, 0, 127}));
  connect(breZonAre.y, breZon.u1)
    annotation(
      Line(
        points={{-58, 140}, {0, 140}, {0, 56}, {18, 56}},
        color={0, 0, 127}));
  connect(floPerPer.y, pro.u1)
    annotation(
      Line(
        points={{-118, 200}, {-100, 200}, {-100, 186}, {-82, 186}},
        color={0, 0, 127}));
  connect(floAre.y, pro.u2)
    annotation(
      Line(
        points={{-118, 160}, {-100, 160}, {-100, 174}, {-82, 174}},
        color={0, 0, 127}));
  connect(breZonPop.y, swi.u3)
    annotation(
      Line(
        points={{-78,-30}, {-60,-30}, {-60,-8}, {-42,-8}},
        color={0, 0, 127}));
  connect(pro.y, breZonPop.u)
    annotation(
      Line(
        points={{-58, 180}, {-40, 180}, {-40, 100}, {-110, 100}, {-110,-30}, {-102,-30}},
        color={0, 0, 127}));
  connect(VUncOut_flow_nominal, gaiDivZer.u)
    annotation(
      Line(
        points={{-180,-250}, {-100,-250}, {-100,-240}, {-82,-240}},
        color={0, 0, 127}));
  connect(gaiDivZer.y, max.u2)
    annotation(
      Line(
        points={{-58,-240}, {-40,-240}, {-40,-226}, {-22,-226}},
        color={0, 0, 127}));
  connect(floPerPer.y, desBreZonPer.u2)
    annotation(
      Line(
        points={{-118, 200}, {-100, 200}, {-100, 214}, {-82, 214}},
        color={0, 0, 127}));
  connect(desPeaOcc.y, desBreZonPer.u1)
    annotation(
      Line(
        points={{-118, 240}, {-100, 240}, {-100, 226}, {-82, 226}},
        color={0, 0, 127}));
  connect(desBreZonPer.y, desBreZon.u1)
    annotation(
      Line(
        points={{-58, 220}, {0, 220}, {0, 206}, {18, 206}},
        color={0, 0, 127}));
  connect(desPeaOcc.y, yDesZonPeaOcc)
    annotation(
      Line(
        points={{-118, 240}, {200, 240}},
        color={0, 0, 127}));
  connect(desBreZonPer.y, VDesPopBreZon_flow)
    annotation(
      Line(
        points={{-58, 220}, {120, 220}, {120, 200}, {200, 200}},
        color={0, 0, 127}));
  connect(breZonAre.y, VDesAreBreZon_flow)
    annotation(
      Line(
        points={{-58, 140}, {200, 140}},
        color={0, 0, 127}));
  connect(zerOutAir.y, swi5.u3)
    annotation(
      Line(
        points={{-18,-70}, {0,-70}, {0,-98}, {118,-98}},
        color={0, 0, 127}));
  connect(swi4.y, swi5.u1)
    annotation(
      Line(
        points={{82,-50}, {100,-50}, {100,-82}, {118,-82}},
        color={0, 0, 127}));
  annotation(
    ...
    Icon(
      ...
      graphics={Rectangle(
        ...
        extent={{-98,-82}, {-14,-98}},
        lineColor={0, 0, 0},
        textString="VUncOut_flow_nominal"), Text(
        ...
        extent={{12, 70}, {96, 54}},
        lineColor={0, 0, 0},
        textString="VDesPopBreZon_flow"), Text(
        extent={{14, 38}, {98, 22}},
        lineColor={0, 0, 0},
        textString="VDesAreBreZon_flow"), Text(
        extent={{28, 10}, {98,-8}},
        lineColor={0, 0, 0},
