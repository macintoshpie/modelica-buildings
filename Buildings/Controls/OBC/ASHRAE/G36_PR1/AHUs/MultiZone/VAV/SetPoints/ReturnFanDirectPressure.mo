...
equation
  ...
  connect(swi.u3, zer.y)
    annotation(
      Line(
        points={{78,-98}, {60,-98}, {60,-110}, {22,-110}},
        color={0, 0, 127}));
  connect(zer1.y, linExhAirDam.x1)
    annotation(
      Line(
        points={{-18, 52}, {30, 52}, {30, 118}, {58, 118}},
        color={0, 0, 127}));
  connect(zer1.y, linExhAirDam.f1)
    annotation(
      Line(
        points={{-18, 52}, {30, 52}, {30, 114}, {58, 114}},
        color={0, 0, 127}));
  connect(con.y, linExhAirDam.x2)
    annotation(
      Line(
        points={{22, 70}, {40, 70}, {40, 106}, {58, 106}},
        color={0, 0, 127}));
  connect(one.y, linExhAirDam.f2)
    annotation(
      Line(
        points={{22, 36}, {46, 36}, {46, 102}, {58, 102}},
        color={0, 0, 127}));
  connect(con.y, linRetFanStaPre.x1)
    annotation(
      Line(
        points={{22, 70}, {40, 70}, {40,-32}, {58,-32}},
        color={0, 0, 127}));
  connect(one.y, linRetFanStaPre.x2)
    annotation(
      Line(
        points={{22, 36}, {46, 36}, {46,-44}, {58,-44}},
        color={0, 0, 127}));
  connect(retFanDisPreMin.y, linRetFanStaPre.f1)
    annotation(
      Line(
        points={{22,-20}, {30,-20}, {30,-36}, {58,-36}},
        color={0, 0, 127}));
  connect(retFanDisPreMax.y, linRetFanStaPre.f2)
    annotation(
      Line(
        points={{22,-70}, {30,-70}, {30,-48}, {58,-48}},
        color={0, 0, 127}));
  connect(linRetFanStaPre.y, swi.u1)
    annotation(
      Line(
        points={{82,-40}, {100,-40}, {100,-60}, {60,-60}, {60,-82}, {78,-82}},
        color={0, 0, 127}));
  connect(uFan, swi1.u2)
    annotation(
      Line(
        points={{-160,-90}, {-100,-90}, {-100, 20}, {78, 20}},
        color={255, 0, 255}));
  connect(linExhAirDam.y, swi1.u1)
    annotation(
      Line(
        points={{82, 110}, {100, 110}, {100, 70}, {60, 70}, {60, 28}, {78, 28}},
        color={0, 0, 127}));
  connect(swi1.y, yExhDam)
    annotation(
      Line(
        points={{102, 20}, {140, 20}},
        color={0, 0, 127}));
  connect(zer1.y, swi1.u3)
    annotation(
      Line(
        points={{-18, 52}, {30, 52}, {30, 12}, {78, 12}},
        color={0, 0, 127}));
  connect(swi.y, dpDisSet)
    annotation(
      Line(
        points={{102,-90}, {140,-90}},
        color={0, 0, 127}));
  ...
  connect(conP.y, linRetFanStaPre.u)
    annotation(
      Line(
        points={{-18, 110}, {-10, 110}, {-10,-40}, {58,-40}},
        color={0, 0, 127}));
  connect(dpBuiSetPoi.y, div.u2)
    annotation(
      Line(
        points={{-108, 50}, {-90, 50}, {-90, 74}, {-82, 74}},
        color={0, 0, 127}));
  connect(movMea.y, div.u1)
    annotation(
      Line(
        points={{-108, 80}, {-100, 80}, {-100, 86}, {-82, 86}},
        color={0, 0, 127}));
  connect(conOne.y, conP.u_s)
    annotation(
      Line(
        points={{-58, 110}, {-42, 110}},
        color={0, 0, 127}));
  connect(div.y, conP.u_m)
    annotation(
      Line(
        points={{-58, 80}, {-30, 80}, {-30, 98}},
        color={0, 0, 127}));
  annotation(
    defaultComponentName="buiPreCon",
    Icon(
      graphics={Text(
        extent={{-98, 142}, {102, 102}},
        lineColor={0, 0, 255},
        ...
        points={{-78, 52}, {-78,-32}, {78,-32}, {78, 52}, {78, 52}},
    ...
    Diagram(
      ...
      graphics={Rectangle(
        ...
        textString="Exhaust air damper control"), Text(
