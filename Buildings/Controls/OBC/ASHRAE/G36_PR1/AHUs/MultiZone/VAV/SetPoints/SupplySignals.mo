...
equation
  connect(zer.y, swi.u3)
    annotation(
      Line(
        points={{-38,-40}, {-20,-40}, {-20, 52}, {-2, 52}},
        color={0, 0, 127}));
  connect(TSup, conTSup.u_m)
    annotation(
      Line(
        points={{-120,-20}, {-50,-20}, {-50, 18}},
        color={0, 0, 127}));
  ...
  connect(one.y, conSigHea.f1)
    annotation(
      Line(
        points={{22,-80}, {50,-80}, {50, 24}, {58, 24}},
        color={0, 0, 127}));
  connect(swi.y, conSigHea.u)
    annotation(
      Line(
        points={{22, 60}, {46, 60}, {46, 20}, {58, 20}},
        color={0, 0, 127}));
  ...
  connect(uHeaMaxCon.y, conSigHea.x2)
    annotation(
      Line(
        points={{22,-10}, {30,-10}, {30, 16}, {58, 16}},
        color={0, 0, 127}));
  connect(zer.y, conSigHea.f2)
    annotation(
      Line(
        points={{-38,-40}, {-20,-40}, {-20,-30}, {36,-30}, {36, 12}, {58, 12}},
        color={0, 0, 127}));
  connect(uCooMinCon.y, conSigCoo.x1)
    annotation(
      Line(
        points={{22,-50}, {40,-50}, {40,-12}, {58,-12}},
        color={0, 0, 127}));
  connect(zer.y, conSigCoo.f1)
    annotation(
      Line(
        points={{-38,-40}, {-20,-40}, {-20,-30}, {36,-30}, {36,-16}, {58,-16}},
        color={0, 0, 127}));
  ...
  connect(one.y, conSigCoo.f2)
    annotation(
      Line(
        points={{22,-80}, {50,-80}, {50,-28}, {58,-28}},
        color={0, 0, 127}));
  ...
  connect(conTSup.y, swi.u1)
    annotation(
      Line(
        points={{-38, 30}, {-28, 30}, {-28, 68}, {-2, 68}},
        color={0, 0, 127}));
  connect(uSupFan, conTSup.trigger)
    annotation(
      Line(
        points={{-120, 80}, {-80, 80}, {-80, 8}, {-58, 8}, {-58, 18}},
        color={255, 0, 255}));
  annotation(
