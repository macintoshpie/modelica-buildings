...
model ExhaustDamper
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZone.VAV.SetPoints.ExhaustDamper exhDamPos(
    k=0.1)
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Ramp meaBuiPre(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-80, 40}, {-60, 60}})));
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZone.VAV.SetPoints.ExhaustDamper exhDamPos1(
    k=0.5)
    "Block of controlling actuated exhaust damper without fan"
    annotation(
      Placement(
        transformation(
          extent={{0, 0}, {20, 20}})));
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZone.VAV.SetPoints.ExhaustDamper exhDamPos2(
    k=1)
    "Block of controlling actuated exhaust damper without fan"
    annotation(
      Placement(
...
equation
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_PR1/AHUs/MultiZone/VAV/SetPoints/Validation/ExhaustDamper.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
