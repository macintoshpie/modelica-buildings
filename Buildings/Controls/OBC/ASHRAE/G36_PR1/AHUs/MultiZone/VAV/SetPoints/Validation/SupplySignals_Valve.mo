...
model SupplySignals_Valve
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZone.VAV.SetPoints.SupplySignals supSig
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Sine TSup(amplitude=2, offset=16 + 273.15, freqHz=1/7200)
    "Supply air temperature"
    annotation(Placement(transformation(extent={{-80, 30}, {-60, 50}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Ramp TSupSet(height=3, duration=7200, offset=15 + 273.15)
    "Supply air temperature setpoint"
    annotation(Placement(transformation(extent={{-80, 70}, {-60, 90}})));
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZone.VAV.SetPoints.SupplySignals supSig1
    "Output valve position and supply air temperature control loop signal"
...
equation
  connect(TSupSet.y, supSig.TSupSet)
    annotation(Line(points={{-59, 80}, {-40, 80}, {-40, 75}, {19, 75}}, color={0, 0, 127}));
  connect(TSup.y, supSig.TSup)
    annotation(Line(points={{-59, 40}, {-30, 40}, {-30, 70}, {19, 70}}, color={0, 0, 127}));
  connect(supFanSta.y, supSig.uSupFan)
    annotation(Line(points={{-59, 0}, {-20, 0}, {-20, 65}, {19, 65}}, color={255, 0, 255}));
  connect(TSupSet.y, supSig1.TSupSet)
    annotation(Line(points={{-59, 80}, {-40, 80}, {-40, 15}, {19, 15}}, color={0, 0, 127}));
  connect(TSup.y, supSig1.TSup)
    annotation(Line(points={{-59, 40}, {-30, 40}, {-30, 10}, {19, 10}}, color={0, 0, 127}));
  connect(fanOn.y, supSig1.uSupFan)
    annotation(Line(points={{-59,-40}, {0,-40}, {0, 5}, {19, 5}}, color={255, 0, 255}));
  annotation(experiment(StopTime=7200, Tolerance=1e-6), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_PR1/AHUs/MultiZone/VAV/SetPoints/Validation/SupplySignals_Valve.mos"
