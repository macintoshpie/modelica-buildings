...
equation
  ...
  connect(outTem.y, conTSupSet.TOut)
    annotation(
      Line(
        points={{-59, 40}, {40, 40}, {40, 4}, {69, 4}},
        color={0, 0, 127}));
  connect(setZonTem.y, conTSupSet.TZonSetAve)
    annotation(
      Line(
        points={{-59, 70}, {60, 70}, {60, 8}, {69, 8}},
        color={0, 0, 127}));
  ...
  connect(reaToInt1.y, conTSupSet.uZonTemResReq)
    annotation(
      Line(
        points={{53,-40}, {60,-40}, {60,-4}, {69,-4}},
        color={255, 127, 0}));
  connect(reaToInt2.y, conTSupSet.uOpeMod)
    annotation(
      Line(
        points={{21,-70}, {66,-70}, {66,-8}, {69,-8}},
        color={255, 127, 0}));
  annotation(
    experiment(
      StopTime=86400,
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_PR1/AHUs/MultiZone/VAV/SetPoints/Validation/SupplyTemperature.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
