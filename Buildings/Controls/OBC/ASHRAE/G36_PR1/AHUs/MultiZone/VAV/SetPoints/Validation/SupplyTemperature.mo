...
model SupplyTemperature
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZone.VAV.SetPoints.SupplyTemperature conTSupSet
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Sine outTem(amplitude=5, freqHz=1/86400, offset=18 + 273.15)
    "Outdoor air temperature"
    annotation(Placement(transformation(extent={{-80, 30}, {-60, 50}})));
  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse supFanSta(period=43200)
    "Supply fan status"
    annotation(Placement(transformation(extent={{-80,-10}, {-60, 10}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Ramp opeMod(offset=1, height=1, duration=90000)
    "Operation mode"
    annotation(Placement(transformation(extent={{-80,-80}, {-60,-60}})));
  Buildings.Controls.OBC.CDL.Continuous.Abs abs
    "Block generates absolute value of input"
    annotation(Placement(transformation(extent={{-40,-50}, {-20,-30}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Sine sine(amplitude=6, freqHz=1/86400)
...
equation
  connect(supFanSta.y, conTSupSet.uSupFan)
    annotation(Line(points={{-59, 0}, {69, 0}}, color={255, 0, 255}));
  connect(outTem.y, conTSupSet.TOut)
    annotation(Line(points={{-59, 40}, {40, 40}, {40, 4}, {69, 4}}, color={0, 0, 127}));
  connect(setZonTem.y, conTSupSet.TZonSetAve)
    annotation(Line(points={{-59, 70}, {60, 70}, {60, 8}, {69, 8}}, color={0, 0, 127}));
  ...
  connect(round2.y, reaToInt2.u)
    annotation(Line(points={{-19,-70}, {-12,-70}, {-12,-70}, {-2,-70}}, color={0, 0, 127}));
  ...
  connect(reaToInt1.y, conTSupSet.uZonTemResReq)
    annotation(Line(points={{53,-40}, {60,-40}, {60,-4}, {69,-4}}, color={255, 127, 0}));
  connect(reaToInt2.y, conTSupSet.uOpeMod)
    annotation(Line(points={{21,-70}, {66,-70}, {66,-8}, {69,-8}}, color={255, 127, 0}));
  annotation(experiment(StopTime=86400, Tolerance=1e-6), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_PR1/AHUs/MultiZone/VAV/SetPoints/Validation/SupplyTemperature.mos"
