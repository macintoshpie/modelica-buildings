...
model Controller
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.MultiZone.VAV.Controller conAHU(
    VPriSysMax_flow=0.35,
    peaSysPop=6)
    "Multizone VAV AHU controller"
    annotation(
      Placement(
        transformation(
          extent={{100,-60}, {180, 68}})));
...
equation
  connect(TSetRooHeaOn.y, conAHU.TZonHeaSet)
    annotation(
      Line(
        points={{-198, 219.5}, {40, 219.5}, {40, 64.4444}, {96, 64.4444}},
        color={0, 0, 127}));
  connect(TSetRooCooOn.y, conAHU.TZonCooSet)
    annotation(
      Line(
        points={{-138, 199.5}, {34, 199.5}, {34, 59.1111}, {96, 59.1111}},
        color={0, 0, 127}));
  connect(TOut.y, conAHU.TOut)
    annotation(
      Line(
        points={{-198, 180}, {28, 180}, {28, 53.7778}, {96, 53.7778}},
        color={0, 0, 127}));
  connect(ducStaPre.y, conAHU.ducStaPre)
    annotation(
      Line(
        points={{-138, 160}, {22, 160}, {22, 48.4444}, {96, 48.4444}},
        color={0, 0, 127}));
  connect(sine2.y, abs3.u)
    annotation(
      Line(
        points={{-198,-200}, {-142,-200}},
        color={0, 0, 127}));
  connect(abs3.y, round4.u)
    annotation(
      Line(
        points={{-118,-200}, {-102,-200}},
        color={0, 0, 127}));
  ...
  connect(sine3.y, abs2.u)
    annotation(
      Line(
        points={{-198,-160}, {-142,-160}},
        color={0, 0, 127}));
  connect(abs2.y, round3.u)
    annotation(
      Line(
        points={{-118,-160}, {-102,-160}},
        color={0, 0, 127}));
  connect(round3.y, maxSupResReq.u)
    annotation(
      Line(
        points={{-78,-160}, {-62,-160}},
        color={0, 0, 127}));
  connect(opeMod.y, conAHU.uOpeMod)
    annotation(
      Line(
        points={{-158,-140}, {28,-140}, {28,-40.4444}, {96,-40.4444}},
        color={255, 127, 0}));
  connect(maxSupResReq.y, conAHU.uZonTemResReq)
    annotation(
      Line(
        points={{-38,-160}, {34,-160}, {34,-45.7778}, {96,-45.7778}},
        color={255, 127, 0}));
  connect(ducPreResReq.y, conAHU.uZonPreResReq)
    annotation(
      Line(
        points={{-38,-200}, {40,-200}, {40,-51.1111}, {96,-51.1111}},
        color={255, 127, 0}));
  connect(TMixMea.y, conAHU.TMix)
    annotation(
      Line(
        points={{-38,-120}, {22,-120}, {22,-33.3333}, {96,-33.3333}},
        color={0, 0, 127}));
  connect(VOut_flow.y, conAHU.VOut_flow)
    annotation(
      Line(
        points={{-158,-100}, {16,-100}, {16,-26.2222}, {96,-26.2222}},
        color={0, 0, 127}));
  connect(TOutCut.y, conAHU.TOutCut)
    annotation(
      Line(
        points={{-78,-80}, {10,-80}, {10,-10.2222}, {96,-10.2222}},
        color={0, 0, 127}));
  connect(TSup.y, conAHU.TSup)
    annotation(
      Line(
        points={{-158,-60}, {4,-60}, {4,-4.88889}, {96,-4.88889}},
        color={0, 0, 127}));
  connect(sumDesZonPop.y, conAHU.sumDesZonPop)
    annotation(
      Line(
        points={{-198, 129.5}, {16, 129.5}, {16, 37.7778}, {96, 37.7778}},
        color={0, 0, 127}));
  connect(sumDesPopBreZon.y, conAHU.VSumDesPopBreZon_flow)
    annotation(
      Line(
        points={{-138, 111.5}, {10, 111.5}, {10, 32.4444}, {96, 32.4444}},
        color={0, 0, 127}));
  connect(sumDesAreBreZon.y, conAHU.VSumDesAreBreZon_flow)
    annotation(
      Line(
        points={{-198, 89.5}, {4, 89.5}, {4, 27.1111}, {96, 27.1111}},
        color={0, 0, 127}));
  connect(desSysVenEff.y, conAHU.uDesSysVenEff)
    annotation(
      Line(
        points={{-138, 61.5}, {-2, 61.5}, {-2, 21.7778}, {96, 21.7778}},
        color={0, 0, 127}));
  connect(uncOutAir.y, conAHU.VSumUncOutAir_flow)
    annotation(
      Line(
        points={{-198, 40}, {-8, 40}, {-8, 16.4444}, {96, 16.4444}},
        color={0, 0, 127}));
  connect(vavBoxFlo2.y, add2.u1)
    annotation(
      Line(
        points={{-138, 20}, {-120, 20}, {-120, 6}, {-102, 6}},
        color={0, 0, 127}));
  ...
  connect(add2.y, conAHU.VSumSysPriAir_flow)
    annotation(
      Line(
        points={{-78, 0}, {-8, 0}, {-8, 11.1111}, {96, 11.1111}},
        color={0, 0, 127}));
  connect(uOutAirFra_max.y, conAHU.uOutAirFra_max)
    annotation(
      Line(
        points={{-198,-40}, {-2,-40}, {-2, 5.77778}, {96, 5.77778}},
        color={0, 0, 127}));
  annotation(
    experiment(
      StopTime=3600.0,
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_PR1/AHUs/MultiZone/VAV/Validation/Controller.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
