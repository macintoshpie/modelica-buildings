...
equation
  connect(const.y, switch.u3)
    annotation(
      Line(
        points={{62,-20}, {66,-20}, {66,-8}, {70,-8}},
        color={0, 0, 127}));
  connect(cooCoiPI.trigger, uSupFan)
    annotation(
      Line(
        points={{-8, 68}, {-8,-80}, {-120,-80}},
        color={255, 0, 255}));
  ...
  connect(and2.u2, uSupFan)
    annotation(
      Line(
        points={{-2,-28}, {-8,-28}, {-8,-80}, {-120,-80}},
        color={255, 0, 255}));
  connect(and2.y, switch.u2)
    annotation(
      Line(
        points={{22,-20}, {30,-20}, {30, 0}, {70, 0}},
        color={255, 0, 255}));
  ...
  connect(uZonSta, intEqu.u2)
    annotation(
      Line(
        points={{-120,-40}, {-50,-40}, {-50,-28}, {-42,-28}},
        color={255, 127, 0}));
  connect(cooCoiPI.y, switch.u1)
    annotation(
      Line(
        points={{12, 80}, {60, 80}, {60, 8}, {70, 8}},
        color={0, 0, 127}));
  annotation(
