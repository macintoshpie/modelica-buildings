...
block Controller
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput TCut(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-160, 110}, {-140, 130}}),
        iconTransformation(
          extent={{-120, 68}, {-100, 88}})));
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.SingleZone.VAV.Economizers.Subsequences.Limits damLim(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-100, 0}, {-80, 20}})));
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.SingleZone.VAV.Economizers.Subsequences.Modulation mod(
...
equation
  connect(uSupFan, enaDis.uSupFan)
    annotation(
      Line(
        points={{-150,-60}, {-100,-60}, {-100,-34}, {-21,-34}},
        color={255, 0, 255}));
  connect(uFreProSta, enaDis.uFreProSta)
    annotation(
      Line(
        points={{-151,-119}, {-60,-119}, {-60,-30}, {-21,-30}},
        color={255, 127, 0}));
  connect(TRet, enaDis.TRet)
    annotation(
      Line(
        points={{-150, 100}, {-28, 100}, {-28,-24}, {-21,-24}},
        color={0, 0, 127}));
  connect(hCut, enaDis.hCut)
    annotation(
      Line(
        points={{-150, 60}, {-40, 60}, {-40,-28}, {-21,-28}},
        color={0, 0, 127}));
  connect(hOut, enaDis.hOut)
    annotation(
      Line(
        points={{-150, 80}, {-36, 80}, {-36,-26}, {-21,-26}},
        color={0, 0, 127}));
  connect(TCut, enaDis.TCut)
    annotation(
      Line(
        points={{-150, 120}, {-26, 120}, {-26,-22.2}, {-21,-22.2}},
        color={0, 0, 127}));
  connect(TOut, enaDis.TOut)
    annotation(
      Line(
        points={{-150, 140}, {-24, 140}, {-24,-20.6}, {-21,-20.6}},
        color={0, 0, 127}));
  connect(uSupFan, damLim.uSupFan)
    annotation(
      Line(
        points={{-150,-60}, {-124,-60}, {-124, 10}, {-102, 10}},
        color={255, 0, 255}));
  connect(uOpeMod, damLim.uOpeMod)
    annotation(
      Line(
        points={{-151,-79}, {-122,-79}, {-122, 1.8}, {-102, 1.8}},
        color={255, 127, 0}));
  connect(uFreProSta, damLim.uFreProSta)
    annotation(
      Line(
        points={{-151,-119}, {-110,-119}, {-110, 6}, {-102, 6}},
        color={255, 127, 0}));
  connect(damLim.yOutDamPosMax, enaDis.uOutDamPosMax)
    annotation(
      Line(
        points={{-78, 16}, {-30, 16}, {-30,-36}, {-21,-36}},
        color={0, 0, 127}));
  connect(enaDis.yOutDamPosMax, mod.uOutDamPosMax)
    annotation(
      Line(
        points={{2,-24}, {10,-24}, {10, 6}, {18, 6}},
        color={0, 0, 127}));
  connect(enaDis.yRetDamPosMax, mod.uRetDamPosMax)
    annotation(
      Line(
        points={{2,-30}, {12,-30}, {12, 12}, {18, 12}},
        color={0, 0, 127}));
  ...
  connect(enaDis.yRetDamPosMin, mod.uRetDamPosMin)
    annotation(
      Line(
        points={{2,-36}, {14,-36}, {14, 10}, {18, 10}},
        color={0, 0, 127}));
  connect(uZonSta, enaDis.uZonSta)
    annotation(
      Line(
        points={{-151,-99}, {-58,-99}, {-58,-32}, {-21,-32}},
        color={255, 127, 0}));
  connect(uSupFanSpe, damLim.uSupFanSpe)
    annotation(
      Line(
        points={{-150,-20}, {-126,-20}, {-126, 14}, {-102, 14}},
        color={0, 0, 127}));
  connect(VOutMinSet_flow, damLim.VOutMinSet_flow)
    annotation(
      Line(
        points={{-150, 0}, {-130, 0}, {-130, 18}, {-102, 18}},
        color={0, 0, 127}));
  ...
  connect(retDamMinFre.y, yRetDamPos)
    annotation(
      Line(
        points={{122, 50}, {126, 50}, {126, 40}, {150, 40}},
        color={0, 0, 127}));
  ...
  connect(mod.yRetDamPos, retDamMinFre.u2)
    annotation(
      Line(
        points={{41, 10}, {92, 10}, {92, 44}, {98, 44}},
        color={0, 0, 127}));
  connect(mod.yOutDamPos, outDamMaxFre.u1)
    annotation(
      Line(
        points={{41, 6}, {94, 6}, {94,-44}, {98,-44}},
        color={0, 0, 127}));
  connect(freProTMix.yFrePro, retDamMinFre.u1)
    annotation(
      Line(
        points={{82,-13}, {86,-13}, {86, 56}, {98, 56}},
        color={0, 0, 127}));
  connect(freProTMix.yFreProInv, outDamMaxFre.u2)
    annotation(
      Line(
        points={{82,-7}, {88,-7}, {88,-56}, {98,-56}},
        color={0, 0, 127}));
  connect(freProSta.y, enaDis.uFreProSta)
    annotation(
      Line(
        points={{-118,-140}, {-40,-140}, {-40,-30}, {-21,-30}},
        color={255, 127, 0}));
  connect(freProSta.y, damLim.uFreProSta)
    annotation(
      Line(
        points={{-118,-140}, {-114,-140}, {-114, 6}, {-102, 6}},
        color={255, 127, 0}));
  connect(uSupFan, mod.uSupFan)
    annotation(
      Line(
        points={{-150,-60}, {-100,-60}, {-100,-10}, {18,-10}, {18, 1}},
        color={255, 0, 255}));
  connect(mod.yHeaCoi, yHeaCoi)
    annotation(
      Line(
        points={{41, 14}, {46, 14}, {46, 102}, {150, 102}},
        color={0, 0, 127}));
  connect(damLim.yOutDamPosMin, enaDis.uOutDamPosMin)
    annotation(
      Line(
        points={{-78, 4}, {-34, 4}, {-34,-38}, {-21,-38}},
        color={0, 0, 127}));
  connect(TMix, freProTMix.TMix)
    annotation(
      Line(
        points={{-150,-40}, {-80,-40}, {-80,-60}, {40,-60}, {40,-10}, {58,-10}},
        color={0, 0, 127}));
  connect(TSup, mod.TSup)
    annotation(
      Line(
        points={{-150, 40}, {0, 40}, {0, 18}, {18, 18}},
        color={0, 0, 127}));
  connect(THeaSupSet, mod.THeaSupSet)
    annotation(
      Line(
        points={{-150, 20}, {-130, 20}, {-130, 34}, {-4, 34}, {-4, 16}, {18, 16}},
        color={0, 0, 127}));
  annotation(
