...
equation
  ...
  connect(uOpeMod, intEqu1.u1)
    annotation(
      Line(
        points={{-180,-160}, {-102,-160}},
        color={255, 127, 0}));
  connect(conInt1.y, intEqu1.u2)
    annotation(
      Line(
        points={{-118,-180}, {-112,-180}, {-112,-168}, {-102,-168}},
        color={255, 127, 0}));
  connect(intLesEqu.u2, conInt.y)
    annotation(
      Line(
        points={{-102,-128}, {-110,-128}, {-110,-140}, {-118,-140}},
        color={255, 127, 0}));
  connect(uFreProSta, intLesEqu.u1)
    annotation(
      Line(
        points={{-180,-120}, {-102,-120}},
        color={255, 127, 0}));
  connect(uSupFan, and3.u1)
    annotation(
      Line(
        points={{-180,-80}, {-80,-80}, {-80,-62}, {-62,-62}},
        color={255, 0, 255}));
  connect(intLesEqu.y, and3.u2)
    annotation(
      Line(
        points={{-78,-120}, {-74,-120}, {-74,-70}, {-62,-70}},
        color={255, 0, 255}));
  connect(intEqu1.y, and3.u3)
    annotation(
      Line(
        points={{-78,-160}, {-68,-160}, {-68,-78}, {-62,-78}},
        color={255, 0, 255}));
...
control loop"), Rectangle(
        ...
        lineColor={0, 0, 0},
        horizontalAlignment=TextAlignment.Left,
        textString="Values set at commissioning"), Rectangle(
        extent={{4, 214}, {152,-46}},
        lineColor={0, 0, 0},
        fillColor={215, 215, 215},
        fillPattern=FillPattern.Solid), Text(
        ...
        lineColor={0, 0, 0},
        horizontalAlignment=TextAlignment.Left,
        textString="Damper position limit"), Text(
