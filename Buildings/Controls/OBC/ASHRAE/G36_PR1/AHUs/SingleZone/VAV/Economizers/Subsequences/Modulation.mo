  ...
  CDL.Logical.Switch enaDis
    ...
    annotation(
      Placement(
        transformation(
          extent={{76, 30}, {96, 50}})));
  CDL.Continuous.Sources.Constant Off(
    final k=0)
