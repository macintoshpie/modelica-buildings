...
equation
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_PR1/AHUs/SingleZone/VAV/Economizers/Subsequences/Validation/Limits_FanSpe_VOut_flow.mos"
        "Simulate and plot"),
    Icon(
      graphics={Ellipse(
        lineColor={75, 138, 73},
...
constant minimum outdoor airflow setpoint"), Text(
        extent={{8, 110}, {140, 96}},
        lineColor={0, 0, 0},
        lineThickness=0.5,
        fillColor={255, 255, 255},
