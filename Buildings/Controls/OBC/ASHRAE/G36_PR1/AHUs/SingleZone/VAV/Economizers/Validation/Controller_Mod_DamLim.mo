...
equation
  connect(fanSta.y, economizer.uSupFan)
    annotation(
      Line(
        points={{-58,-80}, {-14,-80}, {-14, 4.4}, {19, 4.4}},
        color={255, 0, 255}));
  ...
  connect(opeMod.y, economizer.uOpeMod)
    annotation(
      Line(
        points={{-98,-100}, {-50,-100}, {-50,-30}, {-4,-30}, {-4, 3}, {19, 3}},
        color={255, 127, 0}));
  connect(zonSta.y, economizer.uZonSta)
    annotation(
      Line(
        points={{-98,-60}, {-48,-60}, {-48,-32}, {-2,-32}, {-2, 1.8}, {19, 1.8}},
        color={255, 127, 0}));
  ...
  connect(TOutCut1.y, economizer.TCut)
    annotation(
      Line(
        points={{-98, 70}, {-10, 70}, {-10, 17.8}, {19, 17.8}},
        color={0, 0, 127}));
  ...
  connect(TOutBelowCutoff.y, economizer1.TOut)
    annotation(
      Line(
        points={{-98, 110}, {90, 110}, {90,-20.6}, {99,-20.6}},
        color={0, 0, 127}));
  connect(TOutCut1.y, economizer1.TCut)
    annotation(
      Line(
        points={{-98, 70}, {88, 70}, {88,-22.2}, {99,-22.2}},
        color={0, 0, 127}));
  connect(TSupSig1.y, economizer1.TSup)
    annotation(
      Line(
        points={{62, 90}, {80, 90}, {80,-28.6}, {99,-28.6}},
        color={0, 0, 127}));
  connect(TSupSetSig.y, economizer1.THeaSupSet)
    annotation(
      Line(
        points={{-58, 50}, {-54, 50}, {-54,-16}, {20,-16}, {20,-30.2}, {99,-30.2}},
        color={0, 0, 127}));
  connect(fanSta.y, economizer1.uSupFan)
    annotation(
      Line(
        points={{-58,-80}, {20,-80}, {20,-35.6}, {99,-35.6}},
        color={255, 0, 255}));
  connect(freProSta.y, economizer1.uFreProSta)
    annotation(
      Line(
        points={{-58,-120}, {26,-120}, {26,-39.6}, {99,-39.6}},
        color={255, 127, 0}));
  connect(hOutBelowCutoff.y, economizer1.hOut)
    annotation(
      Line(
        points={{-98, 20}, {-64, 20}, {-64,-12}, {24,-12}, {24,-25.4}, {99,-25.4}},
        color={0, 0, 127}));
  connect(hOutCut.y, economizer1.hCut)
    annotation(
      Line(
        points={{-98,-20}, {-20,-20}, {-20,-27}, {99,-27}},
        color={0, 0, 127}));
  connect(opeMod.y, economizer1.uOpeMod)
    annotation(
      Line(
        points={{-98,-100}, {22,-100}, {22,-37}, {99,-37}},
        color={255, 127, 0}));
  connect(zonSta.y, economizer1.uZonSta)
    annotation(
      Line(
        points={{-98,-60}, {24,-60}, {24,-38.2}, {99,-38.2}},
        color={255, 127, 0}));
  ...
  connect(VOutMinSetSig.y, economizer1.VOutMinSet_flow)
    annotation(
      Line(
        points={{-18, 90}, {14, 90}, {14,-30}, {99,-30}, {99,-31.6}},
        color={0, 0, 127}));
  connect(SupFanSpeSig.y, economizer.uSupFanSpe)
    annotation(
      Line(
        points={{-18, 50}, {-2, 50}, {-2, 7}, {19, 7}},
        color={0, 0, 127}));
  connect(SupFanSpeSig.y, economizer1.uSupFanSpe)
    annotation(
      Line(
        points={{-18, 50}, {78, 50}, {78,-33}, {99,-33}},
        color={0, 0, 127}));
  annotation(
    experiment(
      StopTime=900.0,
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_PR1/AHUs/SingleZone/VAV/Economizers/Validation/Controller_Mod_DamLim.mos"
        "Simulate and plot"),
    Icon(
      graphics={Ellipse(
        lineColor={75, 138, 73},
...
and modulation control loops"), Text(
        extent={{100, 6}, {154,-16}},
        lineColor={0, 0, 0},
        horizontalAlignment=TextAlignment.Left,
