...
equation
  connect(outDamPhyPosMaxSig.y, exhDamPos.x2)
    annotation(
      Line(
        points={{-18, 40}, {-4, 40}, {-4,-4}, {18,-4}},
        color={0, 0, 127}));
  connect(maxExhDam.y, exhDamPos.f2)
    annotation(
      Line(
        points={{-58, 20}, {-12, 20}, {-12,-8}, {18,-8}},
        color={0, 0, 127}));
  ...
  connect(zerDam.y, swi1.u3)
    annotation(
      Line(
        points={{42,-80}, {50,-80}, {50,-58}, {58,-58}},
        color={0, 0, 127}));
  ...
  connect(minPosAtMinSpd.y, exhDamPos.x1)
    annotation(
      Line(
        points={{-18, 80}, {12, 80}, {12, 8}, {18, 8}},
        color={0, 0, 127}));
  connect(minExhDam.y, exhDamPos.f1)
    annotation(
      Line(
        points={{-58, 60}, {4, 60}, {4, 4}, {18, 4}},
        color={0, 0, 127}));
  ...
  connect(uSupFan, and2.u2)
    annotation(
      Line(
        points={{-120,-50}, {-60,-50}, {-60,-58}, {-22,-58}},
        color={255, 0, 255}));
  connect(greThr.y, and2.u1)
    annotation(
      Line(
        points={{-38,-30}, {-32,-30}, {-32,-50}, {-22,-50}},
        color={255, 0, 255}));
  connect(exhDamPos.y, swi1.u1)
    annotation(
      Line(
        points={{42, 0}, {50, 0}, {50,-42}, {58,-42}},
        color={0, 0, 127}));
  connect(swi1.y, yExhDamPos)
    annotation(
      Line(
        points={{82,-50}, {90,-50}, {90, 0}, {120, 0}},
        color={0, 0, 127}));
  annotation(
