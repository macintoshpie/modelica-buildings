...
equation
  connect(breZonAre.y, breZon.u1)
    annotation(
      Line(
        points={{-38, 100}, {-30, 100}, {-30, 86}, {-22, 86}},
        color={0, 0, 127}));
  connect(gai.y, swi.u1)
    annotation(
      Line(
        points={{-138, 160}, {-70, 160}, {-70, 56}, {-62, 56}},
        color={0, 0, 127}));
  connect(breZonPop.y, swi.u3)
    annotation(
      Line(
        points={{-78, 30}, {-70, 30}, {-70, 40}, {-62, 40}},
        color={0, 0, 127}));
  connect(swi.y, breZon.u2)
    annotation(
      Line(
        points={{-38, 48}, {-30, 48}, {-30, 74}, {-22, 74}},
        color={0, 0, 127}));
  connect(disEffCoo.y, swi1.u1)
    annotation(
      Line(
        points={{-78,-20}, {-60,-20}, {-60,-52}, {-42,-52}},
        color={0, 0, 127}));
  connect(disEffHea.y, swi1.u3)
    annotation(
      Line(
        points={{-78,-90}, {-60,-90}, {-60,-68}, {-42,-68}},
        color={0, 0, 127}));
  connect(breZon.y, zonOutAirRate.u1)
    annotation(
      Line(
        points={{2, 80}, {10, 80}, {10, 36}, {18, 36}},
        color={0, 0, 127}));
  connect(swi1.y, zonOutAirRate.u2)
    annotation(
      Line(
        points={{-18,-60}, {10,-60}, {10, 24}, {18, 24}},
        color={0, 0, 127}));
  connect(uWin, swi2.u2)
    annotation(
      Line(
        points={{-220, 10}, {-190, 10}, {78, 10}},
        color={255, 0, 255}));
  connect(zerOutAir.y, swi2.u1)
    annotation(
      Line(
        points={{42,-30}, {60,-30}, {60, 2}, {78, 2}},
        color={0, 0, 127}));
  connect(zonOutAirRate.y, swi2.u3)
    annotation(
      Line(
        points={{42, 30}, {60, 30}, {60, 18}, {78, 18}},
        color={0, 0, 127}));
  connect(swi.u2, occSen.y)
    annotation(
      Line(
        points={{-62, 48}, {-76, 48}, {-76, 50}, {-138, 50}},
        color={255, 0, 255}));
  connect(nOcc, gai.u)
    annotation(
      Line(
        points={{-220, 160}, {-162, 160}},
        color={0, 0, 127}));
  connect(swi3.y, VOutMinSet_flow)
    annotation(
      Line(
        points={{162, 10}, {180, 10}, {180, 0}, {220, 0}},
        color={0, 0, 127}));
  connect(TZon, add2.u1)
    annotation(
      Line(
        points={{-220,-40}, {-200,-40}, {-180,-40}, {-180,-54}, {-162,-54}},
        color={0, 0, 127}));
  connect(TDis, add2.u2)
    annotation(
      Line(
        points={{-220,-80}, {-180,-80}, {-180,-66}, {-162,-66}},
        color={0, 0, 127}));
  connect(add2.y, hys.u)
    annotation(
      Line(
        points={{-138,-60}, {-102,-60}, {-102,-60}},
        color={0, 0, 127}));
  connect(hys.y, swi1.u2)
    annotation(
      Line(
        points={{-78,-60}, {-42,-60}, {-42,-60}},
        color={255, 0, 255}));
  connect(swi2.y, swi3.u3)
    annotation(
      Line(
        points={{102, 10}, {120, 10}, {120, 2}, {138, 2}},
        color={0, 0, 127}));
  connect(zerOutAir.y, swi3.u1)
    annotation(
      Line(
        points={{42,-30}, {110,-30}, {110, 18}, {138, 18}},
        color={0, 0, 127}));
  connect(and1.y, not1.u)
    annotation(
      Line(
        points={{-38,-120}, {-38,-120}, {-22,-120}},
        color={255, 0, 255}));
  connect(not1.y, swi3.u2)
    annotation(
      Line(
        points={{2,-120}, {130,-120}, {130, 10}, {138, 10}},
        color={255, 0, 255}));
  connect(uSupFan, and1.u1)
    annotation(
      Line(
        points={{-220,-120}, {-62,-120}},
        color={255, 0, 255}));
  connect(intEqu1.y, and1.u2)
    annotation(
      Line(
        points={{-118,-150}, {-90,-150}, {-90,-128}, {-62,-128}},
        color={255, 0, 255}));
  connect(uOpeMod, intEqu1.u1)
    annotation(
      Line(
        points={{-220,-150}, {-142,-150}, {-142,-150}},
        color={255, 127, 0}));
  connect(occMod.y, intEqu1.u2)
    annotation(
      Line(
        points={{-158,-170}, {-150,-170}, {-150,-158}, {-142,-158}},
        color={255, 127, 0}));
  connect(swi.u1, zerOcc.y)
    annotation(
      Line(
        points={{-62, 56}, {-70, 56}, {-70, 90}, {-138, 90}},
        color={0, 0, 127}));
  annotation(
    ...
    Icon(
      graphics={Rectangle(
        ...
        extent={{-84, 78}, {92,-72}},
        lineColor={0, 0, 0},
        textString="VOutMinSet_flow"), Text(
