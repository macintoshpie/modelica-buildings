  ...
  CDL.Logical.Switch switch
    ...
    annotation(
      Placement(
        transformation(
          extent={{72,-30}, {92,-10}})));
  CDL.Continuous.Sources.Constant fanOff(
    k=0)
    "Fan off status"
    annotation(
      Placement(
...
equation
  connect(offSetTSetHea.u, uCoo)
    annotation(
      Line(
        points={{-2, 180}, {-32, 180}, {-32, 82}, {-94, 82}, {-94, 70}, {-120, 70}},
        color={0, 0, 127}));
  connect(offSetTSetHea.y, addTHe.u2)
    annotation(
      Line(
        points={{22, 180}, {40, 180}, {40, 194}, {58, 194}},
        color={0, 0, 127}));
  connect(addTHe.y, TSupHeaEco)
    annotation(
      Line(
        points={{82, 200}, {92, 200}, {92, 100}, {120, 100}},
        color={0, 0, 127}));
  connect(TSetCooHig.y, addTSupCoo.u1)
    annotation(
      Line(
        points={{22, 140}, {40, 140}, {40, 126}, {58, 126}},
        color={0, 0, 127}));
  connect(offSetTSetCoo.y, addTSupCoo.u2)
    annotation(
      Line(
        points={{22, 100}, {40, 100}, {40, 114}, {58, 114}},
        color={0, 0, 127}));
  connect(TSetCooHig.u, uCoo)
    annotation(
      Line(
        points={{-2, 140}, {-32, 140}, {-32, 82}, {-94, 82}, {-94, 70}, {-120, 70}},
        color={0, 0, 127}));
  connect(offSetTSetCoo.u, uHea)
    annotation(
      Line(
        points={{-2, 100}, {-88, 100}, {-88, 110}, {-120, 110}},
        color={0, 0, 127}));
  connect(addTSupCoo.y, TSupCoo)
    annotation(
      Line(
        points={{82, 120}, {84, 120}, {84, 40}, {120, 40}},
        color={0, 0, 127}));
  connect(dT.u1, TZon)
    annotation(
      Line(
        points={{-72,-112}, {-86,-112}, {-86,-10}, {-120,-10}},
        color={0, 0, 127}));
  connect(dT.u2, TOut)
    annotation(
      Line(
        points={{-72,-124}, {-88,-124}, {-88,-80}, {-120,-80}},
        color={0, 0, 127}));
  connect(dT.y, yMed.u)
    annotation(
      Line(
        points={{-48,-118}, {-32,-118}},
        color={0, 0, 127}));
  ...
  connect(TDea.y, TSetHeaHig.f1)
    annotation(
      Line(
        points={{-58, 30}, {-52, 30}, {-52, 224}, {0, 224}},
        color={0, 0, 127}));
  connect(con05.y, TSetHeaHig.x2)
    annotation(
      Line(
        points={{-58, 150}, {-46, 150}, {-46, 216}, {0, 216}},
        color={0, 0, 127}));
  connect(conTSupSetMax.y, TSetHeaHig.f2)
    annotation(
      Line(
        points={{-58, 60}, {-40, 60}, {-40, 212}, {0, 212}},
        color={0, 0, 127}));
  connect(uHea, TSetHeaHig.u)
    annotation(
      Line(
        points={{-120, 110}, {-88, 110}, {-88, 102}, {-36, 102}, {-36, 220}, {0, 220}},
        color={0, 0, 127}));
  connect(TSetHeaHig.y, addTHe.u1)
    annotation(
      Line(
        points={{24, 220}, {40, 220}, {40, 206}, {58, 206}},
        color={0, 0, 127}));
  connect(con0.y, offSetTSetHea.x1)
    annotation(
      Line(
        points={{-58, 220}, {-56, 220}, {-56, 188}, {-2, 188}},
        color={0, 0, 127}));
  connect(con25.y, offSetTSetHea.x2)
    annotation(
      Line(
        points={{-58, 180}, {-34, 180}, {-34, 176}, {-2, 176}},
        color={0, 0, 127}));
  connect(con0.y, offSetTSetHea.f1)
    annotation(
      Line(
        points={{-58, 220}, {-56, 220}, {-56, 184}, {-2, 184}},
        color={0, 0, 127}));
  connect(TDea.y, TDeaTSupSetMin.u1)
    annotation(
      Line(
        points={{-58, 30}, {-40, 30}, {-40, 16}, {-22, 16}},
        color={0, 0, 127}));
  connect(conTSupSetMin.y, TDeaTSupSetMin.u2)
    annotation(
      Line(
        points={{-58, 0}, {-40, 0}, {-40, 4}, {-22, 4}},
        color={0, 0, 127}));
  ...
  connect(addTDea.y, offSetTSetHea.f2)
    annotation(
      Line(
        points={{32, 10}, {34, 10}, {34, 70}, {-14, 70}, {-14, 172}, {-2, 172}},
        color={0, 0, 127}));
  connect(TSetCooHig.x1, con05.y)
    annotation(
      Line(
        points={{-2, 148}, {-30, 148}, {-30, 150}, {-58, 150}},
        color={0, 0, 127}));
  connect(TSetCooHig.f1, TDea.y)
    annotation(
      Line(
        points={{-2, 144}, {-52, 144}, {-52, 30}, {-58, 30}},
        color={0, 0, 127}));
  connect(TSetCooHig.x2, con75.y)
    annotation(
      Line(
        points={{-2, 136}, {-44, 136}, {-44, 120}, {-58, 120}},
        color={0, 0, 127}));
  connect(TSetCooHig.f2, conTSupSetMin.y)
    annotation(
      Line(
        points={{-2, 132}, {-50, 132}, {-50, 0}, {-58, 0}},
        color={0, 0, 127}));
  connect(offSetTSetCoo.f1, con0.y)
    annotation(
      Line(
        points={{-2, 104}, {-56, 104}, {-56, 220}, {-58, 220}},
        color={0, 0, 127}));
  connect(offSetTSetCoo.x1, con0.y)
    annotation(
      Line(
        points={{-2, 108}, {-56, 108}, {-56, 220}, {-58, 220}},
        color={0, 0, 127}));
  connect(offSetTSetCoo.x2, con05.y)
    annotation(
      Line(
        points={{-2, 96}, {-46, 96}, {-46, 150}, {-58, 150}},
        color={0, 0, 127}));
  connect(TSupSetMaxTDea.u1, conTSupSetMax.y)
    annotation(
      Line(
        points={{-22, 56}, {-40, 56}, {-40, 60}, {-58, 60}},
        color={0, 0, 127}));
  connect(TDea.y, TSupSetMaxTDea.u2)
    annotation(
      Line(
        points={{-58, 30}, {-40, 30}, {-40, 44}, {-22, 44}},
        color={0, 0, 127}));
  connect(TSupSetMaxTDea.y, offSetTSetCoo.f2)
    annotation(
      Line(
        points={{2, 50}, {10, 50}, {10, 80}, {-10, 80}, {-10, 92}, {-2, 92}},
        color={0, 0, 127}));
  connect(uCoo, lin050.u)
    annotation(
      Line(
        points={{-120, 70}, {-94, 70}, {-94,-146}, {-38,-146}, {-38,-192}, {-22,-192}},
        color={0, 0, 127}));
  connect(dY075.u1, con4.y)
    annotation(
      Line(
        points={{-38,-278}, {-54,-278}},
        color={0, 0, 127}));
  connect(lin075.x2, con2.y)
    annotation(
      Line(
        points={{32,-288}, {24,-288}, {24,-310}, {22,-310}},
        color={0, 0, 127}));
  connect(lin075.x1, con5.y)
    annotation(
      Line(
        points={{32,-276}, {22,-276}},
        color={0, 0, 127}));
  connect(uCoo, lin075.u)
    annotation(
      Line(
        points={{-120, 70}, {-90, 70}, {-90,-252}, {24,-252}, {24,-284}, {32,-284}},
        color={0, 0, 127}));
  connect(yMedLim.y, yOffSet.u)
    annotation(
      Line(
        points={{22,-118}, {34,-118}},
        color={0, 0, 127}));
  connect(dY075.u2, yOffSet.y)
    annotation(
      Line(
        points={{-38,-290}, {-42,-290}, {-42,-160}, {70,-160}, {70,-118}, {58,-118}},
        color={0, 0, 127}));
  connect(offCoo.u1, lin050.y)
    annotation(
      Line(
        points={{38,-186}, {20,-186}, {20,-192}, {2,-192}},
        color={0, 0, 127}));
  connect(offCoo.u2, lin075.y)
    annotation(
      Line(
        points={{38,-198}, {34,-198}, {34,-256}, {60,-256}, {60,-284}, {56,-284}},
        color={0, 0, 127}));
  connect(offCoo.y, addHeaCoo.u2)
    annotation(
      Line(
        points={{62,-192}, {90,-192}, {90,-80}, {30,-80}, {30,-62}, {38,-62}},
        color={0, 0, 127}));
  connect(lin050.x2, con1.y)
    annotation(
      Line(
        points={{-22,-196}, {-46,-196}, {-46,-222}, {-58,-222}},
        color={0, 0, 127}));
  connect(con025.y, lin050.x1)
    annotation(
      Line(
        points={{-58,-166}, {-52,-166}, {-52,-184}, {-22,-184}},
        color={0, 0, 127}));
  connect(lin050.f2, yOffSet.y)
    annotation(
      Line(
        points={{-22,-200}, {-42,-200}, {-42,-160}, {70,-160}, {70,-118}, {58,-118}},
        color={0, 0, 127}));
  connect(con3.y, lin050.f1)
    annotation(
      Line(
        points={{-58,-196}, {-50,-196}, {-50,-188}, {-22,-188}},
        color={0, 0, 127}));
  connect(dY075.y, lin075.f2)
    annotation(
      Line(
        points={{-14,-284}, {-8,-284}, {-8,-292}, {32,-292}},
        color={0, 0, 127}));
  connect(con6.y, lin075.f1)
    annotation(
      Line(
        points={{22,-340}, {24,-340}, {24,-280}, {32,-280}},
        color={0, 0, 127}));
  connect(TSetHeaHig.x1, con0.y)
    annotation(
      Line(
        points={{0, 228}, {-56, 228}, {-56, 220}, {-58, 220}},
        color={0, 0, 127}));
  connect(con7.y, yHea.x1)
    annotation(
      Line(
        points={{-18,-30}, {-6,-30}, {-6,-42}, {2,-42}},
        color={0, 0, 127}));
  connect(minSpe.y, yHea.f1)
    annotation(
      Line(
        points={{-58,-30}, {-56,-30}, {-56,-46}, {2,-46}},
        color={0, 0, 127}));
  connect(uHea, yHea.u)
    annotation(
      Line(
        points={{-120, 110}, {-94, 110}, {-94,-50}, {2,-50}},
        color={0, 0, 127}));
  connect(conOne.y, yHea.x2)
    annotation(
      Line(
        points={{-58,-70}, {-56,-70}, {-56,-54}, {2,-54}},
        color={0, 0, 127}));
  connect(maxHeaSpe.y, yHea.f2)
    annotation(
      Line(
        points={{-18,-70}, {-6,-70}, {-6,-58}, {2,-58}},
        color={0, 0, 127}));
  ...
  connect(uFan, switch.u2)
    annotation(
      Line(
        points={{-120,-140}, {84,-140}, {84,-42}, {68,-42}, {68,-20}, {70,-20}},
        color={255, 0, 255}));
  connect(addHeaCoo.y, switch.u1)
    annotation(
      Line(
        points={{62,-56}, {64,-56}, {64,-12}, {70,-12}},
        color={0, 0, 127}));
  connect(fanOff.y, switch.u3)
    annotation(
      Line(
        points={{62,-10}, {66,-10}, {66,-28}, {70,-28}},
        color={0, 0, 127}));
  connect(switch.y, y)
    annotation(
      Line(
        points={{94,-20}, {96,-20}, {96,-60}, {120,-60}},
        color={0, 0, 127}));
  annotation(
    ...
    Icon(
      ...
      graphics={Rectangle(
        ...
        lineColor={0, 0, 0},
        textString="y"), Line(
        points={{-46, 44}, {-28, 20}, {18, 20}, {28, 36}, {38, 36}, {50, 54}},
        color={0, 0, 0}), Line(
        points={{18, 20}, {38, 20}, {50, 54}, {28, 54}, {18, 20}},
        color={0, 0, 0}), Text(
        extent={{-96, 30}, {-70, 8}},
        lineColor={0, 0, 127},
        fillColor={0, 0, 0},
        fillPattern=FillPattern.Solid,
        textString="TZonSet"), Text(
        extent={{-98,-82}, {-72,-104}},
        lineColor={0, 0, 127},
        fillColor={0, 0, 0},
        fillPattern=FillPattern.Solid,
    ...
    Diagram(
      ...
      graphics={Rectangle(
        ...
        fillColor={215, 215, 215},
        fillPattern=FillPattern.Solid,
        textString="0.25 < yCoo < 0.5"), Text(
        extent={{46,-316}, {82,-298}},
        lineColor={0, 0, 0},
        fillColor={215, 215, 215},
        fillPattern=FillPattern.Solid,
        textString="0.75 < yCoo < 1"), Rectangle(
        ...
        fillColor={215, 215, 215},
        fillPattern=FillPattern.Solid,
        textString="0.5 < yCoo < 0.75"), Rectangle(
        extent={{-84,-16}, {26,-86}},
        lineColor={0, 0, 0},
        fillColor={215, 215, 215},
        fillPattern=FillPattern.Solid), Text(
...
cooling control signals to output yFan"), Rectangle(
