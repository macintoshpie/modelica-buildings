...
model OutsideAirFlow
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.SingleZone.VAV.SetPoints.OutsideAirFlow outAirSet_SinZon(
    AFlo=40,
    have_occSen=true)
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Ramp numOfOcc(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60, 40}, {-40, 60}})));
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.SingleZone.VAV.SetPoints.OutsideAirFlow outAirSet_SinZon_noOccSen(
    AFlo=40,
    have_occSen=false)
...
equation
  ...
  connect(supFan.y, outAirSet_SinZon_noOccSen.uSupFan)
    annotation(
      Line(
        points={{-39,-70}, {-30,-70}, {-30,-52}, {18,-52}},
        color={255, 0, 255}));
  connect(TDis.y, outAirSet_SinZon_noOccSen.TDis)
    annotation(
      Line(
        points={{-39,-10}, {0,-10}, {0,-40}, {18,-40}},
        color={0, 0, 127}));
  annotation(
    experiment(
      StopTime=3600.0,
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_PR1/AHUs/SingleZone/VAV/SetPoints/Validation/OutsideAirFlow.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
