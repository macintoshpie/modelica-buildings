  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.SingleZone.VAV.SetPoints.Supply setPoiVAV(
    ...
    annotation(
      Placement(
        transformation(
          extent={{0,-10}, {20, 10}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant uHea(
    k=0)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-80, 70}, {-60, 90}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant uCoo(
    k=0.6)
...
equation
  connect(uCoo.y, setPoiVAV.uCoo)
    annotation(
      Line(
        points={{-58, 50}, {-31.5, 50}, {-31.5, 5}, {-2, 5}},
        color={0, 0, 127}));
  connect(TZon.y, setPoiVAV.TZon)
    annotation(
      Line(
        points={{-58,-10}, {-32,-10}, {-32,-1.66667}, {-2,-1.66667}},
        color={0, 0, 127}));
  connect(TOut.y, setPoiVAV.TOut)
    annotation(
      Line(
        points={{-58,-50}, {-28,-50}, {-28,-5}, {-2,-5}},
        color={0, 0, 127}));
  connect(uHea.y, setPoiVAV.uHea)
    annotation(
      Line(
        points={{-58, 80}, {-58, 80}, {-20, 80}, {-20, 8.33333}, {-2, 8.33333}},
        color={0, 0, 127}));
  connect(dT.u1, TZon.y)
    annotation(
      Line(
        points={{-2,-34}, {-32,-34}, {-32,-10}, {-58,-10}},
        color={0, 0, 127}));
  connect(dT.u2, TOut.y)
    annotation(
      Line(
        points={{-2,-46}, {-28,-46}, {-28,-50}, {-58,-50}},
        color={0, 0, 127}));
  connect(TZonSet.y, setPoiVAV.TZonSet)
    annotation(
      Line(
        points={{-58, 20}, {-40, 20}, {-40, 1.66667}, {-2, 1.66667}},
        color={0, 0, 127}));
  connect(fanSta.y, setPoiVAV.uFan)
    annotation(
      Line(
        points={{-58,-90}, {-10,-90}, {-10,-8.33333}, {-2,-8.33333}},
        color={255, 0, 255}));
  annotation(
    experiment(
      StopTime=1.0,
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_PR1/AHUs/SingleZone/VAV/SetPoints/Validation/Supply_T.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
