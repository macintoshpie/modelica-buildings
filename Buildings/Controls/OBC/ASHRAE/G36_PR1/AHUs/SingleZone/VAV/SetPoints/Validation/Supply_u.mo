  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.SingleZone.VAV.SetPoints.Supply setPoiVAV(
    ...
    annotation(
      Placement(
        transformation(
          extent={{0, 40}, {20, 60}})));
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.SingleZone.VAV.SetPoints.Supply setPoiVAV1(
    yHeaMax=0.7,
    yMin=0.3,
    TSupSetMax=303.15,
    TSupSetMin=289.15)
    ...
    annotation(
      Placement(
        transformation(
          extent={{0, 0}, {20, 20}})));
  Buildings.Controls.OBC.ASHRAE.G36_PR1.AHUs.SingleZone.VAV.SetPoints.Supply setPoiVAV2(
    yHeaMax=0.7,
    yMin=0.3,
    TSupSetMax=303.15,
    TSupSetMin=289.15)
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant TZon1(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-80,-80}, {-60,-60}})));
  CDL.Logical.Sources.Constant fanSta(
    k=true)
    "Fan is on"
    annotation(
      Placement(
...
equation
  ...
  connect(TOut.y, setPoiVAV.TOut)
    annotation(
      Line(
        points={{-58,-40}, {-24,-40}, {-24, 45}, {-2, 45}},
        color={0, 0, 127}));
  connect(uHea.y, setPoiVAV.uHea)
    annotation(
      Line(
        points={{-58, 80}, {-12, 80}, {-12, 58.3333}, {-2, 58.3333}},
        color={0, 0, 127}));
  connect(uCoo.y, setPoiVAV.uCoo)
    annotation(
      Line(
        points={{-58, 50}, {-16, 50}, {-16, 55}, {-2, 55}},
        color={0, 0, 127}));
  connect(TZonSet.y, setPoiVAV.TZonSet)
    annotation(
      Line(
        points={{-58, 20}, {-10, 20}, {-10, 51.6667}, {-2, 51.6667}},
        color={0, 0, 127}));
  connect(TOut.y, setPoiVAV1.TOut)
    annotation(
      Line(
        points={{-58,-40}, {-24,-40}, {-24, 5}, {-2, 5}},
        color={0, 0, 127}));
  connect(uHea.y, setPoiVAV1.uHea)
    annotation(
      Line(
        points={{-58, 80}, {-12, 80}, {-12, 18.3333}, {-2, 18.3333}},
        color={0, 0, 127}));
  connect(uCoo.y, setPoiVAV1.uCoo)
    annotation(
      Line(
        points={{-58, 50}, {-16, 50}, {-16, 15}, {-2, 15}},
        color={0, 0, 127}));
  connect(TZonSet.y, setPoiVAV1.TZonSet)
    annotation(
      Line(
        points={{-58, 20}, {-10, 20}, {-10, 11.6667}, {-2, 11.6667}},
        color={0, 0, 127}));
  connect(TOut.y, setPoiVAV2.TOut)
    annotation(
      Line(
        points={{-58,-40}, {-24,-40}, {-24,-35}, {-2,-35}},
        color={0, 0, 127}));
  connect(uHea.y, setPoiVAV2.uHea)
    annotation(
      Line(
        points={{-58, 80}, {-12, 80}, {-12,-21.6667}, {-2,-21.6667}},
        color={0, 0, 127}));
  connect(uCoo.y, setPoiVAV2.uCoo)
    annotation(
      Line(
        points={{-58, 50}, {-16, 50}, {-16,-25}, {-2,-25}},
        color={0, 0, 127}));
  connect(TZonSet.y, setPoiVAV2.TZonSet)
    annotation(
      Line(
        points={{-58, 20}, {-10, 20}, {-10,-28.3333}, {-2,-28.3333}},
        color={0, 0, 127}));
  ...
  connect(fanSta.y, setPoiVAV.uFan)
    annotation(
      Line(
        points={{-58,-100}, {-6,-100}, {-6, 41.6667}, {-2, 41.6667}},
        color={255, 0, 255}));
  connect(setPoiVAV1.uFan, setPoiVAV.uFan)
    annotation(
      Line(
        points={{-2, 1.66667}, {-6, 1.66667}, {-6, 41.6667}, {-2, 41.6667}},
        color={255, 0, 255}));
  connect(setPoiVAV2.uFan, setPoiVAV.uFan)
    annotation(
      Line(
        points={{-2,-38.3333}, {-6,-38.3333}, {-6, 41.6667}, {-2, 41.6667}},
        color={255, 0, 255}));
  annotation(
    experiment(
      StopTime=1.0,
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_PR1/AHUs/SingleZone/VAV/SetPoints/Validation/Supply_u.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
