  ...
  CDL.Continuous.Sources.Constant TSupSetSig(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-80, 60}, {-60, 80}})));
  CDL.Logical.Sources.Constant fanStatus(
    k=true)
    "Fan is on"
    annotation(
      Placement(
...
equation
  connect(TSup.y, cooCoi.TSup)
    annotation(
      Line(
        points={{-58, 30}, {-40, 30}, {-40, 4}, {-12, 4}},
        color={0, 0, 127}));
  connect(TSupSetSig.y, cooCoi.TSupCoo)
    annotation(
      Line(
        points={{-58, 70}, {-36, 70}, {-36, 8}, {-12, 8}},
        color={0, 0, 127}));
  connect(fanStatus.y, cooCoi.uSupFan)
    annotation(
      Line(
        points={{-58,-50}, {-20,-50}, {-20,-8}, {-12,-8}},
        color={255, 0, 255}));
  ...
  annotation(
    ...
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_PR1/AHUs/SingleZone/VAV/Validation/CoolingCoil.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
