...
equation
  ...
  connect(hysUHea.y, isHea.u1)
    annotation(
      Line(
        points={{-98, 70}, {-76, 70}, {-76, 40}, {-74, 40}},
        color={255, 0, 255}));
  connect(uHea, hysUHea.u)
    annotation(
      Line(
        points={{-160, 40}, {-136, 40}, {-136, 70}, {-122, 70}},
        color={0, 0, 127}));
  connect(uCoo, hysUCoo.u)
    annotation(
      Line(
        points={{-160,-40}, {-102,-40}},
        color={0, 0, 127}));
  connect(uCoo, uHeaMinUCoo.u2)
    annotation(
      Line(
        points={{-160,-40}, {-136,-40}, {-136, 4}, {-132, 4}},
        color={0, 0, 127}));
  connect(uHea, uHeaMinUCoo.u1)
    annotation(
      Line(
        points={{-160, 40}, {-136, 40}, {-136, 16}, {-132, 16}},
        color={0, 0, 127}));
  ...
  connect(hysUCoo.y, isCoo.u2)
    annotation(
      Line(
        points={{-78,-40}, {-20,-40}, {-20,-28}, {-12,-28}},
        color={255, 0, 255}));
  connect(uHeaMinUCoo.y, hysU.u)
    annotation(
      Line(
        points={{-108, 10}, {-102, 10}},
        color={0, 0, 127}));
  ...
  connect(isHea.y, notHea.u)
    annotation(
      Line(
        points={{-50, 40}, {-48, 40}, {-48, 10}, {-46, 10}},
        color={255, 0, 255}));
  connect(hysU.y, isHea.u2)
    annotation(
      Line(
        points={{-78, 10}, {-76, 10}, {-76, 32}, {-74, 32}},
        color={255, 0, 255}));
  connect(notHea.y, isCoo.u1)
    annotation(
      Line(
        points={{-22, 10}, {-20, 10}, {-20,-20}, {-12,-20}},
        color={255, 0, 255}));
  connect(isCoo.y, isDea.u2)
    annotation(
      Line(
        points={{12,-20}, {20,-20}, {20,-78}, {28,-78}},
        color={255, 0, 255}));
  connect(isHea.y, isDea.u1)
    annotation(
      Line(
        points={{-50, 40}, {-48, 40}, {-48,-70}, {28,-70}},
        color={255, 0, 255}));
  connect(booToIntHea.y, addInt.u1)
    annotation(
      Line(
        points={{22, 40}, {60, 40}, {60, 36}, {68, 36}},
        color={255, 127, 0}));
  connect(booToIntCoo.y, addInt.u2)
    annotation(
      Line(
        points={{50,-20}, {60,-20}, {60, 24}, {68, 24}},
        color={255, 127, 0}));
  connect(addInt.y, addInt1.u1)
    annotation(
      Line(
        points={{92, 30}, {100, 30}, {100, 6}, {108, 6}},
        color={255, 127, 0}));
  connect(booToIntDea.y, addInt1.u2)
    annotation(
      Line(
        points={{92,-70}, {100,-70}, {100,-6}, {108,-6}},
        color={255, 127, 0}));
