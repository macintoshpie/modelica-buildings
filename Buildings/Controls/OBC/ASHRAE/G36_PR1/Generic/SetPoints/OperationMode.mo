...
block OperationMode
  ...
  parameter Real TZonFreProOn(final unit="K", final displayUnit="degC", final quantity="ThermodynamicTemperature")=277.55
    "Threshold zone temperature value to activate freeze protection mode";
  parameter Real TZonFreProOff(final unit="K", final displayUnit="degC", final quantity="ThermodynamicTemperature")=280.35
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput uOcc
    ...
    annotation(Placement(transformation(extent={{-300, 310}, {-260, 350}}), iconTransformation(extent={{-140, 100}, {-100, 140}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealInput tNexOcc(final unit="s", final quantity="Time")
    "Time to next occupied period"
    annotation(Placement(transformation(extent={{-300, 270}, {-260, 310}}), iconTransformation(extent={{-140, 80}, {-100, 120}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealInput maxCooDowTim(final unit="s", final quantity="Time")
    "Maximum cool-down time among all the zones"
    annotation(Placement(transformation(extent={{-300, 210}, {-260, 250}}), iconTransformation(extent={{-140, 60}, {-100, 100}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealInput maxWarUpTim(final unit="s", final quantity="Time")
    "Maximum warm-up time among all the zones"
    annotation(Placement(transformation(extent={{-300, 130}, {-260, 170}}), iconTransformation(extent={{-140, 40}, {-100, 80}})));
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput occHeaHigMin
    ...
    annotation(Placement(transformation(extent={{-300, 90}, {-260, 130}}), iconTransformation(extent={{-140, 20}, {-100, 60}})));
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput maxHigOccCoo
    ...
    annotation(Placement(transformation(extent={{-300, 60}, {-260, 100}}), iconTransformation(extent={{-140, 0}, {-100, 40}})));
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput uWinSta if have_winSen
    "Window status: true=open, false=close"
    annotation(Placement(transformation(extent={{-300, 30}, {-260, 70}}), iconTransformation(extent={{-140,-20}, {-100, 20}})));
  Buildings.Controls.OBC.CDL.Interfaces.IntegerInput totColZon
    "Total number of cold zone"
    annotation(Placement(transformation(extent={{-300,-30}, {-260, 10}}), iconTransformation(extent={{-140,-40}, {-100, 0}})));
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput unoHeaHigMin
    ...
    annotation(Placement(transformation(extent={{-300,-90}, {-260,-50}}), iconTransformation(extent={{-140,-60}, {-100,-20}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealInput TZonMax(final unit="K", final displayUnit="degC", final quantity="ThermodynamicTemperature")
    "Maximum zone temperature"
    annotation(Placement(transformation(extent={{-300,-130}, {-260,-90}}), iconTransformation(extent={{-140,-80}, {-100,-40}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealInput TZonMin(final unit="K", final displayUnit="degC", final quantity="ThermodynamicTemperature")
    "Minimum zone temperature"
    annotation(Placement(transformation(extent={{-300,-170}, {-260,-130}}), iconTransformation(extent={{-140,-100}, {-100,-60}})));
  Buildings.Controls.OBC.CDL.Interfaces.IntegerInput totHotZon
    "Total number of hot zone"
    annotation(Placement(transformation(extent={{-300,-230}, {-260,-190}}), iconTransformation(extent={{-140,-120}, {-100,-80}})));
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput maxHigUnoCoo
    ...
    annotation(Placement(transformation(extent={{-300,-290}, {-260,-250}}), iconTransformation(extent={{-140,-140}, {-100,-100}})));
  Buildings.Controls.OBC.CDL.Interfaces.IntegerOutput yOpeMod
    "Operation mode"
    annotation(Placement(transformation(extent={{460,-40}, {500, 0}}), iconTransformation(extent={{100,-20}, {140, 20}})));
protected
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant occModInd(final k=Buildings.Controls.OBC.ASHRAE.G36_PR1.Types.OperationModes.occupied)
    "Occupied mode "
  ...
  Buildings.Controls.OBC.CDL.Logical.Switch corCooDowTim
    "Corrected cool down period"
    annotation(Placement(transformation(extent={{-20, 200}, {0, 220}})));
  Buildings.Controls.OBC.CDL.Logical.Switch corWarUpTim
    "Corrected warm-up period"
    annotation(Placement(transformation(extent={{-20, 160}, {0, 180}})));
  Buildings.Controls.OBC.CDL.Integers.GreaterThreshold intGreThr(final threshold=4)
    "Check if the number of cold zones is not less than than 5"
    annotation(Placement(transformation(extent={{-180,-20}, {-160, 0}})));
  Buildings.Controls.OBC.CDL.Integers.GreaterThreshold intGreThr1(final threshold=numZon-1)
  ...
  Buildings.Controls.OBC.CDL.Continuous.Hysteresis hys2(final pre_y_start=true, final uHigh=0, final uLow=-60)
  ...
  Buildings.Controls.OBC.CDL.Continuous.Hysteresis hys3(final pre_y_start=true, final uHigh=0, final uLow=-60)
  ...
  Buildings.Controls.OBC.CDL.Continuous.Hysteresis hys4(final pre_y_start=false, final uHigh=0, final uLow=-60)
    "Hysteresis to activate the cool-down model"
    annotation(Placement(transformation(extent={{80, 210}, {100, 230}})));
  Buildings.Controls.OBC.CDL.Continuous.Hysteresis hys5(final pre_y_start=false, final uHigh=0, final uLow=-60)
    "Hysteresis to activate the warm-up model"
    annotation(Placement(transformation(extent={{80, 170}, {100, 190}})));
  Buildings.Controls.OBC.CDL.Continuous.Add add6(final k1=-1)
  ...
  Buildings.Controls.OBC.CDL.Continuous.Hysteresis hys9(final pre_y_start=false, final uLow=-0.1, final uHigh=0.1)
    "Hysteresis that outputs if any zone temperature is lower than freeze protection threshold temperature"
    annotation(Placement(transformation(extent={{-140,-120}, {-120,-100}})));
  Buildings.Controls.OBC.CDL.Continuous.AddParameter addPar(final p=TZonFreProOn, final k=-1)
  ...
  Buildings.Controls.OBC.CDL.Continuous.Hysteresis hys10(final pre_y_start=false, final uLow=-0.1, final uHigh=0.1)
  ...
  Buildings.Controls.OBC.CDL.Continuous.AddParameter addPar1(final k=1, final p=(-1)*TZonFreProOff)
  ...
  Buildings.Controls.OBC.CDL.Continuous.AddParameter addPar2(final p=preWarCooTim, final k=-1)
  ...
  Buildings.Controls.OBC.CDL.Continuous.AddParameter addPar3(final p=preWarCooTim, final k=-1)
    "Calculate the differential between maximum warm-up time and the allowed maximum warm-up time"
    annotation(Placement(transformation(extent={{-140, 160}, {-120, 180}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant maxWarCooTime(final k=preWarCooTim)
  ...
  Buildings.Controls.OBC.CDL.Conversions.BooleanToInteger booToInt1(final integerTrue=Buildings.Controls.OBC.ASHRAE.G36_PR1.Types.OperationModes.warmUp)
    "Convert Boolean to Integer number"
    annotation(Placement(transformation(extent={{260, 170}, {280, 190}})));
  Buildings.Controls.OBC.CDL.Conversions.BooleanToInteger booToInt(final integerTrue=Buildings.Controls.OBC.ASHRAE.G36_PR1.Types.OperationModes.coolDown)
    "Convert Boolean to Integer number"
    annotation(Placement(transformation(extent={{260, 210}, {280, 230}})));
  Buildings.Controls.OBC.CDL.Conversions.BooleanToInteger booToInt3(final integerTrue=Buildings.Controls.OBC.ASHRAE.G36_PR1.Types.OperationModes.unoccupied)
    "Convert Boolean to Integer "
    annotation(Placement(transformation(extent={{220,-340}, {240,-320}})));
  Buildings.Controls.OBC.CDL.Conversions.BooleanToReal booToRea6(final realTrue=Buildings.Controls.OBC.ASHRAE.G36_PR1.Types.OperationModes.setUp)
    "Convert Boolean to Real "
    annotation(Placement(transformation(extent={{60,-220}, {80,-200}})));
  Buildings.Controls.OBC.CDL.Conversions.BooleanToReal booToRea4(final realTrue=Buildings.Controls.OBC.ASHRAE.G36_PR1.Types.OperationModes.freezeProtection)
    "Convert Boolean to Real "
    annotation(Placement(transformation(extent={{60,-120}, {80,-100}})));
  Buildings.Controls.OBC.CDL.Conversions.BooleanToReal booToRea3(final realTrue=Buildings.Controls.OBC.ASHRAE.G36_PR1.Types.OperationModes.setBack)
    "Convert Boolean to Real "
    annotation(Placement(transformation(extent={{60,-20}, {80, 0}})));
  Buildings.Controls.OBC.CDL.Utilities.Assert assMes(final message="Level 3 alarm: freeze protection setback")
  ...
  Buildings.Controls.OBC.CDL.Logical.And and1
    "Check if the warm-up time should be activated"
    annotation(Placement(transformation(extent={{200, 170}, {220, 190}})));
  Buildings.Controls.OBC.CDL.Logical.And and2
    "Check if the cool-down time should be activated"
  ...
  Buildings.Controls.OBC.CDL.Integers.GreaterThreshold notOcc(final threshold=1) if have_winSen
  ...
  Buildings.Controls.OBC.CDL.Logical.Not not1 if have_winSen
    "Logical not"
    annotation(Placement(transformation(extent={{300, 40}, {320, 60}})));
  Buildings.Controls.OBC.CDL.Utilities.Assert winOpe(final message="Level 4 alarm: window open during modes other than occupied mode") if have_winSen
...
equation
  connect(swi.y, occMod.u)
    annotation(Line(points={{282, 280}, {298, 280}}, color={0, 0, 127}));
  connect(occModInd.y, swi.u1)
    annotation(Line(points={{222, 310}, {240, 310}, {240, 288}, {258, 288}}, color={0, 0, 127}, pattern=LinePattern.Dash));
  connect(unoPerInd.y, swi.u3)
    annotation(Line(points={{122, 260}, {150, 260}, {150, 272}, {258, 272}}, color={0, 0, 127}, pattern=LinePattern.Dash));
  connect(intGreThr.y, or1.u1)
    annotation(Line(points={{-158,-10}, {-102,-10}}, color={255, 0, 255}));
  connect(intGreThr1.y, or1.u2)
    annotation(Line(points={{-158,-40}, {-120,-40}, {-120,-18}, {-102,-18}}, color={255, 0, 255}));
  connect(or1.y, lat.u)
    annotation(Line(points={{-78,-10}, {-42,-10}}, color={255, 0, 255}));
  connect(falEdg.y, lat.clr)
    annotation(Line(points={{-78,-50}, {-60,-50}, {-60,-16}, {-42,-16}}, color={255, 0, 255}));
  connect(lat.y, booToRea3.u)
    annotation(Line(points={{-18,-10}, {58,-10}}, color={255, 0, 255}));
  connect(unoPerInd.y, swi3.u1)
    annotation(Line(points={{122, 260}, {150, 260}, {150,-2}, {158,-2}}, color={0, 0, 127}, pattern=LinePattern.Dash));
  connect(or3.y, swi3.u2)
    annotation(Line(points={{22, 30}, {140, 30}, {140,-10}, {158,-10}}, color={255, 0, 255}));
  connect(lat1.y, booToRea4.u)
    annotation(Line(points={{-18,-110}, {58,-110}}, color={255, 0, 255}));
  connect(or3.y, swi4.u2)
    annotation(Line(points={{22, 30}, {140, 30}, {140,-110}, {158,-110}}, color={255, 0, 255}));
  connect(unoPerInd.y, swi4.u1)
    annotation(Line(points={{122, 260}, {150, 260}, {150,-102}, {158,-102}}, color={0, 0, 127}, pattern=LinePattern.Dash));
  connect(or4.y, lat2.u)
    annotation(Line(points={{-78,-210}, {-42,-210}}, color={255, 0, 255}));
  connect(falEdg1.y, lat2.clr)
    annotation(Line(points={{-78,-250}, {-60,-250}, {-60,-216}, {-42,-216}}, color={255, 0, 255}));
  connect(lat2.y, booToRea6.u)
    annotation(Line(points={{-18,-210}, {58,-210}}, color={255, 0, 255}));
  connect(or3.y, swi5.u2)
    annotation(Line(points={{22, 30}, {140, 30}, {140,-210}, {158,-210}}, color={255, 0, 255}));
  connect(unoPerInd.y, swi5.u1)
    annotation(Line(points={{122, 260}, {150, 260}, {150,-202}, {158,-202}}, color={0, 0, 127}, pattern=LinePattern.Dash));
  connect(swi3.y, setBacMod.u)
    annotation(Line(points={{182,-10}, {198,-10}}, color={0, 0, 127}));
  connect(swi4.y, freProSetBacMod.u)
    annotation(Line(points={{182,-110}, {198,-110}}, color={0, 0, 127}));
  connect(swi5.y, setUpMod.u)
    annotation(Line(points={{182,-210}, {198,-210}}, color={0, 0, 127}));
  connect(lat.y, or5.u1)
    annotation(Line(points={{-18,-10}, {10,-10}, {10,-302}, {58,-302}}, color={255, 0, 255}));
  connect(lat1.y, or5.u2)
    annotation(Line(points={{-18,-110}, {0,-110}, {0,-310}, {58,-310}}, color={255, 0, 255}));
  connect(lat2.y, or5.u3)
    annotation(Line(points={{-18,-210}, {20,-210}, {20,-318}, {58,-318}}, color={255, 0, 255}));
  connect(or5.y, or6.u1)
    annotation(Line(points={{82,-310}, {100,-310}, {100,-330}, {118,-330}}, color={255, 0, 255}));
  connect(or3.y, or6.u2)
    annotation(Line(points={{22, 30}, {40, 30}, {40,-338}, {118,-338}}, color={255, 0, 255}));
  connect(or6.y, not2.u)
    annotation(Line(points={{142,-330}, {178,-330}}, color={255, 0, 255}));
  connect(not2.y, booToInt3.u)
    annotation(Line(points={{202,-330}, {218,-330}}, color={255, 0, 255}));
  ...
  connect(and2.y, or3.u2)
    annotation(Line(points={{222, 220}, {230, 220}, {230, 100}, {-20, 100}, {-20, 30}, {-2, 30}}, color={255, 0, 255}));
  connect(and1.y, or3.u1)
    annotation(Line(points={{222, 180}, {240, 180}, {240, 90}, {-10, 90}, {-10, 38}, {-2, 38}}, color={255, 0, 255}));
  connect(uOcc, swi.u2)
    annotation(Line(points={{-280, 330}, {-220, 330}, {-220, 280}, {258, 280}}, color={255, 0, 255}));
  connect(uOcc, or3.u3)
    annotation(Line(points={{-280, 330}, {-220, 330}, {-220, 22}, {-2, 22}}, color={255, 0, 255}));
  ...
  connect(hys4.y, and2.u1)
    annotation(Line(points={{102, 220}, {198, 220}}, color={255, 0, 255}));
  connect(tNexOcc, add5.u1)
    annotation(Line(points={{-280, 290}, {20, 290}, {20, 226}, {38, 226}}, color={0, 0, 127}));
  connect(corCooDowTim.y, add5.u2)
    annotation(Line(points={{2, 210}, {30, 210}, {30, 214}, {38, 214}}, color={0, 0, 127}));
  connect(tNexOcc, add6.u1)
    annotation(Line(points={{-280, 290}, {20, 290}, {20, 186}, {38, 186}}, color={0, 0, 127}));
  connect(corWarUpTim.y, add6.u2)
    annotation(Line(points={{2, 170}, {20, 170}, {20, 174}, {38, 174}}, color={0, 0, 127}));
  ...
  connect(hys10.y, lat1.clr)
    annotation(Line(points={{-118,-150}, {-80,-150}, {-80,-116}, {-42,-116}}, color={255, 0, 255}));
  ...
  connect(maxWarCooTime.y, corCooDowTim.u3)
    annotation(Line(points={{-178, 190}, {-60, 190}, {-60, 202}, {-22, 202}}, color={0, 0, 127}));
  connect(maxWarCooTime.y, corWarUpTim.u3)
    annotation(Line(points={{-178, 190}, {-60, 190}, {-60, 162}, {-22, 162}}, color={0, 0, 127}));
  connect(booToRea3.y, swi3.u3)
    annotation(Line(points={{82,-10}, {100,-10}, {100,-18}, {158,-18}}, color={0, 0, 127}));
  connect(booToRea4.y, swi4.u3)
    annotation(Line(points={{82,-110}, {100,-110}, {100,-118}, {158,-118}}, color={0, 0, 127}));
  connect(booToRea6.y, swi5.u3)
    annotation(Line(points={{82,-210}, {100,-210}, {100,-218}, {158,-218}}, color={0, 0, 127}));
  connect(lat3.y, and1.u2)
    annotation(Line(points={{-78, 110}, {188, 110}, {188, 172}, {198, 172}}, color={255, 0, 255}));
  connect(lat4.y, and2.u2)
    annotation(Line(points={{-78, 80}, {-30, 80}, {-30, 120}, {180, 120}, {180, 212}, {198, 212}}, color={255, 0, 255}));
  connect(hys4.y, not3.u)
    annotation(Line(points={{102, 220}, {110, 220}, {110, 200}, {118, 200}}, color={255, 0, 255}));
  connect(hys5.y, not4.u)
    annotation(Line(points={{102, 180}, {110, 180}, {110, 160}, {118, 160}}, color={255, 0, 255}));
  connect(not4.y, lat3.clr)
    annotation(Line(points={{142, 160}, {160, 160}, {160, 140}, {-140, 140}, {-140, 104}, {-102, 104}}, color={255, 0, 255}));
  connect(not3.y, lat4.clr)
    annotation(Line(points={{142, 200}, {170, 200}, {170, 130}, {-160, 130}, {-160, 74}, {-102, 74}}, color={255, 0, 255}));
  connect(lat1.y, not5.u)
    annotation(Line(points={{-18,-110}, {0,-110}, {0,-150}, {58,-150}}, color={255, 0, 255}));
  connect(not5.y, assMes.u)
    annotation(Line(points={{82,-150}, {98,-150}}, color={255, 0, 255}));
  connect(maxCooDowTim, addPar2.u)
    annotation(Line(points={{-280, 230}, {-160, 230}, {-160, 210}, {-142, 210}}, color={0, 0, 127}));
  connect(maxCooDowTim, corCooDowTim.u1)
    annotation(Line(points={{-280, 230}, {-60, 230}, {-60, 218}, {-22, 218}}, color={0, 0, 127}));
  connect(maxWarUpTim, addPar3.u)
    annotation(Line(points={{-280, 150}, {-160, 150}, {-160, 170}, {-142, 170}}, color={0, 0, 127}));
  connect(maxWarUpTim, corWarUpTim.u1)
    annotation(Line(points={{-280, 150}, {-40, 150}, {-40, 178}, {-22, 178}}, color={0, 0, 127}));
  ...
  connect(unoHeaHigMin, falEdg.u)
    annotation(Line(points={{-280,-70}, {-120,-70}, {-120,-50}, {-102,-50}}, color={255, 0, 255}));
  ...
  connect(maxHigUnoCoo, falEdg1.u)
    annotation(Line(points={{-280,-270}, {-120,-270}, {-120,-250}, {-102,-250}}, color={255, 0, 255}));
  connect(totColZon, intGreThr.u)
    annotation(Line(points={{-280,-10}, {-182,-10}}, color={255, 127, 0}));
  connect(totColZon, intGreThr1.u)
    annotation(Line(points={{-280,-10}, {-220,-10}, {-220,-40}, {-182,-40}}, color={255, 127, 0}));
  connect(totHotZon, intGreThr2.u)
    annotation(Line(points={{-280,-210}, {-182,-210}}, color={255, 127, 0}));
  connect(totHotZon, intGreThr3.u)
    annotation(Line(points={{-280,-210}, {-220,-210}, {-220,-240}, {-182,-240}}, color={255, 127, 0}));
  connect(intGreThr2.y, or4.u1)
    annotation(Line(points={{-158,-210}, {-102,-210}}, color={255, 0, 255}));
  connect(intGreThr3.y, or4.u2)
    annotation(Line(points={{-158,-240}, {-120,-240}, {-120,-218}, {-102,-218}}, color={255, 0, 255}));
  connect(booToInt.y, addInt.u1)
    annotation(Line(points={{282, 220}, {290, 220}, {290, 206}, {298, 206}}, color={255, 127, 0}));
  connect(booToInt1.y, addInt.u2)
    annotation(Line(points={{282, 180}, {290, 180}, {290, 194}, {298, 194}}, color={255, 127, 0}));
  connect(occMod.y, addInt1.u1)
    annotation(Line(points={{322, 280}, {340, 280}, {340, 256}, {358, 256}}, color={255, 127, 0}));
  connect(addInt.y, addInt1.u2)
    annotation(Line(points={{322, 200}, {340, 200}, {340, 244}, {358, 244}}, color={255, 127, 0}));
  connect(setBacMod.y, addInt2.u1)
    annotation(Line(points={{222,-10}, {230,-10}, {230,-74}, {238,-74}}, color={255, 127, 0}));
  connect(freProSetBacMod.y, addInt2.u2)
    annotation(Line(points={{222,-110}, {230,-110}, {230,-86}, {238,-86}}, color={255, 127, 0}));
  connect(setUpMod.y, addInt3.u2)
    annotation(Line(points={{222,-210}, {260,-210}, {260,-196}, {278,-196}}, color={255, 127, 0}));
  connect(addInt2.y, addInt3.u1)
    annotation(Line(points={{262,-80}, {270,-80}, {270,-184}, {278,-184}}, color={255, 127, 0}));
  connect(addInt3.y, addInt4.u1)
    annotation(Line(points={{302,-190}, {310,-190}, {310,-274}, {318,-274}}, color={255, 127, 0}));
  connect(booToInt3.y, addInt4.u2)
    annotation(Line(points={{242,-330}, {300,-330}, {300,-286}, {318,-286}}, color={255, 127, 0}));
  connect(addInt1.y, addInt5.u1)
    annotation(Line(points={{382, 250}, {400, 250}, {400,-14}, {418,-14}}, color={255, 127, 0}));
  connect(addInt4.y, addInt5.u2)
    annotation(Line(points={{342,-280}, {400,-280}, {400,-26}, {418,-26}}, color={255, 127, 0}));
  ...
  connect(notOcc.y, and3.u2)
    annotation(Line(points={{222, 30}, {240, 30}, {240, 42}, {258, 42}}, color={255, 0, 255}));
  connect(and3.y, not1.u)
    annotation(Line(points={{282, 50}, {298, 50}}, color={255, 0, 255}));
  connect(addInt5.y, notOcc.u)
    annotation(Line(points={{442,-20}, {450,-20}, {450, 10}, {180, 10}, {180, 30}, {198, 30}}, color={255, 127, 0}));
  connect(not1.y, winOpe.u)
    annotation(Line(points={{322, 50}, {338, 50}}, color={255, 0, 255}));
  annotation(defaultComponentName="opeModSel", Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-260,-360}, {460, 360}}), graphics={Rectangle(extent={{-258,-282}, {458,-358}}, fillColor={215, 215, 215}, fillPattern=FillPattern.Solid, pattern=LinePattern.None), Rectangle(extent={{-258,-202}, {458,-278}}, fillColor={215, 215, 215}, fillPattern=FillPattern.Solid, pattern=LinePattern.None), Rectangle(extent={{-258,-82}, {458,-158}}, fillColor={215, 215, 215}, fillPattern=FillPattern.Solid, pattern=LinePattern.None), Rectangle(extent={{-258,-2}, {458,-78}}, fillColor={215, 215, 215}, fillPattern=FillPattern.Solid, pattern=LinePattern.None), Rectangle(extent={{-258, 188}, {458, 112}}, fillColor={215, 215, 215}, fillPattern=FillPattern.Solid, pattern=LinePattern.None), Rectangle(extent={{-258, 268}, {458, 192}}, fillColor={215, 215, 215}, fillPattern=FillPattern.Solid, pattern=LinePattern.None), Rectangle(extent={{-258, 348}, {458, 272}}, fillColor={215, 215, 215}, fillPattern=FillPattern.Solid, pattern=LinePattern.None), Text(extent={{336, 332}, {426, 314}}, lineColor={0, 0, 255}, fillColor={215, 215, 215}, fillPattern=FillPattern.Solid, textString="Occupied mode"), Text(extent={{296,-32}, {380,-54}}, lineColor={0, 0, 255}, fillColor={215, 215, 215}, fillPattern=FillPattern.Solid, textString="Setback mode"), Text(extent={{324,-224}, {396,-246}}, lineColor={0, 0, 255}, fillColor={215, 215, 215}, fillPattern=FillPattern.Solid, textString="Setup mode"), Text(extent={{314,-308}, {418,-338}}, lineColor={0, 0, 255}, fillColor={215, 215, 215}, fillPattern=FillPattern.Solid, textString="Unoccupied mode"), Text(extent={{280,-114}, {452,-142}}, lineColor={0, 0, 255}, fillColor={215, 215, 215}, fillPattern=FillPattern.Solid, textString="Freeze protection setback mode"), Text(extent={{250, 170}, {338, 146}}, lineColor={0, 0, 255}, fillColor={215, 215, 215}, fillPattern=FillPattern.Solid, textString="Warm-up mode"), Text(extent={{188, 262}, {276, 234}}, lineColor={0, 0, 255}, fillColor={215, 215, 215}, fillPattern=FillPattern.Solid, textString="Cool-down mode")}), Icon(coordinateSystem(extent={{-100,-100}, {100, 100}}), graphics={Rectangle(extent={{-100,-100}, {100, 100}}, lineColor={0, 0, 127}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Text(extent={{-98, 80}, {-52, 68}}, lineColor={0, 0, 127}, pattern=LinePattern.Dash, textString="maxCooDowTim"), Text(extent={{-98, 64}, {-56, 54}}, lineColor={0, 0, 127}, pattern=LinePattern.Dash, textString="maxWarUpTim"), Text(extent={{58, 12}, {96,-10}}, lineColor={255, 127, 0}, pattern=LinePattern.Dash, textString="yOpeMod"), Text(extent={{-120, 144}, {100, 106}}, lineColor={0, 0, 255}, textString="%name"), Text(extent={{-98, 94}, {-74, 82}}, lineColor={0, 0, 127}, pattern=LinePattern.Dash, textString="tNexOcc"), Text(extent={{-100, 104}, {-82, 96}}, lineColor={0, 0, 127}, pattern=LinePattern.Dash, textString="uOcc"), Text(extent={{-98, 42}, {-50, 30}}, lineColor={255, 0, 255}, pattern=LinePattern.Dash, textString="occHeaHigMin"), Text(extent={{-98, 24}, {-48, 12}}, lineColor={255, 0, 255}, pattern=LinePattern.Dash, textString="maxHigOccCoo"), Text(extent={{-98,-14}, {-60,-24}}, lineColor={255, 127, 0}, pattern=LinePattern.Dash, textString="totColZon"), Text(extent={{-98,-32}, {-48,-44}}, lineColor={255, 0, 255}, pattern=LinePattern.Dash, textString="unoHeaHigMin"), Text(extent={{-98,-56}, {-70,-64}}, lineColor={0, 0, 127}, pattern=LinePattern.Dash, textString="TZonMax"), Text(extent={{-100,-76}, {-70,-84}}, lineColor={0, 0, 127}, pattern=LinePattern.Dash, textString="TZonMin"), Text(extent={{-98,-96}, {-66,-104}}, lineColor={255, 127, 0}, pattern=LinePattern.Dash, textString="totHotZon"), Text(extent={{-98,-112}, {-48,-124}}, lineColor={255, 0, 255}, pattern=LinePattern.Dash, textString="maxHigUnoCoo"), Text(visible=have_winSen, extent={{-98, 8}, {-68,-4}}, lineColor={255, 0, 255}, pattern=LinePattern.Dash, textString="uWinSta")}), Documentation(info="<html>
<p>
