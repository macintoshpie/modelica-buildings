...
equation
  ...
  connect(modTim.y, div.u1)
    annotation(
      Line(
        points={{-138, 240}, {-130, 240}, {-130, 226}, {-122, 226}},
        color={0, 0, 127}));
  connect(con.y, div.u2)
    annotation(
      Line(
        points={{-138, 140}, {-130, 140}, {-130, 214}, {-122, 214}},
        color={0, 0, 127}));
  connect(div.y, rou.u)
    annotation(
      Line(
        points={{-98, 220}, {-82, 220}},
        color={0, 0, 127}));
  connect(rou.y, gai.u)
    annotation(
      Line(
        points={{-58, 220}, {-42, 220}},
        color={0, 0, 127}));
  ...
  connect(modTim.y, lesEqu.u2)
    annotation(
      Line(
        points={{-138, 240}, {-10, 240}, {-10, 212}, {-2, 212}},
        color={0, 0, 127}));
  connect(rou.y, addPar1.u)
    annotation(
      Line(
        points={{-58, 220}, {-50, 220}, {-50, 190}, {-42, 190}},
        color={0, 0, 127}));
  ...
  connect(lesEqu.y, swi.u2)
    annotation(
      Line(
        points={{22, 220}, {38, 220}},
        color={255, 0, 255}));
  connect(gai.y, swi.u1)
    annotation(
      Line(
        points={{-18, 220}, {-14, 220}, {-14, 250}, {30, 250}, {30, 228}, {38, 228}},
        color={0, 0, 127}));
  connect(gai1.y, swi.u3)
    annotation(
      Line(
        points={{22, 190}, {30, 190}, {30, 212}, {38, 212}},
        color={0, 0, 127}));
  connect(modTim.y, curTim.u1)
    annotation(
      Line(
        points={{-138, 240}, {-10, 240}, {-10, 246}, {78, 246}},
        color={0, 0, 127}));
  connect(swi.y, curTim.u2)
    annotation(
      Line(
        points={{62, 220}, {70, 220}, {70, 234}, {78, 234}},
        color={0, 0, 127}));
  connect(occStaTim.y, add2.u1)
    annotation(
      Line(
        points={{-118, 100}, {-100, 100}, {-100, 166}, {78, 166}},
        color={0, 0, 127}));
  connect(con.y, add1.u1)
    annotation(
      Line(
        points={{-138, 140}, {-130, 140}, {-130, 146}, {-2, 146}},
        color={0, 0, 127}));
  connect(add1.y, addPar2.u)
    annotation(
      Line(
        points={{22, 140}, {38, 140}},
        color={0, 0, 127}));
  connect(occStaTim.y, lesEqu1.u2)
    annotation(
      Line(
        points={{-118, 100}, {-100, 100}, {-100, 92}, {-2, 92}},
        color={0, 0, 127}));
  connect(curTim.y, lesEqu1.u1)
    annotation(
      Line(
        points={{102, 240}, {140, 240}, {140, 120}, {-20, 120}, {-20, 100}, {-2, 100}},
        color={0, 0, 127}));
  connect(lesEqu1.y, swi1.u2)
    annotation(
      Line(
        points={{22, 100}, {118, 100}},
        color={255, 0, 255}));
  connect(add2.y, swi1.u1)
    annotation(
      Line(
        points={{102, 160}, {110, 160}, {110, 108}, {118, 108}},
        color={0, 0, 127}));
  connect(addPar2.y, swi1.u3)
    annotation(
      Line(
        points={{62, 140}, {100, 140}, {100, 92}, {118, 92}},
        color={0, 0, 127}));
  connect(occTim.y[1], occ.u)
    annotation(
      Line(
        points={{-118, 60}, {-102, 60}},
        color={0, 0, 127}));
  connect(curTim.y, add2.u2)
    annotation(
      Line(
        points={{102, 240}, {140, 240}, {140, 180}, {60, 180}, {60, 154}, {78, 154}},
        color={0, 0, 127}));
  connect(curTim.y, add1.u2)
    annotation(
      Line(
        points={{102, 240}, {140, 240}, {140, 120}, {-20, 120}, {-20, 134}, {-2, 134}},
        color={0, 0, 127}));
  connect(occ.y, opeModSel.uOcc)
    annotation(
      Line(
        points={{-78, 60}, {80, 60}, {80, 22}, {128, 22}},
        color={255, 0, 255}));
  connect(swi1.y, opeModSel.tNexOcc)
    annotation(
      Line(
        points={{142, 100}, {150, 100}, {150, 40}, {72, 40}, {72, 20}, {128, 20}},
        color={0, 0, 127}));
  connect(cooDowTim.y, opeModSel.maxCooDowTim)
    annotation(
      Line(
        points={{-38, 30}, {64, 30}, {64, 18}, {128, 18}},
        color={0, 0, 127}));
  connect(warUpTim.y, opeModSel.maxWarUpTim)
    annotation(
      Line(
        points={{-38, 0}, {-20, 0}, {-20, 16}, {128, 16}},
        color={0, 0, 127}));
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_PR1/Generic/SetPoints/Validation/OperationMode.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
