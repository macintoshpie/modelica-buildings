...
equation
  connect(con.y, trimRespondLogic.uDevSta)
    annotation(
      Line(
        points={{42, 90}, {50, 90}, {50, 78}, {68, 78}},
        color={255, 0, 255}));
  ...
  connect(not1.y, trimRespondLogic2.uDevSta)
    annotation(
      Line(
        points={{42,-10}, {60,-10}, {60,-22}, {68,-22}},
        color={255, 0, 255}));
  connect(con1.y, swi.u1)
    annotation(
      Line(
        points={{-66,-40}, {-62,-40}, {-62,-32}, {-50,-32}},
        color={0, 0, 127}));
  connect(sine1.y, swi.u3)
    annotation(
      Line(
        points={{-66,-80}, {-58,-80}, {-58,-48}, {-50,-48}},
        color={0, 0, 127}));
  connect(swi.y, abs1.u)
    annotation(
      Line(
        points={{-26,-40}, {-20,-40}, {-20,-80}, {-12,-80}},
        color={0, 0, 127}));
  connect(booPul.y, swi.u2)
    annotation(
      Line(
        points={{-66,-10}, {-58,-10}, {-58,-40}, {-50,-40}},
        color={255, 0, 255}));
  ...
  connect(reaToInt1.y, trimRespondLogic.numOfReq)
    annotation(
      Line(
        points={{42, 50}, {60, 50}, {60, 62}, {68, 62}},
        color={255, 127, 0}));
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_PR1/Generic/SetPoints/Validation/TrimAndRespond.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
