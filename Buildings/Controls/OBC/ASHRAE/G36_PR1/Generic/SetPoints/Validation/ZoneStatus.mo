...
equation
  ...
  connect(maxZonTem.y, noWinZonSta.TZonMax)
    annotation(
      Line(
        points={{22, 0}, {40, 0}, {40, 129}, {118, 129}},
        color={0, 0, 127}));
  connect(zonTem.y, noWinZonSta.TZon)
    annotation(
      Line(
        points={{22,-40}, {46,-40}, {46, 127}, {118, 127}},
        color={0, 0, 127}));
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_PR1/Generic/SetPoints/Validation/ZoneStatus.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
