...
equation
  connect(cooDowTim, pro.u1)
    annotation(
      Line(
        points={{-160, 220}, {-60, 220}, {-60, 226}, {78, 226}},
        color={0, 0, 127}));
  connect(warUpTim, pro1.u1)
    annotation(
      Line(
        points={{-160, 160}, {-60, 160}, {-60, 166}, {78, 166}},
        color={0, 0, 127}));
  connect(booToRea.y, pro.u2)
    annotation(
      Line(
        points={{42, 120}, {60, 120}, {60, 214}, {78, 214}},
        color={0, 0, 127}));
  connect(booToRea.y, pro1.u2)
    annotation(
      Line(
        points={{42, 120}, {60, 120}, {60, 154}, {78, 154}},
        color={0, 0, 127}));
  connect(TZonHeaSetOcc, add.u1)
    annotation(
      Line(
        points={{-160, 70}, {-60, 70}, {-60, 76}, {-22, 76}},
        color={0, 0, 127}));
  connect(TZonMin, add.u2)
    annotation(
      Line(
        points={{-160,-110}, {-60,-110}, {-60, 64}, {-22, 64}},
        color={0, 0, 127}));
  connect(add.y, hys.u)
    annotation(
      Line(
  ...
  connect(TZonCooSetOcc, add1.u1)
    annotation(
      Line(
        points={{-160, 20}, {-80, 20}, {-80, 26}, {-22, 26}},
        color={0, 0, 127}));
  connect(TZonMax, add1.u2)
    annotation(
      Line(
        points={{-160,-20}, {-80,-20}, {-80, 14}, {-22, 14}},
        color={0, 0, 127}));
  ...
  connect(uWinSta, not1.u)
    annotation(
      Line(
        points={{-160, 120}, {-22, 120}},
        color={255, 0, 255}));
  connect(uWinSta, swi.u2)
    annotation(
      Line(
        points={{-160, 120}, {-100, 120}, {-100,-60}, {-22,-60}},
        color={255, 0, 255}));
  connect(TZonHeaSetUno, swi.u1)
    annotation(
      Line(
        points={{-160,-150}, {-40,-150}, {-40,-52}, {-22,-52}},
        color={0, 0, 127}));
  connect(TZon, swi.u3)
    annotation(
      Line(
        points={{-160,-60}, {-120,-60}, {-120,-68}, {-22,-68}},
        color={0, 0, 127}));
  connect(swi.y, add2.u1)
    annotation(
      Line(
        points={{2,-60}, {20,-60}, {20,-54}, {38,-54}},
        color={0, 0, 127}));
  connect(TZonHeaSetUno, add2.u2)
    annotation(
      Line(
        points={{-160,-150}, {20,-150}, {20,-66}, {38,-66}},
        color={0, 0, 127}));
  ...
  connect(TZonMin, add3.u2)
    annotation(
      Line(
        points={{-160,-110}, {-60,-110}, {-60,-116}, {38,-116}},
        color={0, 0, 127}));
  connect(TZonHeaSetUno, add3.u1)
    annotation(
      Line(
        points={{-160,-150}, {20,-150}, {20,-104}, {38,-104}},
        color={0, 0, 127}));
  connect(add3.y, hys3.u)
    annotation(
      Line(
        points={{62,-110}, {78,-110}},
        color={0, 0, 127}));
  connect(uWinSta, swi1.u2)
    annotation(
      Line(
        points={{-160, 120}, {-100, 120}, {-100,-220}, {-22,-220}},
        color={255, 0, 255}));
  connect(TZonCooSetUno, swi1.u1)
    annotation(
      Line(
        points={{-160,-240}, {-60,-240}, {-60,-212}, {-22,-212}},
        color={0, 0, 127}));
  connect(TZon, swi1.u3)
    annotation(
      Line(
        points={{-160,-60}, {-120,-60}, {-120,-228}, {-22,-228}},
        color={0, 0, 127}));
  connect(swi1.y, add5.u1)
    annotation(
      Line(
        points={{2,-220}, {20,-220}, {20,-214}, {38,-214}},
        color={0, 0, 127}));
  connect(TZonCooSetUno, add5.u2)
    annotation(
      Line(
        points={{-160,-240}, {20,-240}, {20,-226}, {38,-226}},
        color={0, 0, 127}));
  ...
  connect(TZonMax, add4.u1)
    annotation(
      Line(
        points={{-160,-20}, {-80,-20}, {-80,-164}, {38,-164}},
        color={0, 0, 127}));
  connect(TZonCooSetUno, add4.u2)
    annotation(
      Line(
        points={{-160,-240}, {-60,-240}, {-60,-176}, {38,-176}},
        color={0, 0, 127}));
  connect(add4.y, hys4.u)
    annotation(
      Line(
        points={{62,-170}, {78,-170}},
        color={0, 0, 127}));
  ...
  connect(pro.y, yCooTim)
    annotation(
      Line(
        points={{102, 220}, {160, 220}},
        color={0, 0, 127}));
  connect(pro1.y, yWarTim)
    annotation(
      Line(
        points={{102, 160}, {160, 160}},
        color={0, 0, 127}));
  connect(hys2.y, yLowUnoHea)
    annotation(
      Line(
        points={{102,-60}, {160,-60}},
        color={255, 0, 255}));
  connect(hys3.y, yUnoHeaHigMin)
    annotation(
      Line(
        points={{102,-110}, {160,-110}},
        color={255, 0, 255}));
  connect(hys4.y, yMaxHigUnoCoo)
    annotation(
      Line(
        points={{102,-170}, {160,-170}},
        color={255, 0, 255}));
  ...
  connect(con.y, not1.u)
    annotation(
      Line(
        points={{-106, 140}, {-100, 140}, {-100, 120}, {-22, 120}},
        color={255, 0, 255}));
  connect(con.y, swi.u2)
    annotation(
      Line(
        points={{-106, 140}, {-100, 140}, {-100,-60}, {-22,-60}},
        color={255, 0, 255}));
  connect(con.y, swi1.u2)
    annotation(
      Line(
        points={{-106, 140}, {-100, 140}, {-100,-220}, {-22,-220}},
        color={255, 0, 255}));
  annotation(
    ...
    Icon(
      ...
      graphics={Rectangle(
        ...
        textString="cooDowTim"), Text(
        extent={{-98, 76}, {-50, 64}},
        lineColor={0, 0, 127},
        pattern=LinePattern.Dash,
        textString="warUpTim"), Text(
        extent={{-96,-84}, {-32,-98}},
        lineColor={0, 0, 127},
        pattern=LinePattern.Dash,
        ...
        lineColor={0, 0, 127},
        pattern=LinePattern.Dash,
        textString="uWinSta"), Text(
        extent={{60, 100}, {98, 84}},
        lineColor={0, 0, 127},
        pattern=LinePattern.Dash,
        textString="yCooTim"), Text(
        extent={{60, 80}, {98, 64}},
        lineColor={0, 0, 127},
        pattern=LinePattern.Dash,
        textString="yWarTim"), Text(
        extent={{30, 40}, {96, 22}},
        lineColor={255, 0, 255},
        pattern=LinePattern.Dash,
        textString="yOccHeaHigMin"), Text(
        extent={{30, 20}, {96, 2}},
        lineColor={255, 0, 255},
        pattern=LinePattern.Dash,
        textString="yMaxHigOccCoo"), Text(
        extent={{46, 0}, {96,-16}},
        lineColor={255, 0, 255},
        pattern=LinePattern.Dash,
        textString="yLowUnoHea"), Text(
        extent={{30,-38}, {96,-56}},
        lineColor={255, 0, 255},
        pattern=LinePattern.Dash,
        textString="yUnoHeaHigMin"), Text(
        extent={{30,-58}, {96,-76}},
        lineColor={255, 0, 255},
        pattern=LinePattern.Dash,
        textString="yMaxHigUnoCoo"), Text(
        extent={{46,-80}, {96,-96}},
        lineColor={255, 0, 255},
        pattern=LinePattern.Dash,
