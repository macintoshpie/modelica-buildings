...
block ModeAndSetPoints
  ...
  Buildings.Controls.OBC.CDL.Interfaces.BooleanInput uOcc
    ...
    annotation(
      Placement(
        transformation(
          extent={{-200,-10}, {-160, 30.5}}),
        iconTransformation(
          extent={{-140, 40}, {-100, 80.5}})));
...
equation
  ...
  connect(TSetRooCooOn.y, TZonSet.TZonCooSetOcc)
    annotation(
      Line(
        points={{-98, 110}, {-78, 110}, {-78,-67}, {78,-67}},
        color={0, 0, 127}));
  connect(TSetRooCooOff.y, TZonSet.TZonCooSetUno)
    annotation(
      Line(
        points={{-98, 30}, {-74, 30}, {-74,-71.2}, {78,-71.2}},
        color={0, 0, 127}));
  connect(TSetRooHeaOn.y, TZonSet.TZonHeaSetOcc)
    annotation(
      Line(
        points={{-98, 150}, {-76, 150}, {-76,-75.2}, {78,-75.2}},
        color={0, 0, 127}));
  connect(TSetRooHeaOff.y, TZonSet.TZonHeaSetUno)
    annotation(
      Line(
        points={{-98, 70}, {-80, 70}, {-80,-79}, {78,-79}},
        color={0, 0, 127}));
  connect(uWinSta, opeModSel.uWinSta)
    annotation(
      Line(
        points={{-180,-200}, {-72,-200}, {-72,-10}, {38,-10}},
        color={255, 0, 255}));
  annotation(
    defaultComponentName="modSetPoi",
    Diagram(
      coordinateSystem(
