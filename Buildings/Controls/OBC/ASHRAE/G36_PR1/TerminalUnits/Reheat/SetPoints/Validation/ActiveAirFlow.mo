...
model ActiveAirFlow
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.TerminalUnits.Reheat.SetPoints.ActiveAirFlow actAirSet_RehBox(
    ...
    annotation(
      Placement(
        transformation(
          extent={{60, 60}, {80, 80}})));
  Buildings.Controls.OBC.ASHRAE.G36_PR1.TerminalUnits.Reheat.SetPoints.ActiveAirFlow actAirSet_RehBox1(
    VDisCooSetMax_flow=0.075,
    VDisSetMin_flow=0.017,
    VDisHeaSetMax_flow=0.05,
    VDisConMin_flow=0.01,
...
equation
  ...
  connect(round1.y, actAirSet_RehBox.nOcc)
    annotation(
      Line(
        points={{-18, 30}, {-4, 30}, {-4, 66}, {58, 66}},
        color={0, 0, 127}));
  connect(round1.y, actAirSet_RehBox1.nOcc)
    annotation(
      Line(
        points={{-18, 30}, {-4, 30}, {-4, 6}, {58, 6}},
        color={0, 0, 127}));
  annotation(
    experiment(
      StopTime=86400,
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_PR1/TerminalUnits/Reheat/SetPoints/Validation/ActiveAirFlow.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
