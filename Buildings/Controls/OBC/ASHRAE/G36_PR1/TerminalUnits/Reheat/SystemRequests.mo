...
protected
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant zerHeaResReq(
    ...
    annotation(
      Placement(
        transformation(
          extent={{40,-380}, {60,-360}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant zerBoiPlaReq(
    final k=0) if(have_heaWatCoi and have_heaPla)
    "Constant 0"
    annotation(
      Placement(
        transformation(
          extent={{40,-460}, {60,-440}})));
  ...
  Buildings.Controls.OBC.CDL.Logical.TrueDelay tim4(
    delayTime=durTimDisAir) if have_heaWatCoi
...
equation
  connect(add2.y, hys.u)
    annotation(
      Line(
        points={{-78, 200}, {-62, 200}},
        color={0, 0, 127}));
  connect(TZonCooSet, samTZonCooSet.u)
    annotation(
      Line(
        points={{-200, 440}, {-162, 440}},
        color={0, 0, 127}));
  connect(samTZonCooSet.y, uniDel.u)
    annotation(
      Line(
        points={{-138, 440}, {-100, 440}, {-100, 460}, {-82, 460}},
        color={0, 0, 127}));
  connect(triSam.y, gai.u)
    annotation(
      Line(
        points={{-98, 280}, {-82, 280}},
        color={0, 0, 127}));
  connect(hys2.y, lat.u)
    annotation(
      Line(
        points={{-98, 340}, {-62, 340}},
        color={255, 0, 255}));
  connect(lat.y, tim.u)
    annotation(
      Line(
  ...
  connect(tim.y, gre.u1)
    annotation(
      Line(
        points={{22, 340}, {58, 340}},
        color={0, 0, 127}));
  connect(edg.y, triSam.trigger)
    annotation(
      Line(
        points={{-38, 300}, {-20, 300}, {-20, 264}, {-110, 264}, {-110, 268.2}},
        color={255, 0, 255}));
  connect(lat.y, edg.u)
    annotation(
      Line(
        points={{-38, 340}, {-20, 340}, {-20, 318}, {-80, 318}, {-80, 300}, {-62, 300}},
        color={255, 0, 255}));
  connect(edg.y, lat1.clr)
    annotation(
      Line(
        points={{-38, 300}, {-20, 300}, {-20, 264}, {58, 264}},
        color={255, 0, 255}));
  connect(modTim.y, gre1.u1)
    annotation(
      Line(
        points={{-118, 410}, {-82, 410}},
        color={0, 0, 127}));
  connect(con.y, gre1.u2)
    annotation(
      Line(
        points={{-118, 380}, {-100, 380}, {-100, 402}, {-82, 402}},
        color={0, 0, 127}));
  connect(uniDel.y, add1.u1)
    annotation(
      Line(
        points={{-58, 460}, {-40, 460}, {-40, 446}, {-22, 446}},
        color={0, 0, 127}));
  connect(samTZonCooSet.y, add1.u2)
    annotation(
      Line(
        points={{-138, 440}, {-40, 440}, {-40, 434}, {-22, 434}},
        color={0, 0, 127}));
  connect(gre1.y, swi.u2)
    annotation(
      Line(
        points={{-58, 410}, {38, 410}},
        color={255, 0, 255}));
  connect(add1.y, swi.u1)
    annotation(
      Line(
        points={{2, 440}, {20, 440}, {20, 418}, {38, 418}},
        color={0, 0, 127}));
  connect(conZer.y, swi.u3)
    annotation(
      Line(
        points={{2, 380}, {20, 380}, {20, 402}, {38, 402}},
        color={0, 0, 127}));
  connect(swi.y, abs.u)
    annotation(
      Line(
        points={{62, 410}, {98, 410}},
        color={0, 0, 127}));
  connect(abs.y, triSam.u)
    annotation(
      Line(
        points={{122, 410}, {140, 410}, {140, 360}, {-140, 360}, {-140, 280}, {-122, 280}},
        color={0, 0, 127}));
  connect(abs.y, hys2.u)
    annotation(
      Line(
        points={{122, 410}, {140, 410}, {140, 360}, {-140, 360}, {-140, 340}, {-122, 340}},
        color={0, 0, 127}));
  connect(and2.y, swi1.u2)
    annotation(
      Line(
        points={{62, 200}, {98, 200}},
        color={255, 0, 255}));
  connect(thrCooResReq.y, swi1.u1)
    annotation(
      Line(
        points={{62, 230}, {80, 230}, {80, 208}, {98, 208}},
        color={0, 0, 127}));
  connect(add3.y, hys3.u)
    annotation(
      Line(
        points={{-78, 140}, {-62, 140}},
        color={0, 0, 127}));
  connect(twoCooResReq.y, swi2.u1)
    annotation(
      Line(
        points={{62, 170}, {80, 170}, {80, 148}, {98, 148}},
        color={0, 0, 127}));
  connect(swi2.y, swi1.u3)
    annotation(
      Line(
        points={{122, 140}, {140, 140}, {140, 180}, {80, 180}, {80, 192}, {98, 192}},
        color={0, 0, 127}));
  connect(and1.y, swi2.u2)
    annotation(
      Line(
        points={{62, 140}, {98, 140}},
        color={255, 0, 255}));
  ...
  connect(oneCooResReq.y, swi3.u1)
    annotation(
      Line(
        points={{62, 110}, {80, 110}, {80, 98}, {98, 98}},
        color={0, 0, 127}));
  connect(swi3.y, swi2.u3)
    annotation(
      Line(
        points={{122, 90}, {140, 90}, {140, 120}, {80, 120}, {80, 132}, {98, 132}},
        color={0, 0, 127}));
  connect(zerCooReq.y, swi3.u3)
    annotation(
      Line(
        points={{62, 70}, {80, 70}, {80, 82}, {98, 82}},
        color={0, 0, 127}));
  connect(swi1.y, reaToInt.u)
    annotation(
      Line(
        points={{122, 200}, {138, 200}},
        color={0, 0, 127}));
  connect(reaToInt.y, yZonTemResReq)
    annotation(
      Line(
        points={{162, 200}, {200, 200}},
        color={255, 127, 0}));
  ...
  connect(thrPreResReq.y, swi4.u1)
    annotation(
      Line(
        points={{62,-10}, {80,-10}, {80,-32}, {98,-32}},
        color={0, 0, 127}));
  connect(and4.y, swi5.u2)
    annotation(
      Line(
        points={{62,-100}, {98,-100}},
        color={255, 0, 255}));
  connect(twoPreResReq.y, swi5.u1)
    annotation(
      Line(
        points={{62,-70}, {80,-70}, {80,-92}, {98,-92}},
        color={0, 0, 127}));
  connect(swi5.y, swi4.u3)
    annotation(
      Line(
        points={{122,-100}, {140,-100}, {140,-60}, {80,-60}, {80,-48}, {98,-48}},
        color={0, 0, 127}));
  connect(hys4.y, swi6.u2)
    annotation(
      Line(
        points={{-38,-150}, {98,-150}},
        color={255, 0, 255}));
  connect(onePreResReq.y, swi6.u1)
    annotation(
      Line(
        points={{62,-130}, {80,-130}, {80,-142}, {98,-142}},
        color={0, 0, 127}));
  connect(zerPreResReq.y, swi6.u3)
    annotation(
      Line(
        points={{62,-170}, {80,-170}, {80,-158}, {98,-158}},
        color={0, 0, 127}));
  connect(swi6.y, swi5.u3)
    annotation(
      Line(
        points={{122,-150}, {140,-150}, {140,-120}, {80,-120}, {80,-108}, {98,-108}},
        color={0, 0, 127}));
  connect(swi4.y, reaToInt1.u)
    annotation(
      Line(
        points={{122,-40}, {138,-40}},
        color={0, 0, 127}));
  connect(reaToInt1.y, yZonPreResReq)
    annotation(
      Line(
        points={{162,-40}, {200,-40}},
        color={255, 127, 0}));
  connect(TDis, addPar.u)
    annotation(
      Line(
        points={{-200,-290}, {-160,-290}, {-160,-262}, {-142,-262}},
        color={0, 0, 127}));
  connect(addPar.y, add6.u2)
    annotation(
      Line(
        points={{-118,-262}, {-108,-262}, {-108,-246}, {-82,-246}},
        color={0, 0, 127}));
  connect(TDisHeaSet, add6.u1)
    annotation(
      Line(
        points={{-200,-210}, {-100,-210}, {-100,-234}, {-82,-234}},
        color={0, 0, 127}));
  connect(add6.y, hys8.u)
    annotation(
      Line(
        points={{-58,-240}, {-42,-240}},
        color={0, 0, 127}));
  connect(addPar1.y, add7.u2)
    annotation(
      Line(
        points={{-118,-320}, {-108,-320}, {-108,-306}, {-82,-306}},
        color={0, 0, 127}));
  connect(add7.y, hys9.u)
    annotation(
      Line(
        points={{-58,-300}, {-42,-300}},
        color={0, 0, 127}));
  ...
  connect(thrHeaResReq.y, swi7.u1)
    annotation(
      Line(
        points={{62,-210}, {80,-210}, {80,-232}, {98,-232}},
        color={0, 0, 127}));
  connect(twoHeaResReq.y, swi8.u1)
    annotation(
      Line(
        points={{62,-270}, {80,-270}, {80,-292}, {98,-292}},
        color={0, 0, 127}));
  connect(swi8.y, swi7.u3)
    annotation(
      Line(
        points={{122,-300}, {140,-300}, {140,-260}, {80,-260}, {80,-248}, {98,-248}},
        color={0, 0, 127}));
  connect(TDis, addPar1.u)
    annotation(
      Line(
        points={{-200,-290}, {-160,-290}, {-160,-320}, {-142,-320}},
        color={0, 0, 127}));
  connect(TDisHeaSet, add7.u1)
    annotation(
      Line(
        points={{-200,-210}, {-100,-210}, {-100,-294}, {-82,-294}},
        color={0, 0, 127}));
  connect(uHeaVal, hys10.u)
    annotation(
      Line(
        points={{-200,-350}, {-142,-350}},
        color={0, 0, 127}));
  connect(hys10.y, swi9.u2)
    annotation(
      Line(
        points={{-118,-350}, {98,-350}},
        color={255, 0, 255}));
  connect(oneHeaResReq.y, swi9.u1)
    annotation(
      Line(
        points={{62,-330}, {80,-330}, {80,-342}, {98,-342}},
        color={0, 0, 127}));
  connect(zerHeaResReq.y, swi9.u3)
    annotation(
      Line(
        points={{62,-370}, {80,-370}, {80,-358}, {98,-358}},
        color={0, 0, 127}));
  connect(swi9.y, swi8.u3)
    annotation(
      Line(
        points={{122,-350}, {140,-350}, {140,-320}, {80,-320}, {80,-308}, {98,-308}},
        color={0, 0, 127}));
  connect(swi7.y, reaToInt2.u)
    annotation(
      Line(
        points={{122,-240}, {138,-240}},
        color={0, 0, 127}));
  connect(reaToInt2.y, yHeaValResReq)
    annotation(
      Line(
        points={{162,-240}, {200,-240}},
        color={255, 127, 0}));
  connect(uHeaVal, hys11.u)
    annotation(
      Line(
        points={{-200,-350}, {-160,-350}, {-160,-430}, {-142,-430}},
        color={0, 0, 127}));
  connect(hys11.y, swi10.u2)
    annotation(
      Line(
        points={{-118,-430}, {98,-430}},
        color={255, 0, 255}));
  connect(oneBoiPlaReq.y, swi10.u1)
    annotation(
      Line(
        points={{62,-410}, {80,-410}, {80,-422}, {98,-422}},
        color={0, 0, 127}));
  connect(zerBoiPlaReq.y, swi10.u3)
    annotation(
      Line(
        points={{62,-450}, {80,-450}, {80,-438}, {98,-438}},
        color={0, 0, 127}));
  connect(swi10.y, reaToInt3.u)
    annotation(
      Line(
        points={{122,-430}, {138,-430}},
        color={0, 0, 127}));
  connect(reaToInt3.y, yHeaPlaReq)
    annotation(
      Line(
        points={{162,-430}, {200,-430}},
        color={255, 127, 0}));
  connect(gre.y, truHol.u)
    annotation(
      Line(
        points={{82, 340}, {118, 340}},
        color={255, 0, 255}));
  connect(truHol.y, lat.clr)
    annotation(
      Line(
        points={{142, 340}, {160, 340}, {160, 320}, {-80, 320}, {-80, 334}, {-62, 334}},
        color={255, 0, 255}));
  connect(gre.y, lat1.u)
    annotation(
      Line(
        points={{82, 340}, {100, 340}, {100, 322}, {44, 322}, {44, 270}, {58, 270}},
        color={255, 0, 255}));
  connect(lat.y, logSwi.u2)
    annotation(
      Line(
        points={{-38, 340}, {-20, 340}, {-20, 318}, {100, 318}, {100, 290}, {118, 290}},
        color={255, 0, 255}));
  connect(con5.y, logSwi.u3)
    annotation(
      Line(
        points={{82, 300}, {104, 300}, {104, 298}, {118, 298}},
        color={255, 0, 255}));
  connect(lat1.y, logSwi.u1)
    annotation(
      Line(
        points={{82, 270}, {100, 270}, {100, 282}, {118, 282}},
        color={255, 0, 255}));
  connect(logSwi.y, and2.u1)
    annotation(
      Line(
        points={{142, 290}, {160, 290}, {160, 258}, {20, 258}, {20, 200}, {38, 200}},
        color={255, 0, 255}));
  connect(logSwi.y, and1.u1)
    annotation(
      Line(
        points={{142, 290}, {160, 290}, {160, 258}, {20, 258}, {20, 140}, {38, 140}},
        color={255, 0, 255}));
  connect(gai.y, supTim.u1)
    annotation(
      Line(
        points={{-58, 280}, {-40, 280}, {-40, 286}, {-2, 286}},
        color={0, 0, 127}));
  connect(maxSupTim.y, supTim.u2)
    annotation(
      Line(
        points={{-58, 250}, {-40, 250}, {-40, 274}, {-2, 274}},
        color={0, 0, 127}));
  connect(supTim.y, gre.u2)
    annotation(
      Line(
        points={{22, 280}, {40, 280}, {40, 332}, {58, 332}},
        color={0, 0, 127}));
  connect(tim5.y, swi8.u2)
    annotation(
      Line(
        points={{22,-300}, {98,-300}},
        color={255, 0, 255}));
  ...
  connect(tim3.y, and3.u1)
    annotation(
      Line(
        points={{2, 30}, {20, 30}, {20,-40}, {38,-40}},
        color={255, 0, 255}));
  connect(tim3.y, and4.u1)
    annotation(
      Line(
        points={{2, 30}, {20, 30}, {20,-100}, {38,-100}},
        color={255, 0, 255}));
  connect(hys3.y, tim2.u)
    annotation(
      Line(
        points={{-38, 140}, {-22, 140}},
        color={255, 0, 255}));
  connect(tim2.y, and1.u2)
    annotation(
      Line(
        points={{2, 140}, {12, 140}, {12, 132}, {38, 132}},
        color={255, 0, 255}));
  connect(hys.y, tim1.u)
    annotation(
      Line(
        points={{-38, 200}, {-22, 200}},
        color={255, 0, 255}));
  connect(tim1.y, and2.u2)
    annotation(
      Line(
        points={{2, 200}, {10, 200}, {10, 192}, {38, 192}},
        color={255, 0, 255}));
  connect(sampler.u, VDisSet_flow)
    annotation(
      Line(
        points={{-162,-40}, {-170,-40}, {-170, 30}, {-200, 30}},
        color={0, 0, 127}));
  connect(sampler.y, gai1.u)
    annotation(
      Line(
        points={{-138,-40}, {-102,-40}},
        color={0, 0, 127}));
  connect(sampler.y, gai2.u)
    annotation(
      Line(
        points={{-138,-40}, {-128,-40}, {-128,-88}, {-102,-88}},
        color={0, 0, 127}));
  connect(sampler1.u, VDis_flow)
    annotation(
      Line(
        points={{-162,-70}, {-200,-70}},
        color={0, 0, 127}));
  connect(yDam_actual, sampler2.u)
    annotation(
      Line(
        points={{-200,-150}, {-162,-150}},
        color={0, 0, 127}));
  connect(sampler2.y, hys4.u)
    annotation(
      Line(
        points={{-138,-150}, {-62,-150}},
        color={0, 0, 127}));
  connect(uCoo, sampler4.u)
    annotation(
      Line(
        points={{-200, 90}, {-162, 90}},
        color={0, 0, 127}));
  ...
  connect(samTZonCooSet.y, add2.u1)
    annotation(
      Line(
        points={{-138, 440}, {-128, 440}, {-128, 426}, {-150, 426}, {-150, 206}, {-102, 206}},
        color={0, 0, 127}));
  connect(samTZonCooSet.y, add3.u1)
    annotation(
      Line(
        points={{-138, 440}, {-128, 440}, {-128, 426}, {-150, 426}, {-150, 206}, {-112, 206}, {-112, 146}, {-102, 146}},
        color={0, 0, 127}));
  ...
  connect(add2.u2, TZon)
    annotation(
      Line(
        points={{-102, 194}, {-150, 194}, {-150, 170}, {-200, 170}},
        color={0, 0, 127}));
  connect(add3.u2, TZon)
    annotation(
      Line(
        points={{-102, 134}, {-150, 134}, {-150, 170}, {-200, 170}},
        color={0, 0, 127}));
  ...
  connect(greEqu.u2, sampler1.y)
    annotation(
      Line(
        points={{-62,-48}, {-72,-48}, {-72,-70}, {-138,-70}},
        color={0, 0, 127}));
  connect(greEqu.y, and3.u2)
    annotation(
      Line(
        points={{-38,-40}, {0,-40}, {0,-48}, {38,-48}},
        color={255, 0, 255}));
  connect(gai2.y, greEqu1.u1)
    annotation(
      Line(
        points={{-78,-88}, {-76,-88}, {-76,-100}, {-62,-100}},
        color={0, 0, 127}));
  connect(sampler1.y, greEqu1.u2)
    annotation(
      Line(
        points={{-138,-70}, {-132,-70}, {-132,-108}, {-62,-108}},
        color={0, 0, 127}));
  connect(greEqu1.y, and4.u2)
    annotation(
      Line(
        points={{-38,-100}, {0,-100}, {0,-108}, {38,-108}},
        color={255, 0, 255}));
  annotation(
    ...
    Diagram(
      ...
      graphics={Rectangle(
        ...
        textString="Time-based suppression"), Text(
        extent={{-150, 82}, {-28, 58}},
        lineColor={0, 0, 255},
        horizontalAlignment=TextAlignment.Left,
        textString="Cooling SAT reset requests"), Text(
        extent={{-152,-156}, {-8,-184}},
        lineColor={0, 0, 255},
        horizontalAlignment=TextAlignment.Left,
        textString="Static pressure reset requests"), Text(
        extent={{-152,-360}, {-26,-380}},
        lineColor={0, 0, 255},
        horizontalAlignment=TextAlignment.Left,
        textString="Hot water reset requests"), Text(
    ...
    Icon(
      graphics={Text(
        ...
        lineColor={0, 0, 127},
        pattern=LinePattern.Dash,
        textString="uCoo"), Text(
        extent={{-98, 30}, {-52, 14}},
        lineColor={0, 0, 127},
        pattern=LinePattern.Dash,
        textString="VDisSet_flow"), Text(
        extent={{-98, 6}, {-64,-4}},
        lineColor={0, 0, 127},
        pattern=LinePattern.Dash,
        ...
        lineColor={0, 0, 127},
        pattern=LinePattern.Dash,
        textString="uDam"), Text(
        extent={{-98,-32}, {-52,-48}},
        lineColor={0, 0, 127},
        pattern=LinePattern.Dash,
        visible=(have_heaWatCoi or have_heaPla),
        textString="TDisHeaSet"), Text(
        extent={{-98,-56}, {-64,-66}},
        lineColor={0, 0, 127},
        pattern=LinePattern.Dash,
        visible=(have_heaWatCoi or have_heaPla),
        ...
        pattern=LinePattern.Dash,
        visible=(have_heaWatCoi or have_heaPla),
        textString="uHeaVal"), Text(
        extent={{42, 82}, {98, 62}},
        lineColor={0, 0, 127},
        pattern=LinePattern.Dash,
        horizontalAlignment=TextAlignment.Right,
        textString="yZonTemResReq"), Text(
        extent={{42, 32}, {98, 12}},
        lineColor={0, 0, 127},
        pattern=LinePattern.Dash,
        horizontalAlignment=TextAlignment.Right,
        textString="yZonPreResReq"), Text(
        extent={{42,-28}, {98,-48}},
        lineColor={0, 0, 127},
        pattern=LinePattern.Dash,
        horizontalAlignment=TextAlignment.Right,
        visible=have_heaWatCoi,
        textString="yHeaValResReq"), Text(
        extent={{58,-84}, {98,-100}},
        lineColor={0, 0, 127},
        pattern=LinePattern.Dash,
        horizontalAlignment=TextAlignment.Right,
