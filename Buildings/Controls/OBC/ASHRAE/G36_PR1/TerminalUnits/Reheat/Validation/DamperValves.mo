  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Sine VDis_flow(
    ...
    annotation(
      Placement(
        transformation(
          extent={{20,-70}, {40,-50}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant TDis(
    k=273.15 + 25)
...
equation
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_PR1/TerminalUnits/Reheat/Validation/DamperValves.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
