...
model SystemRequests
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.TerminalUnits.Reheat.SystemRequests sysReq_RehBox(
    have_heaPla=true,
    have_heaWatCoi=true)
...
equation
  ...
  connect(TDisHeaSet.y, sysReq_RehBox.TDisHeaSet)
    annotation(
      Line(
        points={{2,-40}, {26,-40}, {26, 66}, {58, 66}},
        color={0, 0, 127}));
  connect(TDis.y, sysReq_RehBox.TDis)
    annotation(
      Line(
        points={{-38,-60}, {28,-60}, {28, 64}, {58, 64}},
        color={0, 0, 127}));
  connect(valPos.y, sysReq_RehBox.uHeaVal)
    annotation(
      Line(
        points={{2,-80}, {30,-80}, {30, 62}, {58, 62}},
        color={0, 0, 127}));
  annotation(
    experiment(
      StopTime=7200,
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_PR1/TerminalUnits/Reheat/Validation/SystemRequests.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
