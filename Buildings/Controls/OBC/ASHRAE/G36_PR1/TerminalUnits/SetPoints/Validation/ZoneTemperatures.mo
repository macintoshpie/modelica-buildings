...
model ZoneTemperatures
  ...
  Buildings.Controls.OBC.ASHRAE.G36_PR1.TerminalUnits.SetPoints.ZoneTemperatures TZonSet(have_occSen=true, sinAdj=false, cooAdj=true, have_winSen=true, heaAdj=true)
  ...
  Buildings.Controls.OBC.CDL.Conversions.BooleanToInteger booToInt(integerTrue=1, integerFalse=7)
    "Convert boolean input to integer output"
    annotation(Placement(transformation(extent={{-20,-100}, {0,-80}})));
  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse winSta(period=14400, startTime=1200)
...
equation
  ...
  connect(TZonCooSetOcc.y, TZonSet.TZonCooSetOcc)
    annotation(Line(points={{-78, 90}, {-72, 90}, {-72, 108}, {30, 108}, {30, 73}, {58, 73}}, color={0, 0, 127}));
  connect(TZonHeaSetOcc.y, TZonSet.TZonHeaSetOcc)
    annotation(Line(points={{-38, 90}, {26, 90}, {26, 64.8}, {58, 64.8}}, color={0, 0, 127}));
  connect(TZonCooSetUno.y, TZonSet.TZonCooSetUno)
    annotation(Line(points={{-78, 50}, {-72, 50}, {-72, 68.8}, {58, 68.8}}, color={0, 0, 127}));
  connect(TZonHeaSetUno.y, TZonSet.TZonHeaSetUno)
    annotation(Line(points={{-38, 50}, {-32, 50}, {-32, 61}, {58, 61}}, color={0, 0, 127}));
  connect(cooDemLimLev.y, TZonSet.uCooDemLimLev)
    annotation(Line(points={{-118,-60}, {-100,-60}, {-100,-40}, {22,-40}, {22, 46}, {58, 46}}, color={255, 127, 0}));
  connect(heaDemLimLev.y, TZonSet.uHeaDemLimLev)
    annotation(Line(points={{-38,-60}, {26,-60}, {26, 42}, {58, 42}}, color={255, 127, 0}));
  connect(booToInt.y, TZonSet.uOpeMod)
    annotation(Line(points={{2,-90}, {18,-90}, {18, 78}, {58, 78}}, color={255, 127, 0}));
  connect(occSta.y, TZonSet.uOccSen)
    annotation(Line(points={{62, 20}, {74, 20}, {74, 38}}, color={255, 0, 255}));
  connect(winSta.y, TZonSet.uWinSta)
    annotation(Line(points={{62,-20}, {86,-20}, {86, 38}}, color={255, 0, 255}));
  connect(winSta.y, swi2.u2)
    annotation(Line(points={{62,-20}, {86,-20}, {86, 0}, {-60, 0}, {-60, 20}, {-42, 20}}, color={255, 0, 255}));
  connect(winSta.y, swi1.u2)
    annotation(Line(points={{62,-20}, {86,-20}, {86, 0}, {-60, 0}, {-60,-20}, {-42,-20}}, color={255, 0, 255}));
  connect(zerAdj.y, swi2.u1)
    annotation(Line(points={{-118, 0}, {-64, 0}, {-64, 28}, {-42, 28}}, color={0, 0, 127}));
  connect(zerAdj.y, swi1.u1)
    annotation(Line(points={{-118, 0}, {-64, 0}, {-64,-12}, {-42,-12}}, color={0, 0, 127}));
  connect(cooSetAdj.y, swi2.u3)
    annotation(Line(points={{-78, 20}, {-68, 20}, {-68, 12}, {-42, 12}}, color={0, 0, 127}));
  connect(heaSetAdj.y, swi1.u3)
    annotation(Line(points={{-78,-20}, {-68,-20}, {-68,-28}, {-42,-28}}, color={0, 0, 127}));
  connect(swi2.y, TZonSet.setAdj)
    annotation(Line(points={{-18, 20}, {-2, 20}, {-2, 57}, {58, 57}}, color={0, 0, 127}));
  connect(swi1.y, TZonSet.heaSetAdj)
    annotation(Line(points={{-18,-20}, {2,-20}, {2, 53}, {58, 53}}, color={0, 0, 127}));
  annotation(experiment(StopTime=28800, Tolerance=1e-6), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_PR1/TerminalUnits/SetPoints/Validation/ZoneTemperatures.mos"
...
</html>"), Diagram(coordinateSystem(extent={{-140,-120}, {120, 120}})), Icon(graphics={Ellipse(lineColor={75, 138, 73}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid, extent={{-100,-100}, {100, 100}}), Polygon(lineColor={0, 0, 255}, fillColor={75, 138, 73}, pattern=LinePattern.None, fillPattern=FillPattern.Solid, points={{-36, 60}, {64, 0}, {-36,-60}, {-36, 60}}), Ellipse(lineColor={75, 138, 73}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid, extent={{-100,-100}, {100, 100}}), Polygon(lineColor={0, 0, 255}, fillColor={75, 138, 73}, pattern=LinePattern.None, fillPattern=FillPattern.Solid, points={{-36, 58}, {64,-2}, {-36,-62}, {-36, 58}})}));
