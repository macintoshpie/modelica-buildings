...
equation
  ...
  connect(zerAdj.y, swi2.u1)
    annotation(
      Line(
        points={{-118, 0}, {-64, 0}, {-64, 28}, {-42, 28}},
        color={0, 0, 127}));
  connect(zerAdj.y, swi1.u1)
    annotation(
      Line(
        points={{-118, 0}, {-64, 0}, {-64,-12}, {-42,-12}},
        color={0, 0, 127}));
  connect(cooSetAdj.y, swi2.u3)
    annotation(
      Line(
        points={{-78, 20}, {-68, 20}, {-68, 12}, {-42, 12}},
        color={0, 0, 127}));
  connect(heaSetAdj.y, swi1.u3)
    annotation(
      Line(
        points={{-78,-20}, {-68,-20}, {-68,-28}, {-42,-28}},
        color={0, 0, 127}));
  connect(swi2.y, TZonSet.setAdj)
    annotation(
      Line(
        points={{-18, 20}, {-2, 20}, {-2, 57}, {58, 57}},
        color={0, 0, 127}));
  connect(swi1.y, TZonSet.heaSetAdj)
    annotation(
      Line(
        points={{-18,-20}, {2,-20}, {2, 53}, {58, 53}},
        color={0, 0, 127}));
  annotation(
    experiment(
      StopTime=28800,
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/ASHRAE/G36_PR1/TerminalUnits/SetPoints/Validation/ZoneTemperatures.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
