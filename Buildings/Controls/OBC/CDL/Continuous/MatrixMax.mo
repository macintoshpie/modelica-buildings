...
block MatrixMax
  ...
  Interfaces.RealOutput y[if rowMax then size(u, 1) else size(u, 2)]
...
equation
  ...
  annotation(defaultComponentName="matMax", Documentation(info="<html>
<p>
...
</html>"), Icon(coordinateSystem(preserveAspectRatio=true, extent={{-100,-100}, {100, 100}}), graphics={Rectangle(extent={{-100,-100}, {100, 100}}, lineColor={0, 0, 127}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Text(extent={{-150, 150}, {150, 110}}, textString="%name", lineColor={0, 0, 255}), Text(extent={{-78,-62}, {86, 68}}, lineColor={0, 0, 0}, textString="[  ] max()")}), Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-100,-100}, {100, 100}})));
end MatrixMax;
