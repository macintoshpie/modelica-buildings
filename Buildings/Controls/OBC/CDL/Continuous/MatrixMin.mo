...
block MatrixMin
  ...
  Interfaces.RealOutput y[if rowMin then size(u, 1) else size(u, 2)]
...
equation
  ...
  annotation(defaultComponentName="matMin", Documentation(info="<html>
<p>
