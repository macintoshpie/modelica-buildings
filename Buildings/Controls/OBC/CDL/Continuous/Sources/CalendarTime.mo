...
model CalendarTime
  ...
  parameter Integer yearRef(
    ...
    annotation(
      Dialog(
        enable=zerTim == Buildings.Controls.OBC.CDL.Types.ZeroTime.Custom));
...
equation
  connect(calTim.minute, minute)
    annotation(
      Line(
        points={{11, 9}, {55.5, 9}, {55.5, 90}, {110, 90}},
        color={0, 0, 127}));
  connect(calTim.hour, hour)
    annotation(
      Line(
        points={{11, 6.4}, {60, 6.4}, {60, 60}, {110, 60}},
        color={255, 127, 0}));
  connect(calTim.day, day)
    annotation(
      Line(
        points={{11, 3.8}, {64, 3.8}, {64, 30}, {110, 30}},
        color={255, 127, 0}));
  connect(calTim.month, month)
    annotation(
      Line(
        points={{11, 1.2}, {80, 1.2}, {80, 0}, {110, 0}},
        color={255, 127, 0}));
  connect(calTim.year, year)
    annotation(
      Line(
        points={{11,-1.4}, {64,-1.4}, {64,-30}, {110,-30}},
        color={255, 127, 0}));
