...
model Sine
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Sine sin(amplitude=5, freqHz=1/60, phase=0, offset=10, startTime=10)
    "Sine source block"
    annotation(Placement(transformation(extent={{-12,-10}, {8, 10}})));
  annotation(experiment(StopTime=130.0, Tolerance=1e-06), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Continuous/Sources/Validation/Sine.mos"
