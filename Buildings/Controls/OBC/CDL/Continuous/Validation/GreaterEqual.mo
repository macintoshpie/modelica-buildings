...
equation
  connect(ramp1.y, greEqu.u1)
    annotation(
      Line(
        points={{-4, 22}, {8, 22}, {8, 2}, {24, 2}},
        color={0, 0, 127}));
  connect(ramp2.y, greEqu.u2)
    annotation(
      Line(
        points={{-4,-20}, {10,-20}, {10,-6}, {24,-6}},
        color={0, 0, 127}));
  annotation(
    experiment(
      StopTime=1.0,
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Continuous/Validation/GreaterEqual.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
