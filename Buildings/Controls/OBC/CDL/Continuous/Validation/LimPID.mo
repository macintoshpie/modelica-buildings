...
model LimPID
  ...
  Buildings.Controls.OBC.CDL.Continuous.LimPID limPID(controllerType=Buildings.Controls.OBC.CDL.Types.SimpleController.PID, Ti=1, Td=1, yMin=-1)
    "PID controller"
    annotation(Placement(transformation(extent={{-30, 40}, {-10, 60}})));
  Buildings.Controls.OBC.CDL.Continuous.LimPID limPIDOri(controllerType=Buildings.Controls.OBC.CDL.Types.SimpleController.PID, Ti=1, Td=1, yMin=-1)
    "PID controller"
  ...
  Buildings.Controls.OBC.CDL.Continuous.LimPID limPI(Ti=1, Td=1, yMin=-1, controllerType=Buildings.Controls.OBC.CDL.Types.SimpleController.PI)
    "PI controller"
    annotation(Placement(transformation(extent={{-30, 2}, {-10, 22}})));
  Buildings.Controls.OBC.CDL.Continuous.LimPID limPD(Ti=1, Td=1, yMin=-1, controllerType=Buildings.Controls.OBC.CDL.Types.SimpleController.PD)
    "PD controller"
    annotation(Placement(transformation(extent={{-30,-30}, {-10,-10}})));
  Buildings.Controls.OBC.CDL.Continuous.LimPID limP(Ti=1, Td=1, yMin=-1, controllerType=Buildings.Controls.OBC.CDL.Types.SimpleController.P)
    "P controller"
    annotation(Placement(transformation(extent={{-30,-60}, {-10,-40}})));
  Buildings.Controls.OBC.CDL.Continuous.LimPID noLimPID(Ti=1, Td=1, yMax=1e15, yMin=-1e15, controllerType=Buildings.Controls.OBC.CDL.Types.SimpleController.PID)
...
equation
  ...
  connect(pulse.y, limPIDOri.u_s)
    annotation(Line(points={{-68, 24}, {-54, 24}, {-54, 84}, {-32, 84}}, color={0, 0, 127}));
  connect(const.y, limPIDOri.u_m)
    annotation(Line(points={{-68,-12}, {-62,-12}, {-62, 66}, {-20, 66}, {-20, 72}}, color={0, 0, 127}));
  ...
  annotation(experiment(StopTime=1.0, Tolerance=1e-06), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Continuous/Validation/LimPID.mos"
