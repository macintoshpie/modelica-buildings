...
model LimPIDInitialDerivativeOutput
  ...
  Buildings.Controls.OBC.CDL.Continuous.LimPID limPID(controllerType=Buildings.Controls.OBC.CDL.Types.SimpleController.PID, k=3, yd_start=0.2)
    "PID controller"
    annotation(Placement(transformation(extent={{20, 20}, {40, 40}})));
  Buildings.Controls.OBC.CDL.Continuous.LimPID limPD(controllerType=Buildings.Controls.OBC.CDL.Types.SimpleController.PD, k=3, yd_start=0.2)
    "PD controller"
...
equation
  ...
  annotation(experiment(StopTime=0.2, Tolerance=1e-06), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Continuous/Validation/LimPIDInitialDerivativeOutput.mos"
