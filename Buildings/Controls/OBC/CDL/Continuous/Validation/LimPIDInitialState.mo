...
model LimPIDInitialState
  ...
  Buildings.Controls.OBC.CDL.Continuous.LimPID limPID(controllerType=Buildings.Controls.OBC.CDL.Types.SimpleController.PID, k=3, xi_start=0.25)
    "PID controller"
    annotation(Placement(transformation(extent={{20, 20}, {40, 40}})));
  Buildings.Controls.OBC.CDL.Continuous.LimPID limPI(controllerType=Buildings.Controls.OBC.CDL.Types.SimpleController.PI, k=3, xi_start=0.25)
    "PI controller"
...
equation
  ...
  annotation(experiment(StopTime=1, Tolerance=1e-06), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Continuous/Validation/LimPIDInitialState.mos"
