  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Ramp ramp1(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60,-10}, {-40, 10}})));
  Buildings.Controls.OBC.CDL.Continuous.Line line2(
    limitAbove=true,
    limitBelow=false)
    "Block that out the value of the input x along a line specified by two points"
    annotation(
      Placement(
        transformation(
          extent={{-10,-40}, {10,-20}})));
  Buildings.Controls.OBC.CDL.Continuous.Line line3(
    limitBelow=true,
    limitAbove=false)
    "Block that out the value of the input x along a line specified by two points"
    annotation(
...
equation
  ...
  connect(f1.y, line1.f1)
    annotation(
      Line(
        points={{-39, 30}, {-24, 30}, {-24, 4}, {-12, 4}},
        color={0, 0, 127}));
  connect(x1.y, line1.x1)
    annotation(
      Line(
        points={{-39, 62}, {-26, 62}, {-26, 8}, {-12, 8}},
        color={0, 0, 127}));
  ...
  connect(f2.y, line1.f2)
    annotation(
      Line(
        points={{-39,-60}, {-26,-60}, {-26,-8}, {-12,-8}},
        color={0, 0, 127}));
  connect(ramp1.y, line2.u)
    annotation(
      Line(
        points={{-39, 0}, {-36, 0}, {-36,-30}, {-12,-30}},
        color={0, 0, 127}));
  connect(f1.y, line2.f1)
    annotation(
      Line(
        points={{-39, 30}, {-24, 30}, {-24,-26}, {-12,-26}},
        color={0, 0, 127}));
  connect(x1.y, line2.x1)
    annotation(
      Line(
        points={{-39, 62}, {-26, 62}, {-26,-22}, {-12,-22}},
        color={0, 0, 127}));
  connect(x2.y, line2.x2)
    annotation(
      Line(
        points={{-39,-30}, {-24,-30}, {-24,-34}, {-12,-34}},
        color={0, 0, 127}));
  connect(f2.y, line2.f2)
    annotation(
      Line(
        points={{-39,-60}, {-26,-60}, {-26,-38}, {-12,-38}},
        color={0, 0, 127}));
  connect(ramp1.y, line3.u)
    annotation(
      Line(
        points={{-39, 0}, {-36, 0}, {-36,-60}, {-12,-60}},
        color={0, 0, 127}));
  connect(f1.y, line3.f1)
    annotation(
      Line(
        points={{-39, 30}, {-24, 30}, {-24,-56}, {-12,-56}},
        color={0, 0, 127}));
  connect(x1.y, line3.x1)
    annotation(
      Line(
        points={{-39, 62}, {-26, 62}, {-26,-52}, {-12,-52}},
        color={0, 0, 127}));
  connect(x2.y, line3.x2)
    annotation(
      Line(
        points={{-39,-30}, {-24,-30}, {-24,-64}, {-12,-64}},
        color={0, 0, 127}));
  connect(f2.y, line3.f2)
    annotation(
      Line(
        points={{-39,-60}, {-26,-60}, {-26,-68}, {-12,-68}},
        color={0, 0, 127}));
  annotation(
    experiment(
      StopTime=1.0,
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Continuous/Validation/Line.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
