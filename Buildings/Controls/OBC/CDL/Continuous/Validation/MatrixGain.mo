...
equation
  connect(ramp2.y, matGai1.u[2])
    annotation(
      Line(
        points={{-19,-60}, {0,-60}, {0,-40}, {18,-40}},
        color={0, 0, 127}));
  connect(ramp1.y, matGai1.u[1])
    annotation(
      Line(
        points={{-19,-20}, {0,-20}, {0,-40}, {18,-40}},
        color={0, 0, 127}));
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Continuous/Validation/MatrixGain.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
