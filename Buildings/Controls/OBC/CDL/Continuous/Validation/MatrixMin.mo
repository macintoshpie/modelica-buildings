...
model MatrixMin
  ...
  Buildings.Controls.OBC.CDL.Continuous.MatrixMin matMin(nRow=3, nCol=3, rowMin=false)
    "Matrix minimum"
    annotation(Placement(transformation(extent={{0, 50}, {20, 70}})));
  Buildings.Controls.OBC.CDL.Continuous.MatrixMin matMin1(nCol=3, rowMin=false, nRow=2)
    "Matrix minimum"
    annotation(Placement(transformation(extent={{0,-10}, {20, 10}})));
  Buildings.Controls.OBC.CDL.Continuous.MatrixMin matMin2(nCol=3, rowMin=true, nRow=2)
    "Matrix minimum"
...
equation
  ...
  connect(con2.y, matMin2.u)
    annotation(Line(points={{-19,-60}, {-2,-60}}, color={0, 0, 127}));
  annotation(experiment(StopTime=1.0, Tolerance=1e-06), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Continuous/Validation/MatrixMin.mos"
