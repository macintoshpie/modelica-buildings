...
model MultiMin
  ...
  Buildings.Controls.OBC.CDL.Continuous.MultiMin minVal(
    nin=sizOfVec)
...
equation
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Continuous/Validation/MultiMin.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
