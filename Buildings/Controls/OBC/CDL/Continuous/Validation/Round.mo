...
equation
  ...
  connect(ramp1.y, gai1.u)
    annotation(
      Line(
        points={{-39, 0}, {-20, 0}, {-20,-50}, {-2,-50}},
        color={0, 0, 127}));
  connect(round3.u, gai1.y)
    annotation(
      Line(
        points={{38,-50}, {30,-50}, {21,-50}},
        color={0, 0, 127}));
  annotation(
    experiment(
      StopTime=1.0,
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Continuous/Validation/Round.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
