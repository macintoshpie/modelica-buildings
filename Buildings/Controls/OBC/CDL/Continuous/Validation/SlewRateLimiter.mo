...
equation
  connect(ramp1.y, add.u1)
    annotation(
      Line(
        points={{-59, 110}, {-46, 110}, {-46, 96}, {-42, 96}},
        color={0, 0, 127}));
  connect(ramp2.y, add.u2)
    annotation(
      Line(
        points={{-59, 80}, {-52, 80}, {-52, 84}, {-42, 84}},
        color={0, 0, 127}));
  connect(ramp4.y, add1.u1)
    annotation(
      Line(
        points={{-59, 50}, {-50, 50}, {-50, 36}, {-42, 36}},
        color={0, 0, 127}));
  connect(ramp3.y, add1.u2)
    annotation(
      Line(
        points={{-59, 20}, {-50, 20}, {-50, 24}, {-42, 24}},
        color={0, 0, 127}));
  connect(ramp6.y, add2.u1)
    annotation(
      Line(
        points={{-59,-20}, {-50,-20}, {-50,-32}, {-42,-32}},
        color={0, 0, 127}));
  connect(ramp5.y, add2.u2)
    annotation(
      Line(
        points={{-59,-50}, {-50,-50}, {-50,-44}, {-42,-44}},
        color={0, 0, 127}));
  connect(ramp8.y, add3.u1)
    annotation(
      Line(
        points={{-59,-90}, {-50,-90}, {-50,-104}, {-42,-104}},
        color={0, 0, 127}));
  connect(ramp7.y, add3.u2)
    annotation(
      Line(
        points={{-59,-120}, {-50,-120}, {-50,-116}, {-42,-116}},
        color={0, 0, 127}));
  connect(add.y, add4.u1)
    annotation(
      Line(
        points={{-19, 90}, {-12, 90}, {-12, 66}, {-2, 66}},
        color={0, 0, 127}));
  connect(add1.y, add4.u2)
    annotation(
      Line(
        points={{-19, 30}, {-10, 30}, {-10, 54}, {-2, 54}},
        color={0, 0, 127}));
  connect(add2.y, add5.u1)
    annotation(
      Line(
        points={{-19,-38}, {-10,-38}, {-10,-64}, {-2,-64}},
        color={0, 0, 127}));
  connect(add3.y, add5.u2)
    annotation(
      Line(
        points={{-19,-110}, {-12,-110}, {-12,-76}, {-2,-76}},
        color={0, 0, 127}));
  connect(add4.y, add6.u1)
    annotation(
      Line(
        points={{21, 60}, {24, 60}, {24, 6}, {38, 6}},
        color={0, 0, 127}));
  connect(add5.y, add6.u2)
    annotation(
      Line(
        points={{21,-70}, {24,-70}, {24,-6}, {38,-6}},
        color={0, 0, 127}));
  connect(sleRatLim.u, add6.y)
    annotation(
      Line(
        points={{68, 0}, {68, 0}, {61, 0}},
        color={0, 0, 127}));
  annotation(
    experiment(
      StopTime=480,
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Continuous/Validation/SlewRateLimiter.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
