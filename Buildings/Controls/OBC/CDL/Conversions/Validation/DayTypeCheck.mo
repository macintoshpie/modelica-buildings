...
equation
  connect(dayTypSat.y[1], isNonWorDay.u)
    annotation(
      Line(
        points={{-59, 0}, {-40, 0}, {-20, 0}, {18, 0}},
        color={0, 127, 0}));
  connect(dayTypSat.y[1], isHoliday.u)
    annotation(
      Line(
        points={{-59, 0}, {-40, 0}, {-20, 0}, {-20,-40}, {18,-40}},
        color={0, 127, 0}));
  connect(dayTypSat.y[1], isWorDay.u)
    annotation(
      Line(
        points={{-59, 0}, {-20, 0}, {-20, 40}, {18, 40}},
        color={0, 127, 0}));
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Conversions/Validation/DayTypeCheck.mos"
        "Simulate and plot"),
    experiment(
      StartTime=0,
      StopTime=1814400,
