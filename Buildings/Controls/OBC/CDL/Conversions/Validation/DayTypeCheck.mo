...
equation
  ...
  annotation(__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Conversions/Validation/DayTypeCheck.mos"
    "Simulate and plot"), experiment(StartTime=0, StopTime=1814400, Tolerance=1E-6), Documentation(info="<html>
<p>
