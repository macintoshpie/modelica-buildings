...
model DayType
  ...
  Buildings.Controls.OBC.CDL.Discrete.DayType dayTypTwoWeeks(days={Types.Day.WorkingDay, Types.Day.WorkingDay, Types.Day.WorkingDay, Types.Day.WorkingDay, Types.Day.WorkingDay, Types.Day.WorkingDay, Types.Day.NonWorkingDay, Types.Day.NonWorkingDay, Types.Day.NonWorkingDay, Types.Day.NonWorkingDay, Types.Day.NonWorkingDay, Types.Day.NonWorkingDay, Types.Day.NonWorkingDay, Types.Day.NonWorkingDay}, nout=14)
  ...
  annotation(__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Discrete/Examples/DayType.mos"
    "Simulate and plot"), experiment(StartTime=-1814400, StopTime=1.8144e+06, Tolerance=1E-6), Documentation(info="<html>
<p>
