...
equation
  connect(ramp1.y, sin1.u)
    annotation(
      Line(
        points={{-39, 0}, {-12, 0}, {-12, 0}},
        color={0, 0, 127}));
  connect(sin1.y, triggeredMax.u)
    annotation(
      Line(
        points={{11, 0}, {19.5, 0}, {28, 0}},
        color={0, 0, 127}));
  connect(booPul.y, triggeredMax.trigger)
    annotation(
      Line(
        points={{11,-40}, {26,-40}, {40,-40}, {40,-11.8}},
        color={255, 0, 255}));
  annotation(
    experiment(
      StopTime=1.0,
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Discrete/Examples/TriggeredMax.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
