...
model TriggeredMovingMean
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Sine sin(freqHz=1/8, phase=0.5235987755983, startTime=-0.5)
    "Example input signal"
    annotation(Placement(transformation(extent={{-60, 40}, {-40, 60}})));
  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse booPul(width=0.5, period=1, startTime=-0.5)
  ...
  Buildings.Controls.OBC.CDL.Discrete.TriggeredMovingMean triMovMea2(n=3)
    "Triggered moving mean with 3 samples to average with a different trigger period"
    annotation(Placement(transformation(extent={{0,-60}, {20,-40}})));
  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse booPul1(width=0.5, period=1, startTime=0)
    "Block that outputs trigger signals"
...
equation
  ...
  annotation(experiment(StartTime=-0.5, StopTime=15.0, Tolerance=1e-06), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Discrete/Examples/TriggeredMovingMean.mos"
