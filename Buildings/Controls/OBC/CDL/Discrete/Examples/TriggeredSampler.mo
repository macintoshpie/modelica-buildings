...
equation
  ...
  connect(booPul.y, triSam.trigger)
    annotation(
      Line(
        points={{11,-40}, {50,-40}, {50,-12}, {50,-11.8}},
        color={255, 0, 255}));
  connect(sin1.y, triSam1.u)
    annotation(
      Line(
        points={{1, 0}, {30, 0}, {30, 50}, {58, 50}},
        color={0, 0, 127}));
  connect(booPul.y, triSam1.trigger)
    annotation(
      Line(
        points={{11,-40}, {70,-40}, {70, 38.2}},
        color={255, 0, 255}));
  annotation(
    experiment(
      StopTime=1.0,
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Discrete/Examples/TriggeredSampler.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
