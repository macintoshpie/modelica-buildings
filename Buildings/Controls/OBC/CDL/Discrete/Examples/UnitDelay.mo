...
model UnitDelay
  ...
  Buildings.Controls.OBC.CDL.Discrete.UnitDelay unitDelay1(samplePeriod=0.2)
...
equation
  ...
  annotation(experiment(StopTime=1.0, Tolerance=1e-06), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Discrete/Examples/UnitDelay.mos"
