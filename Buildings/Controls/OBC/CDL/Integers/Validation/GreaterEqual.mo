...
equation
  connect(reaToInt.y, intGreEqu.u1)
    annotation(
      Line(
        points={{1, 20}, {40, 20}, {40, 0}, {58, 0}},
        color={255, 127, 0}));
  connect(reaToInt1.y, intGreEqu.u2)
    annotation(
      Line(
        points={{1,-20}, {40,-20}, {40,-8}, {58,-8}},
        color={255, 127, 0}));
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Integers/Validation/GreaterEqual.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
