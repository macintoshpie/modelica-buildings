...
equation
  connect(ramp1.y, round1.u)
    annotation(
      Line(
        points={{-59, 0}, {-50, 0}, {-50, 0}, {-42, 0}},
        color={0, 0, 127}));
  connect(round1.y, reaToInt.u)
    annotation(
      Line(
        points={{-19, 0}, {-12, 0}, {-12, 0}, {-2, 0}},
        color={0, 0, 127}));
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Integers/Validation/GreaterThreshold.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
