...
equation
  ...
  connect(reaToInt1.y, intLesEqu.u2)
    annotation(
      Line(
        points={{21,-20}, {40,-20}, {40,-8}, {58,-8}},
        color={255, 127, 0}));
  connect(reaToInt.y, intLesEqu.u1)
    annotation(
      Line(
        points={{21, 20}, {40, 20}, {40, 0}, {58, 0}},
        color={255, 127, 0}));
  annotation(
    experiment(
      StopTime=1.0,
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Integers/Validation/LessEqual.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
