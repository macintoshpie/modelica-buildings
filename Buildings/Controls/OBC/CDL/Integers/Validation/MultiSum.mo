...
equation
  ...
  connect(reaToInt.y, add1.u[1])
    annotation(
      Line(
        points={{21, 40}, {40, 40}, {40, 4.66667}, {58, 4.66667}},
        color={255, 127, 0}));
  connect(reaToInt1.y, add1.u[2])
    annotation(
      Line(
        points={{21, 0}, {38, 0}, {38, 0}, {58, 0}},
        color={255, 127, 0}));
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Integers/Validation/MultiSum.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
