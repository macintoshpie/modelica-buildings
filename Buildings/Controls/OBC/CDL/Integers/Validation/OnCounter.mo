...
model OnCounter
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse booPul(width=0.5, period=0.1)
    "Block that outputs cyclic on and off"
    annotation(Placement(transformation(extent={{-26,-10}, {-6, 10}})));
  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse reset(width=0.5, period=1.0)
    "Block that outputs cyclic on and off"
...
equation
  ...
  annotation(experiment(StopTime=2.0, Tolerance=1e-06), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Integers/Validation/OnCounter.mos"
