...
model Product
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.TimeTable timTabLin1(smoothness=Buildings.Controls.OBC.CDL.Types.Smoothness.ConstantSegments, table=[
    0, 0;
    0.35, 1;
    0.55, 0;
    0.7, 1;
...
equation
  connect(reaToInt1.y, product.u1)
    annotation(Line(points={{1, 20}, {40, 20}, {40, 6}, {58, 6}}, color={255, 127, 0}));
  ...
  connect(timTabLin1.y[1], reaToInt2.u)
    annotation(Line(points={{-59,-20}, {-22,-20}}, color={0, 0, 127}));
  annotation(experiment(StopTime=1.0, Tolerance=1e-06), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Integers/Validation/Product.mos"
