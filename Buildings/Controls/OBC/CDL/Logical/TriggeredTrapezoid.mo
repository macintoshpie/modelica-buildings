...
block TriggeredTrapezoid
  ...
  parameter Modelica.SIunits.Time rising(
    final min=0)=0
    "Rising duration of trapezoid";
  parameter Modelica.SIunits.Time falling(
    final min=0)=rising
  ...
  annotation(
    ...
    Icon(
      ...
      graphics={Rectangle(
        ...
        fillPattern=FillPattern.Solid,
        points={{-66, 90}, {-74, 68}, {-58, 68}, {-66, 90}}), Line(
        points={{-66,-70}, {-46,-70}, {-46, 24}, {22, 24}, {22,-70}, {74,-70}},
        color={255, 0, 255}), Ellipse(
        extent={{-71, 7}, {-85,-7}},
        ...
        fillColor={192, 192, 192},
        fillPattern=FillPattern.Solid,
        points={{90.0,-70.0}, {68.0,-62.0}, {68.0,-78.0}, {90.0,-70.0}}), Text(
    ...
    Diagram(
      coordinateSystem(
        ...
        extent={{-100,-100}, {100, 100}}),
      graphics={Line(
        points={{-80,-20}, {-60,-20}, {-30, 40}, {8, 40}, {40,-20}, {60,-20}},
        color={0, 0, 255}), Line(
        points={{-90,-70}, {82,-70}}), Line(
        points={{-80, 68}, {-80,-80}},
        color={0, 0, 0}), Polygon(
        ...
        points={{-80,-68}, {-60,-68}, {-60,-42}, {8,-42}, {8,-68}, {60,-68}},
        ...
        points={{-60, 40}, {-30, 40}},
        color={0, 0, 0}), Line(
        points={{8,-20}, {40,-20}}), Line(
        points={{-20, 40}, {-20,-20}}), Line(
        points={{-20,-20}, {-20,-70}}), Text(
        extent={{-44, 50}, {-44, 40}},
        lineColor={0, 0, 0},
