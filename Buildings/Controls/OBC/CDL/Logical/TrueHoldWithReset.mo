  ...
  annotation(
    ...
    Icon(
      graphics={Rectangle(
        ...
        points={{-68,-46}, {-48,-46}, {-48,-2}, {22,-2}, {22,-46}, {78,-46}}), Text(
        extent={{-150, 150}, {150, 110}},
        textString="%name",
        lineColor={0, 0, 255}), Text(
        extent={{-90,-62}, {96,-90}},
        lineColor={0, 0, 255},
        textString="%duration"), Ellipse(
        extent={{71, 7}, {85,-7}},
