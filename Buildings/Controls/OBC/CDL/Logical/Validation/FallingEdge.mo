...
model FallingEdge
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse booPul(width=0.5, period=1.0)
...
equation
  ...
  annotation(experiment(StopTime=5.0, Tolerance=1e-06), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Logical/Validation/FallingEdge.mos"
