...
equation
  ...
  connect(conInt.y, proInt.u1)
    annotation(
      Line(
        points={{-59, 70}, {-20, 70}, {-20, 56}, {-2, 56}},
        color={255, 127, 0}));
  connect(booToInt.y, proInt.u2)
    annotation(
      Line(
        points={{-19, 30}, {-10, 30}, {-10, 44}, {-2, 44}},
        color={255, 127, 0}));
  connect(conInt1.y, proInt1.u1)
    annotation(
      Line(
        points={{-59,-30}, {-10,-30}, {-10,-44}, {-2,-44}},
        color={255, 127, 0}));
  connect(booToInt1.y, proInt1.u2)
    annotation(
      Line(
        points={{-19,-70}, {-10,-70}, {-10,-56}, {-2,-56}},
        color={255, 127, 0}));
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Logical/Validation/IntegerSwitch.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
