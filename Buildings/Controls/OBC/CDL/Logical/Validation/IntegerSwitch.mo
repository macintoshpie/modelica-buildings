...
equation
  ...
  connect(proInt1.y, integerSwitch.u3)
    annotation(Line(points={{21,-50}, {40,-50}, {40,-8}, {58,-8}}, color={255, 127, 0}));
  annotation(experiment(StopTime=5.0, Tolerance=1e-06), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Logical/Validation/IntegerSwitch.mos"
