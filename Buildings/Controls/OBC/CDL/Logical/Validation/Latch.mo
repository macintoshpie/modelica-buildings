...
model Latch
  ...
  Buildings.Controls.OBC.CDL.Logical.Latch truCle(
    pre_y_start=true)
...
equation
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Logical/Validation/Latch.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
...
First implementation.
    ...
    Diagram(
      ...
      graphics={Text(
        ...
        lineColor={28, 108, 200},
        textString="Latch input falls: true to false"), Text(
        extent={{92, 64}, {170, 56}},
        lineColor={28, 108, 200},
        textString="Clear input rises: false to true"), Text(
        extent={{92, 76}, {172, 66}},
        lineColor={28, 108, 200},
        textString="Latch input rise: false to true"), Text(
        extent={{76, 86}, {136, 78}},
        lineColor={28, 108, 200},
