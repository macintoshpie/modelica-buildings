...
equation
  ...
  connect(booPul1.y, logicalSwitch.u1)
    annotation(
      Line(
        points={{-4, 34}, {10, 34}, {10, 8}, {24, 8}},
        color={255, 0, 255}));
  connect(booPul3.y, logicalSwitch.u3)
    annotation(
      Line(
        points={{-4,-36}, {10,-36}, {10,-8}, {24,-8}},
        color={255, 0, 255}));
  annotation(
    experiment(
      StopTime=5.0,
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Logical/Validation/LogicalSwitch.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
