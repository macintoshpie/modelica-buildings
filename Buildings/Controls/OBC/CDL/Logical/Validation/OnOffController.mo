...
model OnOffController
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant cons2(k=0.7)
    "Constant as source term"
    annotation(Placement(transformation(extent={{-32, 18}, {-12, 38}})));
  Buildings.Controls.OBC.CDL.Logical.OnOffController onOffController(bandwidth=0.1)
...
equation
  ...
  annotation(experiment(StopTime=5.0, Tolerance=1e-06), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Logical/Validation/OnOffController.mos"
