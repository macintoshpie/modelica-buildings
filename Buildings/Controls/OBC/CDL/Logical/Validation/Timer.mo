...
equation
  ...
  connect(booPul.y, accuTimer.u)
    annotation(
      Line(
        points={{-18, 80}, {0, 80}, {0, 40}, {18, 40}},
        color={255, 0, 255}));
  connect(booPul1.y, accuTimer.reset)
    annotation(
      Line(
        points={{-18, 40}, {-10, 40}, {-10, 32}, {18, 32}},
        color={255, 0, 255}));
  connect(booPul.y, accuTimer3.u)
    annotation(
      Line(
        points={{-18, 80}, {0, 80}, {0,-70}, {18,-70}},
        color={255, 0, 255}));
  connect(accuTimer3.y, greEquThr.u)
    annotation(
      Line(
        points={{42,-70}, {60,-70}, {60,-90}, {-92,-90}, {-92,-70}, {-82,-70}},
        color={0, 0, 127}));
  ...
  connect(pre.y, accuTimer3.reset)
    annotation(
      Line(
        points={{-18,-70}, {-10,-70}, {-10,-78}, {18,-78}},
        color={255, 0, 255}));
  connect(booPul.y, accuTimer1.u)
    annotation(
      Line(
        points={{-18, 80}, {0, 80}, {0, 0}, {18, 0}},
        color={255, 0, 255}));
  connect(booPul.y, accuTimer1.reset)
    annotation(
      Line(
        points={{-18, 80}, {0, 80}, {0,-8}, {18,-8}},
        color={255, 0, 255}));
  connect(booPul.y, accuTimer2.reset)
    annotation(
      Line(
        points={{-18, 80}, {0, 80}, {0,-48}, {18,-48}},
        color={255, 0, 255}));
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Logical/Validation/Timer.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
