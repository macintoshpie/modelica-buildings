...
model Toggle
  ...
  Buildings.Controls.OBC.CDL.Logical.Toggle truCle(
    pre_y_start=true)
...
equation
  connect(cleInp.y, swiCleInp.clr)
    annotation(
      Line(
        points={{21, 80}, {70, 80}, {70, 94}, {99, 94}},
        color={255, 0, 255}));
  connect(not1.u, cleInp.y)
    annotation(
      Line(
        points={{38,-60}, {30,-60}, {30, 80}, {21, 80}},
        color={255, 0, 255}));
  connect(not1.y, swiCleInp1.clr)
    annotation(
      Line(
        points={{61,-60}, {72,-60}, {72,-66}, {99,-66}},
        color={255, 0, 255}));
  connect(fal.y, falCle.clr)
    annotation(
      Line(
        points={{-139, 80}, {-112, 80}, {-112, 94}, {-101, 94}},
        color={255, 0, 255}));
  connect(togInp.y, falCle.u)
    annotation(
      Line(
        points={{-139, 160}, {-120, 160}, {-120, 100}, {-101, 100}},
        color={255, 0, 255}));
  connect(tru.y, truCle.clr)
    annotation(
      Line(
        points={{-139, 0}, {-106, 0}, {-106, 14}, {-101, 14}},
        color={255, 0, 255}));
  connect(togInp.y, truCle.u)
    annotation(
      Line(
        points={{-139, 160}, {-120, 160}, {-120, 20}, {-101, 20}},
        color={255, 0, 255}));
  connect(fal.y, iniFalOut.clr)
    annotation(
      Line(
        points={{-139, 80}, {-112, 80}, {-112,-66}, {-101,-66}},
        color={255, 0, 255}));
  connect(fal.y, iniTruOut.clr)
    annotation(
      Line(
        points={{-139, 80}, {-112, 80}, {-112,-146}, {-101,-146}},
        color={255, 0, 255}));
  connect(togInp.y, iniFalOut.u)
    annotation(
      Line(
        points={{-139, 160}, {-120, 160}, {-120,-60}, {-101,-60}},
        color={255, 0, 255}));
  connect(togInp.y, iniTruOut.u)
    annotation(
      Line(
        points={{-139, 160}, {-120, 160}, {-120,-140}, {-101,-140}},
        color={255, 0, 255}));
  connect(togInp.y, swiCleInp.u)
    annotation(
      Line(
        points={{-139, 160}, {80, 160}, {80, 100}, {99, 100}},
        color={255, 0, 255}));
  connect(togInp.y, swiCleInp1.u)
    annotation(
      Line(
        points={{-139, 160}, {80, 160}, {80,-60}, {99,-60}},
        color={255, 0, 255}));
  annotation(
    experiment(
      StopTime=10.0,
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Logical/Validation/Toggle.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
...
First implementation.
    ...
    Diagram(
      ...
      graphics={Text(
        ...
        textString="Clear input keeps false"), Text(
        extent={{-108, 60}, {-40, 48}},
        lineColor={28, 108, 200},
        textString="Clear input keeps true"), Text(
        extent={{-108,-20}, {-40,-32}},
        lineColor={28, 108, 200},
        textString="Clear input keeps false"), Text(
        extent={{-108,-26}, {0,-48}},
        lineColor={28, 108, 200},
        textString="Start value of y is false (default)"), Text(
        extent={{-108,-100}, {-40,-112}},
        lineColor={28, 108, 200},
        textString="Clear input keeps false"), Text(
        extent={{-110,-110}, {-28,-124}},
        lineColor={28, 108, 200},
        textString="Start value of y is true"), Text(
        extent={{-108, 50}, {-28, 38}},
        lineColor={28, 108, 200},
        textString="Start value of y is true"), Text(
        extent={{76, 148}, {136, 140}},
        lineColor={28, 108, 200},
        textString="At 3rd second:"), Text(
        extent={{92, 128}, {172, 118}},
        lineColor={28, 108, 200},
        textString="Clear input falls: true to false"), Text(
        extent={{92, 138}, {170, 128}},
        lineColor={28, 108, 200},
        textString="Toggle input falls: true to false"), Text(
        extent={{92, 64}, {170, 56}},
        lineColor={28, 108, 200},
        textString="Clear input rises: false to true"), Text(
        extent={{92, 76}, {172, 66}},
        lineColor={28, 108, 200},
        textString="Toggle input rise: false to true"), Text(
        extent={{76, 86}, {136, 78}},
        lineColor={28, 108, 200},
        textString="At 6th second:"), Text(
