...
model TriggeredTrapezoid
  ...
  Buildings.Controls.OBC.CDL.Logical.TriggeredTrapezoid triggeredTrapezoid1(amplitude=5, rising=0.3, offset=1.5)
...
equation
  ...
  annotation(experiment(StopTime=5.0, Tolerance=1e-06), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Logical/Validation/TriggeredTrapezoid.mos"
