...
model TrueHoldWithReset
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse booPul(period=9000, startTime=300)
    "Boolean pulse input signal"
    annotation(Placement(transformation(extent={{-40, 70}, {-20, 90}})));
  Buildings.Controls.OBC.CDL.Logical.TrueHoldWithReset truHol(duration=3600)
  ...
  Buildings.Controls.OBC.CDL.Logical.TrueHoldWithReset truHol1(duration=600)
    "Block that holds a signal on for a requested time period"
    annotation(Placement(transformation(extent={{20, 20}, {40, 40}})));
  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse booPul2(period=9000, startTime=300)
    "Boolean pulse input signal"
    annotation(Placement(transformation(extent={{-40,-20}, {-20, 0}})));
  Buildings.Controls.OBC.CDL.Logical.TrueHoldWithReset truHol2(duration=3600)
    "Block that holds a signal on for a requested time period"
    annotation(Placement(transformation(extent={{20,-20}, {40, 0}})));
  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse booPul3(period=3600)
    "Boolean pulse input signal"
    annotation(Placement(transformation(extent={{-40,-70}, {-20,-50}})));
  Buildings.Controls.OBC.CDL.Logical.TrueHoldWithReset truHol3(duration=600)
    "Block that holds a signal on for a requested time period"
...
equation
  connect(booPul.y, truHol.u)
    annotation(Line(points={{-19, 80}, {2, 80}, {19, 80}}, color={255, 0, 255}));
  connect(booPul1.y, truHol1.u)
    annotation(Line(points={{-19, 30}, {19, 30}}, color={255, 0, 255}));
  ...
  annotation(experiment(StopTime=15000.0, Tolerance=1e-06), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Logical/Validation/TrueHoldWithReset.mos"
