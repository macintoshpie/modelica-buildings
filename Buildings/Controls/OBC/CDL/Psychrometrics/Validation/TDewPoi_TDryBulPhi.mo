...
model TDewPoi_TDryBulPhi
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Ramp phi(duration=1, height=1, offset=0.001)
    "Relative humidity"
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Ramp TDryBul2(duration=1, height=35, offset=273.15 + 2.0)
    "Dry bulb temperature"
...
equation
  ...
  connect(TDryBul.y, dewBulPhi.TDryBul)
    annotation(Line(points={{-72, 84}, {-68, 84}, {-68, 92}, {14, 92}}, color={0, 0, 127}));
  connect(phi.y, dewBulPhi.phi)
    annotation(Line(points={{-72, 50}, {-62, 50}, {-62, 84}, {14, 84}}, color={0, 0, 127}));
  connect(p.y, dewBulPhi.p)
    annotation(Line(points={{-72, 18}, {-56, 18}, {-56, 76}, {14, 76}}, color={0, 0, 127}));
  connect(p.y, X_pTphi.p_in)
    annotation(Line(points={{-72, 18}, {-56, 18}, {-56, 20}, {-48, 20}}, color={0, 0, 127}));
  ...
  connect(TDryBul2.y, dewBulPhi1.TDryBul)
    annotation(Line(points={{-72,-18}, {-68,-18}, {-68,-10}, {16,-10}}, color={0, 0, 127}));
  connect(TDryBul2.y, X_pTphi1.T)
    annotation(Line(points={{-72,-18}, {-68,-18}, {-68,-88}, {-46,-88}}, color={0, 0, 127}));
  connect(p2.y, X_pTphi1.p_in)
    annotation(Line(points={{-72,-84}, {-56,-84}, {-56,-82}, {-46,-82}}, color={0, 0, 127}));
  connect(p2.y, dewBulPhi1.p)
    annotation(Line(points={{-72,-84}, {-56,-84}, {-56,-26}, {16,-26}}, color={0, 0, 127}));
  connect(phi2.y, dewBulPhi1.phi)
    annotation(Line(points={{-72,-50}, {-62,-50}, {-62,-18}, {16,-18}}, color={0, 0, 127}));
  ...
  annotation(experiment(StopTime=1.0, Tolerance=1e-06), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Psychrometrics/Validation/TDewPoi_TDryBulPhi.mos"
