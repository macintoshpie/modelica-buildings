...
model TWetBul_TDryBulPhi
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Ramp phi(duration=1, height=0.95, offset=0.05)
    "Relative humidity"
  ...
  Buildings.Utilities.Psychrometrics.TWetBul_TDryBulPhi wetBulPhi_BuiLib(redeclare package Medium=Medium, approximateWetBulb=true)
    "Model for wet bulb temperature"
    annotation(Placement(transformation(extent={{-10, 6}, {10, 26}})));
  Buildings.Utilities.Psychrometrics.TWetBul_TDryBulXi wetBulXi(redeclare package Medium=Medium, approximateWetBulb=true)
...
equation
  ...
  connect(TDryBul.y, wetBulPhi.TDryBul)
    annotation(Line(points={{-68, 56}, {-40, 56}, {-40, 64}, {-12, 64}}, color={0, 0, 127}));
  ...
  connect(phi.y, wetBulPhi.phi)
    annotation(Line(points={{-68, 16}, {-46, 16}, {-46, 52}, {-28, 52}, {-28, 56}, {-12, 56}}, color={0, 0, 127}));
  connect(p.y, wetBulPhi.p)
    annotation(Line(points={{-68,-24}, {-52,-24}, {-52, 48}, {-12, 48}}, color={0, 0, 127}));
  ...
  annotation(experiment(StopTime=1.0, Tolerance=1e-06), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Psychrometrics/Validation/TWetBul_TDryBulPhi.mos"
