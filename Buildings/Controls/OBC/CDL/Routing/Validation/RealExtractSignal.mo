...
model RealExtractSignal
  ...
  Buildings.Controls.OBC.CDL.Routing.RealExtractSignal extSig(nin=5, nout=3, extract={1, 2, 5})
...
equation
  ...
  annotation(experiment(StopTime=1.0, Tolerance=1e-06), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Routing/Validation/RealExtractSignal.mos"
