...
equation
  connect(ram.y, extSig.u[1])
    annotation(
      Line(
        points={{-39, 60}, {-39, 60}, {-12, 60}, {-12,-1.6}, {-2,-1.6}},
        color={0, 0, 127}));
  connect(pul.y, extSig.u[2])
    annotation(
      Line(
        points={{-39, 30}, {-39, 30}, {-16, 30}, {-16,-0.8}, {-2,-0.8}},
        color={0, 0, 127}));
  connect(pul1.y, extSig.u[3])
    annotation(
      Line(
        points={{-39, 0}, {-20, 0}, {-2, 0}},
        color={0, 0, 127}));
  connect(ram1.y, extSig.u[4])
    annotation(
      Line(
        points={{-39,-30}, {-39,-30}, {-20,-30}, {-20, 0.8}, {-2, 0.8}},
        color={0, 0, 127}));
  connect(ram2.y, extSig.u[5])
    annotation(
      Line(
        points={{-39,-60}, {-24,-60}, {-24, 1.6}, {-2, 1.6}},
        color={0, 0, 127}));
  annotation(
    experiment(
      StopTime=1.0,
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Routing/Validation/RealExtractSignal.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
