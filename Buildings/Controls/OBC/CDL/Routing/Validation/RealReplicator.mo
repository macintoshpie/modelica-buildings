...
model RealReplicator
  ...
  Buildings.Controls.OBC.CDL.Routing.RealReplicator reaRep(nout=3)
...
equation
  ...
  annotation(experiment(StopTime=1.0, Tolerance=1e-06), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Routing/Validation/RealReplicator.mos"
