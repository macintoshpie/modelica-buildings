...
model SunRiseSetNegativeStartTime
  ...
  annotation(experiment(StartTime=-43200, StopTime=259200, Tolerance=1e-06), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/CDL/Utilities/Validation/SunRiseSetNegativeStartTime.mos"
