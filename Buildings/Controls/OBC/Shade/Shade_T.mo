  ...
  annotation(
    ...
    Icon(
      ...
      graphics={Rectangle(
        ...
        points={{-79,-29}, {41,-29}}), Line(
        points={{-15,-21}, {1,-29}, {-15,-36}}), Line(
        points={{41, 51}, {41,-29}}), Line(
        points={{33, 3}, {41, 22}, {50, 3}}), Line(
        points={{-49, 51}, {81, 51}}), Line(
        points={{-4, 59}, {-19, 51}, {-4, 43}}), Line(
        points={{-59, 29}, {-49, 11}, {-39, 29}}), Line(
        points={{-49, 51}, {-49,-29}}), Text(
        extent={{-92,-49}, {-9,-92}},
        lineColor={192, 192, 192},
        textString="%TLow"), Text(
        extent={{2,-49}, {91,-92}},
        lineColor={192, 192, 192},
        textString="%THigh"), Rectangle(
        extent={{-91,-49}, {-8,-92}},
