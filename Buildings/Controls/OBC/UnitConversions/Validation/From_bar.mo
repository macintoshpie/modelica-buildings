...
protected
  parameter Real kin=1.
    "Validation input";
  parameter Real kin1=0.00025
    "Validation input 1";
  parameter Real kout=1.*100000.
    "Validation output";
  parameter Real kout1=0.00025*100000.
    "Validation output 1";
  Buildings.Controls.OBC.UnitConversions.From_bar from_bar
    "Unit converter from bar to pascal "
    annotation(Placement(transformation(extent={{-20, 40}, {0, 60}})));
  Buildings.Controls.OBC.UnitConversions.From_bar from_bar1
    "Unit converter from bar to pascal "
