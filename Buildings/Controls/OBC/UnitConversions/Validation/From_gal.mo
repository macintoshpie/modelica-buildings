...
protected
  parameter Real kin=1.
    "Validation input";
  parameter Real kin1=100.
    "Validation input 1";
  parameter Real kout=1.*0.003785412
    "Validation output";
  parameter Real kout1=100.*0.003785412
    "Validation output 1";
  Buildings.Controls.OBC.UnitConversions.From_gal from_gal
    "Unit converter from gallon to cubic meter "
    annotation(Placement(transformation(extent={{-20, 40}, {0, 60}})));
  Buildings.Controls.OBC.UnitConversions.From_gal from_gal1
    "Unit converter from gallon to cubic meter "
