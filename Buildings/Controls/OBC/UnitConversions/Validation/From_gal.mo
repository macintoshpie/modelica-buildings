...
equation
  connect(result.y, add.u2)
    annotation(
      Line(
        points={{2, 20}, {10, 20}, {10, 44}, {18, 44}},
        color={0, 0, 127}));
  connect(result1.y, add1.u2)
    annotation(
      Line(
        points={{2,-60}, {10,-60}, {10,-36}, {18,-36}},
        color={0, 0, 127}));
  ...
  connect(from_gal1.y, add1.u1)
    annotation(
      Line(
        points={{2,-30}, {8,-30}, {8,-24}, {18,-24}},
        color={0, 0, 127}));
  connect(from_gal.y, add.u1)
    annotation(
      Line(
        points={{2, 50}, {10, 50}, {10, 56}, {18, 56}},
        color={0, 0, 127}));
  ...
  annotation(
    ...
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/UnitConversions/Validation/From_gal.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
