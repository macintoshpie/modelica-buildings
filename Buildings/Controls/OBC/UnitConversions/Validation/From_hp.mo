...
protected
  parameter Real kin=10.
    "Validation input";
  parameter Real kin1=45.
    "Validation input 1";
  parameter Real kout=10.*0.7457
    "Validation output";
  parameter Real kout1=45.*0.7457
    "Validation output 1";
  Buildings.Controls.OBC.UnitConversions.From_hp from_hp
    "Unit converter from horsepower to watt "
    annotation(Placement(transformation(extent={{-20, 40}, {0, 60}})));
  Buildings.Controls.OBC.UnitConversions.From_hp from_hp1
    "Unit converter from horsepower to watt "
