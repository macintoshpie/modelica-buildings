...
protected
  parameter Real kin=3517.
    "Validation input";
  parameter Real kin1=351700.
    "Validation input 1";
  parameter Real kout=1.
    "Validation output";
  parameter Real kout1=100.
    "Validation output 1";
  Buildings.Controls.OBC.UnitConversions.To_ton to_ton
    "Unit converter from watt to ton of refrigeration "
    annotation(Placement(transformation(extent={{-20, 40}, {0, 60}})));
  Buildings.Controls.OBC.UnitConversions.To_ton to_ton1
    "Unit converter from watt to ton of refrigeration "
