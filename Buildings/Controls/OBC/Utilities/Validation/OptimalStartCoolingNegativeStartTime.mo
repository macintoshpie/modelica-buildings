...
equation
  ...
  connect(TSetCoo.y, add.u2)
    annotation(
      Line(
        points={{82,-50}, {110,-50}, {110, 4}, {118, 4}},
        color={0, 0, 127}));
  connect(booToRea.y, add.u1)
    annotation(
      Line(
        points={{82, 10}, {86, 10}, {86, 16}, {118, 16}},
        color={0, 0, 127}));
  annotation(
    experiment(
      StartTime=-660000,
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/Utilities/Validation/OptimalStartCoolingNegativeStartTime.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
