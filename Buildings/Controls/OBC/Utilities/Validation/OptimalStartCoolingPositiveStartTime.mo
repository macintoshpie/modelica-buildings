...
model OptimalStartCoolingPositiveStartTime
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Sine TOut(amplitude=5, freqHz=1/86400, offset=28 + 273.15, startTime(displayUnit="s")=0)
...
equation
  ...
  annotation(experiment(StartTime=34000, StopTime=864000, Tolerance=1e-06), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/Utilities/Validation/OptimalStartCoolingPositiveStartTime.mos"
