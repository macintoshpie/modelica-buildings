...
equation
  ...
  connect(TSetHeaOcc.y, optStaHea.TSetZonHea)
    annotation(
      Line(
        points={{-18, 80}, {0, 80}, {0, 18}, {18, 18}},
        color={0, 0, 127}));
  connect(TRoo.y, dT.u1)
    annotation(
      Line(
        points={{-19, 10}, {-12, 10}, {-12, 32}, {-166, 32}, {-166, 16}, {-162, 16}},
        color={0, 0, 127}));
  ...
  connect(conPID.y, QHea.u)
    annotation(
      Line(
        points={{182, 10}, {184, 10}, {184,-70}, {-126,-70}, {-126,-50}, {-122,-50}},
        color={0, 0, 127}));
  connect(TRoo.y, conPID.u_m)
    annotation(
      Line(
        points={{-19, 10}, {-12, 10}, {-12,-16}, {170,-16}, {170,-2}},
        color={0, 0, 127}));
  ...
  connect(TOut.y, dT.u2)
    annotation(
      Line(
        points={{-170,-10}, {-166,-10}, {-166, 4}, {-162, 4}},
        color={0, 0, 127}));
  connect(TSetHea.u, occSch.occupied)
    annotation(
      Line(
        points={{58,-50}, {10,-50}, {10,-56}, {-19,-56}},
        color={255, 0, 255}));
  connect(TSetHea.y, add.u2)
    annotation(
      Line(
        points={{82,-50}, {104,-50}, {104, 4}, {118, 4}},
        color={0, 0, 127}));
  connect(booToRea.y, add.u1)
    annotation(
      Line(
        points={{82, 10}, {104, 10}, {104, 16}, {118, 16}},
        color={0, 0, 127}));
  annotation(
    experiment(
      StartTime=-172800,
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/Utilities/Validation/OptimalStartHeating.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
