...
equation
  ...
  connect(TRoo.y, conPID1.u_m)
    annotation(
      Line(
        points={{1, 10}, {6, 10}, {6,-12}, {190,-12}, {190,-2}},
        color={0, 0, 127}));
  ...
  connect(conPID.y, QHea.u)
    annotation(
      Line(
        points={{202, 50}, {212, 50}, {212,-120}, {-108,-120}, {-108,-100}, {-102,-100}},
        color={0, 0, 127}));
  ...
  connect(booToRea2.y, add2.u1)
    annotation(
      Line(
        points={{102, 50}, {126, 50}, {126, 56}, {138, 56}},
        color={0, 0, 127}));
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/OBC/Utilities/Validation/OptimalStartNoHeatingNoCooling.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
