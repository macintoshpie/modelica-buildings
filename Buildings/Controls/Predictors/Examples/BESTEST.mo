...
model BESTEST
  ...
  Sources.DayType dayType(
    days={Buildings.Controls.Types.Day.WorkingDay})
  ...
  Modelica.Blocks.Math.Add preErr(
    k1=1/4000,
    k2=-1/4000)
...
equation
  ...
  annotation(
    ...
    experiment(
      ...
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/Predictors/Examples/BESTEST.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
