...
model ConstantInput
  ...
  Modelica.Blocks.Sources.Constant PCon(k=1)
...
equation
  connect(PCon.y, integrator.u)
    annotation(Line(points={{-69,-30}, {-22,-30}}, color={0, 0, 127}, smooth=Smooth.None));
  connect(integrator.y, baseLoad.ECon)
    annotation(Line(points={{1,-30}, {12,-30}, {12, 0}, {58, 0}}, color={0, 0, 127}, smooth=Smooth.None));
  annotation(experiment(Tolerance=1e-6, StopTime=5270400), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/Predictors/Validation/ConstantInput.mos"
