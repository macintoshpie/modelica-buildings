...
model LinearInput
  ...
  Modelica.Blocks.Sources.Ramp TOut(
    ...
    height=10,
    duration(
      displayUnit="h")=61*24*3600)
    "Outside temperature"
    annotation(
      Placement(
        transformation(
          extent={{-92,-90}, {-72,-70}})));
  Modelica.Blocks.Sources.Constant POffSet(
    k=1)
    "Offset for power"
    annotation(
      Placement(
  ...
  Modelica.Blocks.Continuous.Integrator integrator
    ...
    annotation(
      Placement(
        transformation(
          extent={{0,-30}, {20,-10}})));
  Modelica.Blocks.Sources.RealExpression TOutFut[nPre-1](
    each y=293.15) if nPre > 1
...
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=5270400),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/Predictors/Validation/LinearInput.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
