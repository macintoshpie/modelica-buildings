...
model LinearInputDayOfAdjustment
  ...
  extends Buildings.Controls.Predictors.Validation.LinearInput(baseLoad(use_dayOfAdj=true));
  annotation(experiment(Tolerance=1e-6, StopTime=5270400), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/Predictors/Validation/LinearInputDayOfAdjustment.mos"
