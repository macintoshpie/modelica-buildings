...
model Table
  ...
  Buildings.Controls.SetPoints.Table tabConExt(
    table=[
      20, 0;
      22, 0.5;
      25, 0.5;
  ...
  Modelica.Blocks.Sources.Ramp TRoo(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-80, 0}, {-60, 20}})));
  Buildings.Controls.SetPoints.Table tabLinExt(
    constantExtrapolation=false,
    table=[
      20, 0;
      22, 0.5;
      25, 0.5;
...
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Controls/SetPoints/Examples/Table.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
