...
protected
  final parameter Integer nRow=if constantExtrapolation then size(table, 1) + 2 else size(table, 1)
    "Number of rows";
  final parameter Real[nRow, 2] offsetVector=[
    zeros(nRow), offset*ones(nRow)]
    "Vector to take offset of output signal into account";
  Modelica.Blocks.Tables.CombiTable1D tab(tableOnFile=false, final table=(if constantExtrapolation then cat(1,[
    table[1, 1]-1, table[1, 2]], table,[
...
equation
  connect(u, tab.u[1])
    annotation(Line(points={{-120, 0}, {-70, 0}, {-70, 0}, {-22, 0}}, color={0, 0, 127}));
  connect(tab.y[1], y)
    annotation(Line(points={{3.1, 0}, {53.55, 0}, {53.55, 0}, {110, 0}}, color={0, 0, 127}));
  annotation(defaultComponentName="tab", Documentation(info="<html>
<p>
...
</html>"), Icon(graphics={Text(extent={{-78,-45}, {-40,-56}}, lineColor={0, 0, 0}, textString="offset"), Line(points={{-42,-24}, {-42,-74}}, color={95, 95, 95}, thickness=0.25, arrow={Arrow.None, Arrow.None}), Line(points={{-82,-24}, {-22,-24}, {26, 24}}, color={0, 0, 255}, thickness=0.5), Line(points={{-82, 64}, {-82,-84}}, color={95, 95, 95}), Text(extent={{-80, 88}, {-39, 68}}, lineColor={0, 0, 0}, textString="y"), Polygon(points={{-82, 86}, {-88, 64}, {-76, 64}, {-82, 86}}, lineColor={95, 95, 95}, fillColor={95, 95, 95}, fillPattern=FillPattern.Solid), Polygon(points={{88,-74}, {66,-68}, {66,-80}, {88,-74}}, lineColor={95, 95, 95}, fillColor={95, 95, 95}, fillPattern=FillPattern.Solid), Line(points={{-92,-74}, {80,-74}}, color={95, 95, 95}), Text(extent={{68,-84}, {92,-95}}, lineColor={0, 0, 0}, textString="u"), Polygon(points={{-42,-24}, {-44,-34}, {-39,-34}, {-42,-24}}, lineColor={95, 95, 95}, fillColor={95, 95, 95}, fillPattern=FillPattern.Solid), Polygon(points={{-42,-74}, {-45,-64}, {-40,-64}, {-42,-74}, {-42,-74}}, lineColor={95, 95, 95}, fillColor={95, 95, 95}, fillPattern=FillPattern.Solid), Line(points={{26, 24}, {77, 24}}, color={0, 0, 255}, thickness=0.5)}));
end Table;
