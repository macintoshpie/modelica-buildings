...
model OccupancyScheduleNegativeStartTime
  ...
  OccupancySchedule occSchDay1(occupancy=3600*{0, 2})
    "Day schedule"
    annotation(Placement(transformation(extent={{-60, 20}, {-40, 40}})));
  OccupancySchedule occSchDay2(occupancy=3600*{7, 10, 17, 20}, firstEntryOccupied=false)
    "Day schedule"
    annotation(Placement(transformation(extent={{-60,-20}, {-40, 0}})));
  annotation(experiment(StartTime=-112320, StopTime=207360, Tolerance=1e-06), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/SetPoints/Validation/OccupancyScheduleNegativeStartTime.mos"
