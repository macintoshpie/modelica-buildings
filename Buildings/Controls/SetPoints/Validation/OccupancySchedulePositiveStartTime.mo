...
model OccupancySchedulePositiveStartTime
  ...
  annotation(experiment(StartTime=86400, StopTime=207360, Tolerance=1e-06), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Controls/SetPoints/Validation/OccupancySchedulePositiveStartTime.mos"
