...
model ACACConverter
  ...
  Buildings.Electrical.AC.OnePhase.Conversion.ACACConverter conACAC(
    eta=0.9,
...
First implementation.
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/OnePhase/Conversion/Examples/ACACConverter.mos"
        "Simulate and plot"));
end ACACConverter;
