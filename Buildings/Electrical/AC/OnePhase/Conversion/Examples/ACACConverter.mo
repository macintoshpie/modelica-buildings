...
model ACACConverter
  ...
  Buildings.Electrical.AC.OnePhase.Conversion.ACACConverter conACAC(eta=0.9, conversionFactor=60/120)
    "ACAC transformer"
  ...
  Buildings.Electrical.AC.OnePhase.Loads.Inductive load(mode=Buildings.Electrical.Types.Load.VariableZ_P_input, V_nominal=60)
    "Load model"
...
</html>"), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/OnePhase/Conversion/Examples/ACACConverter.mos"
    "Simulate and plot"));
end ACACConverter;
