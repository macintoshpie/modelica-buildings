...
model ACACTransformer
  ...
  Buildings.Electrical.AC.OnePhase.Conversion.ACACTransformer tra_load(Zperc=0.03, VABase=4000, XoverR=8, VHigh=120, VLow=60)
  ...
  Buildings.Electrical.AC.OnePhase.Conversion.ACACTransformer tra_cc(XoverR=8, Zperc=0.03, VABase=4000, VHigh=120, VLow=60)
  ...
  Buildings.Electrical.AC.OnePhase.Conversion.ACACTransformer tra_void(XoverR=8, Zperc=0.03, VABase=4000, VHigh=120, VLow=60)
...
</html>"), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/OnePhase/Conversion/Examples/ACACTransformer.mos"
    "Simulate and plot"));
end ACACTransformer;
