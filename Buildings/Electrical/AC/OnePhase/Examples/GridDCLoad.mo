  ...
  Buildings.Electrical.AC.OnePhase.Sources.Grid grid(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-80,-20}, {-60, 0}})));
  Buildings.Electrical.AC.OnePhase.Conversion.ACDCConverter idealACDCConverter1(
    eta=0.9,
    ground_AC=false,
    ...
    annotation(
      Placement(
        transformation(
          extent={{-50,-40}, {-30,-20}})));
  Buildings.Electrical.DC.Loads.Resistor resistor(
    R=1,
    V_nominal=12)
    annotation(
      Placement(
...
equation
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/OnePhase/Examples/GridDCLoad.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
