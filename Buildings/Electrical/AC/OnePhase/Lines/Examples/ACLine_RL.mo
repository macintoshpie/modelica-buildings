...
model ACLine_RL
  ...
  TwoPortRL RL_3(R=Rbase, L=Lbase, mode=Buildings.Electrical.Types.Load.FixedZ_dynamic, i_start={0, 0})
...
equation
  ...
  annotation(experiment(StopTime=1.0, Tolerance=1e-06), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/OnePhase/Lines/Examples/ACLine_RL.mos"
