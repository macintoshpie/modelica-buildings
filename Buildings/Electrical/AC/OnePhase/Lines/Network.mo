...
model Network
  ...
  extends Buildings.Electrical.Transmission.BaseClasses.PartialNetwork(V_nominal(start=110), redeclare Interfaces.Terminal_p terminal, redeclare replaceable Transmission.Grids.TestGrid2Nodes grid, redeclare Line lines(commercialCable=grid.cables, each use_C=use_C, each modelMode=modelMode));
  parameter Boolean use_C=false
    "If true, model the cable capacity"
  ...
  parameter Buildings.Electrical.Types.Load modelMode=Types.Load.FixedZ_steady_state
    ...
    annotation(Dialog(tab="Model", group="Assumptions", enable=use_C), choices(choice=Buildings.Electrical.Types.Load.FixedZ_steady_state
...
equation
  ...
  annotation(defaultComponentName="net", Icon(graphics={Line(points={{-92,-60}, {-72,-20}, {-52,-60}, {-32,-100}, {-12,-60}}, color={0, 0, 0}, smooth=Smooth.Bezier)}), Documentation(info="<html>
<p>
