    ...
    annotation(
      Placement(
        transformation(
          extent={{-10,-10}, {10, 10}},
          origin={-70, 10})));
  Modelica.Blocks.Sources.Ramp load_y(
    duration=0.5,
    startTime=0.2)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-10,-10}, {10, 10}},
          origin={10, 30})));
  Buildings.Electrical.AC.OnePhase.Loads.Capacitive varRC(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-10,-10}, {10, 10}},
          origin={10, 10})));
  Buildings.Electrical.AC.OnePhase.Loads.Capacitive RC(
...
First implementation.
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/OnePhase/Loads/Examples/ParallelLoads.mos"
        "Simulate and plot"));
end ParallelLoads;
