  ...
  Buildings.Electrical.AC.OnePhase.Sources.FixedVoltage V(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-80, 20}, {-60, 40}})));
  Buildings.Electrical.AC.OnePhase.Loads.Impedance Z1(
    R=0,
    inductive=true,
    ...
    annotation(
      Placement(
        transformation(
          extent={{-20, 20}, {0, 40}})));
  Buildings.Electrical.AC.OnePhase.Loads.Impedance Z2(
    R=0,
    inductive=false,
    ...
    annotation(
      Placement(
        transformation(
          extent={{-20, 0}, {0, 20}})));
  Buildings.Electrical.AC.OnePhase.Loads.Impedance Z3(
    R=1)
    "Resistive impedance"
    annotation(
      Placement(
...
equation
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/OnePhase/Loads/Examples/TestImpedance.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
