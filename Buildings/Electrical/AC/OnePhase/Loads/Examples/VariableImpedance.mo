...
equation
  ...
  connect(load.y, Z_L.y_L)
    annotation(
      Line(
        points={{39, 6.66134e-16}, {34, 6.66134e-16}, {34, 0}, {30, 0}, {30,-20}, {-6,-20}, {-6,-40}},
        color={0, 0, 127},
        smooth=Smooth.None));
  annotation(
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/OnePhase/Loads/Examples/VariableImpedance.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
