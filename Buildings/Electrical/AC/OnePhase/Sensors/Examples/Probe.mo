  ...
  Buildings.Electrical.AC.OnePhase.Sources.FixedVoltage sou(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60,-30}, {-40,-10}})));
  Buildings.Electrical.AC.OnePhase.Lines.TwoPortResistance res1(
    R=0.1)
...
First implementation.
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/OnePhase/Sensors/Examples/Probe.mos"
        "Simulate and plot"));
end Probe;
