...
model Probe
  ...
  Buildings.Electrical.AC.OnePhase.Loads.Capacitive loaRC(mode=Buildings.Electrical.Types.Load.FixedZ_steady_state, P_nominal=-10000, V_nominal=120)
    "Constant load"
  ...
  Buildings.Electrical.AC.OnePhase.Loads.Inductive loaRL(mode=Buildings.Electrical.Types.Load.FixedZ_steady_state, P_nominal=-10000, V_nominal=120)
    "Constant load"
...
</html>"), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/OnePhase/Sensors/Examples/Probe.mos"
    "Simulate and plot"));
end Probe;
