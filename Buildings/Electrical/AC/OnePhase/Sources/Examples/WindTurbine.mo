  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus
    ...
    annotation(
      Placement(
        transformation(
          extent={{16, 36}, {36, 56}})));
  Buildings.Electrical.AC.OnePhase.Loads.Resistive res(
    P_nominal=-500,
    V_nominal=120)
    "Resistive line"
    annotation(
      Placement(
        transformation(
          extent={{-22,-30}, {-2,-10}})));
  Buildings.Electrical.AC.OnePhase.Sources.Grid sou(
    f=60,
    V=120)
    "Voltage source"
    annotation(
      Placement(
        transformation(
          extent={{-80, 10}, {-60, 30}})));
  Buildings.Electrical.AC.OnePhase.Lines.TwoPortResistance lin(
    R=0.1)
    "Transmission line"
    annotation(
      Placement(
...
First implementation.
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/OnePhase/Sources/Examples/WindTurbine.mos"
        "Simulate and plot"));
end WindTurbine;
