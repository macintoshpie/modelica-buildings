...
model FixedVoltage
  ...
  extends Buildings.Electrical.Interfaces.Source(redeclare package PhaseSystem=PhaseSystems.OnePhase, redeclare replaceable Interfaces.Terminal_p terminal);
...
equation
  ...
  annotation(defaultComponentName="fixVol", Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100}, {100, 100}}), graphics={Ellipse(extent={{-60, 60}, {60,-60}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Line(points={{-44, 0}, {-24, 40}, {-4, 0}, {16,-40}, {36, 0}}, color={0, 0, 0}, smooth=Smooth.Bezier), Text(extent={{-120, 100}, {120, 60}}, lineColor={0, 0, 0}, textString="%name"), Line(points={{60, 0}, {90, 0}}, color={0, 0, 0}, smooth=Smooth.None), Line(visible=definiteReference == true, points={{80,-46}, {120,-46}}, color={0, 120, 120}, smooth=Smooth.None, thickness=0.5), Line(visible=definiteReference == true, points={{80,-46}, {106,-20}}, color={0, 120, 120}, smooth=Smooth.None, thickness=0.5), Line(visible=definiteReference == true, points={{102,-22}, {114,-30}, {118,-48}}, color={0, 120, 120}, smooth=Smooth.Bezier), Text(extent={{-118,-60}, {122,-100}}, lineColor={0, 0, 0}, textString="V = %V")}), Documentation(info="<html>
<p>
