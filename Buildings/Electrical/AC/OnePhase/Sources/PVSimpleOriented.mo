...
model PVSimpleOriented
  ...
  extends Buildings.Electrical.Interfaces.PartialPVOriented(redeclare package PhaseSystem=Buildings.Electrical.PhaseSystems.OnePhase, V_nominal(start=110), redeclare replaceable Interfaces.Terminal_p terminal, redeclare replaceable Buildings.Electrical.AC.OnePhase.Sources.PVSimple panel(pf=pf, eta_DCAC=eta_DCAC, V_nominal=V_nominal, linearized=linearized));
  parameter Boolean linearized=false
    "If =true, linearize the load";
  annotation(defaultComponentName="pv", Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100}, {100, 100}}, grid={1, 1}), graphics={Line(points={{-90, 0}, {-59, 0}}, color={0, 0, 0})}), Documentation(revisions="<html>
<ul>
<li>
