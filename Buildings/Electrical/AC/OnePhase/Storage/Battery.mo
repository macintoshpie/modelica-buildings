...
model Battery
  ...
  parameter Buildings.Electrical.Types.InitMode initMode(min=Buildings.Electrical.Types.InitMode.zero_current, max=Buildings.Electrical.Types.InitMode.linearized)=Buildings.Electrical.Types.InitMode.zero_current
  ...
  Modelica.Blocks.Interfaces.RealInput P(unit="W")
    ...
    annotation(Placement(transformation(extent={{-20,-20}, {20, 20}}, rotation=270, origin={0, 108}), iconTransformation(extent={{-20,-20}, {20, 20}}, rotation=270, origin={0, 100})));
...
protected
  Buildings.Electrical.DC.Storage.BaseClasses.Charge cha(final EMax=EMax, final SOC_start=SOC_start, final etaCha=etaCha, final etaDis=etaDis)
    "Charge model"
    annotation(Placement(transformation(extent={{40, 50}, {60, 70}})));
  replaceable Buildings.Electrical.AC.OnePhase.Loads.Resistive bat constrainedby Buildings.Electrical.Interfaces.Load(final initMode=initMode, final mode=Buildings.Electrical.Types.Load.VariableZ_P_input, final V_nominal=V_nominal, final linearized=linearized)
...
equation
  connect(cha.SOC, SOC)
    annotation(Line(points={{61, 60}, {110, 60}}, color={0, 0, 127}, smooth=Smooth.None));
  connect(gain.y, bat.Pow)
    annotation(Line(points={{41, 20}, {68, 20}, {68, 8.88178e-16}, {60, 8.88178e-16}}, color={0, 0, 127}, smooth=Smooth.None));
  ...
  connect(P, acdc_con_dis.u)
    annotation(Line(points={{8.88178e-16, 108}, {0, 108}, {0, 80}, {-80, 80}, {-80, 20}, {-70, 20}}, color={0, 0, 127}, smooth=Smooth.None));
  connect(P, acdc_con_cha.u)
    annotation(Line(points={{8.88178e-16, 108}, {8.88178e-16, 80}, {-80, 80}, {-80, 60}, {-70, 60}}, color={0, 0, 127}, smooth=Smooth.None));
  connect(acdc_con_cha.y, spl.u1)
    annotation(Line(points={{-47, 60}, {-42, 60}, {-42, 46}, {-38, 46}}, color={0, 0, 127}, smooth=Smooth.None));
  connect(acdc_con_dis.y, spl.u2)
    annotation(Line(points={{-47, 20}, {-42, 20}, {-42, 34}, {-38, 34}}, color={0, 0, 127}, smooth=Smooth.None));
  connect(P, spl.x)
    annotation(Line(points={{8.88178e-16, 108}, {8.88178e-16, 80}, {-80, 80}, {-80, 40}, {-38, 40}}, color={0, 0, 127}, smooth=Smooth.None));
  connect(spl.y, cha.P)
    annotation(Line(points={{-15, 40}, {20, 40}, {20, 60}, {38, 60}}, color={0, 0, 127}, smooth=Smooth.None));
  connect(P, gain.u)
    annotation(Line(points={{0, 108}, {0, 20}, {18, 20}}, color={0, 0, 127}));
  annotation(defaultComponentName="bat", Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100}, {100, 100}}), graphics={Polygon(points={{-62, 40}, {-62,-40}, {72,-40}, {72, 40}, {-62, 40}}, smooth=Smooth.None, fillColor={215, 215, 215}, fillPattern=FillPattern.Solid, pattern=LinePattern.None, lineColor={0, 0, 0}), Polygon(points={{58, 32}, {58,-30}, {32,-30}, {10, 32}, {58, 32}}, smooth=Smooth.None, pattern=LinePattern.None, lineColor={0, 0, 0}, fillColor={0, 127, 0}, fillPattern=FillPattern.Solid), Polygon(points={{-34, 32}, {-12,-30}, {-32,-30}, {-54, 32}, {-34, 32}}, smooth=Smooth.None, pattern=LinePattern.None, lineColor={0, 0, 0}, fillColor={0, 127, 0}, fillPattern=FillPattern.Solid), Polygon(points={{-2, 32}, {20,-30}, {0,-30}, {-22, 32}, {-2, 32}}, smooth=Smooth.None, pattern=LinePattern.None, lineColor={0, 0, 0}, fillColor={0, 127, 0}, fillPattern=FillPattern.Solid), Polygon(points={{-74, 12}, {-74,-12}, {-62,-12}, {-62, 12}, {-74, 12}}, smooth=Smooth.None, fillColor={215, 215, 215}, fillPattern=FillPattern.Solid, pattern=LinePattern.None, lineColor={0, 0, 0}), Text(extent={{-50, 68}, {-20, 100}}, lineColor={0, 0, 0}, fillColor={215, 215, 215}, fillPattern=FillPattern.Solid, textString="P"), Line(points={{-74, 0}, {-100, 0}, {-100, 0}}, color={0, 0, 0}, smooth=Smooth.None), Text(extent={{44, 70}, {100, 116}}, lineColor={0, 0, 0}, fillColor={215, 215, 215}, fillPattern=FillPattern.Solid, textString="SOC"), Text(extent={{44, 154}, {134, 112}}, lineColor={0, 0, 0}, textString="%name")}), Documentation(info="<html>
<p>
Simple model of a battery.
</p>
<p>
