  ...
  Buildings.Electrical.DC.Storage.BaseClasses.Charge cha(
    ...
    annotation(
      Placement(
        transformation(
          extent={{40, 50}, {60, 70}})));
  replaceable Buildings.Electrical.AC.OnePhase.Loads.Resistive bat constrainedby Buildings.Electrical.Interfaces.Load(
  ...
  Modelica.Blocks.Math.Gain acdc_con_dis(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-68, 10}, {-48, 30}})));
  Buildings.Utilities.Math.Splice spl(
    deltax=1e-2)
