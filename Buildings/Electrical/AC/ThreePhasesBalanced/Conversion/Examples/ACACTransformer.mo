...
model ACACTransformer
  ...
  Buildings.Electrical.AC.ThreePhasesBalanced.Conversion.ACACTransformer tra_load(
    Zperc=0.03,
    VABase=4000,
    XoverR=8,
    VHigh=480,
  ...
  Buildings.Electrical.AC.ThreePhasesBalanced.Conversion.ACACTransformer tra_cc(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-16, 0}, {4, 20}})));
  Buildings.Electrical.AC.ThreePhasesBalanced.Loads.Impedance shortCircuit(
    R=1e-8)
    "Short circuit"
    annotation(
      Placement(
        transformation(
          extent={{10, 0}, {30, 20}})));
  Buildings.Electrical.AC.ThreePhasesBalanced.Conversion.ACACTransformer tra_void(
    XoverR=8,
    Zperc=0.03,
    VABase=4000,
    VHigh=480,
...
First implementation.
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesBalanced/Conversion/Examples/ACACTransformer.mos"
        "Simulate and plot"));
end ACACTransformer;
