...
model ACLineMedium
  ...
  ThreePhasesBalanced.Lines.Line line_1(
    P_nominal=5000,
    l=2000,
    redeclare Buildings.Electrical.Transmission.MediumVoltageCables.Generic commercialCable=Buildings.Electrical.Transmission.MediumVoltageCables.Annealed_Al_10(),
    V_nominal=15000)
...
equation
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesBalanced/Lines/Examples/ACLineMedium.mos"
        "Simulate and plot"),
    Documentation(
      revisions="<html>
<ul>
