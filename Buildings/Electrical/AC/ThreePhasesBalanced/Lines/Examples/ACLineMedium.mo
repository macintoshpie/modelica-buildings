...
model ACLineMedium
  ...
  ThreePhasesBalanced.Sources.FixedVoltage E(definiteReference=true, V=15000, f=60)
    "Voltage source"
    annotation(Placement(transformation(extent={{-100,-10}, {-80, 10}})));
  ThreePhasesBalanced.Loads.Impedance R1(R=10)
    "Resistive load 1"
    annotation(Placement(transformation(extent={{0,-10}, {20, 10}})));
  ThreePhasesBalanced.Lines.Line line_1(P_nominal=5000, l=2000, redeclare Buildings.Electrical.Transmission.MediumVoltageCables.Generic commercialCable=Buildings.Electrical.Transmission.MediumVoltageCables.Annealed_Al_10(), V_nominal=15000)
    "Resistive line that connects to load 1"
    annotation(Placement(transformation(extent={{-58,-10}, {-38, 10}})));
  ThreePhasesBalanced.Lines.Line line_2a(P_nominal=5000, l=1000, redeclare Buildings.Electrical.Transmission.MediumVoltageCables.Generic commercialCable=Buildings.Electrical.Transmission.MediumVoltageCables.Annealed_Al_10(), V_nominal=15000)
    "Resistive line that connects to load 2"
    annotation(Placement(transformation(extent={{-60,-30}, {-40,-10}})));
  ThreePhasesBalanced.Loads.Impedance R2(R=10)
    "Resistive load 2"
    annotation(Placement(transformation(extent={{0,-30}, {20,-10}})));
  ThreePhasesBalanced.Lines.Line line_2b(P_nominal=5000, l=1000, redeclare Buildings.Electrical.Transmission.MediumVoltageCables.Generic commercialCable=Buildings.Electrical.Transmission.MediumVoltageCables.Annealed_Al_10(), V_nominal=15000)
    "Resistive line that connects to load 2"
    annotation(Placement(transformation(extent={{-32,-30}, {-12,-10}})));
  ThreePhasesBalanced.Lines.Line line_3a(P_nominal=5000, l=4000, redeclare Buildings.Electrical.Transmission.MediumVoltageCables.Generic commercialCable=Buildings.Electrical.Transmission.MediumVoltageCables.Annealed_Al_10(), V_nominal=15000)
    "Resistive line that connects to load 3"
    annotation(Placement(transformation(extent={{-60,-50}, {-40,-30}})));
  ThreePhasesBalanced.Lines.Line line_3b(P_nominal=5000, l=4000, redeclare Buildings.Electrical.Transmission.MediumVoltageCables.Generic commercialCable=Buildings.Electrical.Transmission.MediumVoltageCables.Annealed_Al_10(), V_nominal=15000)
    "Resistive line that connects to load 3"
    annotation(Placement(transformation(extent={{-60,-70}, {-40,-50}})));
  ThreePhasesBalanced.Loads.Impedance R3(R=10)
    "Resistive load 3"
    annotation(Placement(transformation(extent={{0,-60}, {20,-40}})));
  ThreePhasesBalanced.Lines.Line line_sc(P_nominal=5000, l=2000, redeclare Buildings.Electrical.Transmission.MediumVoltageCables.Generic commercialCable=Buildings.Electrical.Transmission.MediumVoltageCables.Annealed_Al_10(), V_nominal=15000)
...
equation
  connect(line_1.terminal_p, R1.terminal)
    annotation(Line(points={{-38, 0}, {-24, 0}, {-24, 6.66134e-16}, {-4.44089e-16, 6.66134e-16}}, color={0, 120, 120}, smooth=Smooth.None));
  connect(E.terminal, line_1.terminal_n)
    annotation(Line(points={{-80, 4.44089e-16}, {-58, 4.44089e-16}}, color={0, 120, 120}, smooth=Smooth.None));
  connect(E.terminal, line_2a.terminal_n)
    annotation(Line(points={{-80, 4.44089e-16}, {-70, 4.44089e-16}, {-70,-20}, {-60,-20}}, color={0, 120, 120}, smooth=Smooth.None));
  connect(line_2a.terminal_p, line_2b.terminal_n)
    annotation(Line(points={{-40,-20}, {-32,-20}}, color={0, 120, 120}, smooth=Smooth.None));
  connect(line_2b.terminal_p, R2.terminal)
    annotation(Line(points={{-12,-20}, {0,-20}}, color={0, 120, 120}, smooth=Smooth.None));
  connect(line_3a.terminal_p, R3.terminal)
    annotation(Line(points={{-40,-40}, {-20,-40}, {-20,-50}, {0,-50}}, color={0, 120, 120}, smooth=Smooth.None));
  connect(line_3b.terminal_p, R3.terminal)
    annotation(Line(points={{-40,-60}, {-20,-60}, {-20,-50}, {-5.55112e-16,-50}}, color={0, 120, 120}, smooth=Smooth.None));
  connect(E.terminal, line_3a.terminal_n)
    annotation(Line(points={{-80, 0}, {-70, 0}, {-70,-40}, {-60,-40}}, color={0, 120, 120}, smooth=Smooth.None));
  connect(E.terminal, line_3b.terminal_n)
    annotation(Line(points={{-80, 0}, {-70, 0}, {-70,-60}, {-60,-60}}, color={0, 120, 120}, smooth=Smooth.None));
  connect(line_sc.terminal_p, load_sc.terminal)
    annotation(Line(points={{-38, 30}, {-4.44089e-16, 30}}, color={0, 120, 120}, smooth=Smooth.None));
  connect(E.terminal, line_sc.terminal_n)
    annotation(Line(points={{-80, 0}, {-70, 0}, {-70, 30}, {-58, 30}}, color={0, 120, 120}, smooth=Smooth.None));
  annotation(experiment(StopTime=1.0, Tolerance=1e-6), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesBalanced/Lines/Examples/ACLineMedium.mos"
