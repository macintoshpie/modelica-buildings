  ...
  ThreePhasesBalanced.Loads.Impedance R3(
    ...
    annotation(
      Placement(
        transformation(
          extent={{0,-62}, {20,-42}})));
  ThreePhasesBalanced.Loads.Impedance load_sc(
    R=0)
    "Short circuit"
    annotation(
      Placement(
        transformation(
          extent={{0, 40}, {20, 60}})));
  ThreePhasesBalanced.Lines.TwoPortInductance Lline_sc(
    L=Lbase)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60, 40}, {-40, 60}})));
  ThreePhasesBalanced.Lines.TwoPortInductance Lline_1(
    L=Lbase)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60, 0}, {-40, 20}})));
  ThreePhasesBalanced.Lines.TwoPortInductance Lline_2a(
    L=0.5*Lbase)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60,-30}, {-40,-10}})));
  ThreePhasesBalanced.Lines.TwoPortInductance Lline_2b(
    L=0.5*Lbase)
    "Inductive line connected to load 2"
    annotation(
      Placement(
        transformation(
          extent={{-36,-30}, {-16,-10}})));
  ThreePhasesBalanced.Lines.TwoPortInductance Lline_3(
    L=2*Lbase)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60,-50}, {-40,-30}})));
  ThreePhasesBalanced.Lines.TwoPortInductance Lline_3b(
    L=2*Lbase)
    "Inductive line connected to load 3"
    annotation(
      Placement(
...
equation
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesBalanced/Lines/Examples/ACLine_L.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
