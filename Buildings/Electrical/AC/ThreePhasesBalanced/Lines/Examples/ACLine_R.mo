  ...
  ThreePhasesBalanced.Sources.FixedVoltage E(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-100,-10}, {-80, 10}})));
  ThreePhasesBalanced.Loads.Impedance R1(
    R=10)
    "Resistive load 1"
    annotation(
      Placement(
        transformation(
          extent={{0, 0}, {20, 20}})));
  ThreePhasesBalanced.Loads.Impedance R2(
    R=10)
    "Resistive load 2"
    annotation(
      Placement(
        transformation(
          extent={{0,-30}, {20,-10}})));
  ThreePhasesBalanced.Loads.Impedance R3(
    R=10)
    "Resistive load 3"
    annotation(
      Placement(
        transformation(
          extent={{0,-70}, {20,-50}})));
  ThreePhasesBalanced.Loads.Impedance sc_load(
    R=0)
    "Short circuit load"
    annotation(
      Placement(
        transformation(
          extent={{0, 40}, {20, 60}})));
  ThreePhasesBalanced.Lines.TwoPortResistance Rline_sc(
    R=10,
    useHeatPort=false)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60, 60}, {-40, 40}})));
  ThreePhasesBalanced.Lines.TwoPortResistance Rline_1(
    R=10)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60, 0}, {-40, 20}})));
  ThreePhasesBalanced.Lines.TwoPortResistance Rline_2a(
    R=5)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60,-30}, {-40,-10}})));
  ThreePhasesBalanced.Lines.TwoPortResistance Rline_2b(
    R=5)
    "Resistive line that connects to load 2"
    annotation(
      Placement(
        transformation(
          extent={{-36,-30}, {-16,-10}})));
  ThreePhasesBalanced.Lines.TwoPortResistance Rline_3a(
    R=20)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60,-60}, {-40,-40}})));
  ThreePhasesBalanced.Lines.TwoPortResistance Rline_3b(
    R=20)
    "Resistive line that connects to load 3"
    annotation(
      Placement(
...
equation
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesBalanced/Lines/Examples/ACLine_R.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
