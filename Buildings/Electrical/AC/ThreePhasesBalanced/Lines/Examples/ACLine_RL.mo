  ...
  ThreePhasesBalanced.Sources.FixedVoltage E(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-100,-10}, {-80, 10}})));
  ThreePhasesBalanced.Loads.Impedance load_sc_1(
    R=0)
    "Short circuit 1"
    annotation(
      Placement(
        transformation(
          extent={{0, 20}, {20, 40}})));
  ThreePhasesBalanced.Loads.Impedance load_sc_2(
    R=0)
    "Short circuit 2"
    annotation(
      Placement(
        transformation(
          extent={{0,-10}, {20, 10}})));
  ThreePhasesBalanced.Lines.TwoPortRL RL_2(
    R=Rbase,
    L=Lbase)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-48,-10}, {-28, 10}})));
  ThreePhasesBalanced.Lines.TwoPortResistance R_1(
    R=Rbase)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60, 20}, {-40, 40}})));
  ThreePhasesBalanced.Lines.TwoPortInductance L_1(
    L=Lbase)
  ...
  ThreePhasesBalanced.Lines.TwoPortRL RL_3(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-48,-40}, {-28,-20}})));
  ThreePhasesBalanced.Loads.Impedance load_sc_3(
    R=0)
    "Short circuit 3"
    annotation(
      Placement(
...
equation
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesBalanced/Lines/Examples/ACLine_RL.mos"
        "Simulate and plot"),
    Documentation(
      revisions="<html>
<ul>
