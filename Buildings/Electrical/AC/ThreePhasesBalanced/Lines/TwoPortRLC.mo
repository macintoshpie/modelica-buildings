...
model TwoPortRLC
  ...
  extends Buildings.Electrical.AC.OnePhase.Lines.TwoPortRLC(redeclare Interfaces.Terminal_n terminal_n, redeclare Interfaces.Terminal_p terminal_p);
  annotation(defaultComponentName="lineRLC", Documentation(revisions="<html>
<ul>
<li>
