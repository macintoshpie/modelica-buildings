  ...
  Impedance RL_star(
    ...
    annotation(
      Placement(
        transformation(
          extent={{40, 50}, {60, 70}})));
  OnePhase.Sources.FixedVoltage sou_a(
    V=480/sqrt(3),
    definiteReference=true,
    f=60)
  ...
  annotation(
    Diagram(
      ...
      graphics={Text(
        extent={{-60, 100}, {60, 80}},
        lineColor={0, 0, 0},
        textString="Three phases, balanced (Y and D connection) "), Text(
        extent={{-100, 10}, {-4,-10}},
        lineColor={0, 0, 0},
        textString="Three phases, balanced (Y connection) "), Text(
        extent={{4, 10}, {100,-10}},
        lineColor={0, 0, 0},
        textString="Three phases, balanced (D connection) ")}),
    Documentation(
      revisions="<html>
<ul>
<li>
...
can reproduce the same results obtained using three separate one phase circuits.
    ...
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesBalanced/Loads/Examples/ThreePhases.mos"
        "Simulate and plot"));
end ThreePhases;
