...
model GeneralizedSensor
  ...
  Buildings.Electrical.AC.ThreePhasesBalanced.Loads.Capacitive loa(V_nominal=480, P_nominal=-100)
    "Constant load"
...
</html>"), experiment(Tolerance=1e-6, StopTime=1.0), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesBalanced/Sensors/Examples/GeneralizedSensor.mos"
    "Simulate and plot"));
