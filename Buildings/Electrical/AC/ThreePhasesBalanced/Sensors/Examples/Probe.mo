  ...
  Buildings.Electrical.AC.ThreePhasesBalanced.Sources.FixedVoltage sou(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60,-30}, {-40,-10}})));
  Buildings.Electrical.AC.ThreePhasesBalanced.Lines.TwoPortResistance res1(
    R=0.1)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-26, 0}, {-6, 20}})));
  Buildings.Electrical.AC.ThreePhasesBalanced.Sensors.Probe probe_source(
    V_nominal=480)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-50, 30}, {-30, 50}})));
  Buildings.Electrical.AC.ThreePhasesBalanced.Sensors.Probe probe_loadRC(
    V_nominal=480)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-10, 30}, {10, 50}})));
  Buildings.Electrical.AC.ThreePhasesBalanced.Lines.TwoPortResistance res2(
    R=0.1)
...
First implementation.
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesBalanced/Sensors/Examples/Probe.mos"
        "Simulate and plot"));
end Probe;
