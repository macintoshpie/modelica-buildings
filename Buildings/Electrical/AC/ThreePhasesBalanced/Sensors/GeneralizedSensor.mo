...
model GeneralizedSensor
  ...
  Modelica.Blocks.Interfaces.RealOutput V(
    ...
    final unit="V")=Buildings.Electrical.PhaseSystems.OnePhase.systemVoltage(terminal_n.v)
    "Voltage"
    annotation(
      Placement(
        transformation(
  ...
  Modelica.Blocks.Interfaces.RealOutput I(
    ...
    final unit="A")=Buildings.Electrical.PhaseSystems.OnePhase.systemCurrent(terminal_n.i)
    "Current"
    annotation(
      Placement(
        transformation(
  ...
  Modelica.Blocks.Interfaces.RealOutput S[PhaseSystems.OnePhase.n](
    ...
    each final unit="W")=Buildings.Electrical.PhaseSystems.OnePhase.phasePowers_vi(
    v=terminal_n.v,
    i=terminal_n.i)
    "Phase powers"
    annotation(
