  ...
  Modelica.Blocks.Math.Add G
    ...
    annotation(
      Placement(
        transformation(
          extent={{-12, 52}, {8, 72}})));
  ThreePhasesBalanced.Sources.PVSimple pvSimple(
    A=10,
    V_nominal=480)
    "PV array simplified"
    annotation(
...
equation
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesBalanced/Sources/Examples/PVPanels.mos"
        "Simulate and plot"),
    Documentation(
      revisions="<html>
<ul>
