...
model VariablePowerSource
  ...
  Buildings.Electrical.AC.ThreePhasesBalanced.Sources.Generator generator(
    f=60,
...
equation
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesBalanced/Sources/Examples/VariablePowerSource.mos"
        "Simulate and plot"),
    Documentation(
      revisions="<html>
<ul>
