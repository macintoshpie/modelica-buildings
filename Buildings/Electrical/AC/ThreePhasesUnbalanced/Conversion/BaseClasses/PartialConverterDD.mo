...
protected
  Interfaces.Adapter3to3 ada_n
    "Adapter"
    annotation(Placement(transformation(extent={{-30,-10}, {-50, 10}})));
  Interfaces.Adapter3to3 ada_p
    "Adapter"
    annotation(Placement(transformation(extent={{30,-10}, {50, 10}})));
equation
  connect(delta_to_wye.wye, terminal_n)
    annotation(Line(points={{-76, 4.44089e-16}, {-80, 4.44089e-16}, {-80, 0}, {-100, 0}}, color={0, 120, 120}, smooth=Smooth.None));
  connect(wye_to_delta.wye, terminal_p)
    annotation(Line(points={{78, 6.66134e-16}, {82, 6.66134e-16}, {82, 0}, {92, 0}, {92, 4.44089e-16}, {100, 4.44089e-16}}, color={0, 120, 120}, smooth=Smooth.None));
  ...
  connect(conv1.terminal_n, ada_n.terminals[1])
    annotation(Line(points={{-10, 52}, {-20, 52}, {-20, 0.533333}, {-30.2, 0.533333}}, color={0, 0, 0}));
  ...
  connect(conv3.terminal_n, ada_n.terminals[3])
    annotation(Line(points={{-10,-60}, {-20,-60}, {-20,-14}, {-20,-0.533333}, {-30.2,-0.533333}}, color={0, 0, 0}));
  ...
  connect(conv3.terminal_p, ada_p.terminals[3])
    annotation(Line(points={{10,-60}, {20,-60}, {20,-26}, {20,-0.533333}, {30.2,-0.533333}}, color={0, 0, 0}));
