...
partial model PartialConverterStepUpYD
  "Model of a transformer with Y connection primary side and D connection
  secondary side (Voltage step up)"
  extends Buildings.Electrical.AC.ThreePhasesUnbalanced.Conversion.BaseClasses.PartialConverter;
...
protected
  Interfaces.Adapter3to3 ada3to3_n
    "Adapter for connections"
    annotation(Placement(transformation(extent={{-30,-10}, {-50, 10}})));
  Interfaces.Adapter3to3 ada3to3_p
    "Adapter for connections"
    annotation(Placement(transformation(extent={{26,-10}, {46, 10}})));
equation
  connect(delta_to_wye.wye, terminal_p)
    annotation(Line(points={{80, 0}, {100, 0}}, color={0, 120, 120}, smooth=Smooth.None));
  connect(wye_to_wyeg.wye, terminal_n)
    annotation(Line(points={{-82, 6.66134e-16}, {-84, 6.66134e-16}, {-84, 0}, {-86, 0}, {-86, 4.44089e-16}, {-100, 4.44089e-16}}, color={0, 120, 120}, smooth=Smooth.None));
  connect(conv1.terminal_n, ada3to3_n.terminals[1])
    annotation(Line(points={{-10, 52}, {-20, 52}, {-20,-0.533333}, {-30,-0.533333}}, color={0, 0, 0}));
  ...
  connect(conv3.terminal_n, ada3to3_n.terminals[3])
    annotation(Line(points={{-10,-60}, {-20,-60}, {-20, 0.533333}, {-30, 0.533333}}, color={0, 0, 0}));
  ...
  connect(conv1.terminal_p, ada3to3_p.terminals[3])
    annotation(Line(points={{10, 52}, {20, 52}, {20, 0.533333}, {26, 0.533333}}, color={0, 0, 0}));
  connect(conv2.terminal_p, ada3to3_p.terminals[1])
    annotation(Line(points={{10, 0}, {28, 0}, {28,-0.533333}, {26,-0.533333}}, color={0, 0, 0}));
  connect(conv3.terminal_p, ada3to3_p.terminals[2])
    annotation(Line(points={{10,-60}, {10,-60}, {16,-60}, {16,-60}, {20,-60}, {20, 0}, {26, 0}, {26, 0}}, color={0, 0, 0}));
