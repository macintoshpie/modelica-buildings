...
partial model PartialConverterYY
...
equation
  connect(terminal_p, connection3to4_p.terminal3)
    annotation(Line(points={{100, 0}, {80, 0}, {80, 6.66134e-16}}, color={0, 120, 120}, smooth=Smooth.None));
  connect(terminal_n, connection3to4_n.terminal3)
    annotation(Line(points={{-100, 4.44089e-16}, {-80, 4.44089e-16}, {-80, 6.66134e-16}}, color={0, 120, 120}, smooth=Smooth.None));
  ...
  connect(ground_n.terminal, connection3to4_n.ground4)
    annotation(Line(points={{-60,-70}, {-60,-6}, {-60.1,-6}}, color={0, 120, 120}));
  ...
  connect(ada3to3_n.terminals[1], conv1.terminal_n)
    annotation(Line(points={{-30,-0.533333}, {-26,-0.533333}, {-20,-0.533333}, {-20, 52}, {-10, 52}}, color={0, 0, 0}));
  ...
  connect(ada3to3_n.terminals[3], conv3.terminal_n)
    annotation(Line(points={{-30, 0.533333}, {-20, 0.533333}, {-20,-60}, {-10,-60}}, color={0, 0, 0}));
