...
equation
  ...
  connect(ada3to3_n.terminals[3], conv3.terminal_n)
    annotation(
      Line(
        points={{-30, 0.533333}, {-20, 0.533333}, {-20,-60}, {-10,-60}},
        color={0, 0, 0}));
