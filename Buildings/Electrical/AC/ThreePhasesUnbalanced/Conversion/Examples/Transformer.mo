...
model Transformer
  ...
  extends BaseClasses.TransformerExample(
    ...
    redeclare Buildings.Electrical.AC.ThreePhasesUnbalanced.Conversion.ACACTransformer tra(
      VHigh=V_primary,
      VLow=V_secondary,
      XoverR=6,
...
Buildings.Electrical.AC.ThreePhasesUnbalanced.Conversion.ACACTransformer</a> model.
    ...
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Conversion/Examples/Transformer.mos"
        "Simulate and plot"));
end Transformer;
