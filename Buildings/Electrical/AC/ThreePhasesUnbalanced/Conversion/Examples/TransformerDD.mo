...
model TransformerDD
  ...
  extends BaseClasses.TransformerExample(
    ...
    redeclare Buildings.Electrical.AC.ThreePhasesUnbalanced.Conversion.ACACTransformerDD tra(
      VHigh=V_primary,
      VLow=V_secondary,
      XoverR=6,
...
in the connector do not have a neutral reference.
    ...
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Conversion/Examples/TransformerDD.mos"
        "Simulate and plot"));
end TransformerDD;
