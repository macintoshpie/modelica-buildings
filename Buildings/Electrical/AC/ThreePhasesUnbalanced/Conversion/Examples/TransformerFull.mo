...
model TransformerFull
  ...
  extends BaseClasses.TransformerExample(
    ...
    redeclare Buildings.Electrical.AC.ThreePhasesUnbalanced.Conversion.ACACTransformerFull tra(
      VHigh=V_primary,
      VLow=V_secondary,
      VABase=6000000,
      f=60,
...
Buildings.Electrical.AC.ThreePhasesUnbalanced.Conversion.ACACTransformerFull</a> model.
    ...
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Conversion/Examples/TransformerFull.mos"
        "Simulate and plot"));
end TransformerFull;
