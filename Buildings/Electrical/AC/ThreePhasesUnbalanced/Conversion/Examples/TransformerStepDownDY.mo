...
model TransformerStepDownDY
  ...
  extends BaseClasses.TransformerExample(
    ...
    redeclare Buildings.Electrical.AC.ThreePhasesUnbalanced.Conversion.ACACTransformerStepDownDY tra(
      VHigh=V_primary,
      VLow=V_secondary,
      XoverR=6,
...
Buildings.Electrical.AC.ThreePhasesUnbalanced.Conversion.ACACTransformerStepDownDY</a> model.
    ...
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Conversion/Examples/TransformerStepDownDY.mos"
        "Simulate and plot"));
