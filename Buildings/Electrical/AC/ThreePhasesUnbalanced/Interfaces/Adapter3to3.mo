...
model Adapter3to3
  ...
  Buildings.Electrical.Interfaces.Terminal terminals[3](redeclare final package PhaseSystem=PhaseSystems.OnePhase)
    "Generalized terminal"
    annotation(Placement(transformation(extent={{-92,-6}, {-108, 10}}), iconTransformation(extent={{-106, 8}, {-90,-8}})));
  Interfaces.Terminal_p terminal
    "Connector with 3 lines"
...
equation
  ...
  annotation(defaultComponentName="ada", Icon(coordinateSystem(preserveAspectRatio=false), graphics={Line(points={{-64, 0}, {66, 0}}, color={28, 108, 200})}), Documentation(info="<html>
<p>
