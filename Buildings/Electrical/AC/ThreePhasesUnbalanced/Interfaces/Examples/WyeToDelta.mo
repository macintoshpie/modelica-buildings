  ...
  Buildings.Electrical.AC.ThreePhasesUnbalanced.Sources.FixedVoltage V1(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60,-10}, {-40, 10}})));
  Buildings.Electrical.AC.ThreePhasesUnbalanced.Sensors.ProbeWye probe_Y(
    perUnit=false,
    V_nominal=480)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-30, 10}, {-10, 30}})));
  Buildings.Electrical.AC.ThreePhasesUnbalanced.Sensors.ProbeWye probeD(
    perUnit=false,
    V_nominal=480)
    "Probe that measures the voltage and the angles on each phase"
    annotation(
...
equation
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Interfaces/Examples/WyeToDelta.mos"
        "Simulate and plot"),
    Documentation(
      revisions="<html>
<ul>
