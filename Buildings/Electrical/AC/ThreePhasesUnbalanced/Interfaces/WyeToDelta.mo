...
equation
  ...
  annotation(defaultComponentName="y2d", Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100}, {100, 100}}), graphics={Line(points={{-40,-26}, {0, 34}, {40,-26}, {-40,-26}}, color={0, 120, 120}, smooth=Smooth.None, thickness=0.5)}), Documentation(revisions="<html>
<ul>
<li>
