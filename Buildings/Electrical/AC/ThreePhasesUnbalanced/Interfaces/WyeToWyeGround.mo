...
equation
  ...
  connect(connection3to4.terminal4, wyeg)
    annotation(Line(points={{-40, 0}, {28, 0}, {100, 0}}, color={0, 120, 120}));
  connect(connection3to4.ground4, ground.terminal)
    annotation(Line(points={{-40.6,-6}, {-20,-6}, {-20,-20}}, color={0, 120, 120}));
  annotation(defaultComponentName="y2yg", Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100}, {100, 100}}), graphics={Line(points={{0, 40}, {0, 0}, {-30,-30}}, color={0, 120, 120}, smooth=Smooth.None, thickness=0.5), Line(points={{0, 0}, {30,-30}}, color={0, 120, 120}, smooth=Smooth.None, thickness=0.5), Line(points={{0, 0}, {0,-40}}, color={0, 120, 120}, smooth=Smooth.None, thickness=0.25), Line(points={{-8,-40}, {8,-40}}, color={0, 120, 120}, smooth=Smooth.None, thickness=0.25), Line(points={{-6,-42}, {6,-42}}, color={0, 120, 120}, smooth=Smooth.None, thickness=0.25), Line(points={{-4,-44}, {4,-44}}, color={0, 120, 120}, smooth=Smooth.None, thickness=0.25)}), Documentation(revisions="<html>
<ul>
<li>
