...
model ACLineMatrix_RLC
  ...
  Lines.TwoPortMatrixRLC Rline_1(Z11={10, 10}, Z12={0, 0}, Z13={0, 0}, Z22={10, 10}, Z23={0, 0}, Z33={10, 10}, V_nominal=100*sqrt(3), B12=0, B13=0, B23=0, B11=10, B22=10, B33=10)
    "RL line that connects to load 1"
    annotation(Placement(transformation(extent={{-60, 20}, {-40, 40}})));
  Lines.TwoPortMatrixRLC Rline_2(Z12={0, 0}, Z13={0, 0}, Z23={0, 0}, V_nominal=100*sqrt(3), B12=0, B13=0, B23=0, Z11={0, 0}, Z22={0, 0}, Z33={0, 0}, B11=0.1, B22=0.1, B33=0.1)
...
equation
  ...
  annotation(experiment(StopTime=1.0, Tolerance=1e-6), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Lines/Examples/ACLineMatrix_RLC.mos"
