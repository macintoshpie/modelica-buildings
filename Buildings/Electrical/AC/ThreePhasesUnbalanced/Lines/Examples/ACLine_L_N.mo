  ...
  Loads.Impedance_N sc_load(
    ...
    annotation(
      Placement(
        transformation(
          extent={{0, 40}, {20, 60}})));
  Lines.TwoPortInductance_N Lline_sc(
    L=6*Lbase,
    Ln=Lbase)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60, 60}, {-40, 40}})));
  Lines.TwoPortInductance_N Rline_1(
    L=3*Lbase,
    Ln=0.5*Lbase)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60, 0}, {-40, 20}})));
  Lines.TwoPortInductance_N Rline_2a(
    L=3*Lbase/2,
    Ln=0.5*Lbase/2)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60,-30}, {-40,-10}})));
  Lines.TwoPortInductance_N Rline_2b(
    L=3*Lbase/2,
    Ln=0.5*Lbase/2)
    "Inductive line that connects to load 2"
    annotation(
      Placement(
        transformation(
          extent={{-32,-30}, {-12,-10}})));
  Lines.TwoPortInductance_N Rline_3a(
    L=6*Lbase,
    Ln=Lbase)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60,-60}, {-40,-40}})));
  Lines.TwoPortInductance_N Rline_3b(
    L=6*Lbase,
    Ln=Lbase)
    "Inductive line that connects to load 3"
    annotation(
...
equation
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Lines/Examples/ACLine_L_N.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
