...
model ACLine_N
  ...
  Line_N line_1(
    ...
    redeclare Buildings.Electrical.Transmission.LowVoltageCables.Cu35 commercialCable)
...
equation
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Lines/Examples/ACLine_N.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
