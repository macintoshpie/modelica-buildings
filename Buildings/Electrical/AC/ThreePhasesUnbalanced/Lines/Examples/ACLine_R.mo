  ...
  Loads.Impedance sc_load(
    ...
    annotation(
      Placement(
        transformation(
          extent={{0, 40}, {20, 60}})));
  Lines.TwoPortResistance Rline_sc(
    useHeatPort=false,
    R=60)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60, 60}, {-40, 40}})));
  Lines.TwoPortResistance Rline_1(
    R=30)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60, 0}, {-40, 20}})));
  Lines.TwoPortResistance Rline_2a(
    R=15)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60,-30}, {-40,-10}})));
  Lines.TwoPortResistance Rline_2b(
    R=15)
    "Resistive line that connects to load 2"
    annotation(
      Placement(
        transformation(
          extent={{-36,-30}, {-16,-10}})));
  Lines.TwoPortResistance Rline_3a(
    R=60)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60,-60}, {-40,-40}})));
  Lines.TwoPortResistance Rline_3b(
    R=60)
    "Resistive line that connects to load 3"
    annotation(
      Placement(
...
equation
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Lines/Examples/ACLine_R.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
