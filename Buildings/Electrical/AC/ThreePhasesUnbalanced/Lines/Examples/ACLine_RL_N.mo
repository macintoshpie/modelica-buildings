...
model ACLine_RL_N
  ...
  Lines.TwoPortRL_N RL_2(R=Rbase, L=Lbase, Rn=0.5*Rbase, Ln=0.5*Lbase)
...
equation
  connect(RL_2.terminal_p, load_sc_2.terminal)
    annotation(Line(points={{-28, 0}, {0, 0}}, color={127, 0, 127}, smooth=Smooth.None));
  connect(L_1.terminal_p, load_sc_1.terminal)
    annotation(Line(points={{-10, 30}, {0, 30}}, color={127, 0, 127}, smooth=Smooth.None));
  connect(L_1.terminal_n, R_1.terminal_p)
    annotation(Line(points={{-30, 30}, {-40, 30}}, color={127, 0, 127}, smooth=Smooth.None));
  connect(R_1.terminal_n, E.terminal)
    annotation(Line(points={{-60, 30}, {-70, 30}, {-70, 0}, {-76, 0}}, color={127, 0, 127}, smooth=Smooth.None));
  connect(E.terminal, RL_2.terminal_n)
    annotation(Line(points={{-76, 0}, {-48, 0}}, color={127, 0, 127}, smooth=Smooth.None));
  annotation(experiment(StopTime=1.0, Tolerance=1e-06), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Lines/Examples/ACLine_RL_N.mos"
