  ...
  Loads.Impedance_N sc_load(
    ...
    annotation(
      Placement(
        transformation(
          extent={{0, 40}, {20, 60}})));
  Lines.TwoPortResistance_N Rline_sc(
    useHeatPort=false,
    R=60,
    Rn=20)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60, 60}, {-40, 40}})));
  Lines.TwoPortResistance_N Rline_1(
    R=30,
    Rn=10)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60, 0}, {-40, 20}})));
  Lines.TwoPortResistance_N Rline_2a(
    R=15,
    Rn=5)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60,-30}, {-40,-10}})));
  Lines.TwoPortResistance_N Rline_2b(
    R=15,
    Rn=5)
    "Resistive line that connects to load 2"
    annotation(
      Placement(
        transformation(
          extent={{-32,-30}, {-12,-10}})));
  Lines.TwoPortResistance_N Rline_3a(
    R=60,
    Rn=20)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60,-60}, {-40,-40}})));
  Lines.TwoPortResistance_N Rline_3b(
    R=60,
    Rn=20)
    "Resistive line that connects to load 3"
    annotation(
...
equation
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Lines/Examples/ACLine_R_N.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
