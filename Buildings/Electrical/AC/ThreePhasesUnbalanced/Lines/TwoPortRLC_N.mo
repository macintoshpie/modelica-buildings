...
equation
  ...
  connect(phase2.heatPort, heatPort)
    annotation(
      Line(
        points={{4.44089e-16,-10}, {4.44089e-16,-16}, {-32,-16}, {-32,-72}, {4.44089e-16,-72}, {4.44089e-16,-100}},
        color={191, 0, 0},
        smooth=Smooth.None));
  ...
  annotation(
    ...
    Icon(
      ...
      graphics={Text(
        ...
        origin={20,-4},
        rotation=180), Line(
        points={{-68, 16}, {-62, 16}, {-60, 20}, {-56, 12}, {-52, 20}, {-48, 12}, {-44, 20}, {-40, 12}, {-38, 16}, {-34, 16}},
        color={0, 0, 0},
