...
model TwoPortRL_N
  ...
  OnePhase.Lines.TwoPortRL phase1(final T_ref=T_ref, final M=M, final R=R/3, final L=L/3, final mode=mode, final useHeatPort=useHeatPort, i_start=i1_start)
    "Impedance line 1"
    annotation(Placement(transformation(extent={{-10, 20}, {10, 40}})));
  OnePhase.Lines.TwoPortRL phase2(final T_ref=T_ref, final M=M, final R=R/3, final L=L/3, final mode=mode, final useHeatPort=useHeatPort, i_start=i2_start)
    "Impedance line 2"
    annotation(Placement(transformation(extent={{-10,-10}, {10, 10}})));
  OnePhase.Lines.TwoPortRL phase3(final T_ref=T_ref, final M=M, final R=R/3, final L=L/3, final mode=mode, final useHeatPort=useHeatPort, i_start=i3_start)
    "Impedance line 3"
    annotation(Placement(transformation(extent={{-10,-40}, {10,-20}})));
  OnePhase.Lines.TwoPortRL neutral(final T_ref=T_ref, final M=M, final mode=mode, final useHeatPort=useHeatPort, final R=Rn, final L=Ln, i_start=-i1_start-i2_start-i3_start)
...
equation
  ...
  connect(phase3.heatPort, heatPort)
    annotation(Line(points={{0,-40}, {0,-44}, {-32,-44}, {-32,-72}, {0,-72}, {0,-100}}, color={191, 0, 0}, smooth=Smooth.None));
  ...
  connect(neutral.heatPort, heatPort)
    annotation(Line(points={{0,-66}, {0,-100}}, color={191, 0, 0}, smooth=Smooth.None));
  connect(neutral.terminal_p, terminal_p.phase[4])
    annotation(Line(points={{10,-56}, {20,-56}, {20, 0}, {100, 0}}, color={0, 120, 120}, smooth=Smooth.None));
  connect(neutral.terminal_n, terminal_n.phase[4])
    annotation(Line(points={{-10,-56}, {-20,-56}, {-20, 0}, {-100, 0}}, color={0, 120, 120}, smooth=Smooth.None));
  annotation(defaultComponentName="line", Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100}, {100, 100}}), graphics={Text(extent={{-150,-28}, {136,-60}}, lineColor={0, 0, 0}, textString="R=%R, L=%L"), Line(points={{-92, 0}, {-72, 0}}, color={0, 0, 0}), Line(points={{68, 0}, {88, 0}}, color={0, 0, 0}), Rectangle(extent={{-72, 32}, {68,-28}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Line(points={{-6.85214e-44,-8.39117e-60}, {66, 8.0824e-15}}, color={0, 0, 0}, origin={52, 0}, rotation=180), Line(points={{-48, 0}, {-42, 0}, {-40, 4}, {-36,-4}, {-32, 4}, {-28,-4}, {-24, 4}, {-20,-4}, {-18, 0}, {-14, 0}}, color={0, 0, 0}, smooth=Smooth.None), Ellipse(extent={{-6, 6}, {6,-6}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Ellipse(extent={{6, 6}, {18,-6}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Ellipse(extent={{18, 6}, {30,-6}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Rectangle(extent={{-6, 0}, {30,-12}}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid, pattern=LinePattern.None), Text(extent={{-142, 80}, {138, 40}}, lineColor={0, 0, 0}, textString="%name")}), Documentation(info="<html>
<p>
