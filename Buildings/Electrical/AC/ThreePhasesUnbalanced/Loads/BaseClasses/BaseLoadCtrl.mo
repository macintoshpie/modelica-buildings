...
partial model BaseLoadCtrl
  ...
  replaceable Buildings.Electrical.Interfaces.Load load1(
    ...
    final initMode=initMode) if plugPhase1
    "Load 1"
    annotation(
      Placement(
        transformation(
  ...
  replaceable Buildings.Electrical.Interfaces.Load load2(
    ...
    final P_nominal=P_nominal,
    final V_nominal=V_nominal/sqrt(3),
    final initMode=initMode) if plugPhase2
    "Load 2"
    annotation(
      Placement(
        transformation(
  ...
  replaceable Buildings.Electrical.Interfaces.Load load3(
    ...
    final P_nominal=P_nominal,
    final V_nominal=V_nominal/sqrt(3),
    final initMode=initMode) if plugPhase3
    "Load 3"
    annotation(
      Placement(
        transformation(
    ...
    annotation(
      Placement(
        ...
        iconTransformation(
          ...
          rotation=180,
          origin={120, 80})));
  Modelica.Blocks.Interfaces.RealInput Pow1(
    unit="W") if plugPhase1 and mode == Buildings.Electrical.Types.Load.VariableZ_P_input
    "Power consumed"
    annotation(
      Placement(
        transformation(
    ...
    annotation(
      Placement(
        ...
        iconTransformation(
          ...
          rotation=180,
          origin={120, 0})));
  Modelica.Blocks.Interfaces.RealInput Pow2(
    unit="W") if plugPhase2 and mode == Buildings.Electrical.Types.Load.VariableZ_P_input
    "Power consumed"
    annotation(
      Placement(
        transformation(
    ...
    annotation(
      Placement(
        ...
        iconTransformation(
          ...
          rotation=180,
          origin={120,-80})));
  Modelica.Blocks.Interfaces.RealInput Pow3(
    unit="W") if plugPhase3 and mode == Buildings.Electrical.Types.Load.VariableZ_P_input
    "Power consumed"
    annotation(
      Placement(
        transformation(
...
equation
  ...
  if plugPhase1 then
    connect(load1.terminal, adaDel.terminals[1])
      annotation(
        Line(
          points={{-10, 50}, {-26, 50}, {-26,-39.4667}, {-40.2,-39.4667}},
          color={0, 120, 120}));
    connect(load1.terminal, adaWye.terminals[1])
      annotation(
        Line(
          points={{-10, 50}, {-26, 50}, {-26,-69.4667}, {-40.2,-69.4667}},
          color={0, 120, 120}));
  end if;
  if plugPhase2 then
    connect(load2.terminal, adaDel.terminals[2])
      annotation(
        Line(
          points={{-10,-20}, {-22,-20}, {-22,-40}, {-40.2,-40}},
          color={0, 120, 120}));
    connect(load2.terminal, adaWye.terminals[2])
      annotation(
        Line(
          points={{-10,-20}, {-22,-20}, {-22,-70}, {-40.2,-70}},
          color={0, 120, 120}));
  end if;
  if plugPhase3 then
    connect(load3.terminal, adaDel.terminals[3])
      annotation(
        Line(
          points={{-10,-88}, {-16,-88}, {-20,-88}, {-20,-40.5333}, {-40.2,-40.5333}},
          color={0, 120, 120}));
    connect(load3.terminal, adaWye.terminals[3])
      annotation(
        Line(
          points={{-10,-88}, {-20,-88}, {-20,-70.5333}, {-40.2,-70.5333}},
          color={0, 120, 120}));
  end if;
  connect(adaDel.terminal, wyeToDelta.delta)
    annotation(
      Line(
        points={{-60,-40}, {-64,-40}, {-64,-20}, {-28,-20}, {-28, 10}, {-34, 10}},
        color={0, 120, 120}));
  connect(adaWye.terminal, wyeToWyeGround.wyeg)
    annotation(
      Line(
        points={{-60,-70}, {-66,-70}, {-66,-18}, {-30,-18}, {-30,-10}, {-34,-10}},
        color={0, 120, 120}));
  annotation(
    Documentation(
      info="<html>
