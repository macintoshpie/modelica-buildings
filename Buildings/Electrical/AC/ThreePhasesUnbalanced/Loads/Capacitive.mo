...
model Capacitive
  ...
  extends BaseClasses.LoadCtrl(redeclare Buildings.Electrical.AC.OnePhase.Loads.Capacitive load1(pf=pf, use_pf_in=use_pf_in), redeclare Buildings.Electrical.AC.OnePhase.Loads.Capacitive load2(pf=pf, use_pf_in=use_pf_in), redeclare Buildings.Electrical.AC.OnePhase.Loads.Capacitive load3(pf=pf, use_pf_in=use_pf_in));
  ...
  Modelica.Blocks.Interfaces.RealInput pf_in_2(min=0, max=1, unit="1") if(use_pf_in and plugPhase2)
    ...
    annotation(Placement(transformation(extent={{-20,-20}, {20, 20}}, rotation=90, origin={30,-120}), iconTransformation(extent={{-20,-20}, {20, 20}}, rotation=90, origin={0,-100})));
