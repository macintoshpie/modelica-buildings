...
model LoadCtrl
  ...
  Lines.Line_N line1(
    ...
    redeclare Buildings.Electrical.Transmission.LowVoltageCables.Cu10 commercialCable,
    l=400,
    P_nominal=10000,
    V_nominal=480)
...
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=10.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Loads/Examples/LoadCtrl.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
