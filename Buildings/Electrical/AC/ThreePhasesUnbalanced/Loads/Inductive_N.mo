...
model Inductive_N
  ...
  extends BaseClasses.LoadCtrl_N(redeclare Buildings.Electrical.AC.OnePhase.Loads.Inductive load1(pf=pf, use_pf_in=use_pf_in), redeclare Buildings.Electrical.AC.OnePhase.Loads.Inductive load2(pf=pf, use_pf_in=use_pf_in), redeclare Buildings.Electrical.AC.OnePhase.Loads.Inductive load3(pf=pf, use_pf_in=use_pf_in));
  ...
  Modelica.Blocks.Interfaces.RealInput pf_in_1(min=0, max=1, unit="1") if(use_pf_in and plugPhase1)
    ...
    annotation(Placement(transformation(extent={{-20,-20}, {20, 20}}, rotation=90, origin={80,-120}), iconTransformation(extent={{-20,-20}, {20, 20}}, rotation=90, origin={-60,-100})));
  Modelica.Blocks.Interfaces.RealInput pf_in_2(min=0, max=1, unit="1") if(use_pf_in and plugPhase2)
    ...
    annotation(Placement(transformation(extent={{-20,-20}, {20, 20}}, rotation=90, origin={40,-120}), iconTransformation(extent={{-20,-20}, {20, 20}}, rotation=90, origin={0,-100})));
