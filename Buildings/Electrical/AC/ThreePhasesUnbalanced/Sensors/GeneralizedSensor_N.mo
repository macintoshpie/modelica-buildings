  ...
  Interfaces.Terminal4_p terminal_p
    ...
    annotation(
      Placement(
        transformation(
          extent={{90,-10}, {110, 10}})));
  Modelica.Blocks.Interfaces.RealOutput V[4](
    each final quantity="ElectricPotential",
    each final unit="V")
    "Voltage"
    annotation(
      Placement(
        ...
        iconTransformation(
          ...
          rotation=270,
          origin={0,-90})));
  Modelica.Blocks.Interfaces.RealOutput I[4](
    ...
    annotation(
      Placement(
        ...
        iconTransformation(
          ...
          rotation=270,
          origin={60,-90})));
  Modelica.Blocks.Interfaces.RealOutput S[4, Buildings.Electrical.PhaseSystems.OnePhase.n](
...
equation
  for i in 1 : 4 loop
    ...
    S[i, :]=Buildings.Electrical.PhaseSystems.OnePhase.phasePowers_vi(
      v=terminal_n.phase[i].v,
      i=terminal_n.phase[i].i);
  end for;
  ...
  annotation(
    ...
    Icon(
      graphics={Rectangle(
        ...
        textString="S"), Polygon(
        points={{-0.48, 33.6}, {18, 28}, {18, 59.2}, {-0.48, 33.6}},
        lineColor={0, 0, 0},
        fillColor={0, 0, 0},
        fillPattern=FillPattern.Solid), Line(
        points={{-37.6, 15.7}, {-54, 22}},
        color={0, 0, 0}), Line(
        points={{-22.9, 34.8}, {-32, 50}},
        color={0, 0, 0}), Line(
        points={{0, 60}, {0, 42}},
        color={0, 0, 0}), Line(
        points={{22.9, 34.8}, {32, 50}},
        color={0, 0, 0}), Line(
        points={{37.6, 15.7}, {54, 24}},
        color={0, 0, 0}), Line(
        points={{0, 2}, {9.02, 30.6}},
        color={0, 0, 0}), Ellipse(
        extent={{-5, 7}, {5,-3}},
        lineColor={0, 0, 0},
        fillColor={0, 0, 0},
