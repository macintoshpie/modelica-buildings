...
model ProbeWye_N
  ...
  Buildings.Electrical.AC.ThreePhasesUnbalanced.Interfaces.Terminal4_n term
...
equation
  ...
  annotation(defaultComponentName="sen", Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100}, {100, 100}}), graphics={Line(points={{0,-10}, {0,-30}, {-14,-44}}, color={127, 0, 127}, smooth=Smooth.None, thickness=0.5), Line(points={{0,-30}, {14,-44}}, color={127, 0, 127}, smooth=Smooth.None, thickness=0.5)}), Documentation(info="<html>
<p>
