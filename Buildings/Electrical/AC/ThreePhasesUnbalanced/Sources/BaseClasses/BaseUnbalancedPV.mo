...
partial model BaseUnbalancedPV
  ...
  parameter Real areaFraction[3](
    each min=0,
    each max=1.0)=ones(3)/3
  ...
  replaceable OnePhase.Sources.PVSimple pv_phase2(
    ...
    fAct=fAct,
    eta=eta,
    V_nominal=V_nominal/sqrt(3)) if plugPhase2
    "PV phase 2"
    annotation(
      Placement(
        transformation(
  ...
  replaceable OnePhase.Sources.PVSimple pv_phase3(
    ...
    fAct=fAct,
    eta=eta,
    V_nominal=V_nominal/sqrt(3)) if plugPhase3
    "PV phase 3"
    annotation(
      Placement(
        transformation(
  ...
  replaceable OnePhase.Sources.PVSimple pv_phase1(
    ...
    fAct=fAct,
    eta=eta,
    V_nominal=V_nominal/sqrt(3)) if plugPhase1
    "PV phase 1"
    annotation(
      Placement(
        transformation(
