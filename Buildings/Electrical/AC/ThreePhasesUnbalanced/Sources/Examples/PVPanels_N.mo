  ...
  ThreePhasesUnbalanced.Loads.Inductive_N RL(
    ...
    annotation(
      Placement(
        transformation(
          extent={{20,-50}, {40,-30}})));
  ThreePhasesUnbalanced.Sources.Grid_N grid(
    f=60,
    V=480)
...
equation
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Sources/Examples/PVPanels_N.mos"
        "Simulate and plot"),
    Documentation(
      revisions="<html>
<ul>
