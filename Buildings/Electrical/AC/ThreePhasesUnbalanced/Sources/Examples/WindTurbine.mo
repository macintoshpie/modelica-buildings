...
model WindTurbine
  ...
  Buildings.Electrical.AC.ThreePhasesUnbalanced.Sources.WindTurbine tur(table=[
    3.5, 0;
    5.5, 100;
    12, 900;
    14, 1000;
    25, 1000], h=10, scale=10, V_nominal=480, scaleFraction={0.5, 0.25, 0.25})
    "Wind turbine"
  ...
  Buildings.Electrical.AC.ThreePhasesUnbalanced.Lines.Line line(l=200, P_nominal=5000, V_nominal=480)
...
equation
  ...
  connect(sou.terminal, line.terminal_n)
    annotation(Line(points={{-70, 10}, {-70, 0}, {-40, 5.55112e-16}}, color={0, 120, 120}, smooth=Smooth.None));
  connect(line.terminal_p, sen.terminal_n)
    annotation(Line(points={{-20, 5.55112e-16}, {8, 0}, {8, 6.66134e-16}}, color={0, 120, 120}, smooth=Smooth.None));
...
</html>"), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Sources/Examples/WindTurbine.mos"
    "Simulate and plot"));
end WindTurbine;
