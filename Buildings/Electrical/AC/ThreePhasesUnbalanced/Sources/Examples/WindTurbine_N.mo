...
model WindTurbine_N
  ...
  Buildings.Electrical.AC.ThreePhasesUnbalanced.Sources.WindTurbine_N tur(table=[
    3.5, 0;
    5.5, 100;
    12, 900;
    14, 1000;
    25, 1000], h=10, scale=10, V_nominal=480, plugPhase2=false, scaleFraction={0.4, 0.0, 0.6})
    "Wind turbine"
  ...
  Buildings.Electrical.AC.ThreePhasesUnbalanced.Lines.Line_N line(l=200, P_nominal=5000, V_nominal=480)
...
equation
  ...
  connect(tur.terminal, sen.terminal_p)
    annotation(Line(points={{50, 0}, {28, 0}}, color={127, 0, 127}, smooth=Smooth.None));
  connect(sen.terminal_n, line.terminal_p)
    annotation(Line(points={{8, 0}, {-20, 0}}, color={127, 0, 127}, smooth=Smooth.None));
  connect(line.terminal_n, sou.terminal)
    annotation(Line(points={{-40, 0}, {-70, 0}, {-70, 10}}, color={127, 0, 127}, smooth=Smooth.None));
  connect(res.terminal, sou.terminal)
    annotation(Line(points={{-22,-20}, {-70,-20}, {-70, 10}}, color={127, 0, 127}, smooth=Smooth.None));
...
</html>"), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Sources/Examples/WindTurbine_N.mos"
    "Simulate and plot"));
end WindTurbine_N;
