...
model FixedVoltage
  ...
  OnePhase.Sources.FixedVoltage vPhase[3](each f=f, potentialReference={potentialReference, potentialReference, potentialReference}, definiteReference={definiteReference, false, false}, phiSou={phiSou, phiSou-angle120, phiSou + angle120}, each V=V/sqrt(3))
...
equation
  connect(vPhase.terminal, ada.terminals)
    annotation(Line(points={{-30, 0}, {-9.8, 0}, {-9.8, 0}}, color={0, 120, 120}));
