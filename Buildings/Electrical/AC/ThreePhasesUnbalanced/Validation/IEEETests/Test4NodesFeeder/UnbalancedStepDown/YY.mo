  ...
  Modelica.Blocks.Sources.Constant pf3(
    ...
    annotation(
      Placement(
        transformation(
          extent={{24,-88}, {44,-68}})));
  Buildings.Electrical.AC.ThreePhasesUnbalanced.Conversion.ACACTransformer transformer(
    VHigh=VLL_side1,
    VLow=VLL_side2,
    XoverR=6,
...
equation
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/AC/ThreePhasesUnbalanced/Validation/IEEETests/Test4NodesFeeder/UnbalancedStepDown/YY.mos"
        "Simulate and plot"),
    Documentation(
      revisions="<html>
<ul>
