...
model DCDCConverter
  "DC DC converter"
  extends Buildings.Electrical.Interfaces.PartialConversion(redeclare package PhaseSystem_p=PhaseSystems.TwoConductor, redeclare package PhaseSystem_n=PhaseSystems.TwoConductor, redeclare Interfaces.Terminal_n terminal_n, redeclare Interfaces.Terminal_p terminal_p);
...
equation
  ...
  annotation(Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100}, {100, 100}}), graphics={Line(points={{2, 100}, {2, 60}, {82, 60}, {2, 60}, {82,-60}, {2,-60}, {2, 60}, {2,-100}}, color={0, 0, 255}, smooth=Smooth.None), Text(extent={{30, 54}, {90, 14}}, lineColor={0, 0, 255}, textString="DC"), Line(points={{-2, 100}, {-2, 60}, {-82, 60}, {-2, 60}, {-82,-60}, {-2,-60}, {-2, 60}, {-2,-100}}, color={85, 170, 255}, smooth=Smooth.None), Text(extent={{-88, 54}, {-28, 14}}, lineColor={85, 170, 255}, textString="DC"), Text(extent={{-100, 92}, {100, 60}}, lineColor={0, 0, 0}, textString="%name"), Text(extent={{-120,-60}, {-2,-90}}, lineColor={0, 0, 0}, textString="%VHigh"), Text(extent={{-100,-100}, {100,-132}}, lineColor={0, 0, 255}, textString="%eta"), Text(extent={{-132, 80}, {-72, 40}}, lineColor={85, 170, 255}, textString="1"), Text(extent={{70, 80}, {130, 40}}, lineColor={0, 0, 255}, textString="2"), Line(visible=(ground_1 == true), points={{-120,-100}, {-80,-100}}, color={0, 0, 255}, smooth=Smooth.None), Line(visible=(ground_1 == true), points={{-112,-106}, {-88,-106}}, color={0, 0, 255}, smooth=Smooth.None), Line(visible=(ground_1 == true), points={{-106,-112}, {-92,-112}}, color={0, 0, 255}, smooth=Smooth.None), Line(visible=(ground_1 == true), points={{-100,-100}, {-100,-12}}, color={0, 0, 255}, smooth=Smooth.None), Line(visible=(ground_2 == true), points={{100,-100}, {100,-12}}, color={0, 0, 255}, smooth=Smooth.None), Line(visible=(ground_2 == true), points={{80,-100}, {120,-100}}, color={0, 0, 255}, smooth=Smooth.None), Line(visible=(ground_2 == true), points={{88,-106}, {112,-106}}, color={0, 0, 255}, smooth=Smooth.None), Line(visible=(ground_2 == true), points={{94,-112}, {108,-112}}, color={0, 0, 255}, smooth=Smooth.None), Text(extent={{2,-60}, {120,-90}}, lineColor={0, 0, 0}, textString="%VLow")}), Documentation(info="<html>
<p>
