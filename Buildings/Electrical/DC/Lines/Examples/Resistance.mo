  ...
  TwoPortResistance lineR(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-30, 10}, {-10, 30}})));
  Sources.ConstantVoltage constantVoltage(
    V=50)
    "Voltage source"
    annotation(
      Placement(
...
Added model, documentation and results for regression test.
    ...
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/DC/Lines/Examples/Resistance.mos"
        "Simulate and plot"));
end Resistance;
