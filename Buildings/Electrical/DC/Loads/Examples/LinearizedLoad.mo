  ...
  Modelica.Electrical.Analog.Basic.Ground gro
    ...
    annotation(
      Placement(
        transformation(
          extent={{-100,-32}, {-80,-12}})));
  Lines.TwoPortResistance Rline1(
    R=2)
    "Line resistance"
    annotation(
      Placement(
  ...
  Sensors.GeneralizedSensor sen_lin
    ...
    annotation(
      Placement(
        transformation(
          extent={{-10, 20}, {10, 40}})));
  Lines.TwoPortResistance Rline2(
    R=2)
    "Line resistance"
    annotation(
      Placement(
...
equation
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/DC/Loads/Examples/LinearizedLoad.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
