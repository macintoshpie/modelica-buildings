...
model Resistor
  ...
  Buildings.Electrical.DC.Loads.Resistor res2(
    R=2,
    V_nominal=12)
    "Resistor"
    annotation(
  ...
  Sensors.GeneralizedSensor sen
    ...
    annotation(
      Placement(
        transformation(
          extent={{0, 20}, {20, 40}})));
  Buildings.Electrical.DC.Loads.Resistor res1(
    R=2,
    V_nominal=12)
    "Resistor"
    annotation(
...
equation
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/DC/Loads/Examples/Resistor.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
