...
equation
  ...
  connect(sou.n, ground.p)
    annotation(Line(points={{-50, 0}, {-50,-12}}, color={0, 0, 255}, smooth=Smooth.None));
...
</html>"), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/DC/Sensors/Examples/GeneralizedSensor.mos"
    "Simulate and plot"));
