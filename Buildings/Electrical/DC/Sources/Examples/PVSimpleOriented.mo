...
model PVSimpleOriented
  ...
  Buildings.Electrical.DC.Sources.PVSimpleOriented pv(A=10, V_nominal=12, til=0.34906585039887, lat=0.65798912800186, azi=-0.78539816339745)
    "PV module"
...
equation
  ...
  connect(weaDat.weaBus, pv.weaBus)
    annotation(Line(points={{-108, 100}, {50, 100}, {50, 49}}, color={255, 204, 51}, thickness=0.5, smooth=Smooth.None));
...
</html>"), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/DC/Sources/Examples/PVSimpleOriented.mos"
