...
model RenewableSources
  ...
  AC.ThreePhasesBalanced.Sources.Grid gri(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-100, 40}, {-80, 60}})));
  AC.ThreePhasesBalanced.Loads.Inductive loa1(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-40, 30}, {-20, 50}})));
  AC.ThreePhasesBalanced.Loads.Inductive loa2(
    mode=Buildings.Electrical.Types.Load.VariableZ_y_input,
    V_nominal=V_nominal,
    linearized=false,
    use_pf_in=false,
    ...
    annotation(
      Placement(
        transformation(
          extent={{0, 30}, {20, 50}})));
  AC.ThreePhasesBalanced.Loads.Inductive loa3(
    mode=Buildings.Electrical.Types.Load.VariableZ_y_input,
    V_nominal=V_nominal,
    linearized=false,
    use_pf_in=false,
    ...
    annotation(
      Placement(
        transformation(
          extent={{40, 30}, {60, 50}})));
  AC.ThreePhasesBalanced.Loads.Inductive loa4(
    mode=Buildings.Electrical.Types.Load.VariableZ_y_input,
    V_nominal=V_nominal,
    linearized=false,
    use_pf_in=false,
    ...
    annotation(
      Placement(
        transformation(
          extent={{80, 30}, {100, 50}})));
  AC.ThreePhasesBalanced.Lines.Line line1(
  ...
  AC.ThreePhasesBalanced.Lines.Line line5(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-40,-20}, {-20, 0}})));
  AC.ThreePhasesBalanced.Loads.Inductive loa5(
    mode=Buildings.Electrical.Types.Load.VariableZ_y_input,
    V_nominal=V_nominal,
    linearized=false,
    use_pf_in=false,
    ...
    annotation(
      Placement(
        transformation(
          extent={{-20,-50}, {0,-30}})));
  AC.ThreePhasesBalanced.Loads.Inductive loa6(
    mode=Buildings.Electrical.Types.Load.VariableZ_y_input,
    V_nominal=V_nominal,
    linearized=false,
    use_pf_in=false,
    ...
    annotation(
      Placement(
        transformation(
          extent={{20,-50}, {40,-30}})));
  AC.ThreePhasesBalanced.Loads.Inductive loa7(
    mode=Buildings.Electrical.Types.Load.VariableZ_y_input,
    V_nominal=V_nominal,
    linearized=false,
    use_pf_in=false,
  ...
  Modelica.Blocks.Sources.CombiTimeTable pow4(
    ...
    annotation(
      Placement(
        transformation(
          extent={{116, 34}, {104, 46}})));
  Modelica.Blocks.Sources.CombiTimeTable pow5(
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    table=[
      0, 0.1;
      2, 0.1;
    ...
    annotation(
      Placement(
        transformation(
          extent={{16,-46}, {4,-34}})));
  Modelica.Blocks.Sources.CombiTimeTable pow6(
    extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic,
    table=[
      0, 0.1;
      2, 0.1;
  ...
  Modelica.Blocks.Sources.CombiTimeTable pow7(
    ...
    annotation(
      Placement(
        transformation(
          extent={{96,-46}, {84,-34}})));
  AC.ThreePhasesBalanced.Sensors.Probe sen1(
    V_nominal=V_nominal,
    perUnit=true)
    "Voltage probe"
    annotation(
      Placement(
        transformation(
          extent={{-70, 0}, {-50,-20}})));
  AC.ThreePhasesBalanced.Sensors.Probe sen2(
    V_nominal=V_nominal,
    perUnit=true)
    "Voltage probe"
    annotation(
      Placement(
        transformation(
          extent={{-10, 10}, {10,-10}},
          origin={90, 8})));
  AC.ThreePhasesBalanced.Sensors.Probe sen3(
    V_nominal=V_nominal,
    perUnit=true)
    "Voltage probe"
    annotation(
  ...
  Modelica.Blocks.Continuous.Integrator EWin
    ...
    annotation(
      Placement(
        transformation(
          extent={{200,-14}, {220, 6}})));
  Modelica.Blocks.Math.MultiSum PSol(
    nu=7,
    y(
      unit="W"))
...
equation
  ...
  connect(PSol.u[6], pv6.P)
    annotation(
      Line(
        points={{174, 67.6}, {168, 67.6}, {168, 72}, {160, 72}, {160,-90}, {50,-90}, {50,-63}, {41,-63}},
        color={0, 0, 127},
        smooth=Smooth.None,
        pattern=LinePattern.Dot));
  connect(PSol.u[7], pv7.P)
    annotation(
      Line(
        points={{174, 66.4}, {168, 66.4}, {168, 68}, {160, 68}, {160,-90}, {90,-90}, {90,-63}, {81,-63}},
        color={0, 0, 127},
        smooth=Smooth.None,
        pattern=LinePattern.Dot));
...
<img alt=\"image\" src=\"modelica://Buildings/Resources/Images/Electrical/Examples/RenewableSources/VoltageLevel.png\"/>
    ...
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Electrical/Examples/RenewableSources.mos"
        "Simulate and plot"),
    Diagram(
      coordinateSystem(
        preserveAspectRatio=false,
        extent={{-120,-100}, {320, 100}})));
