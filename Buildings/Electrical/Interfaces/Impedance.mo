...
model Impedance
  ...
  extends Buildings.Electrical.Interfaces.Load(final linearized=false, final mode=Buildings.Electrical.Types.Load.FixedZ_steady_state, final P_nominal(fixed=true)=0, final V_nominal(fixed=true)=1);
