...
model PartialPV
  ...
  Modelica.Blocks.Interfaces.RealInput G(unit="W/m2")
    ...
    annotation(Placement(transformation(origin={0, 70}, extent={{-20,-20}, {20, 20}}, rotation=270), iconTransformation(extent={{-20,-20}, {20, 20}}, rotation=270, origin={0, 120})));
