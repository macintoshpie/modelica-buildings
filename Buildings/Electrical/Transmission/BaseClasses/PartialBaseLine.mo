  ...
  parameter Buildings.Electrical.Types.Load modelMode=Buildings.Electrical.Types.Load.FixedZ_steady_state
    ...
    annotation(
      ...
      Dialog(
        ...
        enable=use_C),
      choices(
        choice=Buildings.Electrical.Types.Load.FixedZ_steady_state
          "Steady state",
        choice=Buildings.Electrical.Types.Load.FixedZ_dynamic
          "Dynamic"));
    ...
    annotation(
      Placement(
        ...
        iconTransformation(
          ...
          rotation=270,
          origin={0, 30})));
  Modelica.Blocks.Sources.RealExpression cableTemperature(
    y=T_in)
    "Temperature of the cable"
    annotation(
      Placement(
