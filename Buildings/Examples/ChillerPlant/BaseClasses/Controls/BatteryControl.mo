...
model BatteryControl
  ...
  Modelica.Blocks.Sources.BooleanExpression isDay(
    y=mod(time, 86400) > 7*3600 and mod(time, 86400) <= 19*3600)
    "Outputs true if it is day time"
    annotation(
      Placement(
        transformation(
          extent={{-152, 30}, {-132, 50}})));
