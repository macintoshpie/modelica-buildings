...
equation
  connect(hysteresis.y, y)
    annotation(
      Line(
        points={{41, 6.10623e-16}, {52.5, 6.10623e-16}, {52.5, 1.11022e-16}, {122, 1.11022e-16}},
        color={255, 0, 255},
        smooth=Smooth.None));
  ...
  connect(add.y, hysteresis.u)
    annotation(
      Line(
        points={{-19, 6.10623e-16}, {-1.5, 6.10623e-16}, {-1.5, 6.66134e-16}, {18, 6.66134e-16}},
        color={0, 0, 127},
        smooth=Smooth.None));
  annotation(
...
First implementation.
    ...
    Icon(
      graphics={Rectangle(
        ...
        borderPattern=BorderPattern.Raised), Polygon(
        ...
        points={{-77,-25}, {43,-25}},
        color={0, 0, 0}), Line(
        points={{-13,-17}, {3,-25}, {-13,-32}},
        color={0, 0, 0}), Line(
        points={{43, 55}, {43,-25}},
        color={0, 0, 0}), Line(
        points={{35, 7}, {43, 26}, {52, 7}},
        color={0, 0, 0}), Line(
        points={{-47, 55}, {83, 55}},
        color={0, 0, 0}), Line(
        points={{-2, 63}, {-17, 55}, {-2, 47}},
        color={0, 0, 0}), Line(
        points={{-57, 33}, {-47, 15}, {-37, 33}},
        color={0, 0, 0}), Line(
        points={{-47, 55}, {-47,-25}},
        color={0, 0, 0}), Text(
        extent={{-90,-45}, {-7,-88}},
        ...
        extent={{4,-45}, {93,-88}},
        lineColor={192, 192, 192},
        textString="%uHigh"), Rectangle(
        extent={{-89,-45}, {-6,-88}},
        lineColor={192, 192, 192}), Line(
        points={{-47,-25}, {-47,-45}},
