...
model ChillerSetPointControl
  ...
  Buildings.Fluid.Storage.ExpansionVessel expVesChi(
    ...
    annotation(
      Placement(
        transformation(
          extent={{124, 26}, {144, 46}})));
  Modelica.Blocks.Sources.BooleanConstant booleanConstant1(
    k=true)
    annotation(
      Placement(
        transformation(
          extent={{-180, 62}, {-160, 82}})));
...
equation
  ...
  annotation(
    Diagram(
      ...
      graphics),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Examples/ChillerPlant/BaseClasses/Controls/Examples/ChillerSetPointControl.mos"
        "Simulate and plot"),
    experiment(
      StopTime=86400,
      Tolerance=1e-6),
