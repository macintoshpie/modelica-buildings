  ...
  Modelica.Blocks.Sources.Sine pulse(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-80, 0}, {-60, 20}})));
  Buildings.Examples.ChillerPlant.BaseClasses.Controls.KMinusU kMinU(
    k=1)
    annotation(
      Placement(
        transformation(
...
equation
  ...
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Examples/ChillerPlant/BaseClasses/Controls/Examples/KMinusU.mos"
        "Simulate and plot"),
    experiment(
      StopTime=3600,
      Tolerance=1e-6),
