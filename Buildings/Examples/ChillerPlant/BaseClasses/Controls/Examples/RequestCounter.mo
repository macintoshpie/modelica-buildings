  ...
  Buildings.Examples.ChillerPlant.BaseClasses.Controls.RequestCounter reqCou(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-20, 0}, {0, 20}})));
  Modelica.Blocks.Sources.Constant act3(
    k=0.95)
    annotation(
      Placement(
        transformation(
...
equation
  ...
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Examples/ChillerPlant/BaseClasses/Controls/Examples/RequestCounter.mos"
        "Simulate and plot"),
    experiment(
      StopTime=600,
      Tolerance=1e-6),
