  ...
  Modelica.Blocks.Sources.Pulse wseCHWST(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60, 50}, {-40, 70}})));
  Modelica.Blocks.Sources.Constant wseCWST(
    k=273.15 + 10)
  ...
  Modelica.Blocks.Sources.Constant TWetBub(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60, 10}, {-40, 30}})));
  Modelica.Blocks.Sources.Constant TTowApp(
    k=5)
...
equation
  ...
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Examples/ChillerPlant/BaseClasses/Controls/Examples/WSEControl.mos"
        "Simulate and plot"),
    experiment(
      StopTime=3600,
      Tolerance=1e-6),
