...
block TrimAndRespond
  ...
  Modelica.Blocks.Logical.GreaterEqualThreshold incY(
    threshold=0)
  ...
  Sampler sam(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60, 50}, {-40, 70}})));
  Modelica.Blocks.Sources.Constant conYDec(
    k=yDec)
    "y decrease"
    annotation(
      Placement(
        transformation(
          extent={{20, 30}, {40, 50}})));
  Modelica.Blocks.Sources.Constant conYInc(
    k=yInc)
    "y increase"
    annotation(
      Placement(
...
equation
  ...
  connect(add.y, lim.u)
    annotation(
      Line(
        points={{1, 6.10623e-16}, {9.5, 6.10623e-16}, {9.5, 6.66134e-16}, {18, 6.66134e-16}},
        color={0, 0, 127},
        smooth=Smooth.None));
  ...
  connect(lim.y, uniDel1.u)
    annotation(
      Line(
        points={{41, 6.66134e-16}, {60, 6.66134e-16}, {60,-40}, {-80,-40}, {-80,-6}, {-62,-6}},
        color={0, 0, 127},
        smooth=Smooth.None));
