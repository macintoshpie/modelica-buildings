...
equation
  ...
  connect(PIT.y, PDC)
    annotation(
      Line(
        points={{-279,-280}, {-256,-280}, {-256,-228}, {-194,-228}, {-194,-240}, {-130,-240}},
        color={0, 0, 127},
        smooth=Smooth.None));
  annotation(
    Icon(
      graphics={Rectangle(
        ...
        extent={{-88, 88}, {96,-78}},
        fileName="modelica://Buildings/Resources/Images/Examples/ChillerPlant/DataCenter.png")}),
    Diagram(
      coordinateSystem(
