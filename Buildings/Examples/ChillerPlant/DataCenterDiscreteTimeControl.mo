...
model DataCenterDiscreteTimeControl
  ...
  BaseClasses.Controls.TrimAndRespond triAndRes(yEqu0=0, samplePeriod=120, uTri=0, yDec=-0.03, yInc=0.03)
    "Trim and respond controller"
    annotation(Placement(transformation(extent={{-160, 190}, {-140, 210}})));
equation
  connect(feedback.y, triAndRes.u)
    annotation(Line(points={{-191, 200}, {-162, 200}}, color={0, 0, 127}, smooth=Smooth.None, pattern=LinePattern.Dash));
  connect(triAndRes.y, linPieTwo.u)
    annotation(Line(points={{-139, 200}, {-122, 200}}, color={0, 0, 127}, smooth=Smooth.None, pattern=LinePattern.Dash));
  annotation(__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Examples/ChillerPlant/DataCenterDiscreteTimeControl.mos"
...
</html>"), Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-400,-300}, {400, 300}}), graphics), experiment(StartTime=13046400, Tolerance=1e-6, StopTime=13651200));
