...
model ClosedLoop
  ...
  Buildings.Fluid.HeatExchangers.WetCoilCounterFlow cooCoi(
    ...
    UA_nominal=-mAirCol_flow_nominal*1000*15/Buildings.Fluid.HeatExchangers.BaseClasses.lmtd(
      T_a1=6,
      T_b1=12,
      T_a2=28,
      T_b2=13),
    ...
    annotation(
      Placement(
        transformation(
          extent={{372,-146}, {352,-166}})));
  Buildings.Fluid.Movers.SpeedControlled_y fanSupHot(
    redeclare package Medium=MediumA,
    per(
      pressure(
        V_flow=mAirHot_flow_nominal/1.2*{0, 2},
        dp=600*{2, 0})),
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
    ...
    annotation(
      Placement(
        transformation(
          extent={{300,-10}, {320, 10}})));
  Buildings.Fluid.Movers.SpeedControlled_y fanSupCol(
    redeclare package Medium=MediumA,
    per(
      pressure(
        V_flow=mAirCol_flow_nominal/1.2*{0, 2},
        dp=600*{2, 0})),
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
    ...
    annotation(
      Placement(
        transformation(
          extent={{302,-160}, {322,-140}})));
  Buildings.Fluid.Movers.SpeedControlled_y fanRet(
    redeclare package Medium=MediumA,
    per(
      pressure(
        V_flow=m_flow_nominal/1.2*{0, 2},
        dp=100*{2, 0})),
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
    "Return air fan"
    annotation(
  ...
  Modelica.Blocks.Routing.RealPassThrough TOut(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-300, 138}, {-280, 158}})));
  Buildings.Examples.DualFanDualDuct.Controls.HeatingCoilTemperatureSetpoint TSupSetHea(
    TOn=284.15,
    TOff=279.15)
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort TPreHeaCoi(
    ...
    annotation(
      Placement(
        transformation(
          extent={{134,-50}, {154,-30}})));
  Buildings.Utilities.Math.Min min(
    nin=5)
    "Computes lowest room temperature"
    annotation(
      Placement(
        transformation(
          extent={{1200, 440}, {1220, 460}})));
  Buildings.Utilities.Math.Average ave(
    nin=5)
    "Compute average of room temperatures"
    annotation(
      Placement(
        transformation(
          extent={{1200, 410}, {1220, 430}})));
  ...
  Buildings.Examples.VAVReheat.Controls.RoomTemperatureSetpoint TSetRoo(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-300,-276}, {-280,-256}})));
  Buildings.Fluid.Sources.Boundary_pT souHea(
    redeclare package Medium=MediumW,
    p(
      displayUnit="Pa")=300000 + 12000,
    T=318.15,
    nPorts=2)
  ...
  Buildings.Fluid.FixedResistances.Junction splRetRoo1(
    ...
    annotation(
      Placement(
        transformation(
          extent={{592, 170}, {612, 150}})));
  Buildings.Fluid.FixedResistances.Junction splRetSou(
    redeclare package Medium=MediumA,
    m_flow_nominal={m0_flow_sou + m0_flow_eas + m0_flow_nor + m0_flow_wes, m0_flow_eas + m0_flow_nor + m0_flow_wes, m0_flow_sou},
    from_dp=from_dp,
    linearized=linearizeFlowResistance,
    dp_nominal(
    ...
    annotation(
      Placement(
        transformation(
          extent={{732, 170}, {752, 150}})));
  Buildings.Fluid.FixedResistances.Junction splRetEas(
    redeclare package Medium=MediumA,
    m_flow_nominal={m0_flow_eas + m0_flow_nor + m0_flow_wes, m0_flow_nor + m0_flow_wes, m0_flow_eas},
    from_dp=from_dp,
    linearized=linearizeFlowResistance,
    dp_nominal(
  ...
  Buildings.Fluid.FixedResistances.Junction splSupNorHot(
    ...
    annotation(
      Placement(
        transformation(
          extent={{980, 10}, {1000,-10}})));
  Buildings.Examples.DualFanDualDuct.Controls.CoolingCoilTemperatureSetpoint TSetCoo(
    TOn=285.15,
    TOff=313.15)
  ...
  BoundaryConditions.WeatherData.ReaderTMY3 weaDat(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-390, 170}, {-370, 190}})));
  BoundaryConditions.WeatherData.Bus weaBus
    "Weather Data Bus"
    annotation(
      Placement(
        transformation(
          extent={{-360, 170}, {-340, 190}})));
  ...
  Buildings.Controls.Continuous.LimPID heaCoiCon(
    ...
    annotation(
      Placement(
        transformation(
          extent={{340,-60}, {360,-40}})));
  Buildings.Controls.SetPoints.Table TSetHot(
    table=[
      273.15 + 5, 273.15 + 40;
      273.15 + 22, 273.15 + 22])
  ...
  Modelica.Blocks.Sources.Constant pStaBui_Set(
    y(
      final unit="Pa",
      min=0),
    k=30)
  ...
  Controls.PreHeatCoil conPreHeatCoi
    ...
    annotation(
      Placement(
        transformation(
          extent={{-4,-112}, {16,-92}})));
  Modelica.Blocks.Math.Gain gaiPumPreCoi(
    k=mWatPre_flow_nominal)
...
equation
  ...
  connect(cor.controlBus, controlBus)
    annotation(
      Line(
        points={{548, 60.32}, {548, 20}, {540, 20}, {540,-160}, {480,-160}, {480,-260}, {-240,-260}},
        color={255, 204, 51},
        thickness=0.5,
        smooth=Smooth.None),
      Text(
  ...
  connect(sou.controlBus, controlBus)
    annotation(
      Line(
        points={{686, 59.28}, {686, 18}, {674, 18}, {674,-160}, {480,-160}, {480,-260}, {-240,-260}},
        color={255, 204, 51},
        thickness=0.5,
        smooth=Smooth.None),
      Text(
  ...
  connect(eas.controlBus, controlBus)
    annotation(
      Line(
        points={{824, 62.32}, {812, 62.32}, {812,-160}, {480,-160}, {480,-260}, {-240,-260}},
        color={255, 204, 51},
        thickness=0.5,
        smooth=Smooth.None),
      Text(
  ...
  connect(nor.controlBus, controlBus)
    annotation(
      Line(
        points={{964, 62.32}, {950, 62.32}, {950,-160}, {480,-160}, {480,-260}, {-240,-260}},
        color={255, 204, 51},
        thickness=0.5,
        smooth=Smooth.None),
      Text(
  ...
  connect(wes.controlBus, controlBus)
    annotation(
      Line(
        points={{1102, 62.32}, {1092, 62.32}, {1092,-160}, {480,-160}, {480,-260}, {-240,-260}},
        color={255, 204, 51},
        thickness=0.5,
        smooth=Smooth.None),
      Text(
  ...
  connect(splSupEasHot.port_2, splSupNorHot.port_1)
    annotation(
      Line(
        points={{862,-6.10623e-16}, {928, 3.36456e-22}, {928,-6.10623e-16}, {980,-6.10623e-16}},
        color={0, 127, 255},
        smooth=Smooth.None));
  ...
  connect(TSetCoo.TSet, conEco.TSupCooSet)
    annotation(
      Line(
        points={{-59,-240}, {-46,-240}, {-46,-104}, {-160,-104}, {-160, 141.333}, {-81.3333, 141.333}},
        color={0, 0, 127},
        smooth=Smooth.None));
  connect(modeSelector.cb, TSetCoo.controlBus)
    annotation(
      Line(
        points={{-136.5,-363.5}, {-136,-363.5}, {-136,-364}, {-136,-364}, {-136,-248}, {-71.8,-248}},
        color={255, 204, 51},
        thickness=0.5,
        smooth=Smooth.None));
  ...
  connect(cor.port_b, flo.portsCor[1])
    annotation(
      Line(
        points={{582, 112}, {582, 252}, {784, 252}, {784, 364}, {935.429, 364}, {935.429, 337.48}},
        color={0, 127, 255},
        smooth=Smooth.None));
  connect(splRetRoo1.port_3, flo.portsCor[2])
    annotation(
      Line(
        points={{602, 170}, {602, 240}, {792, 240}, {792, 352}, {928, 352}, {928, 337.48}, {946.714, 337.48}},
        color={0, 127, 255},
        smooth=Smooth.None));
  ...
  connect(TRooAir.u, flo.TRooAir)
    annotation(
      Line(
        points={{496, 130}, {478, 130}, {478, 500}, {1162, 500}, {1162, 380.8}, {1110.36, 380.8}},
        color={0, 0, 127},
        smooth=Smooth.None));
  ...
  connect(heaCoi.port_b1, sinHea.ports[2])
    annotation(
      Line(
        points={{350,-12}, {340,-12}, {340,-28}, {220,-28}, {220,-74}, {174,-74}, {174,-200}, {92,-200}, {92,-210}},
        color={0, 127, 255},
        smooth=Smooth.None));
  ...
  connect(TSupSetHea.TSet, conEco.TSupHeaSet)
    annotation(
      Line(
        points={{-59,-170}, {-52,-170}, {-52,-110}, {-170,-110}, {-170, 145.333}, {-81.3333, 145.333}},
        color={0, 0, 127},
        smooth=Smooth.None));
  ...
  connect(TCoiHea.port_b, splSupRoo1Hot.port_1)
    annotation(
      Line(
        points={{420, 6.10623e-16}, {491, 6.10623e-16}, {491,-6.10623e-16}, {562,-6.10623e-16}},
        color={0, 127, 255},
        smooth=Smooth.None));
  ...
  connect(gaiPumPreCoi.y, pumPreHea.m_flow_in)
    annotation(
      Line(
        points={{81,-90}, {108,-90}, {108,-90}},
        color={0, 0, 127}));
  connect(conPreHeatCoi.yPum, gaiPumPreCoi.u)
    annotation(
      Line(
        points={{17,-97}, {32,-97}, {32,-90}, {58,-90}},
        color={0, 0, 127}));
  connect(conPreHeatCoi.TSupSetHea, TSupSetHea.TSet)
    annotation(
      Line(
        points={{-5,-102}, {-52,-102}, {-52,-170}, {-59,-170}},
        color={0, 0, 127}));
  connect(conPreHeatCoi.TMix, TMix.T)
    annotation(
      Line(
        points={{-5,-96}, {-12,-96}, {-12,-20}, {40,-20}, {40,-29}},
        color={0, 0, 127}));
  connect(TPreHeaCoi.T, conPreHeatCoi.TAirSup)
    annotation(
      Line(
        points={{144,-29}, {144,-29}, {144,-16}, {-20,-16}, {-20,-108}, {-5,-108}},
        color={0, 0, 127}));
  connect(conPreHeatCoi.yVal, valPreHea.y)
    annotation(
      Line(
        points={{17,-107}, {40,-107}, {40,-170}, {108,-170}},
        color={0, 0, 127}));
  connect(modeSelector.yFan, conFanSupCol.uFan)
    annotation(
      Line(
        points={{-117.5,-371}, {-100,-371}, {-100,-370}, {-100, 76}, {98, 76}},
        color={255, 0, 255}));
  connect(modeSelector.yFan, conFanSupHot.uFan)
    annotation(
      Line(
        points={{-117.5,-371}, {-100,-371}, {-100, 76}, {94, 76}, {94, 126}, {118, 126}},
        color={255, 0, 255}));
  connect(modeSelector.yFan, conFanRet.uFan)
    annotation(
      Line(
        points={{-117.5,-371}, {-100,-371}, {-100, 250}, {228, 250}, {228, 236}, {238, 236}},
        color={255, 0, 255}));
  connect(cor.yFan, modeSelector.yFan)
    annotation(
      Line(
        points={{543.467, 71.2}, {530, 71.2}, {530,-371}, {-117.5,-371}},
        color={255, 0, 255}));
  connect(modeSelector.yFan, sou.yFan)
    annotation(
      Line(
        points={{-117.5,-371}, {658,-371}, {658, 70.8}, {681.2, 70.8}},
        color={255, 0, 255}));
  connect(modeSelector.yFan, eas.yFan)
    annotation(
      Line(
        points={{-117.5,-371}, {800,-371}, {800, 73.2}, {819.467, 73.2}},
        color={255, 0, 255}));
  connect(modeSelector.yFan, nor.yFan)
    annotation(
      Line(
        points={{-117.5,-371}, {-117.5,-372}, {932,-372}, {932, 73.2}, {959.467, 73.2}},
        color={255, 0, 255}));
  connect(modeSelector.yFan, wes.yFan)
    annotation(
      Line(
        points={{-117.5,-371}, {1074,-371}, {1074, 73.2}, {1097.47, 73.2}},
        color={255, 0, 255}));
  annotation(
    Diagram(
      coordinateSystem(
        preserveAspectRatio=false,
        extent={{-400,-400}, {1400, 640}})),
    Documentation(
      info="<html>
<p>
...
First implementation.
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Examples/DualFanDualDuct/ClosedLoop.mos"
        "Simulate and plot"),
    experiment(
      StopTime=172800,
      Tolerance=1e-07));
