  ...
  Modelica.Blocks.Sources.Constant TSupSet(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-80, 30}, {-60, 50}})));
  Modelica.Blocks.Sources.Constant TAirSup(
    k=273.15 + 15)
...
equation
  connect(TMix.y, preHeatCoil.TMix)
    annotation(
      Line(
        points={{-59, 70}, {-30, 70}, {-30, 6}, {-1, 6}},
        color={0, 0, 127}));
  connect(preHeatCoil.TSupSetHea, TSupSet.y)
    annotation(
      Line(
        points={{-1, 0}, {-24, 0}, {-50, 0}, {-50, 40}, {-59, 40}},
        color={0, 0, 127}));
  connect(preHeatCoil.TAirSup, TAirSup.y)
    annotation(
      Line(
        points={{-1,-6}, {-54,-6}, {-54,-10}, {-59,-10}},
        color={0, 0, 127}));
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Examples/DualFanDualDuct/Controls/Examples/PreHeatCoil.mos"
        "Simulate and plot"),
    experiment(
      Tolerance=1e-6,
      StopTime=10800),
