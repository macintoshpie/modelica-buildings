...
block RoomMixingBox
  ...
  Buildings.Controls.OBC.CDL.Continuous.LimPID conFloRat(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-42, 30}, {-22, 50}})));
  Modelica.Blocks.Sources.Constant mAirSet(
    k=m_flow_min)
  ...
  Buildings.Controls.OBC.CDL.Continuous.Max max
    ...
    annotation(
      Placement(
        transformation(
          extent={{38, 38}, {58, 58}})));
  Modelica.Blocks.Interfaces.RealInput TRooSetHea(
    unit="K")
  ...
  Modelica.Blocks.Interfaces.RealInput TRooSetCoo(
    unit="K")
  ...
  Buildings.Controls.OBC.CDL.Continuous.Max maxCoo
    ...
    annotation(
      Placement(
        transformation(
          extent={{40,-26}, {60,-6}})));
  Buildings.Controls.OBC.CDL.Continuous.Add dTSet(
    k2=-1)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60,-90}, {-40,-70}})));
  Buildings.Controls.OBC.CDL.Continuous.Add dTRooHea(
    k2=-1)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60,-60}, {-40,-40}})));
  Buildings.Controls.OBC.CDL.Continuous.Limiter gaiCoo(
    uMax=1,
    uMin=0)
    "Gain of cooling"
    annotation(
...
equation
  ...
  connect(dTSet.u1, TRooSetCoo)
    annotation(
      Line(
        points={{-62,-74}, {-68,-74}, {-68, 0}, {-120, 0}},
        color={0, 0, 127}));
  connect(dTSet.u2, TRooSetHea)
    annotation(
      Line(
        points={{-62,-86}, {-76,-86}, {-76, 40}, {-120, 40}},
        color={0, 0, 127}));
  connect(dTRooHea.u1, TRoo)
    annotation(
      Line(
        points={{-62,-44}, {-82,-44}, {-82, 80}, {-120, 80}},
        color={0, 0, 127}));
  connect(dTRooHea.u2, TRooSetHea)
    annotation(
      Line(
        points={{-62,-56}, {-76,-56}, {-76, 40}, {-120, 40}},
        color={0, 0, 127}));
  connect(gaiCooUnl.u1, dTRooHea.y)
    annotation(
      Line(
        points={{-30,-64}, {-36,-64}, {-36,-50}, {-38,-50}},
        color={0, 0, 127}));
  connect(dTSet.y, gaiCooUnl.u2)
    annotation(
      Line(
        points={{-38,-80}, {-34,-80}, {-34,-76}, {-30,-76}},
        color={0, 0, 127}));
  ...
  connect(gaiCoo.y, product1.u2)
    annotation(
      Line(
        points={{22,-70}, {28,-70}, {28,-50}, {-8,-50}, {-8,-40}, {6,-40}},
        color={0, 0, 127}));
  ...
  connect(maxCoo.u2, product1.y)
    annotation(
      Line(
        points={{38,-22}, {32,-22}, {32,-34}, {29,-34}},
        color={0, 0, 127}));
  ...
  connect(swiCoo.u1, maxCoo.y)
    annotation(
      Line(
        points={{70,-42}, {66,-42}, {66,-16}, {62,-16}},
        color={0, 0, 127}));
  connect(swiCoo.u2, yFan)
    annotation(
      Line(
        points={{70,-50}, {62,-50}, {62,-96}, {-80,-96}, {-80,-80}, {-120,-80}},
        color={255, 0, 255}));
  ...
  connect(zer.y, swiHot.u3)
    annotation(
      Line(
        points={{56,-58}, {64,-58}, {64, 32}, {72, 32}},
        color={0, 0, 127}));
  connect(yFan, swiHot.u2)
    annotation(
      Line(
        points={{-120,-80}, {-80,-80}, {-80,-96}, {62,-96}, {62, 40}, {72, 40}},
        color={255, 0, 255}));
  annotation(
    Icon(
      graphics={Text(
        ...
        extent={{46,-36}, {94,-60}},
        lineColor={0, 0, 127},
        textString="yCoo"), Text(
        extent={{-84, 52}, {-36, 28}},
        lineColor={0, 0, 127},
        textString="TSetH"), Text(
        extent={{-84, 10}, {-36,-14}},
        lineColor={0, 0, 127},
        textString="TSetC"), Text(
        extent={{-86,-64}, {-38,-88}},
        lineColor={0, 0, 127},
        textString="yFan")}),
    Documentation(
