...
model SupplyBranch
  ...
  parameter Modelica.SIunits.Volume VRoo
    "Room volume";
  Controls.RoomMixingBox con(
    m_flow_min=VRoo*3*1.2/3600)
  ...
  Modelica.Blocks.Math.Gain fraMasFlo(
    ...
    annotation(
      Placement(
        transformation(
          extent={{102, 134}, {122, 154}})));
  Modelica.Blocks.Math.Gain ACH(
    k=1/VRoo/1.2*3600)
    "Air change per hour"
    annotation(
      Placement(
        transformation(
          extent={{100, 94}, {120, 114}})));
  ...
  Buildings.Fluid.FixedResistances.Junction mix(
    redeclare package Medium=MediumA,
    m_flow_nominal={mAirCol_flow_nominal, mAirHot_flow_nominal, mAirCol_flow_nominal + mAirHot_flow_nominal},
    from_dp=from_dp,
    linearized=linearizeFlowResistance,
    dp_nominal=20*{0, 0, 0},
    ...
    annotation(
      Placement(
        transformation(
          ...
          rotation=180,
          origin={50, 40})));
  Buildings.Fluid.Sensors.RelativePressure senRelPreHot(
    redeclare package Medium=MediumA)
    ...
    annotation(
      Placement(
        transformation(
          ...
          rotation=90,
          origin={150, 0})));
  Buildings.Fluid.Sensors.RelativePressure senRelPreCol(
    redeclare package Medium=MediumA)
...
equation
  ...
  connect(vavHot.port_a, port_aHot)
    annotation(
      Line(
        points={{-1.12703e-16,-40}, {-1.12703e-16,-56.5}, {4.42409e-16,-56.5}, {4.42409e-16,-73}, {5.55112e-16,-73}, {5.55112e-16,-100}},
        color={0, 127, 255},
        smooth=Smooth.None));
