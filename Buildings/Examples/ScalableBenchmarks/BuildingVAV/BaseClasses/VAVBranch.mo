...
equation
  ...
  connect(con.yDam, vav.y)
    annotation(
      Line(
        points={{21, 4.8}, {32, 4.8}, {32, 104}, {38, 104}},
        color={0, 0, 127},
        smooth=Smooth.None,
        pattern=LinePattern.Dash));
  ...
  connect(ACH.u, senMasFlo.m_flow)
    annotation(
      Line(
        points={{98, 90}, {80, 90}, {80, 134}, {61, 134}},
        color={0, 0, 127},
        smooth=Smooth.None,
        pattern=LinePattern.Dash));
  ...
  connect(con.TRoo, TRoo)
    annotation(
      Line(
        points={{-1,-7}, {-60,-7}, {-60,-40}, {-120,-40}},
        color={0, 0, 127}));
  connect(con.TRooHeaSet, TRooHeaSet)
    annotation(
      Line(
        points={{-2, 7}, {-40, 7}, {-40, 80}, {-120, 80}},
        color={0, 0, 127}));
  connect(TRooCooSet, con.TRooCooSet)
    annotation(
      Line(
        points={{-120, 40}, {-44, 40}, {-44, 0}, {-2, 0}},
        color={0, 0, 127}));
