  ...
  for iZon in 1 : nZon loop
    for iFlo in 1 : nFlo loop
      ...
      connect(theZon[iZon, iFlo].heaCooPow, heaCooPow[iZon, iFlo])
        annotation(
          Line(
            points={{20.4, 16}, {40, 16}, {40, 60}, {110, 60}},
            color={0, 0, 127}));
      connect(theZon[iZon, iFlo].TRooAir, TRooAir[iZon, iFlo])
        annotation(
          Line(
            points={{20.4, 8}, {40, 8}, {40,-60}, {110,-60}},
            color={0, 0, 127}));
    end for;
  end for;
  annotation(
    Icon(
      graphics={Rectangle(
        ...
        points={{-14, 52}, {-34, 22}, {-152, 104}},
        pattern=LinePattern.None), Line(
        points={{-40, 38}, {40, 38}, {40, 24}},
        color={85, 170, 255}), Line(
        points={{-40, 38}, {-40, 24}},
        color={85, 170, 255}), Line(
        points={{0, 64}, {0, 38}},
        color={85, 170, 255}), Line(
        ...
        lineColor={0, 0, 255},
        textString="Multizone model with: %nZon zones in %nZon floors"), Text(
