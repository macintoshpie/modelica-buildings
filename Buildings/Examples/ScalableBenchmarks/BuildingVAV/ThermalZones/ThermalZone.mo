...
model ThermalZone
  ...
  final parameter Modelica.SIunits.Angle Z_=Buildings.Types.Tilt.Wall
    "Tilt for wall";
  final parameter HeatTransfer.Data.Solids.Plywood matFur(
    x=0.15,
    nStaRef=5)
...
equation
  ...
  connect(roo.surf_conBou[1], heaPorFlo)
    annotation(
      Line(
        points={{55.5,-13.375}, {55.5,-86}, {0,-86}, {0,-100}},
        color={191, 0, 0}));
  connect(roo.surf_conBou[2], heaPorWal1)
    annotation(
      Line(
        points={{55.5,-12.625}, {55.5,-16}, {-100,-16}},
        color={191, 0, 0}));
  connect(roo.surf_surBou[1], heaPorCei)
    annotation(
      Line(
        points={{48.15,-11.875}, {48.15,-20}, {0,-20}, {0, 100}},
        color={191, 0, 0}));
  connect(roo.surf_surBou[1], heaPorWal2)
    annotation(
      Line(
        points={{48.15,-11.875}, {48.15,-20}, {120,-20}, {120, 0}},
        color={191, 0, 0}));
  connect(uSha.y, roo.uSha[1])
    annotation(
      Line(
        points={{-7.6, 84}, {26, 84}, {26, 12.5}, {34.8, 12.5}},
        color={0, 0, 127}));
  ...
  connect(qLatGai_flow.y, product3.u1)
    annotation(
      Line(
        points={{-75.4, 46}, {-75.4, 46}, {-57, 46}},
        color={0, 0, 127}));
  connect(product3.y, gain2.u)
    annotation(
      Line(
        points={{-45.5, 43}, {-45.5, 43}, {-41, 43}},
        color={0, 0, 127}));
  connect(product2.y, gain1.u)
    annotation(
      Line(
        points={{-45.5, 68}, {-45.5, 68}, {-41, 68}},
        color={0, 0, 127}));
  connect(product1.y, gain.u)
    annotation(
      Line(
        points={{-45.5, 95}, {-45.5, 95}, {-41, 95}},
        color={0, 0, 127}));
  connect(gain1.y, multiplex3_1.u2[1])
    annotation(
      Line(
        points={{-29.5, 68}, {-26, 68}, {-16.8, 68}},
        color={0, 0, 127}));
  connect(qConGai_flow.y, product2.u1)
    annotation(
      Line(
        points={{-75.4, 72}, {-57, 72}, {-57, 71}},
        color={0, 0, 127}));
  connect(qRadGai_flow.y, product1.u1)
    annotation(
      Line(
        points={{-75.4, 98}, {-66, 98}, {-57, 98}},
        color={0, 0, 127}));
  connect(gain.y, multiplex3_1.u1[1])
    annotation(
      Line(
        points={{-29.5, 95}, {-22, 95}, {-22, 70.8}, {-16.8, 70.8}},
        color={0, 0, 127}));
  connect(gain2.y, multiplex3_1.u3[1])
    annotation(
      Line(
        points={{-29.5, 43}, {-22, 43}, {-22, 65.2}, {-16.8, 65.2}},
        color={0, 0, 127}));
  connect(intLoad.y[1], product1.u2)
    annotation(
      Line(
        points={{-75.3, 121}, {-68, 121}, {-68, 92}, {-57, 92}},
        color={0, 0, 127}));
  connect(product1.u2, product2.u2)
    annotation(
      Line(
        points={{-57, 92}, {-62, 92}, {-68, 92}, {-68, 65}, {-57, 65}},
        color={0, 0, 127}));
  connect(product1.u2, product3.u2)
    annotation(
      Line(
        points={{-57, 92}, {-68, 92}, {-68, 40}, {-57, 40}},
        color={0, 0, 127}));
  connect(souInf.ports[1], roo.ports[1])
    annotation(
      Line(
        points={{-8,-52}, {32,-52}, {32,-10.75}, {39.75,-10.75}},
        color={0, 127, 255}));
  ...
  connect(res.port_b, roo.ports[2])
    annotation(
      Line(
        points={{22,-28}, {22,-28}, {28,-28}, {28,-9.25}, {39.75,-9.25}},
        color={0, 127, 255}));
  ...
  connect(supAirTem.port_b, roo.ports[3])
    annotation(
      Line(
        points={{-12, 15}, {14, 15}, {14,-7.75}, {39.75,-7.75}},
        color={0, 127, 255}));
  connect(retAirTem.port_a, roo.ports[4])
    annotation(
      Line(
        points={{-12, 32}, {14, 32}, {14,-6.25}, {39.75,-6.25}},
        color={0, 127, 255}));
  connect(roo.heaPorAir, rooAirTem.port)
    annotation(
      Line(
        points={{50.25,-1}, {50.25, 36}, {66, 36}},
        color={191, 0, 0}));
  annotation(
    Icon(
      coordinateSystem(
      ...
      graphics={Rectangle(
        ...
        extent={{-8,-74}, {12,-88}},
        lineColor={0, 0, 255},
        textString="Floor"), Text(
        extent={{-10, 88}, {10, 74}},
        lineColor={0, 0, 255},
        textString="Ceiling"), Rectangle(
        extent={{-42, 42}, {42,-42}},
