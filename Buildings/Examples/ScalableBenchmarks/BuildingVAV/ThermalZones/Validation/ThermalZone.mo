...
model ThermalZone
  ...
  package MediumA=Buildings.Media.Air
    "Medium model";
  Buildings.Examples.ScalableBenchmarks.BuildingVAV.ThermalZones.ThermalZone thermalZone(redeclare package MediumA=MediumA, lat=41.98*3.14159/180, gainFactor=1)
    "Thermal zone model"
...
equation
  connect(weaDat.weaBus, thermalZone.weaBus)
    annotation(Line(points={{-60,-30}, {-38,-30}, {-14.8,-30}, {-14.8,-16}}, color={255, 204, 51}, thickness=0.5));
  annotation(experiment(StopTime=604800, Tolerance=1e-06), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Examples/ScalableBenchmarks/BuildingVAV/ThermalZones/Validation/ThermalZone.mos"
