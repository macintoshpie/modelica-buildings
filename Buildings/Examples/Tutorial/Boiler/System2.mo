...
model System2
  ...
  //------------------------------------------------------------------------//
  Buildings.Fluid.Sources.Boundary_pT sou(nPorts=1, redeclare package Medium=MediumW, T=TRadSup_nominal)
    "Sink for mass flow rate"
...
equation
  ...
  connect(rad.port_b, sin.ports[1])
    annotation(Line(points={{20,-10}, {50,-10}, {50,-40}}, color={0, 127, 255}, smooth=Smooth.None));
...
</html>"), Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-240,-160}, {100, 100}})), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Examples/Tutorial/Boiler/System2.mos"
