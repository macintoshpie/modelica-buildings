...
equation
  ...
  connect(const.y, valRad.y)
    annotation(Line(points={{-98,-150}, {-62,-150}}, color={0, 0, 127}, smooth=Smooth.None));
  connect(conBoi.y, pumBoi.m_flow_in)
    annotation(Line(points={{-78,-280}, {-70.5,-280}, {-70.5,-280}, {-62,-280}}, color={0, 0, 127}, smooth=Smooth.None));
  connect(const.y, valBoi.y)
    annotation(Line(points={{-98,-150}, {-80,-150}, {-80,-220}, {80,-220}, {80,-250}, {72,-250}}, color={0, 0, 127}, smooth=Smooth.None));
  connect(const1.y, boi.y)
    annotation(Line(points={{22,-280}, {32,-280}, {32,-302}, {22,-302}}, color={0, 0, 127}, smooth=Smooth.None));
  connect(temRoo.T, hysPum.u)
    annotation(Line(points={{-50, 30}, {-234, 30}, {-234,-70}, {-222,-70}}, color={0, 0, 127}, smooth=Smooth.None));
  connect(hysPum.y, not1.u)
    annotation(Line(points={{-198,-70}, {-182,-70}}, color={255, 0, 255}, smooth=Smooth.None));
  connect(not1.y, booToReaRad.u)
    annotation(Line(points={{-158,-70}, {-142,-70}}, color={255, 0, 255}, smooth=Smooth.None));
  connect(booToReaRad.y, pumRad.m_flow_in)
    annotation(Line(points={{-118,-70}, {-90.5,-70}, {-90.5,-70}, {-62,-70}}, color={0, 0, 127}, smooth=Smooth.None));
...
</html>"), Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-240,-360}, {100, 100}})), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Examples/Tutorial/Boiler/System3.mos"
