...
model System6
  ...
  //--------------------------------------------------------------------------------//
  Buildings.Controls.OBC.CDL.Continuous.Hysteresis hysTBoi(
    uHigh=273.15 + 90,
    uLow=273.15 + 70)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-260,-348}, {-240,-328}})));
  Buildings.Controls.OBC.CDL.Logical.Not not3
    annotation(
      Placement(
        transformation(
          extent={{-220,-348}, {-200,-328}})));
  ...
  Buildings.Controls.OBC.CDL.Conversions.BooleanToReal booToReaRad1(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-140,-180}, {-120,-160}})));
  //--------------------------------------------------------------------------------//
  Buildings.Controls.OBC.CDL.Logical.And and2
    annotation(
      Placement(
        transformation(
          extent={{-140,-340}, {-120,-320}})));
...
equation
  ...
  connect(TSetBoiRet.y, conPIDBoi.u_s)
    annotation(
      Line(
        points={{142,-260}, {142,-260}, {158,-260}},
        color={0, 0, 127}));
  connect(temRet.T, conPIDBoi.u_m)
    annotation(
      Line(
        points={{71,-280}, {114,-280}, {170,-280}, {170,-272}},
        color={0, 0, 127}));
  connect(TSetSup.x1, TRooMin.y)
    annotation(
      Line(
        points={{-222,-72}, {-230,-72}, {-230,-10}, {-238,-10}},
        color={0, 0, 127}));
  connect(TSupMax.y, TSetSup.f1)
    annotation(
      Line(
        points={{-238,-50}, {-234,-50}, {-234,-76}, {-222,-76}},
        color={0, 0, 127}));
  connect(TSupMin.y, TSetSup.f2)
    annotation(
      Line(
        points={{-238,-110}, {-230,-110}, {-230,-88}, {-222,-88}},
        color={0, 0, 127}));
  connect(TSupMin.y, TSetSup.x2)
    annotation(
      Line(
        points={{-238,-110}, {-230,-110}, {-230,-84}, {-222,-84}},
        color={0, 0, 127}));
  connect(TSetSup.u, temRoo.T)
    annotation(
      Line(
        points={{-222,-80}, {-270,-80}, {-270, 30}, {-50, 30}},
        color={0, 0, 127}));
  connect(conPIDRad.u_s, TSetSup.y)
    annotation(
      Line(
        points={{-182,-10}, {-190,-10}, {-190,-80}, {-198,-80}},
        color={0, 0, 127}));
  annotation(
    Documentation(
      info="<html>
...
First implementation.
    ...
    Diagram(
      coordinateSystem(
        ...
        extent={{-400,-360}, {240, 100}})),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Examples/Tutorial/Boiler/System6.mos"
        "Simulate and plot"),
    experiment(
      Tolerance=1e-6,
      StopTime=172800));
