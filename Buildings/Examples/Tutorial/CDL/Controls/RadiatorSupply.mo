...
equation
  connect(TMinSup.y, TSetSup.x2)
    annotation(
      Line(
        points={{-28,-30}, {-20,-30}, {-20,-4}, {-12,-4}},
        color={0, 0, 127}));
  connect(TMinSup.y, TSetSup.f2)
    annotation(
      Line(
        points={{-28,-30}, {-20,-30}, {-20,-8}, {-12,-8}},
        color={0, 0, 127}));
  connect(TMaxSup.y, TSetSup.f1)
    annotation(
      Line(
        points={{-28, 30}, {-24, 30}, {-24, 4}, {-12, 4}},
        color={0, 0, 127}));
  connect(TSetSup.x1, TMinRoo.y)
    annotation(
      Line(
        points={{-12, 8}, {-20, 8}, {-20, 70}, {-28, 70}},
        color={0, 0, 127}));
  ...
  connect(TSetSup.u, TRoo)
    annotation(
      Line(
        points={{-12, 0}, {-70, 0}, {-70, 60}, {-120, 60}},
        color={0, 0, 127}));
  connect(TSup, conPIDRad.u_m)
    annotation(
      Line(
        points={{-120,-60}, {50,-60}, {50,-12}},
        color={0, 0, 127}));
  connect(conPIDRad.y, yVal)
    annotation(
      Line(
        points={{62, 0}, {120, 0}, {120, 0}},
        color={0, 0, 127}));
  annotation(
