...
block SystemOnOff
  ...
  parameter Real TRooSet(final unit="K", displayUnit="degC")=293.65
    "Room air temperature set point";
  parameter Real dTRoo(min=0.5, final unit="K")=1
    "Room air temperature dead band";
  parameter Real TOutLow(final unit="K", displayUnit="degC")=289.15
    "Outdoor temperature below which system is allowed to switch on";
  Buildings.Controls.OBC.CDL.Interfaces.RealInput TOut(final unit="K", displayUnit="degC")
...
equation
  ...
  connect(TSetOut.y, onTOut.reference)
    annotation(Line(points={{-58, 80}, {-50, 80}, {-50, 72}, {-42, 72}}, color={0, 0, 127}));
  connect(onTRoo.u, TRoo)
    annotation(Line(points={{-42,-60}, {-120,-60}}, color={0, 0, 127}));
  connect(TSetRoo.y, onTRoo.reference)
    annotation(Line(points={{-58,-30}, {-50,-30}, {-50,-48}, {-42,-48}}, color={0, 0, 127}));
  connect(and1.u2, onTRoo.y)
    annotation(Line(points={{58,-8}, {-10,-8}, {-10,-54}, {-18,-54}}, color={255, 0, 255}));
  connect(and1.y, onSys)
    annotation(Line(points={{82, 0}, {120, 0}}, color={255, 0, 255}));
  connect(onTOut.y, and1.u1)
    annotation(Line(points={{-18, 66}, {-10, 66}, {-10, 0}, {58, 0}}, color={255, 0, 255}));
  annotation(defaultComponentName="conSysSta", Icon(coordinateSystem(preserveAspectRatio=false), graphics={Rectangle(extent={{-100, 100}, {100,-100}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Text(extent={{-90, 82}, {-42, 42}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.None, textString="TOut"), Text(extent={{40, 24}, {88,-16}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.None, textString="onSys"), Text(extent={{-92,-40}, {-44,-80}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.None, textString="TRoo"), Text(lineColor={0, 0, 255}, extent={{-152, 104}, {148, 144}}, textString="%name")}), Diagram(coordinateSystem(preserveAspectRatio=false)), Documentation(info="<html>
<p>
