...
block SystemOnOff
  ...
  Buildings.Controls.OBC.CDL.Logical.OnOffController onTOut(
    bandwidth=1)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-40, 56}, {-20, 76}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant TSetOut(
    k=TOutLow + 0.5)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-80, 70}, {-60, 90}})));
  Buildings.Controls.OBC.CDL.Logical.OnOffController onTRoo(
    bandwidth=1)
...
equation
  ...
  connect(TSetOut.y, onTOut.reference)
    annotation(
      Line(
        points={{-58, 80}, {-50, 80}, {-50, 72}, {-42, 72}},
        color={0, 0, 127}));
  ...
  connect(TSetRoo.y, onTRoo.reference)
    annotation(
      Line(
        points={{-58,-30}, {-50,-30}, {-50,-48}, {-42,-48}},
        color={0, 0, 127}));
  connect(and1.u2, onTRoo.y)
    annotation(
      Line(
        points={{58,-8}, {-10,-8}, {-10,-54}, {-18,-54}},
        color={255, 0, 255}));
