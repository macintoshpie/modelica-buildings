...
model BoilerReturn
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Ramp TRet(height=50, duration=3600, offset=293.15)
...
</html>"), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Examples/Tutorial/CDL/Controls/Validation/BoilerReturn.mos"
