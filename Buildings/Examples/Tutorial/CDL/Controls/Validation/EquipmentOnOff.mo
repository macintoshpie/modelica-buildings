...
equation
  connect(TBoi.y, conEquSta.TBoi)
    annotation(
      Line(
        points={{-38, 30}, {-24, 30}, {-24, 6}, {-10, 6}},
        color={0, 0, 127}));
  connect(onSys.y, conEquSta.onSys)
    annotation(
      Line(
        points={{-38,-10}, {-24,-10}, {-24,-6}, {-10,-6}},
        color={255, 0, 255}));
  annotation(
    Documentation(
      info="<html>
...
First implementation.
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Examples/Tutorial/CDL/Controls/Validation/EquipmentOnOff.mos"
        "Simulate and plot"),
    experiment(
      StopTime=3600,
      Tolerance=1e-06));
