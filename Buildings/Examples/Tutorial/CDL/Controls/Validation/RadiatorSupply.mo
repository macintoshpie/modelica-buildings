...
equation
  connect(TRoo.y, conRadSup.TRoo)
    annotation(
      Line(
        points={{-38, 30}, {-20, 30}, {-20, 6}, {8, 6}},
        color={0, 0, 127}));
  connect(conRadSup.TSup, TSup.y)
    annotation(
      Line(
        points={{8,-6}, {-16,-6}, {-16,-30}, {-38,-30}},
        color={0, 0, 127}));
  annotation(
    Documentation(
      info="<html>
...
First implementation.
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Examples/Tutorial/CDL/Controls/Validation/RadiatorSupply.mos"
        "Simulate and plot"),
    experiment(
      StopTime=3600,
      Tolerance=1e-06));
