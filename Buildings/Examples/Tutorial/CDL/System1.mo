...
equation
  ...
  connect(y3.y, boi.y)
    annotation(Line(points={{-98,-250}, {32,-250}, {32,-302}, {22,-302}}, color={0, 0, 127}));
  connect(y2.y, valBoi.y)
    annotation(Line(points={{122,-200}, {130,-200}, {130,-230}, {72,-230}}, color={0, 0, 127}));
  connect(y4.y, valRad.y)
    annotation(Line(points={{-98,-150}, {-62,-150}}, color={0, 0, 127}));
  connect(y5.y, pumBoi.m_flow_in)
    annotation(Line(points={{-98,-280}, {-80,-280}, {-80,-280}, {-62,-280}}, color={0, 0, 127}));
...
</html>"), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Examples/Tutorial/CDL/System1.mos"
