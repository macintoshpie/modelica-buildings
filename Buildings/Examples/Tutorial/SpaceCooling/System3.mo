...
model System3
  ...
  Buildings.Fluid.HeatExchangers.WetCoilCounterFlow cooCoi(
    ...
    m2_flow_nominal=mA_flow_nominal,
    dp1_nominal=6000,
    UA_nominal=-QCoiC_flow_nominal/Buildings.Fluid.HeatExchangers.BaseClasses.lmtd(
      T_a1=THeaRecLvg,
      T_b1=TASup_nominal,
      T_a2=TWSup_nominal,
      T_b2=TWRet_nominal),
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant mAir_flow(
    k=mA_flow_nominal)
    "Fan air flow rate"
    annotation(
      Placement(
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort senTemSupAir(
    ...
    annotation(
      Placement(
        transformation(
          extent={{6,-26}, {18,-14}})));
  Buildings.Controls.OBC.CDL.Logical.OnOffController con(
    bandwidth=1)
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant TRooSetPoi(
    k=TRooSet)
  ...
  Modelica.Thermal.HeatTransfer.Sensors.TemperatureSensor senTemRoo
    ...
    annotation(
      Placement(
        transformation(
          extent={{70, 70}, {90, 90}})));
  Buildings.Controls.OBC.CDL.Conversions.BooleanToReal mWat_flow(
    realTrue=0,
...
First implementation.
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Examples/Tutorial/SpaceCooling/System3.mos"
        "Simulate and plot"),
    experiment(
      StartTime=15552000,
      Tolerance=1e-6,
