    ...
    annotation(
      Placement(
        transformation(
          extent={{20,-10}, {40, 10}})));
protected
  Modelica.Blocks.Sources.Constant xSetNor(
    k=1)
...
equation
  connect(con.y, y)
    annotation(
      Line(
        points={{41, 6.10623e-16}, {72, 6.10623e-16}, {72, 5.55112e-16}, {110, 5.55112e-16}},
        color={0, 0, 127},
        smooth=Smooth.None));
  connect(xSetNor.y, con.u_s)
    annotation(
      Line(
        points={{1, 6.10623e-16}, {8.5, 6.10623e-16}, {8.5, 6.66134e-16}, {18, 6.66134e-16}},
        color={0, 0, 127},
        smooth=Smooth.None));
