...
model RoomVAV
  ...
  Modelica.Blocks.Math.Gain peoDen(
    k=2.5/VRoo)
...
equation
  ...
  connect(portRoo1, vol.ports[1])
    annotation(
      Line(
        points={{-160, 5.55112e-16}, {-120.833, 5.55112e-16}, {-120.833, 4.87687e-22}, {-81.6667, 4.87687e-22}, {-81.6667,-5.55112e-16}, {-3.2,-5.55112e-16}},
        color={0, 127, 255},
        smooth=Smooth.None));
  connect(vav.port_b, vol.ports[2])
    annotation(
      Line(
        points={{-1.77636e-15, 70}, {0, 70}, {0, 40}, {-22, 40}, {-22,-5.55112e-16}, {-1.6,-5.55112e-16}},
        color={0, 127, 255},
        smooth=Smooth.None));
  ...
  connect(portRoo2, vol.ports[4])
    annotation(
      Line(
        points={{160, 5.55112e-16}, {120.167, 5.55112e-16}, {120.167, 4.87687e-22}, {80.3333, 4.87687e-22}, {80.3333,-5.55112e-16}, {1.6,-5.55112e-16}},
        color={0, 127, 255},
        smooth=Smooth.None));
  ...
  connect(vol.C_flow[1], gaiCO2.y)
    annotation(
      Line(
        points={{-12, 4}, {-100, 4}, {-100,-60}, {-119,-60}},
        color={0, 0, 127}));
  connect(dpPle.port_b, ple.ports[1])
    annotation(
      Line(
        points={{0,-40}, {0,-62}, {0,-62}},
        color={0, 127, 255}));
  connect(ple.ports[2], portRet)
    annotation(
      Line(
        points={{0,-58}, {0,-160}, {0,-160}},
        color={0, 127, 255}));
  annotation(
    Diagram(
      coordinateSystem(
