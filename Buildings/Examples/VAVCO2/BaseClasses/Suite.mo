  ...
  annotation(
    ...
    Icon(
      ...
      graphics={Rectangle(
        ...
        fillPattern=FillPattern.Solid,
        pattern=LinePattern.None), Rectangle(
        extent={{102, 118}, {106,-38}},
        fillColor={0, 127, 255},
        fillPattern=FillPattern.Solid,
        pattern=LinePattern.None), Rectangle(
        extent={{160, 118}, {164, 20}},
        fillColor={0, 127, 255},
        fillPattern=FillPattern.Solid,
        pattern=LinePattern.None), Rectangle(
        extent={{220, 120}, {224, 22}},
        fillColor={0, 127, 255},
        fillPattern=FillPattern.Solid,
        pattern=LinePattern.None), Rectangle(
        extent={{220,-20}, {224,-38}},
        fillColor={0, 127, 255},
        fillPattern=FillPattern.Solid,
        pattern=LinePattern.None), Rectangle(
        extent={{160,-8}, {164,-38}},
        ...
        fillColor={0, 0, 0},
        fillPattern=FillPattern.Solid), Rectangle(
        extent={{274, 80}, {290, 60}},
        lineColor={0, 0, 0},
        fillColor={0, 0, 0},
        fillPattern=FillPattern.Solid), Rectangle(
        extent={{214, 80}, {230, 60}},
        lineColor={0, 0, 0},
        fillColor={0, 0, 0},
        fillPattern=FillPattern.Solid), Rectangle(
        extent={{-34, 34}, {0, 8}},
