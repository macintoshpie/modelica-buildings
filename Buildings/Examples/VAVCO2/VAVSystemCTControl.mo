...
model VAVSystemCTControl
  ...
  Modelica.Blocks.Sources.BooleanPulse onSig(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-90, 60}, {-70, 80}})));
  Modelica.Blocks.Math.Gain dp32(
    k=150)
    "Gain for fan"
    annotation(
      Placement(
  ...
  Modelica.Blocks.Math.Gain dp56(
    k=60)
    "Gain for fan"
    annotation(
      Placement(
  ...
  Modelica.Blocks.Sources.Constant off(
    k=0)
    "Off signal"
    annotation(
      Placement(
  ...
  Controls.OBC.CDL.Conversions.BooleanToReal booToRea(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-50, 60}, {-30, 80}})));
  Controls.OBC.CDL.Continuous.SlewRateLimiter ramLim(
    raisingSlewRate=1/120)
    "Ramp limiter for fan control signal"
    annotation(
      Placement(
        transformation(
          extent={{50, 100}, {70, 120}})));
equation
  ...
  connect(dp32.y, fan32.dp_in)
    annotation(
      Line(
        points={{111, 110}, {138, 110}, {138,-0.4}},
        color={0, 0, 127}));
  connect(dp56.y, fan56.dp_in)
    annotation(
      Line(
        points={{111, 80}, {120, 80}, {120,-40}, {140,-40}, {140,-60.4}},
        color={0, 0, 127}));
  connect(switch1.u1, conSupFan.y)
    annotation(
      Line(
        points={{18, 118}, {12, 118}, {12, 70}, {1, 70}},
        color={0, 0, 127}));
  connect(off.y, switch1.u3)
    annotation(
      Line(
        points={{-69, 102}, {18, 102}},
        color={0, 0, 127}));
  ...
  connect(onSig.y, switch1.u2)
    annotation(
      Line(
        points={{-69, 70}, {-60, 70}, {-60, 110}, {18, 110}},
        color={255, 0, 255}));
  ...
  connect(dp32.u, ramLim.y)
    annotation(
      Line(
        points={{88, 110}, {72, 110}},
        color={0, 0, 127}));
  connect(dp56.u, ramLim.y)
    annotation(
      Line(
        points={{88, 80}, {80, 80}, {80, 110}, {72, 110}},
        color={0, 0, 127}));
  annotation(
    Diagram(
      coordinateSystem(
        preserveAspectRatio=false,
        extent={{-100,-100}, {350, 150}})),
    Documentation(
      info="<html>
<p>
...
for <a href=\"https://github.com/ibpsa/modelica-ibpsa/issues/404\">#404</a>.
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Examples/VAVCO2/VAVSystemCTControl.mos"
        "Simulate and plot",
