...
block Economizer
  ...
  parameter Modelica.SIunits.VolumeFlowRate VOut_flow_min(
    min=0)
  ...
  Modelica.Blocks.Sources.Constant closed(
    k=0)
  ...
  Modelica.Blocks.Math.Min min
    ...
    annotation(
      Placement(
        transformation(
          extent={{20,-20}, {40, 0}})));
  Modelica.Blocks.Sources.Constant TFre(
    k=TFreSet)
  ...
  Modelica.Blocks.Interfaces.RealOutput yRet
    ...
    annotation(
      Placement(
        ...
        iconTransformation(
          extent={{200,-10}, {220, 10}})));
  Buildings.Controls.OBC.CDL.Continuous.AddParameter invSig(
    p=1,
    k=-1)
...
equation
  ...
  connect(yOATFre.u_s, TMix)
    annotation(
      Line(
        points={{18, 130}, {-32, 130}, {-80, 130}, {-80, 100}, {-120, 100}},
        color={0, 0, 127}));
  connect(TFre.y, yOATFre.u_m)
    annotation(
      Line(
        points={{1, 110}, {14, 110}, {30, 110}, {30, 118}},
        color={0, 0, 127}));
  connect(yOATFre.y, min.u1)
    annotation(
      Line(
        points={{41, 130}, {48, 130}, {48, 20}, {10, 20}, {10,-4}, {18,-4}},
        color={0, 0, 127}));
  ...
  connect(extractor.y, yOA)
    annotation(
      Line(
        points={{141, 0}, {160, 0}, {160, 80}, {210, 80}},
        color={0, 0, 127}));
  annotation(
    Diagram(
      coordinateSystem(
    ...
    Icon(
      ...
      graphics={Rectangle(
        ...
        extent={{-90,-2}, {-28,-40}},
        lineColor={0, 0, 255},
        textString="TSupHeaSet"), Text(
        extent={{-86,-58}, {-24,-96}},
        lineColor={0, 0, 255},
        textString="TSupCooSet"), Text(
