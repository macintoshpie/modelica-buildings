...
model CoolingIndirectClosedBuildingLoop
  ...
  Buildings.Experimental.DHC.EnergyTransferStations.Cooling.CoolingIndirect coo(
    redeclare package Medium=Medium,
  ...
  Modelica.Blocks.Math.Add dTBui(
    k1=-1)
...
equation
  ...
  connect(exp.port_a,pumBui.port_a)
    annotation (Line(points={{30,0},{30,14},{-20,14},{-20,0}},color={0,127,255}));
  connect(pro.u1,QCoo.y[1])
    annotation (Line(points={{-62,-44},{-80,-44},{-80,-20},{-99,-20}},color={0,0,127}));
  connect(pro.u2,ram.y)
    annotation (Line(points={{-62,-56},{-99,-56}},color={0,0,127}));
  connect(pro.y,loa.u)
    annotation (Line(points={{-39,-50},{30,-50},{30,-70},{38,-70}},color={0,0,127}));
  connect(gai.u,QCoo.y[1])
    annotation (Line(points={{-62,-10},{-80,-10},{-80,-20},{-99,-20}},color={0,0,127}));
  ...
  connect(TBuiRet.port_b,coo.port_a2)
    annotation (Line(points={{90,-76},{100,-76},{100,14},{60,14}},color={0,127,255}));
  connect(pumBui.port_b,TBuiSup.port_a)
    annotation (Line(points={{-20,-20},{-20,-76},{-10,-76}},color={0,127,255}));
  connect(TBuiSup.port_b,loa.port_a)
    annotation (Line(points={{10,-76},{40,-76}},color={0,127,255}));
  connect(coo.port_b1,TDisRet.port_a)
    annotation (Line(points={{60,26},{66,26},{66,70},{70,70}},color={0,127,255}));
  ...
  connect(TDisSup.port_b,coo.port_a1)
    annotation (Line(points={{30,70},{34,70},{34,26},{40,26}},color={0,127,255}));
  ...
  annotation (
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/DHC/EnergyTransferStations/Cooling/Examples/CoolingIndirectClosedBuildingLoop.mos" "Simulate and plot"),
    experiment(
      StartTime=0,
      StopTime=86400,
      Tolerance=1e-06),
