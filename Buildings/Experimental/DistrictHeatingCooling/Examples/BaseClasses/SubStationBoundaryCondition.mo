...
model SubStationBoundaryCondition
  ...
  Modelica.Blocks.Interfaces.RealInput TOut(final unit="K", displayUnit="degC")
    "Outside temperature, used to set medium temperature"
  ...
  Buildings.Fluid.Sources.Boundary_pT bou(redeclare package Medium=Medium, nPorts=1, use_T_in=true)
    "Boundary condition"
  ...
  Modelica.Blocks.Sources.Constant TAppr(k=dTApp)
    "Approach temperature"
...
equation
  ...
  connect(add.y, bou.T_in)
    annotation(Line(points={{-29, 6}, {-22, 6}, {-22, 4}, {-12, 4}}, color={0, 0, 127}));
  connect(TAppr.y, add.u1)
    annotation(Line(points={{-59, 50}, {-56, 50}, {-56, 12}, {-52, 12}}, color={0, 0, 127}));
  connect(add.y, preTem.T)
    annotation(Line(points={{-29, 6}, {-22, 6}, {-22,-60}, {-12,-60}}, color={0, 0, 127}));
  annotation(Icon(graphics={Ellipse(extent={{-70, 70}, {64,-64}}, lineColor={0, 0, 0}, fillPattern=FillPattern.Sphere, fillColor={0, 127, 255}), Ellipse(extent={{-70, 70}, {64,-64}}, lineColor={0, 0, 0}, visible=warmSide, fillPattern=FillPattern.Sphere, fillColor={255, 0, 0})}), Documentation(info="<html>
<p>
