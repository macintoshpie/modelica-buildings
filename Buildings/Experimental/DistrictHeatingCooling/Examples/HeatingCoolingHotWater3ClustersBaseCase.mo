...
model HeatingCoolingHotWater3ClustersBaseCase
  ...
  extends Buildings.Experimental.DistrictHeatingCooling.Examples.BaseClasses.HeatingCoolingHotWater3Clusters(
    larOff1(
      mixingVolumeEnergyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState),
    ret1(
      mixingVolumeEnergyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState),
    larOff2(
      mixingVolumeEnergyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState),
...
equation
  ...
  connect(weaBus.TDryBul, bou_a7.TOut)
    annotation(
      Line(
        points={{-340, 190}, {-98, 190}, {120, 190}, {120,-44}, {180,-44}, {180,-140}, {188,-140}},
        color={255, 204, 51},
        thickness=0.5));
  ...
  annotation(
    experiment(
      ...
      StopTime=31536000),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/DistrictHeatingCooling/Examples/HeatingCoolingHotWater3ClustersBaseCase.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
