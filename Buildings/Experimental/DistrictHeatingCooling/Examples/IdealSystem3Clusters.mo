...
model IdealSystem3Clusters
  ...
  SubStations.Heating hea6(
    ...
    annotation(
      Placement(
        transformation(
          extent={{160,-210}, {180,-190}})));
  SubStations.Heating hea7(
    redeclare package Medium=Medium,
    Q_flow_nominal=300E3)
    "Heating load"
    annotation(
      Placement(
        transformation(
          extent={{220,-210}, {240,-190}})));
  SubStations.Cooling coo5(
    redeclare package Medium=Medium,
    Q_flow_nominal=-150E3)
    "Cooling load"
    annotation(
      Placement(
        transformation(
          extent={{280,-210}, {300,-190}})));
...
protected
  Modelica.Blocks.Sources.Constant TSetH(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-320, 100}, {-300, 120}})));
equation
  connect(pla.port_b, pip.port_a)
    annotation(
      Line(
        points={{-240, 60}, {-232, 60}, {-228, 60}},
        color={0, 127, 255}));
  connect(pip.port_b, hea1.port_a)
    annotation(
      Line(
        points={{-208, 60}, {-60, 60}, {-60, 30}, {-180, 30}, {-180, 0}, {-160, 0}},
        color={0, 127, 255}));
  connect(pip.port_b, hea2.port_a)
    annotation(
      Line(
        points={{-208, 60}, {-60, 60}, {-60, 30}, {-120, 30}, {-120, 0}, {-100, 0}},
        color={0, 127, 255}));
  connect(pip.port_b, coo1.port_b)
    annotation(
      Line(
        points={{-208, 60}, {-60, 60}, {-60, 30}, {-12, 30}, {-12, 0}, {-20, 0}},
        color={0, 127, 255}));
  connect(pip.port_b, coo2.port_b)
    annotation(
      Line(
        points={{-208, 60}, {-208, 60}, {-60, 60}, {-60, 30}, {44, 30}, {44, 0}, {40, 0}},
        color={0, 127, 255}));
  connect(pla.port_a, pip1.port_b)
    annotation(
      Line(
        points={{-260, 60}, {-280, 60}, {-280,-40}, {-230,-40}},
        color={0, 127, 255}));
  connect(pip1.port_a, hea1.port_b)
    annotation(
      Line(
        points={{-210,-40}, {-210,-40}, {-60,-40}, {-60,-20}, {-128,-20}, {-128, 0}, {-140, 0}},
        color={0, 127, 255}));
  connect(pip1.port_a, hea2.port_b)
    annotation(
      Line(
        points={{-210,-40}, {-210,-40}, {-60,-40}, {-60,-20}, {-70,-20}, {-70, 0}, {-80, 0}},
        color={0, 127, 255}));
  connect(pip1.port_a, coo1.port_a)
    annotation(
      Line(
        points={{-210,-40}, {-60,-40}, {-60,-20}, {-50,-20}, {-50, 0}, {-40, 0}},
        color={0, 127, 255}));
  connect(pip1.port_a, coo2.port_a)
    annotation(
      Line(
        points={{-210,-40}, {-210,-40}, {-60,-40}, {-60,-20}, {6,-20}, {6, 0}, {20, 0}},
        color={0, 127, 255}));
  connect(QHea1.y[1], hea1.Q_flow)
    annotation(
      Line(
        points={{-179, 90}, {-172, 90}, {-172, 6}, {-162, 6}},
        color={0, 0, 127}));
  connect(QHea2.y[1], hea2.Q_flow)
    annotation(
      Line(
        points={{-119, 90}, {-110, 90}, {-110, 6}, {-102, 6}},
        color={0, 0, 127}));
  connect(QCoo1.y[1], coo1.Q_flow)
    annotation(
      Line(
        points={{-59, 90}, {-50, 90}, {-50, 6}, {-42, 6}},
        color={0, 0, 127}));
  connect(QCoo2.y[1], coo2.Q_flow)
    annotation(
      Line(
        points={{1, 90}, {10, 90}, {10, 6}, {18, 6}},
        color={0, 0, 127}));
  connect(pSet.ports[1], pip1.port_b)
    annotation(
      Line(
        points={{-280,-60}, {-280,-40}, {-230,-40}},
        color={0, 127, 255}));
  connect(pip2.port_b, hea3.port_a)
    annotation(
      Line(
        points={{100, 60}, {260, 60}, {260, 30}, {140, 30}, {140, 0}, {160, 0}},
        color={0, 127, 255}));
  connect(pip2.port_b, hea4.port_a)
    annotation(
      Line(
        points={{100, 60}, {260, 60}, {260, 30}, {200, 30}, {200, 0}, {220, 0}},
        color={0, 127, 255}));
  connect(pip2.port_b, coo3.port_b)
    annotation(
      Line(
        points={{100, 60}, {260, 60}, {260, 30}, {308, 30}, {308, 0}, {300, 0}},
        color={0, 127, 255}));
  connect(pip2.port_b, coo4.port_b)
    annotation(
      Line(
        points={{100, 60}, {100, 60}, {260, 60}, {260, 30}, {364, 30}, {364, 0}, {360, 0}},
        color={0, 127, 255}));
  connect(pip3.port_a, hea3.port_b)
    annotation(
      Line(
        points={{100,-40}, {100,-40}, {260,-40}, {260,-20}, {192,-20}, {192, 0}, {180, 0}},
        color={0, 127, 255}));
  connect(pip3.port_a, hea4.port_b)
    annotation(
      Line(
        points={{100,-40}, {100,-40}, {260,-40}, {260,-20}, {250,-20}, {250, 0}, {240, 0}},
        color={0, 127, 255}));
  connect(pip3.port_a, coo3.port_a)
    annotation(
      Line(
        points={{100,-40}, {260,-40}, {260,-20}, {270,-20}, {270, 0}, {280, 0}},
        color={0, 127, 255}));
  connect(pip3.port_a, coo4.port_a)
    annotation(
      Line(
        points={{100,-40}, {100,-40}, {260,-40}, {260,-20}, {326,-20}, {326, 0}, {340, 0}},
        color={0, 127, 255}));
  connect(QHea3.y[1], hea3.Q_flow)
    annotation(
      Line(
        points={{141, 90}, {148, 90}, {148, 6}, {158, 6}},
        color={0, 0, 127}));
  connect(QHea4.y[1], hea4.Q_flow)
    annotation(
      Line(
        points={{201, 90}, {210, 90}, {210, 6}, {218, 6}},
        color={0, 0, 127}));
  connect(QCoo3.y[1], coo3.Q_flow)
    annotation(
      Line(
        points={{261, 90}, {270, 90}, {270, 6}, {278, 6}},
        color={0, 0, 127}));
  connect(QCoo4.y[1], coo4.Q_flow)
    annotation(
      Line(
        points={{321, 90}, {330, 90}, {330, 6}, {338, 6}},
        color={0, 0, 127}));
  ...
  connect(pip3.port_b, pip1.port_a)
    annotation(
      Line(
        points={{80,-40}, {80,-40}, {-210,-40}},
        color={0, 127, 255}));
  connect(pip3.port_a, hea5.port_b)
    annotation(
      Line(
        points={{100,-40}, {100,-40}, {260,-40}, {260,-20}, {430,-20}, {430, 0}, {420, 0}},
        color={0, 127, 255}));
  connect(pip2.port_b, hea5.port_a)
    annotation(
      Line(
        points={{100, 60}, {260, 60}, {260, 30}, {380, 30}, {380, 0}, {400, 0}},
        color={0, 127, 255}));
  connect(QHea5.y[1], hea5.Q_flow)
    annotation(
      Line(
        points={{381, 90}, {390, 90}, {390, 6}, {398, 6}},
        color={0, 0, 127}));
  connect(pip4.port_b, hea6.port_a)
    annotation(
      Line(
        points={{100,-140}, {260,-140}, {260,-170}, {140,-170}, {140,-200}, {160,-200}},
        color={0, 127, 255}));
  connect(pip4.port_b, hea7.port_a)
    annotation(
      Line(
        points={{100,-140}, {260,-140}, {260,-170}, {200,-170}, {200,-200}, {220,-200}},
        color={0, 127, 255}));
  connect(pip4.port_b, coo5.port_b)
    annotation(
      Line(
        points={{100,-140}, {260,-140}, {260,-170}, {308,-170}, {308,-200}, {300,-200}},
        color={0, 127, 255}));
  connect(pip5.port_a, hea6.port_b)
    annotation(
      Line(
        points={{100,-240}, {100,-240}, {260,-240}, {260,-220}, {192,-220}, {192,-200}, {180,-200}},
        color={0, 127, 255}));
  connect(pip5.port_a, hea7.port_b)
    annotation(
      Line(
        points={{100,-240}, {100,-240}, {260,-240}, {260,-220}, {250,-220}, {250,-200}, {240,-200}},
        color={0, 127, 255}));
  connect(pip5.port_a, coo5.port_a)
    annotation(
      Line(
        points={{100,-240}, {260,-240}, {260,-220}, {270,-220}, {270,-200}, {280,-200}},
        color={0, 127, 255}));
  connect(QHea6.y[1], hea6.Q_flow)
    annotation(
      Line(
        points={{141,-110}, {148,-110}, {148,-194}, {158,-194}},
        color={0, 0, 127}));
  connect(QHea7.y[1], hea7.Q_flow)
    annotation(
      Line(
        points={{201,-110}, {210,-110}, {210,-194}, {218,-194}},
        color={0, 0, 127}));
  connect(QCoo5.y[1], coo5.Q_flow)
    annotation(
      Line(
        points={{261,-110}, {270,-110}, {270,-194}, {278,-194}},
        color={0, 0, 127}));
  connect(pip4.port_a, pip.port_b)
    annotation(
      Line(
        points={{80,-140}, {60,-140}, {60, 60}, {-208, 60}},
        color={0, 127, 255}));
  connect(pip5.port_b, pip1.port_a)
    annotation(
      Line(
        points={{80,-240}, {40,-240}, {40,-40}, {-210,-40}},
        color={0, 127, 255}));
  connect(TSetH.y, pla.TSetHea)
    annotation(
      Line(
        points={{-299, 110}, {-270, 110}, {-270, 68}, {-262, 68}},
        color={0, 0, 127}));
  connect(TSetC.y, pla.TSetCoo)
    annotation(
      Line(
        points={{-299, 80}, {-290, 80}, {-290, 64}, {-262, 64}},
        color={0, 0, 127}));
  annotation(
    experiment(
      Tolerance=1E-06,
      StopTime=86400),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Experimental/DistrictHeatingCooling/Examples/IdealSystem3Clusters.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
