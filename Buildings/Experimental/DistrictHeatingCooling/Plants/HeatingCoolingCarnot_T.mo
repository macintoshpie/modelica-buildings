...
model HeatingCoolingCarnot_T
  ...
  Modelica.Blocks.Interfaces.RealInput TSink(
    unit="K")
  ...
  Modelica.Blocks.Interfaces.RealOutput PComHea(
    unit="W")
  ...
  Modelica.Blocks.Interfaces.RealOutput PComCoo(
    unit="W")
  ...
  Modelica.Blocks.Interfaces.RealOutput QAmbHea_flow(
    unit="W")
  ...
  Modelica.Blocks.Interfaces.RealOutput QAmbChi_flow(
    unit="W")
  ...
  Buildings.Fluid.Sources.MassFlowSource_T souHea(
    ...
    annotation(
      Placement(
        transformation(
          extent={{8,-10}, {-12,-30}})));
  Modelica.Blocks.Math.Gain mHeaSin_flow(
    k=1/(cpSin_default*dTSin))
    "Mass flow rate for heat source"
    annotation(
      Placement(
        transformation(
          extent={{-28,-80}, {-8,-60}})));
  Modelica.Blocks.Math.Add addHea(
    k2=-1)
  ...
  Modelica.Blocks.Math.Add addCoo
    ...
    annotation(
      Placement(
        transformation(
          extent={{40, 60}, {60, 80}})));
  Modelica.Blocks.Math.Gain mCooSin_flow(
    k=-1/(cpSin_default*dTSin))
...
equation
  ...
  connect(hea.QCon_flow, addHea.u1)
    annotation(
      Line(
        points={{-31, 3}, {-24, 3}, {-24,-50}, {-70,-50}, {-70,-64}, {-62,-64}},
        color={0, 0, 127}));
  connect(hea.P, addHea.u2)
    annotation(
      Line(
        points={{-31,-6}, {-26,-6}, {-26,-46}, {-72,-46}, {-72,-76}, {-62,-76}},
        color={0, 0, 127}));
  connect(mHeaSin_flow.u, addHea.y)
    annotation(
      Line(
        points={{-30,-70}, {-36,-70}, {-39,-70}},
        color={0, 0, 127}));
  connect(coo.P, addCoo.u2)
    annotation(
      Line(
        points={{59, 6}, {59, 6}, {68, 6}, {68, 54}, {30, 54}, {30, 64}, {38, 64}},
        color={0, 0, 127}));
  ...
  connect(sinHea.ports[1], hea.port_b2)
    annotation(
      Line(
        points={{-60,-20}, {-60,-20}, {-54,-20}, {-54,-12}, {-52,-12}},
        color={0, 127, 255}));
  connect(mHeaSin_flow.y, souHea.m_flow_in)
    annotation(
      Line(
        points={{-7,-70}, {-7,-70}, {20,-70}, {20,-28}, {8,-28}},
        color={0, 0, 127}));
  connect(TSink, souHea.T_in)
    annotation(
      Line(
        points={{-120,-60}, {-84,-60}, {-84,-90}, {22,-90}, {22,-54}, {22,-24}, {10,-24}},
        color={0, 0, 127}));
  connect(souHea.ports[1], hea.port_a2)
    annotation(
      Line(
        points={{-12,-20}, {-20,-20}, {-20,-12}, {-32,-12}},
        color={0, 127, 255}));
  connect(mCooSin_flow.y, sou2.m_flow_in)
    annotation(
      Line(
        points={{87, 70}, {96, 70}, {96, 90}, {80, 90}, {-20, 90}, {-20, 28}, {-8, 28}},
        color={0, 0, 127}));
  connect(sou2.T_in, TSink)
    annotation(
      Line(
        points={{-10, 24}, {-84, 24}, {-84,-60}, {-120,-60}},
        color={0, 0, 127}));
  connect(hea.P, PComHea)
    annotation(
      Line(
        points={{-31,-6}, {-26,-6}, {-26, 98}, {98, 98}, {98, 90}, {110, 90}},
        color={0, 0, 127}));
  connect(coo.P, PComCoo)
    annotation(
      Line(
        points={{59, 6}, {68, 6}, {68, 54}, {98, 54}, {98, 70}, {110, 70}},
        color={0, 0, 127}));
  connect(hea.QCon_flow, QHea_flow)
    annotation(
      Line(
        points={{-31, 3}, {-24, 3}, {-24, 50}, {94, 50}, {110, 50}},
        color={0, 0, 127}));
  connect(TSetCoo, coo.TSet)
    annotation(
      Line(
        points={{-120, 40}, {32, 40}, {32, 15}, {36, 15}},
        color={0, 0, 127}));
  connect(sou2.ports[1], coo.port_a1)
    annotation(
      Line(
        points={{12, 20}, {12, 20}, {20, 20}, {20, 12}, {38, 12}},
        color={0, 127, 255}));
  connect(coo.port_b1, sinCoo.ports[1])
    annotation(
      Line(
        points={{58, 12}, {58, 6}, {62, 6}, {62, 20}, {72, 20}},
        color={0, 127, 255}));
  connect(port_b, coo.port_a2)
    annotation(
      Line(
        points={{100, 0}, {86, 0}, {72, 0}, {58, 0}},
        color={0, 127, 255}));
  connect(addCoo.u1, coo.QEva_flow)
    annotation(
      Line(
        points={{38, 76}, {28, 76}, {28,-14}, {64,-14}, {64,-8}, {64,-3}, {60,-3}, {59,-3}},
        color={0, 0, 127}));
  connect(coo.QEva_flow, QCoo_flow)
    annotation(
      Line(
        points={{59,-3}, {94,-3}, {94, 30}, {110, 30}},
        color={0, 0, 127}));
  ...
  connect(hea.QEva_flow, QAmbHea_flow)
    annotation(
      Line(
        points={{-31,-15}, {-28,-15}, {-28,-40}, {110,-40}},
        color={0, 0, 127}));
  connect(coo.QCon_flow, QAmbChi_flow)
    annotation(
      Line(
        points={{59, 15}, {66, 15}, {66,-60}, {110,-60}},
        color={0, 0, 127}));
  annotation(
    Icon(
      coordinateSystem(
      ...
      graphics={Rectangle(
        ...
        points={{-104, 40}, {-80, 40}, {-80, 6}},
        color={28, 108, 200}), Line(
        points={{-102, 80}, {78, 80}, {78, 6}},
        color={28, 108, 200})}),
    Documentation(
      info="<html>
<p>
