...
model Heating
  ...
  parameter Modelica.SIunits.TemperatureDifference dTHex(max=-0.5, displayUnit="K")=-4
...
equation
  ...
  connect(Q_flow, hex.u)
    annotation(Line(points={{-120, 60}, {10, 60}, {10, 6}, {18, 6}}, color={0, 0, 127}));
  annotation(defaultComponentName="subStaHea", Documentation(info="<html>
<p>
...
</html>"), Icon(graphics={Text(extent={{-106, 70}, {-62, 50}}, lineColor={0, 0, 127}, textString="Q")}));
end Heating;
