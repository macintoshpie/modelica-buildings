...
partial model PartialDamperExponential
  ...
  extends Buildings.Fluid.BaseClasses.PartialResistance(
    ...
    final m_flow_turbulent=if use_deltaM then deltaM*m_flow_nominal else eta_default*ReC*sqrt(A)*facRouDuc);
  ...
  parameter Real yU(
    ...
    annotation(
      Dialog(
        tab="Damper coefficients"));
  final parameter Real k0(
    min=0,
    unit="1")=2*rho_default*(A/kDamMin)^2
