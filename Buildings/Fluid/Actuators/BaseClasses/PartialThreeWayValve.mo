...
partial model PartialThreeWayValve
  ...
  extends Buildings.Fluid.BaseClasses.PartialThreeWayResistance(
    ...
    redeclare replaceable Buildings.Fluid.Actuators.BaseClasses.PartialTwoWayValve res1 constrainedby Buildings.Fluid.Actuators.BaseClasses.PartialTwoWayValve(
      deltaM=deltaM,
      dp(
        start=dpValve_nominal/2),
      from_dp=from_dp,
    ...
    redeclare replaceable Buildings.Fluid.Actuators.BaseClasses.PartialTwoWayValve res3 constrainedby Buildings.Fluid.Actuators.BaseClasses.PartialTwoWayValve(
      deltaM=deltaM,
      dp(
        start=dpValve_nominal/2),
      from_dp=from_dp,
  ...
  parameter Real deltaM=0.02
    ...
    annotation(
      Dialog(
        group="Pressure-flow linearization"));
  ...
  annotation(
    Icon(
      ...
      graphics={Rectangle(
        ...
        points={{-30, 40}, {30, 40}}), Line(
        points={{0, 40}, {0, 0}}), Line(
