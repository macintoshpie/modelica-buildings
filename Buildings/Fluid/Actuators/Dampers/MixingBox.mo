...
model MixingBox
  ...
  parameter Modelica.SIunits.PressureDifference dpDamOut_nominal(
    ...
    annotation(
      Dialog(
        group="Nominal condition"));
  parameter Modelica.SIunits.PressureDifference dpFixOut_nominal(
    min=0,
    displayUnit="Pa")=0
  ...
  parameter Modelica.SIunits.PressureDifference dpDamRec_nominal(
    ...
    annotation(
      Dialog(
        group="Nominal condition"));
  parameter Modelica.SIunits.PressureDifference dpFixRec_nominal(
    min=0,
    displayUnit="Pa")=0
  ...
  parameter Modelica.SIunits.PressureDifference dpDamExh_nominal(
    ...
    annotation(
      Dialog(
        group="Nominal condition"));
  parameter Modelica.SIunits.PressureDifference dpFixExh_nominal(
    min=0,
    displayUnit="Pa")=0
...
equation
  connect(uni.y, add.u1)
    annotation(
      Line(
        points={{-69, 6}, {-42, 6}, {-42, 6}},
        color={0, 0, 127}));
  connect(add.y, damRec.y)
    annotation(
      Line(
        points={{-19, 6.10623e-16}, {-19, 0}, {18, 0}, {18, 1.4009e-15}},
        color={0, 0, 127}));
