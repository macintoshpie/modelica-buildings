...
equation
  connect(damExp.port_a, sou.ports[1])
    annotation(
      Line(
        points={{0,-40}, {-20,-40}, {-20, 3}, {-30, 3}},
        color={0, 127, 255}));
  connect(damExp.port_b, sin.ports[1])
    annotation(
      Line(
        points={{20,-40}, {60,-40}, {60, 3}, {82, 3}},
        color={0, 127, 255}));
  connect(sou.ports[2], damPreInd.port_a)
    annotation(
      Line(
        points={{-30, 1}, {-20, 1}, {-20, 0}, {0, 0}},
        color={0, 127, 255}));
  connect(damPreInd.port_b, sin.ports[2])
    annotation(
      Line(
        points={{20, 0}, {48, 0}, {48, 1}, {82, 1}},
        color={0, 127, 255}));
  connect(yRam.y, damPreInd.y)
    annotation(
      Line(
        points={{1, 80}, {40, 80}, {40, 20}, {10, 20}, {10, 12}},
        color={0, 0, 127}));
  connect(damPreInd.y_actual, damExp.y)
    annotation(
      Line(
        points={{15, 7}, {40, 7}, {40,-20}, {10,-20}, {10,-28}},
        color={0, 0, 127}));
  ...
  connect(senMasFlo.port_b, sin.ports[3])
    annotation(
      Line(
        points={{50,-80}, {68,-80}, {68,-1}, {82,-1}},
        color={0, 127, 255}));
  connect(sou.ports[3], damExpPI.port_a)
    annotation(
      Line(
        points={{-30,-1}, {-20,-1}, {-20,-80}, {0,-80}},
        color={0, 127, 255}));
  connect(conPID.y, damExpPI.y)
    annotation(
      Line(
        points={{-49,-60}, {10,-60}, {10,-68}},
        color={0, 0, 127}));
  connect(yRam.y, conPID.u_s)
    annotation(
      Line(
        points={{1, 80}, {40, 80}, {40, 100}, {-100, 100}, {-100,-60}, {-72,-60}},
        color={0, 0, 127}));
  connect(yRam1.y, add.u1)
    annotation(
      Line(
        points={{-69, 80}, {-60, 80}, {-60, 46}, {-54, 46}},
        color={0, 0, 127}));
  connect(yRam2.y, add.u2)
    annotation(
      Line(
        points={{-69, 40}, {-60, 40}, {-60, 34}, {-54, 34}},
        color={0, 0, 127}));
  connect(add.y, sou.p_in)
    annotation(
      Line(
        points={{-31, 40}, {-26, 40}, {-26, 20}, {-60, 20}, {-60, 8}, {-52, 8}},
        color={0, 0, 127}));
  connect(sou.ports[4], senRelPre.port_a)
    annotation(
      Line(
        points={{-30,-3}, {-20,-3}, {-20, 40}, {0, 40}},
        color={0, 127, 255}));
  ...
  connect(senMasFlo.m_flow, gain.u)
    annotation(
      Line(
        points={{40,-91}, {40,-100}, {-18,-100}},
        color={0, 0, 127}));
  connect(gain.y, conPID.u_m)
    annotation(
      Line(
        points={{-41,-100}, {-60,-100}, {-60,-72}},
        color={0, 0, 127}));
  annotation(
    experiment(
      Tolerance=1e-6,
