...
model IdealMotor
  ...
  parameter Real delta(
    ...
    max=0.5)=0.05
    "Hysteresis";
  parameter Modelica.SIunits.Time tOpe(
    min=0)=120
    "Opening time";
  parameter Modelica.SIunits.Time tClo(
    min=0)=tOpe
    "Closing time";
  ...
  Modelica.Blocks.Logical.Hysteresis uppHys(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60, 20}, {-40, 40}})));
  Modelica.Blocks.Logical.Hysteresis lowHys(
    uLow=-delta,
    final uHigh=0,
...
equation
  connect(zer.y, uppSwi.u3)
    annotation(
      Line(
        points={{-19, 6.10623e-016}, {-14, 6.10623e-016}, {-14, 22}, {-2, 22}},
        color={0, 0, 127}));
  ...
  connect(add.y, int.u)
    annotation(
      Line(
        points={{53, 6.10623e-016}, {60, 6.10623e-016}, {60, 6.66134e-016}, {58, 6.66134e-016}},
        color={0, 0, 127}));
  connect(uppSwi.y, add.u1)
    annotation(
      Line(
        points={{21, 30}, {24, 30}, {24, 6}, {30, 6}},
        color={0, 0, 127}));
  connect(u, feeBac.u1)
    annotation(
      Line(
        points={{-120, 1.11022e-015}, {-104, 1.11022e-015}, {-104, 6.66134e-016}, {-88, 6.66134e-016}},
        color={0, 0, 127}));
  connect(feeBac.y, uppHys.u)
    annotation(
      Line(
        points={{-71, 6.10623e-016}, {-66, 6.10623e-016}, {-66, 30}, {-62, 30}},
        color={0, 0, 127}));
  ...
  connect(int.y, y)
    annotation(
      Line(
        points={{81, 6.10623e-016}, {93.5, 6.10623e-016}, {93.5, 5.55112e-016}, {110, 5.55112e-016}},
        color={0, 0, 127}));
  connect(int.y, feeBac.u2)
    annotation(
      Line(
        points={{81, 6.10623e-016}, {94, 6.10623e-016}, {94,-88}, {-80,-88}, {-80,-8}},
        color={0, 0, 127}));
  annotation(
...
First implementation.
    ...
    Icon(
      graphics={Line(
        ...
        extent={{-37, 12}, {-10, 32}},
        lineColor={0, 0, 0},
        textString="vOpen"), Text(
        extent={{-4,-86}, {30,-64}},
        lineColor={0, 0, 0},
        textString="vClose"), Line(
