...
equation
  ...
  connect(PSin.y, sin.p_in)
    annotation(
      Line(
        points={{81, 70}, {86, 70}, {86, 8}, {72, 8}},
        color={0, 0, 127}));
  connect(y.y, valEquPerLin.y)
    annotation(
      Line(
        points={{-41, 80}, {-12, 80}, {-12, 20}, {10, 20}, {10, 12}},
        color={0, 0, 127}));
  ...
  connect(valTab.port_1, sou.ports[3])
    annotation(
      Line(
        points={{0,-60}, {-16,-60}, {-16,-2.66667}, {-30,-2.66667}},
        color={0, 127, 255}));
  connect(valTab.port_2, sin.ports[3])
    annotation(
      Line(
        points={{20,-60}, {40,-60}, {40,-2.66667}, {50,-2.66667}},
        color={0, 127, 255}));
  connect(valTab.port_3, ret.ports[3])
    annotation(
      Line(
        points={{10,-70}, {10,-72.6667}, {54,-72.6667}},
        color={0, 127, 255}));
  connect(valTab.y, y.y)
    annotation(
      Line(
        points={{10,-48}, {10,-40}, {-12,-40}, {-12, 80}, {-41, 80}},
        color={0, 0, 127}));
  annotation(
    experiment(
      Tolerance=1e-6,
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Actuators/Valves/Examples/ThreeWayValves.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
