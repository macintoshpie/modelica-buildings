...
equation
  ...
  connect(valPol.port_b, sin.ports[5])
    annotation(
      Line(
        points={{20,-80}, {38,-80}, {38,-3.2}, {52,-3.2}},
        color={0, 127, 255}));
  connect(valPol.port_a, sou.ports[5])
    annotation(
      Line(
        points={{0,-80}, {-28,-80}, {-28,-3.2}, {-50,-3.2}},
        color={0, 127, 255}));
  connect(valPol.y, y.y)
    annotation(
      Line(
        points={{10,-68}, {10,-60}, {-12,-60}, {-12, 100}, {-39, 100}},
        color={0, 0, 127}));
  annotation(
    experiment(
      Tolerance=1e-6,
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Actuators/Valves/Examples/TwoWayValves.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
