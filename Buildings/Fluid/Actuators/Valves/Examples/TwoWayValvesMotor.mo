  ...
  Buildings.Fluid.Actuators.Valves.TwoWayEqualPercentage valEqu(
    ...
    annotation(
      Placement(
        transformation(
          extent={{0,-30}, {20,-10}})));
  Modelica.Blocks.Sources.TimeTable ySet(
    table=[
      0, 0;
      60, 0;
      60, 1;
    ...
    annotation(
      Placement(
        transformation(
          extent={{-100, 60}, {-80, 80}})));
  Actuators.Motors.IdealMotor mot(
    tOpe=60)
    "Motor model"
    annotation(
      Placement(
...
equation
  ...
  connect(mot.y, valEqu.y)
    annotation(
      Line(
        points={{-39, 70}, {-12, 70}, {-12, 0}, {10, 0}, {10,-8}},
        color={0, 0, 127}));
  connect(mot.y, valQui.y)
    annotation(
      Line(
        points={{-39, 70}, {-12, 70}, {-12, 40}, {10, 40}, {10, 32}},
        color={0, 0, 127}));
  connect(mot.y, valLin.y)
    annotation(
      Line(
        points={{-39, 70}, {10, 70}, {10, 74}, {10, 72}},
        color={0, 0, 127}));
  ...
  annotation(
    experiment(
      ...
      StopTime=600),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Actuators/Valves/Examples/TwoWayValvesMotor.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
