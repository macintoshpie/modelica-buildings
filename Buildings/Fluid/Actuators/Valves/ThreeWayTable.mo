...
model ThreeWayTable
  ...
  extends BaseClasses.PartialThreeWayValve(final l={0, 0}, redeclare TwoWayTable res1(final flowCharacteristics=flowCharacteristics1), redeclare TwoWayTable res3(final flowCharacteristics=flowCharacteristics3));
...
</html>"), Icon(graphics={Rectangle(origin={-80,-79}, lineColor={64, 64, 64}, fillColor={255, 215, 136}, fillPattern=FillPattern.Solid, extent={{-12,-11}, {12, 11}}, radius=5.0), Line(points={{-80,-68}, {-80,-90}}), Line(points={{-92,-76}, {-68,-76}}), Line(points={{-92,-84}, {-68,-84}})}));
end ThreeWayTable;
