...
equation
  connect(inv.y, res3.y)
    annotation(
      Line(
        points={{-62.6, 46}, {20, 46}, {20,-50}, {12,-50}},
        color={0, 0, 127}));
  connect(y_actual, inv.u2)
    annotation(
      Line(
        points={{50, 70}, {88, 70}, {88, 34}, {-68, 34}, {-68, 41.2}},
        color={0, 0, 127}));
  connect(y_actual, res1.y)
    annotation(
      Line(
        points={{50, 70}, {88, 70}, {88, 34}, {-50, 34}, {-50, 12}},
        color={0, 0, 127}));
  annotation(
...
First implementation.
    ...
    Icon(
      graphics={Rectangle(
        ...
        extent={{-12,-11}, {12, 11}},
        radius=5.0), Line(
        points={{-80,-68}, {-80,-90}}), Line(
        points={{-92,-76}, {-68,-76}}), Line(
        points={{-92,-84}, {-68,-84}})}));
end ThreeWayTable;
