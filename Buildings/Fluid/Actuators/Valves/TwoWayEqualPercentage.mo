...
model TwoWayEqualPercentage
  ...
  extends BaseClasses.PartialTwoWayValveKv(phi=max(0, if homotopyInitialization then homotopy(actual=Buildings.Fluid.Actuators.BaseClasses.equalPercentage(y_actual, R, l, delta0), simplified=l + y_actual*(1-l)) else Buildings.Fluid.Actuators.BaseClasses.equalPercentage(y_actual, R, l, delta0)));
  parameter Real R=50
...
</html>"), Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100}, {100, 100}}), graphics={Text(extent={{-74, 20}, {-36,-24}}, lineColor=DynamicSelect({255, 255, 255},(1-y)*{255, 255, 255}), fillPattern=FillPattern.Solid, textString="%%")}));
