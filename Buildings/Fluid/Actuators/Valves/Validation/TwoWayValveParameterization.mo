...
equation
  ...
  connect(valKv.port_b, senM_flowKv.port_a)
    annotation(
      Line(
        points={{10, 6.10623e-16}, {12.5, 6.10623e-16}, {12.5, 1.22125e-15}, {15, 1.22125e-15}, {15, 6.10623e-16}, {20, 6.10623e-16}},
        color={0, 127, 255}));
  ...
  connect(senM_flowAv.port_b, sin.ports[4])
    annotation(
      Line(
        points={{40,-80}, {60,-80}, {60,-3}, {70,-3}},
        color={0, 127, 255}));
  connect(valAv.y, y.y)
    annotation(
      Line(
        points={{0,-68}, {0,-60}, {-20,-60}, {-20, 70}, {-39, 70}},
        color={0, 0, 127}));
  annotation(
    experiment(
      Tolerance=1e-6,
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Actuators/Valves/Validation/TwoWayValveParameterization.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
