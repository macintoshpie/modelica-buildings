...
model MassFlowRateMultiplier
  ...
  Buildings.Fluid.BaseClasses.MassFlowRateMultiplier massFlowRateMultiplier(
...
equation
  ...
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/BaseClasses/Validation/MassFlowRateMultiplier.mos"
        "Simulate and plot"),
    experiment(
      Tolerance=1e-6,
      StartTime=0.0,
