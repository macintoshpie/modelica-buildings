...
model AssertWaterFlow
  ...
  Buildings.Controls.OBC.CDL.Utilities.Assert assMes(final message="Water flow rate is lower than the minimum!")
...
protected
  ...
  Buildings.Controls.OBC.CDL.Continuous.Hysteresis hys(final uLow=0.99*mWatMin_flow-1e-6, final uHigh=1.01*mWatMin_flow)
