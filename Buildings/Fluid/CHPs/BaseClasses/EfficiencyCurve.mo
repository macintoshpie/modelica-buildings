...
<li>June 1, 2019, by Tea Zakula:<br/>First implementation. </li>
    ...
    Icon(
      ...
      graphics={Line(
        ...
        points={{-80,-80}, {-79.2,-50.6}, {-78.4,-37}, {-77.6,-28}, {-76.8,-21.3}, {-75.2,-11.4}, {-72.8,-1.31}, {-69.5, 8.08}, {-64.7, 17.9}, {-57.5, 28}, {-47, 38.1}, {-31.8, 48.1}, {-10.1, 58}, {22.1, 68}, {68.7, 78.1}, {80, 80}}), Line(
        points={{-80,-80}, {-80, 68}},
