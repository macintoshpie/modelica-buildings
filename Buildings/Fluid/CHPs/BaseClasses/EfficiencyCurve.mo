...
block EfficiencyCurve
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput PNet(final unit="W")
    "Electric power"
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealInput TWatIn(final unit="K")
...
equation
  y=Buildings.Fluid.CHPs.BaseClasses.Functions.polynomialtrivariate(a=a, x1=PNet, x2=mWat_flow, x3=TWatIn-273.15)
    "Efficiency calculated as a function of power, water flow rate and water inlet temperature";
  eta=Buildings.Utilities.Math.Functions.smoothMax(x1=y, x2=etaSma, deltaX=etaSma/2)
    "Corrected efficiency, ensuring that efficiency is not zero";
  annotation(defaultComponentName="effCur", Documentation(info="<html>
<p>
...
</html>"), Diagram(coordinateSystem(extent={{-100,-100}, {100, 100}})), Icon(coordinateSystem(extent={{-100,-100}, {100, 100}}), graphics={Line(points={{-90,-76}, {68,-76}}, color={192, 192, 192}), Line(points={{-80,-80}, {-79.2,-50.6}, {-78.4,-37}, {-77.6,-28}, {-76.8,-21.3}, {-75.2,-11.4}, {-72.8,-1.31}, {-69.5, 8.08}, {-64.7, 17.9}, {-57.5, 28}, {-47, 38.1}, {-31.8, 48.1}, {-10.1, 58}, {22.1, 68}, {68.7, 78.1}, {80, 80}}), Line(points={{-80,-80}, {-80, 68}}, color={192, 192, 192}), Polygon(points={{-80, 90}, {-88, 68}, {-72, 68}, {-80, 90}}, lineColor={192, 192, 192}, fillColor={192, 192, 192}, fillPattern=FillPattern.Solid)}), Icon(graphics={Text(extent={{-90, 38}, {90,-34}}, lineColor={160, 160, 164}, textString="polynominal()")}));
end EfficiencyCurve;
