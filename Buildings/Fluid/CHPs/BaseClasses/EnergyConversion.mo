...
protected
  ...
  Buildings.Fluid.CHPs.BaseClasses.EnergyConversionWarmUp opeModWarUpEngTem(
    final per=per) if not per.warmUpByTimeDelay
  ...
  Modelica.Blocks.Sources.BooleanExpression booExp(
    final y=opeMod == CHPs.BaseClasses.Types.Mode.WarmUp or opeMod == CHPs.BaseClasses.Types.Mode.Normal)
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant PEleTimeDel(
...
equation
  connect(opeModBas.mWat_flow, mWat_flow)
    annotation(
      Line(
        points={{-22, 0}, {-120, 0}, {-120, 20}, {-160, 20}},
        color={0, 0, 127}));
  connect(opeModBas.TWatIn, TWatIn)
    annotation(
      Line(
        points={{-22,-6}, {-100,-6}, {-100,-20}, {-160,-20}},
        color={0, 0, 127}));
  connect(opeModWarUpEngTem.TEng, TEng)
    annotation(
      Line(
        points={{-22,-58}, {-110,-58}, {-110,-90}, {-160,-90}},
        color={0, 0, 127}));
  connect(opeModWarUpEngTem.TWatIn, TWatIn)
    annotation(
      Line(
        points={{-22,-47}, {-100,-47}, {-100,-20}, {-160,-20}},
        color={0, 0, 127}));
  connect(const.y, switch.u3)
    annotation(
      Line(
        points={{-78, 70}, {-70, 70}, {-70, 92}, {-62, 92}},
        color={0, 0, 127}));
  connect(PEle, switch.u1)
    annotation(
      Line(
        points={{-160, 120}, {-70, 120}, {-70, 108}, {-62, 108}},
        color={0, 0, 127}));
