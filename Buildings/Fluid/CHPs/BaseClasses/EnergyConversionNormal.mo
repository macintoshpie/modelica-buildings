...
equation
  connect(groHea.u1, PEle)
    annotation(
      Line(
        points={{-22, 26}, {-110, 26}, {-110, 40}, {-160, 40}},
        color={0, 0, 127}));
  ...
  connect(etaE.TWatIn, TWatIn)
    annotation(
      Line(
        points={{-82,-6}, {-100,-6}, {-100,-76}, {-160,-76}},
        color={0, 0, 127}));
  connect(etaE.PNet, PEle)
    annotation(
      Line(
        points={{-82, 6}, {-110, 6}, {-110, 40}, {-160, 40}},
        color={0, 0, 127}));
  connect(etaQ.PNet, PEle)
    annotation(
      Line(
        points={{-82,-64}, {-110,-64}, {-110, 40}, {-160, 40}},
        color={0, 0, 127}));
  ...
  connect(etaQ.mWat_flow, mWat_flow)
    annotation(
      Line(
        points={{-82,-70}, {-120,-70}, {-120, 0}, {-160, 0}},
        color={0, 0, 127}));
  ...
  connect(etaE.eta, groHea.u2)
    annotation(
      Line(
        points={{-58, 0}, {-40, 0}, {-40, 14}, {-22, 14}},
        color={0, 0, 127}));
  connect(etaQ.eta, heaGen.u2)
    annotation(
      Line(
        points={{-58,-70}, {20,-70}, {20,-46}, {58,-46}},
        color={0, 0, 127}));
  connect(groHea.y, heaGen.u1)
    annotation(
      Line(
        points={{2, 20}, {20, 20}, {20,-34}, {58,-34}},
        color={0, 0, 127}));
  ...
  connect(groHea.y, masFloFue.u)
    annotation(
      Line(
        points={{2, 20}, {20, 20}, {20, 40}, {38, 40}},
        color={0, 0, 127}));
  connect(masFloFue.y, masFloAir.u)
    annotation(
      Line(
        points={{62, 40}, {80, 40}, {80, 0}, {98, 0}},
        color={0, 0, 127}));
  annotation(
