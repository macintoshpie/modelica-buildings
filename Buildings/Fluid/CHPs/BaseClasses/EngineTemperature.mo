  ...
  Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a TRoo
    ...
    annotation(
      Placement(
        ...
        iconTransformation(
          extent={{-110, 48}, {-90, 68}})));
  Buildings.Controls.OBC.CDL.Interfaces.RealInput QGen_flow(
    final unit="W")
  ...
  annotation(
    ...
    Icon(
      coordinateSystem(
        extent={{-100,-100}, {100, 100}}),
      graphics={Polygon(
        points={{0, 75}, {-20, 71}, {-40, 65}, {-52, 51}, {-58, 43}, {-68, 33}, {-72, 21}, {-76, 7}, {-78,-7}, {-76,-23}, {-76,-35}, {-76,-45}, {-70,-57}, {-64,-65}, {-48,-69}, {-30,-75}, {-18,-75}, {-2,-77}, {8,-81}, {22,-81}, {32,-79}, {42,-73}, {54,-67}, {56,-65}, {66,-53}, {68,-45}, {70,-43}, {72,-27}, {76,-13}, {78,-5}, {78, 11}, {74, 23}, {66, 33}, {54, 41}, {44, 49}, {36, 65}, {26, 73}, {0, 75}},
        lineColor={160, 160, 164},
        fillColor={192, 192, 192},
        fillPattern=FillPattern.Solid), Polygon(
        points={{-58, 43}, {-68, 33}, {-72, 21}, {-76, 7}, {-78,-7}, {-76,-23}, {-76,-35}, {-76,-45}, {-70,-57}, {-64,-65}, {-48,-69}, {-30,-75}, {-18,-75}, {-2,-77}, {8,-81}, {22,-81}, {32,-79}, {42,-73}, {54,-67}, {42,-69}, {40,-69}, {30,-71}, {20,-73}, {18,-73}, {10,-73}, {2,-69}, {-12,-65}, {-22,-65}, {-30,-63}, {-40,-57}, {-50,-47}, {-56,-35}, {-58,-27}, {-58,-17}, {-60,-5}, {-60, 3}, {-60, 15}, {-58, 25}, {-56, 27}, {-52, 35}, {-48, 43}, {-44, 53}, {-40, 65}, {-58, 43}},
