...
protected
  ...
  Buildings.Controls.OBC.CDL.Continuous.SlewRateLimiter dPLim(
    final raisingSlewRate(
      unit="W/s")=dPEleMax,
    final fallingSlewRate(
      unit="W/s")=-dPEleMax,
    final Td=1)
    "Power rate limiter"
    annotation(
...
equation
  ...
  connect(PLim.y, dPLim.u)
    annotation(
      Line(
        points={{-19, 0}, {-10, 0}, {-10, 30}, {-2, 30}},
        color={0, 0, 127}));
  connect(PLim.y, switch.u3)
    annotation(
      Line(
        points={{-19, 0}, {-10, 0}, {-10,-8}, {68,-8}},
        color={0, 0, 127}));
  connect(assPow.PEleDem, PEleDem)
    annotation(
      Line(
        points={{-42,-70}, {-90,-70}, {-90, 0}, {-120, 0}},
        color={0, 0, 127}));
  connect(limDp.y, switch.u2)
    annotation(
      Line(
        points={{22,-30}, {40,-30}, {40, 0}, {68, 0}},
        color={255, 0, 255}));
  connect(dPLim.y, switch.u1)
    annotation(
      Line(
        points={{22, 30}, {40, 30}, {40, 8}, {68, 8}},
        color={0, 0, 127}));
  annotation(
    ...
    Icon(
      ...
      graphics={Text(
        ...
        extent={{50, 50}, {90, 70}},
        lineColor={128, 128, 128},
        textString="uMax"), Text(
        extent={{52,-8}, {74,-20}},
        lineColor={128, 128, 128},
        textString="input"), Line(
        points={{-90, 0}, {68, 0}},
        color={192, 192, 192}), Line(
        points={{-50,-70}, {50, 70}}), Line(
        points={{0,-90}, {0, 68}},
