...
protected
  ...
  Modelica.Blocks.Sources.BooleanExpression cooDow(
    final y=opeMod == Buildings.Fluid.CHPs.BaseClasses.Types.Mode.StandBy or opeMod == Buildings.Fluid.CHPs.BaseClasses.Types.Mode.CoolDown)
...
equation
  connect(staByCon.y, switch.u1)
    annotation(
      Line(
        points={{-58, 60}, {-40, 60}, {-40, 38}, {-22, 38}},
        color={0, 0, 127}));
  ...
  connect(const.y, switch1.u3)
    annotation(
      Line(
        points={{22,-30}, {40,-30}, {40,-8}, {58,-8}},
        color={0, 0, 127}));
  connect(cooDowCon.y, switch.u3)
    annotation(
      Line(
        points={{-58, 0}, {-40, 0}, {-40, 22}, {-22, 22}},
        color={0, 0, 127}));
  connect(switch.y, switch1.u1)
    annotation(
      Line(
        points={{2, 30}, {40, 30}, {40, 8}, {58, 8}},
        color={0, 0, 127}));
  annotation(
