...
model AssertWaterFlow
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.TimeTable mWat_flow(table=[
    ...
    360, 0.5;
    600, 0.05;
    900, 0.05], smoothness=Buildings.Controls.OBC.CDL.Types.Smoothness.ConstantSegments)
    "Water flow rate"
...
equation
  connect(mWat_flow.y[1], assWatMas.mWat_flow)
    annotation(Line(points={{-38,-20}, {0,-20}, {0,-4}, {38,-4}}, color={0, 0, 127}));
  connect(runSig.y, assWatMas.runSig)
    annotation(Line(points={{-39, 20}, {0, 20}, {0, 4}, {38, 4}}, color={255, 0, 255}));
  annotation(experiment(StopTime=900, Tolerance=1e-6), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/CHPs/BaseClasses/Validation/AssertWaterFlow.mos"
