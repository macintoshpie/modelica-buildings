...
model AssertWaterTemperature
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.TimeTable TWat(table=[
    0, 273.15 + 20;
    300, 273.15 + 80;
    600, 273.15 + 100;
    900, 273.15 + 100], smoothness=Buildings.Controls.OBC.CDL.Types.Smoothness.ConstantSegments)
    "Water temperature"
    annotation(Placement(transformation(extent={{-60,-10}, {-40, 10}})));
equation
  connect(TWat.y[1], assWatTem.TWat)
    annotation(Line(points={{-38, 0}, {38, 0}}, color={0, 0, 127}));
  annotation(experiment(StopTime=900, Tolerance=1e-6), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/CHPs/BaseClasses/Validation/AssertWaterTemperature.mos"
