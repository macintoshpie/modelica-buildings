...
equation
  connect(avaSig.y, con.avaSig)
    annotation(
      Line(
        points={{-19, 70}, {10, 70}, {10, 17}, {18, 17}},
        color={255, 0, 255}));
  connect(runSig.y, con.runSig)
    annotation(
      Line(
        points={{-19, 30}, {-10, 30}, {-10, 14}, {18, 14}},
        color={255, 0, 255}));
  connect(mWat_flow.y[1], con.mWat_flow)
    annotation(
      Line(
        points={{-18,-30}, {-10,-30}, {-10, 11}, {18, 11}},
        color={0, 0, 127}));
  annotation(
    experiment(
      StopTime=3000,
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/CHPs/BaseClasses/Validation/Controller.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
