...
equation
  ...
  connect(notRun.y, transition1.condition)
    annotation(
      Line(
        points={{2,-100}, {40,-100}, {40,-10}, {-26,-10}, {-26, 52}, {-40, 52}, {-40, 58}},
        color={255, 0, 255}));
  ...
  connect(runSig.y, and1.u2)
    annotation(
      Line(
        points={{-59,-100}, {-40,-100}, {-40,-68}, {-22,-68}},
        color={255, 0, 255}));
  connect(runSig.y, transition3.condition)
    annotation(
      Line(
        points={{-59,-100}, {-40,-100}, {-40,-40}, {80,-40}, {80, 38}},
        color={255, 0, 255}));
  connect(and1.y, transition4.condition)
    annotation(
      Line(
        points={{2,-60}, {20,-60}, {20,-30}, {-40,-30}, {-40,-12}},
        color={255, 0, 255}));
  connect(cooDow.outPort[1], transition2.inPort)
    annotation(
      Line(
        points={{0.5, 50.25}, {8, 50.25}, {8, 50}, {16, 50}},
        color={0, 0, 0}));
  ...
  connect(cooDow.outPort[2], transition4.inPort)
    annotation(
      Line(
        points={{0.5, 49.75}, {10, 49.75}, {10, 30}, {-20, 30}, {-20, 0}, {-36, 0}},
        color={0, 0, 0}));
  connect(transition1.outPort, cooDow.inPort[1])
    annotation(
      Line(
        points={{-38.5, 70}, {-32, 70}, {-32, 50}, {-22, 50}, {-22, 50.5}, {-21, 50.5}},
        color={0, 0, 0}));
  connect(transition5.outPort, cooDow.inPort[2])
    annotation(
      Line(
        points={{-38.5, 30}, {-32, 30}, {-32, 49.5}, {-21, 49.5}},
        color={0, 0, 0}));
  connect(cooDow.active, timer.u)
    annotation(
      Line(
        points={{-10, 39}, {-10, 10}, {-2, 10}},
        color={255, 0, 255}));
  connect(timeDel.y, transition2.condition)
    annotation(
      Line(
        points={{52, 10}, {60, 10}, {60, 30}, {20, 30}, {20, 38}},
        color={255, 0, 255}));
  annotation(
    experiment(
      StopTime=900,
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/CHPs/BaseClasses/Validation/CoolDown.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
