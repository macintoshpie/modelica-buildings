  ...
  parameter Buildings.Fluid.CHPs.Data.ValidationData2 per
    ...
    annotation(
      Placement(
        transformation(
          extent={{60, 60}, {80, 80}})));
  parameter Data.ValidationData2 per1(
...
equation
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/CHPs/BaseClasses/Validation/EnergyConversion.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
