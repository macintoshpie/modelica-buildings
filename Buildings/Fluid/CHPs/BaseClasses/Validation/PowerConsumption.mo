...
equation
  connect(avaSig.y, con.avaSig)
    annotation(
      Line(
        points={{-59, 80}, {-40, 80}, {-40, 7}, {-12, 7}},
        color={255, 0, 255}));
  connect(runSig.y, con.runSig)
    annotation(
      Line(
        points={{-59, 40}, {-50, 40}, {-50, 4}, {-12, 4}},
        color={255, 0, 255}));
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/CHPs/BaseClasses/Validation/PowerConsumption.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
