...
equation
  ...
  connect(transition1.inPort, off.outPort[1])
    annotation(
      Line(
        points={{-44, 80}, {-59.5, 80}},
        color={0, 0, 0}));
  connect(transition4.outPort, off.inPort[1])
    annotation(
      Line(
        points={{-41.5, 40}, {-90, 40}, {-90, 80.5}, {-81, 80.5}},
        color={0, 0, 0}));
  connect(transition3.outPort, off.inPort[2])
    annotation(
      Line(
        points={{81.5, 80}, {92, 80}, {92, 20}, {-90, 20}, {-90, 79.5}, {-81, 79.5}},
        color={0, 0, 0}));
  connect(avaSig.y, transition1.condition)
    annotation(
      Line(
        points={{-59,-40}, {-50,-40}, {-50, 60}, {-40, 60}, {-40, 68}},
        color={255, 0, 255}));
  connect(avaSig.y, notAva.u)
    annotation(
      Line(
        points={{-59,-40}, {-50,-40}, {-50,-20}, {-90,-20}, {-90, 0}, {-82, 0}},
        color={255, 0, 255}));
  connect(notAva.y, transition4.condition)
    annotation(
      Line(
        points={{-58, 0}, {-40, 0}, {-40, 28}},
        color={255, 0, 255}));
  connect(runSig.y, transition2.condition)
    annotation(
      Line(
        points={{1, 0}, {20, 0}, {20, 68}},
        color={255, 0, 255}));
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/CHPs/BaseClasses/Validation/StandBy.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
