...
protected
  Modelica.Blocks.Sources.BooleanExpression offStaBy(
    final y=opeMod == Buildings.Fluid.CHPs.BaseClasses.Types.Mode.Off or opeMod == Buildings.Fluid.CHPs.BaseClasses.Types.Mode.StandBy)
...
equation
  ...
  connect(PEle, mWatIntCon.u1)
    annotation(
      Line(
        points={{-120, 0}, {-20, 0}, {-20,-34}, {-2,-34}},
        color={0, 0, 127}));
  connect(TWatIn, to_degC.u)
    annotation(
      Line(
        points={{-120,-60}, {-92,-60}, {-92,-46}, {-62,-46}},
        color={0, 0, 127}));
