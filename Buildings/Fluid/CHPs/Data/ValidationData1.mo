...
<ul>
<li>
changed the condition of the warm-up mode, from depending on the time delay to
engine temperature.
</li>
<li>
...
<li>
limited the maximum rate of change in the power output <code>dPEleMax</code> and
the maximum rate of change in the fuel mass flow rate <code>dmFueMax_flow</code>,
