...
model ElectricalFollowing
  ...
  Modelica.Blocks.Sources.RealExpression QGen(
    final y=eleFol.eneCon.QGen_flow)
    "Heat generation"
    annotation(
      Placement(
        transformation(
...
equation
  ...
  connect(avaSig.y, eleFol.avaSig)
    annotation(
      Line(
        points={{-139, 80}, {-30, 80}, {-30,-11}, {-22,-11}},
        color={255, 0, 255}));
  ...
  connect(PEleNet.y, dPEleNet.u1)
    annotation(
      Line(
        points={{121, 10}, {130, 10}, {130, 16}, {138, 16}},
        color={0, 0, 127}));
  connect(QGen.y, dQGen.u1)
    annotation(
      Line(
        points={{121,-20}, {130,-20}, {130,-14}, {138,-14}},
        color={0, 0, 127}));
  connect(QWat.y, dQWat.u1)
    annotation(
      Line(
        points={{121,-50}, {130,-50}, {130,-44}, {138,-44}},
        color={0, 0, 127}));
  connect(QLos.y, dQLos.u1)
    annotation(
      Line(
        points={{121,-80}, {130,-80}, {130,-74}, {138,-74}},
        color={0, 0, 127}));
  connect(TWatOut.y, dTWatOut.u1)
    annotation(
      Line(
        points={{121, 70}, {130.55, 70}, {130.55, 76}, {138, 76}},
        color={0, 0, 127}));
  connect(dTEng.u1, TEng.y)
    annotation(
      Line(
        points={{138, 46}, {130, 46}, {130, 40}, {121, 40}},
        color={0, 0, 127}));
  connect(preTem.port, eleFol.TRoo)
    annotation(
      Line(
        points={{-40,-60}, {-30,-60}, {-30,-27}, {-20,-27}},
        color={191, 0, 0}));
  connect(valDat.y[2], cooWat.m_flow_in)
    annotation(
      Line(
        points={{-139, 30}, {-70, 30}, {-70,-12}, {-62,-12}},
        color={0, 0, 127}));
  connect(valDat.y[3], TWatIn.u)
    annotation(
      Line(
        points={{-139, 30}, {-120, 30}, {-120,-20}, {-102,-20}},
        color={0, 0, 127}));
  connect(TWatIn.y, cooWat.T_in)
    annotation(
      Line(
        points={{-78,-20}, {-70,-20}, {-70,-16}, {-62,-16}},
        color={0, 0, 127}));
  connect(valDat.y[4], TRoo.u)
    annotation(
      Line(
        points={{-139, 30}, {-120, 30}, {-120,-60}, {-102,-60}},
        color={0, 0, 127}));
  ...
  connect(valDat.y[10], TWatOutVal.u)
    annotation(
      Line(
        points={{-139, 30}, {50, 30}, {50, 64}, {58, 64}},
        color={0, 0, 127}));
  connect(valDat.y[11], TEngVal.u)
    annotation(
      Line(
        points={{-139, 30}, {50, 30}, {50, 34}, {58, 34}},
        color={0, 0, 127}));
  ...
  connect(valDat.y[1], eleFol.PEleDem)
    annotation(
      Line(
        points={{-139, 30}, {-26, 30}, {-26,-17}, {-22,-17}},
        color={0, 0, 127}));
  ...
  connect(valDat.y[5], PEleNetVal.u)
    annotation(
      Line(
        points={{-139, 30}, {50, 30}, {50, 4}, {58, 4}},
        color={0, 0, 127}));
  connect(valDat.y[7], QGenVal_flow.u)
    annotation(
      Line(
        points={{-139, 30}, {50, 30}, {50,-26}, {58,-26}},
        color={0, 0, 127}));
  ...
  connect(valDat.y[8], QWatVal_flow.u)
    annotation(
      Line(
        points={{-139, 30}, {50, 30}, {50,-56}, {58,-56}},
        color={0, 0, 127}));
  ...
  connect(valDat.y[9], QLosVal_flow.u)
    annotation(
      Line(
        points={{-139, 30}, {50, 30}, {50,-86}, {58,-86}},
        color={0, 0, 127}));
  connect(eleFol.PEleNet, EEle.u)
    annotation(
      Line(
        points={{2,-17}, {14,-17}, {14,-120}, {38,-120}},
        color={0, 0, 127}));
  connect(eleFol.QWat_flow, EThe.u)
    annotation(
      Line(
        points={{2,-27}, {10,-27}, {10,-150}, {38,-150}},
        color={0, 0, 127}));
  connect(QWatVal_flow.y, ETheVal.u)
    annotation(
      Line(
        points={{81,-56}, {86,-56}, {86,-150}, {96,-150}},
        color={0, 0, 127}));
  connect(PEleNetVal.y, EEleVal.u)
    annotation(
      Line(
        points={{81, 4}, {88, 4}, {88,-120}, {96,-120}},
        color={0, 0, 127}));
  annotation(
    experiment(
      StopTime=10000,
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/CHPs/Validation/ElectricalFollowing.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
