...
model ThermalFollowing
  ...
  Modelica.Blocks.Sources.CombiTimeTable valDat(
    ...
    y(
      unit={"W", "kg/s", "degC", "degC", "W", "W", "W", "W", "W", "degC", "degC", "degC"}),
  ...
  ThermalElectricalFollowing theFolNeg(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-20,-90}, {0,-70}})));
  Controls.OBC.CDL.Continuous.Sources.Constant mWat_flow_negative(
    final k=-1)
    "Negative water mass flow rate for validation only"
    annotation(
      Placement(
        transformation(
          extent={{-170,-90}, {-150,-70}})));
  ...
  Modelica.Blocks.Continuous.Integrator EEle(
    ...
    annotation(
      Placement(
        transformation(
          extent={{60,-130}, {80,-110}})));
  Modelica.Blocks.Continuous.Integrator EThe(
    y(
      unit="J"))
  ...
  Modelica.Blocks.Continuous.Integrator EEleVal(
    y(
      unit="J"))
    ...
    annotation(
      Placement(
        transformation(
          extent={{118,-130}, {138,-110}})));
  Modelica.Blocks.Continuous.Integrator ETheVal(
    y(
      unit="J"))
...
equation
  connect(theFol.port_b, sin.ports[1])
    annotation(
      Line(
        points={{0, 10}, {10, 10}, {10,-28}, {20,-28}},
        color={0, 127, 255}));
  connect(avaSig.y, theFol.avaSig)
    annotation(
      Line(
        points={{-99,-20}, {-36,-20}, {-36, 19}, {-22, 19}},
        color={255, 0, 255}));
  ...
  connect(PEleNet.y, dPEleNet.u1)
    annotation(
      Line(
        points={{121, 10}, {128, 10}, {128, 16}, {138, 16}},
        color={0, 0, 127}));
  connect(QWat.y, dQWat.u1)
    annotation(
      Line(
        points={{121,-50}, {128,-50}, {128,-44}, {138,-44}},
        color={0, 0, 127}));
  connect(theFolSig.y, theFol.theFol)
    annotation(
      Line(
        points={{-49, 40}, {-34, 40}, {-34, 17}, {-22, 17}},
        color={255, 0, 255}));
  connect(preTem.port, theFol.TRoo)
    annotation(
      Line(
        points={{-50,-50}, {-30,-50}, {-30, 3}, {-20, 3}},
        color={191, 0, 0}));
  connect(QLos.y, dQLos.u1)
    annotation(
      Line(
        points={{121,-80}, {128,-80}, {128,-74}, {138,-74}},
        color={0, 0, 127}));
  connect(QGen.y, dQGen.u1)
    annotation(
      Line(
        points={{121,-20}, {128,-20}, {128,-14}, {138,-14}},
        color={0, 0, 127}));
  connect(valDat.y[2], cooWat.m_flow_in)
    annotation(
      Line(
        points={{-149, 80}, {-80, 80}, {-80, 18}, {-70, 18}},
        color={0, 0, 127}));
  connect(valDat.y[3], TWatIn.u)
    annotation(
      Line(
        points={{-149, 80}, {-140, 80}, {-140, 10}, {-122, 10}},
        color={0, 0, 127}));
  connect(TWatIn.y, cooWat.T_in)
    annotation(
      Line(
        points={{-98, 10}, {-80, 10}, {-80, 14}, {-70, 14}},
        color={0, 0, 127}));
  connect(valDat.y[4], TRoo.u)
    annotation(
      Line(
        points={{-149, 80}, {-140, 80}, {-140,-50}, {-122,-50}},
        color={0, 0, 127}));
  ...
  connect(TWatOutSet.y, theFol.TWatOutSet)
    annotation(
      Line(
        points={{-98, 50}, {-30, 50}, {-30, 15}, {-22, 15}},
        color={0, 0, 127}));
  ...
  connect(TWatOut.y, dTWatOut.u1)
    annotation(
      Line(
        points={{121, 70}, {130, 70}, {130, 76}, {138, 76}},
        color={0, 0, 127}));
  connect(TEng.y, dTEng.u1)
    annotation(
      Line(
        points={{121, 40}, {130, 40}, {130, 46}, {138, 46}},
        color={0, 0, 127}));
  ...
  connect(valDat.y[10], TWatOutVal.u)
    annotation(
      Line(
        points={{-149, 80}, {50, 80}, {50, 64}, {58, 64}},
        color={0, 0, 127}));
  connect(valDat.y[11], TEngVal.u)
    annotation(
      Line(
        points={{-149, 80}, {50, 80}, {50, 34}, {58, 34}},
        color={0, 0, 127}));
  connect(valDat.y[1], theFol.PEleDem)
    annotation(
      Line(
        points={{-149, 80}, {-26, 80}, {-26, 13}, {-22, 13}},
        color={0, 0, 127}));
  ...
  connect(valDat.y[7], QGenVal_flow.u)
    annotation(
      Line(
        points={{-149, 80}, {50, 80}, {50,-26}, {58,-26}},
        color={0, 0, 127}));
  ...
  connect(valDat.y[8], QWatVal_flow.u)
    annotation(
      Line(
        points={{-149, 80}, {50, 80}, {50,-56}, {58,-56}},
        color={0, 0, 127}));
  ...
  connect(valDat.y[9], QLosVal_flow.u)
    annotation(
      Line(
        points={{-149, 80}, {50, 80}, {50,-86}, {58,-86}},
        color={0, 0, 127}));
  ...
  connect(PEleNetVal.y, EEleVal.u)
    annotation(
      Line(
        points={{81, 4}, {98, 4}, {98,-120}, {116,-120}},
        color={0, 0, 127}));
  connect(QWatVal_flow.y, ETheVal.u)
    annotation(
      Line(
        points={{81,-56}, {94,-56}, {94,-150}, {116,-150}},
        color={0, 0, 127}));
  connect(theFol.PEleNet, EEle.u)
    annotation(
      Line(
        points={{2, 13}, {44, 13}, {44,-120}, {58,-120}},
        color={0, 0, 127}));
  connect(theFol.QWat_flow, EThe.u)
    annotation(
      Line(
        points={{2, 3}, {42, 3}, {42,-150}, {58,-150}},
        color={0, 0, 127}));
  annotation(
    experiment(
      StopTime=10000,
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/CHPs/Validation/ThermalFollowing.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
