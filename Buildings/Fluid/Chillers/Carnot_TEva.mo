...
protected
  Modelica.Blocks.Math.Gain yCon(
    final k=1/QCon_flow_nominal)
    "Normalized condenser heat flow rate"
    annotation(
      Placement(
        transformation(
          extent={{-40, 30}, {-20, 50}})));
  Modelica.Blocks.Math.Add QCon_flow_internal(
    final k1=-1)
...
equation
  connect(TSet, eva.TSet)
    annotation(
      Line(
        points={{-120, 90}, {-66, 90}, {28, 90}, {28,-52}, {12,-52}},
        color={0, 0, 127}));
  connect(eva.Q_flow, QEva_flow)
    annotation(
      Line(
        points={{-11,-52}, {-40,-52}, {-40,-90}, {110,-90}},
        color={0, 0, 127}));
  ...
  connect(yCon.y, con.u)
    annotation(
      Line(
        points={{-19, 40}, {-16, 40}, {-16, 42}, {-16, 64}, {-16, 66}, {-12, 66}},
        color={0, 0, 127}));
  connect(QCon_flow_internal.y, QCon_flow)
    annotation(
      Line(
        points={{-59, 40}, {-52, 40}, {-52, 80}, {80, 80}, {80, 90}, {110, 90}},
        color={0, 0, 127}));
  connect(QCon_flow_internal.u1, eva.Q_flow)
    annotation(
      Line(
        points={{-82, 46}, {-90, 46}, {-90,-52}, {-11,-52}},
        color={0, 0, 127}));
  connect(QCon_flow_internal.u2, PEle.y)
    annotation(
      Line(
        points={{-82, 34}, {-88, 34}, {-88, 20}, {72, 20}, {72, 0}, {61, 0}},
        color={0, 0, 127}));
  annotation(
    Icon(
      coordinateSystem(
      ...
      graphics={Text(
        ...
        textString="TEva"), Line(
        points={{-100, 90}, {-80, 90}, {-80,-56}},
        color={0, 0, 255})}),
