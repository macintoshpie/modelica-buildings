...
model Carnot_TEva_HighTemperature
  ...
  Modelica.Blocks.Sources.Ramp TEvaEnt(startTime=3000, height=38, offset=273.15 + 22, duration=60)
    "Control signal for evaporator entering temperature"
    annotation(Placement(transformation(extent={{-60, 70}, {-40, 90}})));
equation
  connect(TEvaEnt.y, sou2.T_in)
    annotation(Line(points={{-39, 80}, {24, 80}, {90, 80}, {90,-2}, {82,-2}}, color={0, 0, 127}));
  annotation(experiment(Tolerance=1e-6, StopTime=3600), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Chillers/Validation/Carnot_TEva_HighTemperature.mos"
