  ...
  Modelica.Blocks.Sources.Constant TEvaLvg(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-40, 30}, {-20, 50}})));
  Modelica.Blocks.Math.Gain mCon_flow(
    k=-1/cp1_default/dTEva_nominal)
...
equation
  ...
  connect(TEvaLvg.y, chi.TSet)
    annotation(
      Line(
        points={{-19, 40}, {-12, 40}, {-12, 10}, {-12, 9}, {-4, 9}},
        color={0, 0, 127}));
  connect(chi.P, QCon_flow.u1)
    annotation(
      Line(
        points={{19, 0}, {34, 0}, {34, 0}, {34,-34}, {38,-34}},
        color={0, 0, 127}));
  connect(chi.QEva_flow, QCon_flow.u2)
    annotation(
      Line(
        points={{19,-9}, {26,-9}, {26,-10}, {26,-46}, {38,-46}},
        color={0, 0, 127}));
  connect(QCon_flow.y, mCon_flow.u)
    annotation(
      Line(
        points={{61,-40}, {80,-40}, {80,-60}, {-92,-60}, {-92, 14}, {-82, 14}},
        color={0, 0, 127}));
  ...
  annotation(
    experiment(
      ...
      StopTime=3600),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Chillers/Validation/Carnot_TEva_reverseFlow.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
