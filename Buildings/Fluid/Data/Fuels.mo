...
package Fuels
  "Package with properties of fuels"
  extends Modelica.Icons.MaterialPropertiesPackage;
  record NaturalGasLowerHeatingValue=Buildings.Fluid.Data.Fuels.Generic(h=50E6, d=0.84, mCO2=2.23)
    "Natural gas, lower heating value"
    annotation(defaultComponentPrefixes="parameter", defaultComponentName="datFue");
  record NaturalGasHigherHeatingValue=NaturalGasLowerHeatingValue(h=55.5E6)
    "Natural gas, higher heating value"
    annotation(defaultComponentPrefixes="parameter", defaultComponentName="datFue");
  record HeatingOilLowerHeatingValue=Buildings.Fluid.Data.Fuels.Generic(h=42.6E6, d=845, mCO2=3.136)
    "Heating oil, lower heating value"
    annotation(defaultComponentPrefixes="parameter", defaultComponentName="datFue");
  record HeatingOilHigherHeatingValue=HeatingOilLowerHeatingValue(h=45.4E6)
    "Heating oil, higher heating value"
    annotation(defaultComponentPrefixes="parameter", defaultComponentName="datFue");
  record WoodAirDriedLowerHeatingValue=Buildings.Fluid.Data.Fuels.Generic(h=14.6E6, d=700, mCO2=0)
    "Wood, air-dried, lower heating value"
    annotation(defaultComponentPrefixes="parameter", defaultComponentName="datFue", Documentation(info="<html>
<p>
