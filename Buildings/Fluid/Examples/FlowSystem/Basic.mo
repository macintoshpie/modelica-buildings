...
model Basic
  ...
  Buildings.Fluid.Movers.FlowControlled_dp pmpSouth(
    ...
    redeclare replaceable Buildings.Fluid.Movers.Data.Pumps.Wilo.Stratos80slash1to12 per,
    dp_nominal=12*9810,
  ...
  Modelica.Blocks.Sources.BooleanPulse stepPump(
    startTime=5,
    period=1000)
    "Step control"
    annotation(
  ...
  Buildings.Fluid.Movers.FlowControlled_m_flow pumpHea(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-50,-140}, {-70,-120}})));
  Modelica.Blocks.Sources.Constant Thot(
    k=273.15 + 50)
    ...
    annotation(
      Placement(
        transformation(
          ...
          rotation=270,
          origin={-10,-86})));
  Modelica.Blocks.Sources.Pulse stepValve(
    startTime=10,
    period=500)
    ...
    annotation(
      Placement(
        transformation(
          ...
          rotation=270,
          origin={12,-86})));
  Modelica.Blocks.Sources.RealExpression valCooExp(
    y=1-stepValve.y)
    "Cooling valve opens when heating valve is closed"
    annotation(
      Placement(
        transformation(
          extent={{-140,-60}, {-120,-80}})));
  ...
  Buildings.Fluid.MixingVolumes.MixingVolume vol(
    ...
    annotation(
      Placement(
        transformation(
          extent={{74,-100}, {54,-80}})));
  Buildings.HeatTransfer.Sources.FixedTemperature Tcold(
    T=273.15 + 10)
...
equation
  ...
  for i in 1 : 4 loop
    connect(tabsNorth1[i].port_b, valNorth.port_3)
      annotation(
        Line(
          points={{40, 100}, {40, 100}, {40, 118}, {6, 118}, {6,-50}, {50,-50}},
          color={0, 127, 255}));
    connect(tabsSouth1[i].port_b, valSouth.port_3)
      annotation(
        Line(
          points={{-80, 100}, {-80, 120}, {-4, 120}, {-4,-50}, {-50,-50}},
          color={0, 127, 255}));
    connect(valSouth1[i].y, sine.y)
      annotation(
        Line(
          points={{-92, 60}, {-92, 60}, {-98, 60}, {-98, 60}, {-98, 60}, {-98, 30}, {-119, 30}},
          color={0, 0, 127}));
    connect(pipSouth1.port_b, valSouth1[i].port_a)
      annotation(
        Line(
          points={{-80, 28}, {-80, 28}, {-80, 50}},
          color={0, 127, 255}));
  ...
  for i in 1 : 8 loop
    ...
    connect(tabsSouth2[i].port_b, valSouth.port_3)
      annotation(
        Line(
          points={{-40, 100}, {-40, 118}, {-6, 118}, {-6,-50}, {-50,-50}},
          color={0, 127, 255}));
    connect(valSouth2[i].y, sine.y)
      annotation(
        Line(
          points={{-52, 60}, {-48, 60}, {-60, 60}, {-60, 30}, {-119, 30}},
          color={0, 0, 127}));
    connect(pipSouth2.port_b, valSouth2[i].port_a)
      annotation(
        Line(
          points={{-40, 28}, {-40, 39}, {-40, 50}},
          color={0, 127, 255}));
  ...
  connect(pmpSouth.stage, pmpNorth.stage)
    annotation(
      Line(
        points={{-72,-20}, {-88,-20}, {-88,-32}, {36,-32}, {36,-20}, {48,-20}},
        color={255, 127, 0}));
  connect(booleanToInteger.y, pmpSouth.stage)
    annotation(
      Line(
        points={{-119,-20}, {-108,-20}, {-108,-32}, {-88,-32}, {-88,-20}, {-72,-20}},
        color={255, 127, 0}));
  connect(stepPump.y, booleanToInteger.u)
    annotation(
      Line(
        points={{-159,-20}, {-159,-20}, {-142,-20}},
        color={255, 0, 255}));
  connect(valSouth1.y, valNorth1.y)
    annotation(
      Line(
        points={{-92, 60}, {-98, 60}, {-98, 30}, {-102, 30}, {14, 30}, {14, 60}, {28, 60}},
        color={0, 0, 127}));
  connect(valSouth2.y, valNorth2.y)
    annotation(
      Line(
        points={{-52, 60}, {-60, 60}, {-60, 30}, {60, 30}, {60, 30}, {60, 60}, {68, 60}},
        color={0, 0, 127}));
  connect(valSouth.port_2, pmpSouth.port_a)
    annotation(
      Line(
        points={{-60,-40}, {-60,-38}, {-60,-30}},
        color={0, 127, 255}));
  ...
  connect(valNorth.y, valSouth.y)
    annotation(
      Line(
        points={{72,-50}, {70,-50}, {70,-36}, {-72,-36}, {-72,-50}},
        color={0, 0, 127}));
  connect(bou.ports[1], heater.port_a)
    annotation(
      Line(
        points={{-80,-130}, {-80,-130}, {-76,-130}, {-74,-130}, {-74,-100}, {-70,-100}},
        color={0, 127, 255}));
  connect(spl1.port_3, spl.port_3)
    annotation(
      Line(
        points={{-30,-120}, {-30,-110}},
        color={0, 127, 255}));
  ...
  connect(pumpHea.port_a, spl1.port_2)
    annotation(
      Line(
        points={{-50,-130}, {-46,-130}, {-40,-130}},
        color={0, 127, 255}));
  connect(pumpHea.port_b, heater.port_a)
    annotation(
      Line(
        points={{-70,-130}, {-74,-130}, {-74,-104}, {-74,-100}, {-70,-100}},
        color={0, 127, 255}));
  connect(Thot.y, heater.TSet)
    annotation(
      Line(
        points={{-83.4,-92}, {-83.4,-92}, {-72,-92}},
        color={0, 0, 127}));
  connect(spl1.port_1, valSouth.port_3)
    annotation(
      Line(
        points={{-20,-130}, {-20,-130}, {0,-130}, {0,-52}, {-50,-52}, {-50,-50}},
        color={0, 127, 255}));
  connect(spl.port_2, valHea.port_a)
    annotation(
      Line(
        points={{-20,-100}, {-10,-100}, {-10,-96}},
        color={0, 127, 255}));
  connect(valHea.port_b, valSouth.port_1)
    annotation(
      Line(
        points={{-10,-76}, {-10,-76}, {-10,-64}, {-60,-64}, {-60,-60}},
        color={0, 127, 255}));
  connect(stepValve.y, valSouth.y)
    annotation(
      Line(
        points={{-119,-50}, {-119,-50}, {-72,-50}},
        color={0, 0, 127}));
  connect(stepValve.y, valHea.y)
    annotation(
      Line(
        points={{-119,-50}, {-112,-50}, {-112,-76}, {-28,-76}, {-28,-86}, {-22,-86}},
        color={0, 0, 127}));
  connect(valCooExp.y, valCoo.y)
    annotation(
      Line(
        points={{-119,-70}, {32,-70}, {32,-86}, {24,-86}, {24,-86}},
        color={0, 0, 127}));
  connect(valCoo.port_b, valSouth.port_1)
    annotation(
      Line(
        points={{12,-76}, {12,-64}, {-60,-64}, {-60,-60}},
        color={0, 127, 255}));
  connect(valCoo.port_b, valNorth.port_1)
    annotation(
      Line(
        points={{12,-76}, {12,-76}, {12,-64}, {60,-64}, {60,-60}},
        color={0, 127, 255}));
  connect(spl2.port_2, valCoo.port_a)
    annotation(
      Line(
        points={{20,-100}, {12,-100}, {12,-96}},
        color={0, 127, 255}));
  ...
  connect(spl3.port_3, spl2.port_3)
    annotation(
      Line(
        points={{30,-120}, {30,-115}, {30,-110}},
        color={0, 127, 255}));
  connect(spl3.port_2, pumpCoo.port_a)
    annotation(
      Line(
        points={{40,-130}, {43,-130}, {46,-130}},
        color={0, 127, 255}));
  connect(vol.ports[1], pumpCoo.port_b)
    annotation(
      Line(
        points={{66,-100}, {66,-100}, {66,-130}},
        color={0, 127, 255}));
  connect(vol.ports[2], spl2.port_1)
    annotation(
      Line(
        points={{62,-100}, {62,-100}, {40,-100}},
        color={0, 127, 255}));
  connect(Tcold.port, vol.heatPort)
    annotation(
      Line(
        points={{80,-90}, {77,-90}, {74,-90}},
        color={191, 0, 0}));
  connect(pumpHea.stage, pumpCoo.stage)
    annotation(
      Line(
        points={{-60,-118}, {-60,-114}, {56,-114}, {56,-118}, {56,-118}},
        color={255, 127, 0}));
  connect(pumpHea.stage, booleanToInteger.y)
    annotation(
      Line(
        points={{-60,-118}, {-60,-118}, {-60,-114}, {-108,-114}, {-108,-20}, {-119,-20}},
        color={255, 127, 0}));
  connect(valNorth.port_3, spl3.port_1)
    annotation(
      Line(
        points={{50,-50}, {50,-52}, {0,-52}, {0,-130}, {20,-130}},
        color={0, 127, 255}));
  ...
  annotation(
    Diagram(
      ...
      graphics={Rectangle(
        ...
        textString="South"), Text(
        extent={{34, 122}, {64, 130}},
        lineColor={28, 108, 200},
        fillColor={215, 215, 215},
        fillPattern=FillPattern.Solid,
        textString="North"), Rectangle(
...
First implementation.
    ...
    __Dymola_Commands(
      file="Resources/Scripts/Dymola/Fluid/Examples/FlowSystem/Basic.mos"
        "Simulate and plot"));
end Basic;
