  ...
  Modelica.Blocks.Sources.RealExpression mCond(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-40, 40}, {-20, 20}})));
  Buildings.Utilities.Psychrometrics.X_pTphi xSat(
    use_p_in=false)
    ...
    annotation(
      Placement(
        transformation(
          extent={{30, 52}, {50, 32}})));
  Modelica.Blocks.Sources.Constant phiSat(
    k=1)
    "Humidity of 100%"
    annotation(
      Placement(
...
Submitted: 11th Modelica Conference. Paris, France. Sep. 2015.
    ...
    experiment(
      ...
      StopTime=20),
    __Dymola_Commands(
      file="Resources/Scripts/Dymola/Fluid/Examples/Performance/Example4.mos"
        "Simulate and plot"));
end Example4;
