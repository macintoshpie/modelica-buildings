...
model Example8
  ...
  Real a=sin(time + 1);
  Real b=sin(time + 1);
  annotation(Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-120,-40}, {40, 60}}), graphics={Text(extent={{-62, 24}, {-18,-4}}, lineColor={0, 0, 255}, textString="See code")}), experiment(Tolerance=1e-6, StopTime=50), Documentation(revisions="<html>
<ul>
<li>
...
</html>"), __Dymola_Commands(file="Resources/Scripts/Dymola/Fluid/Examples/Performance/Example8.mos"
    "Simulate and plot"));
end Example8;
