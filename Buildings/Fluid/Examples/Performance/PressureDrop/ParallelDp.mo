...
model ParallelDp
  ...
  Modelica.Blocks.Sources.Pulse pulse_p(period=1, offset=Medium.p_default, amplitude=dp_nominal)
    "Pulse input for pressure"
  ...
  Sources.Boundary_pT sin(redeclare package Medium=Medium, nPorts=1)
    ...
    annotation(Placement(transformation(extent={{60,-10}, {40, 10}})));
equation
  connect(pulse_p.y, sou.p_in)
    annotation(Line(points={{-79, 8}, {-70, 8}, {-62, 8}}, color={0, 0, 127}));
...
</html>"), experiment(Tolerance=1e-6, StopTime=1), __Dymola_Commands(file="Resources/Scripts/Dymola/Fluid/Examples/Performance/PressureDrop/ParallelDp.mos"
    "Simulate and plot"));
end ParallelDp;
