...
model ParallelFlowOptimised
  ...
  extends ParallelFlow(resParallel(each from_dp=true));
...
</html>"), experiment(Tolerance=1e-6, StopTime=1), __Dymola_Commands(file="Resources/Scripts/Dymola/Fluid/Examples/Performance/PressureDrop/ParallelFlowOptimised.mos"
    "Simulate and plot"));
