...
model SeriesFlow
  ...
  Modelica.Blocks.Sources.Pulse pulse_p(amplitude=1, period=1, offset=0)
...
equation
  ...
  connect(sou.m_flow_in, pulse_p.y)
    annotation(Line(points={{-62, 8}, {-62, 8}, {-79, 8}}, color={0, 0, 127}));
...
</html>"), experiment(Tolerance=1e-06, StopTime=1), __Dymola_Commands(file="Resources/Scripts/Dymola/Fluid/Examples/Performance/PressureDrop/SeriesFlow.mos"
    "Simulate and plot"));
end SeriesFlow;
