...
model SeriesParallelDpOptimised
  ...
  extends SeriesParallelDp(res2(from_dp=true), resParallel(each from_dp=true));
...
</html>"), experiment(Tolerance=1e-6, StopTime=1), __Dymola_Commands(file="Resources/Scripts/Dymola/Fluid/Examples/Performance/PressureDrop/SeriesParallelDpOptimised.mos"
    "Simulate and plot"));
