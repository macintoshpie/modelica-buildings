  ...
  Modelica.Blocks.Sources.Constant const(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-40, 0}, {-20, 20}})));
  Modelica.Blocks.Sources.BooleanConstant allowFlowReversal(
    k=false)
...
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=10000),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Examples/ResistanceVolumeFlowReversal.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
