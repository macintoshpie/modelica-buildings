...
model Outlet
  ...
  Buildings.Fluid.FMI.Interfaces.Outlet outlet(redeclare final package Medium=Medium, final allowFlowReversal=allowFlowReversal, final use_p_in=use_p_in)
    "Fluid outlet"
...
equation
  ...
  outlet.forward.T=Medium.temperature_phX(p=p_in_internal, h=inStream(port_a.h_outflow), X=cat(1, inStream(port_a.Xi_outflow), {1-sum(inStream(port_a.Xi_outflow))}));
  ...
  bacPro_internal.T=Medium.temperature_phX(p=p_in_internal, h=port_a.h_outflow, X=port_a.Xi_outflow);
  ...
  annotation(defaultComponentName="bouOut", Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100}, {100, 100}}), graphics={Rectangle(extent={{60, 60}, {-60,-60}}, lineColor={0, 0, 0}, fillPattern=FillPattern.Sphere, fillColor={0, 127, 255}), Text(extent={{-150, 110}, {150, 150}}, textString="%name", lineColor={0, 0, 255}), Line(points={{60, 0}, {100, 0}}, color={0, 0, 255}), Rectangle(extent={{-100, 20}, {-60,-21}}, lineColor={0, 0, 0}, fillPattern=FillPattern.HorizontalCylinder, fillColor={0, 127, 255}), Text(extent={{66, 40}, {100, 0}}, lineColor={0, 0, 255}, textString="outlet"), Line(points={{0,-60}, {0,-100}}, color={0, 0, 255}, smooth=Smooth.None, visible=use_p_in), Text(extent={{10,-64}, {44,-104}}, lineColor={0, 0, 255}, textString="p", visible=use_p_in)}), Documentation(info="<html>
<p>
