...
block AirToOutlet
  ...
  Modelica.Blocks.Interfaces.RealInput Xi[Medium.nXi](each final unit="kg/kg")
    ...
    annotation(Placement(visible=Medium.nXi > 0, transformation(extent={{-140,-60}, {-100,-20}})));
  Modelica.Blocks.Interfaces.RealInput C[Medium.nC](final quantity=Medium.extraPropertiesNames)
    "Prescribed boundary trace substances"
    annotation(Placement(visible=Medium.nC > 0, transformation(extent={{-140,-100}, {-100,-60}})));
  Buildings.Fluid.FMI.Interfaces.Outlet outlet(redeclare final package Medium=Medium, final allowFlowReversal=allowFlowReversal, final use_p_in=false)
    "Fluid outlet"
    annotation(Placement(transformation(extent={{100,-10}, {120, 10}})));
  Modelica.Blocks.Interfaces.RealOutput TAirZon(final unit="K", displayUnit="degC") if allowFlowReversal
  ...
  Modelica.Blocks.Interfaces.RealOutput X_wZon(final unit="kg/kg") if Medium.nXi > 0 and allowFlowReversal
  ...
  Modelica.Blocks.Interfaces.RealOutput CZon[Medium.nC](final quantity=Medium.extraPropertiesNames) if allowFlowReversal
...
protected
  ...
  Buildings.Fluid.FMI.Interfaces.FluidProperties bacPro_internal(redeclare final package Medium=Medium)
    "Internal connector for fluid properties for back flow";
  Modelica.Blocks.Interfaces.RealOutput TAirZon_internal(final unit="K", displayUnit="degC")
    "Conditinal connector for zone air temperature";
  Modelica.Blocks.Interfaces.RealOutput X_wZon_internal(final unit="kg/kg")
    "Internal connector for zone water vapor mass fraction";
  Modelica.Blocks.Interfaces.RealOutput X_wZon_internal2(final unit="kg/kg")=0 if Medium.nXi == 0 or not allowFlowReversal
...
equation
  ...
  annotation(defaultComponentName="con", Documentation(info="<html>
<p>
...
</html>"), Icon(graphics={Text(extent={{-98, 52}, {-66, 26}}, lineColor={0, 0, 127}, textString="h"), Text(extent={{-92, 94}, {-28, 68}}, lineColor={0, 0, 127}, textString="m_flow"), Text(extent={{-104,-26}, {-40,-52}}, lineColor={0, 0, 127}, visible=Medium.nXi > 0, textString="Xi"), Text(extent={{-104,-64}, {-40,-90}}, lineColor={0, 0, 127}, visible=Medium.nC > 0, textString="C"), Polygon(points={{90, 0}, {30, 20}, {30,-20}, {90, 0}}, lineColor={191, 0, 0}, fillColor={191, 0, 0}, fillPattern=FillPattern.Solid), Line(points={{-90, 0}, {30, 0}}, color={191, 0, 0}), Line(visible=allowFlowReversal, points={{-34, 25}, {11,-8}, {35,-64}}, color={0, 0, 255}, smooth=Smooth.Bezier, origin={34,-39}, rotation=90), Polygon(visible=allowFlowReversal, points={{30, 6}, {18, 22}, {10, 4}, {30, 6}}, lineColor={0, 0, 255}, fillColor={0, 0, 255}, fillPattern=FillPattern.Solid, origin={-4,-58}, rotation=270)}));
end AirToOutlet;
