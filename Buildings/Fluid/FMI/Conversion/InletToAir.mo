...
block InletToAir
  ...
  Buildings.Fluid.FMI.Interfaces.Inlet inlet(redeclare final package Medium=Medium, final allowFlowReversal=allowFlowReversal, final use_p_in=false)
    "Fluid outlet"
    annotation(Placement(transformation(extent={{-120,-10}, {-100, 10}})));
  Modelica.Blocks.Interfaces.RealInput TAirZon(final unit="K", displayUnit="degC") if allowFlowReversal
  ...
  Modelica.Blocks.Interfaces.RealInput X_wZon(final unit="kg/kg") if Medium.nXi > 0 and allowFlowReversal
  ...
  Modelica.Blocks.Interfaces.RealInput CZon[Medium.nC](final quantity=Medium.extraPropertiesNames) if allowFlowReversal
    "Zone air trace substances"
    annotation(Placement(visible=allowFloWReserval, transformation(extent={{-20,-20}, {20, 20}}, rotation=90, origin={60,-120}), iconTransformation(extent={{-20,-20}, {20, 20}}, rotation=90, origin={60,-120})));
  Modelica.Blocks.Interfaces.RealOutput m_flow(final unit="kg/s")
  ...
  Modelica.Blocks.Interfaces.RealOutput X_w(final unit="kg/kg") if Medium.nXi > 0
    "Water mass fraction per total air mass of the inlet"
    annotation(Placement(transformation(extent={{100,-60}, {140,-20}})));
  Modelica.Blocks.Interfaces.RealOutput C[Medium.nC](final quantity=Medium.extraPropertiesNames)
...
protected
  ...
  Modelica.Blocks.Interfaces.RealInput TAirZon_internal(final unit="K", displayUnit="degC")
    "Conditinal connector for zone air temperature";
  Modelica.Blocks.Interfaces.RealInput X_wZon_internal(final unit="kg/kg")
    "Internal connector for zone water vapor mass fraction";
  Modelica.Blocks.Interfaces.RealInput X_wZon_internal2(final unit="kg/kg")=0 if Medium.nXi == 0 or not allowFlowReversal
...
</html>"), Icon(graphics={Text(extent={{58, 60}, {90, 34}}, lineColor={0, 0, 127}, textString="T"), Text(extent={{20, 96}, {84, 70}}, lineColor={0, 0, 127}, textString="m_flow"), Text(extent={{28,-26}, {92,-52}}, lineColor={0, 0, 127}, textString="X_w"), Text(extent={{36,-66}, {100,-92}}, lineColor={0, 0, 127}, textString="C"), Line(points={{-80, 0}, {40, 0}}, color={191, 0, 0}), Polygon(points={{82, 0}, {22, 20}, {22,-20}, {82, 0}}, lineColor={191, 0, 0}, fillColor={191, 0, 0}, fillPattern=FillPattern.Solid), Text(visible=allowFlowReversal, extent={{-78,-70}, {-46,-96}}, lineColor={0, 0, 127}, textString="T"), Text(visible=allowFlowReversal and Medium.nXi > 0, extent={{-28,-68}, {36,-94}}, lineColor={0, 0, 127}, textString="X_w"), Polygon(visible=allowFlowReversal, points={{30, 0}, {20, 20}, {8, 0}, {30, 0}}, lineColor={0, 0, 255}, fillColor={0, 0, 255}, fillPattern=FillPattern.Solid, origin={-62,-8}, rotation=180), Line(visible=allowFlowReversal, points={{-76,-16}, {-34,-36}, {-8,-66}}, color={0, 0, 255}, smooth=Smooth.Bezier)}));
end InletToAir;
