  ...
  Modelica.Blocks.Sources.Constant h(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60, 20}, {-40, 40}})));
  Modelica.Blocks.Sources.Constant Xi[1](
    k={0.01})
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60,-20}, {-40, 0}})));
  Modelica.Blocks.Sources.Constant C[1](
    k={1E-5})
    "Trace substances"
    annotation(
      Placement(
...
equation
  connect(m_flow.y, conAirNoC.m_flow)
    annotation(
      Line(
        points={{-39, 70}, {-26, 70}, {-26, 68}, {-2, 68}},
        color={0, 0, 127}));
  connect(h.y, conAirNoC.h)
    annotation(
      Line(
        points={{-39, 30}, {-26.5, 30}, {-26.5, 64}, {-2, 64}},
        color={0, 0, 127}));
  connect(Xi.y, conAirNoC.Xi)
    annotation(
      Line(
        points={{-39,-10}, {-20,-10}, {-20, 56}, {-2, 56}},
        color={0, 0, 127}));
  connect(m_flow.y, conAirWithC.m_flow)
    annotation(
      Line(
        points={{-39, 70}, {-26, 70}, {-26, 28}, {-2, 28}},
        color={0, 0, 127}));
  connect(h.y, conAirWithC.h)
    annotation(
      Line(
        points={{-39, 30}, {-26.5, 30}, {-26.5, 24}, {-2, 24}},
        color={0, 0, 127}));
  connect(Xi.y, conAirWithC.Xi)
    annotation(
      Line(
        points={{-39,-10}, {-20,-10}, {-20, 16}, {-2, 16}},
        color={0, 0, 127}));
  connect(m_flow.y, conDryAirNoC.m_flow)
    annotation(
      Line(
        points={{-39, 70}, {-26, 70}, {-26,-22}, {-2,-22}},
        color={0, 0, 127}));
  connect(h.y, conDryAirNoC.h)
    annotation(
      Line(
        points={{-39, 30}, {-26.5, 30}, {-26.5,-26}, {-2,-26}},
        color={0, 0, 127}));
  connect(m_flow.y, conDryAirWithC.m_flow)
    annotation(
      Line(
        points={{-39, 70}, {-26, 70}, {-26,-62}, {-2,-62}},
        color={0, 0, 127}));
  connect(h.y, conDryAirWithC.h)
    annotation(
      Line(
        points={{-39, 30}, {-26.5, 30}, {-26.5,-66}, {-2,-66}},
        color={0, 0, 127}));
  connect(C.y, conAirWithC.C)
    annotation(
      Line(
        points={{-39,-50}, {-14,-50}, {-14, 12}, {-2, 12}},
        color={0, 0, 127}));
  connect(C.y, conDryAirWithC.C)
    annotation(
      Line(
        points={{-39,-50}, {-14,-50}, {-14,-78}, {-2,-78}},
        color={0, 0, 127}));
  annotation(
    Documentation(
      info="<html>
...
First implementation.
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/FMI/Conversion/Validation/AirToOutlet.mos"
        "Simulate and plot"),
    experiment(
      Tolerance=1e-6,
      StopTime=1.0));
