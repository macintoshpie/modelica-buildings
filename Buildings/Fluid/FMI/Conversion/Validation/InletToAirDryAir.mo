...
model InletToAirDryAir
  ...
  extends Buildings.Fluid.FMI.Conversion.Validation.InletToAirMoistAir(redeclare replaceable package Medium=Modelica.Media.Air.SimpleAir);
...
</html>"), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/FMI/Conversion/Validation/InletToAirDryAir.mos"
