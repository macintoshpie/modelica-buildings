...
model InletToAirMoistAirCO2
  ...
  extends Buildings.Fluid.FMI.Conversion.Validation.InletToAirDryAir(redeclare replaceable package Medium=Buildings.Media.Air(extraPropertiesNames={"CO2"}));
...
equation
  connect(CRev.y, conAirRevFlo.CZon)
    annotation(Line(points={{71,-70}, {60,-70}, {36,-70}, {36,-42}}, color={0, 0, 127}));
...
</html>"), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/FMI/Conversion/Validation/InletToAirMoistAirCO2.mos"
