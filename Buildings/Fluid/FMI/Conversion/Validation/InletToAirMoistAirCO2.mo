...
model InletToAirMoistAirCO2
  ...
  Modelica.Blocks.Sources.Constant CRev[Medium.nC](
    each k=0.8)
...
equation
  connect(CRev.y, conAirRevFlo.CZon)
    annotation(
      Line(
        points={{71,-70}, {60,-70}, {36,-70}, {36,-42}},
        color={0, 0, 127}));
  annotation(
    Documentation(
      info="<html>
...
First implementation.
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/FMI/Conversion/Validation/InletToAirMoistAirCO2.mos"
        "Simulate and plot"),
    experiment(
      Tolerance=1e-6,
      StopTime=1.0));
