...
block IdealSource_m_flow
  ...
  extends Buildings.Fluid.FMI.ExportContainers.PartialTwoPort(redeclare replaceable package Medium=Buildings.Media.Air);
...
equation
  assert(abs(inlet.m_flow-outlet.m_flow) < 1E-2, "The mass flow rate of port_a and port_b is not conserved.
...
</html>"), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/FMI/ExportContainers/Examples/FMUs/IdealSource_m_flow.mos"
    "Export FMU"), Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100}, {100, 100}}), graphics={Rectangle(extent={{-100, 14}, {100,-16}}, lineColor={0, 0, 0}, fillColor={0, 127, 255}, fillPattern=FillPattern.HorizontalCylinder), Text(extent={{-94, 110}, {-50, 52}}, lineColor={0, 0, 127}, textString="m_flow"), Ellipse(extent={{-16, 18}, {24,-22}}, lineColor={0, 0, 0}, fillPattern=FillPattern.Sphere, fillColor={0, 100, 199}), Polygon(points={{-8, 14}, {-8,-16}, {22,-2}, {-8, 14}}, lineColor={0, 0, 0}, pattern=LinePattern.None, fillPattern=FillPattern.HorizontalCylinder, fillColor={255, 255, 255})}));
