...
block PressureDrop
  ...
  extends Buildings.Fluid.FMI.ExportContainers.ReplaceableTwoPort(
    ...
    redeclare final Buildings.Fluid.FixedResistances.PressureDrop com(
...
First implementation.
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/FMI/ExportContainers/Examples/FMUs/PressureDrop.mos"
        "Export FMU"),
    Icon(
      graphics={Rectangle(
        extent={{-64, 24}, {70,-26}},
