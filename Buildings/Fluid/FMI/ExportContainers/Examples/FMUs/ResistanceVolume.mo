...
block ResistanceVolume
  ...
  Modelica.Blocks.Sources.RealExpression dpCom(
    y=res.port_a.p-res.port_b.p) if use_p_in
...
First implementation.
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/FMI/ExportContainers/Examples/FMUs/ResistanceVolume.mos"
        "Export FMU"),
    Icon(
      graphics={Rectangle(
        extent={{-64, 24}, {-6,-26}},
