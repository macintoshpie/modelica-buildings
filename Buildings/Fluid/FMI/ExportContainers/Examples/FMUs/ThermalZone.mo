...
equation
  ...
  connect(TAirOut.T, weaBus.TDryBul)
    annotation(
      Line(
        points={{-32, 120}, {-40, 120}, {-40, 160}, {-10, 160}},
        color={0, 0, 127}),
      Text(
        textString="%second",
        index=1,
  ...
  connect(theZonAda.heaPorAir, vol.heatPort)
    annotation(
      Line(
        points={{-120, 152}, {60, 152}, {60, 40}, {80, 40}},
        color={191, 0, 0}));
  connect(TOut, weaBus.TDryBul)
    annotation(
      Line(
        points={{0,-160}, {0,-160}, {0,-120}, {0, 160}, {-10, 160}},
        color={0, 0, 127}));
  connect(vol.mWat_flow, mWat_flow.y)
    annotation(
      Line(
        points={{78, 48}, {78, 48}, {54, 48}, {54, 80}, {31, 80}},
        color={0, 0, 127}));
  connect(theZonAda.ports, senMasFlo.port_a)
    annotation(
      Line(
        points={{-120, 160}, {-100, 160}, {-100, 120}, {-88, 120}},
        color={0, 127, 255}));
  connect(senMasFlo.port_b, vol.ports[1 : 2])
    annotation(
      Line(
        points={{-68, 120}, {-60, 120}, {-60, 20}, {92, 20}, {92, 30}},
        color={0, 127, 255}));
  connect(temSen.port, vol.heatPort)
    annotation(
      Line(
        points={{-60, 0}, {60, 0}, {60, 40}, {80, 40}},
        color={191, 0, 0}));
...
First implementation.
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/FMI/ExportContainers/Examples/FMUs/ThermalZone.mos"
        "Export FMU"));
end ThermalZone;
