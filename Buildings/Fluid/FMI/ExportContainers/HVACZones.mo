...
partial block HVACZones
  ...
  Modelica.Blocks.Interfaces.RealInput TRadZon[nZon](
    ...
    annotation(
      Placement(
        transformation(
          extent={{200, 32}, {160, 72}}),
        iconTransformation(
          extent={{180, 52}, {160, 72}})));
  ...
  Modelica.Blocks.Interfaces.RealOutput QGaiLat_flow[nZon](
    ...
    annotation(
      Placement(
        transformation(
          extent={{160,-160}, {200,-120}}),
        iconTransformation(
          extent={{160,-150}, {180,-130}})));
  ...
  for iZon in 1 : nZon loop
    for iPor in 1 : nPorts loop
      connect(hvacAda[iZon].fluPor[iPor], fluPor[iZon, iPor])
        annotation(
          Line(
            points={{141, 140}, {154, 140}, {170, 140}},
            color={0, 0, 255}));
    end for;
  end for;
  annotation(
