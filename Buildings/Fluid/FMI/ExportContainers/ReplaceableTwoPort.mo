...
block ReplaceableTwoPort
  ...
  replaceable Buildings.Fluid.Interfaces.PartialTwoPort com constrainedby Buildings.Fluid.Interfaces.PartialTwoPort(
  ...
  Modelica.Blocks.Sources.RealExpression dpCom(
    y=com.port_a.p-com.port_b.p) if use_p_in
