...
Buildings.Fluid.FMI.ExportContainers.Validation.RoomHVAC
      ...
      Icon(
        graphics={Rectangle(
          ...
          fillPattern=FillPattern.Solid,
          fillColor={150, 150, 150}), Rectangle(
          extent={{-2,-4}, {20, 26}},
...
equation
  connect(hvaCon.fluPor, rooCon.fluPor)
    annotation(
      Line(
        points={{-39.375, 38.75}, {19.375, 38.75}},
        color={0, 0, 255}));
  connect(hvaCon2.fluPor, rooCon2.fluPor)
    annotation(
      Line(
        points={{-39.375,-22.3529}, {-10,-22.3529}, {-10,-21.25}, {19.375,-21.25}},
        color={0, 0, 255}));
  connect(rooCon.TRad, hvaCon.TRadZon)
    annotation(
      Line(
        points={{19.375, 28.75}, {-20, 28.75}, {-20, 33.8125}, {-39.3125, 33.8125}},
        color={0, 0, 127}));
  connect(rooCon2.TRad1, hvaCon2.TRadZon[1])
    annotation(
      Line(
        points={{19.375,-30}, {-20,-30}, {-20,-26.9412}, {-39.375,-26.9412}},
        color={0, 0, 127}));
  connect(rooCon2.TRad2, hvaCon2.TRadZon[2])
    annotation(
      Line(
        points={{19.375,-32.5}, {-20,-32.5}, {-20,-26.9412}, {-39.375,-26.9412}},
        color={0, 0, 127}));
  annotation(
    Documentation(
      info="<html>
...
First implementation.
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/FMI/ExportContainers/Validation/RoomHVAC.mos"
        "Simulate and plot"),
    experiment(
