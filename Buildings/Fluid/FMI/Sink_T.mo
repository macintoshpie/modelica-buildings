...
model Sink_T
  ...
  Modelica.Blocks.Interfaces.RealInput T_in(unit="K", displayUnit="degC", min=0)
    "Prescribed boundary temperature"
    annotation(Placement(transformation(extent={{-140, 60}, {-100, 100}})));
  Modelica.Blocks.Interfaces.RealInput X_w_in(unit="1") if Medium.nXi > 0
  ...
  Buildings.Fluid.FMI.Interfaces.PressureOutput p if use_p_in
    "Pressure"
    annotation(Placement(transformation(extent={{-10,-10}, {10, 10}}, rotation=180, origin={-110,-80}), iconTransformation(extent={{-20,-20}, {20, 20}}, rotation=180, origin={-120,-80})));
protected
...
equation
  ...
  annotation(Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100}, {100, 100}}), graphics={Rectangle(extent={{-100, 100}, {100,-100}}, lineColor={0, 0, 0}, fillPattern=FillPattern.Solid, fillColor={255, 255, 255}), Text(extent={{-98,-90}, {-62,-72}}, lineColor={0, 0, 255}, textString="P", visible=use_p_in)}), Documentation(info="<html>
<p>
