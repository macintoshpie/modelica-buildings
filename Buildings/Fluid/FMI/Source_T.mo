...
model Source_T
  ...
  Buildings.Fluid.FMI.Interfaces.PressureInput p_in if use_p_in
  ...
  Interfaces.Outlet outlet(redeclare final package Medium=Medium, final allowFlowReversal=allowFlowReversal, final use_p_in=use_p_in)
    "Fluid port"
...
equation
  ...
  annotation(Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100}, {100, 100}}), graphics={Rectangle(extent={{-100, 100}, {100,-100}}, lineColor={0, 0, 0}, fillPattern=FillPattern.Solid, fillColor={255, 255, 255}), Text(extent={{-94, 60}, {94,-58}}, lineColor={0, 0, 255}, textString="m_flow
p")}), Documentation(info="<html>
<p>
