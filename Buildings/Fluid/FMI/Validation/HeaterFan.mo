...
model HeaterFan
  ...
  ExportContainers.Examples.FMUs.Fan floMac(redeclare final package Medium=Medium, m_flow_nominal=m_flow_nominal, dp_nominal=dp_nominal, use_p_in=use_p_in)
    "Flow machine with pressure raise as an input"
    annotation(Placement(transformation(extent={{20,-10}, {40, 10}})));
  ExportContainers.Examples.FMUs.HeaterCooler_u hea(redeclare final package Medium=Medium, m_flow_nominal=m_flow_nominal, dp_nominal=dp_nominal, Q_flow_nominal=Q_flow_nominal, use_p_in=use_p_in)
    "Heater"
...
equation
  ...
  connect(m_flow.y, sou.m_flow_in)
    annotation(Line(points={{-79, 70}, {-68, 70}, {-68, 10}, {-62, 10}}, color={0, 0, 127}, smooth=Smooth.None));
  ...
  connect(X_w_in.y, sou.X_w_in)
    annotation(Line(points={{-79,-20}, {-70,-20}, {-70,-5}, {-62,-5}}, color={0, 0, 127}, smooth=Smooth.None));
  connect(sin.X_w_in, X_w_bac.y)
    annotation(Line(points={{82, 3}, {91, 3}, {91, 4}, {99, 4}}, color={0, 0, 127}, smooth=Smooth.None));
...
</html>"), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/FMI/Validation/HeaterFan.mos"
