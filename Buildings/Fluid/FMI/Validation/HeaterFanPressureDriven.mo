...
model HeaterFanPressureDriven
  ...
  ExportContainers.Examples.FMUs.HeaterCooler_u hea(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-20,-10}, {0, 10}})));
  Modelica.Blocks.Sources.Constant dp(
    k=dp_nominal)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-20, 40}, {0, 60}})));
  Modelica.Blocks.Sources.Constant uHea(
    k=0.2)
  ...
  Modelica.Blocks.Sources.Constant X_w_in(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-100,-30}, {-80,-10}})));
  Modelica.Blocks.Sources.Constant TBac(
    k=303.15)
  ...
  Modelica.Blocks.Sources.Constant X_w_bac(
    k=0.015)
...
First implementation.
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/FMI/Validation/HeaterFanPressureDriven.mos"
        "Simulate and plot"),
    experiment(
      Tolerance=1e-6,
      StopTime=1.0));
