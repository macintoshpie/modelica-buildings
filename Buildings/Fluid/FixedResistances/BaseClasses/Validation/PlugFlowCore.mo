  ...
  Buildings.Fluid.FixedResistances.BaseClasses.PlugFlowCore pip(
    ...
    annotation(
      Placement(
        transformation(
          extent={{0,-10}, {20, 10}})));
  Buildings.HeatTransfer.Sources.FixedTemperature bou(
    T=283.15)
...
equation
  ...
  annotation(
    __Dymola_Commands(
      file="Resources/Scripts/Dymola/Fluid/FixedResistances/BaseClasses/Validation/PlugFlowCore.mos"
        "Simulate and Plot"),
    experiment(
      StopTime=1000,
      Tolerance=1e-006),
