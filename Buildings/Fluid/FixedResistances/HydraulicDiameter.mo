...
protected
  ...
  annotation(defaultComponentName="res", Documentation(info="<html>
<p>
...
</html>"), Icon(graphics={Text(extent={{-40, 18}, {38,-20}}, lineColor={255, 255, 255}, textString="dh")}));
