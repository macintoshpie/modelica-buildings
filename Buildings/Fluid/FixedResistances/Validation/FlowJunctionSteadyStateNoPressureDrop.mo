...
model FlowJunctionSteadyStateNoPressureDrop
  ...
  package Medium=Buildings.Media.Air
    "Medium model";
  Buildings.Fluid.FixedResistances.Junction spl(redeclare package Medium=Medium, m_flow_nominal={2, 2, 2}, energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState, dp_nominal={0, 0, 0})
    "Splitter"
    annotation(Placement(transformation(extent={{10,-10}, {30, 10}})));
  Buildings.Fluid.Sources.MassFlowSource_T bou1(redeclare package Medium=Medium, T=273.15 + 10, nPorts=1, use_m_flow_in=true)
  ...
  Buildings.Fluid.Sources.MassFlowSource_T bou3(redeclare package Medium=Medium, T=273.15 + 30, nPorts=1, use_m_flow_in=true)
    "Mass flow boundary condition"
    annotation(Placement(transformation(extent={{-60,-70}, {-40,-50}})));
  Modelica.Blocks.Sources.Ramp m1_flow(duration=20, startTime=20, height=1, offset=-1)
    "Ramp mass flow signal"
    annotation(Placement(transformation(extent={{-90,-2}, {-70, 18}})));
  Modelica.Blocks.Sources.Ramp m3_flow(height=1, duration=20, startTime=70, offset=1)
    "Ramp mass flow signal"
...
equation
  ...
  annotation(experiment(Tolerance=1e-6, StopTime=100), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/FixedResistances/Validation/FlowJunctionSteadyStateNoPressureDrop.mos"
