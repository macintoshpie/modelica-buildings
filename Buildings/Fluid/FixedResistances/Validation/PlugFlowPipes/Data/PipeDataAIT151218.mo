...
record PipeDataAIT151218
  ...
  extends BaseClasses.PipeDataBaseDefinition(
    final nCol=10,
    final filNam=Modelica.Utilities.Files.loadResource("modelica://Buildings/Resources/Data/Fluid/FixedResistances/Validation/PlugFlowPipes/PipeDataAIT151218.mos"));
  annotation(
    Documentation(
      revisions="<html>
<ul>
