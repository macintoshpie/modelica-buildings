...
record PipeDataULg151202
  ...
  extends Buildings.Fluid.FixedResistances.Validation.PlugFlowPipes.Data.BaseClasses.PipeDataULg(
    ...
    m_flowIni=0.589,
    final nCol=6,
    final filNam=Modelica.Utilities.Files.loadResource("modelica://Buildings/Resources/Data/Fluid/FixedResistances/Validation/PlugFlowPipes/PipeDataULg151202.mos"));
  annotation(
    Documentation(
      revisions="<html>
<ul>
