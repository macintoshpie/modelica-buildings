...
record PipeDataULg151204_4
  ...
  extends Buildings.Fluid.FixedResistances.Validation.PlugFlowPipes.Data.BaseClasses.PipeDataULg(
    ...
    m_flowIni=1.257,
    final nCol=6,
    final filNam=Modelica.Utilities.Files.loadResource("modelica://Buildings/Resources/Data/Fluid/FixedResistances/Validation/PlugFlowPipes/PipeDataULg151204_4.mos"));
  annotation(
    Documentation(
      revisions="<html>
<ul>
