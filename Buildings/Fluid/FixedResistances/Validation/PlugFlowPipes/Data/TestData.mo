...
model TestData
  ...
  Modelica.Blocks.Sources.CombiTimeTable combiTimeTable(tableOnFile=true, tableName="dat", fileName=pipeDataToBeRead.filNam, columns=2 : pipeDataToBeRead.nCol)
    annotation(Placement(transformation(extent={{10,-10}, {30, 10}})));
equation
  annotation(experiment(StopTime=603900, Interval=900, Tolerance=1e-6), Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-40,-40}, {60, 40}})), Documentation(info="<html>
...
</html>"), __Dymola_Commands(file="Resources/Scripts/Dymola/Fluid/FixedResistances/Validation/PlugFlowPipes/Data/TestData.mos"
    "Simulate and plot"));
end TestData;
