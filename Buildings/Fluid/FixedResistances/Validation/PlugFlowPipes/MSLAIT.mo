...
equation
  ...
  connect(senTem_p1.port_a, Point1.ports[1])
    annotation(
      Line(
        points={{124,-52}, {124,-74}},
        color={0, 127, 255}));
  connect(senTem_p1.port_b, pip0.port_a)
    annotation(
      Line(
        points={{124,-32}, {124,-18}},
        color={0, 127, 255}));
  ...
  connect(pip2.heatPorts, res2.port_a)
    annotation(
      Line(
        points={{-99.6, 40.1}, {-95.8, 40.1}, {-95.8, 40}, {-92, 40}},
        color={127, 0, 0}));
  connect(res2.port_b, col2.port_a)
    annotation(
      Line(
        points={{-72, 40}, {-66, 40}, {-66, 54}},
        color={191, 0, 0}));
  connect(pip5.heatPorts, res5.port_a)
    annotation(
      Line(
        points={{-22.1, 8.4}, {-22.1, 30}, {-22, 30}, {-22, 52}},
        color={127, 0, 0}));
  ...
  connect(res4.port_a, pip4.heatPorts)
    annotation(
      Line(
        points={{16, 52}, {16, 38.1}, {37.6, 38.1}},
        color={191, 0, 0}));
  ...
  connect(pip3.heatPorts, res3.port_a)
    annotation(
      Line(
        points={{-43.6,-48.1}, {-14,-48.1}, {-14,-48}},
        color={127, 0, 0}));
  ...
  connect(res1.port_a, pip1.heatPorts)
    annotation(
      Line(
        points={{78, 20}, {78, 8.4}, {77.9, 8.4}},
        color={191, 0, 0}));
  connect(res1.port_b, col1.port_a)
    annotation(
      Line(
        points={{78, 40}, {78, 46}, {92, 46}},
        color={191, 0, 0}));
  connect(pip0.heatPorts, res0.port_a)
    annotation(
      Line(
        points={{128.4,-7.9}, {135.2,-7.9}, {135.2,-8}, {142,-8}},
        color={127, 0, 0}));
  ...
  annotation(
    ...
    experiment(
      ...
      Tolerance=1e-006),
    __Dymola_Commands(
      file="Resources/Scripts/Dymola/Fluid/FixedResistances/Validation/PlugFlowPipes/MSLAIT.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
