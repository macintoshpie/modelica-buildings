...
equation
  ...
  connect(sou1.C_in, CIn.y)
    annotation(
      Line(
        points={{-64,-78}, {-70,-78}, {-70,-106}, {-75,-106}},
        color={0, 0, 127}));
  connect(Tin.y, sou1.T_in)
    annotation(
      Line(
        points={{-71, 30}, {-68, 30}, {-68,-66}, {-64,-66}},
        color={0, 0, 127}));
  annotation(
    __Dymola_Commands(
      file="Resources/Scripts/Dymola/Fluid/FixedResistances/Validation/PlugFlowPipes/TransportWaterAir.mos"
        "Simulate and Plot"),
    experiment(
      StopTime=1000,
      Tolerance=1e-006),
