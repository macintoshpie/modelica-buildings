...
model InternalHEXOneUTube
  ...
  Buildings.Fluid.Geothermal.Borefields.BaseClasses.Boreholes.BaseClasses.InternalHEXOneUTube intHex(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-48,-34}, {-28,-14}})));
  Real Rb_sim(
    unit="(m.K)/W")=((senTem.T + senTem1.T)/2-intHex.port_wall.T)/max(-intHex.port_wall.Q_flow/hSeg, 1);
...
equation
  ...
  annotation(
    ...
    experiment(
      ...
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/BaseClasses/Boreholes/BaseClasses/Examples/InternalHEXOneUTube.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
