    ...
    annotation(
      Placement(
        transformation(
          extent={{-60,-14}, {-40,-34}})));
  Real Rb_sim(
    unit="(m.K)/W")=((senTem.T + senTem1.T + senTem2.T + senTem3.T)/4-intHex.port_wall.T)/max(-intHex.port_wall.Q_flow/hSeg, 1);
...
equation
  ...
  annotation(
    ...
    experiment(
      ...
      Tolerance=1e-6),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/BaseClasses/Boreholes/BaseClasses/Examples/InternalHEXTwoUTube.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
