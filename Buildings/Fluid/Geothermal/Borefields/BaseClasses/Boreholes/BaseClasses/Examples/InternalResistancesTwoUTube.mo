...
model InternalResistancesTwoUTube
  ...
  Modelica.Blocks.Sources.Ramp T_ramp(height=20, duration=600, offset=T_start)
  ...
  Buildings.Fluid.Geothermal.Borefields.BaseClasses.Boreholes.BaseClasses.InternalResistancesTwoUTube intRes2UTub(hSeg=hSeg, T_start=T_start, borFieDat=borFieDat, Rgb_val=Rgb_val, RCondGro_val=RCondGro_val, Rgg1_val=Rgg1_val, Rgg2_val=Rgg2_val, energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
...
equation
  ...
  connect(TWal.port, intRes2UTub.port_wall)
    annotation(Line(points={{-50, 6}, {0, 6}, {0, 4}, {0, 0}}, color={191, 0, 0}));
  connect(TPip4.port, intRes2UTub.port_4)
    annotation(Line(points={{-50,-30}, {-30,-30}, {-30, 0}, {-10, 0}}, color={191, 0, 0}));
  connect(TPip3.port, intRes2UTub.port_3)
    annotation(Line(points={{10,-40}, {0,-40}, {0,-10}}, color={191, 0, 0}));
  annotation(experiment(StopTime=3600, Tolerance=1e-6), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/BaseClasses/Boreholes/BaseClasses/Examples/InternalResistancesTwoUTube.mos"
