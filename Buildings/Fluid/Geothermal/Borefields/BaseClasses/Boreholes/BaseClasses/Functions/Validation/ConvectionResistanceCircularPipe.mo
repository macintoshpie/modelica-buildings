...
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=10000.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/BaseClasses/Boreholes/BaseClasses/Functions/Validation/ConvectionResistanceCircularPipe.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
