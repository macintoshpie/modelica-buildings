...
model InternalResistancesOneUTubeNegative
  ...
  parameter Modelica.SIunits.ThermalResistance Rgg(
    fixed=false)
...
initial equation
  (x, Rgb, Rgg, RCondGro)=Buildings.Fluid.Geothermal.Borefields.BaseClasses.Boreholes.BaseClasses.Functions.internalResistancesOneUTube(
    hSeg=hSeg,
    rBor=rBor,
    rTub=rTub,
    eTub=eTub,
  ...
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/BaseClasses/Boreholes/BaseClasses/Functions/Validation/InternalResistancesOneUTubeNegative.mos"
        "Simulate and plot"),
    experiment(
      Tolerance=1e-6,
      StopTime=1.0),
