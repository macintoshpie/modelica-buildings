...
model MultipoleThermalResistances_OneUTube
  ...
  parameter Real[nPip, nPip] RDelta_Ref(each unit="(m.K)/W")={{1/3.680, 1/0.242}, {1/0.242, 1/3.724}}
    "Reference delta-circuit thermal resistances";
  parameter Real[nPip, nPip] R_Ref(each unit="(m.K)/W")={{0.25592, 0.01561}, {0.01561, 0.25311}}
...
equation
  ...
  annotation(__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/BaseClasses/Boreholes/BaseClasses/Functions/Validation/MultipoleThermalResistances_OneUTube.mos"
