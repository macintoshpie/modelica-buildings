    ...
    annotation(
      Placement(
        transformation(
          ...
          rotation=90,
          origin={0, 30})));
  Modelica.Thermal.HeatTransfer.Components.ThermalResistor Rgg14(
    R=Rgg1_val)
    "Grout thermal resistance"
    annotation(
      Placement(
        transformation(
          ...
          rotation=90,
          origin={-50, 30})));
  Modelica.Thermal.HeatTransfer.Components.ThermalResistor Rgg21(
    R=Rgg2_val)
    "Grout thermal resistance"
    annotation(
      Placement(
        transformation(
          ...
          rotation=270,
          origin={50, 30})));
  Modelica.Thermal.HeatTransfer.Components.ThermalResistor Rgg11(
    R=Rgg1_val)
    "Grout thermal resistance"
    annotation(
      Placement(
    ...
    annotation(
      Placement(
        transformation(
          ...
          rotation=180,
          origin={80, 0})));
  Modelica.Thermal.HeatTransfer.Components.ThermalResistor Rgg12(
    R=Rgg1_val)
    "Grout thermal resistance"
    annotation(
      Placement(
    ...
    annotation(
      Placement(
        transformation(
          ...
          rotation=0,
          origin={30, 0})));
  Modelica.Thermal.HeatTransfer.Components.ThermalResistor Rgb3(
    R=Rgb_val)
    "Grout thermal resistance"
    annotation(
      Placement(
        transformation(
          ...
          rotation=90,
          origin={0,-30})));
  Modelica.Thermal.HeatTransfer.Components.ThermalResistor Rgb4(
    R=Rgb_val)
    "Grout thermal resistance"
    annotation(
      Placement(
        transformation(
          ...
          rotation=180,
          origin={-30, 0})));
  Modelica.Thermal.HeatTransfer.Components.ThermalResistor Rpg4(
    R=RCondGro_val)
    "Grout thermal resistance"
    annotation(
      Placement(
        transformation(
          ...
          rotation=180,
          origin={-80, 0})));
  Modelica.Thermal.HeatTransfer.Components.ThermalResistor Rgg13(
    R=Rgg2_val)
    "Grout thermal resistance"
    annotation(
      Placement(
        transformation(
          ...
          rotation=90,
          origin={-50,-30})));
  Modelica.Thermal.HeatTransfer.Components.ThermalResistor Rpg3(
    R=RCondGro_val)
    "Grout thermal resistance"
    annotation(
      Placement(
        transformation(
          ...
          rotation=90,
          origin={0,-68})));
  Modelica.Thermal.HeatTransfer.Components.ThermalResistor Rgg22(
    R=Rgg1_val)
    "Grout thermal resistance"
    annotation(
      Placement(
  ...
  Modelica.Thermal.HeatTransfer.Components.HeatCapacitor capFil2(
    ...
    annotation(
      Placement(
        transformation(
          extent={{58, 8}, {74, 24}})));
  Modelica.Thermal.HeatTransfer.Components.HeatCapacitor capFil3(
    T(
      start=T_start,
      fixed=(energyDynamics == Modelica.Fluid.Types.Dynamics.FixedInitial)),
    der_T(
    ...
    annotation(
      Placement(
        transformation(
          ...
          rotation=90,
          origin={-26,-62})));
  Modelica.Thermal.HeatTransfer.Components.HeatCapacitor capFil4(
    T(
      start=T_start,
      fixed=(energyDynamics == Modelica.Fluid.Types.Dynamics.FixedInitial)),
    der_T(
...
equation
  connect(Rpg1.port_a, port_1)
    annotation(
      Line(
        points={{0, 88}, {0, 100}, {0, 100}},
        color={191, 0, 0}));
  connect(Rpg1.port_b, Rgb1.port_a)
    annotation(
      Line(
        points={{0, 72}, {0, 72}, {0, 38}},
        color={191, 0, 0}));
  connect(Rgb1.port_b, port_wall)
    annotation(
      Line(
        points={{0, 22}, {0, 22}, {0, 0}},
        color={191, 0, 0}));
  ...
  connect(Rpg2.port_a, port_2)
    annotation(
      Line(
        points={{88, 0}, {100, 0}, {100, 0}},
        color={191, 0, 0}));
  connect(Rgb2.port_a, Rpg2.port_b)
    annotation(
      Line(
        points={{38, 0}, {56, 0}, {72, 0}},
        color={191, 0, 0}));
  connect(port_wall, Rgb2.port_b)
    annotation(
      Line(
        points={{0, 0}, {11, 0}, {22, 0}},
        color={191, 0, 0}));
  connect(port_wall, Rgb4.port_b)
    annotation(
      Line(
        points={{0, 0}, {-12, 0}, {-22, 0}},
        color={191, 0, 0}));
  connect(Rgb4.port_a, Rpg4.port_b)
    annotation(
      Line(
        points={{-38, 8.88178e-016}, {-56, 8.88178e-016}, {-56, 0}, {-72, 0}},
        color={191, 0, 0}));
  connect(Rpg4.port_a, port_4)
    annotation(
      Line(
        points={{-88, 0}, {-94, 0}, {-100, 0}},
        color={191, 0, 0}));
  connect(Rgg14.port_b, Rpg4.port_b)
    annotation(
      Line(
        points={{-50, 22}, {-50, 0}, {-56, 8.88178e-016}, {-56, 0}, {-72, 0}, {-72,-9.99201e-016}},
        color={191, 0, 0}));
  ...
  connect(Rgg13.port_b, Rpg3.port_b)
    annotation(
      Line(
        points={{-50,-38}, {-50,-50}, {0,-50}, {0,-60}, {4.996e-016,-60}},
        color={191, 0, 0}));
  connect(Rgg13.port_b, Rgb3.port_a)
    annotation(
      Line(
        points={{-50,-38}, {-50,-38}, {-50,-50}, {0,-50}, {0,-38}, {-4.44089e-016,-38}},
        color={191, 0, 0}));
  connect(Rgg13.port_b, Rgg11.port_b)
    annotation(
      Line(
        points={{-50,-38}, {-50,-38}, {-50,-50}, {0,-50}, {90,-50}, {90, 22}},
        color={191, 0, 0}));
  connect(Rgg13.port_b, Rgg12.port_b)
    annotation(
      Line(
        points={{-50,-38}, {-50,-38}, {-50,-50}, {50,-50}, {50,-38}},
        color={191, 0, 0}));
  connect(Rgb2.port_a, Rgg12.port_a)
    annotation(
      Line(
        points={{38, 0}, {38, 0}, {50, 0}, {50,-22}},
        color={191, 0, 0}));
  connect(Rgg21.port_a, Rpg2.port_b)
    annotation(
      Line(
        points={{50, 22}, {50, 0}, {72, 0}, {72, 9.99201e-016}},
        color={191, 0, 0}));
  connect(Rpg1.port_b, Rgg11.port_a)
    annotation(
      Line(
        points={{0, 72}, {0, 72}, {0, 64}, {90, 64}, {90, 38}},
        color={191, 0, 0}));
  connect(Rpg1.port_b, Rgg21.port_b)
    annotation(
      Line(
        points={{0, 72}, {0, 72}, {0, 46}, {50, 46}, {50, 38}},
        color={191, 0, 0}));
  connect(Rgg14.port_a, Rgb1.port_a)
    annotation(
      Line(
        points={{-50, 38}, {-50, 46}, {0, 46}, {0, 38}, {4.996e-016, 38}},
        color={191, 0, 0}));
  connect(Rgg22.port_a, Rpg4.port_b)
    annotation(
      Line(
        points={{22,-84}, {-66,-84}, {-66, 0}, {-72, 0}, {-72,-9.99201e-016}},
        color={191, 0, 0}));
  connect(Rgg22.port_b, Rpg2.port_b)
    annotation(
      Line(
        points={{38,-84}, {66,-84}, {66, 0}, {72, 0}, {72, 9.99201e-016}},
        color={191, 0, 0}));
  connect(capFil1.port, Rgb1.port_a)
    annotation(
      Line(
        points={{-14, 64}, {0, 64}, {0, 38}, {4.996e-016, 38}},
        color={191, 0, 0}));
  connect(capFil2.port, Rpg2.port_b)
    annotation(
      Line(
        points={{66, 8}, {66, 0}, {72, 0}, {72, 9.99201e-016}},
        color={191, 0, 0}));
  connect(capFil3.port, Rpg3.port_b)
    annotation(
      Line(
        points={{-18,-62}, {-12,-62}, {-12,-50}, {0,-50}, {0,-60}, {4.996e-016,-60}},
        color={191, 0, 0}));
  connect(capFil4.port, Rpg4.port_b)
    annotation(
      Line(
        points={{-74, 20}, {-74, 12}, {-66, 12}, {-66, 0}, {-72, 0}, {-72,-9.99201e-016}},
        color={191, 0, 0}));
  annotation(
    Icon(
      coordinateSystem(
      ...
      graphics={Line(
        ...
        rotation=45,
        thickness=0.5), Line(
        points={{7.10543e-015,-70.7107}, {0,-40}, {-10,-30}, {9.99997,-9.99997}, {-9.99997, 9.99997}, {10, 30}, {0, 40}, {-7.10543e-015, 70.7107}},
        color={0, 0, 0},
        origin={-50, 50},
        rotation=135,
        thickness=0.5), Line(
