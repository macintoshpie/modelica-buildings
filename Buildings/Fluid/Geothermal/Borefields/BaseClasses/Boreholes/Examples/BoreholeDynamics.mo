...
model BoreholeDynamics
  ...
  Buildings.Fluid.Geothermal.Borefields.BaseClasses.Boreholes.OneUTube borHolOneUTubDyn(
  ...
  parameter Buildings.Fluid.Geothermal.Borefields.Data.Borefield.Example borFieUTubDat
    ...
    annotation(
      Placement(
        transformation(
          extent={{80, 20}, {100, 40}})));
  Buildings.Fluid.Sensors.TemperatureTwoPort TBorIn(
    m_flow_nominal=borFieUTubDat.conDat.mBor_flow_nominal,
    redeclare package Medium=Medium,
    tau=0)
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort TBor1UTubDyn(
    ...
    annotation(
      Placement(
        transformation(
          extent={{20, 50}, {40, 70}})));
  Modelica.Thermal.HeatTransfer.Components.ThermalCollector therCol1(
    m=nSeg)
    "Thermal collector"
    annotation(
      Placement(
        transformation(
          ...
          rotation=270,
          origin={-36, 90})));
  Modelica.Blocks.Sources.Constant TGroUn(
    k=T_start)
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort TBor1UTubSteSta(
    ...
    annotation(
      Placement(
        transformation(
          extent={{20,-10}, {40, 10}})));
  Modelica.Thermal.HeatTransfer.Components.ThermalCollector therCol2(
    m=nSeg)
    "Thermal collector"
    annotation(
      Placement(
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort TBor2UTubDyn(
    ...
    annotation(
      Placement(
        transformation(
          extent={{20,-70}, {40,-50}})));
  Modelica.Thermal.HeatTransfer.Components.ThermalCollector therCol3(
    m=nSeg)
    "Thermal collector"
    annotation(
      Placement(
  ...
  Modelica.Thermal.HeatTransfer.Components.ThermalCollector therCol4(
    m=nSeg)
    "Thermal collector"
    annotation(
      Placement(
...
equation
  ...
  connect(TGroUn.y, prescribedTemperature1.T)
    annotation(
      Line(
        points={{-87, 90}, {-80, 90}, {-80, 30}, {-72, 30}},
        color={0, 0, 127}));
  ...
  connect(prescribedTemperature2.T, prescribedTemperature1.T)
    annotation(
      Line(
        points={{-72,-30}, {-80,-30}, {-80, 30}, {-72, 30}},
        color={0, 0, 127}));
  ...
  connect(prescribedTemperature3.T, prescribedTemperature1.T)
    annotation(
      Line(
        points={{-72,-90}, {-80,-90}, {-80, 30}, {-72, 30}},
        color={0, 0, 127}));
  annotation(
    experiment(
      Tolerance=1e-6,
    ...
    __Dymola_Commands(
      file="Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/BaseClasses/Boreholes/Examples/BoreholeDynamics.mos"
        "Simulate and Plot"),
    Documentation(
      info="<html>
<p>
