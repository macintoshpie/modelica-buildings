...
model AggregationCellTimes
  ...
  final parameter Modelica.SIunits.Time[i] rCel(
    each fixed=false)
    "Cell widths";
...
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/BaseClasses/HeatTransfer/LoadAggregation/Validation/AggregationCellTimes.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
