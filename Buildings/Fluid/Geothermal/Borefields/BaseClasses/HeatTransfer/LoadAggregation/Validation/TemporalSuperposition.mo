...
model TemporalSuperposition
  ...
  parameter Modelica.SIunits.TemperatureDifference supPos=Buildings.Fluid.Geothermal.Borefields.BaseClasses.HeatTransfer.LoadAggregation.temporalSuperposition(i=6, QAgg_flow={2, 1e6, 3, 1e6, 1e6}, kappa={0.4, 0, 0.2, 1, 0}, curCel=3)
    "Temporal superposition";
  Modelica.SIunits.TemperatureDifference supPosErr;
equation
  supPosErr=abs((2*0.4 + 3*0.2)-supPos);
  annotation(experiment(Tolerance=1e-6, StopTime=1.0), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/BaseClasses/HeatTransfer/LoadAggregation/Validation/TemporalSuperposition.mos"
