...
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=3.7e11),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/BaseClasses/HeatTransfer/ThermalResponseFactors/Validation/GFunction_100boreholes.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
