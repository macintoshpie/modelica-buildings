...
model GFunction_100boreholes
  ...
  parameter Modelica.SIunits.Height hBor=150
    "Borehole length";
  parameter Modelica.SIunits.Height dBor=4
...
equation
  ...
  annotation(experiment(Tolerance=1e-6, StopTime=3.7e11), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/BaseClasses/HeatTransfer/ThermalResponseFactors/Validation/GFunction_100boreholes.mos"
