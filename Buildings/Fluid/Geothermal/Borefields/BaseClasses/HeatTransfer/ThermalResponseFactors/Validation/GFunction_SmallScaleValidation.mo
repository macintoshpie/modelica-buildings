...
model GFunction_SmallScaleValidation
  ...
  parameter Modelica.SIunits.Height hBor=borFieDat.conDat.hBor
    "Borehole length";
  parameter Modelica.SIunits.Height dBor=borFieDat.conDat.dBor
    "Borehole buried depth";
  parameter Modelica.SIunits.Radius rBor=borFieDat.conDat.rBor
    "Borehole radius";
...
equation
  ...
  annotation(experiment(Tolerance=1e-6, StopTime=1.8e+12), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/BaseClasses/HeatTransfer/ThermalResponseFactors/Validation/GFunction_SmallScaleValidation.mos"
