...
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=1.8e+12),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/BaseClasses/HeatTransfer/ThermalResponseFactors/Validation/GFunction_SmallScaleValidation.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
