...
model TimeGeometric
  ...
  final parameter Modelica.SIunits.Time[nTim] t(
    each fixed=false)
    "Time vector";
initial equation
  ...
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/BaseClasses/HeatTransfer/ThermalResponseFactors/Validation/TimeGeometric.mos"
        "Simulate and plot"),
    experiment(
      Tolerance=1e-6,
      StopTime=1.0),
