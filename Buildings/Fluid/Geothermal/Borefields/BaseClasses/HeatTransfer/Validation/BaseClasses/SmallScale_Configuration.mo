...
record SmallScale_Configuration
  ...
  extends Buildings.Fluid.Geothermal.Borefields.Data.Configuration.Template(borCon=Types.BoreholeConfiguration.SingleUTube, nBor=1, cooBor={{0, 0}}, mBor_flow_nominal=0.0303/60, dp_nominal=5e4, hBor=0.4*375, rBor=0.00629*375, dBor=0.019*375, rTub=0.125*0.0254/2*375, kTub=401.0, eTub=0.06*0.0254*375, xC=0.0050/2*375);
  annotation(defaultComponentPrefixes="parameter", defaultComponentName="conDat", Documentation(info="<html>
<p>
