...
record SmallScale_Filling
  ...
  extends Buildings.Fluid.Geothermal.Borefields.Data.Filling.Template(kFil=0.262, dFil=1750, cFil=745);
  annotation(defaultComponentPrefixes="parameter", defaultComponentName="filDat", Documentation(info="<html>
