...
record SandBox_Borefield
  ...
  extends Buildings.Fluid.Geothermal.Borefields.Data.Borefield.Template(filDat=Buildings.Fluid.Geothermal.Borefields.Validation.BaseClasses.SandBox_Filling(), soiDat=Buildings.Fluid.Geothermal.Borefields.Validation.BaseClasses.SandBox_Soil(), conDat=Buildings.Fluid.Geothermal.Borefields.Validation.BaseClasses.SandBox_Configuration());
