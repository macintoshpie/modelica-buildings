...
record SandBox_Configuration
  ...
  extends Buildings.Fluid.Geothermal.Borefields.Data.Configuration.Template(borCon=Types.BoreholeConfiguration.SingleUTube, use_Rb=true, Rb=0.165, cooBor={{0, 0}}, mBor_flow_nominal=0.197/998*1000, dp_nominal=5e4, hBor=18.3, rBor=0.063, dBor=0.0, rTub=0.0167, kTub=0.39, eTub=0.003, xC=0.053/2);
