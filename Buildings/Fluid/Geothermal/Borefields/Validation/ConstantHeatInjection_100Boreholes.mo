...
model ConstantHeatInjection_100Boreholes
  ...
  Buildings.Fluid.HeatExchangers.HeaterCooler_u hea(
    ...
    p_start=100000,
    Q_flow_nominal=2*Modelica.Constants.pi*borFieDat.soiDat.kSoi*borFieDat.conDat.hBor*borFieDat.conDat.nBor)
    "Heater"
    annotation(
      Placement(
        transformation(
          extent={{-50,-30}, {-30,-10}})));
  Modelica.Blocks.Sources.Constant heaRat(
    k=1)
...
equation
  ...
  connect(hea.u, heaRat.y)
    annotation(
      Line(
        points={{-52,-14}, {-60,-14}, {-60, 20}, {-67, 20}},
        color={0, 0, 127}));
  annotation(
    experiment(
      Tolerance=1e-6,
      StopTime=31536.0E+06),
    __Dymola_Commands(
      file="Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/Validation/ConstantHeatInjection_100Boreholes.mos"
        "Simulate and Plot"),
    Documentation(
      info="<html>
<p>
