...
model ConstantHeatInjection_100Boreholes
  ...
  Buildings.Fluid.Geothermal.Borefields.OneUTube borHol(redeclare package Medium=Medium, borFieDat=borFieDat, energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial, TExt0_start=T_start, dT_dz=0, tLoaAgg=3600000)
    "Borehole"
  ...
  Buildings.Fluid.HeatExchangers.HeaterCooler_u hea(redeclare package Medium=Medium, dp_nominal=10000, show_T=true, energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState, T_start=T_start, m_flow_nominal=borFieDat.conDat.mBorFie_flow_nominal, m_flow(start=borFieDat.conDat.mBorFie_flow_nominal), p_start=100000, Q_flow_nominal=2*Modelica.Constants.pi*borFieDat.soiDat.kSoi*borFieDat.conDat.hBor*borFieDat.conDat.nBor)
    "Heater"
...
equation
  ...
  connect(hea.u, heaRat.y)
    annotation(Line(points={{-52,-14}, {-60,-14}, {-60, 20}, {-67, 20}}, color={0, 0, 127}));
  annotation(experiment(Tolerance=1e-6, StopTime=31536.0E+06), __Dymola_Commands(file="Resources/Scripts/Dymola/Fluid/Geothermal/Borefields/Validation/ConstantHeatInjection_100Boreholes.mos"
