...
equation
  ...
  connect(pipFil.port, heaFlo.port_a)
    annotation(
      Line(
        points={{-50, 6.10623e-16}, {-45, 6.10623e-16}, {-45, 1.22125e-15}, {-40, 1.22125e-15}, {-40, 6.10623e-16}, {-30, 6.10623e-16}},
        color={191, 0, 0},
        smooth=Smooth.None));
  connect(heaFlo.port_b, soi.port_a)
    annotation(
      Line(
        points={{-10, 6.10623e-16}, {-7.5, 6.10623e-16}, {-7.5, 1.22125e-15}, {-5, 1.22125e-15}, {-5, 6.10623e-16}, {-5.55112e-16, 6.10623e-16}},
        color={191, 0, 0},
        smooth=Smooth.None));
  connect(soi.port_b, TBouCon.port)
    annotation(
      Line(
        points={{20, 6.10623e-16}, {30, 6.10623e-16}, {30, 20}, {80, 20}, {80, 6.10623e-16}, {67.6, 6.10623e-16}},
        color={191, 0, 0},
        smooth=Smooth.None));
