...
model ConvectionResistance
  ...
  parameter Modelica.SIunits.MassFlowRate m_flow_nominal=3000/10/4200
...
equation
  ...
  R=Buildings.Fluid.Geothermal.Boreholes.BaseClasses.convectionResistance(hSeg=10, rTub=0.02, kMed=kMed, mueMed=mueMed, cpMed=cpMed, m_flow=m_flow, m_flow_nominal=m_flow_nominal);
  annotation(experiment(Tolerance=1e-6, StopTime=1.0), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Geothermal/Boreholes/BaseClasses/Examples/ConvectionResistance.mos"
