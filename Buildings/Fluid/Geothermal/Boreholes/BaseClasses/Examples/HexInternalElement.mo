...
equation
  connect(sou_1.ports[1], hex.port_a1)
    annotation(
      Line(
        points={{-40, 6.66134e-16}, {-16, 6.66134e-16}, {-16, 1.22125e-15}, {10, 1.22125e-15}},
        color={0, 127, 255},
        smooth=Smooth.None));
  ...
  annotation(
    experiment(
      ...
      StopTime=3600),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Geothermal/Boreholes/BaseClasses/Examples/HexInternalElement.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
