...
model SingleUTubeBoundaryCondition
  ...
  Buildings.Fluid.Geothermal.Boreholes.BaseClasses.SingleUTubeBoundaryCondition TBouSte(
    final rExt=3,
  ...
  Buildings.Fluid.Geothermal.Boreholes.BaseClasses.SingleUTubeBoundaryCondition TBouCon(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-20, 60}, {0, 80}})));
  Modelica.Blocks.Sources.Constant con(
    k=Q_flow)
    annotation(
      Placement(
        transformation(
          extent={{-60, 60}, {-40, 80}})));
  Buildings.Fluid.Geothermal.Boreholes.BaseClasses.SingleUTubeBoundaryCondition TBouPul(
    final rExt=3,
    final samplePeriod=604800,
    hSeg=1,
    redeclare final Buildings.HeatTransfer.Data.Soil.Sandstone matSoi,
...
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=1.5768e+08),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Geothermal/Boreholes/BaseClasses/Examples/SingleUTubeBoundaryCondition.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
