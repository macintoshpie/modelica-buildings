...
model SingleUTubeResistances
  ...
  parameter Real x(
    ...
    "Capacity location";
initial equation
  (Rgb, Rgg, RCondGro, x)=Buildings.Fluid.Geothermal.Boreholes.BaseClasses.singleUTubeResistances(
    hSeg=hSeg,
    rBor=rBor,
    rTub=rTub,
    eTub=eTub,
  ...
  annotation(
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Geothermal/Boreholes/BaseClasses/Examples/SingleUTubeResistances.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
