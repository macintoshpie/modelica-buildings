...
model SingleUTubeBoundaryCondition
  ...
  Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_b port
    "Heat port"
    annotation(Placement(transformation(extent={{86,-10}, {106, 10}}), iconTransformation(extent={{86,-10}, {106, 10}})));
protected
...
equation
  ...
  when sample(startTime, samplePeriod) then
    ...
    UOld=U;
    port.T=TExt_start + Buildings.Fluid.Geothermal.Boreholes.BaseClasses.temperatureDrop(table=table, iSam=pre(iSam), Q_flow=QAve_flow, samplePeriod=samplePeriod, rExt=rExt, hSeg=hSeg, k=k, d=d, c=c);
    iSam=pre(iSam) + 1;
  end when;
  annotation(Icon(coordinateSystem(preserveAspectRatio=true, extent={{-100,-100}, {100, 100}}), graphics={Rectangle(extent={{-100, 100}, {100,-100}}, lineColor={0, 0, 0}, pattern=LinePattern.None, fillColor={159, 159, 223}, fillPattern=FillPattern.Backward), Line(points={{-102, 0}, {64, 0}}, color={191, 0, 0}, thickness=0.5), Text(extent={{0, 0}, {-100,-100}}, lineColor={0, 0, 0}, textString="K"), Text(extent={{-150, 150}, {150, 110}}, textString="%name", lineColor={0, 0, 255}), Polygon(points={{40,-18}, {40, 22}, {80, 2}, {40,-18}}, lineColor={191, 0, 0}, fillColor={191, 0, 0}, fillPattern=FillPattern.Solid)}), Documentation(info="<html>
<p>
