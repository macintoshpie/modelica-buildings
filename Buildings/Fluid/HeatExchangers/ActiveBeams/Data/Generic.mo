...
record Generic
  "Generic data record for active beam"
  extends Modelica.Icons.Record;
  parameter BaseClasses.AirFlow primaryAir(r_V={0, 0.2, 1}, f={0, 0.5, 1})
    "Performance data for primary air";
  parameter Buildings.Fluid.HeatExchangers.ActiveBeams.Data.BaseClasses.WaterFlow water(r_V={0, 0.5, 1}, f={0, 0.7, 1})
    "Performance data for water";
  parameter BaseClasses.TemperatureDifference dT(r_dT={0, 0.5, 1}, f={0, 0.5, 1})
  ...
  parameter Modelica.SIunits.HeatFlowRate Q_flow_nominal
    ...
    annotation(Dialog(group="Nominal condition"));
  annotation(defaultComponentName="per", Documentation(revisions="<html>
<ul>
<li>
