...
package Trox
  ...
  record DID632A_nozzleH_length6ft_cooling=Buildings.Fluid.HeatExchangers.ActiveBeams.Data.Generic(
    primaryAir(
...
Performance data for Trox active beam for cooling mode.
  ...
  record DID632A_nozzleH_length6ft_heating=Buildings.Fluid.HeatExchangers.ActiveBeams.Data.Generic(
    dT(
      f={0, 0.5, 1},
      r_dT={0, 0.5, 1}),
    primaryAir(
