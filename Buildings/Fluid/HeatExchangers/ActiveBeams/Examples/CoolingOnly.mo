...
equation
  ...
  connect(vol.ports[1], bou.ports[1])
    annotation(
      Line(
        points={{58,-70}, {60,-70}, {60,-100}, {80,-100}},
        color={0, 127, 255}));
  ...
  connect(theConWal.port_b, vol.heatPort)
    annotation(
      Line(
        points={{-40,-100}, {40,-100}, {40,-60}, {50,-60}},
        color={191, 0, 0}));
  ...
  connect(sine.y, gain.u)
    annotation(
      Line(
        points={{-89,-60}, {-89,-60}, {-70,-60}},
        color={0, 0, 127}));
  connect(beaCoo.watCoo_b, sin_1.ports[1])
    annotation(
      Line(
        points={{54, 66}, {70, 66}, {80, 66}},
        color={0, 127, 255}));
  connect(beaCoo.heaPor, vol.heatPort)
    annotation(
      Line(
        points={{40, 48}, {40, 48}, {40, 26}, {40,-60}, {50,-60}},
        color={191, 0, 0}));
  ...
  connect(pum.ports[1], beaCoo.watCoo_a)
    annotation(
      Line(
        points={{-2, 66}, {12, 66}, {26, 66}},
        color={0, 127, 255}));
  connect(pum.m_flow_in, conPID.y)
    annotation(
      Line(
        points={{-24, 74}, {-40, 74}, {-40,-10}, {-49,-10}},
        color={0, 0, 127}));
  annotation(
    Diagram(
      coordinateSystem(
    ...
    experiment(
      ...
      StopTime=172800),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/ActiveBeams/Examples/CoolingOnly.mos"
        "Simulate and plot"),
    Icon(
      coordinateSystem(
        extent={{-120,-120}, {120, 120}})),
