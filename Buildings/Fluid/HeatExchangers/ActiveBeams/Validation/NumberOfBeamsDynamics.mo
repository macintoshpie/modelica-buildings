...
model NumberOfBeamsDynamics
  ...
  extends NumberOfBeams(nBeams=2, beaCooHea(energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial, show_T=true, tau=120, TWatCoo_start=278.15, TWatHea_start=303.15), beaCooHea10(energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial, show_T=true, tau=120, TWatCoo_start=278.15, TWatHea_start=303.15), step(startTime=200), step1(startTime=300), step3(startTime=200), step2(startTime=300));
  annotation(experiment(Tolerance=1e-6, StopTime=500), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/ActiveBeams/Validation/NumberOfBeamsDynamics.mos"
