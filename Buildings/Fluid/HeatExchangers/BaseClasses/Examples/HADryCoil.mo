...
equation
  ...
  connect(TWat.y, hADryCoiWat.T_1)
    annotation(
      Line(
        points={{-59, 30}, {-30, 30}, {-30,-37}, {-1,-37}},
        color={0, 0, 127}));
  connect(hADryCoiWat.T_2, TAir.y)
    annotation(
      Line(
        points={{-1,-43}, {-30,-43}, {-30,-30}, {-59,-30}},
        color={0, 0, 127}));
  ...
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/BaseClasses/Examples/HADryCoil.mos"
        "Simulate and plot"),
    experiment(
      StopTime=80.0,
      Tolerance=1E-6),
