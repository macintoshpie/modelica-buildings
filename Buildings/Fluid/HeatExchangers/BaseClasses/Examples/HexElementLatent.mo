  ...
  Modelica.Blocks.Sources.Constant TDb1(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-100,-76}, {-80,-56}})));
  Modelica.Blocks.Sources.Constant hACon(
    k=10000)
  ...
  Sensors.EnthalpyFlowRate senEntFlo3(
    ...
    annotation(
      Placement(
        transformation(
          extent={{40,-44}, {60,-24}})));
  Modelica.Blocks.Math.MultiSum netEne(
    nu=4,
    k={1,-1, 1,-1})
...
equation
  ...
  connect(TDb1.y, sin_2.T_in)
    annotation(
      Line(
        points={{-79,-66}, {-70.5,-66}, {-62,-66}},
        color={0, 0, 127}));
  connect(hACon.y, hex.Gc_1)
    annotation(
      Line(
        points={{1, 70}, {18, 70}, {18, 10}},
        color={0, 0, 127}));
  connect(hACon.y, hex.Gc_2)
    annotation(
      Line(
        points={{1, 70}, {8, 70}, {8,-16}, {26,-16}, {26,-10}},
        color={0, 0, 127}));
  ...
  annotation(
    experiment(
      ...
      StopTime=600),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/BaseClasses/Examples/HexElementLatent.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
