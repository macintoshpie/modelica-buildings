...
equation
  ...
  connect(res_22.port_a, hex.port_b2)
    annotation(
      Line(
        points={{-4,-20}, {2,-20}, {2,-6}, {10,-6}},
        color={0, 127, 255}));
  connect(TDb1.y, sin_2.T_in)
    annotation(
      Line(
        points={{-79,-16}, {-70.5,-16}, {-62,-16}},
        color={0, 0, 127}));
  ...
  connect(hex.port_a2, res_21.port_b)
    annotation(
      Line(
        points={{30,-6}, {40,-6}, {40,-20}, {50,-20}},
        color={0, 127, 255}));
  connect(hACon.y, hex.Gc_1)
    annotation(
      Line(
        points={{1, 70}, {16, 70}, {16, 10}},
        color={0, 0, 127}));
  connect(hACon.y, hex.Gc_2)
    annotation(
      Line(
        points={{1, 70}, {8, 70}, {8,-16}, {24,-16}, {24,-10}},
        color={0, 0, 127}));
  ...
  annotation(
    experiment(
      ...
      StopTime=600),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/BaseClasses/Examples/HexElementSensible.mos"
        "Simulate and plot"));
