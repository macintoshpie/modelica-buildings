  ...
  Modelica.Blocks.Sources.Constant X_w(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-80, 0}, {-60, 20}})));
  Modelica.Blocks.Sources.Constant Gc(
    k=1)
...
equation
  connect(TSur.y, masExc.TSur)
    annotation(
      Line(
        points={{-59, 70}, {8, 70}, {8, 18}, {18, 18}},
        color={0, 0, 127}));
  connect(Gc.y, masExc.Gc)
    annotation(
      Line(
        points={{-59,-70}, {8,-70}, {8, 2}, {18, 2}},
        color={0, 0, 127}));
  connect(X_w.y, masExc.XInf)
    annotation(
      Line(
        points={{-59, 10}, {-20, 10}, {18, 10}},
        color={0, 0, 127}));
  annotation(
    Diagram(
      coordinateSystem(
    ...
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/BaseClasses/Examples/MassExchange.mos"
        "Simulate and plot"));
end MassExchange;
