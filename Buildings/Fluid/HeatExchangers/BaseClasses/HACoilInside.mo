...
model HACoilInside
  ...
  parameter Modelica.SIunits.Temperature T_nominal=Modelica.SIunits.Conversions.from_degC(20)
...
initial equation
  s=if temperatureDependent then 0.014/(1 + 0.014*Modelica.SIunits.Conversions.to_degC(T_nominal)) else 1;
equation
  ...
  annotation(defaultComponentName="HASin", Documentation(info="<html>
<p>
...
</html>"), Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100}, {100, 100}}), graphics={Text(extent={{-66, 88}, {60,-2}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid, textString="hA"), Rectangle(extent={{-74,-12}, {76,-72}}, lineColor={0, 0, 0}, fillColor={0, 0, 0}, fillPattern=FillPattern.Solid), Rectangle(extent={{-74,-24}, {76,-56}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Line(points={{-52,-40}, {56,-40}, {44,-32}}, color={175, 175, 175}), Line(points={{56,-40}, {44,-48}}, color={175, 175, 175})}), Icon(Rectangle(extent={{-36,-36}, {-24,-72}}, style(color=0, fillColor=8, fillPattern=8)), Line(points=[
    -12,-52;
