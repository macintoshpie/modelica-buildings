...
model HexElementLatent
  ...
  extends Buildings.Fluid.HeatExchangers.BaseClasses.PartialHexElement(redeclare final Buildings.Fluid.MixingVolumes.BaseClasses.MixingVolumeHeatPort vol1(final energyDynamics=energyDynamics, final massDynamics=energyDynamics, final initialize_p=initialize_p1, prescribedHeatFlowRate=false), redeclare final Buildings.Fluid.MixingVolumes.BaseClasses.MixingVolumeHeatMoisturePort vol2(final energyDynamics=energyDynamics, final massDynamics=energyDynamics, final initialize_p=initialize_p2, final simplify_mWat_flow=simplify_mWat_flow, prescribedHeatFlowRate=false));
  MassExchange masExc(redeclare final package Medium=Medium2)
...
protected
  ...
  Modelica.Thermal.HeatTransfer.Sensors.TemperatureSensor temSen(T(final quantity="ThermodynamicTemperature", final unit="K", displayUnit="degC", min=0))
...
equation
  connect(temSen.T, masExc.TSur)
    annotation(Line(points={{-40, 0}, {20, 0}, {20,-22}, {48,-22}}, color={0, 0, 127}));
  connect(masExc.mWat_flow, vol2.mWat_flow)
    annotation(Line(points={{71,-30}, {80,-30}, {80,-44}, {44,-44}, {44,-52}, {14,-52}}, color={0, 0, 127}));
  connect(vol2.X_w, masExc.XInf)
    annotation(Line(points={{-10,-64}, {-20,-64}, {-20,-44}, {30,-44}, {30,-30}, {48,-30}}, color={0, 0, 127}));
  connect(Gc_2, masExc.Gc)
    annotation(Line(points={{40,-100}, {40,-38}, {48,-38}}, color={0, 0, 127}, smooth=Smooth.None));
  connect(temSen.port, con1.solid)
    annotation(Line(points={{-60, 0}, {-66, 0}, {-66, 60}, {-50, 60}}, color={191, 0, 0}, smooth=Smooth.None));
  connect(heaConVapAir.Q_flow, pro.y)
    annotation(Line(points={{0,-20}, {0,-20}, {36,-20}, {36, 0}, {39, 0}}, color={0, 0, 127}));
  connect(masExc.mWat_flow, pro.u2)
    annotation(Line(points={{71,-30}, {80,-30}, {80,-6}, {62,-6}}, color={0, 0, 127}));
  connect(pro.u1, h_fg.y)
    annotation(Line(points={{62, 6}, {66, 6}, {69, 6}}, color={0, 0, 127}));
  connect(heaConVapAir.port, con2.fluid)
    annotation(Line(points={{-20,-20}, {-24,-20}, {-24,-40}, {-30,-40}}, color={191, 0, 0}));
  connect(heaConVapCoi.port, con2.solid)
    annotation(Line(points={{-20, 20}, {-66, 20}, {-66, 0}, {-66,-40}, {-50,-40}}, color={191, 0, 0}));
  connect(gain.y, heaConVapCoi.Q_flow)
    annotation(Line(points={{9, 20}, {6, 20}, {0, 20}}, color={0, 0, 127}));
  connect(pro.y, gain.u)
    annotation(Line(points={{39, 0}, {36, 0}, {36, 0}, {36, 20}, {32, 20}}, color={0, 0, 127}));
...
</html>"), Icon(graphics={Polygon(points={{-56,-52}, {-58,-58}, {-60,-66}, {-58,-74}, {-54,-76}, {-44,-76}, {-38,-70}, {-40,-62}, {-44,-50}, {-50,-38}, {-56,-52}}, lineColor={0, 0, 255}, fillColor={0, 0, 255}, fillPattern=FillPattern.Solid), Polygon(points={{-26,-34}, {-28,-40}, {-30,-48}, {-28,-56}, {-24,-58}, {-14,-58}, {-8,-52}, {-10,-44}, {-14,-32}, {-20,-20}, {-26,-34}}, lineColor={0, 0, 255}, fillColor={0, 0, 255}, fillPattern=FillPattern.Solid), Polygon(points={{8,-50}, {6,-56}, {4,-64}, {6,-72}, {10,-74}, {20,-74}, {26,-68}, {24,-60}, {20,-48}, {14,-36}, {8,-50}}, lineColor={0, 0, 255}, fillColor={0, 0, 255}, fillPattern=FillPattern.Solid), Polygon(points={{44,-24}, {42,-30}, {40,-38}, {42,-46}, {46,-48}, {56,-48}, {62,-42}, {60,-34}, {56,-22}, {50,-10}, {44,-24}}, lineColor={0, 0, 255}, fillColor={0, 0, 255}, fillPattern=FillPattern.Solid)}));
