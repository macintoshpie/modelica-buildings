...
model MassExchange
  ...
  Modelica.Blocks.Interfaces.RealInput TSur(final quantity="ThermodynamicTemperature", final unit="K", displayUnit="degC", min=0)
    "Surface temperature"
...
public
  ...
  Modelica.Blocks.Math.Product mWat
    "Water flow rate"
  ...
  Modelica.Blocks.Math.Add delX(k2=-1, k1=1)
    "Humidity difference"
    annotation(Placement(transformation(extent={{-40,-66}, {-20,-46}})));
protected
  parameter Medium.ThermodynamicState sta_default=Medium.setState_phX(h=Medium.h_default, p=Medium.p_default, X=Medium.X_default);
...
equation
  connect(TSur, TDewPoi.T)
    annotation(Line(points={{-120, 80}, {-80, 80}, {-80, 50}, {-61, 50}}, color={0, 0, 127}));
  connect(TDewPoi.p_w, humRatPre.p_w)
    annotation(Line(points={{-39, 50}, {-20, 50}, {-20, 10}, {-1, 10}}, color={0, 0, 255}));
  connect(Gc, gain.u)
    annotation(Line(points={{-120,-80}, {-82,-80}}, color={0, 0, 127}));
  connect(gain.y, mWat.u2)
    annotation(Line(points={{-59,-80}, {0,-80}, {0,-76}, {58,-76}}, color={0, 0, 127}));
  connect(mWat.y, mWat_flow)
    annotation(Line(points={{81,-70}, {90,-70}, {90, 0}, {110, 0}}, color={0, 0, 127}));
  connect(zero.y, min.u1)
    annotation(Line(points={{1,-30}, {10,-30}, {10,-44}, {18,-44}}, color={0, 0, 127}));
  connect(delX.u2, XInf)
    annotation(Line(points={{-42,-62}, {-80,-62}, {-80, 1.11022e-15}, {-120, 1.11022e-15}}, color={0, 0, 127}));
  connect(humRatPre.X_w, delX.u1)
    annotation(Line(points={{21, 10}, {28, 10}, {28,-8}, {-60,-8}, {-60,-50}, {-42,-50}}, color={0, 0, 255}));
  connect(delX.y, min.u2)
    annotation(Line(points={{-19,-56}, {18,-56}}, color={0, 0, 127}));
  connect(min.y, mWat.u1)
    annotation(Line(points={{41,-50}, {48,-50}, {48,-64}, {58,-64}}, color={0, 0, 127}));
  annotation(Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100}, {100, 100}}), graphics={Rectangle(extent={{-100, 100}, {100,-100}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Text(extent={{-92, 96}, {-48, 54}}, lineColor={0, 0, 127}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid, textString="TSur"), Text(extent={{-96, 22}, {-48,-26}}, lineColor={0, 0, 127}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid, textString="XMed"), Text(extent={{-90,-66}, {-58,-98}}, lineColor={0, 0, 127}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid, textString="Gc"), Text(extent={{54, 10}, {94,-6}}, lineColor={0, 0, 127}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid, textString="m"), Ellipse(extent={{72, 12}, {76, 8}}, lineColor={0, 0, 127}, fillColor={0, 0, 127}, fillPattern=FillPattern.Solid), Polygon(points={{-30, 66}, {-36, 46}, {-38, 32}, {-36, 26}, {-30, 22}, {-20, 22}, {-12, 28}, {-10, 36}, {-14, 52}, {-24, 84}, {-30, 66}}, lineColor={0, 0, 255}, fillColor={0, 0, 255}, fillPattern=FillPattern.Solid), Polygon(points={{10, 26}, {4, 6}, {2,-8}, {4,-14}, {10,-18}, {20,-18}, {28,-12}, {30,-4}, {26, 12}, {16, 44}, {10, 26}}, lineColor={0, 0, 255}, fillColor={0, 0, 255}, fillPattern=FillPattern.Solid), Polygon(points={{-38,-18}, {-44,-38}, {-46,-52}, {-44,-58}, {-38,-62}, {-28,-62}, {-20,-56}, {-18,-48}, {-22,-32}, {-32, 0}, {-38,-18}}, lineColor={0, 0, 255}, fillColor={0, 0, 255}, fillPattern=FillPattern.Solid), Polygon(points={{14,-46}, {8,-66}, {6,-80}, {8,-86}, {14,-90}, {24,-90}, {32,-84}, {34,-76}, {30,-60}, {20,-28}, {14,-46}}, lineColor={0, 0, 255}, fillColor={0, 0, 255}, fillPattern=FillPattern.Solid), Polygon(points={{38, 100}, {32, 80}, {30, 66}, {32, 60}, {38, 56}, {48, 56}, {56, 62}, {58, 70}, {54, 86}, {50, 100}, {38, 100}}, lineColor={0, 0, 255}, fillColor={0, 0, 255}, fillPattern=FillPattern.Solid)}), Documentation(info="<html>
<p>
