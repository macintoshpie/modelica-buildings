...
protected
  ...
  Buildings.Fluid.Interfaces.PrescribedOutlet outCon(redeclare final package Medium=Medium, final allowFlowReversal=allowFlowReversal, final m_flow_small=m_flow_small, final show_T=false, final m_flow_nominal=m_flow_nominal, final tau=tau)
...
equation
  ...
  connect(preDro.port_b, outCon.port_a)
    annotation(Line(points={{-30, 0}, {20, 0}}, color={0, 127, 255}));
  connect(outCon.port_b, port_b)
    annotation(Line(points={{40, 0}, {100, 0}}, color={0, 127, 255}));
  annotation(Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100}, {100, 100}}), graphics={Rectangle(extent={{-102, 5}, {99,-5}}, lineColor={0, 0, 255}, pattern=LinePattern.None, fillColor={0, 0, 0}, fillPattern=FillPattern.Solid), Rectangle(extent={{-70, 60}, {70,-60}}, lineColor={0, 0, 255}, pattern=LinePattern.None, fillColor={95, 95, 95}, fillPattern=FillPattern.Solid)}), defaultComponentName="hea", Documentation(info="<html>
<p>
