...
model NormalizedPower
  ...
  Real y
    "Control signal";
  Modelica.SIunits.Efficiency r_P(
    max=1)
...
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=1),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/CoolingTowers/BaseClasses/Characteristics/Validation/NormalizedPower.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
