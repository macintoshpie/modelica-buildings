...
partial model PartialStaticTwoPortCoolingTower
  ...
  replaceable Buildings.Fluid.HeatExchangers.CoolingTowers.BaseClasses.CoolingTower tow constrainedby Buildings.Fluid.HeatExchangers.CoolingTowers.BaseClasses.CoolingTower(
...
equation
  ...
  connect(tow.port_b, vol.ports[2])
    annotation(
      Line(
        points={{42,-50}, {60,-50}, {60,-120}, {30,-120}},
        color={0, 127, 255}));
  ...
  connect(swi.y, pum.m_flow_in)
    annotation(
      Line(
        points={{41,-190}, {70,-190}, {70,-240}, {-100,-240}, {-100,-30}, {-30,-30}, {-30,-38}},
        color={0, 0, 127}));
  connect(exp.ports[1], vol.ports[3])
    annotation(
      Line(
        points={{80,-120}, {32.6667,-120}},
        color={0, 127, 255}));
  annotation(
    Diagram(
      coordinateSystem(
