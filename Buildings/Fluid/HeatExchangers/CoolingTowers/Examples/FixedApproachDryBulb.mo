...
model FixedApproachDryBulb
  ...
  extends BaseClasses.PartialStaticTwoPortCoolingTower(redeclare CoolingTowers.FixedApproach tow(m_flow_nominal=m_flow_nominal), vol(energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial));
equation
  ...
  annotation(Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-140,-260}, {140, 100}}), graphics), experiment(StartTime=15552000, Tolerance=1e-06, StopTime=15984000), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/CoolingTowers/Examples/FixedApproachDryBulb.mos"
