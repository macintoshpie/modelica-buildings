...
model Merkel
  ...
  extends BaseClasses.PartialStaticTwoPortCoolingTower(redeclare Buildings.Fluid.HeatExchangers.CoolingTowers.Merkel tow(ratWatAir_nominal=ratWatAir_nominal, TAirInWB_nominal=273.15 + 25.55, TWatIn_nominal=273.15 + 35, TWatOut_nominal=273.15 + 35-5.56, PFan_nominal=4800), weaDat(final computeWetBulbTemperature=true));
  ...
  Controls.OBC.CDL.Continuous.LimPID conFan(k=1, Ti=60, Td=10, reverseAction=true, u_s(unit="K", displayUnit="degC"), u_m(unit="K", displayUnit="degC"))
...
equation
  ...
  connect(conFan.y, tow.y)
    annotation(Line(points={{-8,-10}, {6,-10}, {6,-42}, {20,-42}}, color={0, 0, 127}));
  connect(tow.TLvg, conFan.u_m)
    annotation(Line(points={{43,-56}, {54,-56}, {54,-32}, {-20,-32}, {-20,-22}}, color={0, 0, 127}));
  ...
  annotation(Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-140,-260}, {140, 100}})), experiment(StartTime=15552000, Tolerance=1e-06, StopTime=15724800), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/CoolingTowers/Examples/Merkel.mos"
