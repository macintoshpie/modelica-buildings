...
model MerkelEnergyPlus
  ...
  package MediumWat=Buildings.Media.Water
    "Water medium model";
  parameter Modelica.SIunits.Density denWat=MediumWat.density(MediumWat.setState_pTX(MediumWat.p_default, MediumWat.T_default, MediumWat.X_default))
  ...
  parameter Modelica.SIunits.MassFlowRate m_flow_nominal=VWat_flow_nominal*denWat
...
equation
  connect(tow.TAir, TAirWB.y)
    annotation(Line(points={{38,-46}, {20,-46}, {20, 10}, {-38, 10}}, color={0, 0, 127}));
  ...
  connect(datRea.y[2], TAirWB.u)
    annotation(Line(points={{-79, 50}, {-70, 50}, {-70, 10}, {-62, 10}}, color={0, 0, 127}));
  connect(TEntWat.u, datRea.y[3])
    annotation(Line(points={{-62,-46}, {-70,-46}, {-70, 50}, {-79, 50}}, color={0, 0, 127}));
  connect(souWat.m_flow_in, datRea.y[5])
    annotation(Line(points={{-22,-42}, {-30,-42}, {-30,-20}, {-70,-20}, {-70, 50}, {-79, 50}}, color={0, 0, 127}));
  connect(tow.y, datRea.y[9])
    annotation(Line(points={{38,-42}, {30,-42}, {30, 50}, {-79, 50}}, color={0, 0, 127}));
  annotation(Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-120,-100}, {120, 100}})), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/CoolingTowers/Validation/MerkelEnergyPlus.mos"
    "Simulate and plot"), experiment(StartTime=0, StopTime=172800, Tolerance=1e-06), Documentation(info="<html>
<p>
