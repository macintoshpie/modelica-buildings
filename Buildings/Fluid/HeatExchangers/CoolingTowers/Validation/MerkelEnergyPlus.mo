...
model MerkelEnergyPlus
  ...
  Modelica.Blocks.Sources.CombiTimeTable datRea(
    tableOnFile=true,
    fileName=ModelicaServices.ExternalReferences.loadResource("modelica://Buildings//Resources/Data/Fluid/HeatExchangers/CoolingTowers/Validation/MerkelEnergyPlus/CoolingTower_VariableSpeed_Merkel.dat"),
    verboseRead=false,
    columns=2 : 10,
  ...
  Controls.OBC.UnitConversions.From_degC TAirWB
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60, 0}, {-40, 20}})));
  Modelica.Blocks.Sources.RealExpression TLvg_EP(
    y=datRea.y[4])
    ...
    annotation(
      Placement(
        transformation(
          extent={{80, 40}, {100, 60}})));
  Modelica.Blocks.Sources.RealExpression Q_flow_EP(
    y=-1*datRea.y[6])
    ...
    annotation(
      Placement(
        transformation(
          extent={{80, 20}, {100, 40}})));
  Modelica.Blocks.Sources.RealExpression PFan_EP(
    y=datRea.y[7])
...
equation
  connect(tow.TAir, TAirWB.y)
    annotation(
      Line(
        points={{38,-46}, {20,-46}, {20, 10}, {-38, 10}},
        color={0, 0, 127}));
  ...
  connect(datRea.y[2], TAirWB.u)
    annotation(
      Line(
        points={{-79, 50}, {-70, 50}, {-70, 10}, {-62, 10}},
        color={0, 0, 127}));
  connect(TEntWat.u, datRea.y[3])
    annotation(
      Line(
        points={{-62,-46}, {-70,-46}, {-70, 50}, {-79, 50}},
        color={0, 0, 127}));
  connect(souWat.m_flow_in, datRea.y[5])
    annotation(
      Line(
        points={{-22,-42}, {-30,-42}, {-30,-20}, {-70,-20}, {-70, 50}, {-79, 50}},
        color={0, 0, 127}));
  connect(tow.y, datRea.y[9])
    annotation(
      Line(
        points={{38,-42}, {30,-42}, {30, 50}, {-79, 50}},
        color={0, 0, 127}));
  annotation(
    Icon(
      coordinateSystem(
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/CoolingTowers/Validation/MerkelEnergyPlus.mos"
        "Simulate and plot"),
    experiment(
      StartTime=0,
      StopTime=172800,
