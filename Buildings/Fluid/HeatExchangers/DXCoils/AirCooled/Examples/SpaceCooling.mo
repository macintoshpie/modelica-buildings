  ...
  Buildings.Fluid.HeatExchangers.DXCoils.AirCooled.Data.Generic.DXCoil datCoi(
    ...
    annotation(
      Placement(
        transformation(
          extent={{0,-40}, {20,-20}})));
  parameter Buildings.Fluid.HeatExchangers.DXCoils.AirCooled.Data.Generic.DXCoil datCoiMulSpe(
    nSta=2,
    sta={Data.Generic.BaseClasses.Stage(
      spe=900/60,
      nomVal=Data.Generic.BaseClasses.NominalValues(
...
equation
  ...
  connect(weaDat.weaBus, out.weaBus)
    annotation(
      Line(
        points={{-140, 70}, {-128, 70}, {-128,-40}, {-180,-40}, {-180,-66}, {-174,-66}, {-174,-66}, {-174,-66}, {-174,-66}, {-174,-65.8}},
        color={255, 204, 51},
        thickness=0.5,
        smooth=Smooth.None));
...
public
  ...
  equation
    ...
    connect(TRoo, senTemRoo.T)
      annotation(
        Line(
          points={{134, 4.44089e-16}, {35, 4.44089e-16}, {35, 40}, {20, 40}},
          color={0, 0, 127}));
    connect(ports, vol.ports)
      annotation(
        Line(
          points={{-1.5,-158.5}, {-21,-158.5}, {-21,-20}, {7.77156e-16,-20}},
          color={0, 127, 255}));
...
equation
  ...
  connect(rooVarSpe.TOutDryBul, weaBus.TDryBul)
    annotation(
      Line(
        points={{239.067, 52.3077}, {230, 52.3077}, {230, 52}, {230, 52}, {230, 70}, {-128, 70}},
        color={0, 0, 127},
        smooth=Smooth.None));
  ...
  connect(out.ports[5], hex2.port_a1)
    annotation(
      Line(
        points={{-154,-68}, {-146,-68}, {-146,-240}, {-130,-240}, {-130,-240}, {-112,-240}},
        color={0, 127, 255},
        smooth=Smooth.None));
  ...
  connect(rooMulSpe.TRoo, mulSpeCon.u)
    annotation(
      Line(
        points={{200.933, 52.3077}, {220, 52.3077}, {220,-100}, {-70,-100}, {-70,-134.633}, {-60.65,-134.633}},
        color={0, 0, 127},
        smooth=Smooth.None));
...
First implementation.
    ...
    Diagram(
      coordinateSystem(
        ...
        extent={{-200,-300}, {300, 100}}),
      graphics),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/DXCoils/AirCooled/Examples/SpaceCooling.mos"
        "Simulate and plot"),
    experiment(
      StartTime=1.58112e+07,
      Tolerance=1e-6,
      StopTime=1.6416e+07));
end SpaceCooling;
