...
model SingleSpeedPLREnergyPlus
  ...
  Buildings.Fluid.Sources.Boundary_pT sou(
    redeclare package Medium=Medium,
    p(
      displayUnit="Pa")=101325 + dp_nominal,
    use_T_in=true,
    nPorts=1,
    use_p_in=true,
    use_X_in=true,
  ...
  Modelica.Blocks.Sources.RealExpression XEvaOutEPluMod(
    ...
    annotation(
      Placement(
        transformation(
          extent={{0,-110}, {20,-90}})));
  Modelica.Blocks.Sources.BooleanTable onOff(
    startValue=true,
    table={0, 25200, 26223.8694421458, 28800, 30457.5364262964, 32400, 34157.5093643325, 36000, 37915.2504828207, 39600, 41687.2390146012, 43200, 45363.3505825759, 46800, 49129.0477925565, 50400, 52764.5288886473, 54000, 56361.5689116996, 57600, 59868.3223307805})
  ...
  Data.Generic.DXCoil datCoi(
    ...
    sta={Data.Generic.BaseClasses.Stage(
      ...
      nomVal=Data.Generic.BaseClasses.NominalValues(
        ...
        tWet=1000,
        gamma=1.5),
      perCur=Examples.PerformanceCurves.Curve_II())})
    "Coil data"
    annotation(
      Placement(
        transformation(
...
equation
  ...
  annotation(
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/DXCoils/AirCooled/Validation/SingleSpeedPLREnergyPlus.mos"
        "Simulate and plot"),
    experiment(
      Tolerance=1e-6,
      StopTime=86400),
