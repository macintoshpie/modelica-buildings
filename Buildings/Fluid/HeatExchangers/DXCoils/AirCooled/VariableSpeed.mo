...
equation
  connect(speRat, dxCoo.speRat)
    annotation(Line(points={{-110, 80}, {-90, 80}, {-90, 57.6}, {-21, 57.6}}, color={0, 0, 127}, smooth=Smooth.None));
  connect(speRat, deaBan.u)
    annotation(Line(points={{-110, 80}, {-90, 80}, {-90, 70}, {-65.2, 70}}, color={0, 0, 127}, smooth=Smooth.None));
  connect(deaBan.y, eva.on)
    annotation(Line(points={{-51.4, 70}, {-48, 70}, {-48, 62}, {-92, 62}, {-92,-62}, {-10,-62}}, color={255, 0, 255}, smooth=Smooth.None));
  connect(onSwi.y, dxCoo.stage)
    annotation(Line(points={{-29.4, 70}, {-26, 70}, {-26, 60}, {-21, 60}}, color={255, 127, 0}, smooth=Smooth.None));
  connect(deaBan.y, onSwi.u)
    annotation(Line(points={{-51.4, 70}, {-43.2, 70}}, color={255, 0, 255}, smooth=Smooth.None));
...
</html>"), Icon(graphics={Text(extent={{-96, 96}, {-38, 78}}, lineColor={0, 0, 127}, textString="speRat")}));
end VariableSpeed;
