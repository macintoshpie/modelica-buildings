...
equation
  hADP=Buildings.Utilities.Math.Functions.smoothMin(
    ...
    x2=hEvaIn + 100,
    deltaX=10);
  XADP=Buildings.Utilities.Psychrometrics.Functions.X_pW(
    p_w=Medium.saturationPressure(TADP),
    p=p);
  TADP=Medium.temperature(Medium.setState_phX(
    p=p,
    h=hADP,
    X=cat(1, {XADP}, {1-sum({XADP})})));
  annotation(
    defaultComponentName="appDewPt",
    Icon(
      coordinateSystem(
      ...
      graphics={Line(
        ...
        smooth=Smooth.None,
        thickness=0.5), Line(
        points={{56, 68}, {54, 56}, {48, 32}, {38, 12}, {22,-8}, {6,-22}, {-12,-34}, {-28,-40}, {-46,-46}, {-62,-50}, {-66,-50}},
        color={0, 0, 255},
        thickness=0.5,
