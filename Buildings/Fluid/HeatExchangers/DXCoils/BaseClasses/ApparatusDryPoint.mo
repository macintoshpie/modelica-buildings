...
protected
  ...
  Modelica.SIunits.Temperature TADP(
    start=283.15)
...
equation
  ...
  XEvaIn=Buildings.Utilities.Psychrometrics.Functions.X_pW(
    p_w=Buildings.Utilities.Psychrometrics.Functions.saturationPressureLiquid(TADP),
    p=p);
  hMin=Medium.specificEnthalpy(Medium.setState_pTX(
    p=p,
    T=TADP,
    X=XEvaInVec));
  ...
  annotation(
    ...
    Icon(
      ...
      graphics={Line(
        ...
        smooth=Smooth.None,
        thickness=0.5), Line(
        points={{64, 64}, {62, 52}, {56, 28}, {46, 8}, {30,-12}, {14,-26}, {-4,-38}, {-20,-44}, {-38,-50}, {-54,-54}, {-58,-54}},
        color={0, 0, 255},
        thickness=0.5,
