...
block CoolingCapacityAirCooled
  ...
  extends Buildings.Fluid.HeatExchangers.DXCoils.BaseClasses.PartialCoolingCapacity(redeclare replaceable Buildings.Fluid.HeatExchangers.DXCoils.AirCooled.Data.Generic.BaseClasses.Stage sta[nSta], use_mCon_flow=false);
equation
  if stage > 0 then
