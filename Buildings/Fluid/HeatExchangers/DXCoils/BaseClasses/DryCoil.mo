...
</html>"), Icon(graphics={Rectangle(extent={{-54, 36}, {68, 20}}, lineColor={0, 0, 255}, lineThickness=0.5), Text(extent={{-62,-18}, {80,-54}}, lineColor={0, 0, 0}, lineThickness=0.5, fillColor={85, 170, 255}, fillPattern=FillPattern.Solid, textString="Dry Coil"), Line(points={{-42, 48}, {-16, 48}}, color={0, 0, 255}, smooth=Smooth.None), Polygon(points={{-12, 48}, {-16, 46}, {-16, 50}, {-12, 48}}, lineColor={0, 0, 255}, smooth=Smooth.None, fillColor={0, 0, 255}, fillPattern=FillPattern.Solid), Line(points={{-8, 10}, {18, 10}}, color={0, 0, 255}, smooth=Smooth.None), Line(points={{14, 46}, {40, 46}}, color={0, 0, 255}, smooth=Smooth.None), Polygon(points={{44, 46}, {40, 44}, {40, 48}, {44, 46}}, lineColor={0, 0, 255}, smooth=Smooth.None, fillColor={0, 0, 255}, fillPattern=FillPattern.Solid), Polygon(points={{22, 10}, {18, 8}, {18, 12}, {22, 10}}, lineColor={0, 0, 255}, smooth=Smooth.None, fillColor={0, 0, 255}, fillPattern=FillPattern.Solid)}));
end DryCoil;
