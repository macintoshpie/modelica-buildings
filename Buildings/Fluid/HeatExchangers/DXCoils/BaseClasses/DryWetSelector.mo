...
block DryWetSelector
  ...
  Modelica.Blocks.Interfaces.RealInput EIRWet
    "Energy Input Ratio"
    annotation(Placement(transformation(extent={{-10,-10}, {10, 10}}, rotation=270, origin={80, 110})));
  Modelica.Blocks.Interfaces.RealInput QWet_flow(max=0, unit="W")
    "Total cooling capacity"
    annotation(Placement(transformation(extent={{-10,-10}, {10, 10}}, rotation=270, origin={40, 110})));
  Modelica.Blocks.Interfaces.RealInput SHRWet(min=0, max=1.0)
  ...
  Modelica.Blocks.Interfaces.RealInput mWetWat_flow(quantity="MassFlowRate", unit="kg/s")
  ...
  Modelica.Blocks.Interfaces.RealOutput Q_flow(max=0, unit="W")
    "Total cooling capacity"
...
equation
  dX=XADP-XEvaIn;
  fraDry=Buildings.Utilities.Math.Functions.spliceFunction(pos=+ 1, neg=0, x=dX + deltaX, deltax=deltaX);
  fraWet=1-fraDry;
  ...
  annotation(defaultComponentName="dryWetPre", Documentation(info="<html>
<p>
...
</html>"), Icon(graphics={Rectangle(extent={{-100, 100}, {100,-100}}, lineColor={0, 0, 127}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Ellipse(extent={{-58, 28}, {-2,-28}}, lineColor={0, 0, 255}), Line(points={{-100, 50}, {-82, 50}, {-50, 20}}, color={0, 0, 255}, smooth=Smooth.None), Line(points={{-100,-50}, {-82,-50}, {-50,-20}}, color={0, 0, 255}, smooth=Smooth.None), Line(points={{-42, 14}, {-16, 0}, {-40,-16}}, color={0, 0, 255}, smooth=Smooth.None), Line(points={{-2, 0}, {54, 0}}, color={0, 0, 255}, smooth=Smooth.None, pattern=LinePattern.DashDotDot), Polygon(points={{78, 0}, {48, 8}, {48,-8}, {78, 0}}, lineColor={0, 0, 255}, smooth=Smooth.None, fillColor={0, 0, 255}, fillPattern=FillPattern.CrossDiag), Text(extent={{-70, 94}, {70, 52}}, lineColor={0, 0, 255}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid, textString="%name")}));
end DryWetSelector;
