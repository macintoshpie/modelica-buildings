...
model Condensation
  ...
  Modelica.Blocks.Sources.Ramp Q_flow(height=-20000, startTime=600, offset=0, duration=2400)
    "Heat flow"
    annotation(Placement(transformation(extent={{-60, 10}, {-40, 30}})));
  Modelica.Blocks.Sources.Ramp shr(startTime=1800, height=1, offset=0, duration=1200)
    "Sensible heat ratio"
    annotation(Placement(transformation(extent={{-60,-40}, {-40,-20}})));
equation
  connect(Q_flow.y, mWat.Q_flow)
    annotation(Line(points={{-39, 20}, {-20, 20}, {-20, 4}, {-1, 4}}, color={0, 0, 127}, smooth=Smooth.None));
  connect(shr.y, mWat.SHR)
    annotation(Line(points={{-39,-30}, {-20,-30}, {-20,-4}, {-1,-4}}, color={0, 0, 127}, smooth=Smooth.None));
  annotation(experiment(Tolerance=1e-6, StopTime=3600), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/DXCoils/BaseClasses/Examples/Condensation.mos"
