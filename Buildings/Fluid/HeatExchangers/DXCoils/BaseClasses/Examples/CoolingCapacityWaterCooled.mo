...
model CoolingCapacityWaterCooled
  ...
  Buildings.Fluid.HeatExchangers.DXCoils.BaseClasses.CoolingCapacityWaterCooled cooCap(
    sta={sta},
    nSta=1)
...
equation
  ...
  connect(mCon_flow.y, cooCap.mCon_flow)
    annotation(
      Line(
        points={{-59,-80}, {-26,-80}, {-26, 10}, {-21, 10}},
        color={0, 0, 127}));
  annotation(
    experiment(
      Tolerance=1e-6,
      StopTime=3600),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/DXCoils/BaseClasses/Examples/CoolingCapacityWaterCooled.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
