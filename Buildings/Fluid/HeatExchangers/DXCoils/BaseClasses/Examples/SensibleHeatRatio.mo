  ...
  Buildings.Fluid.HeatExchangers.DXCoils.BaseClasses.SensibleHeatRatio shr(
    ...
    annotation(
      Placement(
        transformation(
          extent={{20,-10}, {40, 10}})));
  Modelica.Blocks.Sources.Constant XADP(
    k=0.01)
    "Mass fraction"
    annotation(
      Placement(
        transformation(
          extent={{-80,-50}, {-60,-30}})));
  Modelica.Blocks.Sources.Constant hADP(
    k=35000)
    "Specific enthalpy"
    annotation(
      Placement(
...
equation
  ...
  connect(p.y, shr.p)
    annotation(
      Line(
        points={{-59, 6.10623e-16}, {-20,-3.36456e-22}, {-20, 6.10623e-16}, {19, 6.10623e-16}},
        color={0, 0, 127},
        smooth=Smooth.None));
  ...
  annotation(
    experiment(
      ...
      StopTime=3600),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/DXCoils/BaseClasses/Examples/SensibleHeatRatio.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
