  ...
  parameter Buildings.Fluid.HeatExchangers.DXCoils.AirCooled.Data.Generic.DXCoil datCoi(
    ...
    annotation(
      Placement(
        transformation(
          extent={{60, 60}, {80, 80}})));
  Modelica.Blocks.Sources.IntegerTable sta(
    table=[
      0, 0;
      10, 1;
      20, 2;
...
equation
  connect(sta.y, speSel.stage)
    annotation(
      Line(
        points={{-19, 6.10623e-16}, {0,-3.36456e-22}, {0, 6.10623e-16}, {19, 6.10623e-16}},
        color={255, 127, 0},
        smooth=Smooth.None));
  annotation(
    experiment(
      ...
      StopTime=60),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/DXCoils/BaseClasses/Examples/SpeedSelect.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
