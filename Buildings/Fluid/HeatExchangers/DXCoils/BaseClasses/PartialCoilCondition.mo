...
partial block PartialCoilCondition
  ...
  replaceable Buildings.Fluid.HeatExchangers.DXCoils.BaseClasses.CoolingCapacityAirCooled cooCap constrainedby Buildings.Fluid.HeatExchangers.DXCoils.BaseClasses.PartialCoolingCapacity(
    sta=datCoi.sta,
    nSta=datCoi.nSta)
    "Performance data"
    annotation(
