...
partial model PartialDXCoil
  ...
  Buildings.Fluid.HeatExchangers.DXCoils.BaseClasses.DXCooling dxCoo(
    ...
    wetCoi(
      redeclare replaceable Buildings.Fluid.HeatExchangers.DXCoils.BaseClasses.CoolingCapacityAirCooled cooCap),
    dryCoi(
      redeclare replaceable Buildings.Fluid.HeatExchangers.DXCoils.BaseClasses.CoolingCapacityAirCooled cooCap))
...
protected
  ...
  Modelica.SIunits.Temperature TEvaIn=Medium.temperature_phX(
    p=port_a.p,
    h=hEvaIn,
    X=XEvaIn)
...
equation
  ...
  connect(mCon_flow, dxCoo.mCon_flow)
    annotation(
      Line(
        points={{-110,-30}, {-24,-30}, {-24, 40}, {-21, 40}},
        color={0, 0, 127}));
  annotation(
