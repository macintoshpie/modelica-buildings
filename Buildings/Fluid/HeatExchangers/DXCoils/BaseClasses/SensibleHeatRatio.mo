...
block SensibleHeatRatio
  ...
  Modelica.Blocks.Interfaces.RealInput XADP(min=0, max=1.0)
    "Humidity mass fraction of air at ADP"
    annotation(Placement(transformation(extent={{-120,-50}, {-100,-30}})));
  Modelica.Blocks.Interfaces.RealInput hADP(nominal=40000, quantity="SpecificEnergy", unit="J/kg")
...
equation
  ...
  if on then
    ...
    h_TEvaIn_XADP=Medium.specificEnthalpy_pTX(p=p, T=TEvaIn, X=cat(1, {XADP}, {1-XADP}));
    //Calculate Sensible Heat Ratio
    entRat=(h_TEvaIn_XADP-hADP)/Buildings.Utilities.Math.Functions.smoothMax(x1=epsH, x2=hEvaIn-hADP, deltaX=0.1*epsH);
    SHR=Buildings.Utilities.Math.Functions.smoothMin(x1=entRat, x2=0.999, deltaX=0.0001)
  ...
  annotation(defaultComponentName="shr", Documentation(info="<html>
<p>
...
</html>"), Icon(graphics={Text(extent={{-100, 98}, {98,-98}}, lineColor={0, 0, 255}, fillColor={0, 0, 255}, fillPattern=FillPattern.Solid, textString="Qs/Q")}));
