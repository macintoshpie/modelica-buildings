...
model MultiStage
  ...
  Buildings.Fluid.HeatExchangers.DXCoils.WaterCooled.MultiStage mulSpeDX(redeclare package MediumEva=MediumAir, redeclare package MediumCon=MediumWater, datCoi=datCoi, dpEva_nominal=dpEva_nominal, dpCon_nominal=dpCon_nominal, show_T=true, energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState)
    "Multi-speed DX coil"
...
equation
  connect(TEvaIn.y, souAir.T_in)
    annotation(Line(points={{-67, 42}, {-50, 42}}, color={0, 0, 127}, smooth=Smooth.None));
  ...
  connect(mCon_flow.y, souWat.m_flow_in)
    annotation(Line(points={{67,-38}, {68,-38}, {52,-38}}, color={0, 0, 127}));
  connect(speRat.y, mulSpeDX.stage)
    annotation(Line(points={{-67, 12}, {-60, 12}, {-7.2, 12}}, color={255, 127, 0}));
  annotation(__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/DXCoils/WaterCooled/Examples/MultiStage.mos"
