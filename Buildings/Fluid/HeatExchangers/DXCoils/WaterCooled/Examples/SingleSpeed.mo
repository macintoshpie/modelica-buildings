...
equation
  ...
  connect(sinSpeDX.portCon_a, souWat.ports[1])
    annotation(
      Line(
        points={{10,-6}, {10,-30}, {32,-30}},
        color={0, 127, 255}));
  connect(sinSpeDX.portCon_b, sinWat.ports[1])
    annotation(
      Line(
        points={{-2,-6}, {-2,-30}, {-30,-30}},
        color={0, 127, 255}));
  ...
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/DXCoils/WaterCooled/Examples/SingleSpeed.mos"
        "Simulate and plot"),
    experiment(
      Tolerance=1e-6,
      StopTime=3600),
