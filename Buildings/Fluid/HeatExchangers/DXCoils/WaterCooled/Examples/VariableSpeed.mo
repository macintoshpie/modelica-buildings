...
equation
  ...
  connect(mCon_flow.y, souWat.m_flow_in)
    annotation(
      Line(
        points={{69,-38}, {68,-38}, {52,-38}},
        color={0, 0, 127}));
  connect(speRat.y, varSpeDX.speRat)
    annotation(
      Line(
        points={{-69, 12}, {-40, 12}, {-7.2, 12}},
        color={0, 0, 127}));
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/DXCoils/WaterCooled/Examples/VariableSpeed.mos"
        "Simulate and plot"),
    experiment(
      Tolerance=1e-6,
      StopTime=3600),
