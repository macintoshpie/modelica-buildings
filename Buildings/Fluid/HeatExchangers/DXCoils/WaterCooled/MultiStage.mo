...
model MultiStage
  ...
  extends Buildings.Fluid.HeatExchangers.DXCoils.BaseClasses.PartialWaterCooledDXCoil(redeclare final Buildings.Fluid.HeatExchangers.DXCoils.AirCooled.MultiStage eva(redeclare final Buildings.Fluid.HeatExchangers.DXCoils.WaterCooled.Data.Generic.DXCoil datCoi=datCoi));
...
equation
  ...
  annotation(Icon(coordinateSystem(preserveAspectRatio=false), graphics={Text(extent={{54, 100}, {98, 80}}, lineColor={0, 0, 127}, textString="P"), Line(points={{-100, 80}, {-68, 80}, {-68, 20}}, color={255, 128, 0})}), Documentation(revisions="<html>
<ul>
<li>
