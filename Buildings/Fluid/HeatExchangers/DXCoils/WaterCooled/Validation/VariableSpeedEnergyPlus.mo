...
model VariableSpeedEnergyPlus
  ...
  Buildings.Fluid.HeatExchangers.DXCoils.WaterCooled.Data.Generic.DXCoil datCoi(
    ...
    sta={Buildings.Fluid.HeatExchangers.DXCoils.WaterCooled.Data.Generic.BaseClasses.Stage(
      ...
      perCur=Buildings.Fluid.HeatExchangers.DXCoils.WaterCooled.Examples.PerformanceCurves.Curve_I()), Buildings.Fluid.HeatExchangers.DXCoils.WaterCooled.Data.Generic.BaseClasses.Stage(
      spe=1000/60,
      nomVal=Buildings.Fluid.HeatExchangers.DXCoils.WaterCooled.Data.Generic.BaseClasses.NominalValues(
  ...
  Modelica.Blocks.Math.Mean XEvaOutMea(
    ...
    annotation(
      Placement(
        transformation(
          extent={{80, 120}, {100, 140}})));
  Modelica.Blocks.Sources.RealExpression XEvaOut(
    y=sum(varSpeDX.eva.vol.Xi))
    annotation(
      Placement(
        transformation(
          extent={{40, 120}, {60, 140}})));
  ...
  Sources.MassFlowSource_T souWat(
    ...
    annotation(
      Placement(
        transformation(
          extent={{58,-40}, {38,-20}})));
  Modelica.Blocks.Sources.TimeTable masEvaIn(
    table=[
      0, 0;
      3600, 0;
      3600, 0;
  ...
  Modelica.Blocks.Sources.TimeTable masConIn(
    table=[
      0, 0;
      3600, 0;
      3600, 0;
  ...
  Sensors.TemperatureTwoPort TConOut(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-6,-40}, {-26,-20}})));
  Modelica.Blocks.Sources.TimeTable TCOutEPlu(
    table=[
      0, 14.00192912;
      3600, 14.00192912;
      3600, 14.00192912;
  ...
  Modelica.Blocks.Sources.TimeTable Q_flowConEPlu(
    table=[
      0, 0;
      3600, 0;
      3600, 0;
...
equation
  ...
  annotation(
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/DXCoils/WaterCooled/Validation/VariableSpeedEnergyPlus.mos"
        "Simulate and plot"),
    experiment(
      Tolerance=1e-6,
      StopTime=86400),
