...
equation
  ...
  connect(val.port_b, hex.port_a1)
    annotation(
      Line(
        points={{50, 60}, {54, 60}, {54, 32}, {60, 32}},
        color={0, 127, 255}));
  ...
  annotation(
    ...
    experiment(
      ...
      StopTime=3600),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/Examples/DryCoilCounterFlowPControl.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
