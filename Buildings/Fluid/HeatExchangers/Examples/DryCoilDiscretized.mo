...
model DryCoilDiscretized
  ...
  Buildings.Fluid.HeatExchangers.DryCoilDiscretized hex(
    ...
    UA_nominal=m1_flow_nominal*4200*(T_a1_nominal-T_b1_nominal)/Buildings.Fluid.HeatExchangers.BaseClasses.lmtd(T_a1_nominal, T_b1_nominal, T_a2_nominal, T_b2_nominal),
    dp2_nominal=200,
    dp1_nominal=5000,
    show_T=true,
...
equation
  ...
  connect(TDb.y, sou_2.T_in)
    annotation(
      Line(
        points={{1,-80}, {20,-80}, {20,-56}, {38,-56}},
        color={0, 0, 127}));
  connect(TWat.y, sou_1.T_in)
    annotation(
      Line(
        points={{-79, 54}, {-70.5, 54}, {-62, 54}},
        color={0, 0, 127}));
  connect(PSin_1.y, sin_1.p_in)
    annotation(
      Line(
        points={{61, 70}, {100, 70}, {100, 20}, {86, 20}},
        color={0, 0, 127}));
  ...
  connect(sou_2.ports[1], hex.port_a2)
    annotation(
      Line(
        points={{60,-60}, {70,-60}, {70,-20}, {36,-20}, {36, 5.55112e-16}, {28, 5.55112e-16}},
        color={0, 127, 255},
        smooth=Smooth.None));
  connect(sin_2.ports[1], hex.port_b2)
    annotation(
      Line(
        points={{-38, 6.66134e-16}, {-16, 6.66134e-16}, {-16, 5.55112e-16}, {8, 5.55112e-16}},
        color={0, 127, 255},
        smooth=Smooth.None));
  ...
  annotation(
    experiment(
      ...
      StopTime=360),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/Examples/DryCoilDiscretized.mos"
        "Simulate and plot"),
    Documentation(
      revisions="<html>
<ul>
