...
model WaterCooler_T
  ...
  extends Buildings.Fluid.HeatExchangers.Examples.BaseClasses.Heater(
    ...
    TOut(
      y=273.15 + 22-5*cos(time/86400*2*Modelica.Constants.pi)));
...
First implementation.
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/Examples/WaterCooler_T.mos"
        "Simulate and plot"),
    experiment(
      StopTime=172800,
      Tolerance=1e-8),
