...
model WaterHeater_T
  ...
  extends Buildings.Fluid.HeatExchangers.Examples.BaseClasses.Heater(redeclare package Medium=Buildings.Media.Water, m_flow_nominal=V*1000/3600, Q_flow_nominal=100, vol(V=V/1000), mov(nominalValuesDefineDefaultPressureCurve=true));
  Heater_T hea(redeclare package Medium=Medium, m_flow_nominal=m_flow_nominal, dp_nominal=1000, T_start=289.15, energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial, QMax_flow=Q_flow_nominal)
    "Heater"
...
</html>"), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/Examples/WaterHeater_T.mos"
    "Simulate and plot"), experiment(StopTime=172800, Tolerance=1e-6), Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100}, {120, 100}})), Icon(coordinateSystem(extent={{-100,-100}, {120, 100}})));
end WaterHeater_T;
