...
model WaterHeater_u
  ...
  extends Buildings.Fluid.HeatExchangers.Examples.BaseClasses.Heater(redeclare package Medium=Buildings.Media.Water, m_flow_nominal=V*1000/3600, Q_flow_nominal=100, conPI(k=10), vol(V=V/1000), mov(nominalValuesDefineDefaultPressureCurve=true));
  HeaterCooler_u hea(redeclare package Medium=Medium, m_flow_nominal=m_flow_nominal, dp_nominal=1000, energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial, T_start=289.15, Q_flow_nominal=10*Q_flow_nominal)
    "Heater"
...
</html>"), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/Examples/WaterHeater_u.mos"
