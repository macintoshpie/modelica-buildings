...
model WetCoilCounterFlowPControl
  ...
  Buildings.Fluid.HeatExchangers.WetCoilCounterFlow hex(
    ...
    dp1_nominal(
      displayUnit="Pa")=3000,
    UA_nominal=2*m1_flow_nominal*4200*(T_a1_nominal-T_b1_nominal)/Buildings.Fluid.HeatExchangers.BaseClasses.lmtd(T_a1_nominal, T_b1_nominal, T_a2_nominal, T_b2_nominal),
    show_T=true,
...
equation
  connect(hex.port_b1, res_1.port_a)
    annotation(
      Line(
        points={{80, 32}, {86, 32}, {86, 60}, {90, 60}},
        color={0, 127, 255}));
  ...
  annotation(
    ...
    experiment(
      ...
      StopTime=3600),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/Examples/WetCoilCounterFlowPControl.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
