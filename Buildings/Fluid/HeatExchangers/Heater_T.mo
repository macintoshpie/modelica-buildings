...
equation
  connect(TSet, outCon.TSet)
    annotation(Line(points={{-120, 80}, {-96, 80}, {10, 80}, {10, 8}, {19, 8}}, color={0, 0, 127}));
  connect(outCon.Q_flow, Q_flow)
    annotation(Line(points={{41, 8}, {80, 8}, {80, 80}, {110, 80}}, color={0, 0, 127}));
  annotation(defaultComponentName="hea", Documentation(info="<html>
<p>
...
</html>"), Icon(graphics={Rectangle(extent={{-70, 60}, {70,-60}}, lineColor={0, 0, 255}, pattern=LinePattern.None, fillColor={127, 0, 0}, fillPattern=FillPattern.Solid), Text(extent={{18,-6}, {62,-52}}, lineColor={255, 255, 255}, textString="+"), Rectangle(extent={{70, 82}, {100, 78}}, lineColor={0, 0, 255}, pattern=LinePattern.None, fillColor={0, 0, 127}, fillPattern=FillPattern.Solid), Rectangle(extent={{-100, 82}, {-70, 78}}, lineColor={0, 0, 255}, pattern=LinePattern.None, fillColor={0, 0, 127}, fillPattern=FillPattern.Solid), Text(extent={{-110, 102}, {-74, 84}}, lineColor={0, 0, 127}, textString="T"), Text(extent={{26, 108}, {94, 84}}, lineColor={0, 0, 127}, textString="Q_flow"), Rectangle(extent={{66, 60}, {70, 82}}, lineColor={0, 0, 255}, pattern=LinePattern.None, fillColor={0, 0, 127}, fillPattern=FillPattern.Solid), Rectangle(extent={{-70, 60}, {-66, 82}}, lineColor={0, 0, 255}, pattern=LinePattern.None, fillColor={0, 0, 127}, fillPattern=FillPattern.Solid), Rectangle(extent={{-64, 34}, {-34, 54}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Line(points={{-64, 34}, {-52, 44}, {-64, 54}}, color={0, 0, 0})}));
end Heater_T;
