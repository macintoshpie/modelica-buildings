...
equation
  ...
  port_a.T=port_b.T;
  annotation(Icon(coordinateSystem(preserveAspectRatio=true, extent={{-100,-100}, {100, 100}}), graphics={Line(points={{0, 90}, {0, 40}}, color={181, 0, 0}, smooth=Smooth.None), Rectangle(extent={{-100, 100}, {100,-100}}, fillColor={255, 237, 228}, fillPattern=FillPattern.Solid, pattern=LinePattern.None, lineColor={0, 0, 0}), Polygon(points={{-100, 8}, {100, 20}, {100,-20}, {-100,-8}, {-100, 8}}, smooth=Smooth.None, fillColor={127, 0, 0}, fillPattern=FillPattern.Solid, pattern=LinePattern.None), Text(extent={{-144,-42}, {156,-82}}, textString="%name", lineColor={0, 0, 255})}), Documentation(info="<html>
<p>
