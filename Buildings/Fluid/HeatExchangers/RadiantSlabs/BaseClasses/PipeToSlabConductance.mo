  ...
  parameter kc_overall_IN_con kc_IN_con
    ...
    annotation(
      Placement(
        transformation(
          extent={{-90, 84}, {-78, 96}})));
  Modelica.Fluid.Dissipation.HeatTransfer.StraightPipe.kc_overall_IN_var kc_IN_var(
  ...
  record kc_turbulent_IN_con
    ...
    Modelica.SIunits.Length K=0
      ...
      annotation(
        Dialog(
          group="Straight pipe",
          enable=roughness == Modelica.Fluid.Dissipation.Utilities.Types.Roughness.Considered));
    annotation(
      Documentation(
        info="<html>
<p>
...
<a href=\"https://github.com/lbl-srg/modelica-buildings/issues/557\">Buildings issue 557</a>.
  ...
  Medium.ThermodynamicState fluSta=Medium.setState_pTX(
    p=Medium.p_default,
    T=fluid.T,
    X=Medium.X_default)
    "State of the medium";
