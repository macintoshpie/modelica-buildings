...
partial model Slab
  ...
  parameter Buildings.Fluid.HeatExchangers.RadiantSlabs.Types.SystemType sysTyp
    "Radiant system type";
  parameter Modelica.SIunits.Distance disPip
    "Pipe distance";
  ...
  parameter HeatTransfer.Data.OpaqueConstructions.Generic layers(nLay(min=2))
    ...
    annotation(Dialog(group="Construction"), choicesAllMatching=true, Placement(transformation(extent={{-20, 60}, {0, 80}})));
