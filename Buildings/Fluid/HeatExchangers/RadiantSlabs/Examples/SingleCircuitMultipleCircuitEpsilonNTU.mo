...
model SingleCircuitMultipleCircuitEpsilonNTU
  ...
  Modelica.Thermal.HeatTransfer.Sources.FixedTemperature TAbo(
    T=293.15)
  ...
  Modelica.Thermal.HeatTransfer.Sources.FixedTemperature TBel(
    T=293.15)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-80,-90}, {-60,-70}})));
  Modelica.Thermal.HeatTransfer.Components.ThermalConductor conAbo1(
    G=20*A)
  ...
  Modelica.Thermal.HeatTransfer.Components.ThermalConductor conBel1(
    G=20*A)
  ...
  parameter Data.Pipes.PEX_RADTEST pipe
    ...
    annotation(
      Placement(
        transformation(
          extent={{80, 72}, {100, 92}})));
  Modelica.Thermal.HeatTransfer.Components.ThermalConductor conAbo2(
    G=20*A)
    "Combined convection and radiation resistance above the slab"
    annotation(
      Placement(
  ...
  Buildings.Fluid.HeatExchangers.RadiantSlabs.SingleCircuitSlab sla2(
    ...
    annotation(
      Placement(
        transformation(
          extent={{10,-30}, {30,-10}})));
  Modelica.Thermal.HeatTransfer.Components.ThermalConductor conBel2(
    G=20*A)
    "Combined convection and radiation resistance below the slab"
    annotation(
      Placement(
  ...
  Modelica.Thermal.HeatTransfer.Components.ThermalConductor conBel3(
    G=nCir*20*A)
    "Combined convection and radiation resistance below the slab"
    annotation(
      Placement(
  ...
  ParallelCircuitsSlab sla3(
    ...
    annotation(
      Placement(
        transformation(
          extent={{30,-70}, {50,-50}})));
  Modelica.Thermal.HeatTransfer.Components.ThermalConductor conAbo3(
    G=nCir*20*A)
    "Combined convection and radiation resistance above the slab"
    annotation(
      Placement(
...
equation
  ...
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/RadiantSlabs/Examples/SingleCircuitMultipleCircuitEpsilonNTU.mos"
        "Simulate and plot"),
    Diagram(
      coordinateSystem(
