...
model StepResponseEpsilonNTU
  ...
  Modelica.Thermal.HeatTransfer.Sources.FixedTemperature TAirAbo(
    T=293.15)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60, 60}, {-40, 80}})));
  Modelica.Thermal.HeatTransfer.Sources.FixedTemperature TRadAbo(
    T=293.15)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60, 20}, {-40, 40}})));
  Modelica.Thermal.HeatTransfer.Sources.FixedTemperature TAirBel(
    T=293.15)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60,-60}, {-40,-40}})));
  Modelica.Thermal.HeatTransfer.Sources.FixedTemperature TRadBel(
    T=293.15)
  ...
  HeatTransfer.Convection.Interior conBel(
    ...
    annotation(
      Placement(
        transformation(
          extent={{0,-60}, {-20,-40}})));
  Modelica.Thermal.HeatTransfer.Components.BodyRadiation hRadAbo(
    Gr=A/(1/0.7 + 1/0.7-1))
    ...
    annotation(
      Placement(
        transformation(
          extent={{-20, 20}, {0, 40}})));
  Modelica.Thermal.HeatTransfer.Components.BodyRadiation hRadBel(
    Gr=A/(1/0.7 + 1/0.7-1))
...
equation
  ...
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/RadiantSlabs/Examples/StepResponseEpsilonNTU.mos"
        "Simulate and plot"),
    Diagram(
      coordinateSystem(
