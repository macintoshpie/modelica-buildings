  ...
  Buildings.Fluid.HeatExchangers.Radiators.RadiatorEN442_2 rad2(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-10,-70}, {10,-50}})));
  Buildings.HeatTransfer.Sources.FixedTemperature TBCCon1(
    T=TRoo)
    annotation(
      Placement(
        transformation(
          extent={{-32, 28}, {-20, 40}})));
  Buildings.HeatTransfer.Sources.FixedTemperature TBCCon2(
    T=TRoo)
    annotation(
      Placement(
        transformation(
  ...
  Modelica.Blocks.Sources.Step step(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-100,-60}, {-80,-40}})));
  Buildings.HeatTransfer.Sources.FixedTemperature TBCRad2(
    T=TRoo)
    annotation(
      Placement(
        transformation(
          extent={{-32,-20}, {-20,-8}})));
  Buildings.HeatTransfer.Sources.FixedTemperature TBCRad1(
    T=TRoo)
    annotation(
      Placement(
        transformation(
...
equation
  ...
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/Radiators/Examples/RadiatorEN442_2.mos"
        "Simulate and plot"),
    experiment(
      Tolerance=1e-6,
      StopTime=10800),
