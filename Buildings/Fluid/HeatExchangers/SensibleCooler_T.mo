...
model SensibleCooler_T
  ...
  extends Buildings.Fluid.HeatExchangers.BaseClasses.PartialPrescribedOutlet(outCon(final QMin_flow=QMin_flow, final QMax_flow=0, final mWatMax_flow=0, final mWatMin_flow=0, final use_TSet=true, final use_X_wSet=false, final energyDynamics=energyDynamics, final massDynamics=Modelica.Fluid.Types.Dynamics.SteadyState, final T_start=T_start, final X_start=Medium.X_default));
...
equation
  connect(TSet, outCon.TSet)
    annotation(Line(points={{-120, 80}, {10, 80}, {10, 8}, {19, 8}}, color={0, 0, 127}));
  connect(outCon.Q_flow, Q_flow)
    annotation(Line(points={{41, 8}, {80, 8}, {80, 80}, {110, 80}}, color={0, 0, 127}));
  annotation(defaultComponentName="coo", Documentation(info="<html>
<p>
...
</html>"), Icon(graphics={Rectangle(extent={{-70, 60}, {70,-60}}, lineColor={0, 0, 255}, pattern=LinePattern.None, fillColor={0, 0, 127}, fillPattern=FillPattern.Solid), Text(extent={{20,-10}, {64,-56}}, lineColor={255, 255, 255}, textString="-"), Rectangle(extent={{-64, 34}, {-34, 54}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Line(points={{-64, 34}, {-52, 44}, {-64, 54}}, color={0, 0, 0}), Text(extent={{26, 108}, {94, 84}}, lineColor={0, 0, 127}, textString="Q_flow"), Rectangle(extent={{70, 82}, {100, 78}}, lineColor={0, 0, 255}, pattern=LinePattern.None, fillColor={0, 0, 127}, fillPattern=FillPattern.Solid), Rectangle(extent={{66, 60}, {70, 82}}, lineColor={0, 0, 255}, pattern=LinePattern.None, fillColor={0, 0, 127}, fillPattern=FillPattern.Solid), Rectangle(extent={{-70, 60}, {-66, 82}}, lineColor={0, 0, 255}, pattern=LinePattern.None, fillColor={0, 0, 127}, fillPattern=FillPattern.Solid), Rectangle(extent={{-100, 82}, {-70, 78}}, lineColor={0, 0, 255}, pattern=LinePattern.None, fillColor={0, 0, 127}, fillPattern=FillPattern.Solid), Text(extent={{-110, 102}, {-74, 84}}, lineColor={0, 0, 127}, textString="T")}));
