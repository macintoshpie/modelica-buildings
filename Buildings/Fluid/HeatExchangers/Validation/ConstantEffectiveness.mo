...
equation
  ...
  connect(hex.port_a2, sou_2.ports[1])
    annotation(
      Line(
        points={{26, 5.55112e-16}, {32, 5.55112e-16}, {32,-20}, {70,-20}, {70,-60}, {60,-60}},
        color={0, 127, 255}));
  ...
  connect(sin_2.ports[1], hex.port_b2)
    annotation(
      Line(
        points={{-38, 6.66134e-16}, {-27, 6.66134e-16}, {-27, 1.22125e-15}, {-16, 1.22125e-15}, {-16, 5.55112e-16}, {6, 5.55112e-16}},
        color={0, 127, 255}));
  ...
  annotation(
    experiment(
      ...
      StopTime=360),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/Validation/ConstantEffectiveness.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
