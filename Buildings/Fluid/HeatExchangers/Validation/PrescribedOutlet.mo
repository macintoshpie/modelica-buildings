...
model PrescribedOutlet
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort heaHigPowOut(
    ...
    annotation(
      Placement(
        transformation(
          extent={{78, 110}, {98, 130}})));
  Modelica.Blocks.Sources.TimeTable TSetHeat(
    table=[
      0, 273.15 + 20.0;
      120, 273.15 + 20.0;
      120, 273.15 + 60.0;
  ...
  Buildings.Fluid.HeatExchangers.PrescribedOutlet cooLimPow(
    ...
    annotation(
      Placement(
        transformation(
          extent={{40, 24}, {60, 44}})));
  Modelica.Blocks.Sources.TimeTable TSetCool(
    table=[
      0, 273.15 + 20.0;
      120, 273.15 + 20.0;
      120, 273.15 + 15.0;
  ...
  Buildings.Fluid.HeatExchangers.PrescribedOutlet heaCooUnl(
    ...
    annotation(
      Placement(
        transformation(
          extent={{40,-60}, {60,-40}})));
  Modelica.Blocks.Sources.TimeTable TSetCoolHeat(
    table=[
      0, 273.15 + 20.0;
      120, 273.15 + 20.0;
      120, 273.15 + 15.0;
...
equation
  ...
  annotation(
    Diagram(
      ...
      graphics),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatExchangers/Validation/PrescribedOutlet.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
