...
block EquationFitReversible
  ...
  Modelica.Blocks.Interfaces.RealInput Q_flow_set(
    final unit="W")
    "Required heat to meet set point"
    annotation(
      Placement(
        transformation(
          extent={{-124, 76}, {-100, 100}}),
        iconTransformation(
...
protected
  parameter Modelica.SIunits.HeatFlowRate Q_flow_small(
    min=Modelica.Constants.eps)=per.hea.Q_flow*1E-9*scaling_factor
