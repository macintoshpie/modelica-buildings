...
partial model PartialWaterToWater
  ...
  extends Buildings.Fluid.Interfaces.FourPortFlowResistanceParameters(final computeFlowResistance1=dp1_nominal > 0, final computeFlowResistance2=dp2_nominal > 0);
  ...
  Modelica.Blocks.Interfaces.RealInput y(final unit="1") if enable_variable_speed == true
  ...
  Modelica.Blocks.Interfaces.IntegerInput stage if enable_variable_speed == false
    ...
    annotation(Placement(transformation(extent={{-140, 10}, {-100, 50}})));
  Modelica.Blocks.Interfaces.RealOutput QCon_flow(min=0, final quantity="HeatFlowRate", final unit="W")
  ...
  Modelica.Blocks.Interfaces.RealOutput P(min=0, final quantity="Power", final unit="W")
    "Electric power consumed by compressor"
    annotation(Placement(transformation(extent={{100,-10}, {120, 10}}), iconTransformation(extent={{100,-10}, {120, 10}})));
  Modelica.Blocks.Interfaces.RealOutput QEva_flow(max=0, final quantity="HeatFlowRate", final unit="W")
...
protected
  ...
  Modelica.Blocks.Nonlinear.Limiter lim(final uMin=0, final uMax=1) if enable_variable_speed == false
