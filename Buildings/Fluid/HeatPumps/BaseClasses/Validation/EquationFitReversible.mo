...
model EquationFitReversible
  ...
  BaseClasses.EquationFitReversible equFit(per=per, scaling_factor=1)
  ...
  Controls.OBC.CDL.Continuous.Sources.Sine TLoaEnt(amplitude=10, freqHz=1/2600, offset=25 + 273.15, startTime=0)
  ...
  Controls.OBC.CDL.Continuous.Sources.Sine TSouEnt(amplitude=5, freqHz=1/2600, offset=15 + 273.15, startTime=0)
...
equation
  ...
  connect(reaToInt.y, equFit.uMod)
    annotation(Line(points={{1,-10}, {45,-10}}, color={255, 127, 0}));
  connect(Q_flow_set.y, equFit.Q_flow_set)
    annotation(Line(points={{-39, 80}, {40, 80}, {40,-1}, {45,-1}}, color={0, 0, 127}));
  connect(mLoa_flow.y, equFit.mLoa_flow)
    annotation(Line(points={{-38, 50}, {34, 50}, {34,-4}, {45,-4}}, color={0, 0, 127}));
  connect(TLoaEnt.y, equFit.TLoaEnt)
    annotation(Line(points={{-38, 20}, {24, 20}, {24,-7}, {45,-7}}, color={0, 0, 127}));
  connect(mSou_flow.y, equFit.mSou_flow)
    annotation(Line(points={{-38,-70}, {36,-70}, {36,-18}, {45,-18}}, color={0, 0, 127}));
  connect(TSouEnt.y, equFit.TSouEnt)
    annotation(Line(points={{-38,-40}, {30,-40}, {30,-14}, {45,-14}}, color={0, 0, 127}));
  annotation(Icon(coordinateSystem(preserveAspectRatio=false, extent={{-120,-100}, {100, 100}}), graphics={Ellipse(lineColor={75, 138, 73}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid, extent={{-100,-102}, {100, 98}}), Polygon(lineColor={0, 0, 255}, fillColor={75, 138, 73}, pattern=LinePattern.None, fillPattern=FillPattern.Solid, points={{-30, 64}, {70, 4}, {-30,-56}, {-30, 64}})}), Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100}, {100, 100}})), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatPumps/BaseClasses/Validation/EquationFitReversible.mos"
    "Simulate and plot"), experiment(Tolerance=1e-6, StopTime=2600), Documentation(info="<html>
<p>
