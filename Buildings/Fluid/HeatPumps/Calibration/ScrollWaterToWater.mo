...
model ScrollWaterToWater
  ...
  extends Buildings.Fluid.HeatPumps.Calibration.BaseClasses.PartialWaterToWater(redeclare package Medium1=Buildings.Media.Water, redeclare package Medium2=Buildings.Media.Water, redeclare Buildings.Fluid.HeatPumps.ScrollWaterToWater heaPum(datHeaPum(etaEle=etaEle, PLos=PLos, dTSup=dTSup, UACon=UACon, UAEva=UAEva, volRat=volRat, V_flow_nominal=V_flow_nominal, leaCoe=leaCoe), energyDynamics=Modelica.Fluid.Types.Dynamics.SteadyState, enable_temperature_protection=false), calDat(tableName="ManufacturerData", fileName=Modelica.Utilities.Files.loadResource("modelica://Buildings/Resources/src/fluid/heatpumps/calibration/manufacturerData.txt")), UACon=12000.0, UAEva=12000.0, m1_flow_nominal=1.42, m2_flow_nominal=1.42);
  ...
  annotation(Icon(coordinateSystem(preserveAspectRatio=false, extent={{-140,-100}, {100, 100}})), Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-140,-100}, {100, 100}}), graphics={Text(extent={{-88, 92}, {-64, 90}}, lineColor={28, 108, 200})}), preferredView="info", __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatPumps/Calibration/ScrollWaterToWater.mos"
    "Simulate and plot"), experiment(Tolerance=1e-6, StopTime=142), Documentation(info="<HTML>
<p>
