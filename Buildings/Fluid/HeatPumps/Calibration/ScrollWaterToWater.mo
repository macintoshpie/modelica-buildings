...
model ScrollWaterToWater
  ...
  extends Buildings.Fluid.HeatPumps.Calibration.BaseClasses.PartialWaterToWater(
    ...
    calDat(
      ...
      fileName=Modelica.Utilities.Files.loadResource("modelica://Buildings/Resources/src/fluid/heatpumps/calibration/manufacturerData.txt")),
    UACon=12000.0,
    UAEva=12000.0,
  ...
  annotation(
    ...
    preferredView="info",
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatPumps/Calibration/ScrollWaterToWater.mos"
        "Simulate and plot"),
    experiment(
      Tolerance=1e-6,
      StopTime=142),
