...
protected
  Modelica.Blocks.Math.Gain yEva(
    final k=1/QEva_flow_nominal)
    "Normalized evaporator heat flow rate"
    annotation(
      Placement(
        transformation(
          extent={{40,-40}, {60,-20}})));
  Modelica.Blocks.Math.Add QEva_flow_internal(
    final k1=-1)
...
equation
  connect(TSet, con.TSet)
    annotation(
      Line(
        points={{-120, 90}, {-80, 90}, {-80, 90}, {-80, 68}, {-12, 68}},
        color={0, 0, 127}));
  connect(con.Q_flow, QCon_flow)
    annotation(
      Line(
        points={{11, 68}, {80, 68}, {80, 90}, {110, 90}},
        color={0, 0, 127}));
  connect(QEva_flow_internal.u1, con.Q_flow)
    annotation(
      Line(
        points={{-2,-24}, {-10,-24}, {-10, 0}, {30, 0}, {30, 68}, {11, 68}},
        color={0, 0, 127}));
  connect(QEva_flow_internal.u2, PEle.y)
    annotation(
      Line(
        points={{-2,-36}, {-2,-36}, {-20,-36}, {-20,-14}, {90,-14}, {90, 0}, {61, 0}},
        color={0, 0, 127}));
  connect(QEva_flow_internal.y, yEva.u)
    annotation(
      Line(
        points={{21,-30}, {30,-30}, {38,-30}},
        color={0, 0, 127}));
  connect(QEva_flow, QEva_flow_internal.y)
    annotation(
      Line(
        points={{110,-90}, {78,-90}, {28,-90}, {28,-30}, {21,-30}},
        color={0, 0, 127}));
  connect(yEva.y, eva.u)
    annotation(
      Line(
        points={{61,-30}, {70,-30}, {70,-54}, {12,-54}},
        color={0, 0, 127}));
  annotation(
    Icon(
      coordinateSystem(
      ...
      graphics={Text(
        ...
        textString="TCon"), Line(
        points={{-100, 90}, {-80, 90}, {-80, 84}, {80, 84}, {80, 64}},
        color={0, 0, 255})}),
