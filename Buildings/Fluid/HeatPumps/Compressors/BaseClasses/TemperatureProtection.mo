  ...
  Modelica.Blocks.Logical.Switch switch
    ...
    annotation(
      Placement(
        transformation(
          extent={{60,-10}, {80, 10}})));
  Modelica.Blocks.Logical.Hysteresis hysHig(
    uLow=0,
    uHigh=dTHys,
  ...
  Modelica.Blocks.Sources.Constant zero(
    ...
    annotation(
      Placement(
        transformation(
          extent={{20,-40}, {40,-20}})));
  Modelica.Blocks.Logical.Hysteresis hysLow(
    uLow=0,
    uHigh=dTHys,
    final pre_y_start=pre_y_start)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-20, 20}, {0, 40}})));
  Modelica.Blocks.Sources.Constant TMax(
    final k=TConMax)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-92,-42}, {-80,-30}})));
  Modelica.Blocks.Math.Add dTCon(
    k2=-1)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60,-20}, {-40,-40}})));
  Modelica.Blocks.Math.Add dTEva(
    k1=-1)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60, 20}, {-40, 40}})));
  Modelica.Blocks.Sources.Constant TMin(
    final k=TEvaMin)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-92, 30}, {-80, 42}})));
  Modelica.Blocks.MathBoolean.And on(
    nu=3)
    "Compressor status"
    annotation(
      Placement(
  ...
  Modelica.Blocks.Logical.Hysteresis hysdTConEva(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-20,-10}, {0, 10}})));
  Modelica.Blocks.Math.Add dTEvaCon(
    final k1=-1)
...
equation
  ...
  connect(u, switch.u1)
    annotation(
      Line(
        points={{-120, 0}, {-96, 0}, {-96, 60}, {50, 60}, {50, 8}, {58, 8}},
        color={0, 0, 127}));
  connect(switch.y, y)
    annotation(
      Line(
  ...
  connect(TMax.y, dTCon.u1)
    annotation(
      Line(
        points={{-79.4,-36}, {-79.4,-36}, {-62,-36}},
        color={0, 0, 127}));
  connect(TMin.y, dTEva.u1)
    annotation(
      Line(
        points={{-79.4, 36}, {-62, 36}},
        color={0, 0, 127}));
  connect(dTEva.u2, TEva)
    annotation(
      Line(
        points={{-62, 24}, {-70, 24}, {-70,-80}, {-120,-80}},
        color={0, 0, 127}));
  connect(dTCon.u2, TCon)
    annotation(
      Line(
        points={{-62,-24}, {-76,-24}, {-76, 80}, {-120, 80}},
        color={0, 0, 127}));
  connect(dTEva.y, hysLow.u)
    annotation(
      Line(
        points={{-39, 30}, {-39, 30}, {-22, 30}},
        color={0, 0, 127}));
  connect(hysHig.u, dTCon.y)
    annotation(
      Line(
        points={{-22,-30}, {-22,-30}, {-39,-30}},
        color={0, 0, 127}));
  connect(on.y, switch.u2)
    annotation(
      Line(
        points={{41.5, 0}, {41.5, 0}, {58, 0}},
        color={255, 0, 255}));
  connect(dTEvaCon.y, hysdTConEva.u)
    annotation(
      Line(
        points={{-39, 0}, {-32, 0}, {-22, 0}},
        color={0, 0, 127}));
  connect(dTEvaCon.u2, TCon)
    annotation(
      Line(
        points={{-62,-6}, {-76,-6}, {-76, 80}, {-120, 80}},
        color={0, 0, 127}));
  connect(dTEvaCon.u1, TEva)
    annotation(
      Line(
        points={{-62, 6}, {-70, 6}, {-70,-80}, {-120,-80}},
        color={0, 0, 127}));
  connect(hysLow.y, on.u[1])
    annotation(
      Line(
        points={{1, 30}, {10, 30}, {10, 4.66667}, {20, 4.66667}},
        color={255, 0, 255}));
  ...
  connect(hysHig.y, on.u[3])
    annotation(
      Line(
        points={{1,-30}, {14,-30}, {14,-4}, {18,-4}, {18,-4.66667}, {20,-4.66667}},
        color={255, 0, 255}));
  connect(hysLow.y, notEva.u)
    annotation(
      Line(
        points={{1, 30}, {10, 30}, {10, 90}, {61.6, 90}},
        color={255, 0, 255}));
  connect(notEva.y, errLowPre)
    annotation(
      Line(
        points={{77.2, 90}, {94, 90}, {110, 90}},
        color={255, 0, 255}));
  connect(notdT.u, hysdTConEva.y)
    annotation(
      Line(
        points={{61.6, 70}, {12, 70}, {12, 0}, {1, 0}},
        color={255, 0, 255}));
  connect(notdT.y, errNegTemDif)
    annotation(
      Line(
        points={{77.2, 70}, {110, 70}},
        color={255, 0, 255}));
  connect(notCon.y, errHigPre)
    annotation(
      Line(
        points={{77.2, 50}, {110, 50}, {110, 50}},
        color={255, 0, 255}));
  connect(notCon.u, hysHig.y)
    annotation(
      Line(
        points={{61.6, 50}, {14, 50}, {14,-30}, {1,-30}},
        color={255, 0, 255}));
  annotation(
    Documentation(
      revisions="<html>
