...
model TemperatureProtection
  ...
  Buildings.Fluid.HeatPumps.Compressors.BaseClasses.TemperatureProtection temPro(
    TConMax=313.15,
    TEvaMin=278.15)
...
equation
  ...
  connect(temPro.TCon, TCon.y)
    annotation(
      Line(
        points={{-22, 18}, {-40, 18}, {-40, 50}, {-59, 50}},
        color={0, 0, 127}));
  connect(one.y, temPro.u)
    annotation(
      Line(
        points={{-59, 10}, {-40, 10}, {-22, 10}},
        color={0, 0, 127}));
  annotation(
    Documentation(
      info="<html>
...
First implementation.
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatPumps/Compressors/BaseClasses/Validation/TemperatureProtection.mos"
        "Simulate and plot"),
    experiment(
      StopTime=5,
      Tolerance=1e-06));
