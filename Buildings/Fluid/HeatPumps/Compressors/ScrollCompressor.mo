...
model ScrollCompressor
  ...
  Modelica.SIunits.MassFlowRate mLea_flow
...
equation
  ...
  if isOn then
    ...
    // Refrigerant mass flow rate
    mLea_flow=leaCoe*PR;
    m_flow=v_norm*Buildings.Utilities.Math.Functions.smoothMax(V_flow_nominal/vSuc-mLea_flow, 1e-5*V_flow_nominal/vSuc, 1e-6*V_flow_nominal/vSuc);
  ...
  annotation(defaultComponentName="scrCom", Documentation(info="<html>
<p>
