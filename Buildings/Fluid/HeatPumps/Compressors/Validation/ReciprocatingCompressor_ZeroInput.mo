...
model ReciprocatingCompressor_ZeroInput
  ...
  Buildings.Fluid.HeatPumps.Compressors.ReciprocatingCompressor com(redeclare package ref=Buildings.Media.Refrigerants.R410A, pisDis=0.00162, cleFac=0.069, etaEle=0.696, PLos=100, dTSup=9.82, pDro=99290)
