...
model ScrollCompressor
  ...
  Buildings.Fluid.HeatPumps.Compressors.ScrollCompressor com(redeclare package ref=Buildings.Media.Refrigerants.R410A, V_flow_nominal=0.003, leaCoe=0.005, etaEle=0.85, PLos=500, dTSup=3, volRat=2.1)
    "Scroll compressor"
...
equation
  ...
  annotation(__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatPumps/Compressors/Validation/ScrollCompressor.mos"
