...
record Generic
  ...
  parameter HeatingCoolingData coo(mLoa_flow=hea.mLoa_flow, mSou_flow=hea.mSou_flow)
...
Buildings.Fluid.HeatPumps.EquationFitReversible</a>.
  ...
  annotation(defaultComponentName="per", defaultComponentPrefixes="parameter", Documentation(info="<html>
<p>
