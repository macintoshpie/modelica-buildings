...
record Generic
  ...
  parameter Modelica.SIunits.PressureDifference dpHeaLoa_nominal(
    min=0)=30000
    "Nominal pressure drop at load heat exchanger side at hea.mLoa_flow";
  parameter Modelica.SIunits.PressureDifference dpHeaSou_nominal(
    min=0)=30000
...
protected
  record HeatingCoolingData
    ...
    parameter Modelica.SIunits.HeatFlowRate Q_flow
      ...
      annotation(
        Dialog(
          group="Nominal conditions at load heat exchanger side"));
    ...
    parameter Real coeQ[5]
      ...
      annotation(
        Dialog(
          group="Performance coefficients"));
    parameter Real coeP[5]
      "Power ratio coefficients"
      annotation(
        Dialog(
          group="Electrical power performance coefficients"));
