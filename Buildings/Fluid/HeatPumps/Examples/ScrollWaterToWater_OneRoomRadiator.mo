...
equation
  ...
  connect(temRet.port_b, heaPum.port_a1)
    annotation(
      Line(
        points={{60,-30}, {60,-144}, {30,-144}},
        color={0, 127, 255}));
  connect(pumHeaPumSou.port_b, heaPum.port_a2)
    annotation(
      Line(
        points={{-30,-170}, {-30,-156}, {10,-156}},
        color={0, 127, 255}));
  connect(hysteresis.y, not2.u)
    annotation(
      Line(
        points={{-179,-40}, {-162,-40}},
        color={255, 0, 255}));
  connect(temRoo.T, hysteresis.u)
    annotation(
      Line(
        points={{-50, 30}, {-220, 30}, {-220,-40}, {-202,-40}},
        color={0, 0, 127}));
  ...
  connect(temRet.port_a, rad.port_b)
    annotation(
      Line(
        points={{60,-10}, {60, 0}, {20, 0}},
        color={0, 127, 255}));
  connect(booToReaPum1.y, heaPum.y)
    annotation(
      Line(
        points={{40,-121}, {40,-147}, {32,-147}},
        color={0, 0, 127}));
...
First implementation.
    ...
    Diagram(
      coordinateSystem(
        ...
        extent={{-240,-220}, {100, 100}})),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatPumps/Examples/ScrollWaterToWater_OneRoomRadiator.mos"
        "Simulate and plot"),
    experiment(
      StopTime=172800,
      Tolerance=1e-08));
