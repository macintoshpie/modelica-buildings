...
model Carnot_TCon_LowTemperature
  ...
  Modelica.Blocks.Sources.Ramp TConEnt(duration=60, offset=273.15 + 20, startTime=3000, height=-19)
    "Control signal for condenser entering temperature"
    annotation(Placement(transformation(extent={{-90, 0}, {-70, 20}})));
equation
  connect(TConEnt.y, sou1.T_in)
    annotation(Line(points={{-69, 10}, {-62, 10}}, color={0, 0, 127}));
  annotation(experiment(Tolerance=1e-6, StopTime=3600), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatPumps/Validation/Carnot_TCon_LowTemperature.mos"
