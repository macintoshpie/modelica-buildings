...
model Carnot_y_etaPL
  ...
  extends Examples.Carnot_y(heaPum(a={0.7, 0.3}, T1_start=303.15, T2_start=278.15));
  annotation(experiment(Tolerance=1e-6, StopTime=3600), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatPumps/Validation/Carnot_y_etaPL.mos"
