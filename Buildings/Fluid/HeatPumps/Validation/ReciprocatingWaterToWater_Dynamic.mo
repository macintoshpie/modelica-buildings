  ...
  Modelica.Blocks.Sources.Constant TSou(
    ...
    annotation(
      Placement(
        transformation(
          extent={{100,-90}, {80,-70}})));
  Modelica.Blocks.Sources.RealExpression appCap(
    y=heaPum1.port_a1.m_flow*(heaPum1.port_b1.h_outflow-loa1.ports[1].h_outflow))
...
equation
  connect(mSou.y, sou.m_flow_in)
    annotation(
      Line(
        points={{79,-52}, {74,-52}, {74, 54}, {60, 54}},
        color={0, 0, 127}));
  connect(heaPum.port_a2, sou.ports[1])
    annotation(
      Line(
        points={{10, 46}, {26, 46}, {40, 46}},
        color={0, 127, 255}));
  ...
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatPumps/Validation/ReciprocatingWaterToWater_Dynamic.mos"
        "Simulate and plot"),
    experiment(
      Tolerance=1e-6,
      StopTime=1000),
