...
model ReciprocatingWaterToWater_ScalingFactor
  ...
  Modelica.Blocks.Sources.RealExpression capErr(y=(heaPum1.QCon_flow-scaling_factor*heaPum.QCon_flow))
...
equation
  ...
  connect(TLoa.y, loa1.T_in)
    annotation(Line(points={{-81,-58}, {-70,-58}, {-70,-44}, {-62,-44}}, color={0, 0, 127}));
  connect(TLoa.y, loa.T_in)
    annotation(Line(points={{-81,-58}, {-70,-58}, {-70, 62}, {-62, 62}}, color={0, 0, 127}));
