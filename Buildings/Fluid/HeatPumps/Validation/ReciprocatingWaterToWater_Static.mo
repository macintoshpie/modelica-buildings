  ...
  Modelica.Blocks.Sources.Ramp ySou(
    ...
    annotation(
      Placement(
        transformation(
          extent={{100,-38}, {80,-18}})));
  Modelica.Blocks.Sources.Constant isOn(
    k=1)
...
equation
  ...
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatPumps/Validation/ReciprocatingWaterToWater_Static.mos"
        "Simulate and plot"),
    experiment(
      Tolerance=1e-6,
      StopTime=1000),
