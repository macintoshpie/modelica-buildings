...
model ReciprocatingWaterToWater_VariableSpeed
  ...
  Modelica.Blocks.Sources.Trapezoid N(startTime=100, offset=0.0, rising=200, width=200, falling=200, period=1000)
...
equation
  ...
  connect(TSou.y, sou.T_in)
    annotation(Line(points={{79,-28}, {76,-28}, {72,-28}, {72,-2}, {70,-2}}, color={0, 0, 127}));
  connect(TLoa.y, loa.T_in)
    annotation(Line(points={{-79, 0}, {-79, 0}, {-74, 0}, {-74, 24}, {-68, 24}}, color={0, 0, 127}));
  ...
  connect(heaPum.port_a1, loa.ports[1])
    annotation(Line(points={{-10, 6}, {-20, 6}, {-20, 20}, {-46, 20}}, color={0, 127, 255}));
  ...
  annotation(__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatPumps/Validation/ReciprocatingWaterToWater_VariableSpeed.mos"
    "Simulate and plot"), experiment(Tolerance=1e-6, StopTime=2000), Documentation(info="<html>
<p>
