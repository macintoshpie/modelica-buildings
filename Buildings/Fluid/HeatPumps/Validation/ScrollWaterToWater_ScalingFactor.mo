...
equation
  ...
  connect(TLoa.y, loa1.T_in)
    annotation(
      Line(
        points={{-79,-60}, {-70,-60}, {-70,-44}, {-62,-44}},
        color={0, 0, 127}));
  connect(TLoa.y, loa.T_in)
    annotation(
      Line(
        points={{-79,-60}, {-70,-60}, {-70, 62}, {-62, 62}},
        color={0, 0, 127}));
  ...
  connect(mLoa.y, loa1.m_flow_in)
    annotation(
      Line(
        points={{-79,-40}, {-69.5,-40}, {-60,-40}},
        color={0, 0, 127}));
  connect(mSou.y, sou1.m_flow_in)
    annotation(
      Line(
        points={{79,-52}, {69.5,-52}, {60,-52}},
        color={0, 0, 127}));
  ...
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatPumps/Validation/ScrollWaterToWater_ScalingFactor.mos"
        "Simulate and plot"),
    experiment(
      Tolerance=1e-6,
      StopTime=1000),
