...
equation
  ...
  connect(sou.ports[1], heaPum.port_a2)
    annotation(
      Line(
        points={{48,-6}, {29,-6}, {10,-6}},
        color={0, 127, 255}));
  connect(sin1.ports[1], heaPum.port_b1)
    annotation(
      Line(
        points={{48, 20}, {20, 20}, {20, 6}, {10, 6}},
        color={0, 127, 255}));
  ...
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/HeatPumps/Validation/ScrollWaterToWater_Static.mos"
        "Simulate and plot"),
    experiment(
      Tolerance=1e-6,
      StopTime=1000),
