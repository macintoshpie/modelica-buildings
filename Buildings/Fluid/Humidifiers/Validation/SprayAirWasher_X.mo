...
model SprayAirWasher_X
  ...
  replaceable Buildings.Fluid.Humidifiers.SprayAirWasher_X hum(
    ...
    massDynamics=Modelica.Fluid.Types.Dynamics.SteadyState) constrainedby Buildings.Fluid.HeatExchangers.BaseClasses.PartialPrescribedOutlet(
    redeclare package Medium=Medium,
...
equation
  ...
  connect(senHum.port_b, sin.ports[1])
    annotation(
      Line(
        points={{80, 0}, {92, 0}, {100, 0}, {100, 1.11022e-15}},
        color={0, 127, 255}));
  annotation(
    Diagram(
      coordinateSystem(
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Humidifiers/Validation/SprayAirWasher_X.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
