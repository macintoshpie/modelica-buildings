...
model SteamHumidifier_X
  ...
  extends Buildings.Fluid.Humidifiers.Validation.SprayAirWasher_X(redeclare Buildings.Fluid.Humidifiers.SteamHumidifier_X hum(mWatMax_flow=mWat_flow_nominal, massDynamics=Modelica.Fluid.Types.Dynamics.SteadyState));
  annotation(__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Humidifiers/Validation/SteamHumidifier_X.mos"
