...
record EightPortFlowResistanceParameters
  ...
  parameter Boolean from_dp3=false
    ...
    annotation(
      Evaluate=true,
      Dialog(
        enable=computeFlowResistance3,
        tab="Flow resistance",
        group="Medium 3"));
  parameter Modelica.SIunits.Pressure dp3_nominal(
    min=0,
    displayUnit="Pa")
    "Pressure"
    annotation(
  ...
  parameter Boolean from_dp4=false
    ...
    annotation(
      Evaluate=true,
      Dialog(
        enable=computeFlowResistance4,
        tab="Flow resistance",
        group="Medium 4"));
  parameter Modelica.SIunits.Pressure dp4_nominal(
    min=0,
    displayUnit="Pa")
    "Pressure"
    annotation(
