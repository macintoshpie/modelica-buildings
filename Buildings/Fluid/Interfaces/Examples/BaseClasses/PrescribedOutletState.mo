  ...
  Buildings.Fluid.Interfaces.PrescribedOutlet heaHigPow(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-10, 76}, {10, 96}})));
  Modelica.Blocks.Sources.CombiTimeTable setHeaHigPow(
    table=[
      0, 20.0, 0.012;
      120, 20.0, 0.012;
      500, 60.0, 0.020;
  ...
  Buildings.Fluid.Interfaces.PrescribedOutlet cooLimPow(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-10,-10}, {10, 10}})));
  Modelica.Blocks.Sources.CombiTimeTable setCooLimPow(
    table=[
      0, 20.0, 0.008;
      120, 20.0, 0.008;
      500, 15.0, 0.004;
  ...
  Buildings.Fluid.Interfaces.PrescribedOutlet steSta(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-10,-100}, {10,-80}})));
  Modelica.Blocks.Sources.CombiTimeTable setHeaCooUnl(
    table=[
      0, 20.0, 0.012;
      120, 20.0, 0.012;
      500, 15.0, 0.008;
...
equation
  ...
  connect(m_flow.y, sou4.m_flow_in)
    annotation(
      Line(
        points={{-109, 8}, {-100, 8}, {-100,-82}, {-92,-82}},
        color={0, 0, 127}));
  connect(sou4.ports[1], steSta.port_a)
    annotation(
      Line(
        points={{-70,-90}, {-40,-90}, {-10,-90}},
        color={0, 127, 255}));
  connect(steSta.port_b, sin.ports[4])
    annotation(
      Line(
        points={{10,-90}, {54,-90}, {54, 3}, {90, 3}},
        color={0, 127, 255}));
  annotation(
    Diagram(
      coordinateSystem(
