...
First implementation.
    ...
    experiment(
      ...
      StopTime=5),
    __Dymola_Commands(
      file="Resources/Scripts/Dymola/Fluid/Interfaces/Examples/EightPortHeatMassExchanger.mos"
        "Simulate and plot"));
