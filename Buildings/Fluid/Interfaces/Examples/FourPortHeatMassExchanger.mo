...
equation
  connect(sin.ports[1], fouPor.port_b2)
    annotation(
      Line(
        points={{-40,-28}, {-20,-28}, {-20, 4}, {-10, 4}},
        color={0, 127, 255}));
  connect(fouPor.port_b1, sin.ports[2])
    annotation(
      Line(
        points={{10, 16}, {24, 16}, {24,-32}, {-40,-32}},
        color={0, 127, 255}));
  connect(sou1.ports[1], fouPor.port_a1)
    annotation(
      Line(
        points={{-40, 10}, {-20, 10}, {-20, 16}, {-10, 16}},
        color={0, 127, 255}));
  connect(sou2.ports[1], fouPor.port_a2)
    annotation(
      Line(
        points={{40, 10}, {20, 10}, {20, 4}, {10, 4}},
        color={0, 127, 255}));
  connect(ram_m_flow.y, sou1.m_flow_in)
    annotation(
      Line(
        points={{-69, 40}, {-66, 40}, {-66, 18}, {-62, 18}},
        color={0, 0, 127}));
  connect(ram_T.y, sou1.T_in)
    annotation(
      Line(
        points={{-69, 0}, {-66, 0}, {-66, 14}, {-62, 14}},
        color={0, 0, 127}));
  annotation(
    Documentation(
      info="<html>
...
First implementation.
    ...
    experiment(
      ...
      StopTime=5),
    __Dymola_Commands(
      file="Resources/Scripts/Dymola/Fluid/Interfaces/Examples/FourPortHeatMassExchanger.mos"
        "Simulate and plot"));
