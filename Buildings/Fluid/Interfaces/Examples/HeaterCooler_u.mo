...
model HeaterCooler_u
  ...
  Modelica.Blocks.Sources.Constant TDb(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-200, 94}, {-180, 114}})));
  Buildings.Fluid.Sources.Boundary_pT sou_1(
    redeclare package Medium=Medium,
    use_T_in=true,
    nPorts=4,
    p(
      displayUnit="Pa")=101735,
    T=293.15)
    annotation(
      Placement(
        transformation(
          extent={{-170, 90}, {-150, 110}})));
  ...
  Modelica.Blocks.Math.Add che1(
    ...
    annotation(
      Placement(
        transformation(
          extent={{160, 160}, {180, 180}})));
  Modelica.Blocks.Math.Add che2(
    k2=-1)
    annotation(
      Placement(
        transformation(
          extent={{160, 116}, {180, 136}})));
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort senTem2a(
    redeclare package Medium=Medium,
    m_flow_nominal=0.5,
    tau=0)
    "Temperature sensor"
    annotation(
      Placement(
        transformation(
          extent={{-8, 136}, {8, 152}})));
  Buildings.Fluid.Sensors.TemperatureTwoPort senTem2b(
    redeclare package Medium=Medium,
    m_flow_nominal=0.5,
    tau=0)
    "Temperature sensor"
    annotation(
      Placement(
        transformation(
          extent={{56, 136}, {72, 152}})));
  Buildings.Fluid.Sensors.TemperatureTwoPort senTem1a(
    redeclare package Medium=Medium,
    m_flow_nominal=0.5,
    tau=0)
    "Temperature sensor"
    annotation(
      Placement(
        transformation(
          extent={{-48, 92}, {-32, 108}})));
  Buildings.Fluid.Sensors.TemperatureTwoPort senTem1b(
    redeclare package Medium=Medium,
    m_flow_nominal=0.5,
    tau=0)
    "Temperature sensor"
    annotation(
      Placement(
        transformation(
          extent={{22, 92}, {38, 108}})));
  Buildings.Fluid.Sensors.TemperatureTwoPort senTem3a(
    redeclare package Medium=Medium,
    m_flow_nominal=0.5,
    tau=0)
    "Temperature sensor"
    annotation(
      Placement(
        transformation(
          extent={{-48,-28}, {-32,-12}})));
  Buildings.Fluid.Sensors.TemperatureTwoPort senTem3b(
    redeclare package Medium=Medium,
    m_flow_nominal=0.5,
    tau=0)
    "Temperature sensor"
    annotation(
      Placement(
        transformation(
          extent={{20,-30}, {40,-10}})));
  Buildings.Fluid.Sensors.TemperatureTwoPort senTem4a(
    redeclare package Medium=Medium,
    m_flow_nominal=0.5,
    tau=0)
    "Temperature sensor"
    annotation(
      Placement(
        transformation(
          extent={{-12, 22}, {8, 42}})));
  Buildings.Fluid.Sensors.TemperatureTwoPort senTem4b(
    redeclare package Medium=Medium,
    m_flow_nominal=0.5,
    tau=0)
    "Temperature sensor"
  ...
  Modelica.Blocks.Math.Add che6(
    ...
    annotation(
      Placement(
        transformation(
          extent={{162,-102}, {182,-82}})));
  Buildings.Fluid.Sensors.TemperatureTwoPort senTem6b(
    redeclare package Medium=Medium,
    m_flow_nominal=0.5,
    tau=0)
    "Temperature sensor"
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort senTem6a(
    redeclare package Medium=Medium,
    m_flow_nominal=0.5,
    tau=0)
    "Temperature sensor"
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort senTem5b(
    redeclare package Medium=Medium,
    m_flow_nominal=0.5,
    tau=0)
    "Temperature sensor"
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort senTem5a(
    redeclare package Medium=Medium,
    m_flow_nominal=0.5,
    tau=0)
    "Temperature sensor"
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort senTem8b(
    redeclare package Medium=Medium,
    m_flow_nominal=0.5,
    tau=0)
    "Temperature sensor"
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort senTem8a(
    redeclare package Medium=Medium,
    m_flow_nominal=0.5,
    tau=0)
    "Temperature sensor"
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort senTem7b(
    redeclare package Medium=Medium,
    m_flow_nominal=0.5,
    tau=0)
    "Temperature sensor"
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort senTem7a(
    redeclare package Medium=Medium,
    m_flow_nominal=0.5,
    tau=0)
    "Temperature sensor"
...
equation
  ...
  connect(u.y, hea1.u)
    annotation(
      Line(
        points={{-127, 184}, {-70, 184}, {-70, 160}, {-28, 160}, {-28, 106}, {-16, 106}},
        color={0, 0, 127}));
  connect(gain.y, hea2.u)
    annotation(
      Line(
        points={{-29, 184}, {-20, 184}, {-20, 160}, {20, 160}, {20, 150}, {26, 150}},
        color={0, 0, 127}));
  connect(u.y, gain.u)
    annotation(
      Line(
  ...
  connect(u.y, hea3.u)
    annotation(
      Line(
        points={{-127, 184}, {-70, 184}, {-70, 160}, {-28, 160}, {-28,-14}, {-16,-14}},
        color={0, 0, 127}));
  connect(gain.y, hea4.u)
    annotation(
      Line(
        points={{-29, 184}, {-20, 184}, {-20, 60}, {12, 60}, {12, 38}, {18, 38}},
        color={0, 0, 127}));
  connect(u.y, hea6.u)
    annotation(
      Line(
        points={{-127, 184}, {-70, 184}, {-70, 160}, {-28, 160}, {-28,-114}, {-2,-114}},
        color={0, 0, 127}));
  connect(u.y, hea8.u)
    annotation(
      Line(
        points={{-127, 184}, {-70, 184}, {-70, 160}, {-28, 160}, {-28,-226}, {-28,-254}, {-2,-254}},
        color={0, 0, 127}));
  connect(gain.y, hea5.u)
    annotation(
      Line(
        points={{-29, 184}, {-20, 184}, {-20,-174}, {-12,-174}},
        color={0, 0, 127}));
  connect(gain.y, hea7.u)
    annotation(
      Line(
        points={{-29, 184}, {-20, 184}, {-20,-314}, {-14,-314}, {-12,-314}},
        color={0, 0, 127}));
  ...
  annotation(
    ...
    experiment(
      ...
      StopTime=3600),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Interfaces/Examples/HeaterCooler_u.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
