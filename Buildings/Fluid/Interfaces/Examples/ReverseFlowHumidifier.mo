...
model ReverseFlowHumidifier
  ...
  Buildings.Fluid.Humidifiers.Humidifier_u humBac(redeclare package Medium=Medium, dp_nominal=0, m_flow(start=1), m_flow_nominal=1, mWat_flow_nominal=0.1, energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
    "Humidifier with backward flow"
    annotation(Placement(transformation(extent={{-32,-16}, {-52, 4}})));
  Buildings.Fluid.Humidifiers.Humidifier_u humFor(redeclare package Medium=Medium, dp_nominal=0, m_flow(start=1), m_flow_nominal=1, mWat_flow_nominal=0.1, energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
  ...
  Modelica.Fluid.Sources.MassFlowSource_T source1(redeclare package Medium=Medium, use_m_flow_in=false, use_T_in=false, use_X_in=false, T(displayUnit="K")=323.15, X={0.01, 0.99}, nPorts=1, m_flow=0.5)
    "Fluid source"
    annotation(Placement(transformation(extent={{-10,-10}, {10, 10}}, origin={-90, 30})));
  Buildings.Fluid.Sources.Boundary_pT sink1(redeclare package Medium=Medium, nPorts=2)
    "Fluid sink"
  ...
  Modelica.Fluid.Sources.MassFlowSource_T source2(redeclare package Medium=Medium, use_m_flow_in=false, use_T_in=false, use_X_in=false, T(displayUnit="K")=323.15, X={0.01, 0.99}, nPorts=1, m_flow=0.5)
    "Fluid source"
...
equation
  ...
  annotation(experiment(Tolerance=1e-6, StopTime=1), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Interfaces/Examples/ReverseFlowHumidifier.mos"
