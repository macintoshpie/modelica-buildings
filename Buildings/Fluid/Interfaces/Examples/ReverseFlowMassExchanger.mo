...
model ReverseFlowMassExchanger
  ...
  Sensors.SpecificEnthalpy senEnt3(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-310, 140}, {-290, 160}})));
  Sensors.Temperature senTem3(
    redeclare package Medium=Medium)
    annotation(
      Placement(
        transformation(
          extent={{-350, 140}, {-330, 160}})));
  Sensors.MassFraction senMas3(
    redeclare package Medium=Medium)
    annotation(
      Placement(
        transformation(
          extent={{-270, 140}, {-250, 160}})));
  Sensors.SpecificEnthalpy senEnt4(
    redeclare package Medium=Medium)
    annotation(
      Placement(
        transformation(
          extent={{-310, 60}, {-290, 80}})));
  Sensors.Temperature senTem4(
    redeclare package Medium=Medium)
    annotation(
      Placement(
        transformation(
          extent={{-350, 60}, {-330, 80}})));
  Sensors.MassFraction senMas4(
    redeclare package Medium=Medium)
    annotation(
      Placement(
        transformation(
          extent={{-270, 60}, {-250, 80}})));
  Modelica.Blocks.Math.Add cheTem1(
    k2=-1)
    "Check whether the outputs of the forward flow and reverse flow model are identical"
    annotation(
      Placement(
        transformation(
          extent={{-200,-20}, {-180, 0}})));
  Modelica.Blocks.Math.Add cheEnt1(
    k2=-1)
    "Check whether the outputs of the forward flow and reverse flow model are identical"
    annotation(
      Placement(
  ...
  Modelica.Blocks.Math.Add cheMas1(
    k2=-1)
    "Check whether the outputs of the forward flow and reverse flow model are identical"
    annotation(
      Placement(
  ...
  Sensors.SpecificEnthalpy senEnt1(
    ...
    annotation(
      Placement(
        transformation(
          extent={{10, 140}, {30, 160}})));
  Sensors.Temperature senTem1(
    redeclare package Medium=Medium)
    annotation(
      Placement(
        transformation(
          extent={{-30, 140}, {-10, 160}})));
  Sensors.MassFraction senMas1(
    redeclare package Medium=Medium)
    annotation(
      Placement(
        transformation(
          extent={{50, 140}, {70, 160}})));
...
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=1),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Interfaces/Examples/ReverseFlowMassExchanger.mos"
        "Simulate and plot"),
    Diagram(
      coordinateSystem(
