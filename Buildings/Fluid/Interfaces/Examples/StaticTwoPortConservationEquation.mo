  ...
  Modelica.Blocks.Sources.Constant mWat_flow(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-80, 20}, {-60, 40}})));
  Modelica.Blocks.Sources.TimeTable QSen_flow(
    startTime=0,
    table=[
      0,-100;
      900,-100;
...
equation
  connect(QSen_flow.y, modWatRev.Q_flow)
    annotation(
      Line(
        points={{-59, 70}, {-36, 70}, {-36, 58}, {-11, 58}},
        color={0, 0, 127}));
  connect(mWat_flow.y, modWatRev.mWat_flow)
    annotation(
      Line(
        points={{-59, 30}, {-40, 30}, {-40, 54}, {-10.8, 54}},
        color={0, 0, 127}));
protected
  model SubModel
  ...
  equation
    ...
    connect(Q_flow, conEqn.Q_flow)
      annotation(
        Line(
          points={{-110, 80}, {-110, 80}, {-20, 80}, {-10, 80}, {-10, 8}},
          color={0, 0, 127}));
    connect(mWat_flow, conEqn.mWat_flow)
      annotation(
        Line(
          points={{-108, 40}, {-108, 40}, {-68, 40}, {-40, 40}, {-40, 4}, {-10, 4}},
          color={0, 0, 127}));
  end SubModel;
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=3600),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Interfaces/Examples/StaticTwoPortConservationEquation.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
