...
model StaticTwoPortHeatMassExchanger
  ...
  Buildings.Fluid.Interfaces.StaticTwoPortConservationEquation vol(redeclare final package Medium=Medium, final use_mWat_flow=not sensibleOnly, final prescribedHeatFlowRate=prescribedHeatFlowRate, final m_flow_nominal=m_flow_nominal, final allowFlowReversal=allowFlowReversal, final m_flow_small=m_flow_small)
...
protected
  ...
  Modelica.Blocks.Sources.RealExpression masExc(final y=mWat_flow)
