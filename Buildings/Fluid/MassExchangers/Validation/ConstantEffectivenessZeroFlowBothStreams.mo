...
model ConstantEffectivenessZeroFlowBothStreams
  ...
  extends Buildings.Fluid.MassExchangers.Examples.ConstantEffectiveness(PSin_1(height=0, offset=1E5), PIn(height=0, offset=101325));
...
</html>"), experiment(Tolerance=1e-06, StopTime=1), __Dymola_Commands(file="Resources/Scripts/Dymola/Fluid/MassExchangers/Validation/ConstantEffectivenessZeroFlowBothStreams.mos"
    "Simulate and plot"));
