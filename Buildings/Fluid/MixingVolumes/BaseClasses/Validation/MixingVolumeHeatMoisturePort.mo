...
model MixingVolumeHeatMoisturePort
  ...
  extends Buildings.Fluid.MixingVolumes.BaseClasses.Validation.MixingVolumeHeatPortWater(redeclare package Medium=Buildings.Media.Air, redeclare Buildings.Fluid.MixingVolumes.BaseClasses.MixingVolumeHeatMoisturePort vol);
  Modelica.Blocks.Sources.Constant const[nEle](each k=0)
    "Zero input signal"
...
</html>"), experiment(Tolerance=1E-6, StopTime=1.0), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/MixingVolumes/BaseClasses/Validation/MixingVolumeHeatMoisturePort.mos"
    "Simulate and plot"));
