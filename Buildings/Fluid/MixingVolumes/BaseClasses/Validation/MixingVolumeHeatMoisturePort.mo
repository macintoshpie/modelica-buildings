...
model MixingVolumeHeatMoisturePort
  ...
  Modelica.Blocks.Sources.Constant const[nEle](
    each k=0)
    "Zero input signal"
    annotation(
      Placement(
...
<a href=\"https://github.com/lbl-srg/modelica-buildings/issues/1013\">Buildings, issue 1013</a>.
    ...
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/MixingVolumes/BaseClasses/Validation/MixingVolumeHeatMoisturePort.mos"
        "Simulate and plot"));
