...
model MixingVolumeHeatPortWater
  ...
  parameter Integer nEle(
    ...
    annotation(
      Evaluate=true);
  replaceable Buildings.Fluid.MixingVolumes.BaseClasses.MixingVolumeHeatPort vol[nEle] constrainedby Buildings.Fluid.MixingVolumes.BaseClasses.MixingVolumeHeatPort(
...
equation
  ...
  connect(bou1.ports[1], res1.port_a)
    annotation(
      Line(
        points={{60, 1.33227e-15}, {46, 1.33227e-15}, {46, 0}, {40, 0}},
        color={0, 127, 255}));
  annotation(
    Documentation(
      info="<html>
...
<a href=\"https://github.com/lbl-srg/modelica-buildings/issues/1013\">Buildings, issue 1013</a>.
    ...
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/MixingVolumes/BaseClasses/Validation/MixingVolumeHeatPortWater.mos"
        "Simulate and plot"));
