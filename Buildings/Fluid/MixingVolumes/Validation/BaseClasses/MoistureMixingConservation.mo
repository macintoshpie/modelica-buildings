  ...
  Buildings.Fluid.MixingVolumes.MixingVolumeMoistAir vol2(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-10, 20}, {10, 40}})));
  Modelica.Blocks.Sources.Constant mWatFlo1(
    k=0.001)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-100, 50}, {-80, 70}})));
  Modelica.Blocks.Sources.Constant mWatFlo3(
    k=-(mWatFlo1.k + mWatFlo2.k))
    "Withdrawn water rate"
    annotation(
      Placement(
        transformation(
          extent={{-100, 80}, {-80, 100}})));
  Modelica.Blocks.Sources.Constant mWatFlo2(
    k=0.003)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-100,-60}, {-80,-40}})));
  Modelica.Blocks.Math.Add cheMasFra(
    k2=-1)
  ...
  Buildings.Fluid.Sensors.MassFlowRate senMasFlo(
    ...
    annotation(
      Placement(
        transformation(
          extent={{60, 30}, {80, 10}})));
  Modelica.Blocks.Math.Add cheMasFlo(
    k2=-1)
  ...
  Sensors.EnthalpyFlowRate senSpeEnt(
    ...
    annotation(
      Placement(
        transformation(
          extent={{20, 30}, {40, 10}})));
  Modelica.Blocks.Math.Add cheSpeEnt(
    k2=-1)
    "Check for conservation of energy"
    annotation(
      Placement(
        transformation(
          extent={{140,-200}, {160,-220}})));
  Modelica.Blocks.Sources.Constant hSol
    "Solution mass flow rate"
    annotation(
      Placement(
        transformation(
          extent={{140,-260}, {120,-240}})));
protected
