...
model CoupledVolumesSpecializedAirPerfectGas
  ...
  extends Buildings.Fluid.MixingVolumes.Validation.CoupledVolumesWater(redeclare package Medium=Buildings.Media.Specialized.Air.PerfectGas);
...
</html>"), experiment(StopTime=3600, Tolerance=1e-06), __Dymola_Commands(file="Resources/Scripts/Dymola/Fluid/MixingVolumes/Validation/CoupledVolumesSpecializedAirPerfectGas.mos"
    "Simulate and plot"));
