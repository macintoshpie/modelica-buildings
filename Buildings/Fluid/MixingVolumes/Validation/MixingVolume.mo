...
equation
  ...
  connect(entFloRat2.H_flow, cheEqu2.u2)
    annotation(
      Line(
        points={{50,-71}, {50,-24}, {140,-24}, {140, 14}, {154, 14}},
        color={0, 0, 127}));
  connect(zero.y, vol2.mWat_flow)
    annotation(
      Line(
        points={{-19,-20}, {-12,-20}, {-12,-64}, {-2,-64}},
        color={0, 0, 127}));
  ...
  connect(entFloRat.H_flow, cheEqu1.u1)
    annotation(
      Line(
        points={{50, 71}, {50, 86}, {154, 86}},
        color={0, 0, 127}));
  connect(entFloRat.H_flow, cheEqu2.u1)
    annotation(
      Line(
        points={{50, 71}, {50, 86}, {140, 86}, {140, 26}, {154, 26}},
        color={0, 0, 127}));
  connect(entFloRat1.H_flow, cheEqu1.u2)
    annotation(
      Line(
        points={{50, 21}, {50, 40}, {146, 40}, {146, 74}, {154, 74}},
        color={0, 0, 127}));
  annotation(
    Diagram(
      coordinateSystem(
    ...
    experiment(
      ...
      StopTime=2),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/MixingVolumes/Validation/MixingVolume.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
