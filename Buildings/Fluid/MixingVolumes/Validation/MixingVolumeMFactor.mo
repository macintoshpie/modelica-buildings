...
equation
  ...
  connect(bou.ports[2], volMFactor.ports[2])
    annotation(
      Line(
        points={{40, 1.33227e-15}, {20, 1.33227e-15}, {20,-40}, {2,-40}},
        color={0, 127, 255}));
  connect(bou.ports[3], vol1.ports[2])
    annotation(
      Line(
        points={{40, 1.33227e-15}, {20, 1.33227e-15}, {20,-80}, {2,-80}},
        color={0, 127, 255}));
  annotation(
    Documentation(
      info="<html>
...
First implementation.
    ...
    experiment(
      ...
      StopTime=100),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/MixingVolumes/Validation/MixingVolumeMFactor.mos"
        "Simulate and plot"));
