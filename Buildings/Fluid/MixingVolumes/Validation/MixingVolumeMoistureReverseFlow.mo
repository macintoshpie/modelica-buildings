...
equation
  connect(volDyn.mWat_flow, gain.y)
    annotation(
      Line(
        points={{8, 18}, {-2, 18}, {-10, 18}, {-10, 40}, {-19, 40}},
        color={0, 0, 127}));
  connect(gain.y, volSte.mWat_flow)
    annotation(
      Line(
        points={{-19, 40}, {-10, 40}, {-10,-32}, {8,-32}},
        color={0, 0, 127}));
  annotation(
    Documentation(
      info="<html>
...
First implementation.
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/MixingVolumes/Validation/MixingVolumeMoistureReverseFlow.mos"
        "Simulate and plot"),
    experiment(
      Tolerance=1e-6,
      StopTime=10));
