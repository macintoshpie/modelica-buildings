...
equation
  connect(gain.y, volSte.C_flow[1])
    annotation(
      Line(
        points={{-19, 40}, {-10, 40}, {-10,-46}, {8,-46}},
        color={0, 0, 127}));
  connect(gain.y, volDyn.C_flow[1])
    annotation(
      Line(
        points={{-19, 40}, {-10, 40}, {-10, 4}, {8, 4}},
        color={0, 0, 127}));
  annotation(
    Documentation(
      info="<html>
...
First implementation.
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/MixingVolumes/Validation/MixingVolumeTraceSubstanceReverseFlow.mos"
        "Simulate and plot"),
    experiment(
      Tolerance=1e-08,
      StopTime=10));
