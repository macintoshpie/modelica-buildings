  ...
  Modelica.Blocks.Sources.RealExpression reaExp(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-8,-58}, {30,-78}})));
  Modelica.Blocks.Math.Add cheConMas(
    k2=-1)
...
equation
  ...
  connect(CfloOut.y, intTraSubOut.u)
    annotation(
      Line(
        points={{46,-41}, {46,-41}, {46,-44}, {30,-44}, {30,-22}, {-12,-22}, {-12,-40}, {-2,-40}},
        color={0, 0, 127},
        smooth=Smooth.None));
  annotation(
    experiment(
...
First implementation.
    ...
    __Dymola_Commands(
      file="Resources/Scripts/Dymola/Fluid/MixingVolumes/Validation/TraceSubstanceConservationDynamicBalance.mos"
        "Simulate and plot"));
