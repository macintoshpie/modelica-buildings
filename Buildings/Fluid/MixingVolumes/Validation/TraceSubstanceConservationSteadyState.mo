...
model TraceSubstanceConservationSteadyState
  ...
  extends Buildings.Fluid.MixingVolumes.Validation.BaseClasses.TraceSubstanceConservation(sou(X={0, 1}));
...
equation
  ...
  annotation(experiment(Tolerance=1e-6, StopTime=2), Documentation(info="<html>
<p>
...
</html>"), __Dymola_Commands(file="Resources/Scripts/Dymola/Fluid/MixingVolumes/Validation/TraceSubstanceConservationSteadyState.mos"
    "Simulate and plot"));
