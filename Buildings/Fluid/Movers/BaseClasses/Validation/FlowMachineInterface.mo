  ...
  Modelica.Blocks.Sources.Constant y(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60, 20}, {-40, 40}})));
  Modelica.Blocks.Sources.Constant rho(
    k=1.2)
    "Density"
    annotation(
      Placement(
...
equation
  connect(eff.rho, rho.y)
    annotation(
      Line(
        points={{-12,-6}, {-26,-6}, {-26, 0}, {-39, 0}},
        color={0, 0, 127}));
  connect(m_flow.y, eff.m_flow)
    annotation(
      Line(
        points={{-39,-30}, {-26,-30}, {-26, 4}, {-12, 4}},
        color={0, 0, 127}));
  connect(y.y, eff.y_in)
    annotation(
      Line(
        points={{-39, 30}, {-4, 30}, {-4, 12}},
        color={0, 0, 127}));
  annotation(
    Documentation(
      info="<html>
...
First implementation.
    ...
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Movers/BaseClasses/Validation/FlowMachineInterface.mos"
        "Simulate and plot"));
