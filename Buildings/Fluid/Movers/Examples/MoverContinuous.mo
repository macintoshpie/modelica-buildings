  ...
  Modelica.Blocks.Sources.Ramp ramp(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-80, 60}, {-60, 80}})));
  Modelica.Blocks.Math.Gain gaiNrpm(
    k=2000)
    "Nominal rpm"
    annotation(
      Placement(
        transformation(
          extent={{-40, 60}, {-20, 80}})));
  Modelica.Blocks.Math.Gain gai_m_flow(
    k=m_flow_nominal)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-40, 10}, {-20, 30}})));
  Modelica.Blocks.Math.Gain gai_dp(
    k=dp_nominal)
...
equation
  ...
  connect(gai_dp.y, pump_dp.dp_in)
    annotation(
      Line(
        points={{-19,-60}, {-10,-60}, {-0.2,-60}, {-0.2,-68}},
        color={0, 0, 127}));
  connect(gai_m_flow.y, pump_m_flow.m_flow_in)
    annotation(
      Line(
        points={{-19, 20}, {-0.2, 20}, {-0.2, 12}},
        color={0, 0, 127}));
  ...
  connect(gai_m_flow.u, ramp.y)
    annotation(
      Line(
        points={{-42, 20}, {-50, 20}, {-50, 70}, {-59, 70}},
        color={0, 0, 127}));
  connect(gai_dp.u, ramp.y)
    annotation(
      Line(
        points={{-42,-60}, {-50,-60}, {-50, 70}, {-59, 70}},
        color={0, 0, 127}));
  connect(pump_y.y, ramp.y)
    annotation(
      Line(
        points={{-0.2,-28}, {-0.2,-20}, {-50,-20}, {-50, 70}, {-59, 70}},
        color={0, 0, 127}));
  annotation(
    Documentation(
      info="<html>
...
First implementation.
    ...
    experiment(
      ...
      StopTime=1),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Movers/Examples/MoverContinuous.mos"
        "Simulate and plot"));
end MoverContinuous;
