...
equation
  connect(integerTable.y, pump_Nrpm.stage)
    annotation(
      Line(
        points={{-39, 80}, {0, 80}, {0, 52}},
        color={255, 127, 0}));
  connect(integerTable.y, pump_m_flow.stage)
    annotation(
      Line(
        points={{-39, 80}, {-30, 80}, {-30, 20}, {-30, 20}, {-30, 20}, {0, 20}, {0, 12}},
        color={255, 127, 0}));
  connect(integerTable.y, pump_y.stage)
    annotation(
      Line(
        points={{-39, 80}, {-30, 80}, {-30,-16}, {-30,-16}, {-30,-20}, {0,-20}, {0,-28}},
        color={255, 127, 0}));
  connect(integerTable.y, pump_dp.stage)
    annotation(
      Line(
        points={{-39, 80}, {-30, 80}, {-30,-60}, {0,-60}, {0,-68}},
        color={255, 127, 0}));
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Movers/Examples/MoverStages.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
