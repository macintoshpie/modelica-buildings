...
model PumpsSeries
  ...
  Buildings.Fluid.Sources.Boundary_pT sou1(
    ...
    use_p_in=false,
    p(
      displayUnit="Pa")=300000 + 4000,
    T=293.15,
    nPorts=1)
    annotation(
      Placement(
        transformation(
          extent={{156, 50}, {136, 70}})));
equation
  ...
  annotation(
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Movers/Examples/PumpsSeries.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
