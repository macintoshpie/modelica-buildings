...
equation
  ...
  connect(dp3.port_b, pum2.port_a)
    annotation(
      Line(
        points={{5.55112e-16, 6.10623e-16}, {10, 6.10623e-16}, {10, 0}, {20, 0}, {20, 6.10623e-16}, {40, 6.10623e-16}},
        color={0, 127, 255},
        smooth=Smooth.None));
  connect(y.y, dp3.y)
    annotation(
  ...
  annotation(
    ...
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Movers/Examples/SpeedControlled_y_pumpCurves.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
