...
model SpeedControlled_y
  ...
  Modelica.Blocks.Interfaces.RealInput y(
    unit="1") if inputType == Buildings.Fluid.Types.InputType.Continuous
...
equation
  ...
  if use_inputFilter then
    connect(filter.y, eff.y_in)
      annotation(
        Line(
          points={{34.7, 88}, {38, 88}, {38, 26}, {-26, 26}, {-26,-46}, {-26,-48}, {-26,-46}, {-26,-46}},
          color={0, 0, 127}));
  else
  ...
  annotation(
    ...
    Icon(
      ...
      graphics={Text(
        ...
        textString=DynamicSelect("y", if inputType == Buildings.Fluid.Types.InputType.Continuous then String(y,
          format=".2f") else String(stage)))}),
    Documentation(
      info="<html>
<p>
