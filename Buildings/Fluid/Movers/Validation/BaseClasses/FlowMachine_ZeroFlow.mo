  ...
  Buildings.Fluid.FixedResistances.PressureDrop dpSta(
    ...
    annotation(
      Placement(
        transformation(
          extent={{58, 70}, {78, 90}})));
  replaceable Buildings.Fluid.Movers.BaseClasses.PartialFlowMachine floMacSta constrainedby Buildings.Fluid.Movers.BaseClasses.PartialFlowMachine(
    redeclare package Medium=Medium,
    ...
    annotation(
      Placement(
        transformation(
          extent={{20, 70}, {40, 90}})));
  replaceable Buildings.Fluid.Movers.BaseClasses.PartialFlowMachine floMacDyn constrainedby Buildings.Fluid.Movers.BaseClasses.PartialFlowMachine(
    redeclare package Medium=Medium,
...
equation
  ...
  connect(floMacDyn.port_b, dpDyn.port_a)
    annotation(
      Line(
        points={{40, 6.10623e-16}, {50,-3.36456e-22}, {50, 6.10623e-16}, {60, 6.10623e-16}},
        color={0, 127, 255}));
  ...
  connect(dpDyn1.port_b, floMacDyn.port_a)
    annotation(
      Line(
        points={{5.55112e-16, 6.10623e-16}, {10,-3.36456e-22}, {10, 6.10623e-16}, {20, 6.10623e-16}},
        color={0, 127, 255}));
