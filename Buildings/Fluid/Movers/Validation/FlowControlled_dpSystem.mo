...
equation
  ...
  connect(zone3.ports[1], sin.ports[3])
    annotation(
      Line(
        points={{87.3333,-60}, {100,-60}, {100,-1}},
        color={0, 127, 255}));
  connect(zone4.ports[1], sin.ports[4])
    annotation(
      Line(
        points={{88,-100}, {100,-100}, {100,-3}},
        color={0, 127, 255}));
  ...
  connect(zone4.ports[2], dam4.port_b)
    annotation(
      Line(
        points={{92,-100}, {60,-100}},
        color={0, 127, 255}));
  connect(y1.y, dam2.y)
    annotation(
      Line(
        points={{-39, 100}, {50, 100}, {50, 92}},
        color={0, 0, 127}));
  connect(senRelPre.port_b, zone3.ports[3])
    annotation(
      Line(
        points={{20,-40}, {74,-40}, {74,-60}, {92.6667,-60}},
        color={0, 127, 255}));
  connect(senRelPre.port_a, heaCoi2.port_b)
    annotation(
      Line(
        points={{0,-40}, {-20,-40}, {-20,-80}},
        color={0, 127, 255}));
  ...
  connect(duct3.port_a, heaCoi2.port_b)
    annotation(
      Line(
        points={{0,-60}, {-20,-60}, {-20,-80}},
        color={0, 127, 255}));
  connect(duct4.port_a, heaCoi2.port_b)
    annotation(
      Line(
        points={{0,-100}, {-20,-100}, {-20,-80}},
        color={0, 127, 255}));
  connect(y1.y, dam1.y)
    annotation(
      Line(
        points={{-39, 100}, {30, 100}, {30, 60}, {50, 60}, {50, 52}},
        color={0, 0, 127}));
  connect(y1.y, dam3.y)
    annotation(
      Line(
        points={{-39, 100}, {30, 100}, {30,-30}, {50,-30}, {50,-48}},
        color={0, 0, 127}));
  connect(y1.y, dam4.y)
    annotation(
      Line(
        points={{-39, 100}, {30, 100}, {30,-80}, {50,-80}, {50,-88}},
        color={0, 0, 127}));
  annotation(
    Diagram(
      coordinateSystem(
    ...
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Movers/Validation/FlowControlled_dpSystem.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
