...
equation
  ...
  connect(pum_m_flow.port_b, sou.ports[6])
    annotation(
      Line(
        points={{60,-20}, {68,-20}, {72,-20}, {72,-84}, {-44,-84}, {-44, 12.5}, {-62, 12.5}},
        color={0, 127, 255}));
  ...
  annotation(
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Movers/Validation/PumpCurveConstruction.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
