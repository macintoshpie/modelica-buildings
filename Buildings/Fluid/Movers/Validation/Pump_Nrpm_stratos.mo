  ...
  Modelica.Blocks.Sources.Constant rpm1(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-90, 84}, {-78, 96}})));
  Modelica.Blocks.Sources.Constant rpm2(
    k=2610)
    "Pump speed control signal"
    annotation(
      Placement(
        transformation(
          extent={{-90, 34}, {-78, 46}})));
  Modelica.Blocks.Sources.Constant rpm3(
    k=1930)
    "Pump speed control signal"
    annotation(
      Placement(
        transformation(
          extent={{-90,-6}, {-78, 6}})));
  Modelica.Blocks.Sources.Constant rpm4(
    k=3300)
    "Pump speed control signal"
    annotation(
      Placement(
        transformation(
          extent={{-90,-56}, {-78,-44}})));
  Modelica.Blocks.Sources.Constant rpm5(
    k=900)
    "Pump speed control signal"
    annotation(
      Placement(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-5,-5}, {5, 5}},
          origin={35,-97})));
  Modelica.Blocks.Sources.Constant mMax_flow1(
    k=40/3.6)
    ...
    annotation(
      Placement(
        transformation(
          extent={{2, 76}, {14, 88}})));
  Modelica.Blocks.Sources.Constant mMax_flow2(
    k=55/3.6)
    "Maximum flow rate of the pump at given rpm"
    annotation(
      Placement(
        transformation(
          extent={{0, 30}, {12, 42}})));
  Modelica.Blocks.Sources.Constant mMax_flow3(
    k=40/3.6)
    "Maximum flow rate of the pump at given rpm"
    annotation(
      Placement(
        transformation(
          extent={{0,-20}, {12,-8}})));
  Modelica.Blocks.Sources.Constant mMax_flow4(
    k=22/3.6)
    "Maximum flow rate of the pump at given rpm"
    annotation(
      Placement(
        transformation(
          extent={{0,-64}, {12,-52}})));
  Modelica.Blocks.Sources.Constant mMax_flow5(
    k=16/3.6)
    "Maximum flow rate of the pump at given rpm"
    annotation(
      Placement(
...
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=1000),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Movers/Validation/Pump_Nrpm_stratos.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
