...
model SpeedControlled_y_linear
  ...
  Buildings.Fluid.Movers.SpeedControlled_y pumFixDp(
    ...
    per(
      pressure(
        V_flow=2/1000*{0, m_flow_nominal},
        dp={2*dp_nominal, 0})),
  ...
  Buildings.Fluid.Sources.Boundary_pT sou1(
    ...
    use_p_in=false,
    p(
      displayUnit="Pa")=300000 + 0.01*dp_nominal,
    T=293.15,
    nPorts=1)
    annotation(
      Placement(
...
equation
  ...
  annotation(
    ...
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Movers/Validation/SpeedControlled_y_linear.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
