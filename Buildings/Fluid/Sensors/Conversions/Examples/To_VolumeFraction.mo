...
model To_VolumeFraction
  ...
  Buildings.Fluid.Sensors.Conversions.To_VolumeFraction conMasVolFra(
    ...
    annotation(
      Placement(
        transformation(
          extent={{148, 0}, {168, 20}})));
  Modelica.Blocks.Sources.Constant volFra(
    k=1000E-6)
  ...
  Buildings.Fluid.Sources.TraceSubstancesFlowSource souCO2(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-20, 60}, {0, 80}})));
  Modelica.Blocks.Math.Gain CO2Per(
    k=15/1000/3600*1.977)
  ...
  Modelica.Blocks.Math.Gain gai(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60,-20}, {-40, 0}})));
  Modelica.Blocks.Sources.Constant nPeo(
    k=1)
    "Number of people"
    annotation(
      Placement(
  ...
  Buildings.Fluid.Sensors.VolumeFlowRate senVolFlo(
    ...
    annotation(
      Placement(
        transformation(
          extent={{20,-20}, {40, 0}})));
  Modelica.Blocks.Math.Gain norSet(
    k=1/1000E-6)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-140,-20}, {-120, 0}})));
  Modelica.Blocks.Math.Gain norMea(
    k=1/1000E-6)
  ...
  Modelica.Blocks.Math.Gain conVolFlo(
    ...
    annotation(
      Placement(
        transformation(
          extent={{40, 20}, {60, 40}})));
  Buildings.Fluid.Sensors.TraceSubstancesTwoPort senTraSubPeo(
    m_flow_nominal=0.1,
    redeclare package Medium=Medium,
    C_start=0,
    ...
    annotation(
      Placement(
        transformation(
          extent={{40, 60}, {60, 80}})));
  Buildings.Fluid.Sensors.TraceSubstancesTwoPort senTraSubFre(
    m_flow_nominal=0.1,
    redeclare package Medium=Medium,
    C_start=0,
    initType=Modelica.Blocks.Types.Init.InitialState)
...
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=36000),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Sensors/Conversions/Examples/To_VolumeFraction.mos"
        "Simulate and plot"),
    Diagram(
      coordinateSystem(
