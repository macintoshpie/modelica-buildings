...
model DensityTwoPort
  ...
  parameter Medium.Density d_start=Medium.density(state=Medium.setState_pTX(p=p_start, T=T_start, X=X_start))
...
equation
  ...
  annotation(defaultComponentName="senDen", Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100}, {100, 100}}, grid={1, 1}), graphics={Text(extent={{102, 124}, {6, 95}}, lineColor={0, 0, 0}, textString="d"), Line(points={{0, 100}, {0, 70}}, color={0, 0, 127}), Line(points={{-100, 0}, {-70, 0}}, color={0, 128, 255}), Line(points={{70, 0}, {100, 0}}, color={0, 128, 255}), Text(extent={{-20, 120}, {-140, 70}}, lineColor={0, 0, 0}, textString=DynamicSelect("", String(d, leftjustified=false, significantDigits=3)))}), Documentation(info="<html>
<p>
