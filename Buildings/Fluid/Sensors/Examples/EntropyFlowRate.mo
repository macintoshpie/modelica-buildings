...
equation
  ...
  connect(senS_flow.S_flow, assEqu.u1)
    annotation(
      Line(
        points={{-20, 1}, {-20, 1}, {-20, 72}, {-20, 80}, {30, 80}, {30, 76}, {38, 76}},
        color={0, 0, 127}));
  connect(senS.s, pro.u1)
    annotation(
      Line(
        points={{10, 1}, {10, 26}, {-16, 26}, {-16, 70}, {-2, 70}},
        color={0, 0, 127}));
  annotation(
    experiment(
      Tolerance=1e-6,
      StopTime=60),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Sensors/Examples/EntropyFlowRate.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
