...
equation
  ...
  connect(senH.h_out, pro.u1)
    annotation(
      Line(
        points={{10, 31}, {10, 38}, {10, 76}, {58, 76}},
        color={0, 0, 127}));
  connect(senM_flow.m_flow, pro.u2)
    annotation(
      Line(
        points={{38, 31}, {38, 48}, {38, 64}, {58, 64}},
        color={0, 0, 127}));
  ...
  annotation(
    experiment(
      ...
      StopTime=60),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Sensors/Examples/MoistAirEnthalpyFlowRate.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
