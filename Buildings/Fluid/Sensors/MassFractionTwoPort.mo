...
model MassFractionTwoPort
  ...
  Modelica.Blocks.Interfaces.RealOutput X(min=-1e-3, max=1.001, start=X_start, final unit="kg/kg")
...
protected
  ...
  Medium.MassFraction XiVec[Medium.nXi](final quantity=Medium.substanceNames[1 : Medium.nXi])
...
equation
  if allowFlowReversal then
    XiVec=Modelica.Fluid.Utilities.regStep(x=port_a.m_flow, y1=port_b.Xi_outflow, y2=port_a.Xi_outflow, x_small=m_flow_small);
  else
  ...
  annotation(defaultComponentName="senMasFra", Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100}, {100, 100}}, grid={1, 1}), graphics={Text(extent={{94, 122}, {0, 92}}, lineColor={0, 0, 0}, textString="X"), Line(points={{0, 100}, {0, 70}}, color={0, 0, 127}), Line(points={{-100, 0}, {-70, 0}}, color={0, 128, 255}), Line(points={{70, 0}, {100, 0}}, color={0, 128, 255}), Text(extent={{-20, 120}, {-140, 70}}, lineColor={0, 0, 0}, textString=DynamicSelect("", String(X, leftjustified=false, significantDigits=3)))}), Documentation(info="<html>
<p>
