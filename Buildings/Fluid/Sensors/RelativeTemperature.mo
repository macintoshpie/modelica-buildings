...
model RelativeTemperature
  ...
  Modelica.Fluid.Interfaces.FluidPort_a port_a(m_flow(min=0), p(start=Medium.p_default), redeclare package Medium=Medium)
    "Fluid connector of stream a"
    annotation(Placement(transformation(extent={{-110,-10}, {-90, 10}})));
  Modelica.Fluid.Interfaces.FluidPort_b port_b(m_flow(min=0), p(start=Medium.p_default), redeclare package Medium=Medium)
    "Fluid connector of stream b"
    annotation(Placement(transformation(extent={{110,-10}, {90, 10}})));
  Modelica.Blocks.Interfaces.RealOutput T_rel(final unit="K", displayUnit="K")
    "Temperature difference of port_a minus port_b"
    annotation(Placement(transformation(origin={0,-90}, extent={{10,-10}, {-10, 10}}, rotation=90)));
equation
  ...
  annotation(defaultComponentName="senRelTem", Icon(graphics={Line(points={{-100, 0}, {-70, 0}}, color={0, 127, 255}), Line(points={{70, 0}, {100, 0}}, color={0, 127, 255}), Line(points={{0,-30}, {0,-80}}, color={0, 0, 127}), Text(extent={{-150, 40}, {150, 80}}, textString="%name", lineColor={0, 0, 255}), Text(extent={{128,-70}, {10,-100}}, lineColor={0, 0, 0}, textString="T_rel"), Line(points={{34, 3}, {-56, 3}}, color={0, 128, 255}), Polygon(points={{24, 18}, {64, 3}, {24,-12}, {24, 18}}, lineColor={0, 128, 255}, fillColor={0, 128, 255}, fillPattern=FillPattern.Solid), Text(extent={{-20,-56}, {-140,-106}}, lineColor={0, 0, 0}, textString=DynamicSelect("", String(T_rel, leftjustified=false, significantDigits=3)))}), Documentation(info="<html>
<p>
