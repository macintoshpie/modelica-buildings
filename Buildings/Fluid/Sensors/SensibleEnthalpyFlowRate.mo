...
model SensibleEnthalpyFlowRate
  ...
  parameter Modelica.SIunits.SpecificEnthalpy h_out_start=Medium.enthalpyOfNonCondensingGas(T=Medium.T_default)
...
equation
  ...
  annotation(defaultComponentName="senEntFlo", Icon(graphics={Ellipse(extent={{-70, 70}, {70,-70}}, lineColor={0, 0, 0}, fillColor={170, 213, 255}, fillPattern=FillPattern.Solid), Line(points={{-100, 0}, {-70, 0}}, color={0, 128, 255}), Line(points={{70, 0}, {100, 0}}, color={0, 128, 255}), Line(points={{0, 100}, {0, 70}}, color={0, 0, 127}), Text(extent={{180, 151}, {20, 99}}, lineColor={0, 0, 0}, textString="HS_flow"), Polygon(points={{-0.48, 31.6}, {18, 26}, {18, 57.2}, {-0.48, 31.6}}, lineColor={0, 0, 0}, fillColor={0, 0, 0}, fillPattern=FillPattern.Solid), Line(points={{0, 0}, {9.02, 28.6}}), Ellipse(extent={{-5, 5}, {5,-5}}, lineColor={0, 0, 0}, fillColor={0, 0, 0}, fillPattern=FillPattern.Solid), Line(points={{37.6, 13.7}, {65.8, 23.9}}), Line(points={{22.9, 32.8}, {40.2, 57.3}}), Line(points={{0, 70}, {0, 40}}), Line(points={{-22.9, 32.8}, {-40.2, 57.3}}), Line(points={{-37.6, 13.7}, {-65.8, 23.9}}), Text(extent={{-20, 120}, {-140, 70}}, lineColor={0, 0, 0}, textString=DynamicSelect("", String(H_flow, leftjustified=false, significantDigits=3)))}), Documentation(info="<html>
<p>
