...
equation
  ...
  // Flow velocity
  v=V_flow/A;
  annotation(defaultComponentName="senVel", Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100}, {100, 100}}), graphics={Text(extent={{48, 120}, {8, 78}}, lineColor={0, 0, 0}, textString="v"), Line(points={{0, 100}, {0, 70}}, color={0, 0, 127}), Line(points={{-100, 0}, {-70, 0}}, color={0, 128, 255}), Line(points={{70, 0}, {100, 0}}, color={0, 128, 255}), Text(extent={{180, 90}, {60, 40}}, lineColor={0, 0, 0}, textString=DynamicSelect("", String(v, format=".3g")))}), Documentation(info="<html>
<p>
