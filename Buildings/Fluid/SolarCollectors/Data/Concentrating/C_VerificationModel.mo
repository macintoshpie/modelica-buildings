...
record C_VerificationModel=SolarCollectors.Data.GenericSolarCollector(final ATyp=Types.Area.Aperture, final A=4.302, final V=4.4/1000, final dp_nominal=100, final mperA_flow_nominal=0.0241, final y_intercept=0.720, final IAMDiff=0.133, final C1=2.8312, final C2=0.00119, final B0=0, final B1=0, final mDry=484, final slope=0, final G_nominal=1000, final dT_nominal=20)
