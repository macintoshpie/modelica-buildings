...
equation
  ...
  connect(dT.u1, senTem.T)
    annotation(
      Line(
        points={{58,-64}, {50,-64}, {50, 52}, {30, 52}, {30, 41}},
        color={0, 0, 127}));
  connect(senTem1.T, dT.u2)
    annotation(
      Line(
        points={{30,-19}, {30,-10}, {46,-10}, {46,-76}, {58,-76}},
        color={0, 0, 127}));
  annotation(
    Documentation(
      info="<html>
...
<a href=\"https://github.com/lbl-srg/modelica-buildings/issues/1100\">#1100</a>.
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/SolarCollectors/Validation/EN12975_Series.mos"
        "Simulate and plot"),
    experiment(
      Tolerance=1e-6,
      StopTime=86400));
