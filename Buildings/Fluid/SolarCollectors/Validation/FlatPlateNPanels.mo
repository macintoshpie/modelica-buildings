...
model FlatPlateNPanels
  ...
  Buildings.Fluid.Sources.MassFlowSource_T bou1(nPorts=1, redeclare package Medium=Medium, use_m_flow_in=true, use_T_in=true)
...
equation
  ...
  connect(add.y, bou1.T_in)
    annotation(Line(points={{-29, 10}, {-24, 10}, {-24,-26}, {-14,-26}}, color={0, 0, 127}, smooth=Smooth.None));
  ...
  connect(gaiNPan.u, datRea.y[4])
    annotation(Line(points={{-54,-22}, {-60,-22}, {-60, 38}, {-69, 38}}, color={0, 0, 127}));
...
</html>"), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/SolarCollectors/Validation/FlatPlateNPanels.mos"
