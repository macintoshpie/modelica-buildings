...
equation
  ...
  connect(senMasFra.port_b, senTem.port_a)
    annotation(
      Line(
        points={{30, 0}, {34, 0}, {44, 0}},
        color={0, 127, 255}));
  connect(senTem.port_b, sin_with_h.ports[1])
    annotation(
      Line(
        points={{64, 0}, {70, 0}, {76, 0}},
        color={0, 127, 255}));
  ...
  annotation(
    experiment(
      ...
      StopTime=3.1536e+07),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Sources/Examples/MassFlowSource_WeatherData.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
