  ...
  Buildings.Fluid.Sources.Outside bouFix(
    ...
    annotation(
      Placement(
        transformation(
          extent={{70, 20}, {50, 40}})));
  Modelica.Blocks.Sources.Constant Cp(
    k=0.6)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-80,-20}, {-60, 0}})));
  Buildings.Airflow.Multizone.Orifice ori1(
    A=0.1,
    redeclare package Medium=Medium)
    "Orifice"
    annotation(
  ...
  Buildings.Fluid.Sources.Outside_Cp bou2(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-40,-20}, {-20, 0}})));
  Buildings.Airflow.Multizone.Orifice ori2(
    A=0.1,
    redeclare package Medium=Medium)
    "Orifice"
    annotation(
...
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=86400),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Sources/Examples/Outside_Cp.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
