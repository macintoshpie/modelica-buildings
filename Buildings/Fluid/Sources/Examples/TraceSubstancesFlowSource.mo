...
model TraceSubstancesFlowSource
  ...
  Buildings.Fluid.Sources.Boundary_pT sin1(
    ...
    annotation(
      Placement(
        transformation(
          extent={{220, 90}, {200, 110}})));
equation
  connect(res3.port_b, vol4.ports[2])
    annotation(
      Line(
        points={{-6,-70}, {-6,-40}, {-7,-40}},
        color={0, 127, 255}));
  ...
  annotation(
    Diagram(
      coordinateSystem(
        ...
        extent={{-100,-100}, {240, 180}}),
      graphics),
    experiment(
      Tolerance=1e-6,
      StopTime=600),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Sources/Examples/TraceSubstancesFlowSource.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
