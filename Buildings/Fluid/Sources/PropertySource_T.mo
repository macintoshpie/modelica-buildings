...
model PropertySource_T
  ...
  Modelica.Blocks.Interfaces.RealInput T_in if use_T_in
    "Prescribed value for leaving fluid temperature"
...
protected
  ...
  Modelica.Blocks.Interfaces.RealOutput h_T_a=Medium.specificEnthalpy(Medium.setState_pTX(port_a.p, T_in_internal, port_a.Xi_outflow)) if use_T_in
    "Conditional connector for enthalpy leaving port a";
  Modelica.Blocks.Interfaces.RealOutput h_T_b=Medium.specificEnthalpy(Medium.setState_pTX(port_b.p, T_in_internal, port_b.Xi_outflow)) if use_T_in
...
equation
  ...
  annotation(defaultComponentName="proSou", Icon(coordinateSystem(preserveAspectRatio=true, extent={{-100,-100}, {100, 100}}), graphics={Text(visible=use_T_in, extent={{-90, 98}, {12, 58}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid, textString="T")}), Documentation(info="<html>
<p>
