  ...
  Buildings.Fluid.Sources.Validation.BaseClasses.BoundarySystemWithX_in bouNatGas(
    ...
    annotation(
      Placement(
        transformation(
          extent={{20,-50}, {40,-30}})));
  Modelica.Blocks.Sources.Constant X_2[2](
    k={0.015, 0.985})
    ...
    annotation(
      Placement(
        transformation(
          extent={{-20, 66}, {0, 86}})));
  Modelica.Blocks.Sources.Constant X_6[6](
...
<a href=\"https://github.com/ibpsa/modelica-ibpsa/issues/1205\">Buildings, #1205</a>.
    ...
    __Dymola_Commands(
      file="Resources/Scripts/Dymola/Fluid/Sources/Validation/BoundaryWithX_in.mos"
        "Simulate and plot"),
    experiment(
      StopTime=1,
      Tolerance=1e-06));
