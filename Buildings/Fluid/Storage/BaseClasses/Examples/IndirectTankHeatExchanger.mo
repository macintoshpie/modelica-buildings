  ...
  Buildings.Fluid.Sources.MassFlowSource_T bou(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-72, 34}, {-52, 54}})));
  Buildings.HeatTransfer.Sources.FixedTemperature watTem[3](
    each T=293.15)
    annotation(
      Placement(
        transformation(
...
equation
  ...
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Storage/BaseClasses/Examples/IndirectTankHeatExchanger.mos"
        "Simulate and plot"),
    experiment(
      Tolerance=1e-6,
      StopTime=15),
