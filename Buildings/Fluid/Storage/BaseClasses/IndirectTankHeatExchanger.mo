...
model IndirectTankHeatExchanger
  ...
  Modelica.Thermal.HeatTransfer.Components.HeatCapacitor cap[nSeg](
    ...
    der_T(
      each fixed=(energyDynamicsSolid == Modelica.Fluid.Types.Dynamics.SteadyStateInitial))) if not energyDynamicsSolid == Modelica.Fluid.Types.Dynamics.SteadyState
