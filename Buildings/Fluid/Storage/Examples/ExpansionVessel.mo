...
equation
  connect(pulse.y, preTem.T)
    annotation(
      Line(
        points={{-59, 0}, {-54.75, 0}, {-54.75, 1.27676e-015}, {-50.5, 1.27676e-015}, {-50.5, 0}, {-42, 0}},
        color={0, 0, 127}));
  ...
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Storage/Examples/ExpansionVessel.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
