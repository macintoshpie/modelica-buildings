...
model StratifiedEnhancedInternalHex
  ...
  package MediumTan=Buildings.Media.Water
    "Medium in the tank";
  package MediumHex=Buildings.Media.Water
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort senTemDynSol(redeclare package Medium=MediumHex, allowFlowReversal=false, m_flow_nominal=mHex_flow_nominal, tau=0)
...
equation
  connect(solColSup.ports[1], tanSte.portHex_a)
    annotation(Line(points={{-20, 42.6667}, {-4, 42.6667}, {-4, 65.92}, {6, 65.92}}, color={0, 127, 255}, smooth=Smooth.None));
  connect(senTemSte.port_b, toSolCol.ports[1])
    annotation(Line(points={{-40, 10}, {-40, 10}, {-50, 10}, {-50,-17.3333}, {-62,-17.3333}}, color={0, 127, 255}));
  ...
  connect(tanDynSol.portHex_b, senTemDynSol.port_a)
    annotation(Line(points={{6,-72.8}, {-8,-72.8}, {-8,-70}, {-22,-70}}, color={0, 127, 255}));
  connect(senTemDynSol.port_b, toSolCol.ports[3])
    annotation(Line(points={{-42,-70}, {-42,-70}, {-50,-70}, {-50,-22.6667}, {-62,-22.6667}}, color={0, 127, 255}));
  ...
  connect(solColSup.ports[3], tanDynSol.portHex_a)
    annotation(Line(points={{-20, 37.3333}, {-12, 37.3333}, {-4, 37.3333}, {-4,-66.08}, {6,-66.08}}, color={0, 127, 255}));
  connect(bouWat.ports[1], tanSte.port_b)
    annotation(Line(points={{60,-9.33333}, {52,-9.33333}, {52, 72}, {40, 72}}, color={0, 127, 255}));
  ...
  connect(bouWat.ports[3], tanDynSol.port_b)
    annotation(Line(points={{60,-14.6667}, {52,-14.6667}, {52,-60}, {40,-60}}, color={0, 127, 255}));
  connect(step.y, solColSup.p_in)
    annotation(Line(points={{-59, 48}, {-52, 48}, {-42, 48}}, color={0, 0, 127}));
  annotation(__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Storage/Examples/StratifiedEnhancedInternalHex.mos"
