...
equation
  ...
  connect(sou_1.ports[1], HInEnh_flow.port_a)
    annotation(
      Line(
        points={{-80,-8}, {-70,-8}, {-70, 20}, {-60, 20}},
        color={0, 127, 255}));
  connect(sou_1.ports[2], HIn_flow.port_a)
    annotation(
      Line(
        points={{-80,-12}, {-70,-12}, {-70,-50}, {-58,-50}},
        color={0, 127, 255}));
  annotation(
    experiment(
      Tolerance=1e-6,
      StopTime=3600),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Fluid/Storage/Validation/StratifiedNonUniformInitial.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
