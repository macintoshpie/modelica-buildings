...
model Temperature_u
  ...
  parameter Buildings.HeatTransfer.Data.SolidsPCM.Generic materialMonotone(
    TSol=273.15 + 30.9,
    TLiq=273.15 + 40.0,
    LHea=1000000,
    c=920,
  ...
  parameter Buildings.HeatTransfer.Data.SolidsPCM.Generic materialNonMonotone(
    TSol=273.15 + 30.9,
    TLiq=273.15 + 40.0,
    LHea=1000000,
    c=920,
...
initial equation
  ...
  (udMonotone, TdMonotone, dT_duMonotone)=Buildings.HeatTransfer.Conduction.BaseClasses.der_temperature_u(
...
equation
  ...
  errNonMonotone=relativeError(
    T=T,
    TExa=TExa,
    dTCha=dTCha);
  errMonotone=relativeError(
    T=TMonotone,
    TExa=TExa,
    dTCha=dTCha);
  annotation(
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/HeatTransfer/Conduction/BaseClasses/Examples/Temperature_u.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
