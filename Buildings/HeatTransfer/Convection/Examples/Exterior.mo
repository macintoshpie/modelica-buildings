...
model Exterior
  ...
  Modelica.Blocks.Sources.Ramp direction(
    duration=3600,
    height=2*3.14159)
...
equation
  ...
  annotation(
    Diagram(
      coordinateSystem(
        extent={{-100,-100}, {140, 180}})),
    experiment(
      Tolerance=1e-6,
      StopTime=3600),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/HeatTransfer/Convection/Examples/Exterior.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
