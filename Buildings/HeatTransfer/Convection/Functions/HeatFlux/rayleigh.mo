...
algorithm
  Ra := Buildings.Utilities.Math.Functions.smoothMax(x1=rho^2*x^3*Modelica.Constants.g_n*c_p*abs(T_a-T_b)/((T_a + T_b)/2*mu*k), x2=Ra_min, deltaX=Ra_min/10);
