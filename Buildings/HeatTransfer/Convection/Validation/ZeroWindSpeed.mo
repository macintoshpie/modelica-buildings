...
model ZeroWindSpeed
  ...
  extends Buildings.HeatTransfer.Convection.Examples.Exterior(
    vWin(
      k=0));
  annotation(
    Diagram(
    ...
    experiment(
      ...
      StopTime=3600),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/HeatTransfer/Convection/Validation/ZeroWindSpeed.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
