...
model ZeroWindSpeed
  ...
  annotation(Diagram(coordinateSystem(extent={{-100,-100}, {140, 180}})), experiment(Tolerance=1e-6, StopTime=3600), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/HeatTransfer/Convection/Validation/ZeroWindSpeed.mos"
