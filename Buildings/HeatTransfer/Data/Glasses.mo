...
package Glasses
  ...
  record Generic
    ...
    annotation(defaultComponentPrefixes="parameter", defaultComponentName="datGla", Documentation(info="<html>
<p>
...
First implementation.
  ...
  record ID100=Buildings.HeatTransfer.Data.Glasses.Generic(x=0.0031, k=1.0, tauSol={0.646}, rhoSol_a={0.062}, rhoSol_b={0.063}, tauIR=0, absIR_a=0.84, absIR_b=0.84)
    "Generic Bronze Glass 3.1mm. Manufacturer: Generic."
    annotation(defaultComponentPrefixes="parameter", defaultComponentName="datGla");
  record ID101=Buildings.HeatTransfer.Data.Glasses.Generic(x=0.0057, k=1.0, tauSol={0.486}, rhoSol_a={0.053}, rhoSol_b={0.053}, tauIR=0, absIR_a=0.84, absIR_b=0.84)
    "Generic Bronze Glass 5.7mm. Manufacturer: Generic."
    annotation(defaultComponentPrefixes="parameter", defaultComponentName="datGla");
  record ID102=Buildings.HeatTransfer.Data.Glasses.Generic(x=0.003, k=1.0, tauSol={0.834}, rhoSol_a={0.075}, rhoSol_b={0.075}, tauIR=0, absIR_a=0.84, absIR_b=0.84)
    "Generic Clear Glass 3.048mm. Manufacturer: Generic."
    annotation(defaultComponentPrefixes="parameter", defaultComponentName="datGla");
  record ID103=Buildings.HeatTransfer.Data.Glasses.Generic(x=0.0057, k=1.0, tauSol={0.771}, rhoSol_a={0.070}, rhoSol_b={0.070}, tauIR=0, absIR_a=0.84, absIR_b=0.84)
    "Generic Clear Glass 5.7mm. Manufacturer: Generic."
    annotation(defaultComponentPrefixes="parameter", defaultComponentName="datGla");
  record Electrochromic=Buildings.HeatTransfer.Data.Glasses.Generic(x=0.006, k=0.9, tauSol={0.814, 0.111}, rhoSol_a={0.086, 0.179}, rhoSol_b={0.086, 0.179}, tauIR=0, absIR_a=0.84, absIR_b=0.84)
