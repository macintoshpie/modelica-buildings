...
package GlazingSystems
  ...
  record Generic
    ...
    parameter Gases.Generic gas[:]={Buildings.HeatTransfer.Data.Gases.Air(
      x=-1)}
      "Layer by layer declaration of glass layers, starting from outside to room-side"
      annotation(
        choicesAllMatching=true,
    ...
    parameter Shades.Generic shade
      ...
      annotation(
        choicesAllMatching=true,
        Dialog(
          enable=haveInteriorShade or haveExteriorShade));
...
First implementation.
  ...
  record SingleClear3=Buildings.HeatTransfer.Data.GlazingSystems.Generic(
    glass={Glasses.ID102()},
    UFra=3)
  ...
  record DoubleClearAir13Clear=Buildings.HeatTransfer.Data.GlazingSystems.Generic(
    ...
    annotation(
      defaultComponentPrefixes="parameter",
      defaultComponentName="datGlaSys");
  record DoubleElectrochromicAir13Clear=Buildings.HeatTransfer.Data.GlazingSystems.Generic(
    final glass={Glasses.Electrochromic(), Buildings.HeatTransfer.Data.Glasses.Generic(
      x=0.006,
      k=0.9,
      tauSol={0.775, 0.775},
...
the electrochromic and the clear glass layer.
  ...
  record TripleClearAir13ClearAir13Clear=Buildings.HeatTransfer.Data.GlazingSystems.Generic(
