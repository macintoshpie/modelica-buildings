...
package OpaqueSurfaces
  ...
  record Generic
    ...
    parameter Modelica.SIunits.Emissivity absSol=0.84
      "Solar absorptivity";
    final parameter Boolean isFloor=til > 2.74889125 and til < 3.53428875
      "Flag, true if construction is a floor"
      annotation(Evaluate=true);
    annotation(defaultComponentPrefixes="parameter", defaultComponentName="datOpaSur", Documentation(info="<html>
<p>
...
First implementation.
  ...
  record Black=Buildings.HeatTransfer.Data.OpaqueSurfaces.Generic(absIR=1.0, absSol=1.0)
    "Black surface with absIR=1.0, absSol=1.0"
    annotation(defaultComponentPrefixes="parameter", defaultComponentName="datOpaSur");
  record Gray=Buildings.HeatTransfer.Data.OpaqueSurfaces.Generic(absIR=0.5, absSol=0.5)
    "Gray surface with absIR=0.5, absSol=0.5"
    annotation(defaultComponentPrefixes="parameter", defaultComponentName="datOpaSur");
  record White=Buildings.HeatTransfer.Data.OpaqueSurfaces.Generic(absIR=0.0, absSol=0.0)
