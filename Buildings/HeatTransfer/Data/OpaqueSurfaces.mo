...
First implementation.
  ...
  record Black=Buildings.HeatTransfer.Data.OpaqueSurfaces.Generic(
    absIR=1.0,
    absSol=1.0)
    ...
    annotation(
      defaultComponentPrefixes="parameter",
      defaultComponentName="datOpaSur");
  record Gray=Buildings.HeatTransfer.Data.OpaqueSurfaces.Generic(
    absIR=0.5,
    absSol=0.5)
    ...
    annotation(
      defaultComponentPrefixes="parameter",
      defaultComponentName="datOpaSur");
  record White=Buildings.HeatTransfer.Data.OpaqueSurfaces.Generic(
    absIR=0.0,
    absSol=0.0)
