...
package Soil
  ...
  record Generic
    ...
    annotation(defaultComponentPrefixes="parameter", defaultComponentName="datSoi", Documentation(info="<html>
<p>
...
First implementation.
  ...
  record Granite=Buildings.HeatTransfer.Data.Soil.Generic(k=1.9, d=1920, c=790)
    "Granite (k=1.9)"
    annotation(defaultComponentPrefixes="parameter", defaultComponentName="datSoi");
  ...
  record Marble=Buildings.HeatTransfer.Data.Soil.Generic(k=2.7, d=2500, c=1090)
    "Marble (k=2.7)"
    annotation(defaultComponentPrefixes="parameter", defaultComponentName="datSoi");
  record Sandstone=Buildings.HeatTransfer.Data.Soil.Generic(k=2.8, d=540, c=1210)
    "Sandstone (k=2.8)"
    annotation(defaultComponentPrefixes="parameter", defaultComponentName="datSoi");
