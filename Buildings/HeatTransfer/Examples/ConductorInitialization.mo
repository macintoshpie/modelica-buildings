  ...
  Buildings.HeatTransfer.Sources.PrescribedTemperature TA
    annotation(
      Placement(
        transformation(
          extent={{-60, 20}, {-40, 40}})));
  parameter Buildings.HeatTransfer.Data.Solids.Brick brick(
    x=0.18,
    nStaRef=3,
    nSta=5)
    annotation(
      Placement(
        transformation(
          extent={{18, 72}, {38, 92}})));
  parameter Buildings.HeatTransfer.Data.Solids.InsulationBoard insulation(
    x=0.05,
    nStaRef=2,
    nSta=5)
    annotation(
...
equation
  ...
  annotation(
    ...
    experiment(
      ...
      StopTime=86400),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/HeatTransfer/Examples/ConductorInitialization.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
