...
model ConductorMultiLayer
  ...
  Buildings.HeatTransfer.Conduction.MultiLayer con(
    ...
    redeclare Buildings.HeatTransfer.Data.OpaqueConstructions.Insulation100Concrete200 layers,
    A=0.1,
...
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=86400),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/HeatTransfer/Examples/ConductorMultiLayer.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
