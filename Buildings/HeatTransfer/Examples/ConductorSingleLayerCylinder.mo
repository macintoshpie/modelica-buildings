...
model ConductorSingleLayerCylinder
  ...
  Buildings.HeatTransfer.Conduction.SingleLayerCylinder con(
    material=concrete,
...
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=36000),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/HeatTransfer/Examples/ConductorSingleLayerCylinder.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
