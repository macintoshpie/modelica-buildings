...
model ConductorStepResponse
  ...
  parameter Buildings.HeatTransfer.Data.Solids.Concrete concrete(
    x=0.12,
    nStaRef=4)
    annotation(
      Placement(
...
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=86400),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/HeatTransfer/Examples/ConductorStepResponse.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
