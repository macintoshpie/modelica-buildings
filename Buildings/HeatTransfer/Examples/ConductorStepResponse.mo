...
model ConductorStepResponse
  ...
  parameter Buildings.HeatTransfer.Data.OpaqueConstructions.Generic composite(nLay=2, material={carpet, concrete})
    annotation(Placement(transformation(extent={{80, 60}, {100, 80}})));
  Buildings.HeatTransfer.Conduction.MultiLayer conMul(A=2, layers=composite, stateAtSurface_b=false)
    annotation(Placement(transformation(extent={{40,-60}, {60,-40}})));
  Buildings.HeatTransfer.Conduction.SingleLayer con(A=2, material=carpet, stateAtSurface_a=false, stateAtSurface_b=false)
  ...
  Buildings.HeatTransfer.Conduction.SingleLayer con1(A=2, material=carpet, stateAtSurface_b=false)
  ...
  Buildings.HeatTransfer.Conduction.SingleLayer con2(A=2, material=concrete, stateAtSurface_b=false, stateAtSurface_a=false)
...
equation
  ...
  annotation(experiment(Tolerance=1e-6, StopTime=86400), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/HeatTransfer/Examples/ConductorStepResponse.mos"
