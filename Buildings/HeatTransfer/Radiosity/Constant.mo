...
equation
  JOut=k;
  annotation(defaultComponentName="const", Icon(coordinateSystem(preserveAspectRatio=true, extent={{-100,-100}, {100, 100}}, grid={2, 2}), graphics={Line(points={{-80, 68}, {-80,-80}}, color={192, 192, 192}), Polygon(points={{-80, 90}, {-88, 68}, {-72, 68}, {-80, 90}}, lineColor={192, 192, 192}, fillColor={192, 192, 192}, fillPattern=FillPattern.Solid), Line(points={{-88, 50}, {84, 50}}, color={192, 192, 192}), Polygon(points={{92, 50}, {70, 58}, {70, 42}, {92, 50}}, lineColor={192, 192, 192}, fillColor={192, 192, 192}, fillPattern=FillPattern.Solid), Line(points={{-80,-28}, {80,-28}}, color={0, 0, 0}), Text(extent={{-150,-150}, {150,-110}}, lineColor={0, 0, 0}, textString="k=%k")}), Documentation(info="<html>
<p>
