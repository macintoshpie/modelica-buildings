...
equation
  connect(T1.port, bod1.heatPort)
    annotation(Line(points={{-60,-10}, {-49.2,-10}, {-49.2, 20.2}}, color={191, 0, 0}, smooth=Smooth.None));
  connect(T2.port, bod2.heatPort)
    annotation(Line(points={{40,-10}, {49.2,-10}, {49.2, 20.2}}, color={191, 0, 0}, smooth=Smooth.None));
  connect(bod1.JOut, bod2.JIn)
    annotation(Line(points={{-39, 34}, {12, 34}, {12, 26}, {39, 26}}, color={0, 127, 0}, smooth=Smooth.None));
  connect(bod2.JOut, bod1.JIn)
    annotation(Line(points={{39, 34}, {16, 34}, {16, 24}, {-20, 24}, {-20, 26}, {-39, 26}}, color={0, 127, 0}, smooth=Smooth.None));
  annotation(experiment(Tolerance=1e-6, StopTime=1.0), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/HeatTransfer/Radiosity/Examples/OpaqueSurface.mos"
