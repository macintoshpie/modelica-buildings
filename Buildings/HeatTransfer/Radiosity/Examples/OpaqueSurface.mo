...
model OpaqueSurface
  ...
  Buildings.HeatTransfer.Sources.FixedTemperature T2(
    T=303.15)
    ...
    annotation(
      Placement(
        transformation(
          extent={{20,-20}, {40, 0}})));
  Buildings.HeatTransfer.Radiosity.OpaqueSurface bod1(
    absIR=0.3,
    A=1)
    "Surface 1"
    annotation(
      Placement(
        transformation(
          extent={{-60, 20}, {-40, 40}})));
  Buildings.HeatTransfer.Sources.FixedTemperature T1(
    T=293.15)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-80,-20}, {-60, 0}})));
  Buildings.HeatTransfer.Radiosity.OpaqueSurface bod2(
    absIR=0.3,
    A=1)
    "Surface 2"
    annotation(
...
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/HeatTransfer/Radiosity/Examples/OpaqueSurface.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
