...
model OutdoorRadiosity
  ...
  Buildings.HeatTransfer.Radiosity.OpaqueSurface sur(
    A=A,
    absIR=1)
    "Receiving surface"
    annotation(
      Placement(
        transformation(
          extent={{76,-20}, {56, 0}})));
  Buildings.HeatTransfer.Radiosity.OutdoorRadiosity outRad(
    A=A,
    vieFacSky=0.5)
...
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/HeatTransfer/Radiosity/Examples/OutdoorRadiosity.mos"
        "Simulate and plot"));
