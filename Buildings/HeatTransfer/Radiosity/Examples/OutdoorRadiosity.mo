...
model OutdoorRadiosity
  ...
  Modelica.Blocks.Sources.Ramp TSky(duration=1, height=30, offset=273.15)
    "Sky blackbody temperature"
...
equation
  connect(outRad.JOut, sur.JIn)
    annotation(Line(points={{-19,-12}, {18,-12}, {18,-14}, {55,-14}}, color={0, 127, 0}, smooth=Smooth.None));
  connect(TAir.y, outRad.TBlaSky)
    annotation(Line(points={{-59, 10}, {-52, 10}, {-52,-8}, {-42,-8}}, color={0, 0, 127}, smooth=Smooth.None));
  connect(TSky.y, outRad.TOut)
    annotation(Line(points={{-59,-30}, {-50,-30}, {-50,-16}, {-42,-16}}, color={0, 0, 127}, smooth=Smooth.None));
  annotation(experiment(Tolerance=1e-6, StopTime=1.0), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/HeatTransfer/Radiosity/Examples/OutdoorRadiosity.mos"
    "Simulate and plot"));
