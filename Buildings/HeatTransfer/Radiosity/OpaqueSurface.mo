...
model OpaqueSurface
  ...
  extends Buildings.HeatTransfer.Radiosity.BaseClasses.ParametersOneSurface(final tauIR=1-rhoIR-absIR, final rhoIR=1-absIR);
...
equation
  ...
  annotation(Icon(graphics={Rectangle(extent={{-34, 94}, {8,-94}}, fillColor={135, 135, 135}, fillPattern=FillPattern.Solid, pattern=LinePattern.None), Line(points={{18, 8}, {54, 8}, {46, 14}, {54, 8}, {48, 2}}, color={127, 0, 0}, smooth=Smooth.None), Line(points={{18, 8}, {40,-20}, {32,-20}, {40,-20}, {40,-12}, {40,-12}}, color={127, 0, 0}, smooth=Smooth.None), Line(points={{18, 0}, {-18, 0}, {-10,-6}, {-18, 0}, {-12, 6}}, color={127, 0, 0}, smooth=Smooth.None, origin={18,-8}, rotation=90), Line(points={{18, 8}, {40, 36}, {32, 36}, {40, 36}, {40, 28}, {40, 28}}, color={127, 0, 0}, smooth=Smooth.None), Line(points={{-18, 0}, {18, 0}, {10, 6}, {18, 0}, {12,-6}}, color={127, 0, 0}, smooth=Smooth.None, origin={18, 26}, rotation=90)}), defaultComponentName="sur", Documentation(info="<html>
