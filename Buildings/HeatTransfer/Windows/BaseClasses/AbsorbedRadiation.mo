...
protected
  ...
  final parameter Real coeAbsEx[2, radDat.N, radDat.HEM + 2, NSta](
    each fixed=false);
  final parameter Real coeRefExtPan1[radDat.HEM + 2, NSta](
    each fixed=false)
    "Reflectivity of pane 1";
  final parameter Real coeAbsIn[2, radDat.N, NSta](
    each fixed=false);
  final parameter Real coeAbsDevExtIrrIntSha[radDat.HEM + 2, NSta](
    each fixed=false)
...
First implementation.
    ...
    Icon(
      graphics={Text(
        extent={{26, 86}, {102, 74}},
        lineColor={0, 0, 127},
        textString="QAbsExtSha"), Text(
        extent={{-101,-73}, {-54,-82}},
        lineColor={0, 0, 127},
        textString="HRoo"), Text(
        extent={{24,-68}, {102,-80}},
        lineColor={0, 0, 127},
        textString="QAbsIntSha"), Text(
        extent={{34, 46}, {94, 32}},
        lineColor={0, 0, 127},
        textString="QAbsGlaUns"), Text(
        extent={{30,-32}, {104,-44}},
        lineColor={0, 0, 127},
