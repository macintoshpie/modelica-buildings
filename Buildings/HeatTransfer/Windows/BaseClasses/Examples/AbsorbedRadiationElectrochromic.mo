...
model AbsorbedRadiationElectrochromic
  ...
  annotation(
    experiment(
      ...
      StopTime=864000),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/HeatTransfer/Windows/BaseClasses/Examples/AbsorbedRadiationElectrochromic.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
