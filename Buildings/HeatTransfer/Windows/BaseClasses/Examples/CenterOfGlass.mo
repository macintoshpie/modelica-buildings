...
model CenterOfGlass
  ...
  parameter Buildings.HeatTransfer.Data.GlazingSystems.DoubleClearAir13Clear glaSys(
    ...
    annotation(
      Placement(
        transformation(
          extent={{120, 122}, {140, 142}})));
  Buildings.HeatTransfer.Radiosity.OutdoorRadiosity radOut(
    A=A,
    vieFacSky=0.5)
    "Outdoor radiosity"
    annotation(
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection conRooNonSha
    ...
    annotation(
      Placement(
        transformation(
          extent={{40,-100}, {60,-80}})));
  Modelica.Blocks.Sources.Constant hA(
    k=4*A)
  ...
  Buildings.HeatTransfer.Windows.BaseClasses.ShadingSignal shaCon(
    haveShade=glaSys.haveExteriorShade or glaSys.haveInteriorShade)
    "Bounds the shading signal"
    annotation(
      Placement(
        transformation(
          extent={{-120, 100}, {-100, 120}})));
  Modelica.Blocks.Sources.Constant QAbs[size(glaSys.glass, 1)](
    each k=0)
  ...
  Modelica.Blocks.Math.MultiSum sumJ(
    nu=2)
    "Sum of radiosities from the two surfaces"
    annotation(
      Placement(
        transformation(
          extent={{50,-140}, {62,-128}})));
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/HeatTransfer/Windows/BaseClasses/Examples/CenterOfGlass.mos"
        "Simulate and plot"),
    Diagram(
      coordinateSystem(
