...
model GasConvection
  ...
  Buildings.HeatTransfer.Sources.PrescribedTemperature T_a1
    ...
    annotation(
      Placement(
        transformation(
          extent={{-40, 20}, {-20, 40}})));
  Buildings.HeatTransfer.Sources.FixedTemperature T_b1(
    T=293.15)
    ...
    annotation(
      Placement(
        transformation(
          ...
          rotation=180,
          origin={50, 30})));
  Modelica.Blocks.Sources.Constant u(
    k=1)
  ...
  Buildings.HeatTransfer.Sources.PrescribedTemperature T_a2
    ...
    annotation(
      Placement(
        transformation(
          extent={{-40,-20}, {-20, 0}})));
  Buildings.HeatTransfer.Sources.FixedTemperature T_b2(
    T=293.15)
    "Room-side temperature"
    annotation(
      Placement(
  ...
  Buildings.HeatTransfer.Sources.FixedTemperature T_b3(
    T=293.15)
    "Room-side temperature"
    annotation(
      Placement(
...
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/HeatTransfer/Windows/BaseClasses/Examples/GasConvection.mos"
        "Simulate and plot"),
    Diagram(
      coordinateSystem(
