  ...
  Modelica.Thermal.HeatTransfer.Sensors.HeatFlowSensor heaFloSen
    ...
    annotation(
      Placement(
        transformation(
          extent={{20, 0}, {40, 20}})));
  Modelica.Thermal.HeatTransfer.Sources.FixedTemperature TGla(
    T=295.15)
    "Glass temperature"
    annotation(
      Placement(
        transformation(
          extent={{-80, 0}, {-60, 20}})));
  Modelica.Thermal.HeatTransfer.Sources.FixedTemperature TRoo(
    T=293.15)
...
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/HeatTransfer/Windows/BaseClasses/Examples/InteriorConvection.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
