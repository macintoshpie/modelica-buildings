...
model Shade
  ...
  Buildings.HeatTransfer.Radiosity.OpaqueSurface radOut(
    A=A,
    absIR=0.8,
    linearize=false)
  ...
  Buildings.HeatTransfer.Sources.PrescribedTemperature TRadOut
    ...
    annotation(
      Placement(
        transformation(
          extent={{-114,-100}, {-94,-80}})));
  Buildings.HeatTransfer.Radiosity.OpaqueSurface radIn(
    A=A,
    absIR=0.8,
    linearize=false)
    ...
    annotation(
      Placement(
        transformation(
          extent={{102,-62}, {82,-42}})));
  Modelica.Blocks.Sources.Constant TRoo(
    k=293.15)
    "Room temperature"
    annotation(
      Placement(
    ...
    annotation(
      Placement(
        transformation(
          ...
          rotation=180,
          origin={112,-70})));
  Modelica.Blocks.Sources.Constant QSol_shade(
    k=0)
    ...
    annotation(
      Placement(
        transformation(
          ...
          rotation=180,
          origin={110, 20})));
  Buildings.HeatTransfer.Windows.BaseClasses.ShadingSignal shaCon(
    haveShade=true)
    annotation(
      Placement(
        transformation(
          extent={{-110, 70}, {-90, 90}})));
  Modelica.Blocks.Math.Gain GConSha(
    k=10*A,
    y(
      unit="W/K"))
    ...
    annotation(
      Placement(
        transformation(
          extent={{-46, 40}, {-26, 60}})));
  Modelica.Blocks.Math.Gain GConUns(
    k=10*A,
    y(
      unit="W/K"))
  ...
  Modelica.Blocks.Math.MultiSum sumJRoo(
    nu=2)
    ...
    annotation(
      Placement(
        transformation(
          extent={{44,-76}, {56,-64}})));
  Modelica.Blocks.Math.MultiSum sumJOut(
    nu=2)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-46,-72}, {-58,-60}})));
  Buildings.HeatTransfer.Windows.BaseClasses.ShadeConvection extShaCon(
    A=A,
    thisSideHasShade=true)
    ...
    annotation(
      Placement(
        transformation(
          extent={{0, 40}, {20, 60}})));
  Buildings.HeatTransfer.Windows.BaseClasses.ShadeConvection extNonShaCon(
    A=A,
    thisSideHasShade=false)
...
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/HeatTransfer/Windows/BaseClasses/Examples/Shade.mos"
        "Simulate and plot"),
    Diagram(
      coordinateSystem(
