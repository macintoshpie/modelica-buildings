...
equation
  connect(uSta.y, winRad.uSta)
    annotation(
      Line(
        points={{81,-70}, {92,-70}, {92,-6}, {74.8,-6}, {74.8,-1.6}},
        color={0, 0, 127}));
  annotation(
    experiment(
      Tolerance=1e-6,
      StopTime=864000),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/HeatTransfer/Windows/BaseClasses/Examples/WindowRadiationElectrochromic.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
