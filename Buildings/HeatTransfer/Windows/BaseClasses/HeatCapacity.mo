...
model HeatCapacity
  ...
  Modelica.Blocks.Interfaces.RealInput ySha if haveShade
    "Control signal for shade"
    annotation(Placement(transformation(extent={{-140, 20}, {-100, 60}})));
  Modelica.Blocks.Interfaces.RealInput yCom if haveShade
    "Input 1-y"
  ...
  Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a portUns
    ...
    annotation(Placement(transformation(extent={{95,-45}, {105,-35}}), iconTransformation(extent={{95,-45}, {105,-35}})));
  Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a portSha(T=TSha, Q_flow=QSha_flow) if haveShade
    "Heat port to shaded part of the window"
    annotation(Placement(transformation(extent={{95, 35}, {105, 45}}), iconTransformation(extent={{95, 35}, {105, 45}})));
  Modelica.SIunits.Temperature TUns(start=293.15)
    "Temperature of unshaded part of window";
  Modelica.SIunits.Temperature TSha(start=293.15)
    "Temperature of unshaded part of window";
...
equation
  ...
  annotation(Icon(graphics={Rectangle(extent={{-20, 60}, {20,-60}}, lineColor={0, 0, 0}, fillColor={170, 213, 255}, fillPattern=FillPattern.Solid), Ellipse(extent={{-6, 45}, {6, 34}}, lineColor={255, 0, 0}, fillColor={191, 0, 0}, visible=haveShade, fillPattern=FillPattern.Solid), Line(points={{0, 40}, {100, 40}}, visible=haveShade, color={255, 0, 0}), Text(extent={{-94, 64}, {-60, 22}}, lineColor={0, 0, 127}, textString="ySha"), Text(extent={{-92,-16}, {-58,-58}}, lineColor={0, 0, 127}, textString="yCom"), Ellipse(extent={{-6,-35}, {6,-46}}, lineColor={255, 0, 0}, fillColor={191, 0, 0}, fillPattern=FillPattern.Solid), Line(points={{100,-40}, {0,-40}}, color={255, 0, 0}), Rectangle(extent={{-52, 76}, {-48, 4}}, fillColor={0, 0, 0}, visible=haveShade, fillPattern=FillPattern.Solid, pattern=LinePattern.None, lineColor={0, 0, 0}), Polygon(points={{-70, 18}, {-70, 10}, {-30, 22}, {-30, 30}, {-70, 18}}, lineColor={0, 0, 0}, smooth=Smooth.None, fillColor={135, 135, 135}, visible=haveShade, fillPattern=FillPattern.Solid), Polygon(points={{-70, 38}, {-70, 30}, {-30, 42}, {-30, 50}, {-70, 38}}, lineColor={0, 0, 0}, smooth=Smooth.None, fillColor={135, 135, 135}, visible=haveShade, fillPattern=FillPattern.Solid), Polygon(points={{-70, 58}, {-70, 50}, {-30, 62}, {-30, 70}, {-70, 58}}, lineColor={0, 0, 0}, smooth=Smooth.None, fillColor={135, 135, 135}, visible=haveShade, fillPattern=FillPattern.Solid)}), Documentation(info="<html>
<p>
