...
model HeatCapacity
  ...
  Modelica.SIunits.Temperature TSha(
    start=293.15)
    "Temperature of unshaded part of window";
  Modelica.SIunits.TemperatureSlope der_TUns(
    start=0)
    "Time derivative of temperature (= der(T))";
  Modelica.SIunits.TemperatureSlope der_TSha(
    start=0)
    "Time derivative of temperature (= der(T))";
protected
  final parameter Real CInv(
    unit="K/J")=1/C
  ...
  annotation(
    Icon(
      graphics={Rectangle(
        ...
        extent={{-94, 64}, {-60, 22}},
        lineColor={0, 0, 127},
        textString="ySha"), Text(
        extent={{-92,-16}, {-58,-58}},
        lineColor={0, 0, 127},
        textString="yCom"), Ellipse(
        extent={{-6,-35}, {6,-46}},
        lineColor={255, 0, 0},
        fillColor={191, 0, 0},
        fillPattern=FillPattern.Solid), Line(
