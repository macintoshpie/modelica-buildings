...
equation
  connect(weaBus.solAlt, walSolAzi.alt)
    annotation(Line(points={{-100, 5.55112e-16}, {-80, 5.55112e-16}, {-80,-45.2}, {-62,-45.2}}, color={255, 204, 51}, thickness=0.5, smooth=Smooth.None), Text(textString="%first", index=-1, extent={{-6, 3}, {-6, 3}}));
  connect(walSolAzi.incAng, incAng)
    annotation(Line(points={{-62,-54.8}, {-80,-54.8}, {-80,-60}, {-120,-60}}, color={0, 0, 127}, smooth=Smooth.None));
  connect(product.y, HDirTil)
    annotation(Line(points={{81, 60}, {110, 60}}, color={0, 0, 127}, smooth=Smooth.None));
  connect(product.u1, HDirTilUns)
    annotation(Line(points={{58, 66}, {-80, 66}, {-80, 60}, {-120, 60}}, color={0, 0, 127}, smooth=Smooth.None));
