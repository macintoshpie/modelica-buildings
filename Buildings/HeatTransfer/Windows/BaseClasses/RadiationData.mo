...
record RadiationData
  ...
  final parameter Real layer[3, N, HEM, NSta]=Buildings.HeatTransfer.Windows.Functions.glassProperty(
    N=N,
    NSta=NSta,
    HEM=HEM,
    glass=glass,
    ...
    "Angular and hemispherical transmissivity, front (outside-facing) and back (room facing) reflectivity
      of each glass pane";
  final parameter Real traRef[3, N, N, HEM, NSta]=Buildings.HeatTransfer.Windows.Functions.getGlassTR(
    N=N,
    NSta=NSta,
    HEM=HEM,
    layer=layer)
  ...
  final parameter Real absExtIrrNoSha[N, HEM, NSta]=Buildings.HeatTransfer.Windows.Functions.glassAbsExteriorIrradiationNoShading(
    traRef=traRef,
    N=N,
    NSta=NSta,
    HEM=HEM)
  ...
  final parameter Real absIntIrrNoSha[N, NSta]=Buildings.HeatTransfer.Windows.Functions.glassAbsInteriorIrradiationNoShading(
    traRef=traRef,
    N=N,
    NSta=NSta,
    HEM=HEM)
  ...
  final parameter Real winTraExtIrrExtSha[HEM, NSta]=Buildings.HeatTransfer.Windows.Functions.winTExteriorIrradiatrionExteriorShading(
    traRef=traRef,
  ...
  final parameter Real absExtIrrExtSha[N, HEM, NSta]=Buildings.HeatTransfer.Windows.Functions.glassAbsExteriorIrradiationExteriorShading(
  ...
  final parameter Real winTraExtIrrIntSha[HEM, NSta]=Buildings.HeatTransfer.Windows.Functions.winTExteriorIrradiationInteriorShading(
    traRef=traRef,
    traRefShaDev=traRefShaDev,
    N=N,
    NSta=NSta,
    ...
    "Angular and hemispherical transmissivity of a window system (glass and interior shading device)
      for exterior irradiation";
  final parameter Real absExtIrrIntSha[N, HEM, NSta]=Buildings.HeatTransfer.Windows.Functions.glassAbsExteriorIrradiationInteriorShading(
    absExtIrrNoSha=absExtIrrNoSha,
    traRef=traRef,
    traRefShaDev=traRefShaDev,
    N=N,
  ...
  final parameter Real devAbsExtIrrIntShaDev[HEM, NSta]=Buildings.HeatTransfer.Windows.Functions.devAbsExteriorIrradiationInteriorShading(
    traRef=traRef,
    traRefShaDev=traRefShaDev,
    N=N,
    NSta=NSta,
  ...
  final parameter Real absIntIrrExtSha[N, NSta]=Buildings.HeatTransfer.Windows.Functions.glassAbsInteriorIrradiationExteriorShading(
  ...
  final parameter Real absIntIrrIntSha[N, NSta]=Buildings.HeatTransfer.Windows.Functions.glassAbsInteriorIrradiationInteriorShading(
    absIntIrrNoSha=absIntIrrNoSha,
    traRef=traRef,
    traRefShaDev=traRefShaDev,
    N=N,
  ...
  final parameter Real winTraRefIntIrrIntSha[3, NSta]=Buildings.HeatTransfer.Windows.Functions.winTRInteriorIrradiationInteriorShading(
    traRef=traRef,
    traRefShaDev=traRefShaDev,
    N=N,
    NSta=NSta,
  ...
  final parameter Real devAbsIntIrrIntSha[NSta]=Buildings.HeatTransfer.Windows.Functions.devAbsInteriorIrradiationInteriorShading(
    traRef=traRef,
    traRefShaDev=traRefShaDev,
    N=N,
    NSta=NSta,
