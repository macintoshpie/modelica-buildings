...
model ShadeConvection
  ...
  Modelica.Blocks.Interfaces.RealInput Gc(unit="W/K")
    ...
    annotation(Placement(transformation(extent={{-20,-20}, {20, 20}}, origin={-120, 30}), iconTransformation(extent={{-10,-10}, {10, 10}}, origin={-110, 40})));
  ...
  Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_b glass
    ...
    annotation(Placement(transformation(extent={{84,-10}, {104, 10}}), iconTransformation(extent={{84,-10}, {104, 10}})));
  ...
  Modelica.Blocks.Interfaces.RealOutput TSha(quantity="ThermodynamicTemperature", unit="K")
    "Shade temperature"
    annotation(Placement(transformation(origin={58,-120}, extent={{20,-20}, {-20, 20}}, rotation=90), iconTransformation(extent={{10,-10}, {-10, 10}}, rotation=90, origin={60,-110})));
equation
