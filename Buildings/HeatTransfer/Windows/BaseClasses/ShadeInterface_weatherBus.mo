...
partial model ShadeInterface_weatherBus
  ...
  Modelica.Blocks.Interfaces.RealInput HDirTilUns(quantity="RadiantEnergyFluenceRate", unit="W/m2")
    "Direct solar irradiation on tilted, unshaded surface"
    annotation(Placement(transformation(extent={{-140, 40}, {-100, 80}})));
  Modelica.Blocks.Interfaces.RealOutput HDirTil(quantity="RadiantEnergyFluenceRate", unit="W/m2")
