...
model ShadeRadiation
    ...
    annotation(
      Placement(
        ...
        iconTransformation(
          ...
          rotation=90,
          origin={0,-110})));
  Interfaces.RadiosityInflow JIn_air(
  ...
  Interfaces.RadiosityInflow JIn_glass(
    start=A*0.8*Modelica.Constants.sigma*293.15^4)
  ...
  Modelica.Blocks.Interfaces.RealOutput QRadAbs_flow(
    unit="W")
    ...
    annotation(
      Placement(
        ...
        iconTransformation(
          ...
          rotation=270,
          origin={-50,-110})));
  Modelica.Blocks.Interfaces.RealInput TSha(
    quantity="ThermodynamicTemperature",
    unit="K",
    start=293.15) if thisSideHasShade
    "Shade temperature"
    annotation(
      Placement(
        transformation(
        ...
        iconTransformation(
          ...
          origin={50,-110})));
protected
  Modelica.Blocks.Interfaces.RealInput TSha_internal(
    quantity="ThermodynamicTemperature",
    unit="K",
    start=293.15)
  ...
  if thisSideHasShade then
    ...
    if linearize then
      ...
      if homotopyInitialization then
        T4=homotopy(
          actual=(TSha_internal)^4,
          simplified=T03*TSha_internal);
      else
        T4=TSha_internal^4;
      end if;
    end if;
