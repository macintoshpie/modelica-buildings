...
equation
  if NSta == 1 then
    ...
    Buildings.Utilities.Math.Functions.smoothInterpolation(x=uSta_internal, xSup=uSup, ySup=HSta, ensureMonotonicity=true);
  end if;
  annotation(defaultComponentName="staInt", Documentation(info="<html>
<p>
