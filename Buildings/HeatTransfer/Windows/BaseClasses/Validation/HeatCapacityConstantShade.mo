...
model HeatCapacityConstantShade
  ...
  parameter Modelica.SIunits.Area AGla=2
    "Glass area";
  parameter Data.Solids.Glass datGla(
    x=0.005)
    "Thermal properties for glass"
    annotation(
      Placement(
        transformation(
          extent={{60, 112}, {80, 132}})));
  ...
  Modelica.Thermal.HeatTransfer.Components.HeatCapacitor heaCapUns1(
    ...
    annotation(
      Placement(
        transformation(
          extent={{50, 40}, {70, 60}})));
  Modelica.Blocks.Sources.Constant y05(
    k=0.5)
  ...
  Modelica.Thermal.HeatTransfer.Components.HeatCapacitor heaCapUns2(
    ...
    annotation(
      Placement(
        transformation(
          extent={{50,-50}, {70,-30}})));
  Modelica.Blocks.Sources.Constant y1(
    k=0.1)
    "Shade control signal"
    annotation(
      Placement(
  ...
  Modelica.Thermal.HeatTransfer.Components.ThermalConductor theConSha2(
    ...
    annotation(
      Placement(
        transformation(
          extent={{20,-20}, {40, 0}})));
  Modelica.Blocks.Sources.Constant y2(
    k=0.9)
    "Shade control signal"
    annotation(
      Placement(
  ...
  HeatCapacity heaCapGlaNoSha(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-10,-122}, {10,-102}})));
  Modelica.Thermal.HeatTransfer.Components.ThermalConductor theConUns3(
    G=AGla*10)
    "Thermal conductor"
    annotation(
      Placement(
        transformation(
          extent={{20,-126}, {40,-106}})));
  Modelica.Thermal.HeatTransfer.Components.HeatCapacitor heaCapUns3(
    C=1000,
    T(
      start=283.15,
      fixed=true))
...
equation
  ...
  annotation(
    ...
    experiment(
      ...
      StopTime=600),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/HeatTransfer/Windows/BaseClasses/Validation/HeatCapacityConstantShade.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
