...
model HeatCapacityVariableShadeDT
  ...
  extends HeatCapacityVariableShade(
    heaCapSha(
      T(
        start=298.15)));
  annotation(
    experiment(
      ...
      StopTime=600),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/HeatTransfer/Windows/BaseClasses/Validation/HeatCapacityVariableShadeDT.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
