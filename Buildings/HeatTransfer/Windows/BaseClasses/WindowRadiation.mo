...
block WindowRadiation
  ...
  Modelica.Blocks.Interfaces.RealInput uSta(
    min=0,
    max=1,
    unit="1") if NSta > 1
  ...
  StateInterpolator staIntQAbsExtSha_flow(
    ...
    annotation(
      Placement(
        transformation(
          extent={{60, 70}, {80, 90}})));
  StateInterpolator staIntQAbsGlaUns_flow[N](
    each final NSta=NSta)
    "Interpolator for the window state"
    annotation(
      Placement(
        transformation(
          extent={{60, 40}, {80, 60}})));
  StateInterpolator staIntQAbsGlaSha_flow[N](
    each final NSta=NSta)
    "Interpolator for the window state"
    annotation(
      Placement(
  ...
  StateInterpolator staIntQAbsIntSha_flow(
    ...
    annotation(
      Placement(
        transformation(
          extent={{60,-40}, {80,-20}})));
  StateInterpolator staIntQTraDif_flow(
    final NSta=NSta)
    "Interpolator for the window state"
    annotation(
      Placement(
        transformation(
          extent={{60,-70}, {80,-50}})));
  StateInterpolator staIntQTraDir_flow(
    final NSta=NSta)
    "Interpolator for the window state"
    annotation(
      Placement(
...
equation
  ...
  connect(abs.QAbsExtSha_flow, staIntQAbsExtSha_flow.HSta)
    annotation(
      Line(
        points={{-19,-22}, {8,-22}, {36,-22}, {36, 74}, {58, 74}},
        color={0, 0, 127}));
  connect(staIntQAbsExtSha_flow.H, QAbsExtSha_flow)
    annotation(
      Line(
        points={{81, 80}, {92, 80}, {92, 90}, {110, 90}},
        color={0, 0, 127}));
  connect(abs.QAbsGlaUns_flow, staIntQAbsGlaUns_flow.HSta)
    annotation(
      Line(
        points={{-19,-26}, {14,-26}, {40,-26}, {40, 44}, {58, 44}},
        color={0, 0, 127}));
...
First implementation.
    ...
    Icon(
      graphics={Text(
        ...
        extent={{-2, 20}, {92, 6}},
        lineColor={0, 0, 127},
        textString="QAbsGlaSha"), Text(
        extent={{42,-52}, {106,-66}},
        lineColor={0, 0, 127},
        textString="QTraDif"), Text(
        extent={{-104,-70}, {-50,-84}},
        lineColor={0, 0, 127},
        textString="HRoo"), Text(
        extent={{8,-82}, {62,-94}},
        lineColor={0, 0, 127},
        textString="uSta"), Text(
        extent={{44,-80}, {108,-94}},
        lineColor={0, 0, 127},
        textString="QTraDir")}));
end WindowRadiation;
