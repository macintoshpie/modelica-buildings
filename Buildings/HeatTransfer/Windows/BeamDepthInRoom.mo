  ...
  Modelica.Blocks.Math.Add depInRoo(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-10,-10}, {10, 10}})));
  Modelica.Blocks.Sources.Constant depth(
    final k=-dep)
...
equation
  connect(proShaLen.y, depInRoo.u2)
    annotation(
      Line(
        points={{-39,-20}, {-20,-20}, {-20,-6}, {-12,-6}},
        color={0, 0, 127}));
  connect(depth.y, depInRoo.u1)
    annotation(
      Line(
        points={{-39, 20}, {-20, 20}, {-20, 6}, {-12, 6}, {-12, 6}},
        color={0, 0, 127}));
  connect(zer.y, max.u2)
    annotation(
      Line(
        points={{41,-30}, {48,-30}, {48,-6}, {70,-6}},
        color={0, 0, 127}));
  connect(max.u1, depInRoo.y)
    annotation(
      Line(
        points={{70, 6}, {40, 6}, {40, 0}, {11, 0}},
        color={0, 0, 127}));
  connect(max.y, y)
    annotation(
      Line(
        points={{93, 0}, {93, 0}, {110, 0}},
        color={0, 0, 127}));
  annotation(
