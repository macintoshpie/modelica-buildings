...
protected
  ...
  BoundaryConditions.SolarGeometry.ProjectedShadowLength proShaLen(final h=h, final lat=lat, final azi=azi, final filNam=filNam, final lon=lon, final timZon=timZon)
    "Projected length of shadow"
    annotation(Placement(transformation(extent={{-60,-30}, {-40,-10}})));
  Modelica.Blocks.Math.Add depInRoo(final k2=-1)
    "Depth of beam in room"
  ...
  Modelica.Blocks.Math.Max max
    "Limiter to avoid negative distance"
...
equation
  connect(proShaLen.y, depInRoo.u2)
    annotation(Line(points={{-39,-20}, {-20,-20}, {-20,-6}, {-12,-6}}, color={0, 0, 127}));
  connect(depth.y, depInRoo.u1)
    annotation(Line(points={{-39, 20}, {-20, 20}, {-20, 6}, {-12, 6}, {-12, 6}}, color={0, 0, 127}));
  connect(zer.y, max.u2)
    annotation(Line(points={{41,-30}, {48,-30}, {48,-6}, {70,-6}}, color={0, 0, 127}));
  ...
  annotation(defaultComponentName="beaDep", Documentation(info="<html>
<p>
...
</html>"), Icon(graphics={Bitmap(extent={{-88, 90}, {96,-94}}, fileName="modelica://Buildings/Resources/Images/HeatTransfer/Windows/BeamDepthInRoomIcon.png")}));
end BeamDepthInRoom;
