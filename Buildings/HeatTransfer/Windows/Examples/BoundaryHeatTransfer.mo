...
model BoundaryHeatTransfer
  ...
  parameter Buildings.HeatTransfer.Data.GlazingSystems.TripleClearAir13ClearAir13Clear glaSys3(
    UFra=1)
  ...
  parameter Buildings.HeatTransfer.Data.GlazingSystems.DoubleClearAir13Clear glaSys(
    ...
    annotation(
      Placement(
        transformation(
          extent={{80,-56}, {100,-36}})));
  parameter Buildings.HeatTransfer.Data.GlazingSystems.SingleClear3 glaSys1(
    UFra=2)
    "Parameters for glazing system"
    annotation(
      Placement(
  ...
  Modelica.Blocks.Sources.Constant TRooAir(
    k=293.15,
    y(
      unit="K"))
  ...
  Modelica.Blocks.Sources.Ramp uSha(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-102, 20}, {-82, 40}})));
  Modelica.Blocks.Sources.Constant vWin(
    k=1)
    "Wind speed"
    annotation(
      Placement(
  ...
  Buildings.HeatTransfer.Sources.PrescribedTemperature TRAir3
    ...
    annotation(
      Placement(
        transformation(
          extent={{60,-26}, {80,-6}})));
  Modelica.Blocks.Sources.Constant QAbsSW_flow(
    k=0)
...
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/HeatTransfer/Windows/Examples/BoundaryHeatTransfer.mos"
        "Simulate and plot"),
    Documentation(
      revisions="<html>
<ul>
