...
model ElectrochromicWindow
  ...
  extends Window(
    ...
    uSha(
      ...
      duration=0,
      startTime=0));
  Modelica.Blocks.Sources.Ramp uWin(
    duration=0.5,
    startTime=0.25)
...
equation
  connect(uWin.y, winRad.uSta)
    annotation(
      Line(
        points={{-59,-70}, {-18,-70}, {114.8,-70}, {114.8,-21.6}},
        color={0, 0, 127}));
  annotation(
    Diagram(
      coordinateSystem(
    ...
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/HeatTransfer/Windows/Examples/ElectrochromicWindow.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
