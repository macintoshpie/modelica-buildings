  ...
  Buildings.BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTil(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-20, 60}, {0, 80}})));
  Modelica.Blocks.Routing.Replicator H(
    nout=4)
    "Replicator"
    annotation(
      Placement(
        transformation(
          extent={{20, 60}, {40, 80}})));
  Modelica.Blocks.Routing.Replicator incAng(
    nout=4)
    "Replicator"
    annotation(
      Placement(
...
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=86400),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/HeatTransfer/Windows/Examples/FixedShade.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
