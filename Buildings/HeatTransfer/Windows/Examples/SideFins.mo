...
model SideFins
  ...
  Buildings.HeatTransfer.Windows.SideFins fin(h=0.2, hWin=1.0, wWin=1.0, dep=0.5, gap=0.1)
...
equation
  ...
  connect(HDirTil.inc, fin.incAng)
    annotation(Line(points={{1, 26}, {8, 26}, {8, 4}, {18, 4}}, color={0, 0, 127}, smooth=Smooth.None));
  connect(HDirTil.H, fin.HDirTilUns)
    annotation(Line(points={{1, 30}, {12, 30}, {12, 16}, {18, 16}}, color={0, 0, 127}, smooth=Smooth.None));
  annotation(experiment(Tolerance=1e-6, StopTime=86400), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/HeatTransfer/Windows/Examples/SideFins.mos"
