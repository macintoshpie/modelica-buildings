  ...
  Modelica.Blocks.Math.Add sumFraSun
    ...
    annotation(
      Placement(
        transformation(
          extent={{-40,-40}, {-28,-28}})));
  Modelica.Blocks.Math.Add resFraSun(
    k2=1.0,
    k1=-1.0)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-40,-6}, {-28, 6}})));
  Modelica.Blocks.Sources.Constant overlap(
    k=1.0)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-40, 20}, {-28, 32}})));
  Modelica.Blocks.Sources.Constant noSunCond(
    k=small)
  ...
  Modelica.Blocks.Math.Product mulHDir
    ...
    annotation(
      Placement(
        transformation(
          extent={{60, 50}, {80, 70}})));
  Modelica.Blocks.Routing.Extractor extFraSun(
    ...
    annotation(
      Placement(
        transformation(
          extent={{60, 0}, {80, 20}})));
  Modelica.Blocks.Sources.IntegerConstant idxSou(
    final k=idx)
  ...
  Modelica.Blocks.Sources.Constant const(
    ...
    annotation(
      Placement(
        transformation(
          extent={{0,-90}, {20,-70}})));
  Utilities.Math.SmoothMax smoMax(
    deltaX=small/2)
...
equation
  connect(weaBus.solAlt, walSolAzi.alt)
    annotation(
      Line(
        points={{-100, 5.55112e-16}, {-92, 5.55112e-16}, {-92,-76}, {-82,-76}, {-82,-75.2}},
        color={255, 204, 51},
        thickness=0.5,
        smooth=Smooth.None),
      Text(
