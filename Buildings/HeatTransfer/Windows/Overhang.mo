...
equation
  connect(ove.fraSun, fraSun)
    annotation(
      Line(
        points={{21, 6.10623e-16}, {88.25, 6.10623e-16}, {88.25, 1.16573e-15}, {95.5, 1.16573e-15}, {95.5, 5.55112e-16}, {110, 5.55112e-16}},
        color={0, 0, 127},
        smooth=Smooth.None));
  ...
  connect(weaBus, ove.weaBus)
    annotation(
      Line(
        points={{-100, 5.55112e-16}, {-75.05, 5.55112e-16}, {-75.05, 1.16573e-15}, {-50.1, 1.16573e-15}, {-50.1, 6.10623e-16}, {-0.2, 6.10623e-16}},
        color={255, 204, 51},
        thickness=0.5,
        smooth=Smooth.None),
      Text(
