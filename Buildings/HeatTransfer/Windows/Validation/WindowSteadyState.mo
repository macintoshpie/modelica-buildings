...
equation
  connect(weaDat.HGloHor_in, HSol.y)
    annotation(
      Line(
        points={{-21,-23}, {-46,-23}, {-46,-20}, {-70,-20}},
        color={0, 0, 127}));
  connect(weaDat.HDifHor_in, HSol.y)
    annotation(
      Line(
        points={{-21,-19.5}, {-45.5,-19.5}, {-45.5,-20}, {-70,-20}},
        color={0, 0, 127}));
  annotation(
    Documentation(
      info="<html>
...
First implementation.
    ...
    experiment(
      ...
      StopTime=31536000),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/HeatTransfer/Windows/Validation/WindowSteadyState.mos"
        "Simulate and plot"));
