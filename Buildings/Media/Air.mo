...
package Air
  ...
  // has been removed.
  redeclare replaceable model extends BaseProperties(Xi(each stateSelect=if preferredMediumStates then StateSelect.prefer else StateSelect.default), T(stateSelect=if preferredMediumStates then StateSelect.prefer else StateSelect.default), final standardOrderComponents=true)
    "Base properties"
  protected
...
Density is computed from pressure, temperature and composition in the thermodynamic state record applying the ideal gas law.
  ...
  algorithm
    ...
    annotation(smoothOrder=99, Inline=true, Documentation(info="<html>
<p>
...
First implementation.
  ...
  protected
    Modelica.SIunits.MoleFraction[2] Y
      "Molar fraction";
  algorithm
...
First implementation.
  ...
  algorithm
    ...
    annotation(smoothOrder=5, Inline=true, inverse(T=temperature_phX(p, h, X)), Documentation(info="<html>
...
Temperature is returned from the thermodynamic state record input as a simple assignment.
  ...
  algorithm
    ...
    annotation(Inline=true, smoothOrder=99, Documentation(info="<html>
<p>
...
First implementation.
  ...
  replaceable function der_specificHeatCapacityCp
    ...
    input ThermodynamicState der_state
      "Derivative of thermodynamic state";
