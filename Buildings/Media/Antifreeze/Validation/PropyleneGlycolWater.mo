...
model PropyleneGlycolWater
  ...
  extends Buildings.Media.Antifreeze.Validation.BaseClasses.FluidProperties(
    redeclare package Medium=Buildings.Media.Antifreeze.Validation.BaseClasses.PropyleneGlycolWater(
      property_T=300,
      X_a=0.05),
    nX_a=7,
  ...
  annotation(
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Media/Antifreeze/Validation/PropyleneGlycolWater.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
