...
package ConstantProperties_pT
  ...
  extends Buildings.Media.Water(mediumName="ConstantPropertyWater(p=" + String(p_nominal) + ",T=" + String(T_nominal) + ")", p_default=p_nominal, reference_p=p_nominal, cp_const=cp_nominal, d_const=d_nominal, eta_const=eta_nominal, lambda_const=lambda_nominal, a_const=a_nominal, T_max=T_max_nominal);
...
</html>"), Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100}, {100, 100}}), graphics={Polygon(points={{16,-28}, {32,-42}, {26,-48}, {10,-36}, {16,-28}}, lineColor={95, 95, 95}, fillPattern=FillPattern.Sphere, fillColor={95, 95, 95}), Polygon(points={{10, 34}, {26, 44}, {30, 36}, {14, 26}, {10, 34}}, lineColor={95, 95, 95}, fillPattern=FillPattern.Sphere, fillColor={95, 95, 95}), Ellipse(extent={{-82, 52}, {24,-54}}, lineColor={95, 95, 95}, fillPattern=FillPattern.Sphere, fillColor={0, 0, 0}), Ellipse(extent={{22, 82}, {80, 24}}, lineColor={0, 0, 0}, fillPattern=FillPattern.Sphere, fillColor={95, 95, 95}), Ellipse(extent={{20,-30}, {78,-88}}, lineColor={0, 0, 0}, fillPattern=FillPattern.Sphere, fillColor={95, 95, 95}), Text(extent={{-110, 40}, {50,-36}}, lineColor={238, 46, 47}, textString="pT")}));
