...
package TemperatureDependentDensity
  ...
  extends Modelica.Media.Interfaces.PartialPureSubstance(mediumName="WaterDetailed", p_default=300000, reference_p=300000, reference_T=273.15, reference_X={1}, final singleState=true, ThermoStates=Modelica.Media.Interfaces.Choices.IndependentVariables.T, AbsolutePressure(start=p_default), Temperature(start=T_default));
  ...
  redeclare model extends BaseProperties(preferredMediumStates=true)
    "Base properties"
  equation
...
First implementation.
  ...
  algorithm
    h :=(T-reference_T)*cp_const;
    annotation(smoothOrder=5, Inline=true, derivative=der_enthalpyOfLiquid, Documentation(info="<html>
<p>
...
First implementation.
  ...
  algorithm
    ddTp := if state.T < 278.15 then-0.042860825 elseif state.T < 373.15 then(0.0000450270000000000*state.T^2-0.0362697701000000*state.T + 6.56195279540750) else-0.7025109;
    annotation(smoothOrder=1, Inline=true, Documentation(info="<html>
<p>
...
First implementation.
  ...
  algorithm
    cp := cp_const;
    annotation(Inline=true, derivative=der_specificHeatCapacityCp, Documentation(info="<html>
<p>
...
protected
  ...
  constant Modelica.SIunits.MolarMass MM_const=0.018015268
    "Molar mass";
...
First implementation.
  ...
  function kinematicViscosity
    ...
    input Modelica.SIunits.Temperature T
      "Temperature";
    output Modelica.SIunits.KinematicViscosity kinVis
      "Kinematic viscosity";
  algorithm
    kinVis := smooth(1, if T < 278.15 then-(4.63023776563e-08)*T + 1.44011135763e-05 else 1.0e-6*Modelica.Math.exp(-(7.22111000000000e-7)*T^3 + 0.000809102858950000*T^2-0.312920238272193*T + 40.4003044106506));
...
</html>"), Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100}, {100, 100}}), graphics={Polygon(points={{16,-28}, {32,-42}, {26,-48}, {10,-36}, {16,-28}}, lineColor={95, 95, 95}, fillPattern=FillPattern.Sphere, fillColor={95, 95, 95}), Polygon(points={{10, 34}, {26, 44}, {30, 36}, {14, 26}, {10, 34}}, lineColor={95, 95, 95}, fillPattern=FillPattern.Sphere, fillColor={95, 95, 95}), Ellipse(extent={{-82, 52}, {24,-54}}, lineColor={95, 95, 95}, fillPattern=FillPattern.Sphere, fillColor={0, 0, 0}), Ellipse(extent={{22, 82}, {80, 24}}, lineColor={0, 0, 0}, fillPattern=FillPattern.Sphere, fillColor={95, 95, 95}), Ellipse(extent={{20,-30}, {78,-88}}, lineColor={0, 0, 0}, fillPattern=FillPattern.Sphere, fillColor={95, 95, 95}), Text(extent={{-64, 88}, {-42, 58}}, lineColor={255, 0, 0}, textString="T")}));
