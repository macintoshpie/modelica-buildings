  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Sine sin(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60, 0}, {-40, 20}})));
  Buildings.Obsolete.Controls.OBC.CDL.Discrete.MovingMean movMea(
    n=4,
    samplePeriod=1)
...
equation
  ...
  annotation(
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Obsolete/Controls/OBC/CDL/Discrete/Examples/MovingMean.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
