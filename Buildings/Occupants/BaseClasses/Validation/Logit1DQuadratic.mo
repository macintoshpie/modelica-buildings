...
equation
  ...
  when sample(0, 0.1) then
    ...
    if Buildings.Occupants.BaseClasses.logit1DQuadratic(x, A, B, C, D,
  ...
  annotation(
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/BaseClasses/Validation/Logit1DQuadratic.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
