...
equation
  ...
  when sample(0, 0.1) then
    ...
    if Buildings.Occupants.BaseClasses.weibull1DOFF(x, u, L, k, dt,
  ...
  annotation(
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/BaseClasses/Validation/Weibull1DOFF.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
