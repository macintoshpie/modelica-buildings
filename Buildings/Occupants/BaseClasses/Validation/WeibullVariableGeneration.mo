...
equation
  ...
  when sample(0, 0.1) then
    ...
    y=Buildings.Occupants.BaseClasses.weibullVariableGeneration(lambda, k,
  ...
  annotation(
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/BaseClasses/Validation/WeibullVariableGeneration.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
