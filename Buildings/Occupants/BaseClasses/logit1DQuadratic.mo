...
function logit1DQuadratic
  ...
  output Boolean y
    "Binary variable";
algorithm
  y := Buildings.Occupants.BaseClasses.binaryVariableGeneration(A + C/(1 + Modelica.Math.exp(-B*(Modelica.Math.log10(x)-D))), globalSeed);
