...
model Haldi2008BlindsTOut
  ...
  parameter Real A(final unit="1/K")=0.139
    "Slope of outdoor temperature";
  parameter Real B(final unit="1")=-3.54
    "Intercept";
  parameter Integer seed=20
  ...
  Real pDown(final unit="1", final min=0, final max=1)
    "The probability of lowering the blinds";
protected
...
equation
  ...
  annotation(Icon(graphics={Rectangle(extent={{-60, 40}, {60,-40}}, lineColor={28, 108, 200}), Text(extent={{-40, 20}, {40,-20}}, lineColor={28, 108, 200}, fillColor={0, 0, 255}, fillPattern=FillPattern.Solid, textStyle={TextStyle.Bold}, textString="Blinds_TOut")}), defaultComponentName="bli", Documentation(info="<html>
<p>
