...
model Newsham1994BlindsSolarIntensity
  ...
  Buildings.Occupants.Office.Blinds.Newsham1994BlindsSolarIntensity bli
    "Tested blinds model"
...
equation
  ...
  annotation(experiment(Tolerance=1e-6, StopTime=3600.0), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Office/Blinds/Validation/Newsham1994BlindsSolarIntensity.mos"
