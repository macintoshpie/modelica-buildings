...
model Zhang2012BlindsSolarAltitude
  ...
  Modelica.Blocks.Sources.Sine SA(amplitude=30*3.14159/180, offset=35*3.14159/180, freqHz=0.001, y(unit="1"))
    "Solar altitude"
    annotation(Placement(transformation(extent={{-80,-30}, {-60,-10}})));
  Buildings.Occupants.Office.Blinds.Zhang2012BlindsSolarAltitude bli
    "Tested blinds model"
    annotation(Placement(transformation(extent={{-10,-10}, {10, 10}})));
equation
  connect(occ.y, bli.occ)
    annotation(Line(points={{-59, 20}, {-34, 20}, {-34, 6}, {-12, 6}}, color={255, 0, 255}));
  connect(SA.y, bli.solarAltitude)
    annotation(Line(points={{-59,-20}, {-36,-20}, {-36,-6}, {-12,-6}}, color={0, 0, 127}));
  annotation(experiment(Tolerance=1e-6, StopTime=3600.0), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Office/Blinds/Validation/Zhang2012BlindsSolarAltitude.mos"
