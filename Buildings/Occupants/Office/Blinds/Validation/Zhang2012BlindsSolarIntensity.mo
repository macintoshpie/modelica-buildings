...
model Zhang2012BlindsSolarIntensity
  ...
  Buildings.Occupants.Office.Blinds.Zhang2012BlindsSolarIntensity bli
    "Tested blinds model"
...
equation
  ...
  annotation(experiment(Tolerance=1e-6, StopTime=3600.0), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Office/Blinds/Validation/Zhang2012BlindsSolarIntensity.mos"
