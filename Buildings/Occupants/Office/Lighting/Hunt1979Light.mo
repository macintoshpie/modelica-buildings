...
model Hunt1979Light
  ...
  parameter Real AArriv=-0.0175
    "Upon arrival";
  parameter Real BArriv=-4.0835
    "Upon arrival";
  parameter Real CArriv=1.0361
    "Upon arrival";
  parameter Real MArriv=1.8223
    "Upon arrival";
...
equation
  ...
  when {occ, sampleTrigger} then
    ...
    if sampleTrigger then
      ...
      on=Buildings.Occupants.BaseClasses.binaryVariableGeneration(pArriv,
