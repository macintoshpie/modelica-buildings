...
model Gunay2016Light
  ...
  Modelica.Blocks.Sources.Sine ill(amplitude=200, offset=250, freqHz=0.001)
    "Illuminance at working planein units of lux"
    annotation(Placement(transformation(extent={{-80,-30}, {-60,-10}})));
  Buildings.Occupants.Office.Lighting.Gunay2016Light lig
...
equation
  ...
  connect(booleanPulse.y, lig.occ)
    annotation(Line(points={{-59, 20}, {-36, 20}, {-36, 6}, {-12, 6}}, color={255, 0, 255}));
  annotation(experiment(Tolerance=1e-6, StopTime=3600.0), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Office/Lighting/Validation/Gunay2016Light.mos"
