...
model Reinhart2003Light
  ...
  Modelica.Blocks.Sources.Sine ill(amplitude=200, offset=250, freqHz=0.001)
    "Minimum illuminance at working plane"
    annotation(Placement(transformation(extent={{-80,-30}, {-60,-10}})));
  Buildings.Occupants.Office.Lighting.Reinhart2003Light lig
...
equation
  ...
  annotation(experiment(Tolerance=1e-6, StopTime=3600.0), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Office/Lighting/Validation/Reinhart2003Light.mos"
