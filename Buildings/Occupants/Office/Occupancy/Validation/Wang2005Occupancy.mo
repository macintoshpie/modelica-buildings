...
model Wang2005Occupancy
  "Validating the model for occupancy"
  extends Modelica.Icons.Example;
  Buildings.Occupants.Office.Occupancy.Wang2005Occupancy occ
    "Tested Occupancy model"
    annotation(Placement(transformation(extent={{-10,-10}, {10, 10}})));
  annotation(experiment(Tolerance=1e-6, StopTime=36000.0), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Office/Occupancy/Validation/Wang2005Occupancy.mos"
