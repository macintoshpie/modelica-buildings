...
model Wang2005Occupancy
  ...
  parameter Modelica.SIunits.Time one_mu(displayUnit="min")=4368
    "Mean occupancy duration";
  parameter Modelica.SIunits.Time zero_mu(displayUnit="min")=2556
...
equation
  ...
  annotation(Icon(graphics={Rectangle(extent={{-60, 40}, {60,-40}}, lineColor={28, 108, 200}), Text(extent={{-40, 20}, {40,-20}}, lineColor={28, 108, 200}, fillColor={0, 0, 255}, fillPattern=FillPattern.Solid, textStyle={TextStyle.Bold}, textString="Occupancy")}), defaultComponentName="occ", Documentation(info="<html>
<p>
