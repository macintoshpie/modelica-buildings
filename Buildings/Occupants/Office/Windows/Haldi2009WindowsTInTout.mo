...
model Haldi2009WindowsTInTout
  "A model to predict occupants' window behavior with indoor and outdoor temperature"
  extends Modelica.Blocks.Icons.DiscreteBlock;
  parameter Real AOpenIn=0.263
    "Slope of indoor temp of the logistic relation for the opening probability";
  parameter Real AOpenOut=0.039
    "Slope of outdoor temp of the logistic relation for the opening probability";
  parameter Real BOpen=-11.78
    "Intercept of the logistic relation for the opening probability";
  parameter Real ACloseIn=0.026
    "Slope of indoor temp of the logistic relation for the closing probability";
  parameter Real ACloseOut=-0.065
    "Slope of outdoor temp of the logistic relation for the closing probability";
  parameter Real BClose=-4.14
    "Intercept of the logistic relation for the closing probability";
  ...
  Modelica.Blocks.Interfaces.RealInput TIn(final unit="K", displayUnit="degC")
    ...
    annotation(Placement(transformation(extent={{-140,-40}, {-100, 0}}), iconTransformation(extent={{-140,-50}, {-100,-10}})));
  ...
  Real pOpen(unit="1", min=0, max=1)
    "Probability of opening windows";
  Real pClose(unit="1", min=0, max=1)
    "Probability of closing windows";
protected
...
equation
  ...
  annotation(Icon(graphics={Rectangle(extent={{-60, 40}, {60,-40}}, lineColor={28, 108, 200}), Text(extent={{-40, 20}, {40,-20}}, lineColor={28, 108, 200}, fillColor={0, 0, 255}, fillPattern=FillPattern.Solid, textStyle={TextStyle.Bold}, textString="WindowAll_TInTout")}), defaultComponentName="win", Documentation(info="<html>
<p>
