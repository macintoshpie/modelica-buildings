...
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=3600.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Office/Windows/Validation/Haldi2009WindowsTInTout.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
