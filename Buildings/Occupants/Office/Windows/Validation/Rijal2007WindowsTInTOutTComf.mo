...
equation
  connect(win.occ, occ.y)
    annotation(
      Line(
        points={{-12, 6}, {-36, 6}, {-36, 40}, {-59, 40}},
        color={255, 0, 255}));
  connect(win.TOut, TOut.y)
    annotation(
      Line(
        points={{-12,-4}, {-36,-4}, {-36,-24}, {-59,-24}},
        color={0, 0, 127}));
  connect(win.TIn, TIn.y)
    annotation(
      Line(
        points={{-12, 0}, {-42, 0}, {-42, 10}, {-59, 10}},
        color={0, 0, 127}));
  connect(win.TComf, TComf.y)
    annotation(
      Line(
        points={{-12,-8.4}, {-28,-8.4}, {-28,-60}, {-59,-60}},
        color={0, 0, 127}));
  annotation(
    experiment(
      Tolerance=1e-6,
      StopTime=3600.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Office/Windows/Validation/Rijal2007WindowsTInTOutTComf.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
