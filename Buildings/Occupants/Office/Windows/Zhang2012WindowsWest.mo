...
model Zhang2012WindowsWest
  ...
  parameter Real B=-4.77
    "Intercept of the logistic relation";
  parameter Integer seed=50
  ...
  Modelica.Blocks.Interfaces.BooleanOutput on
    "State of West-oriented window, true for open"
...
equation
  ...
  annotation(Icon(graphics={Rectangle(extent={{-60, 40}, {60,-40}}, lineColor={28, 108, 200}), Text(extent={{-40, 20}, {40,-20}}, lineColor={28, 108, 200}, fillColor={0, 0, 255}, fillPattern=FillPattern.Solid, textStyle={TextStyle.Bold}, textString="WindowWest_Tout")}), defaultComponentName="win", Documentation(info="<html>
<p>
Model predicting the state of the West-oriented window with the outdoor air temperature 
and occupancy.
</p>
<h4>Dynamics</h4>
<p>
