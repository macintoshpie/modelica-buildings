...
model Ren2014ACBedroom
  ...
  Buildings.Occupants.Residential.AirConditioning.Ren2014ACBedroom ac
    "Tested AC model"
    annotation(Placement(transformation(extent={{-10,-10}, {10, 10}})));
equation
  connect(occ.y, ac.occ)
    annotation(Line(points={{-59, 16}, {-36, 16}, {-36, 6}, {-12, 6}}, color={255, 0, 255}));
  connect(Tin.y, ac.TIn)
    annotation(Line(points={{-59,-16}, {-36,-16}, {-36,-6}, {-12,-6}}, color={0, 0, 127}));
  annotation(experiment(Tolerance=1e-6, StopTime=3600.0), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Residential/AirConditioning/Validation/Ren2014ACBedroom.mos"
