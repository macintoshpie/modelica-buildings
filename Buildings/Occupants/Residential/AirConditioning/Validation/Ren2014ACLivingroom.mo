...
model Ren2014ACLivingroom
  ...
  Modelica.Blocks.Sources.Sine Tin(amplitude=10, offset=303, freqHz=0.001, y(unit="K", displayUnit="degC"))
    "Indoor air temperature"
    annotation(Placement(transformation(extent={{-80,-30}, {-60,-10}})));
  Buildings.Occupants.Residential.AirConditioning.Ren2014ACLivingroom ac
    "Tested AC model"
    annotation(Placement(transformation(extent={{-10,-10}, {10, 10}})));
equation
  connect(occ.y, ac.occ)
    annotation(Line(points={{-59, 20}, {-36, 20}, {-36, 6}, {-12, 6}}, color={255, 0, 255}));
  connect(Tin.y, ac.TIn)
    annotation(Line(points={{-59,-20}, {-36,-20}, {-36,-6}, {-12,-6}}, color={0, 0, 127}));
  annotation(experiment(Tolerance=1e-6, StopTime=3600.0), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Occupants/Residential/AirConditioning/Validation/Ren2014ACLivingroom.mos"
