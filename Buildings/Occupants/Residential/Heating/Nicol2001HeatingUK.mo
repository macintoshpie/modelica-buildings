...
model Nicol2001HeatingUK
  ...
  parameter Real A(final unit="1/K")=-0.514
    "Slope of the logistic relation";
  parameter Real B(final unit="1")=5.28
  ...
  Real p(final unit="1", final min=0, final max=1)
...
equation
  ...
  annotation(Icon(graphics={Rectangle(extent={{-60, 40}, {60,-40}}, lineColor={28, 108, 200}), Text(extent={{-40, 20}, {40,-20}}, lineColor={28, 108, 200}, fillColor={0, 0, 255}, fillPattern=FillPattern.Solid, textStyle={TextStyle.Bold}, textString="Heater_Tout")}), defaultComponentName="hea", Documentation(info="<html>
<p>
