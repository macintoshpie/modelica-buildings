...
model Nicol2001WindowsUK
  ...
  parameter Real A(final unit="1/K")=0.169
    "Slope of the logistic relation";
  parameter Real B(final unit="1")=-2.65
...
equation
  ...
  annotation(Icon(graphics={Rectangle(extent={{-60, 40}, {60,-40}}, lineColor={28, 108, 200}), Text(extent={{-40, 20}, {40,-20}}, lineColor={28, 108, 200}, fillColor={0, 0, 255}, fillPattern=FillPattern.Solid, textStyle={TextStyle.Bold}, textString="WindowAll_Tout")}), defaultComponentName="win", Documentation(info="<html>
<p>
...
<p>
The model parameters are regressed from the field study in the UK in
