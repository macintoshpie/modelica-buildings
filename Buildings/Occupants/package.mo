within Buildings;
package Occupants
  "Package with models to simulate building occupant behaviors"
...
</html>"), Icon(graphics={Line(points={{-32,-70}, {0,-20}, {32,-70}}, color={0, 0, 0}), Line(points={{0,-20}, {0, 40}}, color={0, 0, 0}), Line(points={{-28, 20}, {28, 20}}, color={0, 0, 0}), Ellipse(extent={{-14, 40}, {14, 70}}, lineColor={0, 0, 0})}));
end Occupants;
