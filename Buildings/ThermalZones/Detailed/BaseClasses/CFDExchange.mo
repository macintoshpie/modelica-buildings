...
block CFDExchange
  ...
  parameter Real yFixed[nRea]
    ...
    annotation(
      Dialog(
        enable=not activateInterface));
  parameter Integer nSur(
    min=2)
    "Number of surfaces";
