    ...
    annotation(
      Placement(
        transformation(
          extent={{-30, 0}, {10, 40}})));
protected
  Modelica.Blocks.Sources.Constant QRad_flow(
    k=1)
    "Radiative heat gain"
    annotation(
      Placement(
...
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/Detailed/BaseClasses/Examples/InfraredRadiationGainDistribution.mos"
        "Simulate and plot"),
    Diagram(
      coordinateSystem(
        extent={{-160,-220}, {120, 120}})),
    Documentation(
      info="<html>
<p>
