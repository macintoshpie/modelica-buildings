    ...
    annotation(
      Placement(
        transformation(
          extent={{-44,-2}, {-4, 38}})));
protected
  Modelica.Thermal.HeatTransfer.Components.ThermalConductor conGlaSha[NConExtWin](
    each G=100)
    "Heat conductor"
    annotation(
      Placement(
        transformation(
          extent={{42,-182}, {62,-162}})));
    ...
    annotation(
      Placement(
        transformation(
          ...
          rotation=180,
          origin={92,-172})));
  Modelica.Thermal.HeatTransfer.Components.ThermalConductor conGlaUns[NConExtWin](
    each G=100)
    "Heat conductor"
    annotation(
      Placement(
        transformation(
          extent={{42,-142}, {62,-122}})));
...
equation
  ...
  connect(uSha.y, air.uSha)
    annotation(
      Line(
        points={{-119, 90}, {-90, 90}, {-90, 36}, {-84, 36}, {-84, 34.6667}, {-44.6667, 34.6667}},
        color={0, 0, 127},
        smooth=Smooth.None));
  ...
  connect(heaGai.QCon_flow, air.QCon_flow)
    annotation(
      Line(
        points={{-98,-10}, {-70,-10}, {-70, 9.66667}, {-45.6667, 9.66667}},
        color={0, 0, 127}));
  connect(air.QLat_flow, heaGai.QLat_flow)
    annotation(
      Line(
        points={{-45.6667, 4.66667}, {-68, 4.66667}, {-68,-16}, {-98,-16}},
        color={0, 0, 127}));
  annotation(
    Diagram(
      coordinateSystem(
        preserveAspectRatio=false,
        extent={{-220,-200}, {140, 140}})),
    experiment(
      Tolerance=1e-6,
      StopTime=3600),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/Detailed/BaseClasses/Examples/MixedAirHeatMassBalance.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
