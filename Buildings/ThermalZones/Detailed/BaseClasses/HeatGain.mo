...
</html>"), Icon(graphics={Rectangle(extent={{-100, 100}, {100,-100}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Line(points={{-48,-66}, {-24,-18}, {0,-68}}, color={0, 0, 255}, smooth=Smooth.None), Line(points={{-24,-18}, {-24, 46}}, color={0, 0, 255}, smooth=Smooth.None), Line(points={{-52, 24}, {-24, 38}}, color={0, 0, 255}, smooth=Smooth.None), Line(points={{-24, 38}, {8, 22}}, color={0, 0, 255}, smooth=Smooth.None), Ellipse(extent={{-40, 76}, {-8, 46}}, lineColor={0, 0, 255}), Text(extent={{-98, 30}, {-38,-26}}, lineColor={0, 0, 127}, textString="q_flow"), Text(extent={{20, 74}, {94, 52}}, lineColor={0, 0, 127}, textString="QRad_flow"), Text(extent={{18, 14}, {92,-8}}, lineColor={0, 0, 127}, textString="QCon_flow"), Text(extent={{20,-44}, {94,-66}}, lineColor={0, 0, 127}, textString="QLat_flow")}), Documentation(info="<html>
