...
record ParameterConstructionWithWindow
  ...
  parameter Buildings.ThermalZones.Detailed.BaseClasses.Overhang ove(wR=0, wL=0, dep=0, gap=0)
    ...
    annotation(Dialog(group="Glazing system"), choicesAllMatching=true, Placement(transformation(extent={{60, 20}, {80, 40}})));
  parameter Buildings.ThermalZones.Detailed.BaseClasses.SideFins sidFin(h=0, dep=0, gap=0)
    "Geometry of side fins"
    annotation(Dialog(group="Glazing system"), choicesAllMatching=true, Placement(transformation(extent={{60,-20}, {80, 0}})));
  ...
  parameter HeatTransfer.Data.GlazingSystems.Generic glaSys
    ...
    annotation(Dialog(group="Glazing system"), choicesAllMatching=true, Placement(transformation(extent={{58, 62}, {78, 82}})));
