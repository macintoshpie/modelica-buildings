...
partial model PartialAirHeatMassBalance
  ...
  Modelica.Blocks.Interfaces.RealInput uSha[NConExtWin] if haveShade
    ...
    annotation(
      Placement(
        transformation(
          extent={{-280, 180}, {-240, 220}}),
        iconTransformation(
          extent={{-256, 192}, {-240, 208}})));
  Modelica.Blocks.Interfaces.RealInput QRadAbs_flow[NConExtWin](
    each final unit="W") if haveShade
  ...
  annotation(
    ...
    Icon(
      ...
      graphics={Text(
        ...
        fillColor={0, 0, 255},
        fillPattern=FillPattern.Solid,
        textString="QRadAbs"), Text(
        extent={{-228, 44}, {-186, 78}},
        lineColor={0, 0, 127},
        fillColor={0, 0, 255},
        fillPattern=FillPattern.Solid,
        textString="TSha"), Rectangle(
