...
equation
  ...
  rad.T=TRad;
  annotation(Placement(transformation(extent={{-140,-20}, {-100, 20}})), Documentation(info="<html>
...
</html>"), Icon(graphics={Rectangle(extent={{-100, 100}, {100,-100}}, lineColor={0, 0, 0}, fillColor={255, 255, 255}, fillPattern=FillPattern.Solid), Text(extent={{-90, 24}, {-40,-26}}, lineColor={0, 0, 127}, textString="TRad"), Text(extent={{50, 14}, {92,-12}}, lineColor={0, 0, 127}, textString="Q")}), Documentation(info="<html>
