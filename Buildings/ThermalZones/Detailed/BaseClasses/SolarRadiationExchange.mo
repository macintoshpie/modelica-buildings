...
model SolarRadiationExchange
  ...
  extends Buildings.ThermalZones.Detailed.BaseClasses.PartialSurfaceInterfaceRadiative(
    ...
    final epsConExtWinUns={(1-datConExtWin[i].glaSys.glass[size(datConExtWin[i].glaSys.glass, 1)].tauSol[1]-datConExtWin[i].glaSys.glass[size(datConExtWin[i].glaSys.glass, 1)].rhoSol_b[1]) for i in 1 : NConExtWin},
    final epsConExtWinSha={(1-datConExtWin[i].glaSys.glass[size(datConExtWin[i].glaSys.glass, 1)].tauSol[1]-datConExtWin[i].glaSys.glass[size(datConExtWin[i].glaSys.glass, 1)].rhoSol_b[1]) for i in 1 : NConExtWin},
...
protected
  ...
  final parameter Real sumEpsTauA(
    unit="m2",
    fixed=false)
    "Sum(epsTauA)";
initial equation
