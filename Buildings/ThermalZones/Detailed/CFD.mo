...
protected
  ...
  Modelica.Blocks.Sources.Constant conSha[nConExtWin](
    final k=uSha_fixed) if haveShade
  ...
  annotation(
    Icon(
      ...
      graphics={Rectangle(
        ...
        fileName="modelica://Buildings/Resources/Images/ThermalZones/Detailed/cfd.png"), Text(
        extent={{162, 98}, {196, 140}},
        lineColor={0, 0, 127},
        textString="yCFD"), Text(
        extent={{-86,-14}, {0, 16}},
        lineColor={0, 0, 0},
        textString="air"), Text(
        extent={{-102,-50}, {-22,-26}},
