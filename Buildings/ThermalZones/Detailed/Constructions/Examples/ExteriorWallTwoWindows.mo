...
model ExteriorWallTwoWindows
  ...
  ConstructionWithWindow conExt[nCon](
    ...
    annotation(
      Placement(
        transformation(
          extent={{60,-30}, {0, 30}})));
  Buildings.ThermalZones.Detailed.BaseClasses.ExteriorBoundaryConditionsWithWindow bouConExt(
    nCon=2,
    ...
    annotation(
      Placement(
        transformation(
          extent={{82,-14}, {122, 26}})));
  Buildings.HeatTransfer.Sources.FixedTemperature TRoo(
    T=293.15)
    "Room temperature"
    annotation(
      Placement(
  ...
  Buildings.HeatTransfer.Convection.Interior con[nCon](
    A=A-AWin,
  ...
  Modelica.Blocks.Sources.Constant QAbsSha[nCon](
    ...
    annotation(
      Placement(
        transformation(
          extent={{-90,-120}, {-70,-100}})));
  Modelica.Blocks.Sources.Constant QAbs[nCon, size(glaSys1.glass, 1)](
    each k=0)
  ...
  Buildings.HeatTransfer.Windows.BaseClasses.ShadeRadiation intShaRad[nCon](
    ...
    A=AGla) if glaSys1.haveShade or glaSys2.haveShade
...
protected
  Modelica.Blocks.Math.Sum sumJ[nCon](
    each nin=if glaSys1.haveShade or glaSys2.haveShade then 2 else 1)
...
equation
  ...
  connect(bouConExt.uSha, replicator.y)
    annotation(
      Line(
        points={{80.6667, 12.6667}, {66, 12.6667}, {66, 40}, {-20, 40}, {-20,-32}, {-139,-32}},
        color={0, 0, 127},
        smooth=Smooth.None));
  ...
  annotation(
    experiment(
      ...
      StopTime=1209600),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/Detailed/Constructions/Examples/ExteriorWallTwoWindows.mos"
        "Simulate and plot"),
    Diagram(
      coordinateSystem(
