...
model ExteriorWallWithWindow
  ...
  Modelica.Blocks.Sources.Constant QAbs[1, size(glaSys.glass, 1)](
    each k=0)
  ...
  Modelica.Blocks.Sources.Constant QAbsSha(
    k=0)
  ...
  Modelica.Blocks.Sources.Constant QTra(
    k=0)
  ...
  Buildings.HeatTransfer.Windows.BaseClasses.ShadeRadiation intShaRad[1](
    ...
    each A=AGla) if glaSys.haveShade
...
protected
  Modelica.Blocks.Math.Sum sumJ[1](
    each nin=if glaSys.haveShade then 2 else 1)
...
equation
  ...
  connect(uSha.y, bouConExt.uSha[1])
    annotation(
      Line(
        points={{-159,-50}, {-140,-50}, {-140, 6}, {54, 6}, {54, 12}, {64, 12}, {64, 12.6667}, {92.6667, 12.6667}},
        color={0, 0, 127},
        smooth=Smooth.None));
  ...
  annotation(
    experiment(
      ...
      StopTime=1209600),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/Detailed/Constructions/Examples/ExteriorWallWithWindow.mos"
        "Simulate and plot"),
    Diagram(
      coordinateSystem(
        preserveAspectRatio=false,
        extent={{-200,-220}, {200, 100}}),
      graphics),
    Documentation(
      info="<html>
<p>
