...
block ElectrochromicWindow
  ...
  Modelica.Blocks.Interfaces.RealInput T(quantity="ThermodynamicTemperature", unit="K")
    "Temperature used for control"
    annotation(Placement(transformation(extent={{-140, 20}, {-100, 60}}), iconTransformation(extent={{-130, 25}, {-100, 55}})));
  Modelica.Blocks.Interfaces.RealInput H(quantity="RadiantEnergyFluenceRate", unit="W/m2")
    "Direct solar radiation onto window"
    annotation(Placement(transformation(extent={{-140,-60}, {-100,-20}}), iconTransformation(extent={{-130,-55}, {-100,-25}})));
  Modelica.Blocks.Interfaces.RealOutput y
    "Control signal for window"
    annotation(Placement(transformation(extent={{100,-10}, {120, 10}})));
protected
  Modelica.Blocks.Sources.Constant TLow(final k=TClear)
    "Lower temperature"
    annotation(Placement(transformation(extent={{-80, 10}, {-60, 30}})));
  Modelica.Blocks.Nonlinear.Limiter limT(final uMax=1, final uMin=0, final strict=true, final limitsAtInit=true)
    "Limiter for temperature"
    annotation(Placement(transformation(extent={{30, 30}, {50, 50}})));
  Modelica.Blocks.Math.Feedback feeT
  ...
  Modelica.Blocks.Sources.Constant HLow(final k=HClear)
    "Lower irradiation"
    annotation(Placement(transformation(extent={{-80,-70}, {-60,-50}})));
  Modelica.Blocks.Nonlinear.Limiter limH(final uMax=1, final uMin=0, final strict=true, final limitsAtInit=true)
    "Limiter for irradiation"
    annotation(Placement(transformation(extent={{30,-50}, {50,-30}})));
  Modelica.Blocks.Math.Feedback feeH
    "Feedback for irradiation"
...
equation
  ...
  connect(limH.y, product.u2)
    annotation(Line(points={{51,-40}, {58,-40}, {58,-6}, {68,-6}}, color={0, 0, 127}));
  connect(product.y, y)
    annotation(Line(points={{91, 0}, {110, 0}}, color={0, 0, 127}));
  annotation(defaultComponentName="conWin", Documentation(info="<html>
<p>
Controller for electrochromic windows.
...
</html>"), Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100}, {100, 100}}), graphics={Text(extent={{-118, 58}, {-42, 26}}, lineColor={0, 0, 127}, textString="T"), Text(extent={{-118,-24}, {-42,-56}}, lineColor={0, 0, 127}, textString="H"), Text(extent={{42, 22}, {118,-10}}, lineColor={0, 0, 127}, textString="u")}));
