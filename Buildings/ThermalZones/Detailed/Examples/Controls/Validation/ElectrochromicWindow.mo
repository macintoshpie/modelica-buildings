...
model ElectrochromicWindow
  ...
  Modelica.Blocks.Sources.Trapezoid TMea(amplitude=5, rising=3600, falling=3600, period=24*3600, width=12*3600, startTime=5*3600, offset=293.15)
    "Measured temperature"
    annotation(Placement(transformation(extent={{-60, 20}, {-40, 40}})));
  Modelica.Blocks.Sources.Trapezoid HMea(period=24*3600, nperiod=1, rising=2*3600, width=4*3600, falling=2*3600, startTime=7*3600, amplitude=500)
...
equation
  connect(TMea.y, conWin.T)
    annotation(Line(points={{-39, 30}, {-24, 30}, {-24, 4}, {-9.5, 4}}, color={0, 0, 127}));
  connect(HMea.y, conWin.H)
    annotation(Line(points={{-39,-28}, {-24,-28}, {-24,-4}, {-9.5,-4}}, color={0, 0, 127}));
  annotation(experiment(Tolerance=1e-6, StopTime=172800), __Dymola_Commands(file="Resources/Scripts/Dymola/ThermalZones/Detailed/Examples/Controls/Validation/ElectrochromicWindow.mos"
