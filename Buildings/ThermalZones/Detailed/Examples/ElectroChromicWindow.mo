...
equation
  ...
  connect(roo.heaPorAir, TRooAir.port)
    annotation(
      Line(
        points={{81, 4}, {94, 4}, {108, 4}, {110, 4}},
        color={191, 0, 0}));
  connect(TRooAir.T, conWin.T)
    annotation(
      Line(
        points={{130, 4}, {134, 4}, {134, 30}, {-10, 30}, {-10, 14}, {-1.5, 14}},
        color={0, 0, 127}));
  connect(conWin.H, weaBus.HGloHor)
    annotation(
      Line(
        points={{-1.5, 6}, {-12, 6}, {-12, 34}, {150, 34}, {150, 20}},
        color={0, 0, 127}));
  connect(conWin.y, roo.uWin[1])
    annotation(
      Line(
        points={{21, 10}, {30, 10}, {30, 17}, {60.4, 17}},
        color={0, 0, 127}));
  ...
  connect(freshAir.ports[1], duc.port_a)
    annotation(
      Line(
        points={{10,-70}, {10,-70}, {20,-70}},
        color={0, 127, 255}));
  connect(bou.ports[1], roo.ports[1])
    annotation(
      Line(
        points={{10,-120}, {10,-120}, {54,-120}, {54,-8}, {67,-8}},
        color={0, 127, 255}));
  connect(duc.port_b, roo.ports[2])
    annotation(
      Line(
        points={{40,-70}, {48,-70}, {48,-4}, {67,-4}},
        color={0, 127, 255}));
  connect(gai.u[1], nPer.y)
    annotation(
      Line(
        points={{-42,-10}, {-42,-10}, {-59,-10}},
        color={0, 0, 127}));
  connect(gai.y, roo.qGai_flow)
    annotation(
      Line(
        points={{-19,-10}, {34,-10}, {34, 12}, {60.4, 12}},
        color={0, 0, 127}));
  annotation(
    Diagram(
      coordinateSystem(
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/Detailed/Examples/ElectroChromicWindow.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
