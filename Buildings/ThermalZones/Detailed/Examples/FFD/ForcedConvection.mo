...
model ForcedConvection
  ...
  extends Buildings.ThermalZones.Detailed.Examples.FFD.BaseClasses.PartialRoom(
    ...
    nSurBou=6);
  HeatTransfer.Sources.FixedTemperature TWal[nSurBou](
    each T=283.15)
...
equation
  ...
  annotation(
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/Detailed/Examples/FFD/ForcedConvection.mos"
        "Simulate and plot"),
    experiment(
      Tolerance=1e-06,
      StopTime=120),
