...
equation
  connect(roo.yCFD[1], conPID.u_m)
    annotation(
      Line(
        points={{101,-26.5}, {100,-26.5}, {100,-26}, {110,-26}, {110, 20}, {50, 20}, {50, 38}},
        color={0, 0, 127},
        smooth=Smooth.None));
  ...
  annotation(
    Diagram(
      coordinateSystem(
        ...
        extent={{-100,-180}, {220, 120}})),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/Detailed/Examples/FFD/NaturalConvectionWithControl.mos"
        "Simulate and plot"),
    experiment(
      Tolerance=1e-06,
      StopTime=7200),
