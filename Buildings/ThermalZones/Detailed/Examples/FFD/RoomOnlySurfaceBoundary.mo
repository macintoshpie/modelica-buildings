...
model RoomOnlySurfaceBoundary
  ...
  extends Buildings.ThermalZones.Detailed.Examples.FFD.BaseClasses.PartialRoom(
    ...
    nSurBou=6);
  Buildings.HeatTransfer.Sources.FixedTemperature TWesWal(
    T=283.15)
...
equation
  ...
  annotation(
    Diagram(
      ...
      graphics),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/Detailed/Examples/FFD/RoomOnlySurfaceBoundary.mos"
        "Simulate and plot"),
    experiment(
      Tolerance=1e-06,
      StopTime=900),
