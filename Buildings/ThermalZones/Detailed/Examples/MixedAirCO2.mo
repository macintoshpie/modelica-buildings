...
model MixedAirCO2
  ...
  extends Buildings.ThermalZones.Detailed.Examples.ElectroChromicWindow(
    bou(
      use_m_flow_in=true),
    redeclare package MediumA=Buildings.Media.Air(
  ...
  Buildings.Fluid.Sensors.PPM senCO2(
    ...
    annotation(
      Placement(
        transformation(
          extent={{70,-60}, {90,-40}})));
  Modelica.Blocks.Sources.Constant CO2Set(
    k=700)
    "CO2 set point in PPM above the initial value"
    annotation(
      Placement(
        transformation(
          extent={{-160,-130}, {-140,-110}})));
  Modelica.Blocks.Math.Gain norCO2Set(
    k=1/700)
  ...
  Modelica.Blocks.Math.Gain norCO2Mea(
    k=1/700)
  ...
  Buildings.Controls.OBC.CDL.Continuous.AddParameter addFlo(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-50,-130}, {-30,-110}})));
equation
  connect(roo.C_flow[1], gaiCO2.y)
    annotation(
      Line(
        points={{60.4, 6.8}, {36, 6.8}, {36,-30}, {21,-30}},
        color={0, 0, 127}));
  connect(nPer.y, gaiCO2.u)
    annotation(
      Line(
        points={{-59,-10}, {-59,-10}, {-50,-10}, {-50,-30}, {-2,-30}},
        color={0, 0, 127}));
  connect(senCO2.port, roo.ports[3])
    annotation(
      Line(
        points={{80,-60}, {80,-70}, {62,-70}, {62,-6}, {67,-6}},
        color={0, 127, 255}));
  connect(CO2Set.y, norCO2Set.u)
    annotation(
      Line(
        points={{-139,-120}, {-139,-120}, {-122,-120}},
        color={0, 0, 127}));
  connect(senCO2.ppm, norCO2Mea.u)
    annotation(
      Line(
        points={{91,-50}, {92,-50}, {96,-50}, {100,-50}, {100,-170}, {-140,-170}, {-140,-150}, {-122,-150}},
        color={0, 0, 127}));
  connect(norCO2Set.y, conPI.u_s)
    annotation(
      Line(
        points={{-99,-120}, {-82,-120}},
        color={0, 0, 127}));
  connect(norCO2Mea.y, conPI.u_m)
    annotation(
      Line(
        points={{-99,-150}, {-99,-150}, {-70,-150}, {-70,-132}},
        color={0, 0, 127}));
  connect(conPI.y, addFlo.u)
    annotation(
      Line(
        points={{-59,-120}, {-52,-120}},
        color={0, 0, 127}));
  connect(addFlo.y, bou.m_flow_in)
    annotation(
      Line(
        points={{-28,-120}, {-16,-120}, {-16,-112}, {-12,-112}},
        color={0, 0, 127}));
  annotation(
    Documentation(
      info="<html>
...
First implementation.
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/Detailed/Examples/MixedAirCO2.mos"
        "Simulate and plot"),
    experiment(
      StopTime=86400,
      Tolerance=1e-06),
    Diagram(
      ...
      graphics={Rectangle(
        ...
        textString="Feedback control for fresh air"), Text(
        extent={{84,-22}, {140,-42}},
        lineColor={0, 0, 0},
        horizontalAlignment=TextAlignment.Left,
