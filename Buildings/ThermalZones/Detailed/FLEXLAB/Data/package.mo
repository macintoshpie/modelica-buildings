...
package Data
  "Data files commonly used in FLEXLAB models"
  ...
  annotation(
    ...
    test cells. Currently data is only available for wall and
    window constructions. Models for air handling units and
