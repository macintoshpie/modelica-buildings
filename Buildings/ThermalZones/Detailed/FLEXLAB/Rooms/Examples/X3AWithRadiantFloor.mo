...
model X3AWithRadiantFloor
  ...
  Buildings.ThermalZones.Detailed.FLEXLAB.Rooms.X3A.TestCell X3A(nPorts=2, redeclare package Medium=Air, energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
  ...
  Buildings.HeatTransfer.Sources.PrescribedTemperature preT
    ...
    annotation(Placement(transformation(extent={{-10,-10}, {10, 10}}, rotation=90, origin={-94,-170})));
  Modelica.Blocks.Sources.CombiTimeTable TGro(table=[
    0, 288.15;
    86400, 288.15], tableOnFile=false)
    annotation(Placement(transformation(extent={{-10,-10}, {10, 10}}, rotation=90, origin={-94,-198})));
  ...
  Buildings.ThermalZones.Detailed.FLEXLAB.Rooms.X3A.Electrical ele(redeclare package Medium=Air, nPorts=2, energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
    "Model of the electrical room"
    annotation(Placement(transformation(extent={{54,-80}, {94,-40}})));
  Buildings.ThermalZones.Detailed.FLEXLAB.Rooms.X3A.Closet clo(redeclare package Medium=Air, nPorts=2, energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
    "Model of the closet"
    annotation(Placement(transformation(extent={{156, 92}, {196, 132}})));
  Modelica.Blocks.Sources.CombiTimeTable TNei(table=[
    0, 293.15, 293.15;
    86400, 293.15, 293.15], tableOnFile=false)
...
equation
  ...
  connect(sla4A1.surf_b, preT.port)
    annotation(Line(points={{-94,-136}, {-94,-160}}, color={191, 0, 0}, smooth=Smooth.None));
  ...
  connect(watCon4A1.y[1], watIn4A1.m_flow_in)
    annotation(Line(points={{-187,-122}, {-180,-122}, {-180,-118}, {-172,-118}}, color={0, 0, 127}, smooth=Smooth.None));
  ...
  connect(TGro.y[1], preT.T)
    annotation(Line(points={{-94,-187}, {-94,-182}}, color={0, 0, 127}, smooth=Smooth.None));
  ...
  connect(ele.surf_surBou[1], X3A.surf_conBou[5])
    annotation(Line(points={{70.2,-74}, {70,-74}, {70,-88}, {-84,-88}, {-84, 42}}, color={191, 0, 0}, smooth=Smooth.None));
  connect(clo.surf_surBou[1], X3A.surf_conBou[3])
    annotation(Line(points={{172.2, 98}, {172, 98}, {172,-88}, {-84,-88}, {-84, 42}}, color={191, 0, 0}, smooth=Smooth.None));
  ...
  connect(preT2[2].port, clo.surf_conBou[2])
    annotation(Line(points={{54,-114}, {36,-114}, {36,-96}, {182,-96}, {182, 96}}, color={191, 0, 0}, smooth=Smooth.None));
  ...
  connect(preT.port, clo.surf_conBou[3])
    annotation(Line(points={{-94,-160}, {-94,-142}, {182,-142}, {182, 96}}, color={191, 0, 0}, smooth=Smooth.None));
  connect(ele.surf_conBou[1], preT.port)
    annotation(Line(points={{80,-76}, {80,-92}, {-16,-92}, {-16,-142}, {-94,-142}, {-94,-160}}, color={191, 0, 0}, smooth=Smooth.None));
  ...
  connect(sla4A2.surf_a, X3A.surf_surBou[2])
    annotation(Line(points={{-138,-80}, {-138,-48}, {-93.8,-48}, {-93.8, 44}}, color={191, 0, 0}, smooth=Smooth.None));
  connect(preT.port, sla4A2.surf_b)
    annotation(Line(points={{-94,-160}, {-138,-160}, {-138,-100}}, color={191, 0, 0}, smooth=Smooth.None));
  ...
  connect(sla4A3.surf_a, X3A.surf_surBou[3])
    annotation(Line(points={{-178,-42}, {-178,-24}, {-93.8,-24}, {-93.8, 44}}, color={191, 0, 0}, smooth=Smooth.None));
  connect(preT.port, sla4A3.surf_b)
    annotation(Line(points={{-94,-160}, {-138,-160}, {-138,-106}, {-178,-106}, {-178,-62}}, color={191, 0, 0}, smooth=Smooth.None));
  ...
  connect(preT.port, sla4A4.surf_b)
    annotation(Line(points={{-94,-160}, {-138,-160}, {-138,-106}, {-178,-106}, {-178,-72}, {-208,-72}, {-208,-16}}, color={191, 0, 0}, smooth=Smooth.None));
  ...
  annotation(Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-300,-210}, {200, 200}})), Documentation(info="<html>
          <p>
          ...
          </html>"), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/Detailed/FLEXLAB/Rooms/Examples/X3AWithRadiantFloor.mos"
