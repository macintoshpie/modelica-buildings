...
model X3BWithRadiantFloor
  ...
  Buildings.Fluid.Sources.Boundary_pT airOut(
    nPorts=1,
    redeclare package Medium=Air)
    "Air outlet for X3A"
    annotation(
  ...
  Buildings.ThermalZones.Detailed.FLEXLAB.Rooms.X3B.Electrical ele(
    ...
    annotation(
      Placement(
        transformation(
          extent={{54,-80}, {94,-40}})));
  Buildings.ThermalZones.Detailed.FLEXLAB.Rooms.X3B.Closet clo(
    redeclare package Medium=Air,
    nPorts=2,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    datConBou(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-10,-10}, {10, 10}},
          origin={-6,-42})));
  Buildings.Fluid.Sources.Boundary_pT airOutEle(
    nPorts=1,
    redeclare package Medium=Air)
...
equation
  ...
  connect(preT.port, sla4B3.surf_b)
    annotation(
      Line(
        points={{-94,-148}, {-94,-142}, {-138,-142}, {-138,-104}, {-178,-104}, {-178,-62}},
        color={191, 0, 0},
        smooth=Smooth.None));
  connect(preT.port, sla4B4.surf_b)
    annotation(
      Line(
        points={{-94,-148}, {-94,-142}, {-138,-142}, {-138,-104}, {-178,-104}, {-178,-70}, {-208,-70}, {-208,-16}},
        color={191, 0, 0},
        smooth=Smooth.None));
  ...
  annotation(
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/Detailed/FLEXLAB/Rooms/Examples/X3BWithRadiantFloor.mos"
        "Simulate and plot"),
    experiment(
      Tolerance=1e-6,
      StopTime=864000));
