...
model X3WithRadiantFloor
  ...
  Buildings.BoundaryConditions.WeatherData.ReaderTMY3 weaDat(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-240, 260}, {-220, 280}})));
  Modelica.Blocks.Sources.CombiTimeTable intGaiCloB(
    table=[
      0, 0, 0, 0;
      86400, 0, 0, 0],
    tableOnFile=false)
  ...
  Modelica.Blocks.Sources.CombiTimeTable intGaiCloA(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-150, 240}, {-130, 260}})));
  Modelica.Blocks.Sources.CombiTimeTable intGaiEleA(
    table=[
      0, 0, 0, 0;
      86400, 0, 0, 0],
    tableOnFile=false)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-290, 240}, {-270, 260}})));
  Modelica.Blocks.Sources.CombiTimeTable intGaiEleB(
    table=[
      0, 0, 0, 0;
      86400, 0, 0, 0],
    tableOnFile=false)
    ...
    annotation(
      Placement(
        transformation(
          extent={{132, 240}, {152, 260}})));
  Modelica.Blocks.Sources.CombiTimeTable shaPosA(
    table=[
      0, 1;
      86400, 1],
    tableOnFile=false)
  ...
  Modelica.Blocks.Sources.CombiTimeTable shaPosB(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-10, 80}, {10, 100}})));
  Modelica.Blocks.Sources.CombiTimeTable intGaiA(
    table=[
      0, 0, 0, 0;
      86400, 0, 0, 0],
    tableOnFile=false)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-170, 34}, {-150, 54}})));
  Modelica.Blocks.Sources.CombiTimeTable intGaiB(
    table=[
      0, 0, 0, 0;
      86400, 0, 0, 0],
    tableOnFile=false)
  ...
  Buildings.Fluid.Sources.MassFlowSource_T airInA(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-134,-6}, {-114, 14}})));
  Buildings.Fluid.Sources.Boundary_pT airOutA(
    nPorts=1,
    redeclare package Medium=Air)
    "Air outlet for X3A"
    annotation(
  ...
  Buildings.Fluid.Sources.MassFlowSource_T airInB(
    ...
    annotation(
      Placement(
        transformation(
          extent={{26, 18}, {46, 38}})));
  Buildings.Fluid.Sources.Boundary_pT airOutB(
    nPorts=1,
    redeclare package Medium=Air)
    "Air outlet for X3B"
    annotation(
    ...
    annotation(
      Placement(
        transformation(
          ...
          rotation=90,
          origin={0,-290})));
  parameter Buildings.HeatTransfer.Data.OpaqueConstructions.Generic slaCon(
    nLay=3,
  ...
  Buildings.Fluid.HeatExchangers.RadiantSlabs.SingleCircuitSlab sla4A1(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-74,-220}, {-54,-200}})));
  Modelica.Blocks.Sources.CombiTimeTable watCon4A1(
    tableOnFile=false,
    table=[
      0, 0.504, 293.15;
      86400, 0.504, 293.15])
  ...
  Buildings.Fluid.Sources.MassFlowSource_T watIn4A1(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-126,-220}, {-106,-200}})));
  Modelica.Blocks.Sources.CombiTimeTable watCon4A2(
    tableOnFile=false,
    table=[
      0, 0.504, 293.15;
      86400, 0.504, 293.15])
  ...
  Buildings.Fluid.HeatExchangers.RadiantSlabs.SingleCircuitSlab sla4A2(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-126,-184}, {-106,-164}})));
  Buildings.Fluid.Sources.Boundary_pT watOut4A2(
    nPorts=1,
    redeclare package Medium=Water)
    "Water outlet"
    annotation(
      Placement(
        transformation(
          ...
          rotation=180,
          origin={-86,-174})));
  Modelica.Blocks.Sources.CombiTimeTable watCon4A3(
    tableOnFile=false,
    table=[
      0, 0.504, 293.15;
      86400, 0.504, 293.15])
  ...
  Buildings.Fluid.HeatExchangers.RadiantSlabs.SingleCircuitSlab sla4A3(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-166,-146}, {-146,-126}})));
  Buildings.Fluid.Sources.Boundary_pT watOut4A3(
    nPorts=1,
    redeclare package Medium=Water)
    "Water outlet"
    annotation(
      Placement(
        transformation(
          ...
          rotation=180,
          origin={-126,-136})));
  Modelica.Blocks.Sources.CombiTimeTable watCon4A4(
    tableOnFile=false,
    table=[
      0, 0.504, 293.15;
      86400, 0.504, 293.15])
  ...
  Buildings.Fluid.HeatExchangers.RadiantSlabs.SingleCircuitSlab sla4A4(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-196,-100}, {-176,-80}})));
  Buildings.Fluid.Sources.Boundary_pT watOut4A4(
    nPorts=1,
    redeclare package Medium=Water)
    "Water outlet"
    annotation(
      Placement(
        transformation(
          ...
          rotation=180,
          origin={-156,-90})));
  Buildings.Fluid.Sources.Boundary_pT watOut4A1(
    nPorts=1,
    redeclare package Medium=Water)
    "Water outlet"
    annotation(
      Placement(
        transformation(
          ...
          rotation=180,
          origin={-18,-210})));
  Modelica.Blocks.Sources.CombiTimeTable watCon4B1(
    tableOnFile=false,
    table=[
      0, 0.504, 293.15;
      86400, 0.504, 293.15])
    ...
    annotation(
      Placement(
        transformation(
          ...
          rotation=180,
          origin={20,-210})));
  Modelica.Blocks.Sources.CombiTimeTable watCon4B2(
    tableOnFile=false,
    table=[
      0, 0.504, 293.15;
      86400, 0.504, 293.15])
  ...
  Buildings.Fluid.HeatExchangers.RadiantSlabs.SingleCircuitSlab sla4B2(
    ...
    annotation(
      Placement(
        transformation(
          extent={{106,-184}, {86,-164}})));
  Buildings.Fluid.Sources.Boundary_pT watOut4B2(
    nPorts=1,
    redeclare package Medium=Water)
    "Water outlet"
    annotation(
      Placement(
        transformation(
          ...
          rotation=180,
          origin={66,-174})));
  Modelica.Blocks.Sources.CombiTimeTable watCon4B3(
    tableOnFile=false,
    table=[
      0, 0.504, 293.15;
      86400, 0.504, 293.15])
  ...
  Buildings.Fluid.HeatExchangers.RadiantSlabs.SingleCircuitSlab sla4B3(
    ...
    annotation(
      Placement(
        transformation(
          extent={{150,-144}, {130,-124}})));
  Buildings.Fluid.Sources.Boundary_pT watOut4B3(
    nPorts=1,
    redeclare package Medium=Water)
    "Water outlet"
    annotation(
      Placement(
        transformation(
          ...
          rotation=180,
          origin={110,-134})));
  Modelica.Blocks.Sources.CombiTimeTable watCon4B4(
    tableOnFile=false,
    table=[
      0, 0.504, 293.15;
      86400, 0.504, 293.15])
  ...
  Buildings.Fluid.HeatExchangers.RadiantSlabs.SingleCircuitSlab sla4B4(
    ...
    annotation(
      Placement(
        transformation(
          extent={{198,-100}, {178,-80}})));
  Buildings.Fluid.Sources.Boundary_pT watOut4B4(
    nPorts=1,
    redeclare package Medium=Water)
    "Water outlet"
    annotation(
...
equation
  ...
  connect(preT.port, BEle.surf_conBou[1])
    annotation(
      Line(
        points={{1.11022e-15,-244}, {0,-244}, {0, 14}, {-20, 14}, {-20, 114}, {270, 114}, {270, 128}},
        color={191, 0, 0},
        smooth=Smooth.None));
  ...
  connect(preT.port, sla4A4.surf_b)
    annotation(
      Line(
        points={{0,-244}, {0,-230}, {-92,-230}, {-92,-190}, {-152,-190}, {-152,-154}, {-182,-154}, {-182,-100}},
        color={191, 0, 0},
        smooth=Smooth.None));
  ...
  connect(preT.port, sla4B4.surf_b)
    annotation(
      Line(
        points={{0,-244}, {0,-230}, {92,-230}, {92,-192}, {136,-192}, {136,-152}, {154,-152}, {154,-110}, {184,-110}, {184,-100}},
        color={191, 0, 0},
        smooth=Smooth.None));
  ...
  annotation(
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/Detailed/FLEXLAB/Rooms/Examples/X3WithRadiantFloor.mos"
        "Simulate and plot"),
    experiment(
      Tolerance=1e-6,
      StopTime=864000),
