...
package X3B
  ...
  <p align=\"center\">
  <img src=\"modelica://Buildings/Resources/Images/ThermalZones/Detailed/FLEXLAB/Rooms/X3B.png\"border=\"1\" alt=\"Room locations and names in X3AWithRadiantFloor\"/>
  </p>
  <p>
  There are separate models for each room in test cell X3B. The model for the test cell itself is located in
  <a href=\"modelica://Buildings.ThermalZones.Detailed.FLEXLAB.Rooms.X3B.TestCell\">
  Buildings.ThermalZones.Detailed.FLEXLAB.Rooms.X3B.TestCell</a>, the model for the connected closet is located at
  <a href=\"modelica://Buildings.ThermalZones.Detailed.FLEXLAB.Rooms.X3B.Closet\">
  Buildings.ThermalZones.Detailed.FLEXLAB.Rooms.X3B.Closet</a>, and the model for the connected electrical room is located at
  <a href=\"modelica://Buildings.ThermalZones.Detailed.FLEXLAB.Rooms.X3B.Electrical\">
  Buildings.ThermalZones.Detailed.FLEXLAB.Rooms.X3B.Electrical</a>. Each of the models were developed using construction and
