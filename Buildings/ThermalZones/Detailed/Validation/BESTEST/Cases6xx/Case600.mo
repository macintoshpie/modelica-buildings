  ...
  Buildings.Controls.OBC.CDL.Continuous.LimPID conCoo(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-72, 8}, {-64, 16}})));
  Buildings.Controls.OBC.CDL.Continuous.Gain gaiHea(
    k=1E6)
    "Gain for heating"
    annotation(
      Placement(
        transformation(
          extent={{-58, 30}, {-50, 38}})));
  Buildings.Controls.OBC.CDL.Continuous.Gain gaiCoo(
    k=-1E6)
    "Gain for cooling"
    annotation(
      Placement(
        transformation(
          extent={{-58, 8}, {-50, 16}})));
  Modelica.Blocks.Math.Sum sumHeaCoo(
    nin=2)
  ...
  Modelica.Blocks.Continuous.Integrator ECoo(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-20, 6}, {-12, 14}})));
  BaseClasses.DaySchedule TSetHea(
    table=[
      0.0, 273.15 + 20])
    "Heating setpoint"
    annotation(
      Placement(
        transformation(
          extent={{-92, 30}, {-84, 38}})));
  BaseClasses.DaySchedule TSetCoo(
    table=[
      0.0, 273.15 + 27])
    "Cooling setpoint"
    annotation(
      Placement(
        transformation(
          extent={{-92, 8}, {-84, 16}})));
  Controls.OBC.CDL.Continuous.MovingMean PHea(
    delta=3600)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-20, 48}, {-12, 56}})));
  Controls.OBC.CDL.Continuous.MovingMean PCoo(
    delta=3600)
...
equation
  ...
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/Detailed/Validation/BESTEST/Cases6xx/Case600.mos"
        "Simulate and plot"),
    experiment(
      StopTime=3.1536e+07,
      Interval=3600,
