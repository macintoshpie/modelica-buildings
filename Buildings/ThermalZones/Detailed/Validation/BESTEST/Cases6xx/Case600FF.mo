  ...
  Modelica.Thermal.HeatTransfer.Sensors.TemperatureSensor TRooAir
    ...
    annotation(
      Placement(
        transformation(
          extent={{-86,-28}, {-78,-20}})));
  replaceable parameter Buildings.ThermalZones.Detailed.Validation.BESTEST.Data.StandardResultsFreeFloating staRes(
    minT(
      Min=-18.8 + 273.15,
      Max=-15.6 + 273.15,
      Mean=-17.6 + 273.15),
    ...
    meanT(
      Min=24.2 + 273.15,
      Max=25.9 + 273.15,
      Mean=25.1 + 273.15)) constrainedby Modelica.Icons.Record
  ...
  Modelica.Blocks.Math.MultiSum multiSum(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-78,-80}, {-66,-68}})));
  Controls.OBC.CDL.Continuous.MovingMean TRooHou(
    delta=3600)
    ...
    annotation(
      Placement(
        transformation(
          extent={{-68,-28}, {-60,-20}})));
  Controls.OBC.CDL.Continuous.MovingMean TRooAnn(
    delta=86400*365)
...
equation
  ...
  connect(souInf.ports[1], roo.ports[3])
    annotation(
      Line(
        points={{-12,-28}, {14,-28}, {14,-20.5}, {39.75,-20.5}},
        color={0, 127, 255}));
  annotation(
    experiment(
      Tolerance=1e-06,
      StopTime=3.1536e+07),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/Detailed/Validation/BESTEST/Cases6xx/Case600FF.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
