...
model Case610
  ...
  extends Buildings.ThermalZones.Detailed.Validation.BESTEST.Cases6xx.Case600(roo(datConExtWin(ove(wR={0.5}, wL={0.5}, dep={1}, gap={0.5}))), staRes(annualHea(Min=4.355*3.6e9, Max=5.786*3.6e9, Mean=5.146*3.6e9), annualCoo(Min=-3.915*3.6e9, Max=-5.778*3.6e9, Mean=-4.964*3.6e9), peakHea(Min=3.437*1000, Max=4.354*1000, Mean=3.998*1000), peakCoo(Min=-5.689*1000, Max=-6.371*1000, Mean=-5.988*1000)));
  annotation(__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/Detailed/Validation/BESTEST/Cases6xx/Case610.mos"
    "Simulate and plot"), experiment(StopTime=3.1536e+07, Interval=3600, Tolerance=1e-06), Documentation(info="<html>
<p>
