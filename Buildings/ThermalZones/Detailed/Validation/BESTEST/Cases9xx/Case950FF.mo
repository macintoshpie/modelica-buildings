...
model Case950FF
  ...
  extends Case900FF(staRes(minT(Min=-20.2 + 273.15, Max=-18.6 + 273.15, Mean=-19.6 + 273.15), maxT(Min=35.5 + 273.15, Max=38.5 + 273.15, Mean=36.5 + 273.15), meanT(Min=14.0 + 273.15, Max=15.0 + 273.15, Mean=14.4 + 273.15)), multiSum(nu=2));
...
equation
  connect(multiSum.u[2], vent.y[1])
    annotation(Line(points={{-72,-44}, {-76,-44}, {-76,-64}, {-79.6,-64}}, color={0, 0, 127}, smooth=Smooth.None));
  annotation(experiment(Tolerance=1e-06, StopTime=3.1536e+07), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/Detailed/Validation/BESTEST/Cases9xx/Case950FF.mos"
