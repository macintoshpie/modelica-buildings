...
record StandardResultsFreeFloating
  "ASHRAE Standard Results"
  extends Modelica.Icons.Record;
  parameter ResultSummary minT(Min(unit="K"), Max(unit="K"), Mean(unit="K"))
    "Minimum temperature";
  parameter ResultSummary maxT(Min(unit="K"), Max(unit="K"), Mean(unit="K"))
    "Maximum temperature";
  parameter ResultSummary meanT(Min(unit="K"), Max(unit="K"), Mean(unit="K"))
    "Mean temperature";
