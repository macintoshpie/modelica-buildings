...
model SingleZoneFloor
  ...
  parameter Buildings.HeatTransfer.Data.Solids.Plywood matFur(
    x=0.15,
    nStaRef=5)
  ...
  Buildings.ThermalZones.Detailed.MixedAir flo(
    ...
    datConExtWin(
      ...
      wWin={winWalRat/hWin*49.91*hRoo, winWalRat/hWin*49.91*hRoo, winWalRat/hWin*33.27*hRoo, winWalRat/hWin*33.27*hRoo},
      each hWin=hWin,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus
    ...
    annotation(
      Placement(
        transformation(
          extent={{-174, 78}, {-158, 94}}),
        iconTransformation(
          extent={{-140, 162}, {-124, 178}})));
...
equation
  ...
  connect(leaSou.port_b, flo.ports[1])
    annotation(
      Line(
        points={{-86, 152}, {-44, 152}, {-44,-49.4286}, {-11,-49.4286}},
        color={0, 127, 255}));
  connect(leaEas.port_b, flo.ports[2])
    annotation(
      Line(
        points={{-86, 112}, {-44, 112}, {-44,-37.3333}, {-11,-37.3333}, {-11,-48.2857}},
        color={0, 127, 255}));
  connect(leaNor.port_b, flo.ports[3])
    annotation(
      Line(
        points={{-86, 70}, {-44, 70}, {-44,-40}, {-11,-40}, {-11,-47.1429}},
        color={0, 127, 255}));
  connect(leaWes.port_b, flo.ports[4])
    annotation(
      Line(
        points={{-86, 30}, {-44, 30}, {-44,-46}, {-11,-46}},
        color={0, 127, 255}));
  connect(senRelPre.port_a, flo.ports[5])
    annotation(
      Line(
        points={{-60,-6}, {-44,-6}, {-44,-44}, {-11,-44}, {-11,-44.8571}},
        color={0, 127, 255}));
  ...
  connect(senRelPre.p_rel, p_rel)
    annotation(
      Line(
        points={{-70,-15}, {-70,-60}, {210,-60}},
        color={0, 0, 127}));
  connect(intGaiFra.y, gai.u)
    annotation(
      Line(
        points={{-139,-140}, {-122,-140}},
        color={0, 0, 127}));
  connect(gai.y, flo.qGai_flow)
    annotation(
      Line(
        points={{-99,-140}, {-26,-140}, {-26,-28}, {-17.6,-28}},
        color={0, 0, 127}));
  ...
  connect(replicator.y, flo.uSha)
    annotation(
      Line(
        points={{-99,-90}, {-30,-90}, {-30,-18}, {-17.6,-18}},
        color={0, 0, 127}));
  connect(ports[1], flo.ports[6])
    annotation(
      Line(
        points={{-200, 0}, {-188, 0}, {-188,-50}, {-11,-50}, {-11,-43.7143}},
        color={0, 127, 255}));
  connect(ports[2], flo.ports[7])
    annotation(
      Line(
        points={{-180, 0}, {-192, 0}, {-192,-42.5714}, {-11,-42.5714}},
        color={0, 127, 255}));
  annotation(
    Diagram(
      coordinateSystem(
