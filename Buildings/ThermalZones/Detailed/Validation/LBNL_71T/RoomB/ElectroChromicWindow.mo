...
model ElectroChromicWindow
  ...
  MixedAir roo(
    ...
    datConBou(
      ...
      til={Buildings.Types.Tilt.Floor, Buildings.Types.Tilt.Ceiling, Buildings.Types.Tilt.Wall, Buildings.Types.Tilt.Wall, Buildings.Types.Tilt.Wall}),
    AFlo=13.94,
    hRoo=3.37,
  ...
  parameter HeatTransfer.Data.GlazingSystems.DoubleElectrochromicAir13Clear glaSys(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-48, 106}, {-28, 126}})));
  BoundaryConditions.WeatherData.Bus weaBus
    annotation(
      Placement(
        transformation(
          extent={{130, 10}, {154, 34}}),
        iconTransformation(
          extent={{-116, 36}, {-96, 56}})));
  ...
  Modelica.Blocks.Sources.Constant qLatGai_flow(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-96,-66}, {-76,-46}})));
  Modelica.Blocks.Sources.Constant uWin(
    k=1)
  ...
  Modelica.Blocks.Sources.CombiTimeTable refRes(
    ...
    fileName=Modelica.Utilities.Files.loadResource("modelica://Buildings/Resources/Data/ThermalZones/Detailed/Validation/LBNL_71T/RoomB/EnergyPlusHeatingCoolingPower.txt"),
    columns=2 : 2)
  ...
  Controls.Continuous.LimPID conHea(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-40,-100}, {-20,-80}})));
  Modelica.Blocks.Math.Gain gaiHea(
    k=1E4)
    "Gain for heating"
    annotation(
      Placement(
...
equation
  ...
  connect(qRadGai_flow.y, multiplex3_1.u1[1])
    annotation(
      Line(
        points={{-73, 26}, {-68, 26}, {-68,-9}, {-58,-9}},
        color={0, 0, 127}));
  connect(qConGai_flow.y, multiplex3_1.u2[1])
    annotation(
      Line(
        points={{-75,-16}, {-66.5,-16}, {-58,-16}},
        color={0, 0, 127}));
  connect(qLatGai_flow.y, multiplex3_1.u3[1])
    annotation(
      Line(
        points={{-75,-56}, {-72,-56}, {-72,-26}, {-58,-26}, {-58,-23}},
        color={0, 0, 127}));
  connect(multiplex3_1.y, roo.qGai_flow)
    annotation(
      Line(
        points={{-35,-16}, {-35,-16}, {38,-16}, {38, 12}, {60.4, 12}},
        color={0, 0, 127}));
  connect(uWin.y, roo.uWin[1])
    annotation(
      Line(
        points={{11, 16}, {34, 16}, {34, 17}, {60.4, 17}},
        color={0, 0, 127}));
  connect(preHea.port, roo.heaPorAir)
    annotation(
      Line(
        points={{60,-90}, {72,-90}, {72,-58}, {72, 4}, {81, 4}},
        color={191, 0, 0}));
  ...
  connect(TRooSet.y, conHea.u_s)
    annotation(
      Line(
        points={{-59,-90}, {-50,-90}, {-42,-90}},
        color={0, 0, 127}));
  connect(preHea.port, TRooAir.port)
    annotation(
      Line(
        points={{60,-90}, {80,-90}, {80,-90}},
        color={191, 0, 0}));
  connect(TRooAir.T, conHea.u_m)
    annotation(
      Line(
        points={{100,-90}, {110,-90}, {110,-112}, {-30,-112}, {-30,-102}},
        color={0, 0, 127}));
  annotation(
    Diagram(
      coordinateSystem(
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/Detailed/Validation/LBNL_71T/RoomB/ElectroChromicWindow.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
