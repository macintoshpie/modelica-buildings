...
equation
  connect(zer.y, weaDat.HDifHor_in)
    annotation(Line(points={{-78, 40}, {-66, 40}, {-66, 40.5}, {-61, 40.5}}, color={0, 0, 127}));
  connect(zer.y, weaDat.HGloHor_in)
    annotation(Line(points={{-78, 40}, {-70, 40}, {-70, 37}, {-61, 37}}, color={0, 0, 127}));
  annotation(experiment(StopTime=31536000, Tolerance=1e-06), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/Detailed/Validation/MixedAirFreeResponseSteadyState.mos"
    "Simulate and plot"), Diagram(coordinateSystem(extent={{-120,-100}, {200, 200}})), Icon(coordinateSystem(extent={{-100,-100}, {100, 100}})), Documentation(info="<html>
<p>
