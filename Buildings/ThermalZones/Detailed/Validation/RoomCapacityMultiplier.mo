...
model RoomCapacityMultiplier
  ...
  Modelica.Blocks.Sources.Constant qConGai_flow(k=1)
...
equation
  ...
  connect(weaDat.weaBus, roo1.weaBus)
    annotation(Line(points={{180, 150}, {188, 150}, {188, 61.9}, {101.9, 61.9}}, color={255, 204, 51}, thickness=0.5, smooth=Smooth.None));
  connect(roo2.qGai_flow, multiplex3_1.y)
    annotation(Line(points={{62.4,-8}, {20,-8}, {20, 50}, {1, 50}}, color={0, 0, 127}));
  connect(roo1.qGai_flow, multiplex3_1.y)
    annotation(Line(points={{62.4, 52}, {32, 52}, {32, 50}, {1, 50}}, color={0, 0, 127}));
  connect(roo2.weaBus, weaDat.weaBus)
    annotation(Line(points={{101.9, 1.9}, {188, 1.9}, {188, 150}, {180, 150}}, color={255, 204, 51}, thickness=0.5));
  annotation(Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-100,-100}, {200, 200}})), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/Detailed/Validation/RoomCapacityMultiplier.mos"
...
</html>"), experiment(Tolerance=1e-06, StopTime=86400));
