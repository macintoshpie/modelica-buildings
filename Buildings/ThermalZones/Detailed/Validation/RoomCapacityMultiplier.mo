...
equation
  ...
  connect(roo2.qGai_flow, multiplex3_1.y)
    annotation(
      Line(
        points={{62.4,-8}, {20,-8}, {20, 50}, {1, 50}},
        color={0, 0, 127}));
  connect(roo1.qGai_flow, multiplex3_1.y)
    annotation(
      Line(
        points={{62.4, 52}, {32, 52}, {32, 50}, {1, 50}},
        color={0, 0, 127}));
  ...
  annotation(
    ...
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/Detailed/Validation/RoomCapacityMultiplier.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
