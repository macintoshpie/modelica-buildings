...
model OnlyConstructionBoundary
  ...
  Buildings.HeatTransfer.Sources.FixedTemperature TBou1[nConBou](
    each T=288.15)
...
equation
  ...
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/Detailed/Validation/TestConditionalConstructions/OnlyConstructionBoundary.mos"
        "Simulate and plot"),
    Diagram(
      coordinateSystem(
