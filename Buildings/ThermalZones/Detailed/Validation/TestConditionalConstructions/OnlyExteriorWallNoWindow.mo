...
model OnlyExteriorWallNoWindow
  ...
  extends BaseClasses.PartialTestModel(nConExt=1, nConExtWin=0, nConPar=0, nConBou=0, nSurBou=0, roo(datConExt(layers={matLayExt}, each A=10, each til=Buildings.Types.Tilt.Floor, each azi=Buildings.Types.Azimuth.W)));
