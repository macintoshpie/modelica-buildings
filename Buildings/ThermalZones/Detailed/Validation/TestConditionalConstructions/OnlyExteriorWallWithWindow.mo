...
model OnlyExteriorWallWithWindow
  ...
  extends BaseClasses.PartialTestModel(nConExt=0, nConExtWin=2, nConPar=0, nConBou=0, nSurBou=0, roo(datConExtWin(layers={matLayExt, matLayExt}, each A=10, glaSys={glaSys, glaSys}, each wWin=2, each hWin=2, each fFra=0.1, til={Buildings.Types.Tilt.Floor, Buildings.Types.Tilt.Ceiling}, each azi=Buildings.Types.Azimuth.W)));
