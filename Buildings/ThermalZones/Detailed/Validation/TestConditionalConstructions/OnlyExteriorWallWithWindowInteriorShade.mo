...
equation
  ...
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/Detailed/Validation/TestConditionalConstructions/OnlyExteriorWallWithWindowInteriorShade.mos"
        "Simulate and plot"),
    Diagram(
      coordinateSystem(
