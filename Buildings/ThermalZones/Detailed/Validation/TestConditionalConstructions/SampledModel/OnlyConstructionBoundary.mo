...
model OnlyConstructionBoundary
  ...
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/Detailed/Validation/TestConditionalConstructions/SampledModel/OnlyConstructionBoundary.mos"
        "Simulate and plot"),
    Diagram(
      coordinateSystem(
