...
model OnlyExteriorWallWithWindowExteriorShade
  ...
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/Detailed/Validation/TestConditionalConstructions/SampledModel/OnlyExteriorWallWithWindowExteriorShade.mos"
        "Simulate and plot"),
    Diagram(
      coordinateSystem(
