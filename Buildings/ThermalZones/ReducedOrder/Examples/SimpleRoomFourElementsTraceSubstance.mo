...
model SimpleRoomFourElementsTraceSubstance
  ...
  extends Buildings.ThermalZones.ReducedOrder.Examples.SimpleRoomFourElements(
...
equation
  connect(traSub.y, thermalZoneFourElements.C_flow[1])
    annotation(
      Line(
        points={{-67,-48}, {0,-48}, {0, 26}, {43, 26}},
        color={0, 0, 127}));
  connect(souAir.ports[1], thermalZoneFourElements.ports[1])
    annotation(
      Line(
        points={{-20,-70}, {2,-70}, {2,-24}, {44,-24}, {44,-4}, {84,-4}, {84,-1.95}, {83,-1.95}},
        color={0, 127, 255}));
  connect(sinAir.ports[1], thermalZoneFourElements.ports[2])
    annotation(
      Line(
        points={{-18,-90}, {4,-90}, {4,-26}, {46,-26}, {46,-4}, {86,-4}, {86,-1.95}, {83,-1.95}},
        color={0, 127, 255}));
...
First implementation.
    ...
    experiment(
      ...
      StopTime=604800),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/ReducedOrder/Examples/SimpleRoomFourElementsTraceSubstance.mos"
        "Simulate and plot"),
    Diagram(
      coordinateSystem(
