...
equation
  ...
  connect(HDifTil.HSkyDifTil, corGDouPan.HSkyDifTil)
    annotation(
      Line(
        points={{-47, 36}, {-28, 36}, {-6, 36}, {-6, 66}, {4, 66}},
        color={0, 0, 127}));
  connect(HDirTil.H, corGDouPan.HDirTil)
    annotation(
      Line(
        points={{-47, 62}, {-10, 62}, {-10, 70}, {4, 70}},
        color={0, 0, 127}));
  ...
  connect(corGDouPan.solarRadWinTrans, thermalZoneThreeElements.solRad)
    annotation(
      Line(
        points={{27, 64}, {40, 64}, {40, 31}, {43, 31}},
        color={0, 0, 127}));
  annotation(
    Documentation(
      info="<html>
  ...
  Implemented.
    ...
    experiment(
      ...
      Interval=3600),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/ReducedOrder/Examples/SimpleRoomThreeElements.mos"
        "Simulate and plot"));
