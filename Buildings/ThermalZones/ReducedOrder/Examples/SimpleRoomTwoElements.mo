...
model SimpleRoomTwoElements
  ...
  BoundaryConditions.SolarIrradiation.DirectTiltedSurface HDirTil[2](
    each til(
      displayUnit="deg")=1.5707963267949,
    each lat=0.87266462599716,
    azi={3.1415926535898, 4.7123889803847})
...
equation
  ...
  connect(corGDouPan.solarRadWinTrans, thermalZoneTwoElements.solRad)
    annotation(
      Line(
        points={{27, 64}, {34, 64}, {40, 64}, {40, 31}, {43, 31}},
        color={0, 0, 127}));
  annotation(
    Documentation(
      info="<html>
 ...
 Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow</a>
  ...
  Implemented.
    ...
    experiment(
      ...
      Interval=3600),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/ReducedOrder/Examples/SimpleRoomTwoElements.mos"
        "Simulate and plot"));
