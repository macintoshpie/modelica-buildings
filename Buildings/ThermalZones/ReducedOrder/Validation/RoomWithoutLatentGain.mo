...
model RoomWithoutLatentGain
  ...
  extends VDI6007.TestCase12(
    ...
    assEqu(
      ...
      startTime3=0,
      endTime3=0));
  Modelica.Blocks.Sources.Constant QLat_flow(
    k=0)
...
This is for <a href=\"https://github.com/ibpsa/modelica-ibpsa/issues/1209\">Buildings, issue 1209</a>.
    ...
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/ReducedOrder/Validation/RoomWithoutLatentGain.mos"
        "Simulate and plot"),
    Diagram(
      coordinateSystem(
