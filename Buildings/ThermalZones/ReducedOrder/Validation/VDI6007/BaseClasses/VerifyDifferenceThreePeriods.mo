...
block VerifyDifferenceThreePeriods
  ...
  extends Buildings.Utilities.Diagnostics.BaseClasses.PartialInputCheck(message="Inputs differ by more than threShold.\n  Check output 'satisfied' for when violation(s) happened.");
  ...
  Modelica.Blocks.Interfaces.RealOutput diff
    "Difference u1-u2"
    annotation(Placement(transformation(extent={{100, 42}, {140, 82}}), iconTransformation(extent={{100, 42}, {140, 82}})));
protected
...
equation
  ...
  annotation(defaultComponentName="verDif", Documentation(info="<html>
<p>
