...
equation
  ...
  connect(intGai.y[1], macConv.Q_flow)
    annotation(
      Line(
        points={{22.8,-50}, {36,-50}, {36,-74}, {48,-74}},
        color={0, 0, 127}));
  connect(thermalZoneTwoElements.intGainsConv, macConv.port)
    annotation(
      Line(
        points={{92, 20}, {96, 20}, {96,-74}, {68,-74}},
        color={191, 0, 0}));
  ...
  Implemented.
    ...
    experiment(
      ...
      Interval=60),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/ReducedOrder/Validation/VDI6007/TestCase1.mos"
        "Simulate and plot"));
end TestCase1;
