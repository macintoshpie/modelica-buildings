...
model TestCase10
  ...
  RC.TwoElements thermalZoneTwoElements(redeclare final package Medium=Modelica.Media.Air.SimpleAir, gWin=1, nExt=1, hRad=5, nInt=1, RWin=0.00000001, ratioWinConRad=0.09, AInt=58, hConWin=2.7, VAir=0, nOrientations=1, AWin={0}, ATransparent={7}, AExt={28}, RExtRem=0.011638548, RExt={0.00171957697767797}, CExt={4338751.41}, RInt={0.000779671554640369}, CInt={12333949.4129606}, intWallRC(thermCapInt(each T(fixed=true))), extWallRC(thermCapExt(each T(fixed=true))), hConInt=2.398, T_start=290.75, hConExt=2.4)
  ...
  EquivalentAirTemperature.VDI6007 eqAirTemp(aExt=0.7, hConWallOut=20, hRad=5, withLongwave=false, n=1, wfWall={0.04646093176283288}, wfWin={0.32441554918476245}, wfGro=0.6291235190524047, TGro=288.15)
  ...
  Modelica.Blocks.Sources.Constant sunblind(k=0)
    ...
    annotation(Placement(transformation(extent={{-3,-3}, {3, 3}}, rotation=-90, origin={-15, 23})));
  ...
  Modelica.Blocks.Sources.Constant hConWall(k=28*9.75)
    ...
    annotation(Placement(transformation(extent={{-4,-4}, {4, 4}}, rotation=90, origin={28,-19})));
...
equation
  ...
  connect(const.y, eqAirTemp.TBlaSky)
    annotation(Line(points={{-49.7, 7}, {-28.85, 7}, {-28.85, 5}, {-26, 5}}, color={0, 0, 127}));
  connect(eqAirTemp.TEqAir, preTem.T)
    annotation(Line(points={{-3, 5}, {0.9, 5}, {0.9, 0}, {6.8, 0}}, color={0, 0, 127}));
  connect(HSol.y, eqAirTemp.HSol[1])
    annotation(Line(points={{-77.7, 25}, {-32, 25}, {-32, 10.4}, {-26, 10.4}}, color={0, 0, 127}));
  connect(sunblind.y, eqAirTemp.sunblind[1])
    annotation(Line(points={{-15, 19.7}, {-15, 15.85}, {-14, 15.85}, {-14, 15.8}}, color={0, 0, 127}));
  ...
  connect(product1.y, thermalZoneTwoElements.solRad[1])
    annotation(Line(points={{4.5, 70}, {14, 70}, {28, 70}, {28, 31}, {43, 31}}, color={0, 0, 127}));
  ...
  </html>"), experiment(Tolerance=1e-6, StopTime=5.184e+006, Interval=60), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/ReducedOrder/Validation/VDI6007/TestCase10.mos"
    "Simulate and plot"));
end TestCase10;
