...
model TestCase11
  ...
  RC.TwoElements thermalZoneTwoElements(hConExt=2.7, hConWin=2.7, gWin=1, nExt=1, nInt=1, ratioWinConRad=0, AInt=75.5, RWin=0.00000001, hRad=5, RExt={0.00436791293674}, RExtRem=0.03895919557, CExt={1600848.94}, RInt={0.000595693407511}, CInt={14836354.6282}, hConInt=3, indoorPortIntWalls=true, VAir=0, nOrientations=1, redeclare final package Medium=Modelica.Media.Air.SimpleAir, AWin={0}, ATransparent={0}, AExt={10.5}, extWallRC(thermCapExt(each der_T(fixed=true))), T_start=295.15, intWallRC(thermCapInt(each der_T(fixed=true))))
    "Thermal zone"
    annotation(Placement(transformation(extent={{44,-2}, {92, 34}})));
  Buildings.HeatTransfer.Sources.FixedTemperature preTem(T=295.15)
    "Outdoor air temperature"
    annotation(Placement(transformation(extent={{8,-6}, {20, 6}})));
  Modelica.Thermal.HeatTransfer.Components.Convection theConWall(dT(start=0))
  ...
  Modelica.Blocks.Sources.CombiTimeTable reference(tableOnFile=false, extrapolation=Modelica.Blocks.Types.Extrapolation.HoldLastPoint, smoothness=Modelica.Blocks.Types.Smoothness.ConstantSegments, columns={2, 3, 4}, table=[
    0, 22, 0, 0;
    3600, 22, 0, 0;
    7200, 22, 0, 0;
    10800, 22, 0, 0;
    ...
    860400, 26.5,-500,-500;
    864000, 26.4,-500,-500;
    5101200, 26.2,-500,-500;
    5104800, 26.1,-500,-500;
    5108400, 26,-500,-500;
    5112000, 25.8,-500,-500;
    5115600, 25.7,-500,-500;
    5119200, 25.6,-500, 126;
    5122800, 27, 126, 76;
    5126400, 27, 76, 28;
    5130000, 27, 28, 100;
    5133600, 27,-122,-391;
    5137200, 27,-391,-500;
    5140800, 27,-500,-500;
    5144400, 27.1,-500,-500;
    5148000, 27.2,-500,-500;
    5151600, 27.3,-500,-500;
    5155200, 27.4,-500,-500;
    5158800, 27.5,-500,-500;
    5162400, 27.6,-500,-500;
    5166000, 27,-500,-500;
    5169600, 26.9,-500,-500;
    5173200, 26.7,-500,-500;
    5176800, 26.6,-500,-500;
    5180400, 26.5,-500,-500;
    5184000, 26.4,-500,-500])
    "Reference results"
  ...
  Modelica.Blocks.Sources.CombiTimeTable setTemp(extrapolation=Modelica.Blocks.Types.Extrapolation.Periodic, columns={2}, smoothness=Modelica.Blocks.Types.Smoothness.LinearSegments, table=[
    0, 22;
    3600, 22;
    7200, 22;
    10800, 22;
  ...
  Controls.Continuous.LimPID conHeaCoo(yMin=-1, Td=5, controllerType=Modelica.Blocks.Types.SimpleController.PI, yMax=1, k=0.1, Ti=1.2)
  ...
  Modelica.Blocks.Logical.Hysteresis hysteresis(uLow=-0.0000001, uHigh=0.0000001, y(start=true))
    "Threshold for switching between heating and cooling"
    annotation(Placement(transformation(extent={{-5,-5}, {5, 5}}, origin={-67, 51})));
  ...
  BaseClasses.VerifyDifferenceThreePeriods assEqu(endTime=86400, endTime2=864000, endTime3=5184000, threShold=1.5, startTime=3600, startTime2=781200, startTime3=5101200)
...
equation
  ...
  connect(intGai.y[1], machinesRad.Q_flow)
    annotation(Line(points={{22.8,-88}, {22.8,-88}, {48,-88}}, color={0, 0, 127}));
  connect(machinesRad.port, thermalZoneTwoElements.intGainsRad)
    annotation(Line(points={{68,-88}, {68,-88}, {96,-88}, {96, 24}, {92, 24}}, color={191, 0, 0}));
  ...
  connect(setTemp.y[1], from_degC.u)
    annotation(Line(points={{-79.2, 24}, {-75.2, 24}}, color={0, 0, 127}));
  ...
  connect(switchHea.y, gainHea.u)
    annotation(Line(points={{-33.5,-34}, {-33.5,-34}, {-17.2,-34}}, color={0, 0, 127}));
  connect(DefPow.y, switchHea.u3)
    annotation(Line(points={{-81.6, 0}, {-81.6, 0}, {-56, 0}, {-56,-38}, {-45,-38}}, color={0, 0, 127}));
  connect(from_degC.y, conHeaCoo.u_s)
    annotation(Line(points={{-61.4, 24}, {-51.6, 24}}, color={0, 0, 127}));
  connect(switchCoo.y, gainCoo.u)
    annotation(Line(points={{-35.5, 86}, {-26.75, 86}, {-17.2, 86}}, color={0, 0, 127}));
  connect(hysteresis.y, switchCoo.u2)
    annotation(Line(points={{-61.5, 51}, {-54, 51}, {-54, 86}, {-47, 86}}, color={255, 0, 255}));
  connect(DefPow.y, switchCoo.u1)
    annotation(Line(points={{-81.6, 0}, {-76, 0}, {-76, 14}, {-98, 14}, {-98, 90}, {-47, 90}}, color={0, 0, 127}));
  connect(hysteresis.y, switchHea.u2)
    annotation(Line(points={{-61.5, 51}, {-54, 51}, {-54,-34}, {-45,-34}}, color={255, 0, 255}));
  connect(conHeaCoo.y, switchHea.u1)
    annotation(Line(points={{-33.2, 24}, {-24, 24}, {-24,-24}, {-50,-24}, {-50,-30}, {-45,-30}}, color={0, 0, 127}));
  connect(thermalZoneTwoElements.TAir, conHeaCoo.u_m)
    annotation(Line(points={{93, 32}, {96, 32}, {96, 44}, {-20, 44}, {-20, 8}, {-42, 8}, {-42, 14.4}}, color={0, 0, 127}));
  ...
  connect(cool.port, coolFlowSensor.port_a)
    annotation(Line(points={{22, 86}, {26, 86}, {26, 70}, {20, 70}}, color={191, 0, 0}));
  connect(coolFlowSensor.port_b, thermalZoneTwoElements.intWallIndoorSurface)
    annotation(Line(points={{8, 70}, {4, 70}, {4,-24}, {44,-24}, {44,-6}, {56,-6}, {56,-2}}, color={191, 0, 0}));
  connect(coolFlowSensor.Q_flow, add.u1)
    annotation(Line(points={{14, 64}, {14, 62}, {14, 62}, {14, 60}, {30, 60}, {30, 76}, {38, 76}}, color={0, 0, 127}));
  connect(heatFlowSensor.Q_flow, add.u2)
    annotation(Line(points={{82,-40}, {82,-58}, {0,-58}, {0, 52}, {32, 52}, {32, 64}, {38, 64}}, color={0, 0, 127}));
  connect(hysteresis.u, switchHea.u1)
    annotation(Line(points={{-73, 51}, {-76, 51}, {-76, 40}, {-24, 40}, {-24,-24}, {-50,-24}, {-50,-30}, {-45,-30}}, color={0, 0, 127}));
  connect(conHeaCoo.y, switchCoo.u3)
    annotation(Line(points={{-33.2, 24}, {-24, 24}, {-24, 68}, {-52, 68}, {-52, 82}, {-47, 82}}, color={0, 0, 127}));
  connect(add.y, switchMea.u3)
    annotation(Line(points={{61, 70}, {69, 70}, {69, 73}, {69, 110}, {126, 110}, {126, 121.1}, {138, 121.1}}, color={0, 0, 127}));
  connect(reference.y[3], switchMea.u1)
    annotation(Line(points={{101, 90}, {130, 90}, {130, 108}, {130, 137.9}, {138, 137.9}}, color={0, 0, 127}));
  ...
  connect(thr.y, switchMea.u2)
    annotation(Line(points={{121, 130}, {130, 130}, {134, 130}, {136, 130}, {136, 129.5}, {138, 129.5}}, color={255, 0, 255}));
  connect(cha.u, hysteresis.y)
    annotation(Line(points={{-22, 130}, {-54, 130}, {-54, 51}, {-61.5, 51}}, color={255, 0, 255}));
  connect(switchMea.y, mean.u)
    annotation(Line(points={{161, 129.5}, {170, 129.5}, {170, 100}, {140, 100}, {140, 80}, {148, 80}}, color={0, 0, 127}));
  connect(reference.y[2], assEqu.u2)
    annotation(Line(points={{101, 90}, {114, 90}, {120, 90}, {120, 64}, {198, 64}}, color={0, 0, 127}));
  connect(mean.y, assEqu.u1)
    annotation(Line(points={{171, 80}, {180, 80}, {180, 76}, {198, 76}}, color={0, 0, 127}));
  annotation(Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100}, {240, 160}})), Documentation(info="<html>
  ...
  </html>"), experiment(Tolerance=1e-6, StopTime=5.184e+006, Interval=60), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/ReducedOrder/Validation/VDI6007/TestCase11.mos"
    "Simulate and plot"));
end TestCase11;
