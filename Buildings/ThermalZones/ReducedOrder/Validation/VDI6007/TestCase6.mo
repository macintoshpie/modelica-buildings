...
equation
  ...
  connect(heatFlowSensor.Q_flow, mean.u)
    annotation(
      Line(
        points={{84,-40}, {84,-54}, {-6,-54}, {-6, 51}, {61, 51}},
        color={0, 0, 127}));
  annotation(
    Documentation(
      info="<html>
  ...
  Implemented.
    ...
    experiment(
      ...
      Interval=60),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/ReducedOrder/Validation/VDI6007/TestCase6.mos"
        "Simulate and plot"));
end TestCase6;
