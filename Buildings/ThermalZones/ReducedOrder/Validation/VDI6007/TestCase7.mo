...
model TestCase7
  ...
  RC.TwoElements thermalZoneTwoElements(redeclare package Medium=Modelica.Media.Air.SimpleAir, hConExt=2.7, hConWin=2.7, gWin=1, nExt=1, nInt=1, ratioWinConRad=0, AInt=75.5, hConInt=2.24, RWin=0.00000001, hRad=5, RExt={0.00436791293674}, RExtRem=0.03895919557, CExt={1600848.94}, RInt={0.000595693407511}, CInt={14836354.6282}, VAir=0, nOrientations=1, AWin={0}, ATransparent={0}, AExt={10.5}, extWallRC(thermCapExt(each der_T(fixed=true))), intWallRC(thermCapInt(each der_T(fixed=true))), T_start=295.15)
    "Thermal zone"
  ...
  Controls.Continuous.LimPID conHeaCoo(controllerType=Modelica.Blocks.Types.SimpleController.PI, yMax=1, yMin=-1, k=0.1, Ti=4)
  ...
  BaseClasses.VerifyDifferenceThreePeriods assEqu(startTime=3600, endTime=86400, startTime2=781200, endTime2=864000, startTime3=5101200, endTime3=5184000, threShold=1.5)
...
equation
  ...
  connect(machinesRad.port, thermalZoneTwoElements.intGainsRad)
    annotation(Line(points={{68,-88}, {84,-88}, {98,-88}, {98, 24}, {92, 24}}, color={191, 0, 0}));
  ...
  connect(thermalZoneTwoElements.TAir, conHeaCoo.u_m)
    annotation(Line(points={{93, 32}, {100, 32}, {100,-54}, {-10,-54}, {-10,-45.6}}, color={0, 0, 127}));
  connect(conHeaCoo.y, gainHeaCoo.u)
    annotation(Line(points={{-1.2,-36}, {6.8,-36}}, color={0, 0, 127}));
  connect(gainHeaCoo.y, heaCoo.Q_flow)
    annotation(Line(points={{20.6,-36}, {44,-36}}, color={0, 0, 127}));
  connect(setTemp.y[1], from_degC.u)
    annotation(Line(points={{-51.2,-36}, {-39.2,-36}}, color={0, 0, 127}));
  ...
  connect(gainMea.u, heatFlowSensor.Q_flow)
    annotation(Line(points={{43, 51}, {-74, 51}, {-74,-68}, {78,-68}, {78,-42}}, color={0, 0, 127}));
  ...
  </html>"), experiment(Tolerance=1e-6, StopTime=5.184e+006, Interval=60), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/ReducedOrder/Validation/VDI6007/TestCase7.mos"
    "Simulate and plot"));
end TestCase7;
