  ...
  Controls.Continuous.LimPID conHeaCoo(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-18,-44}, {-2,-28}})));
  Modelica.Blocks.Math.Gain gainHeaCoo(
    k=500)
  ...
  Modelica.Thermal.HeatTransfer.Sensors.HeatFlowSensor heatFlowSensor
    ...
    annotation(
      Placement(
        transformation(
          extent={{84,-42}, {72,-30}})));
  Modelica.Blocks.Math.Gain gainMea(
    k=-1)
    "Gain for mean block"
    annotation(
      Placement(
...
equation
  ...
  connect(heatFlowSensor.port_a, thermalZoneTwoElements.intGainsConv)
    annotation(
      Line(
        points={{84,-36}, {96,-36}, {96, 20}, {92, 20}},
        color={191, 0, 0}));
  connect(mean.u, gainMea.y)
    annotation(
      Line(
        points={{61, 51}, {54.5, 51}},
        color={0, 0, 127}));
  connect(gainMea.u, heatFlowSensor.Q_flow)
    annotation(
      Line(
        points={{43, 51}, {-74, 51}, {-74,-68}, {78,-68}, {78,-42}},
        color={0, 0, 127}));
  annotation(
    Documentation(
      info="<html>
  ...
  Implemented.
    ...
    experiment(
      ...
      Interval=60),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/ReducedOrder/Validation/VDI6007/TestCase7.mos"
        "Simulate and plot"));
end TestCase7;
