...
equation
  ...
  connect(outdoorTemp1.y[1], eqAirTemp.TDryBul)
    annotation(
      Line(
        points={{-75.2,-12}, {-28,-12}, {-28,-12.4}},
        color={0, 0, 127}));
  connect(const.y, eqAirTemp.TBlaSky)
    annotation(
      Line(
        points={{-51.7,-5}, {-30.85,-5}, {-30.85,-7}, {-28,-7}},
        color={0, 0, 127}));
  ...
  Implemented.
    ...
    experiment(
      ...
      Interval=60),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/ThermalZones/ReducedOrder/Validation/VDI6007/TestCase8.mos"
        "Simulate and plot"));
end TestCase8;
