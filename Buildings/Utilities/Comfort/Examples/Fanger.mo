  ...
  Buildings.Utilities.Comfort.Fanger theCom(
    ...
    annotation(
      Placement(
        transformation(
          extent={{70,-40}, {90,-20}})));
  Modelica.Blocks.Sources.Constant ICl(
    k=0.9)
    "Clothing insulation"
    annotation(
      Placement(
  ...
  Modelica.Blocks.Sources.Constant vAir(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-80,-56}, {-60,-36}})));
  Modelica.Blocks.Sources.Constant M(
    k=60)
  ...
  Modelica.Blocks.Sources.Ramp TAir(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-80, 50}, {-60, 70}})));
  Modelica.Blocks.Sources.Constant TRad(
    k=273.15 + 22)
  ...
  Modelica.Blocks.Sources.Constant pAtm(
    ...
    annotation(
      Placement(
        transformation(
          extent={{0, 68}, {20, 88}})));
  Modelica.Blocks.Sources.Constant phi(
    k=0.5)
    "Relative humidity"
    annotation(
      Placement(
...
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/Comfort/Examples/Fanger.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
