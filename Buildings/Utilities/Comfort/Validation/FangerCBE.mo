...
model FangerCBE
  ...
  Buildings.Utilities.Comfort.Fanger com(use_vAir_in=true, use_M_in=true, use_ICl_in=true, use_pAir_in=false, M=58, ICl=0.6)
    "Thermal comfort model"
    annotation(Placement(transformation(extent={{-10,-10}, {10, 10}})));
  Modelica.Blocks.Sources.CombiTimeTable inp(table=[
    ...
    2100, 297.15, 0.1, 0.5, 58, 1], smoothness=Modelica.Blocks.Types.Smoothness.ConstantSegments)
  ...
  Modelica.Blocks.Sources.CombiTimeTable PMVRef(table=[
    0,-1.91;
    100,-1.20;
    200,-0.52;
    300, 0.17;
    ...
    1900,-0.12;
    2000, 0.20;
    2100, 0.20], smoothness=Modelica.Blocks.Types.Smoothness.ConstantSegments)
...
equation
  ...
  connect(inp.y[1], com.TAir)
    annotation(Line(points={{-59, 50}, {-28, 50}, {-28, 10}, {-11, 10}}, color={0, 0, 127}));
  connect(inp.y[1], com.TRad)
    annotation(Line(points={{-59, 50}, {-26, 50}, {-26, 6}, {-11, 6}}, color={0, 0, 127}));
  connect(inp.y[2], com.vAir_in)
    annotation(Line(points={{-59, 50}, {-28, 50}, {-28,-1}, {-11,-1}}, color={0, 0, 127}));
  connect(inp.y[3], com.phi)
    annotation(Line(points={{-59, 50}, {-28, 50}, {-28, 2}, {-11, 2}}, color={0, 0, 127}));
  connect(inp.y[4], com.M_in)
    annotation(Line(points={{-59, 50}, {-28, 50}, {-28,-4}, {-11,-4}}, color={0, 0, 127}));
  connect(inp.y[5], com.ICl_in)
    annotation(Line(points={{-59, 50}, {-28, 50}, {-28,-7}, {-11,-7}}, color={0, 0, 127}));
  annotation(experiment(StopTime=2300, Tolerance=1e-06), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/Comfort/Validation/FangerCBE.mos"
