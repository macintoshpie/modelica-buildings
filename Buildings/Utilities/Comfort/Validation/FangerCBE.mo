...
equation
  ...
  connect(inp.y[1], com.TAir)
    annotation(
      Line(
        points={{-59, 50}, {-28, 50}, {-28, 10}, {-11, 10}},
        color={0, 0, 127}));
  connect(inp.y[1], com.TRad)
    annotation(
      Line(
        points={{-59, 50}, {-26, 50}, {-26, 6}, {-11, 6}},
        color={0, 0, 127}));
  connect(inp.y[2], com.vAir_in)
    annotation(
      Line(
        points={{-59, 50}, {-28, 50}, {-28,-1}, {-11,-1}},
        color={0, 0, 127}));
  connect(inp.y[3], com.phi)
    annotation(
      Line(
        points={{-59, 50}, {-28, 50}, {-28, 2}, {-11, 2}},
        color={0, 0, 127}));
  connect(inp.y[4], com.M_in)
    annotation(
      Line(
        points={{-59, 50}, {-28, 50}, {-28,-4}, {-11,-4}},
        color={0, 0, 127}));
  connect(inp.y[5], com.ICl_in)
    annotation(
      Line(
        points={{-59, 50}, {-28, 50}, {-28,-7}, {-11,-7}},
        color={0, 0, 127}));
  annotation(
    experiment(
      StopTime=2300,
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/Comfort/Validation/FangerCBE.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
