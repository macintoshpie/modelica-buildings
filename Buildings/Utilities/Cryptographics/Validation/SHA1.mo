...
model SHA1
  ...
  parameter String strIn5=Modelica.Utilities.Strings.repeat(509, string="a")
    "Fifth test string";
  //Expected outputs
  parameter String strEx1="a9993e364706816aba3e25717850c26c9cd0d89d"
    "Encryption result of first string";
  parameter String strEx2="da39a3ee5e6b4b0d3255bfef95601890afd80709"
    "Encryption result of second string";
  parameter String strEx3="84983e441c3bd26ebaae4aa1f95129e5e54670f1"
    "Encryption result of third string";
  parameter String strEx4="bdd220adb45b392f17915af70ed8a006c382b983"
    "Encryption result of fourth string";
  parameter String strEx5="edff7a135c2e06d4c8084e61b4516c901bd5fcd0"
...
equation
  ...
  annotation(experiment(Tolerance=1e-6, StopTime=1.0), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/Cryptographics/Validation/SHA1.mos"
