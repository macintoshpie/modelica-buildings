...
model SHA1
  ...
  parameter String strIn4="1.23e+4"
    "Fourth test string";
  parameter String strIn5=Modelica.Utilities.Strings.repeat(509,
    string="a")
    "Fifth test string";
  //Expected outputs
...
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/Cryptographics/Validation/SHA1.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
