...
equation
  ...
  annotation(defaultComponentName="cheEqu", Documentation(info="<html>
<p>
...
</html>"), Icon(graphics={Text(extent={{-84, 108}, {90,-28}}, lineColor={255, 0, 0}, textString="u1 = u2"), Text(extent={{-62,-38}, {54,-68}}, lineColor={0, 0, 255}, textString="%threShold")}));
end CheckEquality;
