...
equation
  connect(con.y, cheEqu.u1)
    annotation(
      Line(
        points={{-39, 40}, {-20, 40}, {-20, 26}, {18, 26}},
        color={0, 0, 127}));
  connect(add.u1, con.y)
    annotation(
      Line(
        points={{-22, 16}, {-30, 16}, {-30, 40}, {-39, 40}},
        color={0, 0, 127}));
  connect(sin1.y, add.u2)
    annotation(
      Line(
        points={{-39, 0}, {-30, 0}, {-30, 4}, {-22, 4}},
        color={0, 0, 127}));
  connect(add.y, cheEqu.u2)
    annotation(
      Line(
        points={{1, 10}, {10, 10}, {10, 14}, {18, 14}},
        color={0, 0, 127}));
  annotation(
    __Dymola_Commands(
      file="Resources/Scripts/Dymola/Utilities/Diagnostics/Validation/CheckEquality.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
