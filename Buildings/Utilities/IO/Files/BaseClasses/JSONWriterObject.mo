...
class JSONWriterObject
  ...
  function constructor
    ...
    input String instanceName
      "Instance name of the file write";
    input String fileName
      "Name of the file, including extension";
    input Boolean dumpAtDestruction
      "=true, to write cached values at destruction";
    input String[:] varKeys
      "Keys for values that are written to file";
    output JSONWriterObject jsonWriter
      "Pointer to the file writer";
  external "C" jsonWriter=jsonWriterInit(
    instanceName, fileName, dumpAtDestruction, size(varKeys, 1), varKeys)
    annotation(Include="#include <jsonWriterInit.c>", IncludeDirectory="modelica://Buildings/Resources/C-Sources");
...
c
  ...
  function destructor
    ...
    input JSONWriterObject jsonWriter
      "Pointer to file writer object";
  external "C" jsonWriterFree(
    jsonWriter)
    annotation(Include=" #include <jsonWriterFree.c>", IncludeDirectory="modelica://Buildings/Resources/C-Sources");
    annotation(Documentation(info="<html>
<p>
