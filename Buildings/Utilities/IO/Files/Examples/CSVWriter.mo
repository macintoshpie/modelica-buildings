...
equation
  ...
  connect(csvWriter.u[1], cos.y)
    annotation(
      Line(
        points={{-20,-29}, {-32,-29}, {-32, 30}, {-59, 30}},
        color={0, 0, 127}));
  connect(csvWriter.u[2], step.y)
    annotation(
      Line(
        points={{-20,-31}, {-40,-31}, {-40,-30}, {-59,-30}},
        color={0, 0, 127}));
  annotation(
    experiment(
      StartTime=-1.21,
...
This model demonstrates the use of the csv file writer.
    ...
    __Dymola_Commands(
      file="Resources/Scripts/Dymola/Utilities/IO/Files/Examples/CSVWriter.mos"
        "Simulate and plot"));
end CSVWriter;
