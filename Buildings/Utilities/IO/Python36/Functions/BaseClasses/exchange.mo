within Buildings.Utilities.IO.Python36.Functions.BaseClasses;
function exchange
...
external "C" pythonExchangeValues(
  ...
  annotation(Library={"ModelicaBuildingsPython3.6", "python3.6m"}, LibraryDirectory="modelica://Buildings/Resources/Library", IncludeDirectory="modelica://Buildings/Resources/C-Sources", Include="#include \"pythonWrapper.c\"", __iti_dll="ITI_ModelicaBuildingsPython3.6.dll", __iti_dllNoExport=true);
