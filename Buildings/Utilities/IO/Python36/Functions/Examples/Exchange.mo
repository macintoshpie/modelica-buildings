...
algorithm
  ...
  yR2 := Buildings.Utilities.IO.Python36.Functions.exchange(
    moduleName="testFunctions",
    functionName="r1_r2",
    pytObj=m[3].pytObj,
    passPythonObject=passPythonObject,
  ...
  (yR1, yI1) := Buildings.Utilities.IO.Python36.Functions.exchange(
    moduleName="testFunctions",
    functionName="i1_i1",
    pytObj=m[4].pytObj,
    passPythonObject=passPythonObject,
  ...
  (yR1, yI2) := Buildings.Utilities.IO.Python36.Functions.exchange(
    moduleName="testFunctions",
    functionName="i1_i2",
    pytObj=m[5].pytObj,
    passPythonObject=passPythonObject,
  ...
  (yR2, yI1) := Buildings.Utilities.IO.Python36.Functions.exchange(
    moduleName="testFunctions",
  ...
  annotation(
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/IO/Python36/Functions/Examples/Exchange.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
