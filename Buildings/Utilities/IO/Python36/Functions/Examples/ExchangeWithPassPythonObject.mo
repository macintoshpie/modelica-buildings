...
model ExchangeWithPassPythonObject
  ...
  Real yR2[1]
    "Real function value";
equation
  yR1=Buildings.Utilities.IO.Python36.Functions.exchange(moduleName="testFunctions", functionName="r1_r1PassPythonObject", dblWri={2.0}, intWri={0}, nDblWri=1, nDblRea=1, nIntWri=0, nIntRea=0, nStrWri=0, strWri={""}, pytObj=pytObj, passPythonObject=passPythonObject);
  ...
  yR2=Buildings.Utilities.IO.Python36.Functions.exchange(moduleName="testFunctions", functionName="r1_r1PassPythonObject", dblWri=yR1, intWri={0}, nDblWri=1, nDblRea=1, nIntWri=0, nIntRea=0, nStrWri=0, strWri={""}, pytObj=pytObj, passPythonObject=passPythonObject);
  assert(abs(16-yR2[1]) < 1e-5, "Error in function r1_r1PassPythonObject");
  annotation(experiment(Tolerance=1e-6, StopTime=1.0), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/IO/Python36/Functions/Examples/ExchangeWithPassPythonObject.mos"
