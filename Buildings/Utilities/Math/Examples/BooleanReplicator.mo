...
model BooleanReplicator
  ...
  Buildings.Utilities.Math.BooleanReplicator booRep(nout=4)
    "Replicates boolean values"
    annotation(Placement(transformation(extent={{0, 0}, {20, 20}})));
equation
  connect(booTab.y, booRep.u)
    annotation(Line(points={{-19, 10}, {-2, 10}}, color={255, 0, 255}));
  annotation(experiment(Tolerance=1e-6, StopTime=600), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/Math/Examples/BooleanReplicator.mos"
