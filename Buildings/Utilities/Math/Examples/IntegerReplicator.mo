...
model IntegerReplicator
  ...
  Modelica.Blocks.Sources.IntegerTable intTab(table=[
    0, 1;
    1, 4;
    1.5, 5;
    2, 6])
...
equation
  ...
  annotation(experiment(Tolerance=1e-6, StopTime=2), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/Math/Examples/IntegerReplicator.mos"
