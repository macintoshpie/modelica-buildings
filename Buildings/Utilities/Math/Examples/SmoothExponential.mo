  ...
  Modelica.Blocks.Sources.Ramp x1(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-60,-10}, {-40, 10}})));
  Buildings.Utilities.Math.SmoothExponential smoothExponential(
    delta=0.1)
    annotation(
      Placement(
        transformation(
...
equation
  ...
  annotation(
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/Math/Examples/SmoothExponential.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
