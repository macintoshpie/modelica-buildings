...
block FallingFactorial
  ...
  Modelica.Blocks.Interfaces.IntegerInput k
    "Falling factorial power"
    annotation(Placement(transformation(extent={{-140,-80}, {-100,-40}})));
equation
  y=Buildings.Utilities.Math.Functions.fallingFactorial(n=n, k=k);
  annotation(defaultComponentName="falFac", Icon(graphics={Text(extent={{-90, 38}, {90,-34}}, lineColor={160, 160, 164}, textString="fallingFactorial()")}), Documentation(info="<html>
