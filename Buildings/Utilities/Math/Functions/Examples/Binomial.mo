...
equation
  ...
  annotation(__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/Binomial.mos"
    "Simulate and plot"), experiment(Tolerance=1e-6, StopTime=15.9), Documentation(info="<html>
<p>
