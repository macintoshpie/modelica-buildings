...
equation
  ...
  annotation(__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/Factorial.mos"
    "Simulate and plot"), experiment(Tolerance=1e-6, StopTime=12.9), Documentation(info="<html>
<p>
