...
equation
  ...
  annotation(__Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/FallingFactorial.mos"
    "Simulate and plot"), experiment(Tolerance=1e-6, StopTime=13.9), Documentation(info="<html>
<p>
