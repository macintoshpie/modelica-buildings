...
equation
  x=time^3*gain;
  y=Buildings.Utilities.Math.Functions.regNonZeroPower(x=x, n=n, delta=delta);
  der_y=der(y);
  ...
  annotation(experiment(StartTime=-1, StopTime=1.0, Tolerance=1E-8), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/RegNonZeroPowerDerivative_2_Check.mos"
