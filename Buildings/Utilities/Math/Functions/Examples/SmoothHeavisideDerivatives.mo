...
model SmoothHeavisideDerivatives
  ...
  Real y=Buildings.Utilities.Math.Functions.smoothHeaviside(x=time, delta=0.2)
    "Function value";
  Real der_y=der(y)
    "First derivative";
  Real der2_y=der(der_y)
    "Second derivative";
equation
  annotation(experiment(Tolerance=1e-6, StartTime=-1, StopTime=1.0), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/SmoothHeavisideDerivatives.mos"
