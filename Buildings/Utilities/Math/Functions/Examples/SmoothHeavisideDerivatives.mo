...
model SmoothHeavisideDerivatives
  ...
  Real y=Buildings.Utilities.Math.Functions.smoothHeaviside(
    x=time,
    delta=0.2)
    "Function value";
  Real der_y=der(y)
...
equation
  annotation(
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/SmoothHeavisideDerivatives.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
