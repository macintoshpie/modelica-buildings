...
algorithm
  y := Buildings.Utilities.Math.Functions.trapezoidalIntegration(
    N=7,
    f=y1,
    deltaX=1);
  ...
  annotation(
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/TrapezoidalIntegration.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
