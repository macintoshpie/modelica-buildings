...
algorithm
  ...
  assert(y-286.0 < 1E-4, "Error. Function should have returned 286.");
  annotation(experiment(Tolerance=1e-6, StopTime=1.0), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/Math/Functions/Examples/TrapezoidalIntegration.mos"
