...
protected
  ...
  constant Real R[6]={-2957821389.0, 7062834065.0,-512359803.6, 10879881.29,-86327.92757, 228.5622733};
  constant Real S[6]={40076544269.0, 745249964.8, 7189466.438, 47447.26470, 226.1030244, 1.0};
  Real ax=abs(x);
  Real xx;
  Real y;
  Real z;
