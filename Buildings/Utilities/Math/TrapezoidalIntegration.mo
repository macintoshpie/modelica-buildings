...
model TrapezoidalIntegration
  ...
  parameter Integer N
    "Number of integrand points";
  parameter Real deltaX
    "Width of interval for Trapezoidal integration";
equation
  y=Buildings.Utilities.Math.Functions.trapezoidalIntegration(N=N, f=u, deltaX=deltaX);
  annotation(Icon(graphics={Text(extent={{-90, 36}, {90,-36}}, lineColor={160, 160, 164}, textString="trapezoidalIntegration()")}), Documentation(info="<html>
