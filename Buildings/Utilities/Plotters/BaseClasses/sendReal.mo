...
function sendReal
  ...
  input Buildings.Utilities.Plotters.BaseClasses.Backend plt
    "Plot object";
  input Real[:] x
    "Array of Real values to be sent to printer";
external "C" plotSendReal(
  plt, x)
  annotation(Include="#include <plotSendReal.c>", IncludeDirectory="modelica://Buildings/Resources/C-Sources");
