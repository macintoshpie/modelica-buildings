...
model Configuration
  ...
  parameter Buildings.Utilities.Plotters.Types.GlobalActivation activation=Buildings.Utilities.Plotters.Types.GlobalActivation.always
  ...
  Modelica.Blocks.Interfaces.BooleanInput activate if(activation == Buildings.Utilities.Plotters.Types.GlobalActivation.use_input)
...
equation
  ...
  annotation(defaultComponentName="plotConfiguration", defaultComponentPrefixes="inner", missingInnerMessage="
...
to specify system properties.", Icon(coordinateSystem(preserveAspectRatio=false), graphics={Rectangle(extent={{-100, 100}, {100,-100}}, lineColor={0, 0, 255}, fillColor={255, 254, 238}, fillPattern=FillPattern.Solid), Polygon(lineColor={192, 192, 192}, fillColor={192, 192, 192}, fillPattern=FillPattern.Solid, points={{-80.0, 90.0}, {-88.0, 68.0}, {-72.0, 68.0}, {-80.0, 90.0}}), Line(points={{-80.0, 78.0}, {-80.0,-90.0}}, color={192, 192, 192}), Polygon(lineColor={192, 192, 192}, fillColor={192, 192, 192}, fillPattern=FillPattern.Solid, points={{90.0,-80.0}, {68.0,-72.0}, {68.0,-88.0}, {90.0,-80.0}}), Line(points={{-90.0,-80.0}, {82.0,-80.0}}, color={192, 192, 192}), Line(origin={-1.939,-1.816}, points={{81.939, 36.056}, {65.362, 36.056}, {14.39,-26.199}, {-29.966, 113.485}, {-65.374,-61.217}, {-78.061,-78.184}}, color={0, 0, 127}, smooth=Smooth.Bezier), Text(extent={{-42,-44}, {34,-74}}, lineColor={0, 0, 0}, textString="delay=%activationDelay"), Ellipse(extent={{-95, 67}, {-81, 53}}, lineColor=DynamicSelect({235, 235, 235}, if activate > 0.5 then {0, 255, 0} else {235, 235, 235}), fillColor=DynamicSelect({235, 235, 235}, if activate > 0.5 then {0, 255, 0} else {235, 235, 235}), fillPattern=FillPattern.Solid, visible=activation == Buildings.Utilities.Plotters.Types.GlobalActivation.use_input)}), Diagram(coordinateSystem(preserveAspectRatio=false)), Documentation(info="<html>
<p>
