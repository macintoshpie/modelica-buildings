...
model CoolingCoilValve
  ...
  parameter Real TOutCooCut(final unit="F", final quantity="ThermodynamicTemperature")=283.15
    "Lower outdoor air temperature limit for enabling cooling";
  parameter Real TSup(final unit="F", final quantity="ThermodynamicTemperature")=293.15
    "Supply air temperature";
  parameter Real TSupSet(final unit="F", final quantity="ThermodynamicTemperature")=289.15
    "Supply air temperature setpoint";
  parameter Real TSetMinLowLim(final unit="F", final quantity="ThermodynamicTemperature")=278.71
    "Minimum supply air temperature for defining the upper limit of the valve position";
  parameter Real TSetMaxLowLim(final unit="F", final quantity="ThermodynamicTemperature")=283.15
    "Maximum supply air temperature for defining the upper limit of the valve position";
  parameter Real LowTSupSet(final unit="F", final quantity="ThermodynamicTemperature")=280.37
    "Supply air temeprature setpoint to check the limiter functionality";
  parameter Real fanFee(final unit="1")=0.60
    "Fan feedback";
  Buildings.Utilities.Plotters.Examples.BaseClasses.CoolingCoilValve cooVal(final reverseAction=true, final alc_int_k=1/100)
    "Cooling valve control sequence"
    annotation(Placement(transformation(extent={{-40, 80}, {-20, 100}})));
  Buildings.Utilities.Plotters.Examples.BaseClasses.CoolingCoilValve cooVal1(final reverseAction=true, final alc_int_k=1/100)
    "Cooling valve control sequence"
    annotation(Placement(transformation(extent={{-40,-40}, {-20,-20}})));
  Buildings.Utilities.Plotters.Examples.BaseClasses.CoolingCoilValve cooVal2(final reverseAction=true, final alc_int_k=1/100)
    "Cooling valve control sequence"
    annotation(Placement(transformation(extent={{140, 78}, {160, 98}})));
  Buildings.Utilities.Plotters.Examples.BaseClasses.CoolingCoilValve cooVal3(final reverseAction=true, final alc_int_k=1/100)
    "Cooling valve control sequence"
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.Pulse uSupFan(final period=900)
    "Supply fan status"
    annotation(Placement(transformation(extent={{-80, 10}, {-60, 30}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant uFanFee(final k=fanFee)
    "Supply fan feedback"
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.Constant uSupFan1(final k=true)
    "Supply fan status"
    annotation(Placement(transformation(extent={{-80,-110}, {-60,-90}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant uFanFee1(final k=fanFee)
    "Supply fan feedback"
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.Constant uSupFan2(final k=true)
    "Supply fan status"
    annotation(Placement(transformation(extent={{100, 10}, {120, 30}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant uFanFee2(final k=fanFee)
    "Supply fan feedback"
    annotation(Placement(transformation(extent={{100, 40}, {120, 60}})));
  // Tests controler operation when supply air temperature is within limiter values
  Buildings.Controls.OBC.CDL.Continuous.Sources.Ramp uTSup2(final duration=1800, final height=4, final offset=TSupSet-2, final startTime=0)
    "\"Supply air temperature\""
  ...
  Buildings.Controls.OBC.CDL.Logical.Sources.Constant uSupFan3(final k=true)
    "Supply fan status"
    annotation(Placement(transformation(extent={{100,-110}, {120,-90}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Ramp uTSup3(final duration=1800, final startTime=0, final height=TSetMaxLowLim-TSetMinLowLim, final offset=TSetMinLowLim)
    "Supply air temperature source"
    annotation(Placement(transformation(extent={{20,-40}, {40,-20}})));
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant uFanFee3(final k=fanFee)
    "Supply fan feedback"
...
equation
  ...
  connect(uTSupSet.y, cooVal.TSupSet)
    annotation(Line(points={{-139, 50}, {-130, 50}, {-130, 80}, {-84, 80}, {-84, 80}, {-84, 80}, {-84, 94}, {-41, 94}}, color={0, 0, 127}));
  connect(uTOutAboveCutoff.y, cooVal.TOut)
    annotation(Line(points={{-99, 50}, {-82, 50}, {-82, 92}, {-82, 92}, {-82, 92}, {-82, 93}, {-41, 93}, {-41, 90}}, color={0, 0, 127}));
  ...
  connect(uTSupSet1.y, cooVal1.TSupSet)
    annotation(Line(points={{-139,-70}, {-132,-70}, {-132,-32}, {-116,-32}, {-116,-26}, {-41,-26}}, color={0, 0, 127}));
  ...
  connect(uTSupSet3.y, cooVal3.TSupSet)
    annotation(Line(points={{41,-70}, {46,-70}, {46,-34}, {64,-34}, {64,-28}, {139,-28}}, color={0, 0, 127}));
  ...
  connect(uSupFan3.y, cooVal3.uFanSta)
    annotation(Line(points={{121,-100}, {128,-100}, {128,-100}, {134,-100}, {134,-40}, {139,-40}}, color={255, 0, 255}));
  annotation(experiment(StopTime=1800.0, Tolerance=1e-06), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/Plotters/Examples/BaseClasses/Validation/CoolingCoilValve.mos"
    "Simulate and plot"), Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-180,-120}, {180, 120}}), graphics={Rectangle(extent={{-176, 116}, {-14, 4}}, lineColor={217, 217, 217}, fillColor={217, 217, 217}, fillPattern=FillPattern.Solid), Text(extent={{-158, 18}, {-102, 6}}, lineColor={0, 0, 127}, textString="Supply fan signal"), Rectangle(extent={{-176,-4}, {-14,-116}}, lineColor={217, 217, 217}, fillColor={217, 217, 217}, fillPattern=FillPattern.Solid), Text(extent={{-160,-102}, {-96,-114}}, lineColor={0, 0, 127}, textString="TOut is above cuttoff - disable control"), Rectangle(extent={{14, 116}, {176, 4}}, lineColor={217, 217, 217}, fillColor={217, 217, 217}, fillPattern=FillPattern.Solid), Text(extent={{22, 22}, {116, 2}}, lineColor={0, 0, 127}, horizontalAlignment=TextAlignment.Left, textString="Normal operation above 
the upper limit TSup range."), Rectangle(extent={{14,-4}, {176,-116}}, lineColor={217, 217, 217}, fillColor={217, 217, 217}, fillPattern=FillPattern.Solid), Text(extent={{22,-98}, {116,-118}}, lineColor={0, 0, 127}, horizontalAlignment=TextAlignment.Left, textString="Operation within the 
          upper limit TSup range.")}), Documentation(info="<html>
<p>
