...
equation
  connect(uTSup.y, cooVal.TSup)
    annotation(
      Line(
        points={{-139, 90}, {-90, 90}, {-90, 98}, {-41, 98}},
        color={0, 0, 127}));
  connect(uTSupSet.y, cooVal.TSupSet)
    annotation(
      Line(
        points={{-139, 50}, {-130, 50}, {-130, 80}, {-84, 80}, {-84, 80}, {-84, 80}, {-84, 94}, {-41, 94}},
        color={0, 0, 127}));
  connect(uTOutAboveCutoff.y, cooVal.TOut)
    annotation(
      Line(
        points={{-99, 50}, {-82, 50}, {-82, 92}, {-82, 92}, {-82, 92}, {-82, 93}, {-41, 93}, {-41, 90}},
        color={0, 0, 127}));
  connect(uFanFee.y, cooVal.uFanFee)
    annotation(
      Line(
        points={{-59, 50}, {-50, 50}, {-50, 86}, {-41, 86}},
        color={0, 0, 127}));
  connect(cooVal.uFanSta, uSupFan.y)
    annotation(
      Line(
        points={{-41, 82}, {-46, 82}, {-46, 20}, {-59, 20}},
        color={255, 0, 255}));
  connect(uTSup2.y, cooVal2.TSup)
    annotation(
      Line(
        points={{41, 90}, {74, 90}, {74, 96}, {139, 96}},
        color={0, 0, 127}));
  connect(uTSupSet2.y, cooVal2.TSupSet)
    annotation(
      Line(
        points={{41, 50}, {50, 50}, {50, 82}, {82, 82}, {82, 92}, {139, 92}},
        color={0, 0, 127}));
  connect(uTOutAboveCutoff2.y, cooVal2.TOut)
    annotation(
      Line(
        points={{81, 50}, {90, 50}, {90, 88}, {139, 88}},
        color={0, 0, 127}));
  connect(uFanFee2.y, cooVal2.uFanFee)
    annotation(
      Line(
        points={{121, 50}, {130, 50}, {130, 84}, {139, 84}},
        color={0, 0, 127}));
  connect(uSupFan2.y, cooVal2.uFanSta)
    annotation(
      Line(
        points={{121, 20}, {134, 20}, {134, 80}, {139, 80}},
        color={255, 0, 255}));
  connect(uTSup1.y, cooVal1.TSup)
    annotation(
      Line(
        points={{-139,-28}, {-124,-28}, {-124,-22}, {-41,-22}},
        color={0, 0, 127}));
  connect(uTSupSet1.y, cooVal1.TSupSet)
    annotation(
      Line(
        points={{-139,-70}, {-132,-70}, {-132,-32}, {-116,-32}, {-116,-26}, {-41,-26}},
        color={0, 0, 127}));
  connect(uTOutBelowCutoff.y, cooVal1.TOut)
    annotation(
      Line(
        points={{-99,-70}, {-94,-70}, {-94,-30}, {-41,-30}},
        color={0, 0, 127}));
  connect(uFanFee1.y, cooVal1.uFanFee)
    annotation(
      Line(
        points={{-59,-70}, {-54,-70}, {-54,-34}, {-41,-34}},
        color={0, 0, 127}));
  connect(uSupFan1.y, cooVal1.uFanSta)
    annotation(
      Line(
        points={{-59,-100}, {-50,-100}, {-50,-38}, {-41,-38}},
        color={255, 0, 255}));
  connect(uTSup3.y, cooVal3.TSup)
    annotation(
      Line(
        points={{41,-30}, {56,-30}, {56,-24}, {139,-24}},
        color={0, 0, 127}));
  connect(uTSupSet3.y, cooVal3.TSupSet)
    annotation(
      Line(
        points={{41,-70}, {46,-70}, {46,-34}, {64,-34}, {64,-28}, {139,-28}},
        color={0, 0, 127}));
  connect(uTOutAboveCutoff1.y, cooVal3.TOut)
    annotation(
      Line(
        points={{81,-70}, {90,-70}, {90,-32}, {139,-32}},
        color={0, 0, 127}));
  connect(uFanFee3.y, cooVal3.uFanFee)
    annotation(
      Line(
        points={{121,-70}, {130,-70}, {130,-36}, {139,-36}},
        color={0, 0, 127}));
  connect(uSupFan3.y, cooVal3.uFanSta)
    annotation(
      Line(
        points={{121,-100}, {128,-100}, {128,-100}, {134,-100}, {134,-40}, {139,-40}},
        color={255, 0, 255}));
  annotation(
    experiment(
      StopTime=1800.0,
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/Plotters/Examples/BaseClasses/Validation/CoolingCoilValve.mos"
        "Simulate and plot"),
    Diagram(
      coordinateSystem(
      ...
      graphics={Rectangle(
        ...
        extent={{-158, 18}, {-102, 6}},
        lineColor={0, 0, 127},
        textString="Supply fan signal"), Rectangle(
        extent={{-176,-4}, {-14,-116}},
        lineColor={217, 217, 217},
        fillColor={217, 217, 217},
        fillPattern=FillPattern.Solid), Text(
        ...
        lineColor={0, 0, 127},
        textString="TOut is above cuttoff - disable control"), Rectangle(
        extent={{14, 116}, {176, 4}},
        lineColor={217, 217, 217},
        fillColor={217, 217, 217},
        fillPattern=FillPattern.Solid), Text(
...
the upper limit TSup range."), Rectangle(
        extent={{14,-4}, {176,-116}},
        lineColor={217, 217, 217},
        fillColor={217, 217, 217},
        fillPattern=FillPattern.Solid), Text(
