...
model ControlsVerification_CoolingCoilValve
  ...
  Modelica.Blocks.Sources.CombiTimeTable TOut_F(
    ...
    columns={3},
    fileName=Modelica.Utilities.Files.loadResource("modelica://Buildings/Resources/Data/Utilities/Plotters/Examples/ControlsVerification_CoolingCoilValve/OA_Temp.mos"))
    "Measured outdoor air temperature"
    annotation(
      Placement(
        transformation(
          extent={{-140,-30}, {-120,-10}})));
  Modelica.Blocks.Sources.CombiTimeTable TSupSetpoint_F(
    ...
    columns={3},
    fileName=Modelica.Utilities.Files.loadResource("modelica://Buildings/Resources/Data/Utilities/Plotters/Examples/ControlsVerification_CoolingCoilValve/SA_Clg_Stpt.mos"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable coolingValveSignal(
    ...
    columns={3},
    smoothness=Modelica.Blocks.Types.Smoothness.LinearSegments,
    fileName=Modelica.Utilities.Files.loadResource("modelica://Buildings/Resources/Data/Utilities/Plotters/Examples/ControlsVerification_CoolingCoilValve/Clg_Coil_Valve.mos"))
  ...
  Modelica.Blocks.Sources.CombiTimeTable fanFeedback(
    ...
    columns={3},
    smoothness=Modelica.Blocks.Types.Smoothness.LinearSegments,
    fileName=Modelica.Utilities.Files.loadResource("modelica://Buildings/Resources/Data/Utilities/Plotters/Examples/ControlsVerification_CoolingCoilValve/VFD_Fan_Feedback.mos"))
    "Fan feedback"
    annotation(
      Placement(
        transformation(
          extent={{-140,-70}, {-120,-50}})));
  Modelica.Blocks.Sources.CombiTimeTable fanStatus(
    ...
    columns={3},
    smoothness=Modelica.Blocks.Types.Smoothness.LinearSegments,
    fileName=Modelica.Utilities.Files.loadResource("modelica://Buildings/Resources/Data/Utilities/Plotters/Examples/ControlsVerification_CoolingCoilValve/VFD_Fan_Enable.mos"))
    "Fan status"
    annotation(
      Placement(
        transformation(
          extent={{-140,-100}, {-120,-80}})));
  Modelica.Blocks.Sources.CombiTimeTable TSupply_F(
    ...
    columns={3},
    fileName=Modelica.Utilities.Files.loadResource("modelica://Buildings/Resources/Data/Utilities/Plotters/Examples/ControlsVerification_CoolingCoilValve/Supply_Air_Temp.mos"))
    "Measured supply air temperature"
    annotation(
      Placement(
        transformation(
          extent={{-140, 40}, {-120, 60}})));
  Buildings.Utilities.Plotters.Examples.BaseClasses.CoolingCoilValve cooValSta(
    ...
    TOutDelta(
      displayUnit="degC"),
    TOutCooCut(
      displayUnit="degC")=50*(5/9)-32*(5/9) + 273.15)
  ...
  Buildings.Controls.OBC.CDL.Continuous.Gain percConv(
    k=0.01)
  ...
  Buildings.Controls.OBC.CDL.Continuous.Gain percConv1(
    k=0.01)
    "Converter from percentage"
    annotation(
      Placement(
...
equation
  ...
  connect(percConv.y, csvWriter.u[1])
    annotation(
      Line(
        points={{-79, 90}, {50, 90}, {50,-29}, {100,-29}},
        color={0, 0, 127}));
  connect(cooValSta.yCooVal, csvWriter.u[2])
    annotation(
      Line(
        points={{41, 0}, {70, 0}, {70,-31}, {100,-31}},
        color={0, 0, 127}));
  ...
  connect(from_degF.y, to_degC.u)
    annotation(
      Line(
        points={{-79, 50}, {-70, 50}, {-70, 70}, {-62, 70}},
        color={0, 0, 127}));
  ...
  connect(from_degF1.y, to_degC1.u)
    annotation(
      Line(
        points={{-79, 20}, {-70, 20}, {-70, 30}, {-62, 30}},
        color={0, 0, 127}));
  ...
  connect(from_degF2.y, to_degC2.u)
    annotation(
      Line(
        points={{-79,-20}, {-72,-20}, {-72,-10}, {-62,-10}},
        color={0, 0, 127}));
  connect(from_degF2.y, cooValSta.TOut)
    annotation(
      Line(
        points={{-79,-20}, {-72,-20}, {-72,-30}, {-10,-30}, {-10, 0}, {19, 0}},
        color={0, 0, 127}));
  connect(from_degF1.y, cooValSta.TSupSet)
    annotation(
      Line(
        points={{-79, 20}, {-70, 20}, {-70, 10}, {-10, 10}, {-10, 4}, {19, 4}},
        color={0, 0, 127}));
  connect(from_degF.y, cooValSta.TSup)
    annotation(
      Line(
        points={{-79, 50}, {0, 50}, {0, 8}, {19, 8}},
        color={0, 0, 127}));
  connect(to_degC.y, timSerInp.y[1])
    annotation(
      Line(
        points={{-39, 70}, {-30, 70}, {-30, 61.3333}, {98, 61.3333}},
        color={0, 0, 127}));
  connect(to_degC1.y, timSerInp.y[2])
    annotation(
      Line(
        points={{-39, 30}, {-30, 30}, {-30, 60}, {98, 60}},
        color={0, 0, 127}));
  connect(to_degC2.y, timSerInp.y[3])
    annotation(
      Line(
        points={{-39,-10}, {-20,-10}, {-20, 58.6667}, {98, 58.6667}},
        color={0, 0, 127}));
  annotation(
    experiment(
      Tolerance=1e-06,
      StopTime=315710),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/Plotters/Examples/ControlsVerification_CoolingCoilValve.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
