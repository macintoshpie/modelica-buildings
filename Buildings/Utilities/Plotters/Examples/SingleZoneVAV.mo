...
model SingleZoneVAV
  ...
  equation
    ...
    connect(scaPFan.x, yFan)
      annotation(
        Line(
          points={{38,-78}, {-4,-78}, {-4,-90}, {-120,-90}},
          color={0, 0, 127}));
    connect(PFan, scaPFan.y[1])
      annotation(
        Line(
          points={{-120,-60}, {-4,-60}, {-4,-70}, {38,-70}},
          color={0, 0, 127}));
    connect(scaEco.x, TOutDryBul_degC.y)
      annotation(
        Line(
          points={{38,-38}, {-4,-38}, {-4, 60}, {-39, 60}},
          color={0, 0, 127}));
    ...
    connect(TOutDryBul_degC.y, ploTOut.y[1])
      annotation(
        Line(
          points={{-39, 60}, {-4, 60}, {-4, 61.3333}, {38, 61.3333}},
          color={0, 0, 127}));
    connect(TDewPoi_degC.y, ploTOut.y[2])
      annotation(
        Line(
          points={{-39, 30}, {-2, 30}, {-2, 60}, {38, 60}},
          color={0, 0, 127}));
    connect(TRooAir_degC.y, ploTOut.y[3])
      annotation(
        Line(
          points={{-39, 0}, {0, 0}, {0, 58.6667}, {38, 58.6667}},
          color={0, 0, 127}));
    connect(TRooAir_degC.y, scaTRoo.y[1])
      annotation(
        Line(
          points={{-39, 0}, {0, 0}, {0, 10}, {38, 10}},
          color={0, 0, 127}));
    connect(scaTRoo.x, TOutDryBul_degC.y)
      annotation(
        Line(
          points={{38, 2}, {-4, 2}, {-4, 60}, {-39, 60}},
          color={0, 0, 127}));
    annotation(
      Icon(
        graphics={Line(
          ...
          points={{-80.0, 90.0}, {-88.0, 68.0}, {-72.0, 68.0}, {-80.0, 90.0}}), Line(
          origin={-1.939,-1.816},
          ...
          fillColor={192, 192, 192},
          fillPattern=FillPattern.Solid,
          points={{90.0,-80.0}, {68.0,-72.0}, {68.0,-88.0}, {90.0,-80.0}}), Line(
...
equation
  ...
  connect(plo.TRoo, zon.TRooAir)
    annotation(
      Line(
        points={{119, 50}, {90, 50}, {90, 0}, {81, 0}},
        color={0, 0, 127}));
  connect(con.yOutAirFra, plo.uEco)
    annotation(
      Line(
        points={{-79, 3}, {-70, 3}, {-70, 47}, {119, 47}},
        color={0, 0, 127}));
  connect(hvac.PFan, plo.PFan)
    annotation(
      Line(
        points={{1, 18}, {24, 18}, {24, 44}, {119, 44}},
        color={0, 0, 127}));
  connect(con.yFan, plo.yFan)
    annotation(
      Line(
        points={{-79, 9}, {-60, 9}, {-60, 41}, {119, 41}},
        color={0, 0, 127}));
  annotation(
    experiment(
      Tolerance=1e-6,
      ...
      StopTime=15984000),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/Plotters/Examples/SingleZoneVAV.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
