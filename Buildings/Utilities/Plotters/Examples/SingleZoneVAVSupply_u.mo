...
model SingleZoneVAVSupply_u
  ...
  Buildings.Controls.OBC.CDL.Continuous.Add heaCooConSig(
    k1=-1)
  ...
  Buildings.Controls.OBC.CDL.Continuous.Sources.Constant TSetZon(
    ...
    annotation(
      Placement(
        transformation(
          extent={{-80,-20}, {-60, 0}})));
  Controls.OBC.CDL.Logical.Sources.Constant fanSta(
    k=true)
    "Fan is on"
    annotation(
      Placement(
...
equation
  connect(TOut.y, setPoiVAV.TOut)
    annotation(
      Line(
        points={{-58,-70}, {-46,-70}, {-46,-15}, {-2,-15}},
        color={0, 0, 127}));
  connect(uHea.y, setPoiVAV.uHea)
    annotation(
      Line(
        points={{-58, 56}, {-44, 56}, {-44,-1.66667}, {-2,-1.66667}},
        color={0, 0, 127}));
  connect(uCoo.y, setPoiVAV.uCoo)
    annotation(
      Line(
        points={{-58, 20}, {-50, 20}, {-50,-5}, {-2,-5}},
        color={0, 0, 127}));
  ...
  connect(uCoo.y, heaCooConSig.u2)
    annotation(
      Line(
        points={{-58, 20}, {-50, 20}, {-50, 44}, {-34, 44}},
        color={0, 0, 127}));
  connect(scaTem.x, heaCooConSig.y)
    annotation(
      Line(
        points={{98,-8}, {90,-8}, {90, 50}, {-10, 50}},
        color={0, 0, 127}));
  connect(THea_degC.y, scaTem.y[1])
    annotation(
      Line(
        points={{62, 20}, {70, 20}, {70, 1}, {98, 1}},
        color={0, 0, 127}));
  connect(TCoo_degC.y, scaTem.y[2])
    annotation(
      Line(
        points={{62,-10}, {70,-10}, {70,-1}, {98,-1}},
        color={0, 0, 127}));
  connect(setPoiVAV.y, scaYFan.y[1])
    annotation(
      Line(
        points={{22,-15}, {30,-15}, {30,-50}, {98,-50}},
        color={0, 0, 127}));
  connect(heaCooConSig.y, scaYFan.x)
    annotation(
      Line(
        points={{-10, 50}, {90, 50}, {90,-58}, {98,-58}},
        color={0, 0, 127}));
  connect(setPoiVAV.TZon, TZon.y)
    annotation(
      Line(
        points={{-2,-11.6667}, {-50,-11.6667}, {-50,-40}, {-58,-40}},
        color={0, 0, 127}));
  connect(setPoiVAV.TSupHeaEco, THea_degC.u)
    annotation(
      Line(
        points={{22,-5}, {30,-5}, {30, 20}, {38, 20}},
        color={0, 0, 127}));
  ...
  connect(TSetZon.y, setPoiVAV.TZonSet)
    annotation(
      Line(
        points={{-58,-10}, {-30,-10}, {-30,-8.33333}, {-2,-8.33333}},
        color={0, 0, 127}));
  connect(fanSta.y, setPoiVAV.uFan)
    annotation(
      Line(
        points={{-18,-50}, {-10,-50}, {-10,-18.3333}, {-2,-18.3333}},
        color={255, 0, 255}));
  annotation(
    Diagram(
      coordinateSystem(
    ...
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/Plotters/Examples/SingleZoneVAVSupply_u.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
