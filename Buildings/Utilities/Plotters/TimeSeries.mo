...
equation
  ...
  annotation(
    ...
    Icon(
      graphics={Line(
        origin={4.061,-23.816},
        points={{81.939, 36.056}, {65.362, 36.056}, {21.939, 17.816}, {-8.061, 75.816}, {-36.061, 5.816}, {-78.061, 23.816}},
        color={0, 0, 127},
        smooth=Smooth.Bezier), Line(
        origin={4.061,-71.816},
        points={{81.939, 36.056}, {71.939, 39.816}, {43.939, 17.816}, {1.939, 75.816}, {-40.061, 21.816}, {-78.061, 23.816}},
        color={244, 125, 35},
        ...
        textString="t"), Line(
        origin={4.061, 6.184},
        points={{81.939, 36.056}, {65.362, 36.056}, {43.939, 27.816}, {11.939, 75.816}, {-36.061, 5.816}, {-78.061, 23.816}},
        color={0, 0, 127},
