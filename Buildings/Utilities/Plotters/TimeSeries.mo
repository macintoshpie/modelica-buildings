...
protected
  final parameter String timeUnitString=if timeUnit == Types.TimeUnit.seconds then "s" elseif timeUnit == Types.TimeUnit.minutes then "min" elseif timeUnit == Types.TimeUnit.hours then "h" else "d"
    "String for time unit that is used in the plotter";
  Real timeConverted
    "Time converted to display unit";
initial algorithm
  timeConverted := 0;
  for i in 1 : n loop
...
equation
  when sampleTrigger then
    ...
    Buildings.Utilities.Plotters.BaseClasses.sendReal(plt=plt, x=cat(1, {timeConverted}, y));
  end when;
  annotation(defaultComponentName="timSer", Icon(graphics={Line(origin={4.061,-23.816}, points={{81.939, 36.056}, {65.362, 36.056}, {21.939, 17.816}, {-8.061, 75.816}, {-36.061, 5.816}, {-78.061, 23.816}}, color={0, 0, 127}, smooth=Smooth.Bezier), Line(origin={4.061,-71.816}, points={{81.939, 36.056}, {71.939, 39.816}, {43.939, 17.816}, {1.939, 75.816}, {-40.061, 21.816}, {-78.061, 23.816}}, color={244, 125, 35}, smooth=Smooth.Bezier), Text(extent={{50,-70}, {76,-94}}, lineColor={0, 0, 0}, fillColor={192, 192, 192}, fillPattern=FillPattern.Solid, textString="t"), Line(origin={4.061, 6.184}, points={{81.939, 36.056}, {65.362, 36.056}, {43.939, 27.816}, {11.939, 75.816}, {-36.061, 5.816}, {-78.061, 23.816}}, color={0, 0, 127}, smooth=Smooth.Bezier)}), Documentation(info="<html>
<p>
