...
model PlotterActivationGlobalInput
  ...
  extends PlotterActivationAlwaysOn(plotConfiguration(activation=Buildings.Utilities.Plotters.Types.GlobalActivation.use_input));
...
equation
  ...
  annotation(experiment(Tolerance=1e-6, StopTime=10.0), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/Plotters/Validation/PlotterActivationGlobalInput.mos"
