...
model PlotterActivationGlobalInputFirstOff
  ...
  annotation(experiment(Tolerance=1e-6, StopTime=10.0), __Dymola_Commands(file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/Plotters/Validation/PlotterActivationGlobalInputFirstOff.mos"
