...
model PlotterActivationGlobalInputFirstOff
  extends PlotterActivationGlobalInput(
    booPul(
      startTime=2));
  annotation(
    experiment(
      ...
      StopTime=10.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/Plotters/Validation/PlotterActivationGlobalInputFirstOff.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
