...
model PlotterActivationLocalInputFirstOff
  ...
  extends PlotterActivationLocalInput(
    booPul(
      startTime=2));
  annotation(
    experiment(
      ...
      StopTime=10.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/Plotters/Validation/PlotterActivationLocalInputFirstOff.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
