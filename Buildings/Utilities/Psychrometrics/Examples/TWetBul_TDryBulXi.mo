...
equation
  ...
  connect(p.y, wetBulApp.p)
    annotation(
      Line(
        points={{-59,-10}, {-40,-10}, {-40,-10}, {-40,-10}, {-40,-18}, {-1,-18}},
        color={0, 0, 127}));
  ...
  annotation(
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/Psychrometrics/Examples/TWetBul_TDryBulXi.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
