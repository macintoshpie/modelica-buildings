...
equation
  ...
  p=101325 + 300*time^3;
  y=Buildings.Utilities.Psychrometrics.Functions.pW_X(
    X_w=X_w,
    p=p);
  der(y)=der(y_comp);
  err=y-y_comp;
  ...
  annotation(
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/Psychrometrics/Functions/BaseClasses/Examples/WaterVaporPressureDerivativeCheck.mos"
        "Simulate and plot"),
    experiment(
      StartTime=-1,
      StopTime=1,
