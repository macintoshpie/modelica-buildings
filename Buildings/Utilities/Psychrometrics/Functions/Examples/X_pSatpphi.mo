...
equation
  ...
  X_w=Buildings.Utilities.Psychrometrics.Functions.X_pSatpphi(
    pSat=pSat,
    p=p,
    phi=phi);
  annotation(
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/Psychrometrics/Functions/Examples/X_pSatpphi.mos"
        "Simulate and plot"),
    Documentation(
      info="<html>
<p>
