...
equation
  ...
  phi=Buildings.Utilities.Psychrometrics.Functions.phi_pTX(
    ...
    T=T,
    X_w=X_w);
  X_inv=Buildings.Utilities.Psychrometrics.Functions.X_pTphi(
    p=p,
    T=T,
    phi=phi);
  ...
  annotation(
    experiment(
      ...
      StopTime=1.0),
    __Dymola_Commands(
      file="modelica://Buildings/Resources/Scripts/Dymola/Utilities/Psychrometrics/Functions/Examples/phi_pTX.mos"
        "Simulate and plot"),
    Documentation(
      revisions="<html>
<ul>
