...
algorithm
  R := Modelica.Media.IdealGases.Common.SingleGasesData.Air.R*(1-X_w) + Modelica.Media.IdealGases.Common.SingleGasesData.H2O.R*X_w;
  d := p/(R*T);
  annotation(smoothOrder=99, Documentation(info="<html>
<p>
