...
function pW_X
  ...
  input Modelica.SIunits.MassFraction X_w(min=0, max=0.99999, nominal=0.01)
    "Species concentration at dry bulb temperature";
  input Modelica.SIunits.Pressure p=101325
    "Total pressure";
  output Modelica.SIunits.Pressure p_w(displayUnit="Pa")
...
algorithm
  ...
  annotation(Inline=true, smoothOrder=99, derivative=BaseClasses.der_pW_X, Documentation(info="<html>
<p>
