...
block X_pW
  ...
  Modelica.Blocks.Interfaces.RealInput p_w(final quantity="Pressure", final unit="Pa", displayUnit="Pa", min=0.003, start=2000, nominal=1000)
...
equation
  ...
  x_w=X_w/(1-X_w);
  annotation(defaultComponentName="humRat", Documentation(info="<html>
<p>
...
</html>"), Icon(graphics={Text(extent={{-92, 52}, {-36,-40}}, lineColor={0, 0, 0}, textString="pW"), Text(extent={{46, 44}, {94,-24}}, lineColor={0, 0, 0}, textString="X")}));
end X_pW;
