...
model CalendarTime
  ...
  Buildings.Utilities.Time.CalendarTime calendarTime2016(zerTim=Buildings.Utilities.Time.Types.ZeroTime.NY2016)
...
</html>"), experiment(Tolerance=1e-6, StopTime=1e+08));
end CalendarTime;
