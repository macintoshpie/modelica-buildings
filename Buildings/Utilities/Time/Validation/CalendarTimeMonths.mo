...
equation
  annotation(__Dymola_Commands(file="Resources/Scripts/Dymola/Utilities/Time/Validation/CalendarTimeMonths.mos"
...
</html>"), experiment(StartTime=172800, Tolerance=1e-6, StopTime=345600));
