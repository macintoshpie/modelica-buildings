...
model CalendarTimeMonthsMinus
  ...
  annotation(__Dymola_Commands(file="Resources/Scripts/Dymola/Utilities/Time/Validation/CalendarTimeMonthsMinus.mos"
...
</html>"), experiment(StartTime=172799, Tolerance=1e-6, StopTime=345599));
