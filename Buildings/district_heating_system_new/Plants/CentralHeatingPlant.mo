...
equation
  ...
  connect(mPum_flow.y,heaWatPumCon.masFloPum)
    annotation (Line(points={{-121,40},{-132,40},{-132,-26},{-121,-26}},    color={0,0,127}));
  ...
  connect(heaWatPumCon.deCouVal,valByp.y)
    annotation (Line(points={{-99,-35},{-94,-35},{-94,-70},{80,-70},{80,0},{74,
          0},{74,-8.88178e-16},{66,-8.88178e-16}},                                                 color={0,0,127}));
  ...
  connect(boiStaCon.y_On,heaWatPumCon.resPI)
    annotation (Line(points={{-99,70.6},{-88,70.6},{-88,-6},{-126,-6},{-126,
          -23.4},{-121,-23.4}},                                                                  color={255,0,255}));
